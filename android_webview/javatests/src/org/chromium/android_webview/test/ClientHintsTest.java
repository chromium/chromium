...
public class ClientHintsTest {
    ...
    @CommandLineFlags.Add({"enable-features=UserAgentClientHint",
            ContentSwitches.HOST_RESOLVER_RULES + "=MAP * 127.0.0.1"})
    public void
    testOverrideUserAgentMetadataGetApi() throws Throwable {
        final TestAwContentsClient contentsClient = new TestAwContentsClient();
        final AwContents contents =
                mActivityTestRule.createAwTestContainerViewOnMainSync(contentsClient)
                        .getAwContents();
        ...
        Assert.assertEquals("fake_platform",
    ...
    @CommandLineFlags.Add({"enable-features=UserAgentClientHint",
            ContentSwitches.HOST_RESOLVER_RULES + "=MAP * 127.0.0.1"})
    public void
    testOverrideUserAgentMetadataInvalidBitness() throws Throwable {
        try {
            getClientHintsWithOverrides(Map.of(AwUserAgentMetadata.MetadataKeys.BITNESS, "foo"),
                    /*overrideUserAgent=*/null);
            Assert.fail("Should have thrown exception.");
        } catch (IllegalArgumentException e) {
            Assert.assertEquals("AwUserAgentMetadata map does not have right type of "
    ...
    @CommandLineFlags.Add({"enable-features=UserAgentClientHint",
            ContentSwitches.HOST_RESOLVER_RULES + "=MAP * 127.0.0.1"})
    public void
    testOverrideUserAgentMetadataDefaultBitness() throws Throwable {
        // Override with bitness 0, we expect it return an empty string.
        ClientHintsTestResult clientHintsResult =
                getClientHintsWithOverrides(Map.of(AwUserAgentMetadata.MetadataKeys.BITNESS, 0),
                        /*overrideUserAgent=*/null);
    ...
    @CommandLineFlags.Add({"enable-features=UserAgentClientHint",
            ContentSwitches.HOST_RESOLVER_RULES + "=MAP * 127.0.0.1"})
    public void
    testOverrideUserAgentMetadataValidBitness() throws Throwable {
        ClientHintsTestResult clientHintsResult =
                getClientHintsWithOverrides(Map.of(AwUserAgentMetadata.MetadataKeys.BITNESS, 32),
                        /*overrideUserAgent=*/null);
    ...
    @CommandLineFlags.Add({"enable-features=UserAgentClientHint",
            ContentSwitches.HOST_RESOLVER_RULES + "=MAP * 127.0.0.1"})
    public void
    testOverrideUserAgentMetadataOverrideBrand() throws Throwable {
        // override with empty full version
        ClientHintsTestResult clientHintsResult = getClientHintsWithOverrides(
                Map.of(AwUserAgentMetadata.MetadataKeys.BRAND_VERSION_LIST,
        ...
        // Verify js client hints results.
        JSONObject jsClientHints = clientHintsResult.mJsClientHints;
        Assert.assertEquals("[{\"brand\":\"brand1\",\"version\":\"1\"},"
                        + "{\"brand\":\"brand2\",\"version\":\"2\"}]",
                jsClientHints.getString("brands"));
        Assert.assertEquals("[{\"brand\":\"brand1\",\"version\":\"1.1.1\"}]",
    ...
    @CommandLineFlags.Add({"enable-features=UserAgentClientHint",
            ContentSwitches.HOST_RESOLVER_RULES + "=MAP * 127.0.0.1"})
    public void
    testOverrideUserAgentMetadataInvalidBrand() throws Throwable {
        ...
        try {
            ...
            Assert.assertEquals("AwUserAgentMetadata map does not have right type of value "
                            + "for key: " + AwUserAgentMetadata.MetadataKeys.BRAND_VERSION_LIST
    ...
    @CommandLineFlags.Add({"enable-features=UserAgentClientHint",
            ContentSwitches.HOST_RESOLVER_RULES + "=MAP * 127.0.0.1"})
    public void
    testOverrideUserAgentMetadataClearOverride() throws Throwable {
        final TestAwContentsClient contentsClient = new TestAwContentsClient();
        final AwContents contents =
                mActivityTestRule.createAwTestContainerViewOnMainSync(contentsClient)
                        .getAwContents();
        ...
        settings.setUserAgentMetadataFromMap(Map.of(AwUserAgentMetadata.MetadataKeys.PLATFORM,
                "fake_platform", AwUserAgentMetadata.MetadataKeys.BRAND_VERSION_LIST,
                new String[][] {{"brand1", "1", "1.1.1"}, {"brand2", "2", "2.2.2"}},
                AwUserAgentMetadata.MetadataKeys.WOW64, true));
        ...
        Assert.assertEquals(
                "\"brand1\";v=\"1\", \"brand2\";v=\"2\"", clientHintsMap.get("sec-ch-ua"));
        Assert.assertEquals("\"brand1\";v=\"1.1.1\", \"brand2\";v=\"2.2.2\"",
        ...
        overrideResetMap.put(AwUserAgentMetadata.MetadataKeys.BRAND_VERSION_LIST,
        ...
        Assert.assertEquals("\"brand1\";v=\"2.1.1\", \"brand2\";v=\"3.2.2\"",
                clientHintsMap.get("sec-ch-ua-full-version-list"));
        ...
        Assert.assertEquals("Android", jsClientHints.getString("platform"));
        Assert.assertEquals("[{\"brand\":\"brand1\",\"version\":\"2\"},"
                        + "{\"brand\":\"brand2\",\"version\":\"3\"}]",
                jsClientHints.getString("brands"));
        Assert.assertEquals("[{\"brand\":\"brand1\",\"version\":\"2.1.1\"},"
    ...
    @CommandLineFlags.Add({"enable-features=UserAgentClientHint",
            ContentSwitches.HOST_RESOLVER_RULES + "=MAP * 127.0.0.1"})
    public void
    testOverrideUserAgentMetadataClearOverrideWithCustomUA() throws Throwable {
        final TestAwContentsClient contentsClient = new TestAwContentsClient();
        final AwContents contents =
                mActivityTestRule.createAwTestContainerViewOnMainSync(contentsClient)
                        .getAwContents();
    ...
    @CommandLineFlags.Add({"enable-features=UserAgentClientHint",
            ContentSwitches.HOST_RESOLVER_RULES + "=MAP * 127.0.0.1"})
    public void
    testOverrideUserAgentMetadataClearOverrideVerifyGetApi() throws Throwable {
        final TestAwContentsClient contentsClient = new TestAwContentsClient();
        final AwContents contents =
                mActivityTestRule.createAwTestContainerViewOnMainSync(contentsClient)
                        .getAwContents();
        ...
        settings.setUserAgentMetadataFromMap(Map.of(AwUserAgentMetadata.MetadataKeys.PLATFORM,
                "fake_platform", AwUserAgentMetadata.MetadataKeys.BRAND_VERSION_LIST,
                overrideBrands, AwUserAgentMetadata.MetadataKeys.WOW64, true));
        Map<String, Object> customUserAgentMetadata = settings.getUserAgentMetadataMap();
        Assert.assertEquals("fake_platform",
                customUserAgentMetadata.get(AwUserAgentMetadata.MetadataKeys.PLATFORM));
        Assert.assertEquals(new Boolean(true),
                customUserAgentMetadata.get(AwUserAgentMetadata.MetadataKeys.WOW64));
        Assert.assertEquals(Arrays.deepToString(overrideBrands),
                Arrays.deepToString((String[][]) customUserAgentMetadata.get(
        ...
        Assert.assertNotEquals(Arrays.deepToString(overrideBrands),
                Arrays.deepToString((String[][]) customUserAgentMetadata.get(
                        AwUserAgentMetadata.MetadataKeys.BRAND_VERSION_LIST)));
        ...
        String[][] actualOverrideBrands = (String[][]) customUserAgentMetadata.get(
                AwUserAgentMetadata.MetadataKeys.BRAND_VERSION_LIST);
    ...
    @CommandLineFlags.Add({"enable-features=UserAgentClientHint,ClientHintsFormFactor",
            ContentSwitches.HOST_RESOLVER_RULES + "=MAP * 127.0.0.1"})
    public void
    testOverrideUserAgentMetadataFullWithoutUAOverrides() throws Throwable {
    ...
    @CommandLineFlags.Add({"enable-features=UserAgentClientHint,ClientHintsFormFactor",
            ContentSwitches.HOST_RESOLVER_RULES + "=MAP * 127.0.0.1"})
    public void
    testOverrideUserAgentMetadataFullWithCustomUa() throws Throwable {
    ...
    @CommandLineFlags.Add({"enable-features=UserAgentClientHint,ClientHintsFormFactor",
            ContentSwitches.HOST_RESOLVER_RULES + "=MAP * 127.0.0.1"})
    public void
    testOverrideUserAgentMetadataFullWithDefaultUA() throws Throwable {
    ...
    @CommandLineFlags.Add({"enable-features=UserAgentClientHint,ClientHintsFormFactor",
            ContentSwitches.HOST_RESOLVER_RULES + "=MAP * 127.0.0.1"})
    public void
    testOverrideUserAgentMetadataNullWithCustomUserAgent() throws Throwable {
        ...
        ClientHintsTestResult clientHintsResult = getClientHintsWithOverrides(
                /*uaMetadataOverrides=*/null, /*overrideUserAgent=*/"customUserAgent");
        Map<String, String> clientHintsMap = clientHintsResult.mHttpHeaderClientHints;
    ...
    private Map<String, Object> makeFakeMetadata() {
        ...
        settings.put(AwUserAgentMetadata.MetadataKeys.BRAND_VERSION_LIST,
                new String[][] {{"brand1", "1", "1.1.1"}, {"brand2", "2", "2.2.2"}});
    ...
    private ClientHintsTestResult makeRequestAndGetClientHints(final AwEmbeddedTestServer server,
            final AwContents contents, final TestAwContentsClient contentsClient) throws Throwable {
        ...
        JSUtils.executeJavaScriptAndWaitForResult(InstrumentationRegistry.getInstrumentation(),
                contents, contentsClient.getOnEvaluateJavaScriptResultHelper(),
    ...
    private void verifyUserAgentOverrideClientHints(final TestAwContentsClient contentsClient,
            final AwContents contents, String customUserAgent, boolean expectHighEntropyClientHints)
            throws Throwable {
        AwActivityTestRule.enableJavaScriptOnUiThread(contents);
        contents.getSettings().setJavaScriptEnabled(true);
    ...
    private HashMap<String, String> getClientHints(String textContent) throws Throwable {
        ...
        for (String hintPair : hintPairs) {
            ...
            // quote(").
            String clientHintName = hints[0].startsWith("\"")
