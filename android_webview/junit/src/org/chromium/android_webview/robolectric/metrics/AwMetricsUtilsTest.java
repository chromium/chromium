...
public class AwMetricsUtilsTest {
    ...
    public void testHistogramNameHashing() {
        Assert.assertEquals(AwMetricsUtils.hashHistogramName("Android.WebView.Visibility.Global"),
        ...
        Assert.assertEquals(AwMetricsUtils.hashHistogramName(
        ...
        Assert.assertEquals(AwMetricsUtils.hashHistogramName("Back"),
                Long.decode("0x0557fa923dcee4d0").longValue());

        Assert.assertEquals(AwMetricsUtils.hashHistogramName("NewTab"),
                Long.decode("0x290eb683f96572f1").longValue());

        Assert.assertEquals(AwMetricsUtils.hashHistogramName("Forward"),
