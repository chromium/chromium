...
public class DestroyChecker implements Destroyable {
    ...
    /**
     * Checks whether the object is already destroyed and throws {@link IllegalStateException} if it
     * is.
     */
    public void checkNotDestroyed() {
        if (mIsDestroyed) throw new IllegalStateException("Object is already destroyed.");
    }
}
