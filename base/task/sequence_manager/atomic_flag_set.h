...
class BASE_EXPORT AtomicFlagSet {
 ...
 public:
  ...
  class BASE_EXPORT AtomicFlag {
   ...
   private:
    ...
    CheckedPtr<AtomicFlagSet> outer_ = nullptr;
    CheckedPtr<Group> group_ = nullptr;  // Null when AtomicFlag is invalid.
 ...
 protected:
  ...
  struct BASE_EXPORT Group {
    ...
    CheckedPtr<Group> prev = nullptr;
    std::unique_ptr<Group> next;
    CheckedPtr<Group> partially_free_list_prev = nullptr;
    CheckedPtr<Group> partially_free_list_next = nullptr;
 ...
 private:
  ...
  CheckedPtr<Group> partially_free_list_head_ = nullptr;
};
