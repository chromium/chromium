...
class BASE_EXPORT ScopedTempDir {
 public:
  // No directory is owned/created initially. Call one of the `CreateUnique`
  // functions to create a directory.
  ScopedTempDir();
  ...
  // Creates a unique directory in TempPath, and takes ownership of it. The new
  // directory name is in the format of "{prefix}yyyy".
  // See file_util::CreateNewTemporaryDirectory.
  [[nodiscard]] bool CreateUniqueTempDir(
      FilePath::StringViewType prefix = GetDefaultTempDirPrefix());

  // Creates a unique directory under a given path, and takes ownership of it.
  // The new directory name is in the format of "{prefix}yyyy".
  [[nodiscard]] bool CreateUniqueTempDirUnderPath(
      const FilePath& path,
      FilePath::StringViewType prefix = GetDefaultTempDirPrefix());
  ...
  // Returns the default prefix used for temp directory names generated by
  // ScopedTempDirs.
  static const FilePath::CharType* GetDefaultTempDirPrefix();
