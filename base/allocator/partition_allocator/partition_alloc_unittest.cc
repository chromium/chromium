...
TEST_F(PartitionAllocTest, EmptySlotSpanSizeIsCapped) {
  ...
  constexpr size_t single_slot_size = 128 * 1024;
  // Check that this is using single-slot slot spans.
  ASSERT_GE(single_slot_size,
            kMaxPartitionPagesPerRegularSlotSpan * PartitionPageSize());
