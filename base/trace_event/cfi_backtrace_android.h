...
class BASE_EXPORT CFIBacktraceAndroid {
 ...
 private:
  ...
  // uintptr_t.
  CheckedPtr<const uintptr_t> unw_index_function_col_ = nullptr;
  ...
  CheckedPtr<const uint16_t> unw_index_indices_col_ = nullptr;
  // The number of rows in UNW_INDEX table.
  size_t unw_index_row_count_ = 0;

  // The start address of UNW_DATA table.
  CheckedPtr<const uint16_t> unw_data_start_addr_ = nullptr;
