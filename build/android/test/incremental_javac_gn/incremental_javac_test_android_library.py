...
def main():
    ...
    _run_gn(
        ['clean', options.out_dir.relative_to(_CHROMIUM_SRC)],
    ...
    _run_gn(
        [
            '--root-target=' + options.target_name,
            'gen',
    ...
    expected_output_path = '{}/obj/{}.javac.jar'.format(
        options.out_dir, gn_path.replace(':', '/')
    )
