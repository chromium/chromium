...
class DebugTagsTest(unittest.TestCase):
    def testOrdering(self):
        ...
        self.assertEqual(
            ['a', 'd', '-b', '-c'], avd.ProcessDebugTags('-c,-b,d,a')
        )

    def testOrderingWithDefaultTags(self):
        default_debug_tags = ['a', '-d', '-c']
        tags = avd.ProcessDebugTags(
            'c,b,-e', default_debug_tags=default_debug_tags
        )
...
class AvdCreateTest(unittest.TestCase):
  ...
  """
    ...
    def testGetAvdSettingsWithVariants(self):
        ...
        self.assertEqual(
            avd_settings_foo.avd_properties['disk.dataPartition.size'], '4G'
        )
        self.assertEqual(
            avd_settings_bar.avd_properties['disk.dataPartition.size'], '8G'
        )
...
class AvdInstallCreateUninstallTest(unittest.TestCase):
  ...
  """
    ...
    def testInstallWithRawSystemImage(
        self,
        _mock_rebase,
        _mock_update,
        _mock_writable,
        ...
        with patch(
            'builtins.open', mock_open(read_data=self._CONFIG_RAW_SYS_IMG)
        ):
    ...
    @patch('pylib.local.emulator.avd.AvdConfig._UpdateConfigs')
    @patch('pylib.local.emulator.avd.AvdConfig._RebaseQcow2Images')
    def testInstallWithoutRawSystemImage(
        self,
        _mock_rebase,
        _mock_update,
        _mock_writable,
    ...
    def testCreateWithRawSystemImage(
        self, _mock_avd_manager, _mock_settings, mock_install_cipd, mock_process
    ):
        with patch(
            'builtins.open', mock_open(read_data=self._CONFIG_RAW_SYS_IMG)
        ):
    ...
    @patch('pylib.local.emulator.avd.AvdConfig.GetAvdSettings')
    @patch('pylib.local.emulator.avd._AvdManagerAgent')
    def testCreateWithoutRawSystemImage(
        self, _mock_avd_manager, _mock_settings, mock_install_cipd, mock_process
    ):
        with patch('builtins.open', mock_open(read_data=self._CONFIG_SYS_IMG)):
            avd_config = avd.AvdConfig('/path/to/creation.textpb')
    ...
    @patch('pylib.local.emulator.avd._AvdManagerAgent')
    def testUninstallWithRawSystemImage(
        self, mock_avd_manager, mock_iter_cipd, mock_exists, mock_rmtree
    ):
        with patch(
            'builtins.open', mock_open(read_data=self._CONFIG_RAW_SYS_IMG)
        ):
    ...
    @patch('pylib.local.emulator.avd.AvdConfig._IterCipdPackages')
    @patch('pylib.local.emulator.avd._AvdManagerAgent')
    def testUninstallWithoutRawSystemImage(
        self, mock_avd_manager, mock_iter_cipd, mock_exists, mock_rmtree
    ):
        with patch('builtins.open', mock_open(read_data=self._CONFIG_SYS_IMG)):
            avd_config = avd.AvdConfig('/path/to/creation.textpb')
    ...
    @patch('pylib.local.emulator.avd.AvdConfig._UpdateConfigs')
    @patch('pylib.local.emulator.avd.AvdConfig._RebaseQcow2Images')
    def testInstallWithRawSystemImageTwice(
        self,
        mock_rebase,
        mock_update,
        mock_writable,
    ...
    @patch('pylib.local.emulator.avd.AvdConfig.GetAvdSettings')
    @patch('pylib.local.emulator.avd._AvdManagerAgent')
    def testCreateWithRawSystemImageTwice(
        self, _mock_avd_manager, _mock_settings, mock_install_cipd, mock_process
    ):
        with patch(
            'builtins.open', mock_open(read_data=self._CONFIG_RAW_SYS_IMG)
    ...
    @patch('pylib.local.emulator.avd.AvdConfig._IterCipdPackages')
    @patch('pylib.local.emulator.avd._AvdManagerAgent')
    def testUninstallWithRawSystemImageTwice(
        self, mock_avd_manager, mock_iter_cipd, mock_exists, mock_rmtree
    ):
        with patch(
            'builtins.open', mock_open(read_data=self._CONFIG_RAW_SYS_IMG)
...
class AvdProcessRawSystemImageTest(unittest.TestCase):
  ...
  """
    ...
    @patch('os.walk')
    @patch('pylib.local.emulator.avd.AvdConfig._InstallCipdPackages')
    def testProcessRawSystemImageAlreadyProcessed(
        self, mock_install_cipd, mock_walk
    ):
        with patch(
            'builtins.open', mock_open(read_data=self._CONFIG_RAW_SYS_IMG)
        ):
    ...
    def testProcessRawSystemImageSuccessful(
        self,
        mock_uninstall_raw,
        mock_install_cipd,
        mock_walk,
        ...
        expected_system_image_path = os.path.join(
            avd_config.emulator_sdk_root,
            'system-images',
            'android-33',
            'google_apis',
            'x86_64',
        ...
        template_content = (
            "Template ${package_path} ${api_level} ${tag_id} ${abi}"
        )
    ...
    @patch('pylib.local.emulator.avd.AvdConfig._InstallCipdPackages')
    @patch('pylib.local.emulator.avd.AvdConfig.UninstallRawSystemImage')
    def testProcessRawSystemImageVersionMismatch(
        self,
        mock_uninstall_raw,
        mock_install_cipd,
        mock_walk,
