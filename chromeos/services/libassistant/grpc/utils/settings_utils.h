...
#ifndef CHROMEOS_SERVICES_LIBASSISTANT_GRPC_UTILS_SETTINGS_UTILS_H_
#define CHROMEOS_SERVICES_LIBASSISTANT_GRPC_UTILS_SETTINGS_UTILS_H_
...
#endif  // CHROMEOS_SERVICES_LIBASSISTANT_GRPC_UTILS_SETTINGS_UTILS_H_
