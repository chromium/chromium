...
#ifndef CHROMEOS_SERVICES_LIBASSISTANT_ASSISTANT_CLIENT_OBSERVER_H_
#define CHROMEOS_SERVICES_LIBASSISTANT_ASSISTANT_CLIENT_OBSERVER_H_
...
#endif  // CHROMEOS_SERVICES_LIBASSISTANT_ASSISTANT_CLIENT_OBSERVER_H_
