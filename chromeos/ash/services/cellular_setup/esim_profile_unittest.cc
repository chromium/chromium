...
class ESimProfileTest : public ESimTestBase {
 public:
  explicit ESimProfileTest(bool enable_dbus_migration) {
...
class ESimProfileTest_DBusMigrationDisabled : public ESimProfileTest {
 public:
  ESimProfileTest_DBusMigrationDisabled(
      const ESimProfileTest_DBusMigrationDisabled&) = delete;
  ESimProfileTest_DBusMigrationDisabled& operator=(
      const ESimProfileTest_DBusMigrationDisabled&) = delete;
 ...
 protected:
  ...
  ~ESimProfileTest_DBusMigrationDisabled() override = default;
};

class ESimProfileTest_DBusMigrationEnabled : public ESimProfileTest {
 public:
  ESimProfileTest_DBusMigrationEnabled(
      const ESimProfileTest_DBusMigrationEnabled&) = delete;
  ESimProfileTest_DBusMigrationEnabled& operator=(
      const ESimProfileTest_DBusMigrationEnabled&) = delete;
 ...
 protected:
  ...
  ~ESimProfileTest_DBusMigrationEnabled() override = default;
};

TEST_F(ESimProfileTest_DBusMigrationDisabled, GetProperties) {
  SetIsGuest(false);
...
TEST_F(ESimProfileTest_DBusMigrationDisabled, InstallProfile) {
  SetIsGuest(false);
...
TEST_F(ESimProfileTest_DBusMigrationDisabled, InstallConnectFailure) {
  SetIsGuest(false);
...
TEST_F(ESimProfileTest_DBusMigrationDisabled, UninstallProfile) {
  SetIsGuest(false);
...
TEST_F(ESimProfileTest_DBusMigrationDisabled, CannotUninstallProfileAsGuest) {
  SetIsGuest(true);
...
TEST_F(ESimProfileTest_DBusMigrationDisabled, SetProfileNickName) {
  SetIsGuest(false);
...
TEST_F(ESimProfileTest_DBusMigrationDisabled, CannotSetProfileNickNameAsGuest) {
  SetIsGuest(true);
...
TEST_F(ESimProfileTest_DBusMigrationEnabled, GetProperties) {
  SetIsGuest(false);
...
TEST_F(ESimProfileTest_DBusMigrationEnabled, InstallProfile) {
  SetIsGuest(false);
  base::HistogramTester histogram_tester;
...
TEST_F(ESimProfileTest_DBusMigrationEnabled, InstallProfileAlreadyConnected) {
  SetIsGuest(false);
...
TEST_F(ESimProfileTest_DBusMigrationEnabled, InstallConnectFailure) {
  SetIsGuest(false);
...
TEST_F(ESimProfileTest_DBusMigrationEnabled, UninstallProfile) {
  SetIsGuest(false);
...
TEST_F(ESimProfileTest_DBusMigrationEnabled, CannotUninstallProfileAsGuest) {
  SetIsGuest(true);
...
TEST_F(ESimProfileTest_DBusMigrationEnabled, SetProfileNickName) {
  SetIsGuest(false);
...
TEST_F(ESimProfileTest_DBusMigrationEnabled, CannotSetProfileNickNameAsGuest) {
  SetIsGuest(true);
