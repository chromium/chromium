...
#ifndef CHROMEOS_ASH_COMPONENTS_BOCA_BABELORCA_FAKE_TOKEN_FETCHER_H_
#define CHROMEOS_ASH_COMPONENTS_BOCA_BABELORCA_FAKE_TOKEN_FETCHER_H_
...
#endif  // CHROMEOS_ASH_COMPONENTS_BOCA_BABELORCA_FAKE_TOKEN_FETCHER_H_
