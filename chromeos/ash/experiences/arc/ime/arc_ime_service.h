...
#ifndef CHROMEOS_ASH_EXPERIENCES_ARC_IME_ARC_IME_SERVICE_H_
#define CHROMEOS_ASH_EXPERIENCES_ARC_IME_ARC_IME_SERVICE_H_
...
#endif  // CHROMEOS_ASH_EXPERIENCES_ARC_IME_ARC_IME_SERVICE_H_
