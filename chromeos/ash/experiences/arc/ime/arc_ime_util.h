...
#ifndef CHROMEOS_ASH_EXPERIENCES_ARC_IME_ARC_IME_UTIL_H_
#define CHROMEOS_ASH_EXPERIENCES_ARC_IME_ARC_IME_UTIL_H_
...
#endif  // CHROMEOS_ASH_EXPERIENCES_ARC_IME_ARC_IME_UTIL_H_
