...
#ifndef CHROMEOS_ASH_EXPERIENCES_ARC_METRICS_ARC_METRICS_SERVICE_H_
#define CHROMEOS_ASH_EXPERIENCES_ARC_METRICS_ARC_METRICS_SERVICE_H_
...
#endif  // CHROMEOS_ASH_EXPERIENCES_ARC_METRICS_ARC_METRICS_SERVICE_H_
