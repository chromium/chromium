...
#ifndef CHROMEOS_ASH_EXPERIENCES_ARC_METRICS_ARC_DAILY_METRICS_H_
#define CHROMEOS_ASH_EXPERIENCES_ARC_METRICS_ARC_DAILY_METRICS_H_
...
#endif  // CHROMEOS_ASH_EXPERIENCES_ARC_METRICS_ARC_DAILY_METRICS_H_
