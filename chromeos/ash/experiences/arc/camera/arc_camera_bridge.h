...
#ifndef CHROMEOS_ASH_EXPERIENCES_ARC_CAMERA_ARC_CAMERA_BRIDGE_H_
#define CHROMEOS_ASH_EXPERIENCES_ARC_CAMERA_ARC_CAMERA_BRIDGE_H_
...
#endif  // CHROMEOS_ASH_EXPERIENCES_ARC_CAMERA_ARC_CAMERA_BRIDGE_H_
