...
#ifndef CHROMEOS_ASH_EXPERIENCES_ARC_NET_CERT_MANAGER_H_
#define CHROMEOS_ASH_EXPERIENCES_ARC_NET_CERT_MANAGER_H_
...
#endif  // CHROMEOS_ASH_EXPERIENCES_ARC_NET_CERT_MANAGER_H_
