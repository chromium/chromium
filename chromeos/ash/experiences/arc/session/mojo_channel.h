...
#ifndef CHROMEOS_ASH_EXPERIENCES_ARC_SESSION_MOJO_CHANNEL_H_
#define CHROMEOS_ASH_EXPERIENCES_ARC_SESSION_MOJO_CHANNEL_H_
...
#endif  // CHROMEOS_ASH_EXPERIENCES_ARC_SESSION_MOJO_CHANNEL_H_
