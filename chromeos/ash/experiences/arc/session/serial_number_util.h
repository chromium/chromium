...
#ifndef CHROMEOS_ASH_EXPERIENCES_ARC_SESSION_SERIAL_NUMBER_UTIL_H_
#define CHROMEOS_ASH_EXPERIENCES_ARC_SESSION_SERIAL_NUMBER_UTIL_H_
...
#endif  // CHROMEOS_ASH_EXPERIENCES_ARC_SESSION_SERIAL_NUMBER_UTIL_H_
