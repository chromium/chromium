...
#ifndef CHROMEOS_ASH_EXPERIENCES_ARC_MOJOM_PRINT_MOJOM_TRAITS_H_
#define CHROMEOS_ASH_EXPERIENCES_ARC_MOJOM_PRINT_MOJOM_TRAITS_H_
...
#endif  // CHROMEOS_ASH_EXPERIENCES_ARC_MOJOM_PRINT_MOJOM_TRAITS_H_
