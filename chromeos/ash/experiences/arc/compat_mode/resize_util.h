...
#ifndef CHROMEOS_ASH_EXPERIENCES_ARC_COMPAT_MODE_RESIZE_UTIL_H_
#define CHROMEOS_ASH_EXPERIENCES_ARC_COMPAT_MODE_RESIZE_UTIL_H_
...
#endif  // CHROMEOS_ASH_EXPERIENCES_ARC_COMPAT_MODE_RESIZE_UTIL_H_
