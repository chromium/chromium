...
#ifndef CHROMEOS_ASH_EXPERIENCES_ARC_WINDOW_ARC_WINDOW_WATCHER_H_
#define CHROMEOS_ASH_EXPERIENCES_ARC_WINDOW_ARC_WINDOW_WATCHER_H_
...
#endif  // CHROMEOS_ASH_EXPERIENCES_ARC_WINDOW_ARC_WINDOW_WATCHER_H_
