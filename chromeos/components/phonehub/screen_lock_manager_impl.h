...
#ifndef CHROMEOS_COMPONENTS_PHONEHUB_SCREEN_LOCK_MANAGER_IMPL_H_
#define CHROMEOS_COMPONENTS_PHONEHUB_SCREEN_LOCK_MANAGER_IMPL_H_
...
#endif  // CHROMEOS_COMPONENTS_PHONEHUB_SCREEN_LOCK_MANAGER_IMPL_H_
