...
#ifndef CHROMEOS_COMPONENTS_ECHE_APP_UI_APPS_ACCESS_MANAGER_H_
#define CHROMEOS_COMPONENTS_ECHE_APP_UI_APPS_ACCESS_MANAGER_H_
...
#endif  // CHROMEOS_COMPONENTS_ECHE_APP_UI_APPS_ACCESS_MANAGER_H_
