...
#ifndef CHROMEOS_COMPONENTS_ECHE_APP_UI_ECHE_UID_PROVIDER_H_
#define CHROMEOS_COMPONENTS_ECHE_APP_UI_ECHE_UID_PROVIDER_H_
...
class EcheUidProvider : public mojom::UidGenerator {
 ...
 private:
  ...
  base::Optional<std::vector<uint8_t>> ConvertStringToBinary(
...
#endif  // CHROMEOS_COMPONENTS_ECHE_APP_UI_ECHE_UID_PROVIDER_H_
