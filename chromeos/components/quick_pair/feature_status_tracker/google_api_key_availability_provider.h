...
#ifndef CHROMEOS_COMPONENTS_QUICK_PAIR_FEATURE_STATUS_TRACKER_GOOGLE_API_KEY_AVAILABILITY_PROVIDER_H_
...
#endif  // CHROMEOS_COMPONENTS_QUICK_PAIR_FEATURE_STATUS_TRACKER_GOOGLE_API_KEY_AVAILABILITY_PROVIDER_H_
