...
#ifndef CHROMEOS_COMPONENTS_PROJECTOR_APP_PROJECTOR_OAUTH_TOKEN_FETCHER_H_
#define CHROMEOS_COMPONENTS_PROJECTOR_APP_PROJECTOR_OAUTH_TOKEN_FETCHER_H_
...
#endif  // CHROMEOS_COMPONENTS_PROJECTOR_APP_PROJECTOR_OAUTH_TOKEN_FETCHER_H_
