...
INSERT INTO buckets(storage_key, host, name, use_count, last_accessed, last_modified, expiration, quota, persistent, durability)
  VALUES('http://a/', 'http://a/', 'bucket_a', 123, 13260644621105493, 13242931862595604, 0, 0, 0, 0);
INSERT INTO buckets(storage_key, host, name, use_count, last_accessed, last_modified, expiration, quota, persistent, durability)
  VALUES('http://b/', 'http://b/', 'bucket_b', 111, 13250042735631065, 13260999511438890, 0, 1000, 0, 0);
