...
chromium_luci.configure_targets(
    generate_pyl_files = chromium_luci.pyl_generation_configuration(
        mixin_overrides = {
            ...
            "legacy_gpu_vulkan_pixel_skia_gold_test_args": True,
            "legacy_gpu_webgl_conformance_shards": True,
            "legacy_gpu_webgl2_conformance_shards": True,
            ...
            "out_dir_arg": True,
            "skia_gold_test": True,
            "skylab-tauto-chromium-graphics": True,
