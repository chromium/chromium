...
targets.console_test_launcher(
    name = "chrome_modern_public_bundle_smoke_test",
...
targets.generated_script(
    name = "ios_chrome_bookmarks_egtests",
...
targets.console_test_launcher(
    name = "web_engine_integration_tests_cfv1",
    label = "//fuchsia_web/webengine:web_engine_integration_tests_cfv1",
)
