...
#ifndef ASH_COMPONENTS_ARC_TEST_FAKE_ARC_INTENT_HELPER_MOJO_H_
#define ASH_COMPONENTS_ARC_TEST_FAKE_ARC_INTENT_HELPER_MOJO_H_
...
#endif  // ASH_COMPONENTS_ARC_TEST_FAKE_ARC_INTENT_HELPER_MOJO_H_
