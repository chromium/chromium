...
#ifndef ASH_COMPONENTS_ARC_TEST_FAKE_ARC_DLC_INSTALL_NOTIFICATION_DELEGATE_H_
#define ASH_COMPONENTS_ARC_TEST_FAKE_ARC_DLC_INSTALL_NOTIFICATION_DELEGATE_H_
...
#endif  // ASH_COMPONENTS_ARC_TEST_FAKE_ARC_DLC_INSTALL_NOTIFICATION_DELEGATE_H_
