...
#ifndef ASH_COMPONENTS_ARC_INTENT_HELPER_OPEN_URL_DELEGATE_H_
#define ASH_COMPONENTS_ARC_INTENT_HELPER_OPEN_URL_DELEGATE_H_
...
#endif  // ASH_COMPONENTS_ARC_INTENT_HELPER_OPEN_URL_DELEGATE_H_
