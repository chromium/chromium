...
#ifndef ASH_COMPONENTS_PROXIMITY_AUTH_PROXIMITY_MONITOR_H_
#define ASH_COMPONENTS_PROXIMITY_AUTH_PROXIMITY_MONITOR_H_
...
#endif  // ASH_COMPONENTS_PROXIMITY_AUTH_PROXIMITY_MONITOR_H_
