...
#ifndef ASH_COMPONENTS_PHONEHUB_FAKE_PING_MANAGER_H_
#define ASH_COMPONENTS_PHONEHUB_FAKE_PING_MANAGER_H_
...
#endif  // ASH_COMPONENTS_PHONEHUB_FAKE_PING_MANAGER_H_
