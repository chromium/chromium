...
#ifndef ASH_COMPONENTS_PHONEHUB_APP_STREAM_MANAGER_H_
#define ASH_COMPONENTS_PHONEHUB_APP_STREAM_MANAGER_H_
...
#endif  // ASH_COMPONENTS_PHONEHUB_APP_STREAM_MANAGER_H_
