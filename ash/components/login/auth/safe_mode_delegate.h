...
#ifndef ASH_COMPONENTS_LOGIN_AUTH_SAFE_MODE_DELEGATE_H_
#define ASH_COMPONENTS_LOGIN_AUTH_SAFE_MODE_DELEGATE_H_
...
class COMPONENT_EXPORT(ASH_LOGIN_AUTH) SafeModeDelegate {
 public:
