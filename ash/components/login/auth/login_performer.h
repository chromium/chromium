...
#ifndef ASH_COMPONENTS_LOGIN_AUTH_LOGIN_PERFORMER_H_
#define ASH_COMPONENTS_LOGIN_AUTH_LOGIN_PERFORMER_H_
...
class COMPONENT_EXPORT(ASH_LOGIN_AUTH) LoginPerformer
