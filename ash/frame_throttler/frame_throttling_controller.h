...
class ASH_EXPORT FrameThrottlingController
 ...
 public:
  ...
  void OnCompositingShuttingDown(aura::WindowTreeHost* host) override;
  ...
  void AddObservation(aura::WindowTreeHost* host);
  void RemoveObservation(aura::WindowTreeHost* host);
 ...
 private:
  ...
  base::ScopedMultiSourceObservation<aura::WindowTreeHost,
                                     aura::WindowTreeHostObserver>
      window_tree_host_observation_{this};
};
