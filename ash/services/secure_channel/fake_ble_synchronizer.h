...
#ifndef ASH_SERVICES_SECURE_CHANNEL_FAKE_BLE_SYNCHRONIZER_H_
#define ASH_SERVICES_SECURE_CHANNEL_FAKE_BLE_SYNCHRONIZER_H_
...
using ::ash::secure_channel::FakeBleSynchronizer;
}
