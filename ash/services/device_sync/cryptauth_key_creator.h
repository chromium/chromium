...
#ifndef ASH_SERVICES_DEVICE_SYNC_CRYPTAUTH_KEY_CREATOR_H_
#define ASH_SERVICES_DEVICE_SYNC_CRYPTAUTH_KEY_CREATOR_H_
...
#endif  // ASH_SERVICES_DEVICE_SYNC_CRYPTAUTH_KEY_CREATOR_H_
