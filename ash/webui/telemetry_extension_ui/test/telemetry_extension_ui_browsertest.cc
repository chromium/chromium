...
#include "ash/webui/telemetry_extension_ui/test/telemetry_extension_ui_browsertest.h"
...
constexpr base::FilePath::CharType kUntrustedAppResources[] = FILE_PATH_LITERAL(
    "ash/webui/telemetry_extension_ui/test/untrusted_app_resources");
