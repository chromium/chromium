...
#ifndef ASH_WEBUI_DIAGNOSTICS_UI_BACKEND_INPUT_DEVICE_INFORMATION_H_
#define ASH_WEBUI_DIAGNOSTICS_UI_BACKEND_INPUT_DEVICE_INFORMATION_H_
...
#endif  // ASH_WEBUI_DIAGNOSTICS_UI_BACKEND_INPUT_DEVICE_INFORMATION_H_
