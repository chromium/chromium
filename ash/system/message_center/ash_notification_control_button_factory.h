...
#ifndef ASH_SYSTEM_MESSAGE_CENTER_ASH_NOTIFICATION_CONTROL_BUTTON_FACTORY_H_
#define ASH_SYSTEM_MESSAGE_CENTER_ASH_NOTIFICATION_CONTROL_BUTTON_FACTORY_H_
...
#endif  // ASH_SYSTEM_MESSAGE_CENTER_ASH_NOTIFICATION_CONTROL_BUTTON_FACTORY_H_