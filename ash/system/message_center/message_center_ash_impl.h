...
#ifndef ASH_SYSTEM_MESSAGE_CENTER_MESSAGE_CENTER_ASH_IMPL_H_
#define ASH_SYSTEM_MESSAGE_CENTER_MESSAGE_CENTER_ASH_IMPL_H_
...
#endif  // ASH_SYSTEM_MESSAGE_CENTER_MESSAGE_CENTER_ASH_IMPL_H_