...
#ifndef ASH_SYSTEM_UNIFIED_SNOOPING_PROTECTION_CONTROLLER_H_
#define ASH_SYSTEM_UNIFIED_SNOOPING_PROTECTION_CONTROLLER_H_
...
#endif  // ASH_SYSTEM_UNIFIED_SNOOPING_PROTECTION_CONTROLLER_H_
