...
// overivew shutdown signal, to prevent calls to the model during shutdown.
class ASH_EXPORT DesksTemplatesPresenter {
 public:
  ...
  // TODO(sammiequon): Integrate with desk_storage::DeskModelObserver.
