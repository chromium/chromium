...
COMPONENT_EXPORT(ASH_CONSTANTS)
BASE_DECLARE_FEATURE(kEnableMappableSIForFastInkHost);
...
COMPONENT_EXPORT(ASH_CONSTANTS)
COMPONENT_EXPORT(ASH_CONSTANTS)
BASE_DECLARE_FEATURE(kEnableInputDeviceSettingsLogging);
...
COMPONENT_EXPORT(ASH_CONSTANTS)
BASE_DECLARE_FEATURE(kUseOneSharedImageForFastInkHostResources);
COMPONENT_EXPORT(ASH_CONSTANTS)
