...
COMPONENT_EXPORT(ASH_CONSTANTS)
BASE_DECLARE_FEATURE(kApplyManagedProxyBypassListVerbatim);
...
COMPONENT_EXPORT(ASH_CONSTANTS)
BASE_DECLARE_FEATURE(kAudioFocusSetting);
COMPONENT_EXPORT(ASH_CONSTANTS)
...
COMPONENT_EXPORT(ASH_CONSTANTS)
BASE_DECLARE_FEATURE(kClipboardHistoryPolicy);
...
COMPONENT_EXPORT(ASH_CONSTANTS)
BASE_DECLARE_FEATURE(kFrameSinkHostNewBackend);
COMPONENT_EXPORT(ASH_CONSTANTS)
BASE_DECLARE_FEATURE(kViewTreeHostRootViewNewBackend);
COMPONENT_EXPORT(ASH_CONSTANTS)
BASE_DECLARE_FEATURE(kFastInkHostNewBackend);
COMPONENT_EXPORT(ASH_CONSTANTS)
BASE_DECLARE_FEATURE(kFastInkHostLowPriorityHint);
COMPONENT_EXPORT(ASH_CONSTANTS)
BASE_DECLARE_FEATURE(kRoundedDisplayHostNewBackend);
...
COMPONENT_EXPORT(ASH_CONSTANTS) bool IsFrameSinkHostNewBackendEnabled();
COMPONENT_EXPORT(ASH_CONSTANTS) bool IsViewTreeHostNewBackendEnabled();
COMPONENT_EXPORT(ASH_CONSTANTS) bool IsFastInkHostNewBackendEnabled();
COMPONENT_EXPORT(ASH_CONSTANTS) bool IsFastInkHostLowPriorityHintEnabled();
COMPONENT_EXPORT(ASH_CONSTANTS) bool IsRoundedDisplayHostNewBackendEnabled();
