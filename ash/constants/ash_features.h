...
COMPONENT_EXPORT(ASH_CONSTANTS) BASE_DECLARE_FEATURE(kOak);
...
COMPONENT_EXPORT(ASH_CONSTANTS) bool IsOakEnabled();
...
COMPONENT_EXPORT(ASH_CONSTANTS) bool IsPineEnabled();
