...
COMPONENT_EXPORT(ASH_CONSTANTS)
BASE_DECLARE_FEATURE(kAppInstallServiceUriBorealis);
...
COMPONENT_EXPORT(ASH_CONSTANTS) BASE_DECLARE_FEATURE(kCameraAppAutoQRDetection);
COMPONENT_EXPORT(ASH_CONSTANTS) BASE_DECLARE_FEATURE(kCameraAppCrosEvents);
...
COMPONENT_EXPORT(ASH_CONSTANTS)
BASE_DECLARE_FEATURE(kRemoveDetectPortalFromChrome);
...
COMPONENT_EXPORT(ASH_CONSTANTS) BASE_DECLARE_FEATURE(kOakFeature);
...
COMPONENT_EXPORT(ASH_CONSTANTS) BASE_DECLARE_FEATURE(kOobeAiIntro);
...
COMPONENT_EXPORT(ASH_CONSTANTS)
BASE_DECLARE_FEATURE(kFeatureManagementOobeTuna);
...
COMPONENT_EXPORT(ASH_CONSTANTS) BASE_DECLARE_FEATURE(kOobeTuna);
...
COMPONENT_EXPORT(ASH_CONSTANTS) BASE_DECLARE_FEATURE(kOrcaFeedback);
...
COMPONENT_EXPORT(ASH_CONSTANTS) BASE_DECLARE_FEATURE(kOrcaControlledByPolicy);
...
COMPONENT_EXPORT(ASH_CONSTANTS) BASE_DECLARE_FEATURE(kOverviewNewFocus);
...
COMPONENT_EXPORT(ASH_CONSTANTS) BASE_DECLARE_FEATURE(kPickerDogfood);
COMPONENT_EXPORT(ASH_CONSTANTS) BASE_DECLARE_FEATURE(kPickerFlip);
...
COMPONENT_EXPORT(ASH_CONSTANTS) BASE_DECLARE_FEATURE(kProjectorV2);
COMPONENT_EXPORT(ASH_CONSTANTS)
...
COMPONENT_EXPORT(ASH_CONSTANTS) BASE_DECLARE_FEATURE(kSeaPenUINext);
...
COMPONENT_EXPORT(ASH_CONSTANTS) BASE_DECLARE_FEATURE(kWallpaperInfoImprovement);
...
COMPONENT_EXPORT(ASH_CONSTANTS) BASE_DECLARE_FEATURE(kWindowBoundsTracker);
...
// TMP QCERT
COMPONENT_EXPORT(ASH_CONSTANTS) BASE_DECLARE_FEATURE(kCacheClientCertQueries);

// Keep alphabetized.

// TMP QCERT
COMPONENT_EXPORT(ASH_CONSTANTS) bool CacheClientCertQueries();
...
COMPONENT_EXPORT(ASH_CONSTANTS) bool IsRemoveDetectPortalFromChromeEnabled();
...
COMPONENT_EXPORT(ASH_CONSTANTS) bool IsOakFeatureEnabled();
...
COMPONENT_EXPORT(ASH_CONSTANTS) bool IsOverviewNewFocusEnabled();
...
COMPONENT_EXPORT(ASH_CONSTANTS) bool IsSeaPenUINextEnabled();
...
COMPONENT_EXPORT(ASH_CONSTANTS) bool IsWallpaperInfoImprovementEnabled();
