...
COMPONENT_EXPORT(ASH_CONSTANTS) BASE_DECLARE_FEATURE(kVpnAppsOnFlex);
COMPONENT_EXPORT(ASH_CONSTANTS)
...
COMPONENT_EXPORT(ASH_CONSTANTS) BASE_DECLARE_FEATURE(kSeaPenPromptRewrite);
...
COMPONENT_EXPORT(ASH_CONSTANTS) bool IsBocaStudentHeartbeatEnabled();
...
COMPONENT_EXPORT(ASH_CONSTANTS) bool IsVpnAppsOnFlexEnabled();
...
COMPONENT_EXPORT(ASH_CONSTANTS) bool IsSeaPenPromptRewriteEnabled();
