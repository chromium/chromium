...
COMPONENT_EXPORT(ASH_CONSTANTS) BASE_DECLARE_FEATURE(kAudioFocusSetting);
COMPONENT_EXPORT(ASH_CONSTANTS)
...
COMPONENT_EXPORT(ASH_CONSTANTS) BASE_DECLARE_FEATURE(kCameraCloudStorage);
...
COMPONENT_EXPORT(ASH_CONSTANTS) BASE_DECLARE_FEATURE(kBorealis);
...
COMPONENT_EXPORT(ASH_CONSTANTS) BASE_DECLARE_FEATURE(kCrostini);
...
COMPONENT_EXPORT(ASH_CONSTANTS) BASE_DECLARE_FEATURE(kSkyVault);
