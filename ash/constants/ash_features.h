...
COMPONENT_EXPORT(ASH_CONSTANTS) BASE_DECLARE_FEATURE(kApnPolicies);
...
COMPONENT_EXPORT(ASH_CONSTANTS)
BASE_DECLARE_FEATURE(kCrostiniTerminaDlcForceOta);
COMPONENT_EXPORT(ASH_CONSTANTS)
...
COMPONENT_EXPORT(ASH_CONSTANTS)
BASE_DECLARE_FEATURE(kHelpAppCrosComponents);
COMPONENT_EXPORT(ASH_CONSTANTS)
...
COMPONENT_EXPORT(ASH_CONSTANTS)
BASE_DECLARE_FEATURE(kShimlessRMASkuDescription);
COMPONENT_EXPORT(ASH_CONSTANTS)
...
COMPONENT_EXPORT(ASH_CONSTANTS) bool IsApnPoliciesEnabled();
...
COMPONENT_EXPORT(ASH_CONSTANTS) bool IsShimlessRMASkuDescriptionEnabled();
