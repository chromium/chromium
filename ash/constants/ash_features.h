...
COMPONENT_EXPORT(ASH_CONSTANTS) BASE_DECLARE_FEATURE(kCalendarV2);
...
COMPONENT_EXPORT(ASH_CONSTANTS)
BASE_DECLARE_FEATURE(kCrosJpSysPkSettingsMigrate);
...
COMPONENT_EXPORT(ASH_CONSTANTS)
BASE_DECLARE_FEATURE(kDeviceActiveClientFirstActiveCheckIn);
COMPONENT_EXPORT(ASH_CONSTANTS)
...
COMPONENT_EXPORT(ASH_CONSTANTS) bool IsCalendarV2Enabled();
