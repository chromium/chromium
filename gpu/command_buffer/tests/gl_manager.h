...
class GLManager : private GpuControl {
 public:
  struct Options {
    ...
    CheckedPtr<GLManager> share_group_manager = nullptr;
    // If not null will share a mailbox manager with this context.
    CheckedPtr<GLManager> share_mailbox_manager = nullptr;
    // If not null will create a virtual manager based on this context.
    CheckedPtr<GLManager> virtual_manager = nullptr;
    ...
    CheckedPtr<gpu::ImageFactory> image_factory = nullptr;
 ...
 private:
  ...
  CheckedPtr<MailboxManager> mailbox_manager_ = nullptr;
