...
class GPU_IPC_SERVICE_EXPORT ImageDecodeAcceleratorStub
 ...
 private:
  ...
  CheckedPtr<ImageDecodeAcceleratorWorker> worker_ = nullptr;

  base::Lock lock_;
  CheckedPtr<GpuChannel> channel_ GUARDED_BY(lock_) = nullptr;
  ...
  CheckedPtr<ImageFactory> external_image_factory_for_testing_ = nullptr;
