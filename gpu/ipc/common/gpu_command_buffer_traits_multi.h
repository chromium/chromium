...
IPC_STRUCT_TRAITS_BEGIN(gpu::Capabilities)
  ...
  IPC_STRUCT_TRAITS_MEMBER(supports_luminance_shared_images)
  IPC_STRUCT_TRAITS_MEMBER(disable_r8_shared_images)
  IPC_STRUCT_TRAITS_MEMBER(supports_oop_raster)
  IPC_STRUCT_TRAITS_MEMBER(supports_yuv_rgb_conversion)
