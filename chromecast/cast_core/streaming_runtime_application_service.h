...
#ifndef CHROMECAST_CAST_CORE_STREAMING_RUNTIME_APPLICATION_SERVICE_H_
#define CHROMECAST_CAST_CORE_STREAMING_RUNTIME_APPLICATION_SERVICE_H_
...
class StreamingRuntimeApplicationService final
    : public RuntimeApplicationServiceBase,
      public StreamingReceiverSessionClient::Handler {
 public:
  // |web_service| is expected to exist for the lifetime of this instance.
  StreamingRuntimeApplicationService(
      CastWebService* web_service,
      scoped_refptr<base::SequencedTaskRunner> task_runner,
      cast_streaming::NetworkContextGetter network_context_getter);
  ~StreamingRuntimeApplicationService() override;
...
#endif  // CHROMECAST_CAST_CORE_STREAMING_RUNTIME_APPLICATION_SERVICE_H_
