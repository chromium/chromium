...
#ifndef CHROMECAST_CAST_CORE_CAST_RUNTIME_ACTION_RECORDER_H_
#define CHROMECAST_CAST_CORE_CAST_RUNTIME_ACTION_RECORDER_H_
...
#endif  // CHROMECAST_CAST_CORE_CAST_RUNTIME_ACTION_RECORDER_H_
