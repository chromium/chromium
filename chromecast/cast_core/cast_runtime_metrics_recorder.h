...
#ifndef CHROMECAST_CAST_CORE_CAST_RUNTIME_METRICS_RECORDER_H_
#define CHROMECAST_CAST_CORE_CAST_RUNTIME_METRICS_RECORDER_H_
...
#endif  // CHROMECAST_CAST_CORE_CAST_RUNTIME_METRICS_RECORDER_H_
