...
#ifndef CHROMECAST_CAST_CORE_MESSAGE_PORT_SERVICE_H_
#define CHROMECAST_CAST_CORE_MESSAGE_PORT_SERVICE_H_
...
#endif  // CHROMECAST_CAST_CORE_MESSAGE_PORT_SERVICE_H_
