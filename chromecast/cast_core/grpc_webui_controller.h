...
#ifndef CHROMECAST_CAST_CORE_GRPC_WEBUI_CONTROLLER_H_
#define CHROMECAST_CAST_CORE_GRPC_WEBUI_CONTROLLER_H_
...
#endif  // CHROMECAST_CAST_CORE_GRPC_WEBUI_CONTROLLER_H_