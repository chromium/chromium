...
#ifndef CHROMECAST_CAST_CORE_URL_REWRITE_RULES_PROVIDER_H_
#define CHROMECAST_CAST_CORE_URL_REWRITE_RULES_PROVIDER_H_
...
#endif  // CHROMECAST_CAST_CORE_URL_REWRITE_RULES_PROVIDER_H_
