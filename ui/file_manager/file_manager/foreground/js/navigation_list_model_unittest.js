...
export function testModel() {
  ...
  // are generated by specifying the one recentItem when constructing the
  // model.
  ...
  assertEquals(
      'fake-entry://recent', /** @type {!NavigationModelFakeItem} */
      (model.item(1)).entry.toURL());
  assertEquals(
      'fake-entry://recent', /** @type {!NavigationModelFakeItem} */
      (model.item(2)).entry.toURL());
  assertEquals(
      'fake-entry://recent', /** @type {!NavigationModelFakeItem} */
      (model.item(3)).entry.toURL());
  assertEquals(
      '/root/shortcut', /** @type {!NavigationModelShortcutItem} */
      (model.item(4)).entry.fullPath);
  assertEquals('My files', model.item(5).label);
  assertEquals(
      'drive', /** @type {!NavigationModelVolumeItem} */
      (model.item(6)).volumeInfo.volumeId);
  assertEquals(
  ...
  const myFilesItem = /** @type NavigationModelFakeItem */ (model.item(5));
...
export function testOrderAndNestItems() {
  ...
  //  1.  fake-entry://recent
  //  2.  fake-entry:Audio (auto-generated from recent model item)
  //  3.  fake-entry:Images (auto-generated from recent model item)
  //  4.  fake-entry:Videos (auto-generated from recent model item)
  //  5.  /root/shortcut
  //  6.  /root/shortcut2
  //  7.  My files
  //        -> Downloads
  ...
  assertEquals('MEDIA_VIEW_IMAGES_ROOT_LABEL', model.item(2).label);
  assertEquals('MEDIA_VIEW_VIDEOS_ROOT_LABEL', model.item(3).label);
  ...
  // Media View (now implemented on top of Recents feature).
  // Audio.
