...
<div id="container">
  ...
  <span class="dummy-very-long-class-name-to-exceed-limit" ?hidden="${this.someCondition_}">*</span>
  ...
  <cr-icon
      icon="${this.someConditionEnabled_ ? 'my-dummy-icons:first-icon' : 'my-dummy-icons:second-icon'}">
  </cr-icon>
