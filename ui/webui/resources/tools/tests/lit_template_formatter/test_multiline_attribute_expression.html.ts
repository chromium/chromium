...
<div id="container">
  <cr-icon ?hidden="${!this.someCondition}"
      icon="${this.someOtherConditionProperty ? 'my-dummy-icons:hello' : 'my-dummy-icons:world'}" alt="" title="hello world">
  </cr-icon>
  <button ?hidden="${this.someLongHiddenCondition && this.myCoolFeature && !this.someOtherConditionThatIsLong}"
