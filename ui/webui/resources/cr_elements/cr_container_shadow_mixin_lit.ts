...
export const CrContainerShadowMixinLit = <T extends Constructor<CrLitElement>>(
  ...
  class CrContainerShadowMixinLit extends superClass implements
    ...
    private dropShadows_: Map<CrContainerShadowSide, HTMLDivElement> =
        new Map();
    private intersectionProbes_: Map<CrContainerShadowSide, HTMLDivElement> =
        new Map();
...
export interface CrContainerShadowMixinLitInterface {
