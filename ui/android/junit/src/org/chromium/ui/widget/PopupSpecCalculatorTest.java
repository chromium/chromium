...
public final class PopupSpecCalculatorTest {
    ...
    public void positionParams_BelowRight() {
        ...
        int spaceLeftOfAnchor =
                AnchoredPopupWindowUtils.getSpaceLeftOfAnchor(anchorRect, mWindowRect, false);
        int spaceRightOfAnchor =
                AnchoredPopupWindowUtils.getSpaceRightOfAnchor(anchorRect, mWindowRect, false);
    ...
    public void positionParams_BelowRight_Overlap() {
        ...
        int spaceLeftOfAnchor =
                AnchoredPopupWindowUtils.getSpaceLeftOfAnchor(anchorRect, mWindowRect, true);
        int spaceRightOfAnchor =
                AnchoredPopupWindowUtils.getSpaceRightOfAnchor(anchorRect, mWindowRect, true);
        boolean positionToLeft =
                AnchoredPopupWindowUtils.shouldPositionLeftOfAnchor(
                        spaceLeftOfAnchor, spaceRightOfAnchor, mPopupWidth, false, false);
    ...
    public void spec_MaxContentWidth() {
        int maxWidth = AnchoredPopupWindowUtils.getMaxContentWidth(300, 600, 10, 10);
        assertEquals("Max width should be based on desired width.", 290, maxWidth);

        maxWidth = AnchoredPopupWindowUtils.getMaxContentWidth(300, 300, 10, 10);
        assertEquals("Max width should be based on root view width.", 270, maxWidth);

        maxWidth = AnchoredPopupWindowUtils.getMaxContentWidth(0, 600, 10, 10);
        assertEquals(
