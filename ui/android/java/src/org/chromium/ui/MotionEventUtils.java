...
public class MotionEventUtils {
     ...
     * sources including fingers and styluses) or by a mouse's primary button.
     */
    public static boolean isTouchOrMousePrimaryButton(boolean fromMouse, int buttons) {
        return !fromMouse || isMousePrimaryButton(fromMouse, buttons);
    }

    /** Checks if the motion event was generated by a mouse's primary button. */
    public static boolean isMousePrimaryButton(boolean fromMouse, int buttons) {
        return fromMouse && (buttons & MotionEvent.BUTTON_PRIMARY) != 0;
    }
}
