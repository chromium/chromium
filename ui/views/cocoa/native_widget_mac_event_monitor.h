 ...
 public:
  class Client {
   public:
    ...
    // The `target_is_this_window_or_descendant` parameter is set to true if the
    // event target was equal to the NSWindow being monitored, or one of its
    // descendant windows.
    virtual void NativeWidgetMacEventMonitorOnEvent(
        ui::Event* event,
