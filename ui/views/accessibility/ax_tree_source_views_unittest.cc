...
class AXTreeSourceViewsTest : public ViewsTestBase {
 public:
  ...
  CheckedPtr<Label> label1_ = nullptr;         // Owned by views hierarchy.
  CheckedPtr<Label> label2_ = nullptr;         // Owned by views hierarchy.
  CheckedPtr<Textfield> textfield_ = nullptr;  // Owned by views hierarchy.
};
