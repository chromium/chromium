...
void test_object_constructed(GObject* obj) {
  G_OBJECT_CLASS(test_object_parent_class)->constructed(obj);
}

// Used by G_DEFINE_TYPE above.
void test_object_finalize(GObject* obj) {
...
void test_object_class_init(TestObjectClass* klass) {
  ...
  object_class->constructed = test_object_constructed;
