...
class VirtualDisplayMacUtil : public display::DisplayObserver {
 public:
  ...
  // `display_id` is only used to label the virtual display. The real id
  // produced by the system can be gotten from the return value, and can be used
  // in `RemoveDisplay` as the input parameter.
