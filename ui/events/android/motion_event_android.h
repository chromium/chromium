...
// All *input* coordinates are in device pixels (as with Android MotionEvent),
// while all *output* coordinates are in DIPs (as with WebTouchEvent).
class EVENTS_EXPORT MotionEventAndroidJavaBacked : public MotionEventAndroid {
 public:
  ...
  MotionEventAndroidJavaBacked(JNIEnv* env,
                               jobject event,
                               jfloat pix_to_dip,
                               jfloat ticks_x,
                               jfloat ticks_y,
  ...
  ~MotionEventAndroidJavaBacked() override;

  // Disallow copy/assign.
  MotionEventAndroidJavaBacked(const MotionEventAndroidJavaBacked& e) = delete;
  void operator=(const MotionEventAndroidJavaBacked&) = delete;
 ...
 private:
  ...
  MotionEventAndroidJavaBacked(const MotionEventAndroidJavaBacked& e,
