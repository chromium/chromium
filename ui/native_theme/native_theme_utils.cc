...
NativeThemeColorIdToColorId(NativeTheme::ColorId native_theme_color_id) {
  ...
  static constexpr const auto map =
      base::MakeFixedFlatMap<NativeTheme::ColorId, ColorId>({
        ...
        {NTCID::kColorId_ShadowValueAmbientShadowElevationTwo,
          kColorShadowValueAmbientShadowElevationTwo},
        {NTCID::kColorId_ShadowValueKeyShadowElevationTwo,
          kColorShadowValueKeyShadowElevationTwo},
