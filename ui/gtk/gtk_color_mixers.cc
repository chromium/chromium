...
void AddGtkNativeCoreColorMixer(ui::ColorProvider* provider) {
  ...
  mixer[ui::kColorAlertHighSeverity] = {ui::SelectBasedOnDarkInput(
      ui::kColorPrimaryBackground, gfx::kGoogleRed300, gfx::kGoogleRed600)};
  mixer[ui::kColorAlertLowSeverity] = {ui::SelectBasedOnDarkInput(
      ui::kColorPrimaryBackground, gfx::kGoogleGreen300, gfx::kGoogleGreen700)};
  mixer[ui::kColorAlertMediumSeverity] = {
      ui::SelectBasedOnDarkInput(ui::kColorPrimaryBackground,
...
void AddGtkNativeUiColorMixer(ui::ColorProvider* provider) {
  ...
  mixer[ui::kColorAvatarHeaderArt] =
      ui::AlphaBlend(ui::kColorPrimaryForeground, ui::kColorPrimaryBackground,
                     gfx::kGoogleGreyAlpha300);
  mixer[ui::kColorAvatarIconGuest] =
      ui::DeriveDefaultIconColor(ui::kColorPrimaryForeground);
