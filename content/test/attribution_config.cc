...
// static
const AttributionConfig AttributionConfig::kDefault = {
    .max_sources_per_origin = kAttributionMaxSourcesPerOrigin,
    .source_event_id_cardinality = kAttributionSourceEventIdCardinality,
    .max_destinations_per_source_site_reporting_origin =
        kAttributionMaxDestinationsPerSourceSiteReportingOrigin,
    .rate_limit = AttributionRateLimitConfig::kDefault,
    .event_level_limit =
        {
            .navigation_source_trigger_data_cardinality =
                kAttributionNavigationSourceTriggerDataCardinality,
            .event_source_trigger_data_cardinality =
                kAttributionEventSourceTriggerDataCardinality,
            .navigation_source_randomized_response_rate =
                kAttributionNavigationSourceRandomizedResponseRate,
            .event_source_randomized_response_rate =
                kAttributionEventSourceRandomizedResponseRate,
            .max_reports_per_destination = kAttributionMaxReportsPerDestination,
            .max_attributions_per_navigation_source =
                kMaxAttributionsPerNavigationSource,
            .max_attributions_per_event_source = kMaxAttributionsPerEventSource,
        },
    .aggregate_limit =
        {
            .max_reports_per_destination = kAttributionMaxReportsPerDestination,
            .aggregatable_budget_per_source =
                kAttributionAggregatableBudgetPerSource,
            .min_delay = kAttributionAggregatableReportMinDelay,
            .delay_span = kAttributionAggregatableReportDelaySpan,
        },
};
