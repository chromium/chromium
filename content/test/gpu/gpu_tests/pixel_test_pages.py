...
class PixelTestPage(sghitb.SkiaGoldHeartbeatTestCase):
  ...
  def __init__(  # pylint: disable=too-many-arguments
    ...
    *args,
    ...
    timeout: int = 300,
    should_capture_full_screenshot_func: Callable[
      [browser_module.Browser], bool
    ]
    | None = None,
...
class TestActionCrashGpuProcess(sghitb.TestAction):
  ...
  def Run(
    ...
    sghitb.EvalInTestIframe(
      tab_data.tab, 'chrome.gpuBenchmarking.crashGpuProcess()'
    )
...
class TestActionRunTestWithHighPerformanceTab(sghitb.TestAction):
  ...
  def Run(
    ...
    if not test_instance.IsDualGPUMacLaptop():
      ...
      logging.info(
        'Short-circuiting test because not running on dual-GPU Mac laptop'
      )
    ...
    try:
      test_instance.NavigateTo(
        high_performance_file, tab_data=high_performance_tab_data
      )
      test_instance.HandleMessageLoop(
        SHORT_GLOBAL_TIMEOUT,
      ...
      test_instance.HandleMessageLoop(
        SHORT_GLOBAL_TIMEOUT, loop_state=loop_state, tab_data=tab_data
      )
...
class TestActionRunLowToHighPowerTest(sghitb.TestAction):
  ...
  def Run(
    ...
    sghitb.EvalInTestIframe(
      tab_data.tab, f'initialize({json.dumps(is_dual_gpu)})'
    )
...
def GetMediaStreamTestBrowserArgs(
  media_stream_source_relpath: str,
) -> list[str]:
  return [
...
class PixelTestPages:
    ...
    return [
      ...
      PixelTestPage(
        ...
        matching_algorithm=algo.FuzzyMatchingAlgorithm(
          max_different_pixels=130, pixel_per_channel_delta_threshold=2
        ),
      ),
      PixelTestPage(
        'pixel_canvas2d_blit.html',
        base_name + '_Canvas2DBlitText',
        crop_action=ca.NonWhiteContentCropAction(
          initial_crop=ca.FixedRectCropAction(0, 0, 1000, 300)
        ),
        matching_algorithm=algo.FuzzyMatchingAlgorithm(
          max_different_pixels=5, pixel_per_channel_delta_threshold=2
        ),
      ),
      PixelTestPage(
      ...
      PixelTestPage(
        ...
        matching_algorithm=algo.SobelMatchingAlgorithm(
          max_different_pixels=0, pixel_delta_threshold=0, edge_threshold=90
        ),
      ),
      PixelTestPage(
      ...
      PixelTestPage(
        'pixel_video_mp4_rounded_corner.html?width=240&height=135&use_timer=1',
      ...
      PixelTestPage(
        'pixel_video_vp9.html?width=240&height=135&use_timer=1',
      ...
      PixelTestPage(
        'pixel_video_av1.html?width=240&height=135&use_timer=1',
      ...
      PixelTestPage(
        'pixel_video_hevc.html?width=240&height=135&use_timer=1',
      ...
      PixelTestPage(
        ...
        # efficient.
        matching_algorithm=algo.FuzzyMatchingAlgorithm(
          max_different_pixels=31700, pixel_per_channel_delta_threshold=10
        ),
        expected_per_process_crashes={
          EXPECTED_CRASHES_PLATFORM_DEFAULT: {
            CRASH_TYPE_GPU: 1,
      ...
      PixelTestPage(
        'pixel_webgl_texture_from_webgl_readback.html',
      ...
      PixelTestPage(
        'pixel_webgl_display_p3.html',
        base_name + '_WebGLDisplayP3',
        crop_action=standard_crop,
      ),
      PixelTestPage(
        'pixel_webgl_float.html',
        base_name + '_WebGLFloat',
        crop_action=standard_crop,
        browser_args=experimental_hdr_args,
      ),
      PixelTestPage(
        'pixel_offscreenCanvas_ibrc_worker.html',
        base_name + '_OffscreenCanvasIBRCWorker',
        crop_action=standard_crop,
      ),
      PixelTestPage(
        'pixel_webgl_resized_canvas.html',
      ...
      PixelTestPage(
        ...
        requires_fullscreen_os_screenshot_func=RequiresFullScreenOSScreenshot,
      ),
      PixelTestPage(
        'pixel_view_transitions_capture.html',
  ...
  def WebGPUPages(base_name) -> list[PixelTestPage]:
    ...
    def webgpu_pages_helper(base_name, mode):
      ...
      return [
        ...
        PixelTestPage(
          'pixel_webgpu_import_video_frame_hdr.html' + hdr_params,
          base_name + '_WebGPUImportVideoFrameHDR',
          crop_action=standard_crop,
          browser_args=webgpu_args + hdr_args,
        ),
        PixelTestPage(
          'pixel_webgpu_webgl_teximage2d.html',
          base_name + '_WebGPUWebGLTexImage2D',
          crop_action=standard_crop,
          browser_args=webgpu_args,
        ),
        PixelTestPage(
          'pixel_webgpu_canvas2d_drawimage.html',
          base_name + '_WebGPUCanvas2DDrawImage',
          crop_action=standard_crop,
          browser_args=webgpu_args,
        ),
        PixelTestPage(
          'pixel_webgpu_texture_storage.html',
          base_name + '_WebGPUCanvasTextureStorage',
          crop_action=standard_crop,
          browser_args=webgpu_args,
        ),
        PixelTestPage(
          'pixel_webgpu_copy_image.html',
          base_name + '_WebGPUToDataURL',
          crop_action=standard_crop,
          browser_args=webgpu_args,
        ),
        PixelTestPage(
          'pixel_webgpu_cached_swap_buffer_invalidated.html',
          base_name + '_WebGPUCachedSwapBufferInvalidatedShouldBeBlank',
          crop_action=fixed_crop,
          browser_args=webgpu_args,
        ),
        PixelTestPage(
          'pixel_webgpu_copy_externalImage_2d_canvas.html',
          base_name + '_WebGPUCopyExternalImage2DCanvas',
          crop_action=standard_crop,
          browser_args=webgpu_args,
        ),
        PixelTestPage(
          'pixel_webgpu_copy_externalImage_imageData.html',
          base_name + '_WebGPUCopyExternalImageImageData',
          crop_action=standard_crop,
          browser_args=webgpu_args,
        ),
        PixelTestPage(
          'pixel_webgpu_copy_externalImage_imageBitmap.html',
          base_name + '_WebGPUCopyExternalImageImageBitmap',
          crop_action=standard_crop,
          browser_args=webgpu_args,
        ),
        PixelTestPage(
          'pixel_webgpu_copy_externalImage_offscreenCanvas.html',
          base_name + '_WebGPUCopyExternalImageOffscreenCanvas',
          crop_action=standard_crop,
          browser_args=webgpu_args,
        ),
        PixelTestPage(
          'pixel_webgpu_copy_externalImage_webgl_canvas.html',
          base_name + '_WebGPUCopyExternalImageWebGLCanvas',
          crop_action=standard_crop,
          browser_args=webgpu_args,
        ),
        PixelTestPage(
          'pixel_webgpu_copy_externalImage_webgpu_canvas.html',
          base_name + '_WebGPUCopyExternalImageWebGPUCanvas',
          crop_action=standard_crop,
          browser_args=webgpu_args,
        ),
        PixelTestPage(
          'pixel_webgpu_display_p3.html',
          base_name + '_WebGPUDisplayP3',
          crop_action=standard_crop,
          browser_args=webgpu_args,
        ),
        PixelTestPage(
          'pixel_webgpu_canvas_format_reinterpretation.html',
    ...
    return (
      webgpu_pages_helper(base_name, mode=Mode.WEBGPU_DEFAULT)
  ...
  def WebGPUCanvasCapturePages(base_name) -> list[PixelTestPage]:
    ...
    return [
      ...
      PixelTestPage(
        'pixel_webgpu_canvas_capture_to_video.html',
      ...
      PixelTestPage(
        'pixel_webgpu_canvas_capture_to_video.html?hidden=true',
  ...
  def WebGPUDeviceDestroyPages(base_name) -> list[PixelTestPage]:
    ...
    for method in methods:
      for canvas_type in canvas_tyes:
        ...
        testPages.append(
          PixelTestPage(
            'pixel_destroyed_webgpu_canvas.html' + arguments,
  ...
  def ExperimentalCanvasFeaturesPages(base_name: str) -> list[PixelTestPage]:
    ...
    return [
      ...
      PixelTestPage(
        'pixel_offscreenCanvas_transferToImageBitmap_main.html',
        base_name + '_OffscreenCanvasTransferToImageBitmapSoftwareCompositing',
        crop_action=standard_crop,
      ...
      PixelTestPage(
        'pixel_webgl_webcodecs_breakoutbox_displays_frame.html',
  ...
  def LowLatencyPages(base_name: str) -> list[PixelTestPage]:
    ...
    return [
      ...
      PixelTestPage(
        'pixel_canvas_low_latency_2d_draw_image.html',
        base_name + '_CanvasLowLatency2DDrawImage',
        crop_action=standard_crop,
      ),
      PixelTestPage(
        'pixel_canvas_low_latency_webgl_draw_image.html',
        base_name + '_CanvasLowLatencyWebGLDrawImage',
        crop_action=standard_crop,
      ),
      PixelTestPage(
        'pixel_canvas_low_latency_2d_image_data.html',
        base_name + '_CanvasLowLatency2DImageData',
        crop_action=standard_crop,
      ),
      PixelTestPage(
        'pixel_canvas_low_latency_webgl_rounded_corners.html',
        base_name + '_CanvasLowLatencyWebGLRoundedCorners',
        crop_action=standard_crop,
        matching_algorithm=ROUNDING_ERROR_ALGO,
      ),
      PixelTestPage(
        'pixel_canvas_low_latency_webgl_occluded.html',
  ...
  def MacSpecificPages(base_name: str) -> list[PixelTestPage]:
    ...
    return [
      ...
      PixelTestPage(
        'pixel_webgl_noaa_noalpha.html',
        base_name + '_WebGLGreenTriangle_NotInOverlay_NoAA_NoAlpha',
        crop_action=standard_crop,
        browser_args=webgl_not_in_overlays_args,
      ),
      ...
      # this test.
      PixelTestPage(
        'core_animation_status_api.html?error=0',
      ...
      # this test.
      PixelTestPage(
        'core_animation_status_api.html?error=32',
      ...
      PixelTestPage(
        'offscreencanvas_imagebitmap_from_worker_uses_overlay.html',
        base_name + '_UnacceleratedOffscreenCanvasImageBitmapWorkerUsesOverlay',
        crop_action=standard_crop,
        browser_args=unaccelerated_2d_canvas_args,
      ),
      # --enable-gpu-benchmarking is required to run this test. it's added to
      # the pixel tests by default.
      PixelTestPage(
        'offscreencanvas_imagebitmap_uses_overlay.html',
      ...
      PixelTestPage(
        'offscreencanvas_imagebitmap_uses_overlay.html',
        base_name + '_UnacceleratedOffscreenCanvasImageBitmapUsesOverlay',
        crop_action=standard_crop,
        browser_args=unaccelerated_2d_canvas_args,
      ),
  ...
  def DirectCompositionPages(
    ...
    return [
      ...
      PixelTestPage(
        f'pixel_video_vp9.html?width=240&height=135&{swap_param}',
      ...
      PixelTestPage(
        (f'pixel_video_vp9_i420a.html?width=240&height=135&{swap_param}'),
        base_name + '_DirectComposition_Video_VP9_I420A',
        crop_action=standard_crop,
        browser_args=browser_args,
        other_args={'no_overlay': True, 'codec': vp9},
        matching_algorithm=strict_dc_sobel_algorithm,
      ),
      PixelTestPage(
        f'pixel_video_vp9.html?width=240&height=135&{swap_param}',
      ...
      PixelTestPage(
        (f'pixel_video_underlay.html?width=240&height=136&{swap_param}'),
      ...
      PixelTestPage(
        (f'pixel_video_underlay.html?width=960&height=540&{swap_param}'),
      ...
      PixelTestPage(
        (
          f'pixel_video_mp4_rounded_corner.html?'
      ...
      PixelTestPage(
        (f'pixel_video_backdrop_filter.html?width=240&height=135&{swap_param}'),
  ...
  def VideoFromCanvasPages(base_name: str) -> list[PixelTestPage]:
    ...
    return [
      ...
      PixelTestPage(
        'pixel_video_from_canvas_webgl2_alpha.html',
      ...
      PixelTestPage(
        'pixel_video_from_canvas_webgl2.html',
      ...
      PixelTestPage(
        'pixel_video_from_canvas_2d.html',
        base_name + '_VideoStreamFrom2DAlphaCanvas_DisableReadbackFromTexture',
        crop_action=standard_crop,
        browser_args=[
      ...
      PixelTestPage(
        'pixel_video_from_canvas_webgl2.html',
        base_name + '_VideoStreamFromWebGLCanvas_TwoCopy_Accelerated',
        crop_action=standard_crop,
        browser_args=['--disable-features=OneCopyCanvasCapture'],
        other_args={'one_copy': False, 'accelerated_two_copy': True},
        matching_algorithm=match_algo,
        timeout=timeout,
      ),
    ]
  ...
  def MeetEffectsPages(base_name: str) -> list[PixelTestPage]:
    test_cases_path = os.path.join(
      gpu_path_util.MEET_EFFECTS_ASSETS_DIR, 'test_cases.json'
    )
    video_path = os.path.join(
      gpu_path_util.MEET_EFFECTS_VIDEO_DIR, 'effects-normal-light.y4m'
    )
    video_args = [
    ...
    with open(test_cases_path, 'r', encoding='utf-8') as f:
      for name, value in json.load(f).items():
        ...
        output.append(
          PixelTestPage(
            f'meet_effects/meet-gpu-tests/index.html?{params}',
