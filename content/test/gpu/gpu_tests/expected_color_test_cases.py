...
def MapsTestCases() -> list[ExpectedColorTestCase]:
  class TestActionStartMapsTest(sghitb.TestAction):
    def Run(
      self,
      test_case: ExpectedColorTestCase,
...
def MediaRecorderTestCases() -> list[ExpectedColorTestCase]:
  ...
  canvas_expected_colors = [
    ...
    ExpectedColorExpectation(
      location=(206, 78), size=(44, 44), color=green, tolerance=100
    ),
  ]
  ...
  video_expected_colors = [
    ...
    ExpectedColorExpectation(
      location=(130, 78), size=(100, 47), color=green, tolerance=100
    ),
    # Source video (bottom image).
    ExpectedColorExpectation(location=(10, 160), size=(100, 47), color=yellow),
    ...
    ExpectedColorExpectation(
      location=(130, 228), size=(100, 47), color=green, tolerance=100
    ),
  ]
