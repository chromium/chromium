...
GPU_DATA_DIR = os.path.join(
  CHROMIUM_SRC_DIR, *_GPU_DATA_RELATIVE_PATH_COMPONENTS
)
MEET_EFFECTS_ASSETS_DIR = os.path.join(
  GPU_DATA_DIR, 'meet_effects', 'meet-gpu-tests'
)
