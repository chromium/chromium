...
class CONTENT_EXPORT TracingDelegate {
 public:
  ...
  // again.
  virtual void OnBackgroundTracingIdle();
  // Returns true if the tracing session is allowed finalize.
  virtual bool CanFinalizeTrace(bool requires_anonymized_data);
