...
public class InputDialogContainerTest {
    ...
    public void testDateValueParsing() {
        mInputDialogContainer.setShowDialogExpectation(
                ...
                0,
                0,
                DATE_DIALOG_DEFAULT_MIN,
                DATE_DIALOG_DEFAULT_MAX,
                1.0);
        mInputDialogContainer.showPickerDialog(
                TextInputType.DATE, 0.0, DATE_DIALOG_DEFAULT_MIN, DATE_DIALOG_DEFAULT_MAX, 1.0);
    ...
    public void testDatetimelocalValueParsing() {
        mInputDialogContainer.setShowDialogExpectation(
                ...
                0,
                0,
                DATETIMELOCAL_DIALOG_DEFAULT_MIN,
    ...
    public void testMonthValueParsing() {
        mInputDialogContainer.setShowDialogExpectation(
                ...
                0,
                0,
                MONTH_DIALOG_DEFAULT_MIN,
                MONTH_DIALOG_DEFAULT_MAX,
                1.0);
        mInputDialogContainer.showPickerDialog(
                TextInputType.MONTH, 0.0, MONTH_DIALOG_DEFAULT_MIN, MONTH_DIALOG_DEFAULT_MAX, 1.0);
    ...
    public void testTimeValueParsing() {
        mInputDialogContainer.setShowDialogExpectation(
                ...
                0,
                0,
                TIME_DIALOG_DEFAULT_MIN,
                TIME_DIALOG_DEFAULT_MAX,
                1.0);
        mInputDialogContainer.showPickerDialog(
                TextInputType.TIME, 0.0, TIME_DIALOG_DEFAULT_MIN, TIME_DIALOG_DEFAULT_MAX, 1.0);
    ...
    public void testDateValueGenerating() {
        ...
        mInputDialogContainer.setFieldDateTimeValue(TextInputType.DATE, 1, 0, 1, 0, 0, 0, 0, 0);

        mInputActionDelegate.setReplaceDateTimeExpectation(8640000000000000.0);
        mInputDialogContainer.setFieldDateTimeValue(
                TextInputType.DATE, 275760, 8, 13, 0, 0, 0, 0, 0);

        mInputActionDelegate.setReplaceDateTimeExpectation(1383782400000.0);
        mInputDialogContainer.setFieldDateTimeValue(TextInputType.DATE, 2013, 10, 7, 0, 0, 0, 0, 0);
    }
    ...
    public void testDatetimelocalValueGenerating() {
        mInputActionDelegate.setReplaceDateTimeExpectation(0);
        mInputDialogContainer.setFieldDateTimeValue(
                TextInputType.DATE_TIME_LOCAL, 1970, 0, 1, 0, 0, 0, 0, 0);

        mInputActionDelegate.setReplaceDateTimeExpectation(-62135596800000.0);
        mInputDialogContainer.setFieldDateTimeValue(
                TextInputType.DATE_TIME_LOCAL, 1, 0, 1, 0, 0, 0, 0, 0);

        mInputActionDelegate.setReplaceDateTimeExpectation(8640000000000000.0);
        mInputDialogContainer.setFieldDateTimeValue(
                TextInputType.DATE_TIME_LOCAL, 275760, 8, 13, 0, 0, 0, 0, 0);

        mInputActionDelegate.setReplaceDateTimeExpectation(1383872462196.0);
        mInputDialogContainer.setFieldDateTimeValue(
                TextInputType.DATE_TIME_LOCAL, 2013, 10, 8, 1, 1, 2, 196, 0);
    }
    ...
    public void testMonthValueGenerating() {
        ...
        mInputActionDelegate.setReplaceDateTimeExpectation(-62135596800000.0);
        mInputDialogContainer.setFieldDateTimeValue(TextInputType.MONTH, 1, 0, 1, 0, 0, 0, 0, 0);

        mInputActionDelegate.setReplaceDateTimeExpectation(8640000000000000.0);
        mInputDialogContainer.setFieldDateTimeValue(
                TextInputType.MONTH, 275760, 8, 0, 0, 0, 0, 0, 0);

        mInputActionDelegate.setReplaceDateTimeExpectation(1383872462196.0);
        mInputDialogContainer.setFieldDateTimeValue(
                TextInputType.MONTH, 2013, 10, 0, 0, 0, 0, 0, 0);
    }
    ...
    public void testTimeValueGenerating() {
        ...
        mInputDialogContainer.setFieldDateTimeValue(
                TextInputType.TIME, 0, 0, 0, 23, 59, 59, 999, 0);

        mInputActionDelegate.setReplaceDateTimeExpectation(55425678.0);
        mInputDialogContainer.setFieldDateTimeValue(
                TextInputType.TIME, 2013, 10, 0, 3, 23, 45, 678, 0);
    }
    ...
    public void testWeekValueGenerating() {
        ...
        mInputActionDelegate.setReplaceDateTimeExpectation(-62135596800000.0);
        mInputDialogContainer.setFieldDateTimeValue(TextInputType.WEEK, 1, 0, 0, 0, 0, 0, 0, 1);

        mInputActionDelegate.setReplaceDateTimeExpectation(8639999568000000.0);
        mInputDialogContainer.setFieldDateTimeValue(
                TextInputType.WEEK, 275760, 0, 0, 0, 0, 0, 0, 37);

        mInputActionDelegate.setReplaceDateTimeExpectation(1382918400000.0);
        mInputDialogContainer.setFieldDateTimeValue(TextInputType.WEEK, 2013, 0, 0, 0, 0, 0, 0, 44);
    }
    ...
    private static class InputDialogContainerForTests extends InputDialogContainer {
        ...
        public InputDialogContainerForTests(
                Context context, InputDialogContainer.InputActionDelegate inputActionDelegate) {
            super(context, inputActionDelegate);
        }

        void setShowDialogExpectation(
                int dialogType,
                int year,
                int month,
                int monthDay,
        ...
        @Override
        public void setFieldDateTimeValue(
                int dialogType,
                int year,
                int month,
                int monthDay,
                ...
                int millis,
                int week) {
            super.setFieldDateTimeValue(
                    dialogType, year, month, monthDay, hourOfDay, minute, second, millis, week);
        }
    }
}
