...
void BrowserAccessibilityManagerWin::FireUiaActiveTextPositionChangedEvent(
  ...
  // This API is only supported from Win8.1 onwards. Skip firing this event on
  // older platforms (such as Windows 7) by querying for the address of the
  // method "UiaRaiseActiveTextPositionChangedEvent" in uiautomationcore.dll.
  ...
  UiaRaiseActiveTextPositionChangedEventFunction
      active_text_position_changed_func =
          reinterpret_cast<UiaRaiseActiveTextPositionChangedEventFunction>(
