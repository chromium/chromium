...
#ifndef CONTENT_BROWSER_FILE_SYSTEM_ACCESS_FILE_SYSTEM_ACCESS_DRAG_DROP_TOKEN_IMPL_H_
#define CONTENT_BROWSER_FILE_SYSTEM_ACCESS_FILE_SYSTEM_ACCESS_DRAG_DROP_TOKEN_IMPL_H_
...
// This is the browser side implementation of the FileSystemAccessDragDropToken
...
// mojo::PendingRemote<FileSystemAccessDragDropToken>s are passed to the
// renderer process specified by `renderer_process_id` and can then be redeemed
// for FileSystemAccessEntry objects.
class CONTENT_EXPORT FileSystemAccessDragDropTokenImpl
    : public blink::mojom::FileSystemAccessDragDropToken {
 public:
  FileSystemAccessDragDropTokenImpl(
  ...
  ~FileSystemAccessDragDropTokenImpl() override;

  FileSystemAccessDragDropTokenImpl(const FileSystemAccessDragDropTokenImpl&) =
      delete;

  FileSystemAccessDragDropTokenImpl& operator=(
      const FileSystemAccessDragDropTokenImpl&) = delete;
...
#endif  // CONTENT_BROWSER_FILE_SYSTEM_ACCESS_FILE_SYSTEM_ACCESS_DRAG_DROP_TOKEN_IMPL_H_
