...
class NativeFileSystemFileWriterImplTest : public testing::Test {
 ...
 protected:
  ...
  CheckedPtr<TestFileSystemBackend> test_file_system_backend_;
  scoped_refptr<ChromeBlobStorageContext> chrome_blob_context_;
  CheckedPtr<storage::BlobStorageContext> blob_context_;
  ...
  CheckedPtr<NativeFileSystemFileWriterImpl> handle_;
};
