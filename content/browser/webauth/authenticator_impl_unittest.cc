...
class PINTestAuthenticatorRequestDelegate
 ...
 private:
  ...
  const CheckedPtr<absl::optional<InterestingFailureReason>> failure_reason_;
...
class BlockingAuthenticatorRequestDelegate
 ...
 private:
  const CheckedPtr<base::OnceClosure> callback_;
...
class BlockingDelegateContentBrowserClient : public ContentBrowserClient {
 ...
 private:
  ...
  const CheckedPtr<base::OnceClosure> callback_;
  CheckedPtr<BlockingAuthenticatorRequestDelegate> delegate_ = nullptr;
};
