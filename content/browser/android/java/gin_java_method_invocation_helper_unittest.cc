...
TEST_F(GinJavaMethodInvocationHelperTest, RetrievalOfObjectsHaveObjects) {
  ...
  objects.Append(base::Value(std::move(sub_list_with_dict)));
  ...
  objects.Append(base::Value(std::move(sub_dict_with_list)));
