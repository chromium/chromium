...
class CONTENT_EXPORT RenderWidgetHostViewAndroid
 ...
 private:
  ...
  CheckedPtr<ImeAdapterAndroid> ime_adapter_android_;
  CheckedPtr<SelectionPopupController> selection_popup_controller_;
  CheckedPtr<TextSuggestionHostAndroid> text_suggestion_host_;
  CheckedPtr<GestureListenerManager> gesture_listener_manager_;
  ...
  CheckedPtr<WebContentsAccessibilityAndroid> web_contents_accessibility_ =
      nullptr;
