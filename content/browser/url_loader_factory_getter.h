...
class URLLoaderFactoryGetter
 ...
 private:
  ...
  CheckedPtr<network::mojom::URLLoaderFactory> test_factory_ = nullptr;
  CheckedPtr<network::mojom::URLLoaderFactory> test_factory_corb_enabled_ =
      nullptr;
  ...
  CheckedPtr<StoragePartitionImpl> partition_ = nullptr;
