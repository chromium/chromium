...
class CONTENT_EXPORT DebuggableAuctionWorklet {
 ...
 private:
  ...
  const CheckedPtr<RenderFrameHostImpl> owning_frame_ = nullptr;
  const GURL url_;
  CheckedPtr<auction_worklet::mojom::BidderWorklet> bidder_worklet_ = nullptr;
  CheckedPtr<auction_worklet::mojom::SellerWorklet> seller_worklet_ = nullptr;
};
