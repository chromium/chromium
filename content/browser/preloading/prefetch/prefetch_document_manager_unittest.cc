...
TEST_F(PrefetchDocumentManagerTest, CanPrefetchNowLimits_EagerEviction) {
  ...
  for (int i = 0; i < 4; ++i) {
    ...
    prefetch_document_manager->PrefetchUrl(
        ...
        blink::mojom::Referrer(), SpeculationRulesTags(), nullptr,
