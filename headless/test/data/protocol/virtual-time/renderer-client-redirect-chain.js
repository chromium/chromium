...
(async function(testRunner) {
  ...
  httpInterceptor.addResponse(`http://www.example.com/2`, `<html>
        <head>
  ...
  httpInterceptor.addResponse(`http://www.example.com/3`, `<html>
        <head>
          <title>Pass</title>
        </head>
        <body>
  ...
  httpInterceptor.addResponse(`http://www.example.com/pass`, `<html>
        <body>
        pass
        </body>
      </html>`);
