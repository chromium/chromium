...
(async function(testRunner) {
  ...
  httpInterceptor.addResponse('http://www.example.com/1', `<html>
        <head>
  ...
  httpInterceptor.addResponse(
      'http://www.example.com/2', null, ['HTTP/1.1 302 Found', 'Location: 3']);

  httpInterceptor.addResponse(
      'http://www.example.com/3', null,
      ['HTTP/1.1 301 Moved', 'Location: http://www.example.com/4']);

  httpInterceptor.addResponse('http://www.example.com/4', `<p>Pass</p>`);
