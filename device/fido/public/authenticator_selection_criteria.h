...
#ifndef DEVICE_FIDO_PUBLIC_AUTHENTICATOR_SELECTION_CRITERIA_H_
#define DEVICE_FIDO_PUBLIC_AUTHENTICATOR_SELECTION_CRITERIA_H_
...
class COMPONENT_EXPORT(FIDO_PUBLIC) AuthenticatorSelectionCriteria {
 public:
...
#endif  // DEVICE_FIDO_PUBLIC_AUTHENTICATOR_SELECTION_CRITERIA_H_
