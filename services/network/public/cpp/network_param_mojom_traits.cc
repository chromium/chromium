...
EnumTraits<network::mojom::SSLClientCertType, net::SSLClientCertType>::ToMojom(
  ...
  switch (scheme) {
    case net::SSLClientCertType::CLIENT_CERT_RSA_SIGN:
      return network::mojom::SSLClientCertType::kRsaSign;
    case net::SSLClientCertType::CLIENT_CERT_ECDSA_SIGN:
      return network::mojom::SSLClientCertType::kEcdsaSign;
    case net::SSLClientCertType::CLIENT_CERT_INVALID_TYPE:
      return network::mojom::SSLClientCertType::kInvalid;
  }
  NOTREACHED_NORETURN();
}
...
bool EnumTraits<network::mojom::SSLClientCertType, net::SSLClientCertType>::
  ...
  switch (scheme) {
    case network::mojom::SSLClientCertType::kRsaSign:
      *out = net::SSLClientCertType::CLIENT_CERT_RSA_SIGN;
      return true;
    case network::mojom::SSLClientCertType::kEcdsaSign:
      *out = net::SSLClientCertType::CLIENT_CERT_ECDSA_SIGN;
      return true;
    case network::mojom::SSLClientCertType::kInvalid:
      *out = net::SSLClientCertType::CLIENT_CERT_INVALID_TYPE;
      return true;
  }
  return false;
}
