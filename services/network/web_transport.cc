...
class WebTransport::Stream final {
 ...
 private:
  ...
  const CheckedPtr<WebTransport> transport_;  // outlives |this|.
  const uint32_t id_;
  ...
  CheckedPtr<quic::WebTransportStream> outgoing_ = nullptr;
  CheckedPtr<quic::WebTransportStream> incoming_ = nullptr;
