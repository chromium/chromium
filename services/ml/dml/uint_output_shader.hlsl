...
RWBuffer<uint> input_buffer : register(u0);
RWBuffer<uint> output_buffer : register(u1);
...
void format_uint_output(uint3 block_id : SV_GroupID, uint3 thread_id : SV_GroupThreadID)
{
