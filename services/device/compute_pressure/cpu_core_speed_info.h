...
#ifndef SERVICES_DEVICE_COMPUTE_PRESSURE_CPU_CORE_SPEED_INFO_H_
#define SERVICES_DEVICE_COMPUTE_PRESSURE_CPU_CORE_SPEED_INFO_H_
...
#endif  // SERVICES_DEVICE_COMPUTE_PRESSURE_CPU_CORE_SPEED_INFO_H_
