...
#ifndef SERVICES_DEVICE_COMPUTE_PRESSURE_SYSFS_CPUFREQ_CORE_PARSER_H_
#define SERVICES_DEVICE_COMPUTE_PRESSURE_SYSFS_CPUFREQ_CORE_PARSER_H_
...
#endif  // SERVICES_DEVICE_COMPUTE_PRESSURE_SYSFS_CPUFREQ_CORE_PARSER_H_
