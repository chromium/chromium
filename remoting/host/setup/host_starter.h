...
class HostStarter {
 public:
  ...
  struct Params {
    ...
    std::string host_pin;
    // An OAuth2 authorization code generated for the |host_owner|, used to
    // associate the new host instance with its owner in the Directory.
    std::string auth_code;
    // URL used to retrieve an OAuth2 access using |auth_code|.
    std::string redirect_url;

    // Optional parameter used to verify that |auth_code| was generated by the
  ...
  virtual void StartHost(const Params& params, CompletionCallback on_done) = 0;
};
