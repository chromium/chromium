...
static_assert(sizeof(ServiceEntry) >= kMinServiceSize,
              "wrong minimum service length");
static_assert(sizeof(ServiceEntry) < kMaxServiceSize,
              "wrong maximum service length");
static_assert(sizeof(Wow64Entry) >= kMinServiceSize,
              "wrong minimum service length");
static_assert(sizeof(Wow64Entry) <= kMaxServiceSize,
              "wrong maximum service length");
