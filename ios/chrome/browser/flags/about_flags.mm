...
const flags_ui::FeatureEntry kFeatureEntries[] = {
    ...
    {"enable-stale-identities", flag_descriptions::kEnableStaleIdentitiesName,
     flag_descriptions::kEnableStaleIdentitiesDescription, flags_ui::kOsIos,
     FEATURE_VALUE_TYPE(switches::kEnableStaleIdentities)},
