...
#ifndef IOS_CHROME_BROWSER_BRING_ANDROID_TABS_MODEL_FEATURES_H_
#define IOS_CHROME_BROWSER_BRING_ANDROID_TABS_MODEL_FEATURES_H_
...
#endif  // IOS_CHROME_BROWSER_BRING_ANDROID_TABS_MODEL_FEATURES_H_
