...
#ifndef IOS_CHROME_BROWSER_TABS_INACTIVE_TABS_METRICS_H_
#define IOS_CHROME_BROWSER_TABS_INACTIVE_TABS_METRICS_H_
...
#endif  // IOS_CHROME_BROWSER_TABS_INACTIVE_TABS_METRICS_H_
