...
#ifndef IOS_CHROME_BROWSER_BACKEND_PROMO_SERVICE_MODEL_BACKEND_PROMO_SERVICE_H_
#define IOS_CHROME_BROWSER_BACKEND_PROMO_SERVICE_MODEL_BACKEND_PROMO_SERVICE_H_
...
#endif  // IOS_CHROME_BROWSER_BACKEND_PROMO_SERVICE_MODEL_BACKEND_PROMO_SERVICE_H_
