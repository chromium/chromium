...
#ifndef IOS_CHROME_BROWSER_CRASH_REPORT_MODEL_MAIN_THREAD_FREEZE_DETECTOR_H_
#define IOS_CHROME_BROWSER_CRASH_REPORT_MODEL_MAIN_THREAD_FREEZE_DETECTOR_H_
...
#endif  // IOS_CHROME_BROWSER_CRASH_REPORT_MODEL_MAIN_THREAD_FREEZE_DETECTOR_H_
