...
#ifndef IOS_CHROME_BROWSER_SIGNIN_SYSTEM_IDENTITY_INTERACTION_MANAGER_H_
#define IOS_CHROME_BROWSER_SIGNIN_SYSTEM_IDENTITY_INTERACTION_MANAGER_H_
...
#endif  // IOS_CHROME_BROWSER_SIGNIN_SYSTEM_IDENTITY_INTERACTION_MANAGER_H_
