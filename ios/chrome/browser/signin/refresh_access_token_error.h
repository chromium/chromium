...
#ifndef IOS_CHROME_BROWSER_SIGNIN_REFRESH_ACCESS_TOKEN_ERROR_H_
#define IOS_CHROME_BROWSER_SIGNIN_REFRESH_ACCESS_TOKEN_ERROR_H_
...
#endif  // IOS_CHROME_BROWSER_SIGNIN_REFRESH_ACCESS_TOKEN_ERROR_H_
