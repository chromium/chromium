...
#ifndef IOS_CHROME_BROWSER_SIGNIN_COORDINATOR_AGE_MISMATCH_SIGNOUT_MEDIATOR_H_
#define IOS_CHROME_BROWSER_SIGNIN_COORDINATOR_AGE_MISMATCH_SIGNOUT_MEDIATOR_H_
...
#endif  // IOS_CHROME_BROWSER_SIGNIN_COORDINATOR_AGE_MISMATCH_SIGNOUT_MEDIATOR_H_
