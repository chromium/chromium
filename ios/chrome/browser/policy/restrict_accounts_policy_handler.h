...
#ifndef IOS_CHROME_BROWSER_POLICY_RESTRICT_ACCOUNTS_POLICY_HANDLER_H_
#define IOS_CHROME_BROWSER_POLICY_RESTRICT_ACCOUNTS_POLICY_HANDLER_H_
...
#endif  // IOS_CHROME_BROWSER_POLICY_RESTRICT_ACCOUNTS_POLICY_HANDLER_H_
