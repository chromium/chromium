...
#ifndef IOS_CHROME_BROWSER_POLICY_POLICY_EARL_GREY_MATCHERS_H_
#define IOS_CHROME_BROWSER_POLICY_POLICY_EARL_GREY_MATCHERS_H_
...
#endif  // IOS_CHROME_BROWSER_POLICY_POLICY_EARL_GREY_MATCHERS_H_
