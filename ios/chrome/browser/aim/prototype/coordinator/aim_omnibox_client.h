...
#ifndef IOS_CHROME_BROWSER_AIM_PROTOTYPE_COORDINATOR_AIM_OMNIBOX_CLIENT_H_
#define IOS_CHROME_BROWSER_AIM_PROTOTYPE_COORDINATOR_AIM_OMNIBOX_CLIENT_H_
...
class AIMOmniboxClient final : public OmniboxClient,
                               public web::WebStateObserver {
 public:
  AIMOmniboxClient(WebLocationBar* location_bar,
                   Browser* browser,
                   feature_engagement::Tracker* tracker,
                   id<AIMOmniboxClientDelegate> delegate);

  AIMOmniboxClient(const AIMOmniboxClient&) = delete;
  AIMOmniboxClient& operator=(const AIMOmniboxClient&) = delete;

  ~AIMOmniboxClient() override;
 ...
 private:
  ...
  // Delegate which implement the AIMOmniboxClientDelegate protocol responsible
  // for handling user actions, such as accepting an omnibox suggestion.
  __weak id<AIMOmniboxClientDelegate> delegate_;

  base::WeakPtrFactory<AIMOmniboxClient> weak_factory_{this};
};

#endif  // IOS_CHROME_BROWSER_AIM_PROTOTYPE_COORDINATOR_AIM_OMNIBOX_CLIENT_H_
