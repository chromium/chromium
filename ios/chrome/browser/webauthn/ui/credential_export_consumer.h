...
#ifndef IOS_CHROME_BROWSER_WEBAUTHN_UI_CREDENTIAL_EXPORT_CONSUMER_H_
#define IOS_CHROME_BROWSER_WEBAUTHN_UI_CREDENTIAL_EXPORT_CONSUMER_H_
...
#endif  // IOS_CHROME_BROWSER_WEBAUTHN_UI_CREDENTIAL_EXPORT_CONSUMER_H_
