...
#define IOS_CHROME_BROWSER_BOOKMARKS_FOLDER_EDITOR_UI_BOOKMARKS_FOLDER_EDITOR_VIEW_CONTROLLER_H_
...
#endif  // IOS_CHROME_BROWSER_BOOKMARKS_FOLDER_EDITOR_UI_BOOKMARKS_FOLDER_EDITOR_VIEW_CONTROLLER_H_
