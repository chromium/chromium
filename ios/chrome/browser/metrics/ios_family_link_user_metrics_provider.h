...
#ifndef IOS_CHROME_BROWSER_METRICS_IOS_FAMILY_LINK_USER_METRICS_PROVIDER_H_
#define IOS_CHROME_BROWSER_METRICS_IOS_FAMILY_LINK_USER_METRICS_PROVIDER_H_
...
#endif  // IOS_CHROME_BROWSER_METRICS_IOS_FAMILY_LINK_USER_METRICS_PROVIDER_H_
