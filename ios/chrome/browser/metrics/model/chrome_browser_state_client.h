...
#ifndef IOS_CHROME_BROWSER_METRICS_MODEL_CHROME_BROWSER_STATE_CLIENT_H_
#define IOS_CHROME_BROWSER_METRICS_MODEL_CHROME_BROWSER_STATE_CLIENT_H_
...
#endif  // IOS_CHROME_BROWSER_METRICS_MODEL_CHROME_BROWSER_STATE_CLIENT_H_
