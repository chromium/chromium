...
#ifndef IOS_CHROME_BROWSER_READING_LIST_UI_BUNDLED_READING_LIST_MENU_NOTIFIER_H_
#define IOS_CHROME_BROWSER_READING_LIST_UI_BUNDLED_READING_LIST_MENU_NOTIFIER_H_
...
#endif  // IOS_CHROME_BROWSER_READING_LIST_UI_BUNDLED_READING_LIST_MENU_NOTIFIER_H_
