...
#ifndef IOS_CHROME_BROWSER_PROMOS_MANAGER_PROMO_CONFIG_H_
#define IOS_CHROME_BROWSER_PROMOS_MANAGER_PROMO_CONFIG_H_
...
#endif  // IOS_CHROME_BROWSER_PROMOS_MANAGER_PROMO_CONFIG_H_
