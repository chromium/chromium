...
#ifndef IOS_CHROME_BROWSER_MAIN_BROWSER_PROVIDER_INTERFACE_H_
#define IOS_CHROME_BROWSER_MAIN_BROWSER_PROVIDER_INTERFACE_H_
...
#endif  // IOS_CHROME_BROWSER_MAIN_BROWSER_PROVIDER_INTERFACE_H_
