...
#ifndef IOS_CHROME_BROWSER_SETTINGS_GOOGLE_SERVICES_TEST_GOOGLE_SERVICES_SETTINGS_APP_INTERFACE_H_
#define IOS_CHROME_BROWSER_SETTINGS_GOOGLE_SERVICES_TEST_GOOGLE_SERVICES_SETTINGS_APP_INTERFACE_H_
