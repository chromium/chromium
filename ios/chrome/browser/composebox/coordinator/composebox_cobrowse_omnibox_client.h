...
#ifndef IOS_CHROME_BROWSER_COMPOSEBOX_COORDINATOR_COMPOSEBOX_COBROWSE_OMNIBOX_CLIENT_H_
#define IOS_CHROME_BROWSER_COMPOSEBOX_COORDINATOR_COMPOSEBOX_COBROWSE_OMNIBOX_CLIENT_H_
...
class ComposeboxCobrowseOmniboxClient final : public OmniboxClient {
 public:
  ...
  ComposeboxCobrowseOmniboxClient(const ComposeboxCobrowseOmniboxClient&) =
      delete;
  ComposeboxCobrowseOmniboxClient& operator=(
      const ComposeboxCobrowseOmniboxClient&) = delete;
 ...
 private:
  ...
  base::WeakPtrFactory<ComposeboxCobrowseOmniboxClient> weak_factory_{this};
};

#endif  // IOS_CHROME_BROWSER_COMPOSEBOX_COORDINATOR_COMPOSEBOX_COBROWSE_OMNIBOX_CLIENT_H_
