...
#ifndef IOS_CHROME_BROWSER_SESSIONS_SESSION_IO_REQUEST_H_
#define IOS_CHROME_BROWSER_SESSIONS_SESSION_IO_REQUEST_H_
...
#endif  // IOS_CHROME_BROWSER_SESSIONS_SESSION_IO_REQUEST_H_
