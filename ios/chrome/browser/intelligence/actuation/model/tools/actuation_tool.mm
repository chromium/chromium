...
ActuationTool::TabResolutionResult::TabResolutionResult() = default;

ActuationTool::TabResolutionResult::TabResolutionResult(
    const TabResolutionResult&) = default;

ActuationTool::TabResolutionResult&
ActuationTool::TabResolutionResult::operator=(const TabResolutionResult&) =
    default;

ActuationTool::TabResolutionResult::~TabResolutionResult() = default;

// static
base::expected<ActuationTool::TabResolutionResult, ActuationError>
ActuationTool::ResolveTab(int32_t tab_id, ProfileIOS* profile) {
