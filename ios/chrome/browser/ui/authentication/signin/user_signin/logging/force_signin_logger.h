...
#ifndef IOS_CHROME_BROWSER_UI_AUTHENTICATION_SIGNIN_USER_SIGNIN_LOGGING_FORCE_SIGNIN_LOGGER_H_
...
@interface ForceSigninLogger : UserSigninLogger
...
#endif  // IOS_CHROME_BROWSER_UI_AUTHENTICATION_SIGNIN_USER_SIGNIN_LOGGING_FORCE_SIGNIN_LOGGER_H_
