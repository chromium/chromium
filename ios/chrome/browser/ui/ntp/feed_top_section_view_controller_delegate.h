...
#ifndef IOS_CHROME_BROWSER_UI_NTP_FEED_TOP_SECTION_VIEW_CONTROLLER_DELEGATE_H_
#define IOS_CHROME_BROWSER_UI_NTP_FEED_TOP_SECTION_VIEW_CONTROLLER_DELEGATE_H_
...
#endif  // IOS_CHROME_BROWSER_UI_NTP_FEED_TOP_SECTION_VIEW_CONTROLLER_DELEGATE_H_
