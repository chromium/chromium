...
#ifndef IOS_CHROME_BROWSER_UI_NTP_FEED_TOP_SECTION_CONSUMER_H_
#define IOS_CHROME_BROWSER_UI_NTP_FEED_TOP_SECTION_CONSUMER_H_
...
#endif  // IOS_CHROME_BROWSER_UI_NTP_FEED_TOP_SECTION_CONSUMER_H_
