...
#ifndef IOS_CHROME_BROWSER_UI_FIRST_RUN_LOCATION_PERMISSIONS_FIELD_TRIAL_H_
#define IOS_CHROME_BROWSER_UI_FIRST_RUN_LOCATION_PERMISSIONS_FIELD_TRIAL_H_
...
#endif  // IOS_CHROME_BROWSER_UI_FIRST_RUN_LOCATION_PERMISSIONS_FIELD_TRIAL_H_
