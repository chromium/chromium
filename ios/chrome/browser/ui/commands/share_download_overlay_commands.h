...
#ifndef IOS_CHROME_BROWSER_UI_COMMANDS_SHARE_DOWNLOAD_OVERLAY_COMMANDS_H_
#define IOS_CHROME_BROWSER_UI_COMMANDS_SHARE_DOWNLOAD_OVERLAY_COMMANDS_H_
...
#endif  // IOS_CHROME_BROWSER_UI_COMMANDS_SHARE_DOWNLOAD_OVERLAY_COMMANDS_H_
