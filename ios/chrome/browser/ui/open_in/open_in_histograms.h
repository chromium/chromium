...
#ifndef IOS_CHROME_BROWSER_UI_OPEN_IN_OPEN_IN_HISTOGRAMS_H_
#define IOS_CHROME_BROWSER_UI_OPEN_IN_OPEN_IN_HISTOGRAMS_H_
...
#endif  // IOS_CHROME_BROWSER_UI_OPEN_IN_OPEN_IN_HISTOGRAMS_H_
