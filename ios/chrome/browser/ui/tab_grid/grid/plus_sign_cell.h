...
#ifndef IOS_CHROME_BROWSER_UI_TAB_GRID_GRID_PLUS_SIGN_CELL_H_
#define IOS_CHROME_BROWSER_UI_TAB_GRID_GRID_PLUS_SIGN_CELL_H_
...
#endif  // IOS_CHROME_BROWSER_UI_TAB_GRID_GRID_PLUS_SIGN_CELL_H_
