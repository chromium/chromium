...
#ifndef IOS_CHROME_BROWSER_UI_WEBUI_USERDEFAULTS_INTERNALS_UI_H_
#define IOS_CHROME_BROWSER_UI_WEBUI_USERDEFAULTS_INTERNALS_UI_H_
...
#endif  // IOS_CHROME_BROWSER_UI_WEBUI_USERDEFAULTS_INTERNALS_UI_H_
