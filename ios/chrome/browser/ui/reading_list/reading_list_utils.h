...
// Adds `web_state` visible or canonical URL to reading list using `handler`.
// This function retrieves the canonical URL asynchronously first, and post
// the request when the result is fetched. It does nothing if the `handler`
// or the `web_state` are destroyed before the URL can be added to the list.
