...
using chrome_test_util::SettingsPriceNotificationsTableView;

// Integration tests using the Price Notifications settings screen.
@interface PriceNotificationsTestCase : ChromeTestCase
@end

@implementation PriceNotificationsTestCase
...
- (void)testPriceNotificationsSwipeDown {
  ...
  [[EarlGrey selectElementWithMatcher:SettingsPriceNotificationsTableView()]
