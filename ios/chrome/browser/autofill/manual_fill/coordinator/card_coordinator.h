...
#ifndef IOS_CHROME_BROWSER_AUTOFILL_MANUAL_FILL_COORDINATOR_CARD_COORDINATOR_H_
#define IOS_CHROME_BROWSER_AUTOFILL_MANUAL_FILL_COORDINATOR_CARD_COORDINATOR_H_
...
#endif  // IOS_CHROME_BROWSER_AUTOFILL_MANUAL_FILL_COORDINATOR_CARD_COORDINATOR_H_
