...
#ifndef IOS_CHROME_BROWSER_NTP_UI_BUNDLED_NEW_TAB_PROTOTYPE_VIEW_CONTROLLER_H_
#define IOS_CHROME_BROWSER_NTP_UI_BUNDLED_NEW_TAB_PROTOTYPE_VIEW_CONTROLLER_H_
...
#endif  // IOS_CHROME_BROWSER_NTP_UI_BUNDLED_NEW_TAB_PROTOTYPE_VIEW_CONTROLLER_H_
