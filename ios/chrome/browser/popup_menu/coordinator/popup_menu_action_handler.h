...
#ifndef IOS_CHROME_BROWSER_POPUP_MENU_COORDINATOR_POPUP_MENU_ACTION_HANDLER_H_
#define IOS_CHROME_BROWSER_POPUP_MENU_COORDINATOR_POPUP_MENU_ACTION_HANDLER_H_
...
#endif  // IOS_CHROME_BROWSER_POPUP_MENU_COORDINATOR_POPUP_MENU_ACTION_HANDLER_H_
