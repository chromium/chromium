...
#ifndef IOS_CHROME_BROWSER_POPUP_MENU_UI_POPUP_MENU_VIEW_CONTROLLER_H_
#define IOS_CHROME_BROWSER_POPUP_MENU_UI_POPUP_MENU_VIEW_CONTROLLER_H_
...
#endif  // IOS_CHROME_BROWSER_POPUP_MENU_UI_POPUP_MENU_VIEW_CONTROLLER_H_
