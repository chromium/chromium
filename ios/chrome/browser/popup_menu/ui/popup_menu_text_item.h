...
#ifndef IOS_CHROME_BROWSER_POPUP_MENU_UI_POPUP_MENU_TEXT_ITEM_H_
#define IOS_CHROME_BROWSER_POPUP_MENU_UI_POPUP_MENU_TEXT_ITEM_H_
...
#endif  // IOS_CHROME_BROWSER_POPUP_MENU_UI_POPUP_MENU_TEXT_ITEM_H_
