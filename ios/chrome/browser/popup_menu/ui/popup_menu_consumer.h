...
#ifndef IOS_CHROME_BROWSER_POPUP_MENU_UI_POPUP_MENU_CONSUMER_H_
#define IOS_CHROME_BROWSER_POPUP_MENU_UI_POPUP_MENU_CONSUMER_H_
...
#endif  // IOS_CHROME_BROWSER_POPUP_MENU_UI_POPUP_MENU_CONSUMER_H_
