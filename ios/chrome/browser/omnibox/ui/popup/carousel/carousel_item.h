...
#ifndef IOS_CHROME_BROWSER_OMNIBOX_UI_POPUP_CAROUSEL_CAROUSEL_ITEM_H_
#define IOS_CHROME_BROWSER_OMNIBOX_UI_POPUP_CAROUSEL_CAROUSEL_ITEM_H_
...
#endif  // IOS_CHROME_BROWSER_OMNIBOX_UI_POPUP_CAROUSEL_CAROUSEL_ITEM_H_
