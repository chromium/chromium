...
#ifndef IOS_CHROME_BROWSER_OMNIBOX_UI_BUNDLED_ZERO_SUGGEST_PREFETCH_HELPER_H_
#define IOS_CHROME_BROWSER_OMNIBOX_UI_BUNDLED_ZERO_SUGGEST_PREFETCH_HELPER_H_
...
#endif  // IOS_CHROME_BROWSER_OMNIBOX_UI_BUNDLED_ZERO_SUGGEST_PREFETCH_HELPER_H_
