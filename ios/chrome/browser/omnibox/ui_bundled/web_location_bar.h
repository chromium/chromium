...
#ifndef IOS_CHROME_BROWSER_OMNIBOX_UI_BUNDLED_WEB_LOCATION_BAR_H_
#define IOS_CHROME_BROWSER_OMNIBOX_UI_BUNDLED_WEB_LOCATION_BAR_H_
...
#endif  // IOS_CHROME_BROWSER_OMNIBOX_UI_BUNDLED_WEB_LOCATION_BAR_H_
