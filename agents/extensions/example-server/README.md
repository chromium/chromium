...
The [vpython spec][2] should include the following fastmcp package for version
1.9.4 and its dependencies (either as independent vpython.toml file or part of
inline PEP 723 script metadata like in [server.py][3]).
