...
TEST(AudioParameters, ShouldCheckIncorrectlySetChannels) {
  // Attempt to set the layout to stereo with 5 channels.
  ASSERT_DEATH(
      { ChannelLayoutConfig channel_layout_config(CHANNEL_LAYOUT_STEREO, 5); },
      "");
}
