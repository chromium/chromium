...
SOURCE_TYPE(HTTP_STREAM_POOL)
SOURCE_TYPE(HTTP_STREAM_POOL_JOB)
SOURCE_TYPE(HTTP_STREAM_POOL_GROUP)
SOURCE_TYPE(HTTP_STREAM_POOL_ATTEMPT_MANAGER)
SOURCE_TYPE(HTTP_STREAM_POOL_QUIC_ATTEMPT)
...
SOURCE_TYPE(CERT_VERIFIER_2QWAC_JOB)
...
SOURCE_TYPE(QUIC_SESSION_POOL_ASYNC_DNS_JOB)
...
SOURCE_TYPE(DNS_TRANSACTION_PLATFORM_ATTEMPT)
...
SOURCE_TYPE(PROXY_OVERRIDE_HOST_RESOLUTION)
SOURCE_TYPE(CANARY_DOMAIN_SERVICE)
SOURCE_TYPE(WEBSOCKET_CHANNEL)
SOURCE_TYPE(ENTERPRISE_PROXY_SERVICE)
