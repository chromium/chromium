...
public class StartupLoadingMetricsTest {
    ...
    private void assertHistogramsRecorded(int expectedCount, String histogramSuffix) {
        ...
        // Verify that the first nav commit (if it occurred) was registered as having occurred
        // post-foregrounding (otherwise the above metrics would not have been recorded).
        Assert.assertEquals(expectedCount,
