...
public class NavigationTransitionsTest {
    ...
    @Test
    @MediumTest
    @DisabledTest(message = "crbug.com/476505895")
    ...
    @Test
    @MediumTest
    public void testUnreleasedGestureDoesNotOutliveItsHandler() {
    ...
    @Test
    @MediumTest
    public void testUnreleasedGestureOnSameEdgeRestartsCleanly() {
        Assume.assumeTrue(mTestNavigationMode == NAVIGATION_MODE_THREE_BUTTON);
