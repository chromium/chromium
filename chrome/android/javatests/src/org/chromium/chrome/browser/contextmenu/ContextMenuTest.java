...
public class ContextMenuTest implements DownloadTestRule.CustomMainActivityStart {
    ...
    @Feature({"Browser", "ContextMenu"})
    @CommandLineFlags.Add({
        "enable-features=" + ChromeFeatureList.CONTEXT_MENU_GOOGLE_LENS_CHIP + "<FakeStudyName",
        "force-fieldtrials=FakeStudyName/Enabled",
        "force-fieldtrial-params=FakeStudyName.Enabled:orderShareImageBeforeLens/true"
    })
    @Restriction(UiRestriction.RESTRICTION_TYPE_PHONE)
    public void testContextMenuShareImageStillAddedWhenReordered() throws TimeoutException {
        LensUtils.setFakePassableLensEnvironmentForTesting(true);
    ...
    @Restriction(UiRestriction.RESTRICTION_TYPE_PHONE)
    public void testSearchImageWithGoogleLensAltText1MenuItemName() throws Throwable {
        Tab tab = mDownloadTestRule.getActivity().getActivityTab();
        ...
        String title = getMenuTitleFromItem(menu, R.id.contextmenu_search_with_google_lens);
        Assert.assertTrue(
                "Context menu item name should be \'Search image with Google\'.",
    ...
    @Restriction(UiRestriction.RESTRICTION_TYPE_PHONE)
    public void testSearchImageWithGoogleLensAltText2MenuItemName() throws Throwable {
        Tab tab = mDownloadTestRule.getActivity().getActivityTab();
        ...
        String title = getMenuTitleFromItem(menu, R.id.contextmenu_search_with_google_lens);
        Assert.assertTrue(
                "Context menu item name should be \'Search inside image with Google\'.",
