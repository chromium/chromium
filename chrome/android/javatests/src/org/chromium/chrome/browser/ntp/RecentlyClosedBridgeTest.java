...
public class RecentlyClosedBridgeTest {
    ...
    public void setUp() {
        ...
        mTabGroupModelFilter = (TabGroupModelFilter) mTabModelSelector.getTabModelFilterProvider()
    ...
    public void testOpenRecentlyClosedTab_FromBulkClosure_InNewTab() {
        ...
        // Close all tabs exits Chrome if not on the tab switcher.
    ...
    //
    // TODO(crbug.com/1307345): Add and modify tests for group & title restoration. Functionality
    // not yet added.
