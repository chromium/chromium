...
public class KeyboardAccessoryViewTest {
    ...
    @MediumTest
    @EnableFeatures(ChromeFeatureList.AUTOFILL_ANDROID_KEYBOARD_ACCESSORY_DYNAMIC_POSITIONING)
    public void testUndockedStyleWithDynamicPositioning_HiddenNotch() throws InterruptedException {
        final @Px int horizontalOffset = 10;
        final @Px int verticalOffset = 20;
        final @Px int maxWidth = 100;
        ...
        assertThrows(
                ...
                () -> {
                    KeyboardAccessoryStyle hiddenNotchStyle =
                            KeyboardAccessoryStyle.createUndockedKeyboardAccessoryStyle(
                                    horizontalOffset,
                                    verticalOffset,
                                    maxWidth,
                                    KeyboardAccessoryStyle.NotchPosition.HIDDEN);
                });
    }
