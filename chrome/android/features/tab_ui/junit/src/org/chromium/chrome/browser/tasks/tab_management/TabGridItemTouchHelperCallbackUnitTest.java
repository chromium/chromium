...
public class TabGridItemTouchHelperCallbackUnitTest {
    ...
    @Mock
    TabGridItemTouchHelperCallback.OnLongPressEventListener mOnLongPressEventListener;
    ...
    public void onLongPress_triggerTabSelectionEditor() {
        ...
        verify(mOnLongPressEventListener).onLongPressEvent(TAB1_ID);
    ...
    public void onLongPress_preventTriggerTabSelectionEditor() {
        ...
        verify(mOnLongPressEventListener, never()).onLongPressEvent(TAB1_ID);
        TabUiFeatureUtilities.ENABLE_TAB_SELECTION_EDITOR_V2_LONGPRESS_ENTRY.setForTesting(false);
    }
