...
class MessageCardViewBinder {
    public static void bind(PropertyModel model, ViewGroup view, PropertyKey propertyKey) {
        ...
        } else if (MessageCardViewProperties.LEFT_MARGIN_OVERRIDE == propertyKey) {
            itemView.setLeftMargin(model.get(MessageCardViewProperties.LEFT_MARGIN_OVERRIDE));
        } else if (MessageCardViewProperties.TOP_MARGIN_OVERRIDE == propertyKey) {
            itemView.setTopMargin(model.get(MessageCardViewProperties.TOP_MARGIN_OVERRIDE));
        } else if (MessageCardViewProperties.RIGHT_MARGIN_OVERRIDE == propertyKey) {
            itemView.setRightMargin(model.get(MessageCardViewProperties.RIGHT_MARGIN_OVERRIDE));
        } else if (MessageCardViewProperties.BOTTOM_MARGIN_OVERRIDE == propertyKey) {
            itemView.setBottomMargin(model.get(MessageCardViewProperties.BOTTOM_MARGIN_OVERRIDE));
        }
    }
