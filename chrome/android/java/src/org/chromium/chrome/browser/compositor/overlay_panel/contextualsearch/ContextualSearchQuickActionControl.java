...
public class ContextualSearchQuickActionControl extends ViewResourceInflater {
     ...
     * @param toolbarBackgroundColor The current toolbar background color. This may be used for icon
     *     tinting.
     */
     ...
     *
     * @param tab The current tab, used to load a URL if the quick action should open inside Chrome.
     */
    ...
    /**
     * @return The caption associated with the quick action or null if no quick action is available.
     */
    ...
    /**
     * @return The resource id for the icon associated with the quick action or 0 if no quick action
     *     is available.
     */
