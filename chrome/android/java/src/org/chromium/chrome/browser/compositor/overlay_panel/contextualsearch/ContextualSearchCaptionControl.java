...
package org.chromium.chrome.browser.compositor.overlay_panel.contextualsearch;
...
import org.chromium.chrome.browser.compositor.overlay_panel.OverlayPanelAnimation;
...
public class ContextualSearchCaptionControl extends OverlayPanelTextViewInflater {
    ...
    public ContextualSearchCaptionControl(
        ...
        super(
                ...
                ChromeFeatureList.sContextualPanelCloseButton.isEnabled()
    ...
    /**
     * Controls whether the caption is visible and can be rendered. The caption must be visible in
     * order to draw it and take a snapshot. Even though the caption is visible the user might not
     * be able to see it due to a completely transparent opacity associated with an animation
     * percentage of zero.
     *
