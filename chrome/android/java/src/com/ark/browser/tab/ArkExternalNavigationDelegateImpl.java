 ...
 */
public class ArkExternalNavigationDelegateImpl implements ExternalNavigationDelegate {
...
//    private final Supplier<TabModelSelector> mTabModelSelectorSupplier;
    ...
    public ArkExternalNavigationDelegateImpl(Tab tab) {
        mTab = tab;
//        mTabModelSelectorSupplier = TabModelSelectorSupplier.from(tab.getWindowAndroid());
    ...
    public static boolean isPackageSpecializedHandler(String packageName, Intent intent) {
        ...
        return !ExternalNavigationHandler
                        .getSpecializedHandlersWithFilter(handlers, packageName)
                        .isEmpty();
    }
