...
//import org.chromium.chrome.browser.tab.TabFaviconJni;
...
// */
//public class ArkTabFavicon extends TabWebContentsUserData {
//    private static final Class<ArkTabFavicon> USER_DATA_KEY = ArkTabFavicon.class;
//
...
//
//    public static ArkTabFavicon from(Tab tab) {
//        ArkTabFavicon favicon = get(tab);
//        if (favicon == null) {
//            favicon = tab.getUserDataHost().setUserData(USER_DATA_KEY, new ArkTabFavicon(tab));
//        }
//        return favicon;
//    }
//
//    private static ArkTabFavicon get(Tab tab) {
...
//        ArkTabFavicon tabFavicon = get(tab);
//        return tabFavicon != null ? tabFavicon.getFavicon() : null;
//    }
//
//    private ArkTabFavicon(Tab tab) {
//        super(tab);
//        mTab = (ArkTabImpl) tab;
...
//        mNativeTabFavicon = TabFaviconJni.get().init(ArkTabFavicon.this);
//    }
//
//    @Override
//    public void initWebContents(WebContents webContents) {
//        TabFaviconJni.get().setWebContents(mNativeTabFavicon, ArkTabFavicon.this, webContents);
//    }
//
//    @Override
//    public void cleanupWebContents(WebContents webContents) {
//        TabFaviconJni.get().resetWebContents(mNativeTabFavicon, ArkTabFavicon.this);
//    }
//
//    @Override
//    public void destroyInternal() {
//        TabFaviconJni.get().onDestroyed(mNativeTabFavicon, ArkTabFavicon.this);
//    }
//
//    /**
...
//        }
//
//        return TabFaviconJni.get().getFavicon(mNativeTabFavicon, ArkTabFavicon.this);
//    }
//
//    /**
