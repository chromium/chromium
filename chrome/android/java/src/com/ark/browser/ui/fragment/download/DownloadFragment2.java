...
public class DownloadFragment2 extends BaseSwipeBackFragment
    ...
    public static DownloadFragment2 newInstance(int index) {
        Bundle args = new Bundle();
        args.putInt(Keys.KEY_ID, index);
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            if (getArguments() != null) {
                mFilterIndex = getArguments().getInt(Keys.KEY_ID, 0);
            }
        } else {
            mFilterIndex = savedInstanceState.getInt(Keys.KEY_ID, 0);
        }
    }
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putInt(Keys.KEY_ID, mFilterIndex);
    }

    @Override
    protected int getLayoutId() {
        return R.layout.fragment_download3;
    }
    ...
    protected void initView(View view, @Nullable Bundle savedInstanceState) {
        ...
        toolbar.setNavigationOnClickListener(view13 -> pop());
...
//                updateStatus(holder, mission);
    ...
    private void updateStatus(EasyViewHolder holder, DownloadItem item) {
        ...
        Log.d(TAG, "updateStatus item=" + item);
    ...
    private List<FilterItem> getFilterItems() {
        ...
        items.add(new DownloadingTypeFilterItem());
...
//            context.grantUriPermission(context.getPackageName(), contentUri, Intent.FLAG_GRANT_READ_URI_PERMISSION | Intent.FLAG_GRANT_WRITE_URI_PERMISSION);
    ...
    static class AllTypeFilterItem extends FilterItem {
    ...
    static class DownloadingTypeFilterItem extends FilterItem {
    ...
    static class FinishedTypeFilterItem extends FilterItem {
        ...
        List<DownloadItem> filter(List<DownloadItem> items) {
            ...
            List<DownloadItem> filterItems = new ArrayList<>();
            for (DownloadItem item : items) {
                if (item.isComplete() && !item.isRemoved()) {
                    filterItems.add(item);
                }
            }
    ...
    static class RemovedTypeFilterItem extends FilterItem {
    ...
    static class FileTypeFilterItem extends FilterItem {
