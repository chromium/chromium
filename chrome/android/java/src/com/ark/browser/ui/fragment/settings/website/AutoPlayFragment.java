...
public class AutoPlayFragment extends BaseWebsiteListFragment {
//
//    @Override
//    protected String getSiteSettingsCategoryStr() {
//        return SiteSettingsCategory.CATEGORY_AUTOPLAY;
//    }
//
//    @Override
//    protected ContentSetting getContentSetting(Website website) {
//        return website.getAutoplayPermission();
//    }
//
//    @Override
//    protected void setContentSetting(Website website, ContentSetting contentSetting) {
//        website.setAutoplayPermission(contentSetting);
//    }

    @Override
    protected void initView(View view) {
        setToolbarTitle("自动播放权限");

        addSwitchItem(getString(R.string.text_autoplay),
