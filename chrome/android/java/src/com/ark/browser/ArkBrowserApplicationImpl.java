...
public class ArkBrowserApplicationImpl extends ChromeApplicationImpl {
    ...
    public static class CheckLayoutApplicator extends SkinViewApplicator {
        public CheckLayoutApplicator() {
            super();
            addAttributeApplicator("title_text_color", new IAttributeApplicator<CheckBoxItem>() {
                @Override
                public void onApply(CheckBoxItem view, TypedArray typedArray, int typedArrayIndex) {
            ...
            addAttributeApplicator("content_text_color", new IAttributeApplicator<CheckBoxItem>() {
                @Override
                public void onApply(CheckBoxItem view, TypedArray typedArray, int typedArrayIndex) {
