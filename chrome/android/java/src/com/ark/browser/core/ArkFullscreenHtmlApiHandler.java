 ...
 */
public class ArkFullscreenHtmlApiHandler implements ActivityStateListener, WindowFocusChangedListener,
    ...
    private static class FullscreenHandler extends Handler {
        private final WeakReference<ArkFullscreenHtmlApiHandler> mFullscreenHtmlApiHandler;

        public FullscreenHandler(ArkFullscreenHtmlApiHandler fullscreenHtmlApiHandler) {
            mFullscreenHtmlApiHandler = new WeakReference<ArkFullscreenHtmlApiHandler>(
        ...
        public void handleMessage(Message msg) {
            if (msg == null) return;
            ArkFullscreenHtmlApiHandler fullscreenHtmlApiHandler = mFullscreenHtmlApiHandler.get();
     ...
     */
    public ArkFullscreenHtmlApiHandler(Activity activity,
    ...
    public void onEnterFullscreen(Tab tab, FullscreenOptions options) {
        ...
        ArkLogger.e(TAG, "onEnterFullscreen isUserInteractable=" + tab.isUserInteractable()
                + " options=" + options);
    ...
    public void exitFullscreen() {
        ...
        setEnterFullscreenRunnable(mTab, null);
        exitPersistentFullscreenMode();
        for (Observer observer : mObservers) {
            observer.onExitFullscreen(mTab);
        }
    }
    ...
    Runnable getEnterFullscreenRunnable(Tab tab) {
    ...
    public void enterFullscreen(final Tab tab, FullscreenOptions options) {
        ...
        ArkLogger.e(TAG, "enterFullscreen, options=" + options);
        ...
        contentView.addOnLayoutChangeListener(mFullscreenOnLayoutChangeListener);
        ArkLogger.e(TAG, "enterFullscreen, systemUiVisibility=" + systemUiVisibility);
        contentView.setSystemUiVisibility(systemUiVisibility);
        mFullscreenOptions = options;
