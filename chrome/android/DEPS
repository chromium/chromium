include_rules = [
  ...
  # Restrict dependencies to xsurface by default (crbug.com/40144215)
  ...
  "+components/enterprise/browser/reporting/android",
  ...
  "+components/tabs/public/android",
...
specific_include_rules = {
  # Allow dependencies to xsurface from AppHooks only (crbug.com/40144215)
