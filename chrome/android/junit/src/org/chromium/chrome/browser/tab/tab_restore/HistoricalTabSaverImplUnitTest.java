...
public class HistoricalTabSaverImplUnitTest {
    ...
    public void testCreateHistoricalGroup_Empty() {
        HistoricalEntry group =
                new HistoricalEntry(0, new Token(1L, 2L), "Foo", Arrays.asList(new Tab[0]));
    ...
    public void testCreateHistoricalTab_FromGroup_WithoutTabGroupId() {
        ...
        HistoricalEntry group = new HistoricalEntry(0, null, "Foo", Arrays.asList(new Tab[] {tab}));
        mHistoricalTabSaver.createHistoricalTabOrGroup(group);
    ...
    public void testCreateHistoricalTab_FromGroup_WithTabGroupId() {
        ...
        HistoricalEntry group =
                new HistoricalEntry(0, new Token(1L, 2L), "Foo", Arrays.asList(new Tab[] {tab}));
        mHistoricalTabSaver.createHistoricalTabOrGroup(group);
    ...
    public void testCreateHistoricalGroup_FromBulk() {
        ...
        HistoricalEntry group = new HistoricalEntry(0, tabGroupId, "Foo", Arrays.asList(tabList));
    ...
    public void testCreateHistoricalTab_FromGroupWithIncognito_SingleTabGroupNotSupported() {
        ...
        Tab[] tabList = new Tab[] {tab0, tab1};
        HistoricalEntry group =
                new HistoricalEntry(0, new Token(1L, 2L), "Foo", Arrays.asList(tabList));
        mHistoricalTabSaver.createHistoricalTabOrGroup(group);
    ...
    public void testCreateHistoricalBulk_MixedWithInvalid() {
        ...
        entries.add(
                new HistoricalEntry(
                        1, tabGroupId1, "Group 1", Arrays.asList(new Tab[] {tab4, tab5, tab6})));
        entries.add(new HistoricalEntry(tab7));
        Token tabGroupId2 = new Token(347389L, 47893L);
        entries.add(
                new HistoricalEntry(
                        2, tabGroupId2, "Group 2", Arrays.asList(new Tab[] {tab8, tab9})));
        Token tabGroupId3 = new Token(289L, 7489L);
        entries.add(
                new HistoricalEntry(
                        3, tabGroupId3, "Group 3", Arrays.asList(new Tab[] {tab10, tab11})));
        mHistoricalTabSaver.createHistoricalBulkClosure(entries);
    ...
    public void testCreateHistoricalBulk_MixedWithInvalid_WithoutTabGroupIds() {
        ...
        entries.add(new HistoricalEntry(tab1));
        entries.add(
                new HistoricalEntry(0, null, "Incognito", Arrays.asList(new Tab[] {tab2, tab3})));
        entries.add(
                new HistoricalEntry(
                        1, null, "Group 1", Arrays.asList(new Tab[] {tab4, tab5, tab6})));
        entries.add(new HistoricalEntry(tab7));
        entries.add(new HistoricalEntry(2, null, "Group 2", Arrays.asList(new Tab[] {tab8, tab9})));
        entries.add(
                new HistoricalEntry(3, null, "Group 3", Arrays.asList(new Tab[] {tab10, tab11})));
        mHistoricalTabSaver.createHistoricalBulkClosure(entries);
