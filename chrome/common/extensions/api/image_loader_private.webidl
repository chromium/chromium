...
callback GetThumbnailCallback = undefined (DOMString thumbnailDataUrl);
...
interface ImageLoaderPrivate {
  ...
  static undefined getDriveThumbnail(DOMString url, boolean cropToSquare,
                                     GetThumbnailCallback callback);

  // For a local PDF file, retrieves its thumbnail with a given |width| and
  // |height|.
  static undefined getPdfThumbnail(DOMString url, long width, long height,
                                   GetThumbnailCallback callback);
  ...
  static undefined getArcDocumentsProviderThumbnail(
      DOMString url, long widthHint, long heightHint,
      GetThumbnailCallback callback);
};

partial interface Browser {
  static attribute ImageLoaderPrivate imageLoaderPrivate;
};
