...
#ifndef CHROME_UPDATER_LINUX_UPDATE_SERVICE_PROXY_H_
#define CHROME_UPDATER_LINUX_UPDATE_SERVICE_PROXY_H_
...
#endif  // CHROME_UPDATER_LINUX_UPDATE_SERVICE_PROXY_H_
