...
def parse_options():
    ...
    parser.add_option(
        '-o', '--output_file', help='Path to where we should output the script'
    )
    parser.add_option(
        '-v', '--version', help='Version of the application bundle being built.'
    )
    parser.add_option(
        '-p', '--product_full_name', help='Name of the product being built.'
    )
