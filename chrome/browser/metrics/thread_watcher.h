...
class ThreadWatcher {
 ...
 private:
  ...
  CheckedPtr<base::HistogramBase> response_time_histogram_;
  ...
  CheckedPtr<base::HistogramBase> unresponsive_time_histogram_;
  ...
  CheckedPtr<base::HistogramBase> responsive_count_histogram_;
  ...
  CheckedPtr<base::HistogramBase> unresponsive_count_histogram_;
