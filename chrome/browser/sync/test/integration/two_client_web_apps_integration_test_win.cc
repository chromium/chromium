...
IN_PROC_BROWSER_TEST_F(
    WebAppIntegration,
    WAI_InstallMenuStandalone_SwitchProfileClientsClient2_SwitchProfileClientsClient1_SyncTurnOff_UninstallFromOsStandalone_SwitchProfileClientsClient2) {
  // Test contents are generated by script. Please do not modify!
  // See `docs/webapps/why-is-this-test-failing.md` or
  // `docs/webapps/integration-testing-framework` for more info.
  // Gardeners: Disabling this test is supported.
...
IN_PROC_BROWSER_TEST_F(
    WebAppIntegration,
    WAI_InstallMenuStandalone_SwitchProfileClientsClient2_SyncTurnOff_SwitchProfileClientsClient1_UninstallFromOsStandalone_SyncTurnOn_SwitchProfileClientsClient2) {
  // Test contents are generated by script. Please do not modify!
  // See `docs/webapps/why-is-this-test-failing.md` or
  // `docs/webapps/integration-testing-framework` for more info.
  // Gardeners: Disabling this test is supported.
