...
class LoadingPredictorTabHelperTest : public ChromeRenderViewHostTestHarness {
 ...
 protected:
  ...
  CheckedPtr<StrictMock<MockLoadingDataCollector>> mock_collector_;
  // Owned elsewhere.
  CheckedPtr<NiceMock<MockOptimizationGuideKeyedService>>
      mock_optimization_guide_keyed_service_;
  // Owned by |web_contents()|.
  CheckedPtr<LoadingPredictorTabHelper> tab_helper_;
};
...
class LoadingPredictorTabHelperTestCollectorTest
 ...
 protected:
  CheckedPtr<TestLoadingDataCollector> test_collector_;
};
