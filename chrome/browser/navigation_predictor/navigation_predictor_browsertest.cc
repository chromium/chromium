...
IN_PROC_BROWSER_TEST_F(NavigationPredictorBrowserTest, SingleObserver) {
  ...
  EXPECT_THAT(
      ...
      ::testing::ElementsAre("https://google.com/", "https://example.com/"));
...
IN_PROC_BROWSER_TEST_F(NavigationPredictorBrowserTest, TwoObservers) {
  ...
  EXPECT_THAT(
      observer_1.last_prediction()->sorted_predicted_urls(),
      ::testing::ElementsAre("https://google.com/", "https://example.com/"));
  ...
  EXPECT_THAT(
      observer_2.last_prediction()->sorted_predicted_urls(),
      ::testing::ElementsAre("https://google.com/", "https://example.com/"));
}
