...
#include "chrome/browser/prefetch/prefetch_proxy/isolated_prerender_prefetch_metrics_collector.h"
...
class IsolatedPrerenderPrefetchMetricsCollectorTest
    : public ChromeRenderViewHostTestHarness {};

TEST_F(IsolatedPrerenderPrefetchMetricsCollectorTest, MainframesNotEligible) {
...
TEST_F(IsolatedPrerenderPrefetchMetricsCollectorTest,
...
TEST_F(IsolatedPrerenderPrefetchMetricsCollectorTest, NoResponseHead) {
  GURL mainframe_url("https://eligible.com");
...
TEST_F(IsolatedPrerenderPrefetchMetricsCollectorTest, NetError) {
  GURL mainframe_url("https://eligible.com");
...
TEST_F(IsolatedPrerenderPrefetchMetricsCollectorTest, ProbeResult) {
  GURL mainframe_url("https://eligible.com");

  const struct {
    IsolatedPrerenderProbeResult probe_result;
    int want_status;
  } kTestCases[] = {
      {IsolatedPrerenderProbeResult::kNoProbing, 0},
      {IsolatedPrerenderProbeResult::kDNSProbeSuccess, 1},
      {IsolatedPrerenderProbeResult::kTLSProbeSuccess, 1},
      {IsolatedPrerenderProbeResult::kDNSProbeFailure, 2},
      {IsolatedPrerenderProbeResult::kTLSProbeFailure, 2},
  };
...
TEST_F(IsolatedPrerenderPrefetchMetricsCollectorTest, SubresourceReused) {
  GURL mainframe_url("https://eligible.com");
...

  {
    ...
    collector->OnMainframeNavigationProbeResult(
        mainframe_url, IsolatedPrerenderProbeResult::kNoProbing);
...
TEST_F(IsolatedPrerenderPrefetchMetricsCollectorTest, TypicalUsage) {
  GURL mainframe_url("https://eligible.com");
  GURL subresource_url("https://subresource.com");
  GURL subresource_url2("https://subresource.com/2");
