...
class ActorFormFillingServiceImpl : public ActorFormFillingService,
 ...
 private:
  ...
  // Ensures that `this` is observing the `manager`.
  void ObserveManager(AutofillManager& manager);
  ...
  // Manages observations of `AutofillManager`s.
  ScopedAutofillManagersObservation managers_observation_{this};

  // Manages the recording of actor-related metrics.
  ActorKeyMetricsRecorder metrics_recorder_;
