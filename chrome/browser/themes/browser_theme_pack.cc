...
void BrowserThemePack::BuildFromColor(SkColor color, BrowserThemePack* pack) {
  ...
  pack->SetColor(TP::COLOR_FRAME, colors.frame_color);
  pack->SetColor(TP::COLOR_BACKGROUND_TAB, colors.frame_color);
  pack->SetColor(TP::COLOR_BACKGROUND_TAB_TEXT, colors.frame_text_color);
