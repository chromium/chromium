...
// APIs for desktop windowing (ui::Views) and theme image assets (custom theme
// backgrounds).
...
#if BUILDFLAG(ENABLE_EXTENSIONS)
  // Declared after |observers_|, because ThemeSyncableService removes itself
  // from the |observers_| list on destruction.
