...
#pragma pack(push,1)
  ...
  CheckedPtr<BrowserThemePackHeader> header_ = nullptr;
  ...
  CheckedPtr<TintEntry> tints_ = nullptr;

  struct ColorPair {
    int32_t id;
    SkColor color;
  };
  CheckedPtr<ColorPair> colors_ = nullptr;

  struct DisplayPropertyPair {
    int32_t id;
    int32_t property;
  };
  CheckedPtr<DisplayPropertyPair> display_properties_ = nullptr;

  // A list of included source images. A pointer to a -1 terminated array of
  // our persistent IDs.
  CheckedPtr<int> source_images_ = nullptr;
#pragma pack(pop)
