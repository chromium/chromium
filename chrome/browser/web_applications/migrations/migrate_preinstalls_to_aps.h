...
#ifndef CHROME_BROWSER_WEB_APPLICATIONS_MIGRATIONS_MIGRATE_PREINSTALLS_TO_APS_H_
#define CHROME_BROWSER_WEB_APPLICATIONS_MIGRATIONS_MIGRATE_PREINSTALLS_TO_APS_H_
...
#endif  // CHROME_BROWSER_WEB_APPLICATIONS_MIGRATIONS_MIGRATE_PREINSTALLS_TO_APS_H_
