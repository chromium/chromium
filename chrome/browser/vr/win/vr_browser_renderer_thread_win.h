...
class VR_EXPORT VRBrowserRendererThreadWin {
 ...
 private:
  ...
  CheckedPtr<InputDelegateWin> input_ = nullptr;
  CheckedPtr<GraphicsDelegateWin> graphics_ = nullptr;
  CheckedPtr<SchedulerDelegateWin> scheduler_ = nullptr;
  CheckedPtr<BrowserUiInterface> ui_ = nullptr;
  CheckedPtr<SchedulerUiInterface> scheduler_ui_ = nullptr;

  // Owned by vr_ui_host:
  CheckedPtr<device::mojom::XRCompositorHost> compositor_;
