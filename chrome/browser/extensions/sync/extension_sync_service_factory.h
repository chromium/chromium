...
#ifndef CHROME_BROWSER_EXTENSIONS_SYNC_EXTENSION_SYNC_SERVICE_FACTORY_H_
#define CHROME_BROWSER_EXTENSIONS_SYNC_EXTENSION_SYNC_SERVICE_FACTORY_H_
...
#endif  // CHROME_BROWSER_EXTENSIONS_SYNC_EXTENSION_SYNC_SERVICE_FACTORY_H_
