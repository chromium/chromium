...
#ifndef CHROME_BROWSER_EXTENSIONS_DESKTOP_ANDROID_DESKTOP_ANDROID_EXTENSION_APITEST_H_
#define CHROME_BROWSER_EXTENSIONS_DESKTOP_ANDROID_DESKTOP_ANDROID_EXTENSION_APITEST_H_
...
// TODO(https://401522580): Delete this file.
...
class DesktopAndroidExtensionApiTest : public ExtensionPlatformBrowserTest {
 public:
  struct RunOptions {
  ...
  explicit DesktopAndroidExtensionApiTest(
      ContextType context_type = ContextType::kNone);
  ~DesktopAndroidExtensionApiTest() override;
 ...
 protected:
  ...
  // All extensions tested by DesktopAndroidExtensionApiTest are in the
  // "api_test" dir.
...
#endif  // CHROME_BROWSER_EXTENSIONS_DESKTOP_ANDROID_DESKTOP_ANDROID_EXTENSION_APITEST_H_
