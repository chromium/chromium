...
#ifndef CHROME_BROWSER_EXTENSIONS_PENDING_EXTENSION_MANAGER_FACTORY_H_
#define CHROME_BROWSER_EXTENSIONS_PENDING_EXTENSION_MANAGER_FACTORY_H_
...
#endif  // CHROME_BROWSER_EXTENSIONS_PENDING_EXTENSION_MANAGER_FACTORY_H_
