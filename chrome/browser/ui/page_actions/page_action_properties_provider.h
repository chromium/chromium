...
#ifndef CHROME_BROWSER_UI_PAGE_ACTIONS_PAGE_ACTION_PROPERTIES_PROVIDER_H_
#define CHROME_BROWSER_UI_PAGE_ACTIONS_PAGE_ACTION_PROPERTIES_PROVIDER_H_
...
#endif  // CHROME_BROWSER_UI_PAGE_ACTIONS_PAGE_ACTION_PROPERTIES_PROVIDER_H_
