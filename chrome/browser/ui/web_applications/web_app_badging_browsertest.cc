...
class WebAppBadgingBrowserTest : public WebAppControllerBrowserTest {
 ...
 protected:
  ...
  CheckedPtr<RenderFrameHost> main_frame_;
  CheckedPtr<RenderFrameHost> sub_app_frame_;
  CheckedPtr<RenderFrameHost> in_scope_frame_;
  CheckedPtr<RenderFrameHost> cross_site_frame_;
 ...
 private:
  ...
  CheckedPtr<badging::TestBadgeManagerDelegate> delegate_;
