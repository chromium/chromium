...
DECLARE_ELEMENT_IDENTIFIER_VALUE(kAutofillAiErrorElementId);
DECLARE_ELEMENT_IDENTIFIER_VALUE(kAutofillAiFillElementId);
DECLARE_ELEMENT_IDENTIFIER_VALUE(kAutofillAiTriggerElementId);
