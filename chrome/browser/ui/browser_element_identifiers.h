...
DECLARE_ELEMENT_IDENTIFIER_VALUE(kPageInfoElementId);
DECLARE_ELEMENT_IDENTIFIER_VALUE(kPageInfoPermissionsElementId);
DECLARE_ELEMENT_IDENTIFIER_VALUE(kPasswordsOmniboxKeyIconElementId);
DECLARE_ELEMENT_IDENTIFIER_VALUE(kPermissionRequestChipElementId);
DECLARE_ELEMENT_IDENTIFIER_VALUE(kPermissionPromptBubbleElementId);
DECLARE_ELEMENT_IDENTIFIER_VALUE(kPermissionPromptAllowButtonElementId);
