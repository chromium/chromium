...
DECLARE_ELEMENT_IDENTIFIER_VALUE(kOrganizerPanelCloseButtonElementId);
DECLARE_ELEMENT_IDENTIFIER_VALUE(kOrganizerPanelControlsElementId);
DECLARE_ELEMENT_IDENTIFIER_VALUE(kOrganizerPanelElementId);
