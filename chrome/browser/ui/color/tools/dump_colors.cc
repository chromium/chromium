...
int main(int argc, const char* argv[]) {
  const auto add_mixers = [](ui::ColorProvider* provider, auto color_mode,
                             auto contrast_mode, auto system_theme) {
    ui::AddColorMixers(provider, color_mode, contrast_mode, system_theme);
    AddChromeColorMixers(provider, color_mode, contrast_mode, system_theme);
  };
