...
#ifndef CHROME_BROWSER_UI_AUTOFILL_AUTOFILL_SNACKBAR_VIEW_H_
#define CHROME_BROWSER_UI_AUTOFILL_AUTOFILL_SNACKBAR_VIEW_H_
...
#endif  // CHROME_BROWSER_UI_AUTOFILL_AUTOFILL_SNACKBAR_VIEW_H_
