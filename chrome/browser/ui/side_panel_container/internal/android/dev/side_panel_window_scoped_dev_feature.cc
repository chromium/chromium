...
#include "chrome/browser/ui/side_panel_container/internal/android/dev/side_panel_window_scoped_dev_feature.h"
...
void SidePanelWindowScopedDevFeature::Toggle() {
  auto* side_panel_ui = SidePanelUIProvider::From(browser_window_);
  CHECK(side_panel_ui);
