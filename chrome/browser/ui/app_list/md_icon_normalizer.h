...
#ifndef CHROME_BROWSER_UI_APP_LIST_MD_ICON_NORMALIZER_H_
#define CHROME_BROWSER_UI_APP_LIST_MD_ICON_NORMALIZER_H_
...
#endif  // CHROME_BROWSER_UI_APP_LIST_MD_ICON_NORMALIZER_H_
