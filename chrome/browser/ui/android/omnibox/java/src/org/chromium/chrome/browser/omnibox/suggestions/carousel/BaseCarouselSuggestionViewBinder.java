...
public final class BaseCarouselSuggestionViewBinder {
    ...
    static int getItemSpacingPx(
            @FormFactor int formFactor, int itemWidth, @NonNull Resources resources) {
        ...
        switch (formFactor) {
            case FormFactor.PHONE:
                ...
                // TODO(crbug/1490333): Update algorithm below to accommodate about X.5 of an item
                // view.
                // Currently attempts to accommodate exactly 4.5, which may not always fit on
                // screen.
                return Integer.max(
                        -resources.getDimensionPixelOffset(R.dimen.tile_view_padding),
                        (int) ((screenWidth - tileViewPortraitEdgePadding - itemWidth * 4.5) / 4));
