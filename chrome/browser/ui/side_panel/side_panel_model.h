...
#ifndef CHROME_BROWSER_UI_SIDE_PANEL_SIDE_PANEL_MODEL_H_
#define CHROME_BROWSER_UI_SIDE_PANEL_SIDE_PANEL_MODEL_H_
...
#endif  // CHROME_BROWSER_UI_SIDE_PANEL_SIDE_PANEL_MODEL_H_
