...
#ifndef CHROME_BROWSER_UI_SIDE_PANEL_ANDROID_SIDE_PANEL_COORDINATOR_ANDROID_H_
#define CHROME_BROWSER_UI_SIDE_PANEL_ANDROID_SIDE_PANEL_COORDINATOR_ANDROID_H_
...
#endif  // CHROME_BROWSER_UI_SIDE_PANEL_ANDROID_SIDE_PANEL_COORDINATOR_ANDROID_H_
