...
@NullMarked
final class WindowScopedSidePanelRegistryBridge implements ChromeAndroidTaskFeature {
    private static final String TAG = "WindowScopedSidePanelRegistryBridge";
    ...
    long createNativePtr(long nativeBrowserWindowPtr) {
        ...
        mNativeWindowScopedSidePanelRegistryBridge =
                WindowScopedSidePanelRegistryBridgeJni.get().create(this, nativeBrowserWindowPtr);
    ...
    void destroyNativePtr() {
        ...
        if (mNativeWindowScopedSidePanelRegistryBridge != 0) {
            WindowScopedSidePanelRegistryBridgeJni.get()
    ...
    interface Natives {
         ...
         */
        long create(WindowScopedSidePanelRegistryBridge caller, long nativeBrowserWindowPtr);
