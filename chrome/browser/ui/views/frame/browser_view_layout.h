...
class BrowserViewLayout : public views::LayoutManager {
 ...
 private:
  ...
  const CheckedPtr<views::View> left_aligned_side_panel_;
  const CheckedPtr<views::View> left_aligned_side_panel_separator_;
  const CheckedPtr<views::View> right_aligned_side_panel_;
  const CheckedPtr<views::View> right_aligned_side_panel_separator_;
