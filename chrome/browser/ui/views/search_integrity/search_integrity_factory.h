...
#ifndef CHROME_BROWSER_UI_VIEWS_SEARCH_INTEGRITY_SEARCH_INTEGRITY_FACTORY_H_
#define CHROME_BROWSER_UI_VIEWS_SEARCH_INTEGRITY_SEARCH_INTEGRITY_FACTORY_H_
...
#endif  // CHROME_BROWSER_UI_VIEWS_SEARCH_INTEGRITY_SEARCH_INTEGRITY_FACTORY_H_
