...
IN_PROC_BROWSER_TEST_F(FindInPageTest, MAYBE_SelectionRestoreOnTabSwitch) {
  ...
  // Select "de".
  ASSERT_TRUE(ui_test_utils::SendKeyPressSync(browser(), ui::VKEY_HOME, false,
                                              false, false, false));
...
IN_PROC_BROWSER_TEST_F(FindInPageTest, DISABLED_PasteWithoutTextChange) {
  ...
  ASSERT_TRUE(ui_test_utils::SendKeyPressSync(browser(), ui::VKEY_C, true,
                                              false, false, false));
  ...
  ASSERT_TRUE(ui_test_utils::SendKeyPressSync(browser(), ui::VKEY_V, true,
                                              false, false, false));
...
IN_PROC_BROWSER_TEST_F(FindInPageTest, MatchOrdinalStableWhileTyping) {
  ...
  ASSERT_TRUE(ui_test_utils::SendKeyPressSync(browser(), ui::VKEY_O, false,
                                              false, false, false));
  waiter2.Wait();
