...
IN_PROC_BROWSER_TEST_F(HomeButtonAccessibilityTest, LeftClickHome) {
  DEFINE_LOCAL_STATE_IDENTIFIER_VALUE(
      ui::test::PollingElementStateObserver<bool>,
      kToolbarHomeButtonElementZeroSize);
  ...
  RunTestSequence(
      ...
      PollElement(kToolbarHomeButtonElementZeroSize,
                  kToolbarHomeButtonElementId,
                  [](const ui::TrackedElement* el) {
                    return el->GetScreenBounds().IsEmpty();
                  }),
      WaitForState(kToolbarHomeButtonElementZeroSize, false),
      StopObservingState(kToolbarHomeButtonElementZeroSize),
