...
#ifndef CHROME_BROWSER_UI_VIEWS_AUTOFILL_DELETE_ADDRESS_PROFILE_DIALOG_VIEW_H_
#define CHROME_BROWSER_UI_VIEWS_AUTOFILL_DELETE_ADDRESS_PROFILE_DIALOG_VIEW_H_
