...
class PaymentsWindowUserConsentDialogBrowserTest
 ...
 protected:
  InteractiveBrowserTestApi::MultiStep TriggerDialogAndWait() {
    return Steps(TriggerDialog(),
                 WaitForShow(PaymentsWindowUserConsentDialogView::kTopViewId));
  }
...
IN_PROC_BROWSER_TEST_F(PaymentsWindowUserConsentDialogBrowserTest,
  ...
  RunTestSequence(TriggerDialogAndWait(),
