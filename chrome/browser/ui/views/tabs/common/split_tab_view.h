...
#ifndef CHROME_BROWSER_UI_VIEWS_TABS_COMMON_SPLIT_TAB_VIEW_H_
#define CHROME_BROWSER_UI_VIEWS_TABS_COMMON_SPLIT_TAB_VIEW_H_
...
class SplitTabView : public TabCollectionZOrderManager,
 ...
 public:
  ...
  explicit SplitTabView(TabCollectionNode* collection_node);
  SplitTabView(const SplitTabView&) = delete;
  SplitTabView& operator=(const SplitTabView&) = delete;
  ~SplitTabView() override;
...
#endif  // CHROME_BROWSER_UI_VIEWS_TABS_COMMON_SPLIT_TAB_VIEW_H_
