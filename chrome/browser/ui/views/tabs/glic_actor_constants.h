...
#ifndef CHROME_BROWSER_UI_VIEWS_TABS_GLIC_ACTOR_CONSTANTS_H_
#define CHROME_BROWSER_UI_VIEWS_TABS_GLIC_ACTOR_CONSTANTS_H_
...
#endif  // CHROME_BROWSER_UI_VIEWS_TABS_GLIC_ACTOR_CONSTANTS_H_
