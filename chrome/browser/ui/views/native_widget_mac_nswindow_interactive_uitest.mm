...
IN_PROC_BROWSER_TEST_F(NativeWidgetMacNSWindowInteractiveUITest,
  ...
  RunTestSequence(
      ...
      PollUntil([&]() { return [browser_window isKeyWindow]; },
      ...
      PollUntil([&]() { return [modal_window isKeyWindow]; },
...
IN_PROC_BROWSER_TEST_F(
  ...
  RunTestSequence(
      ...
      // Open two tabs
      AddInstrumentedTab(kTab2Id, GURL("about:blank")),
      ...
      PollUntil([&]() { return [modal_window2 isKeyWindow]; },
