...
1. If the dialog is called from code outside views, which most likely is, add a `Show<Name>Dialog` method signature to a dedicated header file `<name>_dialog.h`.
