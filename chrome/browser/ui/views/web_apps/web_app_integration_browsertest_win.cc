...
IN_PROC_BROWSER_TEST_F(
    WebAppIntegrationBrowserTestWin,
    WebAppIntegration_30SiteA_24_12SiteA_7SiteA_112SiteANotShown_87SiteA_15SiteA_37SiteA_18_19) {
  // Test contents are generated by script. Please do not modify!
  // See `chrome/test/webapps/README.md` for more info.
  // Sheriffs: Disabling this test is supported.
  helper_.InstallCreateShortcutWindowed(Site::kSiteA);
...
IN_PROC_BROWSER_TEST_F(
    WebAppIntegrationBrowserTestWin,
    WebAppIntegration_31SiteA_24_12SiteA_7SiteA_112SiteANotShown_87SiteA_15SiteA_37SiteA_18_19) {
  // Test contents are generated by script. Please do not modify!
  // See `chrome/test/webapps/README.md` for more info.
  // Sheriffs: Disabling this test is supported.
...
IN_PROC_BROWSER_TEST_F(
    WebAppIntegrationBrowserTestWin,
    WebAppIntegration_47SiteA_24_12SiteA_7SiteA_112SiteANotShown_87SiteA_15SiteA_37SiteA_18_19) {
  // Test contents are generated by script. Please do not modify!
  // See `chrome/test/webapps/README.md` for more info.
  // Sheriffs: Disabling this test is supported.
