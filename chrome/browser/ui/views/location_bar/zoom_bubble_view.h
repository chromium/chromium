...
class ZoomBubbleView : public LocationBarBubbleDelegateView,
 ...
 private:
  ...
  // "chrome://extensions".
  CheckedPtr<views::ImageButton> image_button_ = nullptr;

  // Label displaying the zoom percentage.
  CheckedPtr<views::Label> label_ = nullptr;

  // Action buttons that can change zoom.
  CheckedPtr<views::Button> zoom_out_button_ = nullptr;
  CheckedPtr<views::Button> zoom_in_button_ = nullptr;
  CheckedPtr<views::Button> reset_button_ = nullptr;

  // Virtual view used to announce zoom level changes.
  CheckedPtr<views::AXVirtualView> zoom_level_alert_ = nullptr;
  ...
  // |web_contents_|.
  // Not owned.
  CheckedPtr<ImmersiveModeController> immersive_mode_controller_;
