...
class LocationBarView : public LocationBar,
 ...
 private:
  ...
  CheckedPtr<PermissionChip> chip_ = nullptr;
  ...
  CheckedPtr<views::Label> ime_prefix_autocomplete_view_ = nullptr;
  CheckedPtr<views::Label> ime_inline_autocomplete_view_ = nullptr;
  ...
  CheckedPtr<views::Label> omnibox_additional_text_view_ = nullptr;
