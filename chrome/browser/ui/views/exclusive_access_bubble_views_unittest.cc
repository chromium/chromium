...
std::u16string GetInstructionText(UserGoal goal, Shortcut shortcut) {
...
class ExclusiveAccessBubbleViewsTest
 ...
 public:
  ...
  std::u16string GetInstructionText() {
...
// TODO(crbug.com/1459121): Reenable the test on Win once Aura supports
// fine-grained top-most window levels.
#if BUILDFLAG(IS_WIN)
...
TEST_P(ExclusiveAccessBubbleViewsTest, MAYBE_UpdateViewContent) {
  ...
  EXPECT_EQ(GetInstructionText(), test_case.text);
}
...
INSTANTIATE_TEST_SUITE_P(
    ...
    testing::ValuesIn<InstructionTextTestCase>({
        {"tabFullscreen",
         EXCLUSIVE_ACCESS_BUBBLE_TYPE_FULLSCREEN_EXIT_INSTRUCTION,
         GetInstructionText(UserGoal::kExitFullscreen, Shortcut::kPressEsc),
         false},
        ...
        {"pointerLock",
         ...
         GetInstructionText(UserGoal::kExitPointerLock, Shortcut::kPressEsc),
         false},
        {"tabFullscreenAndKeyboardLock",
         EXCLUSIVE_ACCESS_BUBBLE_TYPE_KEYBOARD_LOCK_EXIT_INSTRUCTION,
         GetInstructionText(UserGoal::kExitFullscreen,
                            Shortcut::kPressAndHoldEsc),
         false},
        {"browserFullscreen",
         EXCLUSIVE_ACCESS_BUBBLE_TYPE_BROWSER_FULLSCREEN_EXIT_INSTRUCTION,
         GetInstructionText(UserGoal::kExitFullscreen, Shortcut::kAccelerator),
         false},
        ...
        {"tabFullscreenSeeDownload",
         EXCLUSIVE_ACCESS_BUBBLE_TYPE_FULLSCREEN_EXIT_INSTRUCTION,
         GetInstructionText(UserGoal::kExitFullscreenAndSeeDownload,
                            Shortcut::kPressEsc),
         false, true},
        {"browserFullscreenSeeDownload",
         EXCLUSIVE_ACCESS_BUBBLE_TYPE_BROWSER_FULLSCREEN_EXIT_INSTRUCTION,
         GetInstructionText(UserGoal::kExitFullscreenAndSeeDownload,
                            Shortcut::kAccelerator),
         false, true},
