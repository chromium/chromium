...
// PaymentRequestProfileListTest, but with basic-card disabled. Parameterized
// tests are not used because the test setup for both tests are too different.
class PaymentRequestProfileListBasicCardDisabledTest
    : public PaymentRequestBrowserTestBase {
 protected:
  PaymentRequestProfileListBasicCardDisabledTest() {
...
IN_PROC_BROWSER_TEST_F(PaymentRequestProfileListBasicCardDisabledTest,
