...
// too different.
class PaymentRequestShippingOptionViewControllerBasicCardDisabledTest
    : public PaymentRequestBrowserTestBase {
 public:
  PaymentRequestShippingOptionViewControllerBasicCardDisabledTest(
      const PaymentRequestShippingOptionViewControllerBasicCardDisabledTest&) =
      delete;
  PaymentRequestShippingOptionViewControllerBasicCardDisabledTest& operator=(
      const PaymentRequestShippingOptionViewControllerBasicCardDisabledTest&) =
      delete;
