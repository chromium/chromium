...
VerticalTabStripStateControllerImpl::VerticalTabStripStateControllerImpl(
    ...
    : VerticalTabStripStateController(browser_window),
  ...
  // accordingly.
  did_become_active_subscription_ =
      browser_window_->RegisterDidBecomeActive(base::BindRepeating(
          &VerticalTabStripStateControllerImpl::OnDidBecomeActive,
          base::Unretained(this)));
  ...
  if (base::SequencedTaskRunner::HasCurrentDefault()) {
    expand_on_hover_iph_collapse_timer_.Start(
        ...
        base::BindOnce(
            &VerticalTabStripStateControllerImpl::MaybeShowExpandOnHoverIPH,
            base::Unretained(this)));
  }
}
...
class VerticalTabStripStateControllerImpl::ScopedEnableStateLockImpl
    : public VerticalTabStripStateController::ScopedEnableStateLock {
 public:
  explicit ScopedEnableStateLockImpl(
      VerticalTabStripStateControllerImpl& controller)
      : controller_(controller) {
    controller_->OnLockCreated();
  }

  ~ScopedEnableStateLockImpl() override { controller_->OnLockDestroyed(); }

 private:
  const raw_ref<VerticalTabStripStateControllerImpl> controller_;
};

std::unique_ptr<VerticalTabStripStateControllerImpl::ScopedEnableStateLock>
VerticalTabStripStateControllerImpl::GetEnableStateLock() {
  return std::make_unique<ScopedEnableStateLockImpl>(*this);
}

void VerticalTabStripStateControllerImpl::SetDelegate(Delegate* delegate) {
  delegate_ = delegate;
  if (delegate_) {
    delegate_->SetCollapsedStateUpdatedCallback(
        base::BindRepeating(&VerticalTabStripStateControllerImpl::SetCollapsed,
                            base::Unretained(this)));
  }
}

bool VerticalTabStripStateControllerImpl::ShouldDisplayVerticalTabs() const {
  return is_vertical_tabs_enabled_;
}

void VerticalTabStripStateControllerImpl::SetVerticalTabsEnabled(bool enabled) {
...
bool VerticalTabStripStateControllerImpl::IsCollapsed() const {
  return state_.collapsed;
}

VerticalTabStripCollapseState
VerticalTabStripStateControllerImpl::GetCollapseState() const {
  if (IsCollapsed()) {
...
void VerticalTabStripStateControllerImpl::RequestCollapse(bool collapse) {
  if (!delegate_) {
    return;
  }
...
int VerticalTabStripStateControllerImpl::GetUncollapsedWidth() const {
  return state_.uncollapsed_width;
}

void VerticalTabStripStateControllerImpl::SetUncollapsedWidth(int width) {
...
bool VerticalTabStripStateControllerImpl::IsExpandOnHoverEnabled() const {
  return is_expand_on_hover_enabled_;
}

void VerticalTabStripStateControllerImpl::SetExpandOnHoverEnabled(
    bool enabled) {
  pref_service_->SetBoolean(prefs::kVerticalTabsExpandOnHoverEnabled, enabled);
}

bool VerticalTabStripStateControllerImpl::IsResizing() const {
  return is_resizing_;
}

void VerticalTabStripStateControllerImpl::SetIsResizing(bool is_resizing) {
  if (is_resizing_ == is_resizing) {
    return;
  }
  is_resizing_ = is_resizing;
  NotifyResizingChanged(is_resizing_);
}

const VerticalTabStripState& VerticalTabStripStateControllerImpl::GetState()
    const {
  return state_;
}

void VerticalTabStripStateControllerImpl::NotifyCollapseChanged() {
  VerticalTabStripStateController::NotifyCollapseChanged(GetCollapseState());
  UpdateCollapseActionItem();
  UpdateSessionService();
  UpdatePrefService();
}

void VerticalTabStripStateControllerImpl::OnModeChanged() {
...
void VerticalTabStripStateControllerImpl::OnExpandOnHoverEnabledChanged() {
  is_expand_on_hover_enabled_ =
      pref_service_->GetBoolean(prefs::kVerticalTabsExpandOnHoverEnabled);
  ...
  NotifyExpandOnHoverEnabledChanged(is_expand_on_hover_enabled_);
}

void VerticalTabStripStateControllerImpl::SetCollapsed(bool collapsed) {
...
void VerticalTabStripStateControllerImpl::OnLockCreated() {
  enable_state_lock_count_++;
}

void VerticalTabStripStateControllerImpl::OnLockDestroyed() {
...
void VerticalTabStripStateControllerImpl::UpdateSessionService() {
...
void VerticalTabStripStateControllerImpl::UpdatePrefService() {
  if (pref_service_) {
...
void VerticalTabStripStateControllerImpl::UpdateCollapseActionItem() {
...
void VerticalTabStripStateControllerImpl::OnDidBecomeActive(
    BrowserWindowInterface* browser) {
  UpdatePrefService();
}

void VerticalTabStripStateControllerImpl::OnDestroying(
...
void VerticalTabStripStateControllerImpl::OnBrowserCreated(
    BrowserWindowInterface* browser) {
...
void VerticalTabStripStateControllerImpl::MaybeShowDelayedToast(
    bool new_enabled) {
