...
#ifndef CHROME_BROWSER_UI_ASH_LOBSTER_LOBSTER_CLIENT_FACTORY_IMPL_H_
#define CHROME_BROWSER_UI_ASH_LOBSTER_LOBSTER_CLIENT_FACTORY_IMPL_H_
...
#endif  // CHROME_BROWSER_UI_ASH_LOBSTER_LOBSTER_CLIENT_FACTORY_IMPL_H_
