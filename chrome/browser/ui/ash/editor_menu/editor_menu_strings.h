...
#ifndef CHROME_BROWSER_UI_ASH_EDITOR_MENU_EDITOR_MENU_STRINGS_H_
#define CHROME_BROWSER_UI_ASH_EDITOR_MENU_EDITOR_MENU_STRINGS_H_
...
std::u16string GetEditorMenuFreeformPromptInputFieldPlaceholderForHelpMeWrite();
...
#endif  // CHROME_BROWSER_UI_ASH_EDITOR_MENU_EDITOR_MENU_STRINGS_H_
