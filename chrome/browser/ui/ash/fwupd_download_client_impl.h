...
#ifndef CHROME_BROWSER_UI_ASH_FWUPD_DOWNLOAD_CLIENT_IMPL_H_
#define CHROME_BROWSER_UI_ASH_FWUPD_DOWNLOAD_CLIENT_IMPL_H_
...
#endif  // CHROME_BROWSER_UI_ASH_FWUPD_DOWNLOAD_CLIENT_IMPL_H_
