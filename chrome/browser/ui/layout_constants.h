...
// TODO(agale): Make this an enum class once all uses are migrated.
enum LayoutConstant {
  ...
  kVerticalTabStripUncollapsedHorizontalPadding,
  ...
  // TODO(agale): Remove the following values once all callers are updated.
  // These exist temporarily for backwards compatibility.
