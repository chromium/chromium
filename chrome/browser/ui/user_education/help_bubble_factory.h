...
#ifndef CHROME_BROWSER_UI_USER_EDUCATION_HELP_BUBBLE_FACTORY_H_
#define CHROME_BROWSER_UI_USER_EDUCATION_HELP_BUBBLE_FACTORY_H_
...
#endif  // CHROME_BROWSER_UI_USER_EDUCATION_HELP_BUBBLE_FACTORY_H_
