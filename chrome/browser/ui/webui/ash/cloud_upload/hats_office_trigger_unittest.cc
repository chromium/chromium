...
class HatsOfficeTriggerTest : public testing::Test {
 public:
  ...
  void TearDown() override {
    ...
    profile_ = nullptr;
    test_profile_manager_.DeleteTestingProfile("test-user@example.com");
  }
...
TEST_F(HatsOfficeTriggerTest, ShowSurveySuccess) {
  ...
  hats_office_trigger_.ShowSurveyAfterDelay(HatsOfficeGroup::kQuickOffice);
...
TEST_F(HatsOfficeTriggerTest, ShowSurveyOnlyOnce) {
  ...
  hats_office_trigger_.ShowSurveyAfterDelay(
      HatsOfficeGroup::kQuickOfficeClippyOff);
  ...
  hats_office_trigger_.ShowSurveyAfterDelay(HatsOfficeGroup::kDrive);
...
TEST_F(HatsOfficeTriggerTest, NoActiveProfile) {
  ...
  hats_office_trigger_.ShowSurveyAfterDelay(HatsOfficeGroup::kMS365);
