...
#ifndef CHROME_BROWSER_UI_WEBUI_ASH_CLOUD_UPLOAD_ODFS_SKYVAULT_UPLOADER_H_
#define CHROME_BROWSER_UI_WEBUI_ASH_CLOUD_UPLOAD_ODFS_SKYVAULT_UPLOADER_H_
...
#endif  // CHROME_BROWSER_UI_WEBUI_ASH_CLOUD_UPLOAD_ODFS_SKYVAULT_UPLOADER_H_
