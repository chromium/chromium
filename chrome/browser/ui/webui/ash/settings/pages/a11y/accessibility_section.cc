...
void AccessibilitySection::AddLoadTimeData(
  ...
  webui::LocalizedString kLocalizedStrings[] = {
      ...
      {"faceGazeConflictingGesturesSingleLabel",
       IDS_OS_SETTINGS_ACCESSIBILITY_FACEGAZE_CONFLICTING_GESTURES_SINGLE_LABEL},
      {"faceGazeConflictingGesturesDoubleLabel",
       IDS_OS_SETTINGS_ACCESSIBILITY_FACEGAZE_CONFLICTING_GESTURES_DOUBLE_LABEL},
      {"faceGazeConflictingGesturesTripleLabel",
       IDS_OS_SETTINGS_ACCESSIBILITY_FACEGAZE_CONFLICTING_GESTURES_TRIPLE_LABEL},
