...
class EmojiObserver : public ui::InputMethodObserver {
 public:
  explicit EmojiObserver(const std::string emojiToInsert, ui::InputMethod* ime)
      : emoji_to_insert_(emojiToInsert), ime_(ime) {
    deleteTimer.Start(
  ...
  void OnTextInputStateChanged(const ui::TextInputClient* client) override {
    ...
    // focusing in the new text field.  I would have expected this to fail if
