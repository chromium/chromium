...
class SafetyCheckHandler
 ...
 private:
  ...
  CheckedPtr<password_manager::BulkLeakCheckServiceInterface> leak_service_ =
      nullptr;
  CheckedPtr<password_manager::InsecureCredentialsManager>
      insecure_credentials_manager_ = nullptr;
  CheckedPtr<extensions::PasswordsPrivateDelegate> passwords_delegate_ =
      nullptr;
  CheckedPtr<extensions::ExtensionPrefs> extension_prefs_ = nullptr;
