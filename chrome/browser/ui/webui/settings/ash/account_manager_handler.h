...
#ifndef CHROME_BROWSER_UI_WEBUI_SETTINGS_ASH_ACCOUNT_MANAGER_HANDLER_H_
#define CHROME_BROWSER_UI_WEBUI_SETTINGS_ASH_ACCOUNT_MANAGER_HANDLER_H_
...
#endif  // CHROME_BROWSER_UI_WEBUI_SETTINGS_ASH_ACCOUNT_MANAGER_HANDLER_H_
