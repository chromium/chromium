...
class TestFaviconSource : public FaviconSource {
 ...
 private:
  const CheckedPtr<ui::NativeTheme> theme_;
};
...
class FaviconSourceTestBase : public testing::Test {
 ...
 protected:
  ...
  CheckedPtr<NiceMock<MockHistoryUiFaviconRequestHandler>>
      mock_history_ui_favicon_request_handler_;
  CheckedPtr<NiceMock<favicon::MockFaviconService>> mock_favicon_service_;
