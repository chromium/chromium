...
void CustomizeChromePageHandler::SetDefaultColor() {
  // As long as a GM2 theme was set before, it will need to be
  // reset using UseDefaultTheme in order for the new way of setting
  // theme to take affect.
...
void CustomizeChromePageHandler::SetGreyDefaultColor() {
  // As long as a GM2 theme was set before, it will need to be
  // reset using UseDefaultTheme in order for the new way of setting
  // theme to take affect.
...
void CustomizeChromePageHandler::SetSeedColor(SkColor seed_color) {
  if (features::IsChromeWebuiRefresh2023()) {
    // Delete any GM2 theme that the user has, since it will override
    // the GM3 theme.
    theme_service_->SetUserColor(seed_color);
    theme_service_->UseDefaultTheme();
    theme_service_->SetIsGrayscale(false);
  } else {
