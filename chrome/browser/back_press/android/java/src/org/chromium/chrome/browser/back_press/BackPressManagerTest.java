...
public class BackPressManagerTest {
    ...
    public void testFailedHandlers() {
        BackPressManager manager = new BackPressManager();
        var textBubbleFailedHandler = new FailedBackPressHandler();
        var arSuccessHandler = new EmptyBackPressHandler();
    ...
    public void testRecordSwipeEdge() {
        ...
        backEvent = new BackEventCompat(0, 0, 0, BackEventCompat.EDGE_RIGHT);
        manager.getCallback().handleOnBackStarted(backEvent);
    ...
    public void testEscapeUsageTrue() {
        BackPressManager manager = new BackPressManager();
        EscModifyingBackPressHandler h1 = new EscModifyingBackPressHandler(true);
    ...
    public void testEscapeUsageFalse() {
        BackPressManager manager = new BackPressManager();
        EscModifyingBackPressHandler h1 = new EscModifyingBackPressHandler(false);
    ...
    public void testEscapeUsageFallthrough() {
        ...
        EscModifyingBackPressHandler h1 = new EscModifyingBackPressHandler(false);
        FailedBackPressHandler h2 = new FailedBackPressHandler();
        EmptyBackPressHandler h3 = new EmptyBackPressHandler();
        EscModifyingBackPressHandler h4 = new EscModifyingBackPressHandler(true);
    ...
    public void testEscapePressesDoNotUseFallback() {
        ...
        EscModifyingBackPressHandler h1 = new EscModifyingBackPressHandler(false);
        EscModifyingBackPressHandler h2 = new EscModifyingBackPressHandler(null);
