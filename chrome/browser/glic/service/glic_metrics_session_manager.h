...
#ifndef CHROME_BROWSER_GLIC_SERVICE_GLIC_METRICS_SESSION_MANAGER_H_
#define CHROME_BROWSER_GLIC_SERVICE_GLIC_METRICS_SESSION_MANAGER_H_
...
#endif  // CHROME_BROWSER_GLIC_SERVICE_GLIC_METRICS_SESSION_MANAGER_H_
