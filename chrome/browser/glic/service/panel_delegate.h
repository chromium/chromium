...
#ifndef CHROME_BROWSER_GLIC_SERVICE_PANEL_DELEGATE_H_
#define CHROME_BROWSER_GLIC_SERVICE_PANEL_DELEGATE_H_
...
#endif  // CHROME_BROWSER_GLIC_SERVICE_PANEL_DELEGATE_H_
