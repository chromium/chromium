...
#ifndef CHROME_BROWSER_GLIC_GLIC_VECTOR_ICON_MANAGER_H_
#define CHROME_BROWSER_GLIC_GLIC_VECTOR_ICON_MANAGER_H_
...
#endif  // CHROME_BROWSER_GLIC_GLIC_VECTOR_ICON_MANAGER_H_
