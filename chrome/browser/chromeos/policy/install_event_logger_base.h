...
#ifndef CHROME_BROWSER_CHROMEOS_POLICY_INSTALL_EVENT_LOGGER_BASE_H_
#define CHROME_BROWSER_CHROMEOS_POLICY_INSTALL_EVENT_LOGGER_BASE_H_
...
class InstallEventLoggerBase {
 public:
  InstallEventLoggerBase(Profile* profile) : profile_(profile) {
...
#endif  // CHROME_BROWSER_CHROMEOS_POLICY_INSTALL_EVENT_LOGGER_BASE_H_
