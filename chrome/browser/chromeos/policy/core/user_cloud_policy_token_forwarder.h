...
#ifndef CHROME_BROWSER_CHROMEOS_POLICY_CORE_USER_CLOUD_POLICY_TOKEN_FORWARDER_H_
#define CHROME_BROWSER_CHROMEOS_POLICY_CORE_USER_CLOUD_POLICY_TOKEN_FORWARDER_H_
...
#endif  // CHROME_BROWSER_CHROMEOS_POLICY_CORE_USER_CLOUD_POLICY_TOKEN_FORWARDER_H_
