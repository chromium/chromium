...
#ifndef CHROME_BROWSER_CHROMEOS_POLICY_CORE_DEVICE_LOCAL_ACCOUNT_POLICY_STORE_H_
#define CHROME_BROWSER_CHROMEOS_POLICY_CORE_DEVICE_LOCAL_ACCOUNT_POLICY_STORE_H_
...
#endif  // CHROME_BROWSER_CHROMEOS_POLICY_CORE_DEVICE_LOCAL_ACCOUNT_POLICY_STORE_H_
