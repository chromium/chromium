...
#ifndef CHROME_BROWSER_CHROMEOS_POLICY_CORE_DEVICE_POLICY_REMOVER_H_
#define CHROME_BROWSER_CHROMEOS_POLICY_CORE_DEVICE_POLICY_REMOVER_H_
...
#endif  // CHROME_BROWSER_CHROMEOS_POLICY_CORE_DEVICE_POLICY_REMOVER_H_
