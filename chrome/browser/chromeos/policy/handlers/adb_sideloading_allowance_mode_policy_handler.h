...
#ifndef CHROME_BROWSER_CHROMEOS_POLICY_HANDLERS_ADB_SIDELOADING_ALLOWANCE_MODE_POLICY_HANDLER_H_
...
#endif  // CHROME_BROWSER_CHROMEOS_POLICY_HANDLERS_ADB_SIDELOADING_ALLOWANCE_MODE_POLICY_HANDLER_H_
