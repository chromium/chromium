...
#ifndef CHROME_BROWSER_CHROMEOS_POLICY_HANDLERS_DEVICE_DOCK_MAC_ADDRESS_SOURCE_HANDLER_H_
...
#endif  // CHROME_BROWSER_CHROMEOS_POLICY_HANDLERS_DEVICE_DOCK_MAC_ADDRESS_SOURCE_HANDLER_H_
