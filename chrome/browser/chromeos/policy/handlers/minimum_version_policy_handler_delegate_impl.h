...
#ifndef CHROME_BROWSER_CHROMEOS_POLICY_HANDLERS_MINIMUM_VERSION_POLICY_HANDLER_DELEGATE_IMPL_H_
...
#endif  // CHROME_BROWSER_CHROMEOS_POLICY_HANDLERS_MINIMUM_VERSION_POLICY_HANDLER_DELEGATE_IMPL_H_
