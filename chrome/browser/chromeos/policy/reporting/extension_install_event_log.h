...
#ifndef CHROME_BROWSER_CHROMEOS_POLICY_REPORTING_EXTENSION_INSTALL_EVENT_LOG_H_
#define CHROME_BROWSER_CHROMEOS_POLICY_REPORTING_EXTENSION_INSTALL_EVENT_LOG_H_

#include "chrome/browser/chromeos/policy/reporting/install_event_log.h"
...
#endif  // CHROME_BROWSER_CHROMEOS_POLICY_REPORTING_EXTENSION_INSTALL_EVENT_LOG_H_
