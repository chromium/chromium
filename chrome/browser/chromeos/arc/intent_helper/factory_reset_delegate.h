...
#ifndef CHROME_BROWSER_CHROMEOS_ARC_INTENT_HELPER_FACTORY_RESET_DELEGATE_H_
#define CHROME_BROWSER_CHROMEOS_ARC_INTENT_HELPER_FACTORY_RESET_DELEGATE_H_
...
#endif  // CHROME_BROWSER_CHROMEOS_ARC_INTENT_HELPER_FACTORY_RESET_DELEGATE_H_
