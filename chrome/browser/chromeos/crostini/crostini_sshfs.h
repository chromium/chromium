...
#ifndef CHROME_BROWSER_CHROMEOS_CROSTINI_CROSTINI_SSHFS_H_
#define CHROME_BROWSER_CHROMEOS_CROSTINI_CROSTINI_SSHFS_H_
...
#endif  // CHROME_BROWSER_CHROMEOS_CROSTINI_CROSTINI_SSHFS_H_
