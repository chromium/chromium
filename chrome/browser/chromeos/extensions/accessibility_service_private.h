...
#ifndef CHROME_BROWSER_CHROMEOS_EXTENSIONS_ACCESSIBILITY_SERVICE_PRIVATE_H_
#define CHROME_BROWSER_CHROMEOS_EXTENSIONS_ACCESSIBILITY_SERVICE_PRIVATE_H_
...
#endif  // CHROME_BROWSER_CHROMEOS_EXTENSIONS_ACCESSIBILITY_SERVICE_PRIVATE_H_
