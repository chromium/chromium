...
#ifndef CHROME_BROWSER_CHROMEOS_EXTENSIONS_TELEMETRY_API_REMOTE_PROBE_SERVICE_STRATEGY_H_
...
#endif  // CHROME_BROWSER_CHROMEOS_EXTENSIONS_TELEMETRY_API_REMOTE_PROBE_SERVICE_STRATEGY_H_
