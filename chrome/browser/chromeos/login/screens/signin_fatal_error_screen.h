...
#ifndef CHROME_BROWSER_CHROMEOS_LOGIN_SCREENS_SIGNIN_FATAL_ERROR_SCREEN_H_
#define CHROME_BROWSER_CHROMEOS_LOGIN_SCREENS_SIGNIN_FATAL_ERROR_SCREEN_H_
...
#endif  // CHROME_BROWSER_CHROMEOS_LOGIN_SCREENS_SIGNIN_FATAL_ERROR_SCREEN_H_