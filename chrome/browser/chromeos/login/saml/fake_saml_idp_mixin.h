...
#ifndef CHROME_BROWSER_CHROMEOS_LOGIN_SAML_FAKE_SAML_IDP_MIXIN_H_
#define CHROME_BROWSER_CHROMEOS_LOGIN_SAML_FAKE_SAML_IDP_MIXIN_H_
...
#endif  // CHROME_BROWSER_CHROMEOS_LOGIN_SAML_FAKE_SAML_IDP_MIXIN_H_