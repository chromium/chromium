...
#ifndef CHROME_BROWSER_CHROMEOS_TELEMETRY_FAKE_PROBE_SERVICE_H_
#define CHROME_BROWSER_CHROMEOS_TELEMETRY_FAKE_PROBE_SERVICE_H_
...
#endif  // CHROME_BROWSER_CHROMEOS_TELEMETRY_FAKE_PROBE_SERVICE_H_
