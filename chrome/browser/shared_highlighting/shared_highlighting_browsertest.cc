...
SharedHighlightingBrowserTest::SharedHighlightingBrowserTest() {
  html_content_ = R"HTML(
    <!DOCTYPE html>
    <style>
      body {
        height: 2200px;
...
IN_PROC_BROWSER_TEST_F(SharedHighlightingBrowserTest, LinkGenerationTest) {
  // Load the URL.
