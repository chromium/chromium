...
/** Tests for {@link SimpleNoticeSheetView} */
@RunWith(ChromeJUnit4ClassRunner.class)
@Batch(Batch.PER_CLASS)
@CommandLineFlags.Add({ChromeSwitches.DISABLE_FIRST_RUN_EXPERIENCE})
public class SimpleNoticeSheetViewTest {
    @Rule
    ...
    public void setupTest() throws InterruptedException {
        ...
        runOnUiThreadBlocking(
                () -> {
                    mModel = SimpleNoticeSheetProperties.createDefaultModel(mDismissCallback);
                    mView =
                            new SimpleNoticeSheetView(
                                    mActivityTestRule.getActivity(), mBottomSheetController);
                    PropertyModelChangeProcessor.create(
                            mModel, mView, SimpleNoticeSheetViewBinder::bindSimpleNoticeSheetView);
                });
    }
