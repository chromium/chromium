...
class PromiseAppUpdate {
 public:
  ...
  // Indicates the app name that was provided by Melting Pot. If we are still
  // waiting on the response from Melting Pot or Melting Pot hasn't found the
  // app in its catalog, this method will return absl::nullopt.
