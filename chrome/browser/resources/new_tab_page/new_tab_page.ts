...
export {InputSource, QueryActionOverride, SearchboxOverride, SearchboxTutorial, SuggestInventory} from 'chrome://resources/mojo/components/omnibox/browser/fusebox_action.mojom-webui.js';
