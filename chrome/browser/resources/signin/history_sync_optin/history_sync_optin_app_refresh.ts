...
import {getCss} from './history_sync_optin_app_refresh.css.js';
import {getHtml} from './history_sync_optin_app_refresh.html.js';

const HistorySyncOptinAppRefreshElementBase = I18nMixinLit(CrLitElement);

export interface HistorySyncOptinAppRefreshElement {
  $: {
...
export class HistorySyncOptinAppRefreshElement extends
    HistorySyncOptinAppRefreshElementBase {
  static get is() {
    return 'history-sync-optin-app-refresh';
  }
  ...
  protected accessor isModal_: boolean =
      this.isLaunchContext_(LaunchContext.kModal);
...
declare global {
  interface HTMLElementTagNameMap {
    'history-sync-optin-app-refresh': HistorySyncOptinAppRefreshElement;
  }
}

customElements.define(
    HistorySyncOptinAppRefreshElement.is, HistorySyncOptinAppRefreshElement);
