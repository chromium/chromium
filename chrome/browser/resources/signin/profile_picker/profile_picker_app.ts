...
import {navigateTo, NavigationMixinLit, ProfileCreationSteps, Routes} from './navigation_mixin.js';
...
const ProfilePickerAppElementBase =
    WebUiListenerMixinLit(I18nMixinLit(NavigationMixinLit(CrLitElement)));
