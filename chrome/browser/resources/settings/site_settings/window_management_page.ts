...
export class WindowManagementPageElement extends
  ...
  protected getSelectWindowOffIcon_(): string {
    return loadTimeData.getBoolean('webuiRoundedIconsEnabled') ?
        'privacy:select-window-off' :
        'privacy:select-window-off-old';
  }
}

declare global {
  interface HTMLElementTagNameMap {
    'settings-window-management-page': WindowManagementPageElement;
  }
}

customElements.define(
    WindowManagementPageElement.is, WindowManagementPageElement);
