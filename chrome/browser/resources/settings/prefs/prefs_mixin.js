...
export const PrefsMixin = dedupingMixin(superClass => {
  ...
  class PrefsMixin extends superClass {
    ...
    /**
     * Sets the value of the pref at the given prefPath. Throws if the pref is
     * not found.
     * @param {string} prefPath
     * @param {*} value
     * @protected
     ...
     * found. Asserts if the pref itself is not found or is not an Array type.
     * @param {string} key
     * @param {*} item
     * @protected
     */
...
/** @interface */
export class PrefsMixinInterface {
  /** @return  {!Object} */
  get prefs() {}
