...
export const JELLY_EMOJI_PICKER_TOP_PADDING = 10;
export const JELLY_EMOJI_PICKER_SEARCH_SIDE_PADDING = 16;

export const JELLY_EMOJI_PICKER_TOP_PADDING_PX =
    `${JELLY_EMOJI_PICKER_TOP_PADDING}px`;
export const JELLY_EMOJI_PICKER_SEARCH_SIDE_PADDING_PX =
    `${JELLY_EMOJI_PICKER_SEARCH_SIDE_PADDING}px`;
