...
import type {OnTabsCreatedEvent, OnTabsClosedEvent, OnDataChangedEvent, OnCollectionCreatedEvent, OnNodeMovedEvent} from './tab_strip_api_events.mojom-webui.js';
