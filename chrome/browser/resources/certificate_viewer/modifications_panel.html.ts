...
<div class="vertical-box">
  ...
  <div class="horizontal-row">
    ...
    <div class="input-with-error">
      <select id="trustStateSelect" class="md-select"
          .value="${this.trustStateValue}" @change="${this.onTrustStateChange_}"
      ...
      <div id="trustStateSelectError"
          ?hidden="${this.trustStateErrorMessage.length === 0}" class="error">
    ...
    <div>
      ${this.constraints.map((constraint: string, index: number) => html`
        <div class="constraint">
          ${constraint}
          <cr-icon-button id="constraint-delete-${index}" data-index="${index}"
  ...
  <div class="horizontal-row" id="addConstraintSection"
    ...
    <cr-input id="addConstraintInput" aria-label="$i18n{addConstraints}"
        ...
        @keypress="${this.onConstraintKeypress_}" value="">
