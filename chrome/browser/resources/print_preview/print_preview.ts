...
export {ColorMode, createDestinationKey, Destination, DestinationConnectionStatus, DestinationOrigin, DestinationType, GooglePromotedDestinationId, makeRecentDestination, PDF_DESTINATION_KEY, RecentDestination} from './data/destination.js';
