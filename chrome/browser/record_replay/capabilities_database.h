...
#ifndef CHROME_BROWSER_RECORD_REPLAY_CAPABILITIES_DATABASE_H_
#define CHROME_BROWSER_RECORD_REPLAY_CAPABILITIES_DATABASE_H_
#include <string>
#include <vector>
...
#endif  // CHROME_BROWSER_RECORD_REPLAY_CAPABILITIES_DATABASE_H_
