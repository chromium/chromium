...
class DownloadStatusUpdaterTest : public testing::Test {
 ...
 protected:
  ...
  std::vector<std::vector<dangling_raw_ptr<download::DownloadItem>>>
      manager_items_;
  ...
  std::vector<dangling_raw_ptr<content::DownloadManager::Observer>>
      manager_observers_;
  ...
  std::vector<dangling_raw_ptr<TestingProfile>> testing_profiles_;
};
