 ...
 protected:
  class TestAutofillManager : public autofill::BrowserAutofillManager {
   public:
    ...
    // have a timeout, but it could be flaky on bots with different specs. Hence
    // the test checks the OnAskForValues event, if this event got fired,
    // Autofill popup should have appeared, otherwise it is disabled by policy.
