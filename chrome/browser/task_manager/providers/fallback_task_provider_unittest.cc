...
class FakeTaskProvider : public TaskProvider {
 ...
 private:
  ...
  std::vector<dangling_raw_ptr<Task>> task_provider_tasks_;
};
...
class FallbackTaskProviderTest : public testing::Test,
 ...
 public:
  ...
  std::vector<dangling_raw_ptr<Task>> seen_tasks() { return seen_tasks_; }

 private:
  content::BrowserTaskEnvironment task_environment_;
  std::unique_ptr<FallbackTaskProvider> task_provider_;
  std::vector<dangling_raw_ptr<Task>> seen_tasks_;
};
