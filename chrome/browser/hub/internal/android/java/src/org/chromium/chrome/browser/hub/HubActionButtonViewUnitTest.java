...
/** Unit tests for {@link HubActionButtonView}. */
...
public class HubActionButtonViewUnitTest {
    ...
    private HubActionButtonView mActionButtonView;
    ...
    private void onActivity(TestActivity activity) {
        ...
        mActionButtonView = toolbarContainer.findViewById(R.id.toolbar_action_button);
        ...
        PropertyModelChangeProcessor.create(
                mPropertyModel, mActionButtonView, HubActionButtonViewBinder::bind);
    }
    ...
    public void testActionButtonVisibility() {
        ...
        assertEquals(View.GONE, mActionButtonView.getVisibility());
        ...
        assertEquals(View.VISIBLE, mActionButtonView.getVisibility());
