...
/**
 * Helper for the {@link SafetyHubLocalPasswordsModule} for the has no compromised passwords state.
 */
public class SafetyHubLocalPasswordsNoCompromisedPasswordsModuleHelper
        implements SafetyHubModuleHelper {
    private final Context mContext;
    private final SafetyHubModuleDelegate mModuleDelegate;

    SafetyHubLocalPasswordsNoCompromisedPasswordsModuleHelper(
    ...
    public String getSummary() {
        return mContext.getString(R.string.safety_hub_no_compromised_local_passwords_summary);
    }
