...
/** Helper for the {@link SafetyHubLocalPasswordsModule} for the has reused passwords state. */
public class SafetyHubLocalPasswordsHasReusedPasswordsModuleHelper
    ...
    SafetyHubLocalPasswordsHasReusedPasswordsModuleHelper(
