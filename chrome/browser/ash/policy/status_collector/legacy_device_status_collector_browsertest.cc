...
class LegacyDeviceStatusCollectorTest : public testing::Test {
 public:
  LegacyDeviceStatusCollectorTest()
  ...
  LegacyDeviceStatusCollectorTest(const LegacyDeviceStatusCollectorTest&) =
      delete;
  LegacyDeviceStatusCollectorTest& operator=(
 ...
 protected:
  ...
  void GetStatus() {
    ...
    status_collector_->GetStatusAsync(
        base::BindRepeating(&LegacyDeviceStatusCollectorTest::OnStatusReceived,
...
TEST_F(LegacyDeviceStatusCollectorTest, AllIdle) {
...
TEST_F(LegacyDeviceStatusCollectorTest, AllActive) {
...
TEST_F(LegacyDeviceStatusCollectorTest, MixedStates) {
...
TEST_F(LegacyDeviceStatusCollectorTest, MixedStatesForKiosk) {
...
TEST_F(LegacyDeviceStatusCollectorTest, MixedStatesForArcKiosk) {
  ui::IdleState test_states[] = {
      ui::IDLE_STATE_ACTIVE, ui::IDLE_STATE_IDLE, ui::IDLE_STATE_ACTIVE,
...
TEST_F(LegacyDeviceStatusCollectorTest, StateKeptInPref) {
  ui::IdleState test_states[] = {ui::IDLE_STATE_ACTIVE, ui::IDLE_STATE_IDLE,
                                 ui::IDLE_STATE_ACTIVE, ui::IDLE_STATE_ACTIVE,
                                 ui::IDLE_STATE_IDLE,   ui::IDLE_STATE_IDLE};
  scoped_testing_cros_settings_.device_settings()->SetBoolean(
...
TEST_F(LegacyDeviceStatusCollectorTest, ActivityTimesEnabledByDefault) {
...
TEST_F(LegacyDeviceStatusCollectorTest, ActivityTimesOff) {
...
TEST_F(LegacyDeviceStatusCollectorTest, ActivityCrossingMidnight) {
...
TEST_F(LegacyDeviceStatusCollectorTest,
...
TEST_F(LegacyDeviceStatusCollectorTest, ActivityNoUser) {
...
TEST_F(LegacyDeviceStatusCollectorTest, ActivityWithPublicSessionUser) {
  scoped_feature_list_.InitAndEnableFeature(
      features::kActivityReportingSessionType);
  ui::IdleState test_states[] = {ui::IDLE_STATE_ACTIVE, ui::IDLE_STATE_ACTIVE,
                                 ui::IDLE_STATE_ACTIVE};
...
TEST_F(LegacyDeviceStatusCollectorTest, ActivityWithKioskUser) {
  scoped_feature_list_.InitAndEnableFeature(
      features::kActivityReportingSessionType);
  ui::IdleState test_states[] = {ui::IDLE_STATE_ACTIVE, ui::IDLE_STATE_ACTIVE,
                                 ui::IDLE_STATE_ACTIVE};
...
TEST_F(LegacyDeviceStatusCollectorTest, ActivityWithAffiliatedUser) {
  scoped_feature_list_.InitAndEnableFeature(
      features::kActivityReportingSessionType);
  ui::IdleState test_states[] = {ui::IDLE_STATE_ACTIVE, ui::IDLE_STATE_ACTIVE,
                                 ui::IDLE_STATE_ACTIVE};
...
TEST_F(LegacyDeviceStatusCollectorTest, ActivityWithNotAffiliatedUser) {
  scoped_feature_list_.InitAndEnableFeature(
      features::kActivityReportingSessionType);
  ui::IdleState test_states[] = {ui::IDLE_STATE_ACTIVE, ui::IDLE_STATE_ACTIVE,
                                 ui::IDLE_STATE_ACTIVE};
...
TEST_F(LegacyDeviceStatusCollectorTest, DevSwitchBootMode) {
...
TEST_F(LegacyDeviceStatusCollectorTest, WriteProtectSwitch) {
  ...
  // statistics provider returns valid data.
  scoped_testing_cros_settings_.device_settings()->SetBoolean(
      ash::kReportDeviceHardwareStatus, true);
...
TEST_F(LegacyDeviceStatusCollectorTest, VersionInfo) {
...
TEST_F(LegacyDeviceStatusCollectorTest, ReportUsers) {
  const AccountId public_account_id(
...
TEST_F(LegacyDeviceStatusCollectorTest, TestVolumeInfo) {
...
TEST_F(LegacyDeviceStatusCollectorTest, TestAvailableMemory) {
...
TEST_F(LegacyDeviceStatusCollectorTest, TestSystemFreeRamInfo) {
...
TEST_F(LegacyDeviceStatusCollectorTest, TestCPUSamples) {
  // Mock 100% CPU usage.
...
TEST_F(LegacyDeviceStatusCollectorTest, TestCPUInfos) {
  // Mock 100% CPU usage.
  std::string full_cpu_usage("cpu  500 0 500 0 0 0 0");
...
TEST_F(LegacyDeviceStatusCollectorTest, TestCPUTemp) {
...
TEST_F(LegacyDeviceStatusCollectorTest, TestDiskLifetimeEstimation) {
...
TEST_F(LegacyDeviceStatusCollectorTest, KioskAndroidReporting) {
  auto options = CreateEmptyDeviceStatusCollectorOptions();
  options->android_status_fetcher =
...
TEST_F(LegacyDeviceStatusCollectorTest, NoKioskAndroidReportingWhenDisabled) {
  auto options = CreateEmptyDeviceStatusCollectorOptions();
  options->android_status_fetcher =
      base::BindRepeating(&GetFakeAndroidStatus, kArcStatus, kDroidGuardInfo);
  RestartStatusCollector(std::move(options));
...
TEST_F(LegacyDeviceStatusCollectorTest, RegularUserAndroidReporting) {
  auto options = CreateEmptyDeviceStatusCollectorOptions();
  options->android_status_fetcher =
      base::BindRepeating(&GetFakeAndroidStatus, kArcStatus, kDroidGuardInfo);
  RestartStatusCollector(std::move(options));
...
TEST_F(LegacyDeviceStatusCollectorTest, RegularUserCrostiniReporting) {
  auto options = CreateEmptyDeviceStatusCollectorOptions();
  options->android_status_fetcher =
      base::BindRepeating(&GetFakeAndroidStatus, kArcStatus, kDroidGuardInfo);
  RestartStatusCollector(std::move(options));
...
TEST_F(LegacyDeviceStatusCollectorTest, RegularUserCrostiniReportingNoData) {
  auto options = CreateEmptyDeviceStatusCollectorOptions();
  options->android_status_fetcher =
      base::BindRepeating(&GetFakeAndroidStatus, kArcStatus, kDroidGuardInfo);
  RestartStatusCollector(std::move(options));
...
TEST_F(LegacyDeviceStatusCollectorTest,
       CrostiniTerminaVmKernelVersionReporting) {
  auto options = CreateEmptyDeviceStatusCollectorOptions();
  options->android_status_fetcher =
      base::BindRepeating(&GetFakeAndroidStatus, kArcStatus, kDroidGuardInfo);
  RestartStatusCollector(std::move(options));
...
TEST_F(LegacyDeviceStatusCollectorTest, CrostiniAppUsageReporting) {
  auto options = CreateEmptyDeviceStatusCollectorOptions();
  options->android_status_fetcher =
      base::BindRepeating(&GetFakeAndroidStatus, kArcStatus, kDroidGuardInfo);
  RestartStatusCollector(std::move(options));
...
TEST_F(LegacyDeviceStatusCollectorTest, NoRegularUserReportingByDefault) {
  auto options = CreateEmptyDeviceStatusCollectorOptions();
  options->android_status_fetcher =
      base::BindRepeating(&GetFakeAndroidStatus, kArcStatus, kDroidGuardInfo);
  RestartStatusCollector(std::move(options));
...
TEST_F(LegacyDeviceStatusCollectorTest, TpmStatusReporting) {
...
TEST_F(LegacyDeviceStatusCollectorTest, TpmStatusReportingAnyDBusError) {
  auto* tpm_status_reply = chromeos::TpmManagerClient::Get()
                               ->GetTestInterface()
                               ->mutable_nonsensitive_status_reply();
  auto* enrollment_status_reply =
...
TEST_F(LegacyDeviceStatusCollectorTest, NoTimeZoneReporting) {
...
TEST_F(LegacyDeviceStatusCollectorTest, NoSessionStatusIfNoSession) {
...
TEST_F(LegacyDeviceStatusCollectorTest, ReportKioskSessionStatus) {
  scoped_testing_cros_settings_.device_settings()->SetBoolean(
      ash::kReportDeviceSessionStatus, true);
  status_collector_->set_kiosk_account(
      std::make_unique<DeviceLocalAccount>(fake_kiosk_device_local_account_));
...
TEST_F(LegacyDeviceStatusCollectorTest, NoOsUpdateStatusByDefault) {
...
TEST_F(LegacyDeviceStatusCollectorTest, ReportOsUpdateStatusUpToDate) {
  auto scoped_version = MockPlatformVersion(kDefaultPlatformVersion);
  scoped_testing_cros_settings_.device_settings()->SetBoolean(
...
TEST_F(LegacyDeviceStatusCollectorTest, ReportOsUpdateStatusUpToDate_NonKiosk) {
  auto scoped_version = MockPlatformVersion(kDefaultPlatformVersion);
  scoped_testing_cros_settings_.device_settings()->SetBoolean(
      ash::kReportOsUpdateStatus, true);
  GetStatus();
...
TEST_F(LegacyDeviceStatusCollectorTest, ReportOsUpdateStatus) {
  auto scoped_version = MockPlatformVersion(kDefaultPlatformVersion);
  scoped_testing_cros_settings_.device_settings()->SetBoolean(
      ash::kReportOsUpdateStatus, true);
  MockAutoLaunchKioskAppWithRequiredPlatformVersion(
...
TEST_F(LegacyDeviceStatusCollectorTest, ReportOsUpdateStatus_NonKiosk) {
  auto scoped_version = MockPlatformVersion(kDefaultPlatformVersion);
  scoped_testing_cros_settings_.device_settings()->SetBoolean(
      ash::kReportOsUpdateStatus, true);
...
TEST_F(LegacyDeviceStatusCollectorTest, NoLastCheckedTimestampByDefault) {
  auto scoped_version = MockPlatformVersion(kDefaultPlatformVersion);
  MockAutoLaunchKioskAppWithRequiredPlatformVersion(
      fake_kiosk_device_local_account_, kDefaultPlatformVersion);
...
TEST_F(LegacyDeviceStatusCollectorTest, ReportLastCheckedTimestamp) {
  auto scoped_version = MockPlatformVersion(kDefaultPlatformVersion);
  MockAutoLaunchKioskAppWithRequiredPlatformVersion(
      fake_kiosk_device_local_account_, kDefaultPlatformVersion);
...
TEST_F(LegacyDeviceStatusCollectorTest, NoLastRebootTimestampByDefault) {
  auto scoped_version = MockPlatformVersion(kDefaultPlatformVersion);
  MockAutoLaunchKioskAppWithRequiredPlatformVersion(
      fake_kiosk_device_local_account_, kDefaultPlatformVersion);
...
TEST_F(LegacyDeviceStatusCollectorTest, ReportLastRebootTimestamp) {
  auto scoped_version = MockPlatformVersion(kDefaultPlatformVersion);
  MockAutoLaunchKioskAppWithRequiredPlatformVersion(
      fake_kiosk_device_local_account_, kDefaultPlatformVersion);
...
TEST_F(LegacyDeviceStatusCollectorTest, NoRunningKioskAppByDefault) {
  auto scoped_version = MockPlatformVersion(kDefaultPlatformVersion);
  MockAutoLaunchKioskAppWithRequiredPlatformVersion(
      fake_kiosk_device_local_account_, kDefaultPlatformVersion);
  status_collector_->set_kiosk_account(
...
TEST_F(LegacyDeviceStatusCollectorTest,
       NoRunningKioskAppWhenNotInKioskSession) {
  scoped_testing_cros_settings_.device_settings()->SetBoolean(
...
TEST_F(LegacyDeviceStatusCollectorTest, ReportRunningKioskApp) {
  scoped_testing_cros_settings_.device_settings()->SetBoolean(
      ash::kReportRunningKioskApp, true);
  auto scoped_version = MockPlatformVersion(kDefaultPlatformVersion);
  MockAutoLaunchKioskAppWithRequiredPlatformVersion(
...
TEST_F(LegacyDeviceStatusCollectorTest, ReportRunningArcKioskApp) {
  scoped_testing_cros_settings_.device_settings()->SetBoolean(
      ash::kReportRunningKioskApp, true);
...
TEST_F(LegacyDeviceStatusCollectorTest, ReportRunningWebKioskApp) {
  scoped_testing_cros_settings_.device_settings()->SetBoolean(
      ash::kReportRunningKioskApp, true);
...
TEST_F(LegacyDeviceStatusCollectorTest, TestSoundVolume) {
...
TEST_F(LegacyDeviceStatusCollectorTest, TestStatefulPartitionInfo) {
...
TEST_F(LegacyDeviceStatusCollectorTest, TestGraphicsStatus) {
...
TEST_F(LegacyDeviceStatusCollectorTest, TestCrashReportInfo) {
...
TEST_F(LegacyDeviceStatusCollectorTest, TestCrashReportInfo_DeviceRestartOnly) {
...
TEST_F(LegacyDeviceStatusCollectorTest,
       TestCrashReportInfo_LastDayUploadedOnly) {
...
TEST_F(LegacyDeviceStatusCollectorTest, TestCrosHealthdInfo) {
...
TEST_F(LegacyDeviceStatusCollectorTest, TestCrosHealthdInfoOptional) {
...
TEST_F(LegacyDeviceStatusCollectorTest, TestPartialCrosHealthdInfo) {
...
TEST_F(LegacyDeviceStatusCollectorTest, TestCrosHealthdVpdAndSystemInfo) {
  // Create a fake response from cros_healthd and populate it with some
  // arbitrary values.
  auto options = CreateEmptyDeviceStatusCollectorOptions();
  options->cros_healthd_data_fetcher =
...
TEST_F(LegacyDeviceStatusCollectorTest, GenerateAppInfo) {
  const AccountId account_id(AccountId::FromUserEmail("user0@managed.com"));
  MockRegularUserWithAffiliation(account_id, true);
  scoped_testing_cros_settings_.device_settings()->SetBoolean(
...
class LegacyDeviceStatusCollectorNetworkTest
    : public LegacyDeviceStatusCollectorTest {
 protected:
  void SetUp() override {
    RestartStatusCollector();
  ...
  void SetReportDeviceNetworkInterfacesPolicy(bool enable) {
    scoped_testing_cros_settings_.device_settings()->SetBoolean(
        ash::kReportDeviceNetworkInterfaces, enable);
  }

  void TearDown() override { LegacyDeviceStatusCollectorTest::TearDown(); }
...
TEST_F(LegacyDeviceStatusCollectorNetworkInterfacesTest, Default) {
...
TEST_F(LegacyDeviceStatusCollectorNetworkInterfacesTest, IfUnaffiliatedUser) {
...
TEST_F(LegacyDeviceStatusCollectorNetworkInterfacesTest, IfAffiliatedUser) {
...
TEST_F(LegacyDeviceStatusCollectorNetworkInterfacesTest, IfPublicSession) {
...
TEST_F(LegacyDeviceStatusCollectorNetworkInterfacesTest, IfKioskMode) {
...
class LegacyDeviceStatusCollectorNetworkStateTest
    : public LegacyDeviceStatusCollectorNetworkTest {
 protected:
  void VerifyReporting() override {
...
TEST_F(LegacyDeviceStatusCollectorNetworkStateTest, Default) {
...
TEST_F(LegacyDeviceStatusCollectorNetworkStateTest, IfUnaffiliatedUser) {
...
TEST_F(LegacyDeviceStatusCollectorNetworkStateTest, IfAffiliatedUser) {
...
TEST_F(LegacyDeviceStatusCollectorNetworkStateTest, IfPublicSession) {
...
TEST_F(LegacyDeviceStatusCollectorNetworkStateTest, IfKioskMode) {
