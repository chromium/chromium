...
#ifndef CHROME_BROWSER_ASH_WEB_APPLICATIONS_PERSONALIZATION_APP_MOCK_PERSONALIZATION_APP_MANAGER_H_
#define CHROME_BROWSER_ASH_WEB_APPLICATIONS_PERSONALIZATION_APP_MOCK_PERSONALIZATION_APP_MANAGER_H_
