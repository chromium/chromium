...
#ifndef CHROME_BROWSER_ASH_ARC_CAST_RECEIVER_ARC_CAST_RECEIVER_SERVICE_H_
#define CHROME_BROWSER_ASH_ARC_CAST_RECEIVER_ARC_CAST_RECEIVER_SERVICE_H_
...
#endif  // CHROME_BROWSER_ASH_ARC_CAST_RECEIVER_ARC_CAST_RECEIVER_SERVICE_H_
