...
MultiCaptureNotification::MultiCaptureNotification(
    ...
    : multi_capture_service_client_(multi_capture_service_client) {
  multi_capture_service_client_->AddObserver(this);
}

MultiCaptureNotification::~MultiCaptureNotification() {
  multi_capture_service_client_->RemoveObserver(this);
}
