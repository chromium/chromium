...
base::Value::Dict GetFileManagerPluralStrings() {
  ...
  dict.Set("CONFIRM_MOBILE_DATA_USE", IDS_FILE_BROWSER_CONFIRM_MOBILE_DATA_USE);
  dict.Set("FOLDER_SHARED_WITH_CROSTINI",
           IDS_FILE_BROWSER_FOLDER_SHARED_WITH_CROSTINI);
  dict.Set("FOLDER_SHARED_WITH_PLUGIN_VM",
           IDS_FILE_BROWSER_FOLDER_SHARED_WITH_PLUGIN_VM);
  dict.Set("HOSTED_OFFLINE_MESSAGE", IDS_FILE_BROWSER_HOSTED_OFFLINE_MESSAGE);
  dict.Set("OFFLINE_MESSAGE", IDS_FILE_BROWSER_OFFLINE_MESSAGE);
  dict.Set("OPEN_IN_OTHER_DESKTOP_MESSAGE",
           IDS_FILE_BROWSER_OPEN_IN_OTHER_DESKTOP_MESSAGE);
  dict.Set("SCANNING_LABEL", IDS_FILE_BROWSER_SCANNING_LABEL);
  dict.Set("OPEN_A11Y", IDS_FILE_BROWSER_OPEN_A11Y);
