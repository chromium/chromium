...
#ifndef CHROME_BROWSER_ASH_REPORT_CONTROLLER_INITIALIZER_H_
#define CHROME_BROWSER_ASH_REPORT_CONTROLLER_INITIALIZER_H_
...
class ReportControllerInitializer : public DeviceSettingsService::Observer {
 public:
  ...
  enum class State {
    ...
    kWaitingForStartupDelay = 1,   // Wait for startup delay to be completed.
...
#endif  // CHROME_BROWSER_ASH_REPORT_CONTROLLER_INITIALIZER_H_
