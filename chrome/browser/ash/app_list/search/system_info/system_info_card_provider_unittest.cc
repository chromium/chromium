...
TEST_F(SystemInfoCardProviderTest, PreventTriggeringOfTooShortQueries) {
  ...
  system_info::SetCrosHealthdCpuResponse(
      {core_1, core_2}, {temp_1, temp_2, temp_3}, {core_1_speed, core_2_speed});
  StartSearch(u"cp");
  Wait();
...
TEST_F(SystemInfoCardProviderTest, Cpu) {
  ...
  system_info::SetCrosHealthdCpuResponse(
      ...
      {new_temp_1, new_temp_2, new_temp_3}, {core_1_speed, core_2_speed});
  ...
  system_info::SetCrosHealthdCpuResponse({core_1 + core_1_delta + core_1_delta,
...
TEST_F(SystemInfoCardProviderTest, CpuProbeError) {
  ...
  auto cpu_result = healthd_mojom::CpuResult::NewError(
      system_info::CreateProbeError(healthd_mojom::ErrorType::kFileReadError));
...
TEST_F(SystemInfoCardProviderTest, Memory) {
  ...
  system_info::SetCrosHealthdMemoryUsageResponse(
  ...
  system_info::SetCrosHealthdMemoryUsageResponse(
      total_memory_kib_2, free_memory_kib_2, available_memory_kib_2);
...
TEST_F(SystemInfoCardProviderTest, MemoryProbeError) {
  ...
  auto memory_result =
      healthd_mojom::MemoryResult::NewError(system_info::CreateProbeError(
          healthd_mojom::ErrorType::kSystemUtilityError));
...
TEST_F(SystemInfoCardProviderTest, Battery) {
  ...
  system_info::SetCrosHealthdBatteryHealthResponse(
      charge_full_now, charge_full_design, cycle_count);
  ...
  system_info::SetPowerManagerProperties(
      power_source, battery_state, is_calculating_battery_time,
      time_to_full_secs, time_to_empty_secs, battery_percent);
  Wait();
  ...
  system_info::SetPowerManagerProperties(
      power_source, battery_state, is_calculating_battery_time,
      new_time_to_full_secs, time_to_empty_secs, new_battery_percent);
  Wait();
...
TEST_F(SystemInfoCardProviderTest, BatteryProbeError) {
  ...
  auto battery_result = healthd_mojom::BatteryResult::NewError(
      system_info::CreateProbeError(healthd_mojom::ErrorType::kParseError));
...
TEST_F(SystemInfoCardProviderTest, BatteryProbeDataError) {
  ...
  system_info::SetCrosHealthdBatteryHealthResponse(0, 0, 0);
