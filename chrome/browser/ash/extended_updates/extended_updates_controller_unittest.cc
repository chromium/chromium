...
constexpr char kOwnerUsername[] = "owner@gmail.com";
...
class ExtendedUpdatesControllerTest
 ...
 public:
  ...
  void SetUp() override {
    ...
    DeviceSettingsService::Get()->InitOwner(
        kOwnerUsername,
        OwnerSettingsServiceAshFactory::GetForBrowserContext(&profile_)
            ->as_weak_ptr());
 ...
 protected:
  ...
  void ExpectQuickSettingsNoticeVisibility(bool visible) {
