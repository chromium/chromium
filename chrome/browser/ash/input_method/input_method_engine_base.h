...
#ifndef CHROME_BROWSER_ASH_INPUT_METHOD_INPUT_METHOD_ENGINE_BASE_H_
#define CHROME_BROWSER_ASH_INPUT_METHOD_INPUT_METHOD_ENGINE_BASE_H_
...
class InputMethodEngineBase : virtual public ui::IMEEngineHandlerInterface,
 ...
 protected:
  ...
  std::unique_ptr<InputMethodEngineBaseObserver> observer_;
