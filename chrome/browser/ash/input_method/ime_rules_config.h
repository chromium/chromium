...
class ImeRulesConfig {
 ...
 private:
  ...
  std::vector<std::string> default_auto_correct_domain_denylist_{
      "amazon.com",    "b.corp.google.com", "classroom.google.com",
      "desmos.com",    "docs.google.com",   "facebook.com",
      "instagram.com", "outlook.live.com",  "outlook.office.com",
      "quizlet.com",   "whatsapp.com",      "youtube.com",
  };
};
