...
class WizardControllerTestBase : public NoSessionAshTestBase {
 public:
  WizardControllerTestBase()
      : NoSessionAshTestBase(std::unique_ptr<base::test::TaskEnvironment>(
...
class WizardControllerTest : public WizardControllerTestBase {
 ...
 protected:
  ...
  base::raw_ptr<WizardController> wizard_controller_;
...
TEST_F(WizardControllerTest,
       ConsumerOobeFlowShouldContinueOnNonCriticalUpdate) {
  // Update screen is skipped on non-branded builds.
