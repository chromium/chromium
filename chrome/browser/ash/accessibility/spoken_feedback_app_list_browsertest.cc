...
IN_PROC_BROWSER_TEST_P(SpokenFeedbackAppListSearchTest,
  ...
  sm_.ExpectSpeech("List box with 7 items");
  ...
  sm_.ExpectSpeech("A");
  sm_.ExpectSpeech("Displaying 5 results for item 3a");
  sm_.ExpectSpeech("app 0");
  sm_.ExpectSpeech("List item 1 of 5");
...
IN_PROC_BROWSER_TEST_P(SpokenFeedbackAppListSearchProductivityLauncherTest,
  ...
  sm_.ExpectSpeech("List box with 8 items");
  ...
  sm_.ExpectSpeech("A");
  sm_.ExpectSpeech("Displaying 5 results for item 2a");
  sm_.ExpectSpeech("app 0");
  sm_.ExpectSpeech("List item 1 of 5");
