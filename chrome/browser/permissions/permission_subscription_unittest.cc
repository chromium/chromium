...
// The following tests are moving from PermissionManagerTest in
// `components/permissions/` due to removing duplicate implementation of
// subscription map in PermissionManager.
...
#else
#define MAYBE_SubscribeUnsubscribeForNewTabPage \
    ENABLE_SubscribeUnsubscribeForNewTabPage
#endif
