...
BASE_FEATURE(kAndroidTabDeclutterAutoDeleteKillSwitch, base::FEATURE_ENABLED_BY_DEFAULT);
...
BASE_FEATURE(kAutomotiveBackButtonBarStreamline, base::FEATURE_DISABLED_BY_DEFAULT);
...
BASE_FEATURE(kReadAloudAudioOverviewsFeedback, base::FEATURE_DISABLED_BY_DEFAULT);
BASE_FEATURE(kReadAloudAudioOverviewsSkipDisclaimerWhenPossible, base::FEATURE_DISABLED_BY_DEFAULT);
...
BASE_FEATURE(kTabGroupAndroidVisualDataCleanup, base::FEATURE_DISABLED_BY_DEFAULT);
...
BASE_FEATURE(kTabSwitcherForeignFaviconSupport, base::FEATURE_ENABLED_BY_DEFAULT);
