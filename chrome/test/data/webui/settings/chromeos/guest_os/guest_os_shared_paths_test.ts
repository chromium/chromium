...
import {GuestOsBrowserProxyImpl, SettingsGuestOsSharedPathsElement} from 'chrome://os-settings/chromeos/lazy_load.js';
import {CrButtonElement} from 'chrome://os-settings/chromeos/os_settings.js';
