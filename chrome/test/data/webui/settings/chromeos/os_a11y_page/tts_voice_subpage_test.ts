...
import {SettingsTtsVoiceSubpageElement} from 'chrome://os-settings/chromeos/lazy_load.js';
import {Router, routes, TtsVoiceSubpageBrowserProxy, TtsVoiceSubpageBrowserProxyImpl} from 'chrome://os-settings/chromeos/os_settings.js';
