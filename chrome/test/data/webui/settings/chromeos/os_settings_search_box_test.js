...
import {OpenWindowProxyImpl, OsSettingsSearchBoxBrowserProxyImpl, personalizationSearchMojom, Router, routes, routesMojom, searchMojomWebui, searchResultIconMojomWebui, setPersonalizationSearchHandlerForTesting, setSettingsSearchHandlerForTesting, settingMojom, setUserActionRecorderForTesting, userActionRecorderMojomWebui} from 'chrome://os-settings/chromeos/os_settings.js';
...
suite('OSSettingsSearchBox', () => {
   ...
   * @param {?searchResultIconMojomWebui.SearchResultIcon} icon Result
   *     icon enum.
   ...
   * @return {!searchMojomWebui.SearchResult} A search result.
   */
  function fakeSettingsResult(
    ...
    return /** @type {!mojom.SearchResult} */ ({
      ...
      icon: icon ? icon : searchResultIconMojomWebui.SearchResultIcon.MIN_VALUE,
      ...
      type: searchMojomWebui.SearchResultType.MIN_VALUE,
  ...
  test('search results sorted descending', async () => {
    ...
    settingsSearchHandler.setFakeResults([
      fakeSettingsResult(
          ...
          /*icon=*/ searchResultIconMojomWebui.SearchResultIcon.MIN_VALUE,
