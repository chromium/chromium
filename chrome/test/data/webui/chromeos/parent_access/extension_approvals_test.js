...
/** @enum {string} */
extension_approvals_tests.TestNames = {
  TestNoPermissions: 'Test that no permissions render',
  TestWithPermissions: 'Test that permission without details renders',
  TestWithPermissionDetails: 'Test permission with details renders',
};

suite(extension_approvals_tests.suiteName, function() {
  setup(function() {
  ...
  test(
      ...
      async () => {
        ...
        const parentAccessBefore =
            document.createElement('parent-access-before');
        document.body.appendChild(parentAccessBefore);
        await flushTasks();
        ...
        assertNotEquals(
            null,
            template.shadowRoot.querySelector(
        ...
        const showDetails =
            permission.shadowRoot.querySelector('#show-details');
        const hideDetails =
            permission.shadowRoot.querySelector('#hide-details');
