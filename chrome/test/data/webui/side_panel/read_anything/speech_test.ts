...
import {PauseActionSource, WordBoundaryMode} from 'chrome-untrusted://read-anything-side-panel.top-chrome/app.js';
import {NEXT_GRANULARITY_EVENT, PREVIOUS_GRANULARITY_EVENT, RATE_EVENT} from 'chrome-untrusted://read-anything-side-panel.top-chrome/read_anything_toolbar.js';
