...
function main() {
  chrome.tabs.query({active: true, currentWindow: true}, function(tabs) {
    ...
    chrome.storage.local.get(tab.id.toString(), function(result) {
      const input = result[tab.id];
      const feeds = input !== undefined ? input['feeds'] : undefined;
