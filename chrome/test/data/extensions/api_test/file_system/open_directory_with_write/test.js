        ...
        chrome.test.callbackPass(function(directoryEntry) {
          directoryEntry.getFile(
              'open_existing.txt', {}, chrome.test.callback(function(entry) {
                entry.copyTo(
                    directoryEntry, 'to_move.txt',
                    chrome.test.callback(function(copy) {
                      copy.moveTo(
                          directoryEntry, 'moved.txt',
                          chrome.test.callback(function(move) {
                            directoryEntry.getFile(
                                'to_move.txt', {},
          ...
          directoryEntry.getFile(
              ...
              chrome.test.callback(function(entry) {
                entry.remove(
                    chrome.test.callback(function() {
                      directoryEntry.getFile(
                          'remove.txt', {}, chrome.test.callback(function() {
