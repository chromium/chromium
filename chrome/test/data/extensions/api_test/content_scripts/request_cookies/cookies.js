...
const requests = [
  ...
  {
    method: 'POST',
    url: '/expect-and-set-cookie?expect=laxcookie%3d1&set=laxFoundPost%3d1',
  },
  {
    method: 'POST',
    url: '/expect-and-set-cookie' +
        '?expect=strictcookie%3d1&set=strictFoundPost%3d1',
  },
];
...
(async function makeRequests() {
  ...
  if (s.includes('laxFoundGet=1') && s.includes('strictFoundGet=1') &&
      s.includes('laxFoundPost=1') && s.includes('strictFoundPost=1')) {
