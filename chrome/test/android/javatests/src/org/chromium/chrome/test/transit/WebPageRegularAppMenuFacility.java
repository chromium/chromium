...
public class WebPageRegularAppMenuFacility extends PageAppMenuFacility<WebPageStation> {
    public WebPageRegularAppMenuFacility(WebPageStation station) {
        super(station);
    }
    ...
    protected void declareItems(ItemsBuilder items) {
        ...
        declarePossibleStubMenuItem(items, ADD_TO_HOME_SCREEN_ID);
        declarePossibleStubMenuItem(items, INSTALL_WEBAPP_ID);
