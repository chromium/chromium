...
class TestingProfile : public Profile {
 ...
 protected:
  ...
  CheckedPtr<sync_preferences::TestingPrefServiceSyncable> testing_prefs_ = nullptr;
 ...
 private:
  ...
  CheckedPtr<BrowserContextDependencyManager> browser_context_dependency_manager_{
