...
// static
void BenchmarkingBindings::Install(v8::Local<v8::Context> context) {
...
gin::ObjectTemplateBuilder BenchmarkingBindings::GetObjectTemplateBuilder(
    v8::Isolate* isolate) {
  return gin::Wrappable<BenchmarkingBindings>::GetObjectTemplateBuilder(isolate)
      .SetMethod("isSingleProcess", &BenchmarkingBindings::IsSingleProcess)
