...
The official orderfiles are generated by the
[`android-arm32-orderfile`](https://ci.chromium.org/p/chrome/builders/ci/android-arm32-orderfile)
and
[`android-arm64-orderfile`](https://ci.chromium.org/p/chrome/builders/ci/android-arm64-orderfile)
builders. These builders are configured in
`//internal/infra/config/subprojects/chrome/ci/chrome.orderfile.star`. and are
triggered by the PGO builds. The builders run the
[`generate_orderfile.py`](../tools/cygprofile/generate_orderfile.py) script with
the appropriate architecture. See
[`//tools/cygprofile/BUILD.gn`](../tools/cygprofile/BUILD.gn) for the exact args
