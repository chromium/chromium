...
#ifndef FUCHSIA_CAST_STREAMING_MESSAGE_SERIALIZATION_H_
#define FUCHSIA_CAST_STREAMING_MESSAGE_SERIALIZATION_H_
...
#endif  // FUCHSIA_CAST_STREAMING_MESSAGE_SERIALIZATION_H_