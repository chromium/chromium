...
#ifndef FUCHSIA_ENGINE_BROWSER_FAKE_SEMANTICS_MANAGER_H_
#define FUCHSIA_ENGINE_BROWSER_FAKE_SEMANTICS_MANAGER_H_
...
#endif  // FUCHSIA_ENGINE_BROWSER_FAKE_SEMANTICS_MANAGER_H_
