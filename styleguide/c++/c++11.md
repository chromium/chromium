...
**Description:** C++17 introduces the `[[nodiscard]]` attribute.
...
**Notes:**
*** promo
See similar attribute macro in base/compiler_specific.h.
***
...
**Description:** C++17 introduces the `[[maybe_unused]]` attribute.
