...
### nodiscard attribute <sup>[tbd]</sup>
...
**Notes:**
*** promo
See `WARN_UNUSED_RESULT` macro in base/compiler_specific.h.
***

### maybe_unused attribute <sup>[tbd]</sup>
...
variables or values of a class/struct/enum can be left unused (including values
...
**Notes:**
*** promo
Similar to the `ignore_result` function in base/ignore_result.h [(and other
places)](https://source.chromium.org/search?q=function:ignore_result&sq=).
***
...
### std::map::try_emplace <sup>[tbd]</sup>
...
**Notes:**
*** promo
Already available on `base::flat_map`.
***

### std::map::insert_or_assign <sup>[tbd]</sup>
