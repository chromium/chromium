...
if not hasattr(builtins, 'init_empty_weights'):
    class DummyContextManager:
        def __enter__(self):
            return self
        def __exit__(self, exc_type, exc_val, traceback):
            pass
    builtins.init_empty_weights = lambda *args, **kwargs: DummyContextManager()

if not hasattr(builtins, 'find_tied_parameters'):
    def find_tied_parameters(*args, **kwargs):
        return {}
    builtins.find_tied_parameters = find_tied_parameters
