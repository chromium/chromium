...
#ifndef COMPONENTS_VIZ_SERVICE_FRAME_SINKS_SURFACE_ANIMATION_MANAGER_H_
#define COMPONENTS_VIZ_SERVICE_FRAME_SINKS_SURFACE_ANIMATION_MANAGER_H_
...
#endif  // COMPONENTS_VIZ_SERVICE_FRAME_SINKS_SURFACE_ANIMATION_MANAGER_H_
