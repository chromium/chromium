...
import org.chromium.components.page_info.CertificateViewerJni;
...
public class CertificateViewer implements OnItemSelectedListener {
    ...
    public static String nativeGetCertIssuedToText() {
        return CertificateViewerJni.get().getCertIssuedByText();
    }

    public static String nativeGetCertInfoCommonNameText() {
        return CertificateViewerJni.get().getCertInfoCommonNameText();
    }

    public static String nativeGetCertInfoOrganizationText() {
        return CertificateViewerJni.get().getCertInfoOrganizationText();
    }

    public static String nativeGetCertInfoSerialNumberText() {
        return CertificateViewerJni.get().getCertInfoSerialNumberText();
    }

    public static String nativeGetCertInfoOrganizationUnitText() {
        return CertificateViewerJni.get().getCertInfoOrganizationUnitText();
    }

    public static String nativeGetCertIssuedByText() {
        return CertificateViewerJni.get().getCertIssuedByText();
    }

    public static String nativeGetCertValidityText() {
        return CertificateViewerJni.get().getCertValidityText();
    }

    public static String nativeGetCertIssuedOnText() {
        return CertificateViewerJni.get().getCertIssuedOnText();
    }

    public static String nativeGetCertExpiresOnText() {
        return CertificateViewerJni.get().getCertExpiresOnText();
    }

    public static String nativeGetCertFingerprintsText() {
        return CertificateViewerJni.get().getCertFingerprintsText();
    }

    public static String nativeGetCertSHA256FingerprintText() {
        return CertificateViewerJni.get().getCertSHA256FingerprintText();
    }

    public static String nativeGetCertSHA1FingerprintText() {
        return CertificateViewerJni.get().getCertSHA1FingerprintText();
    }

    public static String nativeGetCertExtensionText() {
        return CertificateViewerJni.get().getCertExtensionText();
    }

    public static String nativeGetCertSANText() {
        return CertificateViewerJni.get().getCertSANText();
    }
