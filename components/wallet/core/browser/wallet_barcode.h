...
#ifndef COMPONENTS_WALLET_CORE_BROWSER_WALLET_BARCODE_H_
#define COMPONENTS_WALLET_CORE_BROWSER_WALLET_BARCODE_H_
...
#endif  // COMPONENTS_WALLET_CORE_BROWSER_WALLET_BARCODE_H_
