...
constexpr auto intents =
    base::MakeFixedFlatMap<base::StringPiece, AutofillAssistantIntent>(
        {{"BUY_MOVIE_TICKET", AutofillAssistantIntent::BUY_MOVIE_TICKET},
         ...
         {"FOOD_ORDERING_PICKUP",
          AutofillAssistantIntent::FOOD_ORDERING_PICKUP},
         {"FOOD_ORDERING_DELIVERY",
          AutofillAssistantIntent::FOOD_ORDERING_DELIVERY},
         {"UNLAUNCHED_VERTICAL_1",
          AutofillAssistantIntent::UNLAUNCHED_VERTICAL_1},
