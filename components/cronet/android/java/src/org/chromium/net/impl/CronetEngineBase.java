...
public abstract class CronetEngineBase extends ExperimentalCronetEngine {
     ...
     *         {@link UrlRequest.Builder#DEFAULT_IDEMPOTENCY IDEMPOTENT NOT_IDEMPOTENT}
     *         values.
     * @return new request.
     */
    ...
    @IntDef({UrlRequest.Builder.DEFAULT_IDEMPOTENCY, UrlRequest.Builder.IDEMPOTENT,
            UrlRequest.Builder.NOT_IDEMPOTENT})
    @Retention(RetentionPolicy.SOURCE)
