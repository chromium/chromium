...
TEST(SoftNavigationTrackerTest,
  ...
  tracker.Process(&latencies_span, &calculator);
...
TEST(SoftNavigationTrackerTest,
  ...
  tracker.Process(&layout_shifts_span, &normalization);
...
TEST(SoftNavigationTrackerTest,
  ...
  tracker.Process(&lcps_span, &lcp_candidate);
...
TEST(SoftNavigationTrackerTest, IncrementalSoftNavigationUpdates) {
  ...
  tracker.Process(&events_span_1, &calculator);
  ...
  tracker.Process(&events_span_2, &calculator);
  ...
  tracker.Process(&events_span_3, &calculator);
