...
PageEntityCollection GetPageEntityCollectionForString(
  ...
  constexpr auto kPageEntityCollectionMap = base::MakeFixedFlatMap<
      std::string_view, PageEntityCollection>(
      {{"/collection/accommodations", PageEntityCollection::kAccommodations},
       ...
       {"/collection/human_languages", PageEntityCollection::kHumanLanguages},
       {"/collection/software", PageEntityCollection::kSoftware},
       {"/collection/job_titles", PageEntityCollection::kJobTitles},
       {"/collection/literary_series", PageEntityCollection::kLiterarySeries},
       ...
       {"/collection/musical_artists", PageEntityCollection::kMusicalArtists},
       ...
       {"/collection/musical_releases", PageEntityCollection::kMusicalReleases},
       ...
       {"/collection/shopping_centers", PageEntityCollection::kShoppingCenters},
...
std::string_view GetPageEntityCollectionLabel(
  ...
  // collection list:
  // https://source.corp.google.com/piper///depot/google3/production/borg/webref/ondevice/model-building-conf-chrome.gcl?q=labelling_collections_hrids
  constexpr auto kPageEntityCollectionLabelMap =
  ...
  return it != kPageEntityCollectionLabelMap.end() ? it->second : kUnknown;
}
