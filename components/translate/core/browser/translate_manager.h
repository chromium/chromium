...
class TranslateManager {
 ...
 private:
  ...
  CheckedPtr<TranslateClient> translate_client_;        // Weak.
  CheckedPtr<TranslateDriver> translate_driver_;        // Weak.
  CheckedPtr<TranslateRanker> translate_ranker_;        // Weak.
  CheckedPtr<language::LanguageModel> language_model_;  // Weak.
