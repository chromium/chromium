...
#ifndef COMPONENTS_ACTOR_CORE_PAGE_STABILITY_METRICS_COMMON_H_
#define COMPONENTS_ACTOR_CORE_PAGE_STABILITY_METRICS_COMMON_H_
...
#endif  // COMPONENTS_ACTOR_CORE_PAGE_STABILITY_METRICS_COMMON_H_
