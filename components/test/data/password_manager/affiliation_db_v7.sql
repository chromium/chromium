...
INSERT INTO eq_class_groups(facet_uri, set_id, main_domain, change_password_url) VALUES ('https://beta.example.com', 1, 'example.com', 'https://example.com/change/password');
...
INSERT INTO eq_class_groups(facet_uri, set_id, change_password_url) VALUES ('https://epsilon.example.com', 2, 'https://example.com/change/password');
INSERT INTO eq_class_groups(facet_uri, set_id, change_password_url) VALUES ('https://delta.example.com', 2, 'https://example.com/change/password');
...
INSERT INTO psl_extensions(domain) VALUES ('app.com');
INSERT INTO psl_extensions(domain) VALUES ('example.com');
INSERT INTO psl_extensions(domain) VALUES ('news.com');
