...
INSERT INTO meta VALUES('version','142');
...
CREATE TABLE autofill_ai_entities (guid TEXT NOT NULL PRIMARY KEY, entity_type TEXT NOT NULL, nickname TEXT NOT NULL, date_modified INTEGER NOT NULL, use_count INTEGER DEFAULT 0, use_date INTEGER DEFAULT 0, record_type INTEGER DEFAULT 0);
