...
INSERT INTO meta VALUES('version','138');
INSERT INTO meta VALUES('last_compatible_version','138');
...
CREATE TABLE autofill_ai_entities (guid TEXT NOT NULL PRIMARY KEY, entity_type TEXT NOT NULL, nickname TEXT NOT NULL, date_modified INTEGER NOT NULL);
COMMIT;
