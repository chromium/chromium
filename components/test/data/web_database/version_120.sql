...
INSERT INTO meta VALUES('version','120');
INSERT INTO meta VALUES('last_compatible_version','119');
...
CREATE TABLE bank_accounts (instrument_id INTEGER PRIMARY KEY NOT NULL, bank_name VARCHAR, account_number_suffix VARCHAR, account_type INTEGER DEFAULT 0);
CREATE TABLE payment_instruments (instrument_id INTEGER NOT NULL, instrument_type INTEGER NOT NULL, display_icon_url VARCHAR, nickname VARCHAR, PRIMARY KEY (instrument_id, instrument_type));
...
CREATE TABLE payment_instrument_supported_rails (instrument_id INTEGER NOT NULL, instrument_type INTEGER NOT NULL, payment_rail INTEGER NOT NULL, PRIMARY KEY (instrument_id, instrument_type, payment_rail));
COMMIT;
