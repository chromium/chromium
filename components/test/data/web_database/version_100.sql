...
INSERT INTO meta VALUES('version','100');
...
CREATE TABLE credit_card_art_images ( id VARCHAR NOT NULL DEFAULT 0, instrument_id INTEGER DEFAULT 0, card_art_image BLOB);
