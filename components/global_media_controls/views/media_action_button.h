...
#ifndef COMPONENTS_GLOBAL_MEDIA_CONTROLS_VIEWS_MEDIA_ACTION_BUTTON_H_
#define COMPONENTS_GLOBAL_MEDIA_CONTROLS_VIEWS_MEDIA_ACTION_BUTTON_H_
...
#endif  // COMPONENTS_GLOBAL_MEDIA_CONTROLS_VIEWS_MEDIA_ACTION_BUTTON_H_
