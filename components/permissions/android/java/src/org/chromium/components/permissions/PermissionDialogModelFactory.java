...
class PermissionDialogModelFactory {
    public static PropertyModel getModel(
        ...
        return new PropertyModel.Builder(ModalDialogProperties.ALL_KEYS)
                ...
                .with(ModalDialogProperties.POSITIVE_BUTTON_TEXT, delegate.getPositiveButtonText())
                .with(ModalDialogProperties.NEGATIVE_BUTTON_TEXT, delegate.getNegativeButtonText())
