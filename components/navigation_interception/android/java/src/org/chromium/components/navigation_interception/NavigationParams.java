...
public class NavigationParams {
    ...
    public NavigationParams(String url, String referrer, int navigationId, boolean isPost,
    ...
    @CalledByNative
    public static NavigationParams create(String url, String referrer, int navigationId,
