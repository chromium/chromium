...
#ifndef COMPONENTS_HISTORY_CORE_TEST_THUMBNAIL_INL_H_
#define COMPONENTS_HISTORY_CORE_TEST_THUMBNAIL_INL_H_
...
#endif  // COMPONENTS_HISTORY_CORE_TEST_THUMBNAIL_INL_H_
