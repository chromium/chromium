...
class ProfileCloudPolicyManagerTest : public testing::Test {
 public:
  ProfileCloudPolicyManagerTest(const ProfileCloudPolicyManagerTest&) = delete;
  ProfileCloudPolicyManagerTest& operator=(
      const ProfileCloudPolicyManagerTest&) = delete;

 protected:
  ProfileCloudPolicyManagerTest() : store_(nullptr) {}
