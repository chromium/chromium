...
// Enterprise.UserRemoteCommand.Executed.BrowserRestart
...
// Enterprise.DeviceRemoteCommand.Executed.BrowserRestart
...
// Enterprise.CBCMRemoteCommand.Executed.BrowserRestart
