...
class RequestHandlerForClientCertProvisioning
 ...
 protected:
  ...
  ~RequestHandlerForClientCertProvisioning() override = default;
...
TEST_F(RequestHandlerForClientCertProvisioning,
...
TEST_F(RequestHandlerForClientCertProvisioning, HandleNoSpecificRequest_Fails) {
  em::DeviceManagementRequest device_management_request;
  SetPayload(device_management_request);
