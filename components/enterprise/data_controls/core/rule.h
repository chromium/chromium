...
#ifndef COMPONENTS_ENTERPRISE_DATA_CONTROLS_CORE_RULE_H_
#define COMPONENTS_ENTERPRISE_DATA_CONTROLS_CORE_RULE_H_
...
#endif  // COMPONENTS_ENTERPRISE_DATA_CONTROLS_CORE_RULE_H_
