...
#ifndef COMPONENTS_ENTERPRISE_DATA_CONTROLS_CORE_CONDITIONS_CONDITION_H_
#define COMPONENTS_ENTERPRISE_DATA_CONTROLS_CORE_CONDITIONS_CONDITION_H_
...
#endif  // COMPONENTS_ENTERPRISE_DATA_CONTROLS_CORE_CONDITIONS_CONDITION_H_
