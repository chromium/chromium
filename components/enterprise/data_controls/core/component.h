...
#ifndef COMPONENTS_ENTERPRISE_DATA_CONTROLS_CORE_COMPONENT_H_
#define COMPONENTS_ENTERPRISE_DATA_CONTROLS_CORE_COMPONENT_H_
...
#endif  // COMPONENTS_ENTERPRISE_DATA_CONTROLS_CORE_COMPONENT_H_
