...
class MultipartUploadRequest : public ConnectorUploadRequest {
 public:
  ...
  // Creates a ConnectorUploadRequest, which will upload `data` to the given
  // `base_url` with `metadata` attached.
  ...
  // Creates a ConnectorUploadRequest, which will upload the file
  ...
  // Creates a ConnectorUploadRequest, which will upload the page in
  // `page_region` to the given `base_url` with `metadata` attached.
