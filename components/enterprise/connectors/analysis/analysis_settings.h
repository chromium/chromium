...
#ifndef COMPONENTS_ENTERPRISE_CONNECTORS_ANALYSIS_ANALYSIS_SETTINGS_H_
#define COMPONENTS_ENTERPRISE_CONNECTORS_ANALYSIS_ANALYSIS_SETTINGS_H_
...
#endif  // COMPONENTS_ENTERPRISE_CONNECTORS_ANALYSIS_ANALYSIS_SETTINGS_H_
