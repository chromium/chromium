...
#ifndef COMPONENTS_SUBRESOURCE_FILTER_CONTENT_COMMON_UTILS_H_
#define COMPONENTS_SUBRESOURCE_FILTER_CONTENT_COMMON_UTILS_H_
...
#endif  // COMPONENTS_SUBRESOURCE_FILTER_CONTENT_COMMON_UTILS_H_
