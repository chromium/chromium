...
class PartitionedVisitedLinkWriter : public VisitedLinkCommon {
 public:
  ...
  PartitionedVisitedLinkWriter(Listener* listener,
                               VisitedLinkDelegate* delegate,
                               bool persist_to_disk,
  ...
  PartitionedVisitedLinkWriter(const PartitionedVisitedLinkWriter&) = delete;
  PartitionedVisitedLinkWriter& operator=(const PartitionedVisitedLinkWriter&) =
      delete;
