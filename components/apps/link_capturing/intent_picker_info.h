...
#ifndef COMPONENTS_APPS_LINK_CAPTURING_INTENT_PICKER_INFO_H_
#define COMPONENTS_APPS_LINK_CAPTURING_INTENT_PICKER_INFO_H_
...
#endif  // COMPONENTS_APPS_LINK_CAPTURING_INTENT_PICKER_INFO_H_
