...
#ifndef COMPONENTS_AUTOFILL_CONTENT_RENDERER_TEST_UTIL_H_
#define COMPONENTS_AUTOFILL_CONTENT_RENDERER_TEST_UTIL_H_
...
#endif  // COMPONENTS_AUTOFILL_CONTENT_RENDERER_TEST_UTIL_H_
