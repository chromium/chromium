...
#ifndef COMPONENTS_AUTOFILL_CORE_COMMON_TEST_UTILS_AUTOFILL_FORM_TEST_UTIL_H_
#define COMPONENTS_AUTOFILL_CORE_COMMON_TEST_UTILS_AUTOFILL_FORM_TEST_UTIL_H_
...
struct FieldDescription {
  ...
  // LINT.ThenChange(//components/autofill/core/common/test_utils/autofill_form_test_util.cc:FormFieldDescriptionEq)
};
...
#endif  // COMPONENTS_AUTOFILL_CORE_COMMON_TEST_UTILS_AUTOFILL_FORM_TEST_UTIL_H_
