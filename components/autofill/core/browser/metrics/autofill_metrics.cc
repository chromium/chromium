...
void AutofillMetrics::
  ...
  using AutocompleteCategory =
      AutofillMetrics::AutocompleteCategoryForStructuredAddressMetric;
  AutocompleteCategory autocomplete_metric;
  switch (field.html_type()) {
    case HtmlFieldType::kAddressLine1:
    case HtmlFieldType::kAddressLine2:
      autocomplete_metric = AutocompleteCategory::kAddressLine1Or2;
      break;
    case HtmlFieldType::kUnrecognized:
      autocomplete_metric = AutocompleteCategory::kUnrecognized;
      break;
    case HtmlFieldType::kUnspecified:
      autocomplete_metric = AutocompleteCategory::kUnspecified;
      break;
    default:
      autocomplete_metric = AutocompleteCategory::kOtherRecognized;
      break;
  }
