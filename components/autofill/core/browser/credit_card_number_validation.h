...
#ifndef COMPONENTS_AUTOFILL_CORE_BROWSER_CREDIT_CARD_NUMBER_VALIDATION_H_
#define COMPONENTS_AUTOFILL_CORE_BROWSER_CREDIT_CARD_NUMBER_VALIDATION_H_
...
#endif  // COMPONENTS_AUTOFILL_CORE_BROWSER_CREDIT_CARD_NUMBER_VALIDATION_H_
