...
class EntityType final {
 public:
  ...
  //
  // Defined in entity_type_funcs.h generated by transpile_entity_schema.py.
  DenseSet<AttributeTypeName> attributes() const;
  ...
  //
  // Defined in entity_type_funcs.h generated by transpile_entity_schema.py.
  base::span<const DenseSet<AttributeTypeName>> unique_keys() const;
  ...
  //
  // Defined in entity_type_funcs.h generated by transpile_entity_schema.py.
  base::span<const DenseSet<AttributeTypeName>> required_attributes() const;
