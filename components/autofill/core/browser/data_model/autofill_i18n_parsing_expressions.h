...
constexpr char kRegularExpression_38[] = "(?P<ADDRESS_HOME_APT_NUM>(?P<UNKNOWN_TYPE__1>(?:apto\\.?|apt\\.?|apartamento|sala nº|sala|conjunto))(?:(?:^|\\s+)(?P<UNKNOWN_TYPE__2>(?:\\d+\\w?\\b|\\w\\b))))"; // nocheck
...
constexpr char kRegularExpression_42[] = "(?P<ADDRESS_HOME_APT_NUM>(?P<UNKNOWN_TYPE__1>(?:apto\\.?|apt\\.?|apartamento|sala nº|sala|conjunto))?(?:(?:^|\\s+)(?P<UNKNOWN_TYPE__2>(?:\\d+\\w?\\b|\\w\\b))))"; // nocheck
...
constexpr char kRegularExpression_52[] = "(?P<ADDRESS_HOME_APT_NUM>(?P<UNKNOWN_TYPE__1>(?:despacho|loc\\.?|local|int(?:erior|\\.?)|n[uú]m(?:ero|\\.)? int(?:erno|\\.)?|Apartamento|Apto\\.?|Departamento|apto\\.?))(?:(?:^|\\s+)(?P<UNKNOWN_TYPE__2>(?:\\d+\\w?\\b|\\w\\b))\\b))"; // nocheck
...
constexpr char kRegularExpression_56[] = "(?P<ADDRESS_HOME_APT_NUM>(?P<UNKNOWN_TYPE__1>(?:despacho|loc\\.?|local|int(?:erior|\\.?)|n[uú]m(?:ero|\\.)? int(?:erno|\\.)?|Apartamento|Apto\\.?|Departamento|apto\\.?))?(?:(?:^|\\s+)(?P<UNKNOWN_TYPE__2>(?:\\d+\\w?\\b|\\w\\b))))"; // nocheck
