...
// Implementation of StrikeDatabaseIntegratorBase for offering save CVC dialogs.
class CvcStorageStrikeDatabase : public StrikeDatabaseIntegratorBase {
 public:
  explicit CvcStorageStrikeDatabase(StrikeDatabase* strike_database);
