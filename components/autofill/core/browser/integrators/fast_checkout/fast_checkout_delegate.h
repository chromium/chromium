...
#ifndef COMPONENTS_AUTOFILL_CORE_BROWSER_INTEGRATORS_FAST_CHECKOUT_FAST_CHECKOUT_DELEGATE_H_
#define COMPONENTS_AUTOFILL_CORE_BROWSER_INTEGRATORS_FAST_CHECKOUT_FAST_CHECKOUT_DELEGATE_H_
...
#endif  // COMPONENTS_AUTOFILL_CORE_BROWSER_INTEGRATORS_FAST_CHECKOUT_FAST_CHECKOUT_DELEGATE_H_
