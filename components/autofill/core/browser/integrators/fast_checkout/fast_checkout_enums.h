...
#ifndef COMPONENTS_AUTOFILL_CORE_BROWSER_INTEGRATORS_FAST_CHECKOUT_FAST_CHECKOUT_ENUMS_H_
#define COMPONENTS_AUTOFILL_CORE_BROWSER_INTEGRATORS_FAST_CHECKOUT_FAST_CHECKOUT_ENUMS_H_
...
#endif  // COMPONENTS_AUTOFILL_CORE_BROWSER_INTEGRATORS_FAST_CHECKOUT_FAST_CHECKOUT_ENUMS_H_
