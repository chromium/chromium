...
#ifndef COMPONENTS_SAVED_TAB_GROUPS_EMPTY_TAB_GROUP_SYNC_DELEGATE_H_
#define COMPONENTS_SAVED_TAB_GROUPS_EMPTY_TAB_GROUP_SYNC_DELEGATE_H_
...
#endif  // COMPONENTS_SAVED_TAB_GROUPS_EMPTY_TAB_GROUP_SYNC_DELEGATE_H_
