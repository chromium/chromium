...
#include "components/multistep_filter/core/logging/filter_metrics_logger.h"
...
TEST(FilterMetricsLoggerTest, NoSuggestionShownRecordsNoSamples) {
  base::HistogramTester histogram_tester;
  {
    FilterMetricsLogger logger("SEARCH_ACCOMMODATIONS");
  }
...
// destruction.
TEST(FilterMetricsLoggerTest, InitialCueShownAndIgnoredRecordsSample) {
  base::HistogramTester histogram_tester;
  {
    FilterMetricsLogger logger("SEARCH_ACCOMMODATIONS");
...
TEST(FilterMetricsLoggerTest, InitialCueExplicitDecisionRecordsSample) {
  base::HistogramTester histogram_tester;
  {
    FilterMetricsLogger logger("SEARCH_ACCOMMODATIONS");
    logger.RecordInitialCueShown();
...
TEST(FilterMetricsLoggerTest, ReopenedCueExplicitDecisionRecordsSample) {
  base::HistogramTester histogram_tester;
  {
    FilterMetricsLogger logger("SEARCH_FLIGHTS");
...
TEST(FilterMetricsLoggerTest, ReopenedCueMultipleTimesRecordsSingleSample) {
  base::HistogramTester histogram_tester;
  {
    FilterMetricsLogger logger("SEARCH_FLIGHTS");
    logger.RecordInitialCueShown();
