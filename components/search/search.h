...
// cryptographic and resolves to `SEARCH_ENGINE_GOOGLE`. If `template_url`
// specifies a suggestions URL, that URL must also be cryptographic and resolve
// to `SEARCH_ENGINE_GOOGLE`.
