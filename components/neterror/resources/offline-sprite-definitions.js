  ...
  altgame: {
    ...
    OBSTACLES: [
      ...
      },
      {
        ...
        minSpeed: 0,
        collisionBoxes: [
          new CollisionBox(0, 12, 20, 44),
          new CollisionBox(20, 0, 26, 56),
          new CollisionBox(46, 18, 10, 38),
        ],
      },
      {
        type: 'OBSTACLE7',
        ...
        minSpeed: 0,
        collisionBoxes: [
          new CollisionBox(0, 10, 8, 42),
          new CollisionBox(8, 10, 22, 52),
          new CollisionBox(30, 10, 24, 42),
        ],
      },
      {
        type: 'OBSTACLE8',
