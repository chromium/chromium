...
ShellClientData::ShellClientData(test::TestClient* client)
  ...
  constexpr wl_pointer_listener kPointerListener = {
      ...
      .motion = &OnMotion,
      .button = &OnButton,
      .axis = [](void* data, wl_pointer* obj, uint32_t time, uint32_t axis,
                 wl_fixed_t value) {},
      .frame = [](void* data, wl_pointer* obj) {},
      .axis_source = [](void* data, wl_pointer* obj, uint32_t axis_source) {},
      .axis_stop = [](void* data, wl_pointer* obj, uint32_t time,
                      uint32_t axis) {},
      .axis_discrete = [](void* data, wl_pointer* obj, uint32_t axis,
                          int32_t discrete) {},
      .axis_value120 = [](void* data, wl_pointer* obj, uint32_t axis,
                          int32_t value120) {},
  };
  ...
  constexpr wl_touch_listener kTouchListener = {
      .down = &OnTouchDown,
      .up = &OnTouchUp,
      .motion = [](void* data, wl_touch* touch, uint32_t time, int32_t id,
                   wl_fixed_t x, wl_fixed_t y) {},
      .frame = [](void* data, wl_touch* touch) {},
      .cancel = [](void* data, wl_touch* touch) {},
      .shape = [](void* data, wl_touch* touch, int32_t id, wl_fixed_t major,
                  wl_fixed_t minor) {},
      .orientation = [](void* data, wl_touch* touch, int32_t id,
