...
struct AccountAvailabilityOptions {
  ...
  explicit AccountAvailabilityOptions(const std::string& email);
 ...
 private:
  ...
  AccountAvailabilityOptions(const std::string& email,
                             const std::string& gaia_id,
...
class AccountAvailabilityOptionsBuilder {
 public:
  ...
  AccountAvailabilityOptionsBuilder& WithGaiaId(const std::string& gaia_id);
  ...
  AccountAvailabilityOptions Build(const std::string& email);
