...
class COMPONENT_EXPORT(MEDIA_MESSAGE_CENTER) MediaNotificationViewModernImpl
 ...
 private:
  ...
  CheckedPtr<MediaButton> picture_in_picture_button_ = nullptr;
  CheckedPtr<views::View> notification_controls_spacer_ = nullptr;
  CheckedPtr<views::View> media_controls_container_ = nullptr;
  CheckedPtr<MediaButton> play_pause_button_ = nullptr;
  CheckedPtr<MediaControlsProgressView> progress_ = nullptr;
};
