...
class COMPONENT_EXPORT(MEDIA_MESSAGE_CENTER) MediaNotificationViewImpl
 ...
 private:
  ...
  CheckedPtr<views::View> header_row_controls_view_ = nullptr;
  ...
  CheckedPtr<message_center::NotificationHeaderView> header_row_ = nullptr;
  CheckedPtr<views::Label> cros_header_label_ = nullptr;
  CheckedPtr<views::View> button_row_ = nullptr;
  CheckedPtr<views::View> playback_button_container_ = nullptr;
  CheckedPtr<views::View> pip_button_separator_view_ = nullptr;
  ...
  CheckedPtr<views::View> title_artist_row_ = nullptr;
  CheckedPtr<views::Label> title_label_ = nullptr;
  CheckedPtr<views::Label> artist_label_ = nullptr;
  CheckedPtr<views::View> layout_row_ = nullptr;
  CheckedPtr<views::View> main_row_ = nullptr;

  CheckedPtr<views::BoxLayout> title_artist_row_layout_ = nullptr;
  CheckedPtr<const gfx::VectorIcon> vector_header_icon_ = nullptr;
