...
#ifndef COMPONENTS_ARC_INPUT_OVERLAY_ACTIONS_ACTION_MOVE_KEY_H_
#define COMPONENTS_ARC_INPUT_OVERLAY_ACTIONS_ACTION_MOVE_KEY_H_
...
#endif  // COMPONENTS_ARC_INPUT_OVERLAY_ACTIONS_ACTION_MOVE_KEY_H_
