...
#ifndef COMPONENTS_SYNC_TRUSTED_VAULT_TRUSTED_VAULT_REGISTRATION_VERIFIER_H_
#define COMPONENTS_SYNC_TRUSTED_VAULT_TRUSTED_VAULT_REGISTRATION_VERIFIER_H_
...
#endif  // COMPONENTS_SYNC_TRUSTED_VAULT_TRUSTED_VAULT_REGISTRATION_VERIFIER_H_
