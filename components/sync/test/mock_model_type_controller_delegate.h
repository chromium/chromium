...
#ifndef COMPONENTS_SYNC_TEST_MOCK_MODEL_TYPE_CONTROLLER_DELEGATE_H_
#define COMPONENTS_SYNC_TEST_MOCK_MODEL_TYPE_CONTROLLER_DELEGATE_H_
...
class MockModelTypeControllerDelegate : public ModelTypeControllerDelegate {
 public:
  MockModelTypeControllerDelegate();
  ~MockModelTypeControllerDelegate() override;
