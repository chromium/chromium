...
#ifndef COMPONENTS_SYNC_ENGINE_JS_SYNC_ENCRYPTION_HANDLER_OBSERVER_H_
#define COMPONENTS_SYNC_ENGINE_JS_SYNC_ENCRYPTION_HANDLER_OBSERVER_H_
...
#endif  // COMPONENTS_SYNC_ENGINE_JS_SYNC_ENCRYPTION_HANDLER_OBSERVER_H_
