...
// total_title_match_length, num_input_terms_matched_by_title.
//
// Currently, only synchronously looks up URLs from the in-memory URL Db.
// Skips non-URL suggestions or suggestions that already have history signals.
class HistoryScoringSignalsAnnotator
 ...
 private:
  ...
  // Autocomplete match is eligible to be annotated.
