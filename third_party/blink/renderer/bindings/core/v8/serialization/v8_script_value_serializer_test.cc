...
TEST(V8ScriptValueSerializerTest, RoundTripDOMPoint) {
  ...
  ASSERT_TRUE(V8DOMPoint::HasInstance(scope.GetIsolate(), result));
  DOMPoint* new_point = V8DOMPoint::ToWrappableUnsafe(result.As<v8::Object>());
...
TEST(V8ScriptValueSerializerTest, DecodeDOMPoint) {
  ...
  ASSERT_TRUE(V8DOMPoint::HasInstance(scope.GetIsolate(), result));
  DOMPoint* point = V8DOMPoint::ToWrappableUnsafe(result.As<v8::Object>());
  EXPECT_EQ(1, point->x());
  EXPECT_EQ(2, point->y());
  EXPECT_EQ(3, point->z());
  EXPECT_EQ(4, point->w());
...
TEST(V8ScriptValueSerializerTest, RoundTripDOMPointReadOnly) {
  ...
  v8::Local<v8::Value> result = RoundTrip(wrapper, scope);
  ASSERT_TRUE(V8DOMPointReadOnly::HasInstance(scope.GetIsolate(), result));
  EXPECT_FALSE(V8DOMPoint::HasInstance(scope.GetIsolate(), result));
  DOMPointReadOnly* new_point =
      V8DOMPointReadOnly::ToWrappableUnsafe(result.As<v8::Object>());
  EXPECT_NE(point, new_point);
  EXPECT_EQ(point->x(), new_point->x());
  EXPECT_EQ(point->y(), new_point->y());
  EXPECT_EQ(point->z(), new_point->z());
...
TEST(V8ScriptValueSerializerTest, RoundTripDOMRect) {
  ...
  v8::Local<v8::Value> result = RoundTrip(wrapper, scope);
  ASSERT_TRUE(V8DOMRect::HasInstance(scope.GetIsolate(), result));
  DOMRect* new_rect = V8DOMRect::ToWrappableUnsafe(result.As<v8::Object>());
...
TEST(V8ScriptValueSerializerTest, DecodeDOMRect) {
  ...
  v8::Local<v8::Value> result =
      V8ScriptValueDeserializer(script_state, input).Deserialize();
  ASSERT_TRUE(V8DOMRect::HasInstance(scope.GetIsolate(), result));
  DOMRect* rect = V8DOMRect::ToWrappableUnsafe(result.As<v8::Object>());
  EXPECT_EQ(1, rect->x());
  EXPECT_EQ(2, rect->y());
...
TEST(V8ScriptValueSerializerTest, RoundTripDOMRectReadOnly) {
  ...
  v8::Local<v8::Value> wrapper =
      ToV8(rect, scope.GetContext()->Global(), scope.GetIsolate());
  v8::Local<v8::Value> result = RoundTrip(wrapper, scope);
  ASSERT_TRUE(V8DOMRectReadOnly::HasInstance(scope.GetIsolate(), result));
  EXPECT_FALSE(V8DOMRect::HasInstance(scope.GetIsolate(), result));
  DOMRectReadOnly* new_rect =
      V8DOMRectReadOnly::ToWrappableUnsafe(result.As<v8::Object>());
  EXPECT_NE(rect, new_rect);
  EXPECT_EQ(rect->x(), new_rect->x());
  EXPECT_EQ(rect->y(), new_rect->y());
  EXPECT_EQ(rect->width(), new_rect->width());
...
TEST(V8ScriptValueSerializerTest, RoundTripDOMQuad) {
  ...
  v8::Local<v8::Value> result = RoundTrip(wrapper, scope);
  ASSERT_TRUE(V8DOMQuad::HasInstance(scope.GetIsolate(), result));
  DOMQuad* new_quad = V8DOMQuad::ToWrappableUnsafe(result.As<v8::Object>());
...
TEST(V8ScriptValueSerializerTest, DecodeDOMQuad) {
  ...
  v8::Local<v8::Value> result =
      V8ScriptValueDeserializer(script_state, input).Deserialize();
  ASSERT_TRUE(V8DOMQuad::HasInstance(scope.GetIsolate(), result));
  DOMQuad* quad = V8DOMQuad::ToWrappableUnsafe(result.As<v8::Object>());
...
TEST(V8ScriptValueSerializerTest, RoundTripDOMMatrix2D) {
  ...
  v8::Local<v8::Value> result = RoundTrip(wrapper, scope);
  ASSERT_TRUE(V8DOMMatrix::HasInstance(scope.GetIsolate(), result));
  DOMMatrix* new_matrix =
      V8DOMMatrix::ToWrappableUnsafe(result.As<v8::Object>());
...
TEST(V8ScriptValueSerializerTest, DecodeDOMMatrix2D) {
  ...
  v8::Local<v8::Value> result =
      V8ScriptValueDeserializer(script_state, input).Deserialize();
  ASSERT_TRUE(V8DOMMatrix::HasInstance(scope.GetIsolate(), result));
  DOMMatrix* matrix = V8DOMMatrix::ToWrappableUnsafe(result.As<v8::Object>());
  EXPECT_TRUE(matrix->is2D());
...
TEST(V8ScriptValueSerializerTest, RoundTripDOMMatrixReadOnly2D) {
  ...
  v8::Local<v8::Value> wrapper =
      ToV8(matrix, scope.GetContext()->Global(), scope.GetIsolate());
  v8::Local<v8::Value> result = RoundTrip(wrapper, scope);
  ASSERT_TRUE(V8DOMMatrixReadOnly::HasInstance(scope.GetIsolate(), result));
  EXPECT_FALSE(V8DOMMatrix::HasInstance(scope.GetIsolate(), result));
  DOMMatrixReadOnly* new_matrix =
      V8DOMMatrixReadOnly::ToWrappableUnsafe(result.As<v8::Object>());
  EXPECT_NE(matrix, new_matrix);
  EXPECT_TRUE(new_matrix->is2D());
  EXPECT_EQ(matrix->a(), new_matrix->a());
  EXPECT_EQ(matrix->b(), new_matrix->b());
...
TEST(V8ScriptValueSerializerTest, RoundTripImageData) {
  ...
  v8::Local<v8::Value> result = RoundTrip(wrapper, scope);
  ASSERT_TRUE(V8ImageData::HasInstance(scope.GetIsolate(), result));
  ImageData* new_image_data =
      V8ImageData::ToWrappableUnsafe(result.As<v8::Object>());
...
TEST(V8ScriptValueSerializerTest, RoundTripMessagePort) {
  ...
  ASSERT_TRUE(V8MessagePort::HasInstance(scope.GetIsolate(), result));
  MessagePort* new_port =
      V8MessagePort::ToWrappableUnsafe(result.As<v8::Object>());
...
TEST(V8ScriptValueSerializerTest, OutOfRangeMessagePortIndex) {
  ...
  }
  {
    ...
    ASSERT_TRUE(V8MessagePort::HasInstance(scope.GetIsolate(), result));
    EXPECT_EQ(port2, V8MessagePort::ToWrappableUnsafe(result.As<v8::Object>()));
  }
}
...
TEST(V8ScriptValueSerializerTest, RoundTripMojoHandle) {
  ...
  v8::Local<v8::Value> result =
      RoundTrip(wrapper, scope, nullptr, &transferables);
  ASSERT_TRUE(V8MojoHandle::HasInstance(scope.GetIsolate(), result));
  MojoHandle* new_handle =
      V8MojoHandle::ToWrappableUnsafe(result.As<v8::Object>());
...
TEST(V8ScriptValueSerializerTest, RoundTripImageBitmap) {
  ...
  v8::Local<v8::Value> result = RoundTrip(wrapper, scope);
  ASSERT_TRUE(V8ImageBitmap::HasInstance(scope.GetIsolate(), result));
  ImageBitmap* new_image_bitmap =
      V8ImageBitmap::ToWrappableUnsafe(result.As<v8::Object>());
...
TEST(V8ScriptValueSerializerTest, TransferOffscreenCanvas) {
  ...
  v8::Local<v8::Value> result =
      RoundTrip(wrapper, scope, nullptr, &transferables);
  ASSERT_TRUE(V8OffscreenCanvas::HasInstance(scope.GetIsolate(), result));
  OffscreenCanvas* new_canvas =
      V8OffscreenCanvas::ToWrappableUnsafe(result.As<v8::Object>());
...
TEST(V8ScriptValueSerializerTest, RoundTripBlob) {
  ...
  v8::Local<v8::Value> result = RoundTrip(wrapper, scope);
  ASSERT_TRUE(V8Blob::HasInstance(scope.GetIsolate(), result));
  Blob* new_blob = V8Blob::ToWrappableUnsafe(result.As<v8::Object>());
...
TEST(V8ScriptValueSerializerTest, RoundTripFileNative) {
  ...
  v8::Local<v8::Value> result = RoundTrip(wrapper, scope);
  ASSERT_TRUE(V8File::HasInstance(scope.GetIsolate(), result));
  File* new_file = V8File::ToWrappableUnsafe(result.As<v8::Object>());
...
TEST(V8ScriptValueSerializerTest, RoundTripFileList) {
  ...
  v8::Local<v8::Value> result = RoundTrip(wrapper, scope);
  ASSERT_TRUE(V8FileList::HasInstance(scope.GetIsolate(), result));
...
TEST(V8ScriptValueSerializerTest, RoundTripReadableStream) {
  ...
  ASSERT_TRUE(V8ReadableStream::HasInstance(isolate, result));
  ReadableStream* transferred =
      V8ReadableStream::ToWrappableUnsafe(result.As<v8::Object>());
...
TEST(V8ScriptValueSerializerTest, RoundTripDOMException) {
  ...
  v8::Local<v8::Value> result = RoundTrip(wrapper, scope);
  ASSERT_TRUE(V8DOMException::HasInstance(scope.GetIsolate(), result));
  DOMException* new_exception =
      V8DOMException::ToWrappableUnsafe(result.As<v8::Object>());
