...
TEST(ResolveSamplingParamsOptionTest, NoSamplingParams) {
  auto* options = MakeGarbageCollected<AILanguageModelCreateCoreOptions>();
...
TEST(ResolveSamplingParamsOptionTest, ValidOptions) {
  ...
  auto* options2 = MakeGarbageCollected<AILanguageModelCreateCoreOptions>();
  options2->setTopK(10);
  ...
  auto* options3 = MakeGarbageCollected<AILanguageModelCreateCoreOptions>();
  options3->setTopK(10);
