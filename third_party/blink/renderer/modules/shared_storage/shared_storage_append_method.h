...
class MODULES_EXPORT SharedStorageAppendMethod : public ScriptWrappable {
 ...
 public:
  static SharedStorageAppendMethod* Create(ScriptState*,
                                           const String& key,
                                           const String& value,
                                           ExceptionState&);
  static SharedStorageAppendMethod* Create(
      ScriptState*,
      const String& key,
      const String& value,
  ...
  SharedStorageAppendMethod(ScriptState*,
                            const String& key,
                            const String& value,
                            const SharedStorageModifierMethodOptions*,
                            ExceptionState&);
...
#endif  // THIRD_PARTY_BLINK_RENDERER_MODULES_SHARED_STORAGE_SHARED_STORAGE_APPEND_METHOD_H_
