...
class WebMediaPlayerMSTest
 ...
 protected:
  ...
  CheckedPtr<MockRenderFactory> render_factory_;
  ...
  CheckedPtr<WebMediaPlayerMSCompositor> compositor_;
  ReusableMessageLoopEvent message_loop_controller_;
  CheckedPtr<cc::Layer> layer_;
  ...
  CheckedPtr<NiceMock<MockSurfaceLayerBridge>> surface_layer_bridge_ptr_ =
      nullptr;
  CheckedPtr<NiceMock<MockWebVideoFrameSubmitter>> submitter_ptr_ = nullptr;
