...
const TimelineTriggerRange::Boundary* TimelineTriggerRange::rangeStart(
    ExecutionContext* execution_context) {
  return range_start_;
}
const TimelineTriggerRange::Boundary* TimelineTriggerRange::rangeEnd(
    ExecutionContext* execution_context) {
  return range_end_;
}
const TimelineTriggerRange::Boundary* TimelineTriggerRange::exitRangeStart(
    ExecutionContext* execution_context) {
  return exit_range_start_;
}
const TimelineTriggerRange::Boundary* TimelineTriggerRange::exitRangeEnd(
    ExecutionContext* execution_context) {
