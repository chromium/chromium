...
#ifndef THIRD_PARTY_BLINK_RENDERER_CORE_LAYOUT_NG_NG_BASELINE_UTILS_H_
#define THIRD_PARTY_BLINK_RENDERER_CORE_LAYOUT_NG_NG_BASELINE_UTILS_H_
...
#endif  // THIRD_PARTY_BLINK_RENDERER_CORE_LAYOUT_NG_NG_BASELINE_UTILS_H_
