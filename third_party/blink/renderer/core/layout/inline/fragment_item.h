...
struct SvgFragmentData : public RefCounted<SvgFragmentData> {
...
class CORE_EXPORT FragmentItem final {
 ...
 public:
  ...
  struct TextItem {
    ...
    scoped_refptr<const SvgFragmentData> svg_data;
  ...
  void SetSvgFragmentData(scoped_refptr<const SvgFragmentData> data,
