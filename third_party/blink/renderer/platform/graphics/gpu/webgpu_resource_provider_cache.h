...
class PLATFORM_EXPORT RecyclableCanvasResource {
 ...
 private:
  std::unique_ptr<CanvasResourceProviderSharedImageNon2D> resource_provider_;
...
class PLATFORM_EXPORT WebGPURecyclableResourceCache {
 ...
 private:
  ...
  struct PLATFORM_EXPORT Resource {
    Resource(std::unique_ptr<CanvasResourceProviderSharedImageNon2D>
                 resource_provider,
  ...
  std::unique_ptr<CanvasResourceProviderSharedImageNon2D> AcquireCachedProvider(
      const gfx::Size& size,
