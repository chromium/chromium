...
class PLATFORM_EXPORT GeometryMapperClipCache {
 ...
 public:
  ...
  struct ClipAndTransform {
   ...
   public:
    raw_ptr<const ClipPaintPropertyNode> ancestor_clip;
    raw_ptr<const TransformPaintPropertyNode> ancestor_transform;
 ...
 private:
  ...
  raw_ptr<const ClipPaintPropertyNode> nearest_pixel_moving_filter_clip_ =
      nullptr;
