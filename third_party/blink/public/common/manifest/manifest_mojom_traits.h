...
template <>
struct BLINK_COMMON_EXPORT
    StructTraits<blink::mojom::ManifestUrlPatternDataView,
                 ::blink::Manifest::UrlPattern> {
  static const std::vector<liburlpattern::Part>& pathname(
      const ::blink::Manifest::UrlPattern& pattern) {
    return pattern.pathname;
  }

  static bool Read(blink::mojom::ManifestUrlPatternDataView data,
...
struct BLINK_COMMON_EXPORT StructTraits<blink::mojom::HomeTabParamsDataView,
  ...
  static const std::vector<::blink::Manifest::UrlPattern>& scope_patterns(
      const ::blink::Manifest::HomeTabParams& params) {
