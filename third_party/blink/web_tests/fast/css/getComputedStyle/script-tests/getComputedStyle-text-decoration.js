...
testComputedStyle("textDecoration", "rgb(0, 0, 0)");
debug('');
...
testComputedStyle("textDecoration", "underline rgb(0, 0, 0)");
debug('');

debug("Value 'overline':");
e.style.textDecoration = 'overline';
testComputedStyle("textDecoration", "overline rgb(0, 0, 0)");
debug('');

debug("Value 'line-through':");
e.style.textDecoration = 'line-through';
testComputedStyle("textDecoration", "line-through rgb(0, 0, 0)");
debug('');

debug("Value 'underline overline line-through':");
e.style.textDecoration = 'underline overline line-through';
testComputedStyle("textDecoration", "underline overline line-through rgb(0, 0, 0)");
debug('');

debug("Value 'blink' (valid but ignored):");
e.style.textDecoration = 'blink';
testComputedStyle("textDecoration", "blink rgb(0, 0, 0)");
debug('');
