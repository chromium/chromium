...
const roundEvenTests = [
  ...
  {
    'name': 'roundEven float32 large 4D tensor with 5 chained operators',
    'graph': {
      'inputs': {
        'roundEvenInput': {
          'data': new Array(1000 * 1000).fill([-1.5, -2.5, 1.5, 2.5]).flat(),
          'descriptor': {shape: [1, 1000, 1000, 4], dataType: 'float32'}
        }
      },
      'operators': [
        {
          'name': 'roundEven',
          'arguments': [{'input': 'roundEvenInput'}],
          'outputs': 'roundEvenOutput1'
        },
        {
          'name': 'roundEven',
          'arguments': [{'input': 'roundEvenOutput1'}],
          'outputs': 'roundEvenOutput2'
        },
        {
          'name': 'roundEven',
          'arguments': [{'input': 'roundEvenOutput2'}],
          'outputs': 'roundEvenOutput3'
        },
        {
          'name': 'roundEven',
          'arguments': [{'input': 'roundEvenOutput3'}],
          'outputs': 'roundEvenOutput4'
        },
        {
          'name': 'roundEven',
          'arguments': [{'input': 'roundEvenOutput4'}],
          'outputs': 'roundEvenOutput'
        }
      ],
      'expectedOutputs': {
        'roundEvenOutput': {
          'data': new Array(1000 * 1000).fill([-2, -2, 2, 2]).flat(),
          'descriptor': {shape: [1, 1000, 1000, 4], dataType: 'float32'}
        }
      }
    }
  ...
  {
    'name': 'roundEven float16 large 4D tensor with 5 chained operators',
    'graph': {
      'inputs': {
        'roundEvenInput': {
          'data': new Array(1000 * 1000).fill([-1.5, -2.5, 1.5, 2.5]).flat(),
          'descriptor': {shape: [1, 1000, 1000, 4], dataType: 'float16'}
        }
      },
      'operators': [
        {
