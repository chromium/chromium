...
if ($_SERVER['QUERY_STRING'] != "start")
  exit;
?>
<script src="/low-priority-async-script-execution/resources/inert.js" async></script>
<script src="/low-priority-async-script-execution/resources/lcp-img-create.js" async></script>
<script src="/low-priority-async-script-execution/resources/lcp-img-insert.js" async></script>
<script>
  assert_implements(window.LargestContentfulPaint, "LargestContentfulPaint is not implemented");

  promise_test(async t => {
    const url = new URL('/low-priority-async-script-execution/resources/lcp-img-insert.js', location).toString();
    ...
    const url2 = new URL('/low-priority-async-script-execution/resources/lcp-img-create.js', location).toString();
  ...
  promise_test(async t => {
    const url = new URL('/low-priority-async-script-execution/resources/inert.js', location).toString();
