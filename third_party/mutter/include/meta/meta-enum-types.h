...
META_EXPORT GType meta_inhibit_shortcuts_dialog_response_get_type (void) G_GNUC_CONST;
#define META_TYPE_INHIBIT_SHORTCUTS_DIALOG_RESPONSE (meta_inhibit_shortcuts_dialog_response_get_type())
...
#define META_TYPE_MONITOR_SWITCH_CONFIG_TYPE (meta_monitor_switch_config_type_get_type())
META_EXPORT GType meta_power_save_change_reason_get_type (void) G_GNUC_CONST;
#define META_TYPE_POWER_SAVE_CHANGE_REASON (meta_power_save_change_reason_get_type())
