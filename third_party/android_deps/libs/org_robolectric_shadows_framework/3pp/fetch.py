...
_FILE_URL = 'https://repo.maven.apache.org/maven2/org/robolectric/shadows-framework/4.6.1/shadows-framework-4.6.1.jar'
_FILE_NAME = 'shadows-framework-4.6.1.jar'
_FILE_VERSION = '4.6.1'
