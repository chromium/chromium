...
_FILE_URL = 'https://repo.maven.apache.org/maven2/org/robolectric/shadows-framework/4.5.1/shadows-framework-4.5.1.jar'
_FILE_NAME = 'shadows-framework-4.5.1.jar'
_FILE_VERSION = '4.5.1'
