...
#include "third_party/jni_zero/samples/jni_sample_header/SampleForAnnotationProcessor_jni.h"  // Generated by JNI.
#include "third_party/jni_zero/samples/jni_sample_header/SampleForTests_jni.h"  // Generated by JNI.
