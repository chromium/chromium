...
#include <stdio.h>
    ...
    #define BUILD_NETWORK_C_WRAPPER(...) OPENCV_C_EXTERN __VA_ARGS__
            ...
            #define BUILD_NETWORK_C_WRAPPER(...) OPENCV_C_EXTERN   __declspec(dllexport) __VA_ARGS__ __cdecl
        #else
            #define BUILD_NETWORK_C_WRAPPER(...) OPENCV_C_EXTERN  __declspec(dllimport) __VA_ARGS__ __cdecl
        #endif
    #else
        #define BUILD_NETWORK_C_WRAPPER(...) OPENCV_C_EXTERN __attribute__((visibility("default"))) __VA_ARGS__
    #endif
#endif
 ...
 * @return Status code of the operation: OK(0) for success.
 */
BUILD_NETWORK_C_WRAPPER(int32_t) ie_model_add_operand(ie_model_t *model,
 ...
 * @return Status code of the operation: OK(0) for success.
 */
BUILD_NETWORK_C_WRAPPER(int32_t) ie_model_set_operand_value(ie_model_t *model,
                                                            uint32_t index,
                                                            const void* buffer,
                                                                            size_t length);
 ...
 * @return Status code of the operation: OK(0) for success.
 */
BUILD_NETWORK_C_WRAPPER(int32_t) ie_model_add_operation(ie_model_t *model,
                                                        int32_t type,
                                                        uint32_t inputCount,
 ...
 * @return Status code of the operation: OK(0) for success.
 */
BUILD_NETWORK_C_WRAPPER(int32_t) ie_model_identify_inputs_outputs(ie_model_t *model,
                                                                uint32_t inputCount,
                                                                const uint32_t* inputs,
                                                                uint32_t outputCount,
                                                                const uint32_t* outputs);
 ...
 * @return Status code of the operation: OK(0) for success.
 */
BUILD_NETWORK_C_WRAPPER(int32_t) ie_compilation_create(ie_model_t* model,
 ...
 * @return Status code of the operation: OK(0) for success.
 */
BUILD_NETWORK_C_WRAPPER(int32_t) ie_compilation_set_preference(
 ...
 * @return Status code of the operation: OK(0) for success.
 */
BUILD_NETWORK_C_WRAPPER(int32_t) ie_compilation_finish(
        ie_compilation_t* compliation);
 ...
 */
BUILD_NETWORK_C_WRAPPER(void) ie_compilation_free(ie_compilation_t *compilation);
 ...
 * @return Status code of the operation: OK(0) for success.
 */
BUILD_NETWORK_C_WRAPPER(int32_t) ie_execution_create(
 ...
 * @return Status code of the operation: OK(0) for success.
 */
BUILD_NETWORK_C_WRAPPER(int32_t) ie_execution_set_input(
 ...
 * @return Status code of the operation: OK(0) for success.
 */
BUILD_NETWORK_C_WRAPPER(int32_t) ie_execution_set_output(
        ie_execution_t* execution, uint32_t index, void* buffer, uint32_t length);
 ...
 * @return Status code of the operation: OK(0) for success.
 */
BUILD_NETWORK_C_WRAPPER(int32_t) ie_execution_start_compute(
