var mapperTab = (function () {
	...
	class BrowsingContextImpl {
	    ...
	    #browsingContextStorage;
	    #lifecycle = {
	        DOMContentLoaded: new Deferred_js_1$1.Deferred(),
	        load: new Deferred_js_1$1.Deferred(),
	    };
	    #navigation = {
	        withinDocument: new Deferred_js_1$1.Deferred(),
	    };
	    #url = 'about:blank';
	    #eventManager;
	    #realmStorage;
	    ...
	    #resetLifecycleIfFinished() {
	        ...
	        if (this.#lifecycle.load.isFinished) {
	            this.#lifecycle.load = new Deferred_js_1$1.Deferred();
	        }
	        else {
	    ...
	    async locateNodes(params) {
	        ...
	        if (params.ownership === "root" /* Script.ResultOwnership.Root */) {
	            // TODO: implement.
	            throw new protocol_js_1$h.UnsupportedOperationException(`ownership:root is not supported`);
	        }
	...
	class NetworkProcessor {
	    ...
	    #getBlockedRequestOrFail(id, phases) {
	        ...
	        if (request.currentInterceptPhase &&
	            ...
	            throw new protocol_js_1$b.InvalidArgumentException(`Blocked request for network id '${id}' is in '${request.currentInterceptPhase}' phase`);
	        }
	        return request;
	    }
	    /**
