...
mod test {
    ...
    fn test_subset_markbase_pos() {
        ...
        plan.glyph_map_gsub.insert(GlyphId::from(37_u32), GlyphId::from(1_u32));
        plan.glyph_map_gsub.insert(GlyphId::from(390_u32), GlyphId::from(3_u32));
        plan.glyph_map_gsub.insert(GlyphId::from(405_u32), GlyphId::from(4_u32));

        plan.glyphset_gsub.insert(GlyphId::from(37_u32));
        plan.glyphset_gsub.insert(GlyphId::from(390_u32));
        plan.glyphset_gsub.insert(GlyphId::from(405_u32));

        plan.layout_varidx_delta_map.insert(0x820044_u32, (0x40001_u32, 0));
        plan.layout_varidx_delta_map.insert(0x160004_u32, (0x10000_u32, 0));
        plan.layout_varidx_delta_map.insert(0x110002_u32, (0x0_u32, 0));
        plan.layout_varidx_delta_map.insert(0x820018_u32, (0x40000_u32, 0));
    ...
    fn test_subset_markbase_pos_remove_empty_base_record() {
        ...
        plan.glyph_map_gsub.insert(GlyphId::from(36_u32), GlyphId::from(1_u32));
        plan.glyph_map_gsub.insert(GlyphId::from(37_u32), GlyphId::from(2_u32));
        plan.glyph_map_gsub.insert(GlyphId::from(404_u32), GlyphId::from(4_u32));
        plan.glyph_map_gsub.insert(GlyphId::from(409_u32), GlyphId::from(5_u32));
        ...
        plan.layout_varidx_delta_map.insert(0x40001_u32, (0x0_u32, 0));
        plan.layout_varidx_delta_map.insert(0x160004_u32, (0x30000_u32, 0));
        plan.layout_varidx_delta_map.insert(0x6f000c_u32, (0x40000_u32, 0));
        plan.layout_varidx_delta_map.insert(0x830015_u32, (0x50000_u32, 0));
        plan.layout_varidx_delta_map.insert(0x860011_u32, (0x70000_u32, 0));
