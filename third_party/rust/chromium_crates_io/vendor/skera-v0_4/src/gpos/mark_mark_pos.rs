...
mod test {
    ...
    fn test_subset_markmark_pos() {
        ...
        let font =
            FontRef::new(include_bytes!("../../test-data/fonts/NotoNastaliqUrdu-Regular.ttf"))
                .unwrap();
        let gpos_lookups = font.gpos().unwrap().lookup_list().unwrap();
        ...
        plan.glyph_map_gsub.insert(GlyphId::from(66_u32), GlyphId::from(2_u32));
        plan.glyph_map_gsub.insert(GlyphId::from(67_u32), GlyphId::from(3_u32));
        plan.glyph_map_gsub.insert(GlyphId::from(70_u32), GlyphId::from(4_u32));
        plan.glyph_map_gsub.insert(GlyphId::from(74_u32), GlyphId::from(5_u32));
