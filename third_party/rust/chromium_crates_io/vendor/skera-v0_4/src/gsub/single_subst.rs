...
impl SubsetTable<'_> for SingleSubstFormat2<'_> {
    ...
    fn subset(
        ...
        for (new_g, new_sub_g) in
            cov_glyphs.iter().zip(glyph_idxes.iter()).filter_map(|(new_g, idx)| {
...
mod test {
    ...
    fn test_subset_single_subst_format1() {
        ...
        plan.glyph_map_gsub.insert(GlyphId::from(777_u32), GlyphId::from(5_u32));
        plan.glyph_map_gsub.insert(GlyphId::from(779_u32), GlyphId::from(6_u32));
    ...
    fn test_subset_single_subst_format2() {
        ...
        plan.glyph_map_gsub.insert(GlyphId::from(777_u32), GlyphId::from(5_u32));
        plan.glyph_map_gsub.insert(GlyphId::from(779_u32), GlyphId::from(6_u32));
        plan.glyph_map_gsub.insert(GlyphId::from(885_u32), GlyphId::from(7_u32));
        plan.glyph_map_gsub.insert(GlyphId::from(1282_u32), GlyphId::from(8_u32));
        ...
        plan.glyph_map_gsub.insert(GlyphId::from(73_u32), GlyphId::from(1_u32));
        plan.glyph_map_gsub.insert(GlyphId::from(75_u32), GlyphId::from(2_u32));
        plan.glyph_map_gsub.insert(GlyphId::from(485_u32), GlyphId::from(3_u32));
        plan.glyph_map_gsub.insert(GlyphId::from(552_u32), GlyphId::from(4_u32));
