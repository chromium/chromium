...
mod test {
    ...
    fn test_subset_multiple_subst() {
        ...
        plan.glyph_map_gsub.insert(GlyphId::from(362_u32), GlyphId::from(5_u32));
        plan.glyph_map_gsub.insert(GlyphId::from(512_u32), GlyphId::from(6_u32));
        plan.glyph_map_gsub.insert(GlyphId::from(966_u32), GlyphId::from(11_u32));
