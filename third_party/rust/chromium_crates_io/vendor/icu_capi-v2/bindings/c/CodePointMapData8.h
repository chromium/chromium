...
CodePointMapData8* icu4x_CodePointMapData8_create_indic_conjunct_break_mv1(void);

typedef struct icu4x_CodePointMapData8_create_indic_conjunct_break_with_provider_mv1_result {union {CodePointMapData8* ok; DataError err;}; bool is_ok;} icu4x_CodePointMapData8_create_indic_conjunct_break_with_provider_mv1_result;
icu4x_CodePointMapData8_create_indic_conjunct_break_with_provider_mv1_result icu4x_CodePointMapData8_create_indic_conjunct_break_with_provider_mv1(const DataProvider* provider);

CodePointMapData8* icu4x_CodePointMapData8_create_joining_group_mv1(void);

typedef struct icu4x_CodePointMapData8_create_joining_group_with_provider_mv1_result {union {CodePointMapData8* ok; DataError err;}; bool is_ok;} icu4x_CodePointMapData8_create_joining_group_with_provider_mv1_result;
icu4x_CodePointMapData8_create_joining_group_with_provider_mv1_result icu4x_CodePointMapData8_create_joining_group_with_provider_mv1(const DataProvider* provider);
...
CodePointMapData8* icu4x_CodePointMapData8_create_vertical_orientation_mv1(void);
