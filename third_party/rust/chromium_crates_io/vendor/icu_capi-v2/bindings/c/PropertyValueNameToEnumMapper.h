...
PropertyValueNameToEnumMapper* icu4x_PropertyValueNameToEnumMapper_create_numeric_type_mv1(void);

typedef struct icu4x_PropertyValueNameToEnumMapper_create_numeric_type_with_provider_mv1_result {union {PropertyValueNameToEnumMapper* ok; DataError err;}; bool is_ok;} icu4x_PropertyValueNameToEnumMapper_create_numeric_type_with_provider_mv1_result;
icu4x_PropertyValueNameToEnumMapper_create_numeric_type_with_provider_mv1_result icu4x_PropertyValueNameToEnumMapper_create_numeric_type_with_provider_mv1(const DataProvider* provider);
...
PropertyValueNameToEnumMapper* icu4x_PropertyValueNameToEnumMapper_create_canonical_combining_class_mv1(void);

typedef struct icu4x_PropertyValueNameToEnumMapper_create_canonical_combining_class_with_provider_mv1_result {union {PropertyValueNameToEnumMapper* ok; DataError err;}; bool is_ok;} icu4x_PropertyValueNameToEnumMapper_create_canonical_combining_class_with_provider_mv1_result;
icu4x_PropertyValueNameToEnumMapper_create_canonical_combining_class_with_provider_mv1_result icu4x_PropertyValueNameToEnumMapper_create_canonical_combining_class_with_provider_mv1(const DataProvider* provider);
...
PropertyValueNameToEnumMapper* icu4x_PropertyValueNameToEnumMapper_create_indic_conjunct_break_mv1(void);

typedef struct icu4x_PropertyValueNameToEnumMapper_create_indic_conjunct_break_with_provider_mv1_result {union {PropertyValueNameToEnumMapper* ok; DataError err;}; bool is_ok;} icu4x_PropertyValueNameToEnumMapper_create_indic_conjunct_break_with_provider_mv1_result;
icu4x_PropertyValueNameToEnumMapper_create_indic_conjunct_break_with_provider_mv1_result icu4x_PropertyValueNameToEnumMapper_create_indic_conjunct_break_with_provider_mv1(const DataProvider* provider);

PropertyValueNameToEnumMapper* icu4x_PropertyValueNameToEnumMapper_create_joining_group_mv1(void);

typedef struct icu4x_PropertyValueNameToEnumMapper_create_joining_group_with_provider_mv1_result {union {PropertyValueNameToEnumMapper* ok; DataError err;}; bool is_ok;} icu4x_PropertyValueNameToEnumMapper_create_joining_group_with_provider_mv1_result;
icu4x_PropertyValueNameToEnumMapper_create_joining_group_with_provider_mv1_result icu4x_PropertyValueNameToEnumMapper_create_joining_group_with_provider_mv1(const DataProvider* provider);

PropertyValueNameToEnumMapper* icu4x_PropertyValueNameToEnumMapper_create_joining_type_mv1(void);

typedef struct icu4x_PropertyValueNameToEnumMapper_create_joining_type_with_provider_mv1_result {union {PropertyValueNameToEnumMapper* ok; DataError err;}; bool is_ok;} icu4x_PropertyValueNameToEnumMapper_create_joining_type_with_provider_mv1_result;
icu4x_PropertyValueNameToEnumMapper_create_joining_type_with_provider_mv1_result icu4x_PropertyValueNameToEnumMapper_create_joining_type_with_provider_mv1(const DataProvider* provider);
