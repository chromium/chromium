...
typedef struct icu4x_SentenceBreak_try_from_str_mv1_result {union {SentenceBreak ok; }; bool is_ok;} icu4x_SentenceBreak_try_from_str_mv1_result;
icu4x_SentenceBreak_try_from_str_mv1_result icu4x_SentenceBreak_try_from_str_mv1(DiplomatStringView s);
