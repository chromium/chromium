...
CodePointSetData* icu4x_CodePointSetData_create_id_compat_math_continue_mv1(void);

typedef struct icu4x_CodePointSetData_create_id_compat_math_continue_with_provider_mv1_result {union {CodePointSetData* ok; DataError err;}; bool is_ok;} icu4x_CodePointSetData_create_id_compat_math_continue_with_provider_mv1_result;
icu4x_CodePointSetData_create_id_compat_math_continue_with_provider_mv1_result icu4x_CodePointSetData_create_id_compat_math_continue_with_provider_mv1(const DataProvider* provider);

bool icu4x_CodePointSetData_id_compat_math_start_for_char_mv1(char32_t ch);

CodePointSetData* icu4x_CodePointSetData_create_id_compat_math_start_mv1(void);

typedef struct icu4x_CodePointSetData_create_id_compat_math_start_with_provider_mv1_result {union {CodePointSetData* ok; DataError err;}; bool is_ok;} icu4x_CodePointSetData_create_id_compat_math_start_with_provider_mv1_result;
icu4x_CodePointSetData_create_id_compat_math_start_with_provider_mv1_result icu4x_CodePointSetData_create_id_compat_math_start_with_provider_mv1(const DataProvider* provider);
...
CodePointSetData* icu4x_CodePointSetData_create_ids_unary_operator_mv1(void);

typedef struct icu4x_CodePointSetData_create_ids_unary_operator_with_provider_mv1_result {union {CodePointSetData* ok; DataError err;}; bool is_ok;} icu4x_CodePointSetData_create_ids_unary_operator_with_provider_mv1_result;
icu4x_CodePointSetData_create_ids_unary_operator_with_provider_mv1_result icu4x_CodePointSetData_create_ids_unary_operator_with_provider_mv1(const DataProvider* provider);
...
CodePointSetData* icu4x_CodePointSetData_create_modifier_combining_mark_mv1(void);

typedef struct icu4x_CodePointSetData_create_modifier_combining_mark_with_provider_mv1_result {union {CodePointSetData* ok; DataError err;}; bool is_ok;} icu4x_CodePointSetData_create_modifier_combining_mark_with_provider_mv1_result;
icu4x_CodePointSetData_create_modifier_combining_mark_with_provider_mv1_result icu4x_CodePointSetData_create_modifier_combining_mark_with_provider_mv1(const DataProvider* provider);
