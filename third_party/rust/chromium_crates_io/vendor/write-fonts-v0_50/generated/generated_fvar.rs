...
pub struct Fvar {
    ...
    /// VariationAxisRecord array. The InstanceRecord array directly
    /// follows.
...
impl Fvar {
    ...
    pub fn new(axis_instance_arrays: AxisInstanceArrays) -> Self {
        Self { axis_instance_arrays: axis_instance_arrays.into() }
    }
}
...
impl<'a> FromObjRef<read_fonts::tables::fvar::Fvar<'a>> for Fvar {
    fn from_obj_ref(obj: &read_fonts::tables::fvar::Fvar<'a>, _: FontData) -> Self {
        Fvar { axis_instance_arrays: obj.axis_instance_arrays().to_owned_table() }
    }
}
...
impl VariationAxisRecord {
    ...
    pub fn new(
        ...
        Self { axis_tag, min_value, default_value, max_value, flags, axis_name_id }
    }
}
