...
impl Name {
    ...
    pub fn new(name_record: Vec<NameRecord>) -> Self {
        Self { name_record, ..Default::default() }
    }
}
...
impl FromObjRef<read_fonts::tables::name::LangTagRecord> for LangTagRecord {
    fn from_obj_ref(obj: &read_fonts::tables::name::LangTagRecord, offset_data: FontData) -> Self {
        LangTagRecord { lang_tag: obj.lang_tag(offset_data).to_owned_table() }
    }
}
...
impl NameRecord {
    ...
    pub fn new(
        ...
        Self { platform_id, encoding_id, language_id, name_id, string: string.into() }
    }
}
