...
impl<'a> FromObjRef<read_fonts::tables::layout::ScriptList<'a>> for ScriptList {
    fn from_obj_ref(obj: &read_fonts::tables::layout::ScriptList<'a>, _: FontData) -> Self {
        ...
        ScriptList { script_records: obj.script_records().to_owned_obj(offset_data) }
    }
}
...
impl ScriptRecord {
    ...
    pub fn new(script_tag: Tag, script: Script) -> Self {
        Self { script_tag, script: script.into() }
    }
}
...
impl Script {
    ...
    pub fn new(default_lang_sys: Option<LangSys>, lang_sys_records: Vec<LangSysRecord>) -> Self {
        Self { default_lang_sys: default_lang_sys.into(), lang_sys_records }
    }
}
...
impl LangSysRecord {
    ...
    pub fn new(lang_sys_tag: Tag, lang_sys: LangSys) -> Self {
        Self { lang_sys_tag, lang_sys: lang_sys.into() }
    }
}
...
impl Default for LangSys {
    fn default() -> Self {
        Self { required_feature_index: 0xFFFF, feature_indices: Default::default() }
    }
}
...
impl LangSys {
    ...
    pub fn new(feature_indices: Vec<u16>) -> Self {
        Self { feature_indices, ..Default::default() }
    }
}
...
impl<'a> FromObjRef<read_fonts::tables::layout::FeatureList<'a>> for FeatureList {
    fn from_obj_ref(obj: &read_fonts::tables::layout::FeatureList<'a>, _: FontData) -> Self {
        let offset_data = obj.offset_data();
        FeatureList { feature_records: obj.feature_records().to_owned_obj(offset_data) }
    }
}
...
impl FeatureRecord {
    ...
    pub fn new(feature_tag: Tag, feature: Feature) -> Self {
        Self { feature_tag, feature: feature.into() }
    }
}
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct Feature {
    /// Offset from start of Feature table to FeatureParams table, if defined
    /// for the feature and present, else NULL
...
impl Feature {
    ...
    pub fn new(feature_params: Option<FeatureParams>, lookup_list_indices: Vec<u16>) -> Self {
        Self { feature_params: feature_params.into(), lookup_list_indices }
    }
}
...
impl<T: Default> LookupList<T> {
    ...
    pub fn new(lookups: Vec<T>) -> Self {
        Self { lookups: lookups.into_iter().map(Into::into).collect() }
    }
}
    ...
    T: FromTableRef<U> + Default + 'static,
{
    fn from_obj_ref(obj: &read_fonts::tables::layout::LookupList<'a, U>, _: FontData) -> Self {
        LookupList { lookups: obj.lookups().to_owned_table() }
    }
}
...
impl<'a> FromObjRef<read_fonts::tables::layout::CoverageFormat1<'a>> for CoverageFormat1 {
    fn from_obj_ref(obj: &read_fonts::tables::layout::CoverageFormat1<'a>, _: FontData) -> Self {
        let offset_data = obj.offset_data();
        CoverageFormat1 { glyph_array: obj.glyph_array().to_owned_obj(offset_data) }
    }
}
...
impl<'a> FromObjRef<read_fonts::tables::layout::CoverageFormat2<'a>> for CoverageFormat2 {
    fn from_obj_ref(obj: &read_fonts::tables::layout::CoverageFormat2<'a>, _: FontData) -> Self {
        let offset_data = obj.offset_data();
        CoverageFormat2 { range_records: obj.range_records().to_owned_obj(offset_data) }
    }
}
...
impl RangeRecord {
    ...
    pub fn new(
        ...
        Self { start_glyph_id, end_glyph_id, start_coverage_index }
    }
}
...
impl ClassDefFormat1 {
    ...
    pub fn new(start_glyph_id: GlyphId16, class_value_array: Vec<u16>) -> Self {
        Self { start_glyph_id, class_value_array }
    }
}
...
impl<'a> FromObjRef<read_fonts::tables::layout::ClassDefFormat2<'a>> for ClassDefFormat2 {
    fn from_obj_ref(obj: &read_fonts::tables::layout::ClassDefFormat2<'a>, _: FontData) -> Self {
        let offset_data = obj.offset_data();
        ClassDefFormat2 { class_range_records: obj.class_range_records().to_owned_obj(offset_data) }
    }
}
...
impl ClassRangeRecord {
    ...
    pub fn new(start_glyph_id: GlyphId16, end_glyph_id: GlyphId16, class: u16) -> Self {
        Self { start_glyph_id, end_glyph_id, class }
    }
}
...
impl SequenceLookupRecord {
    ...
    pub fn new(sequence_index: u16, lookup_list_index: u16) -> Self {
        Self { sequence_index, lookup_list_index }
    }
}
...
impl SequenceRuleSet {
    ...
    pub fn new(seq_rules: Vec<SequenceRule>) -> Self {
        Self { seq_rules: seq_rules.into_iter().map(Into::into).collect() }
    }
}
...
impl<'a> FromObjRef<read_fonts::tables::layout::SequenceRuleSet<'a>> for SequenceRuleSet {
    fn from_obj_ref(obj: &read_fonts::tables::layout::SequenceRuleSet<'a>, _: FontData) -> Self {
        SequenceRuleSet { seq_rules: obj.seq_rules().to_owned_table() }
    }
}
...
impl SequenceRule {
    ...
    pub fn new(
        ...
        Self { input_sequence, seq_lookup_records }
    }
}
...
impl ClassSequenceRuleSet {
    ...
    pub fn new(class_seq_rules: Vec<ClassSequenceRule>) -> Self {
        Self { class_seq_rules: class_seq_rules.into_iter().map(Into::into).collect() }
    }
}
...
impl<'a> FromObjRef<read_fonts::tables::layout::ClassSequenceRuleSet<'a>> for ClassSequenceRuleSet {
    fn from_obj_ref(
        ...
        ClassSequenceRuleSet { class_seq_rules: obj.class_seq_rules().to_owned_table() }
    }
}
...
impl SequenceContextFormat3 {
    ...
    pub fn new(
        ...
        Self { coverages: coverages.into_iter().map(Into::into).collect(), seq_lookup_records }
    }
}
...
impl SequenceContext {
    ...
    pub fn format_2(
        ...
        Self::Format2(SequenceContextFormat2::new(coverage, class_def, class_seq_rule_sets))
    }
...
impl ChainedSequenceRuleSet {
    ...
    pub fn new(chained_seq_rules: Vec<ChainedSequenceRule>) -> Self {
        Self { chained_seq_rules: chained_seq_rules.into_iter().map(Into::into).collect() }
    }
}
    ...
    for ChainedSequenceRuleSet
{
    fn from_obj_ref(
        ...
        ChainedSequenceRuleSet { chained_seq_rules: obj.chained_seq_rules().to_owned_table() }
    }
}
...
impl ChainedSequenceRule {
    ...
    pub fn new(
        ...
        Self { backtrack_sequence, input_sequence, lookahead_sequence, seq_lookup_records }
    }
}
...
impl ChainedClassSequenceRuleSet {
    ...
    pub fn new(chained_class_seq_rules: Vec<ChainedClassSequenceRule>) -> Self {
        Self {
            chained_class_seq_rules: chained_class_seq_rules.into_iter().map(Into::into).collect(),
        }
    }
}
...
impl ChainedSequenceContext {
    ...
    pub fn format_1(
        ...
        Self::Format1(ChainedSequenceContextFormat1::new(coverage, chained_seq_rule_sets))
    }
...
impl VariationIndex {
    ...
    pub fn new(delta_set_outer_index: u16, delta_set_inner_index: u16) -> Self {
        Self { delta_set_outer_index, delta_set_inner_index }
    }
}
...
///
/// This type is not part of the spec and will never appear in an actual font
/// file. It is intended to serve as a sentinel value, and will panic when
/// written, ensuring that all VariationIndex tables have been correctly mapped
/// before the font is compiled.
#[derive(Clone, Debug, Default, PartialEq, Eq, PartialOrd, Ord, Hash)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
...
/// Either a [Device] table (in a non-variable font) or a [VariationIndex] table
/// (in a variable font)
#[derive(Clone, Debug, PartialEq, Eq, PartialOrd, Ord, Hash)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
...
impl DeviceOrVariationIndex {
    ...
    pub fn variation_index(delta_set_outer_index: u16, delta_set_inner_index: u16) -> Self {
        Self::VariationIndex(VariationIndex::new(delta_set_outer_index, delta_set_inner_index))
    }
...
impl<'a> FromObjRef<read_fonts::tables::layout::ConditionSet<'a>> for ConditionSet {
    fn from_obj_ref(obj: &read_fonts::tables::layout::ConditionSet<'a>, _: FontData) -> Self {
        ConditionSet { conditions: obj.conditions().to_owned_table() }
    }
}
...
///
/// Formats 2..5 are implementations of specification changes currently under
/// debate at ISO for an OFF update. For the time being the specification is <https://github.com/harfbuzz/boring-expansion-spec/blob/main/ConditionTree.md>.
#[derive(Clone, Debug, PartialEq, Eq, PartialOrd, Ord, Hash)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub enum Condition {
...
impl ConditionFormat1 {
    ...
    pub fn new(
        ...
        Self { axis_index, filter_range_min_value, filter_range_max_value }
    }
}
...
impl<'a> FromObjRef<read_fonts::tables::layout::ConditionFormat2<'a>> for ConditionFormat2 {
    fn from_obj_ref(obj: &read_fonts::tables::layout::ConditionFormat2<'a>, _: FontData) -> Self {
        ConditionFormat2 { default_value: obj.default_value(), var_index: obj.var_index() }
    }
}
...
impl ConditionFormat3 {
    ...
    pub fn new(condition_count: u8, conditions: Vec<Condition>) -> Self {
        Self { condition_count, conditions: conditions.into_iter().map(Into::into).collect() }
    }
}
...
impl<'a> FromObjRef<read_fonts::tables::layout::ConditionFormat5<'a>> for ConditionFormat5 {
    fn from_obj_ref(obj: &read_fonts::tables::layout::ConditionFormat5<'a>, _: FontData) -> Self {
        ConditionFormat5 { condition: obj.condition().to_owned_table() }
    }
}
    ...
    for FeatureTableSubstitution
{
    fn from_obj_ref(
        ...
        let offset_data = obj.offset_data();
        FeatureTableSubstitution { substitutions: obj.substitutions().to_owned_obj(offset_data) }
    }
}
...
impl FeatureTableSubstitutionRecord {
    ...
    pub fn new(feature_index: u16, alternate_feature: Feature) -> Self {
        Self { feature_index, alternate_feature: alternate_feature.into() }
    }
}
...
pub struct SizeParams {
    /// The first value represents the design size in 720/inch units
    /// (decipoints).
    ///
    ...
    pub design_size: u16,
    /// The second value has no independent meaning, but serves as an identifier
    /// that associates fonts in a subfamily.
    ///
    ...
    /// If this value is zero, the remaining fields in the array will be
    /// ignored.
    pub identifier: u16,
    /// The third value enables applications to use a single name for the
    /// subfamily identified by the second value.
    ///
    ...
    /// Unicode and Macintosh Roman, and may contain additional strings
    /// localized to other scripts and languages. Each of these strings is
    /// the name an application should use, in combination with the family
    /// name, to represent the subfamily in a menu. Applications will choose
    /// the appropriate version based on their selection criteria.
    pub name_entry: u16,
...
impl SizeParams {
    ...
    pub fn new(
        ...
        Self { design_size, identifier, name_entry, range_start, range_end }
    }
}
...
impl<'a> FromObjRef<read_fonts::tables::layout::StylisticSetParams<'a>> for StylisticSetParams {
    fn from_obj_ref(obj: &read_fonts::tables::layout::StylisticSetParams<'a>, _: FontData) -> Self {
        StylisticSetParams { ui_name_id: obj.ui_name_id() }
    }
}
