...
impl TableDirectory {
    ...
    pub fn new(
        ...
        Self { sfnt_version, search_range, entry_selector, range_shift, table_records }
    }
}
...
pub struct TTCHeader {
    ...
    pub num_fonts: u32,
    /// Array of offsets to the TableDirectory for each font from the beginning
    /// of the file
    pub table_directory_offsets: Vec<u32>,
    /// Tag indicating that a DSIG table exists, 0x44534947 ('DSIG') (null if no
    /// signature)
