...
impl SignatureRecord {
    ...
    pub fn new(signature_block: SignatureBlockFormat1) -> Self {
        Self { signature_block: signature_block.into() }
    }
}
...
impl FromObjRef<read_fonts::tables::dsig::SignatureRecord> for SignatureRecord {
    fn from_obj_ref(
        ...
        SignatureRecord { signature_block: obj.signature_block(offset_data).to_owned_table() }
    }
}
...
impl<'a> FromObjRef<read_fonts::tables::dsig::SignatureBlockFormat1<'a>> for SignatureBlockFormat1 {
    fn from_obj_ref(
        ...
        let offset_data = obj.offset_data();
        SignatureBlockFormat1 { signature: obj.signature().to_owned_obj(offset_data) }
    }
}
