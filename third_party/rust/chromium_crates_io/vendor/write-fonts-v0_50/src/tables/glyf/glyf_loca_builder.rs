...
///
/// This is a marker trait to ensure that only glyphs are passed to
/// [`GlyfLocaBuilder`].
...
impl GlyfLocaBuilder {
    ...
    pub fn new() -> Self {
        Self { glyph_writer: TableWriter::default(), raw_loca: vec![0] }
    }

    /// Add a glyph to the table.
    ///
    /// The argument can be any of [`Glyph`], [`SimpleGlyph`] or
    /// [`CompositeGlyph`].
    ///
