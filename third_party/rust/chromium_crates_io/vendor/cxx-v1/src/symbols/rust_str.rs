...
#[unsafe(export_name = "cxxbridge1$str$new")]
...
#[cfg(feature = "alloc")]
#[unsafe(export_name = "cxxbridge1$str$ref")]
...
#[unsafe(export_name = "cxxbridge1$str$from")]
...
#[unsafe(export_name = "cxxbridge1$str$ptr")]
unsafe extern "C" fn str_ptr(this: &&str) -> *const u8 {
    this.as_ptr()
}

#[unsafe(export_name = "cxxbridge1$str$len")]
