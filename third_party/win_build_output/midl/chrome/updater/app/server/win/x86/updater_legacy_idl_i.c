...
MIDL_DEFINE_GUID(IID, IID_IProcessLauncherUser,0x17A38E6E,0xA1E6,0x47E4,0x93,0x6F,0xF7,0xA5,0x5E,0xB0,0x42,0xEB);
...
MIDL_DEFINE_GUID(IID, IID_IProcessLauncher2User,0x0300C0EC,0xA975,0x4926,0x9A,0x12,0x6F,0x80,0xE4,0xD1,0xB7,0xE3);
