...
/* 810 */	0x33,		/* FC_AUTO_HANDLE */
			0x6c,		/* Old Flags:  object, Oi2 */
/* 812 */	NdrFcLong( 0x0 ),	/* 0 */
/* 816 */	NdrFcShort( 0x9 ),	/* 9 */
/* 818 */	NdrFcShort( 0x18 ),	/* ARM64 Stack size/offset = 24 */
...
/* 842 */	NdrFcShort( 0x8 ),	/* ARM64 Stack size/offset = 8 */
/* 844 */	NdrFcShort( 0x58 ),	/* Type Offset=88 */

	/* Return value */

/* 846 */	NdrFcShort( 0x70 ),	/* Flags:  out, return, base type, */
/* 848 */	NdrFcShort( 0x10 ),	/* ARM64 Stack size/offset = 16 */
/* 850 */	0x8,		/* FC_LONG */
			0x0,		/* 0 */
...
/* 860 */	NdrFcShort( 0x40 ),	/* ARM64 Stack size/offset = 64 */
...
/* 886 */	NdrFcShort( 0x10b ),	/* Flags:  must size, must free, in, simple ref, */
/* 888 */	NdrFcShort( 0x8 ),	/* ARM64 Stack size/offset = 8 */
/* 890 */	NdrFcShort( 0x58 ),	/* Type Offset=88 */

	/* Parameter installer_path */

/* 892 */	NdrFcShort( 0x10b ),	/* Flags:  must size, must free, in, simple ref, */
/* 894 */	NdrFcShort( 0x10 ),	/* ARM64 Stack size/offset = 16 */
/* 896 */	NdrFcShort( 0x58 ),	/* Type Offset=88 */

	/* Parameter install_args */

/* 898 */	NdrFcShort( 0x10b ),	/* Flags:  must size, must free, in, simple ref, */
/* 900 */	NdrFcShort( 0x18 ),	/* ARM64 Stack size/offset = 24 */
/* 902 */	NdrFcShort( 0x58 ),	/* Type Offset=88 */

	/* Parameter install_data */

/* 904 */	NdrFcShort( 0x10b ),	/* Flags:  must size, must free, in, simple ref, */
/* 906 */	NdrFcShort( 0x20 ),	/* ARM64 Stack size/offset = 32 */
/* 908 */	NdrFcShort( 0x58 ),	/* Type Offset=88 */

	/* Parameter install_settings */

/* 910 */	NdrFcShort( 0x10b ),	/* Flags:  must size, must free, in, simple ref, */
/* 912 */	NdrFcShort( 0x28 ),	/* ARM64 Stack size/offset = 40 */
/* 914 */	NdrFcShort( 0x58 ),	/* Type Offset=88 */

	/* Parameter observer */

/* 916 */	NdrFcShort( 0xb ),	/* Flags:  must size, must free, in, */
/* 918 */	NdrFcShort( 0x30 ),	/* ARM64 Stack size/offset = 48 */
/* 920 */	NdrFcShort( 0x7e ),	/* Type Offset=126 */

	/* Return value */

/* 922 */	NdrFcShort( 0x70 ),	/* Flags:  out, return, base type, */
/* 924 */	NdrFcShort( 0x38 ),	/* ARM64 Stack size/offset = 56 */
/* 926 */	0x8,		/* FC_LONG */
			0x0,		/* 0 */
