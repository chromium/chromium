...
class _RasterizeAndRecordMicro(perf_benchmark.PerfBenchmark):
  ...
  def AddBenchmarkCommandLineArgs(cls, parser):
    parser.add_argument(
      ...
      default=2,
      help=(
        'Wait time before the benchmark is started '
    ...
    parser.add_argument(
      ...
      default=100,
      help=(
        'Repeat each raster this many times. Increase '
    ...
    parser.add_argument(
      ...
      default=100,
      help=(
        'Repeat each record this many times. Increase '
        'this value to reduce variance.'
      ),
    )
    parser.add_argument(
      ...
      default=120,
      help=(
        'The length of time to wait for the micro '
  ...
  def CreatePageTest(self, options):
    return rasterize_and_record_micro.RasterizeAndRecordMicro(
      ...
      options.rasterize_repeat,
      options.record_repeat,
      options.timeout,
...
@benchmark.Info(
  emails=['pdr@chromium.org', 'wangxianzhu@chromium.org'],
