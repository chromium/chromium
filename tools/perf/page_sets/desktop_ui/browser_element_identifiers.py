...
# This file is a subset of browser element identifiers being used in Destkop
# UI benchmark. The name of the identifiers and the string names used by the
...
kAiModePageActionIconElementId = 'kAiModePageActionIconElementId'
