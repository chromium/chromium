...
class Gmail2018SmoothPage(TopRealWorldDesktopPage):
  ...
  def RunPageInteractions(self, action_runner):
    ...
    with action_runner.CreateGestureInteraction('ScrollAction'):
      ...
      if self.story_set.scroll_forever:
        while True:
          action_runner.ScrollElement(direction='up', selector='.Tm.aeJ')
          action_runner.ScrollElement(direction='down', selector='.Tm.aeJ')
...
class GoogleCalendar2018SmoothPage(TopRealWorldDesktopPage):
  ...
  def RunPageInteractions(self, action_runner):
    ...
    with action_runner.CreateGestureInteraction('ScrollAction'):
      ...
      if self.story_set.scroll_forever:
        while True:
          action_runner.ScrollElement(direction='up', selector='#YPCqFe')
          action_runner.ScrollElement(direction='down', selector='#YPCqFe')
