...
#ifndef TOOLS_CLANG_RAW_PTR_PLUGIN_RAWPTRPLUGINCONSUMER_H_
#define TOOLS_CLANG_RAW_PTR_PLUGIN_RAWPTRPLUGINCONSUMER_H_
...
class RawPtrPluginConsumer
    : public clang::RecursiveASTVisitor<RawPtrPluginConsumer>,
      public ChromeClassTester {
 public:
  RawPtrPluginConsumer(clang::CompilerInstance& instance,
...
#endif  // TOOLS_CLANG_RAW_PTR_PLUGIN_RAWPTRPLUGINCONSUMER_H_
