...
ChromeClassTester::LocationType ChromeClassTester::ClassifyLocation(
    SourceLocation loc) {
  auto classification = raw_ptr_plugin::ClassifySourceLocation(
      instance().getHeaderSearchOpts(), instance().getSourceManager(), loc);

  // Convert to a less granular legacy classificatoin.
  switch (classification) {
    case raw_ptr_plugin::LocationClassification::kFirstParty:
      return LocationType::kChrome;
    case raw_ptr_plugin::LocationClassification::kBlink:
      return LocationType::kBlink;
    case raw_ptr_plugin::LocationClassification::kChromiumThirdParty:
      return LocationType::kThirdParty;
    case raw_ptr_plugin::LocationClassification::kThirdParty:
      return LocationType::kThirdParty;
    case raw_ptr_plugin::LocationClassification::kGenerated:
      return LocationType::kThirdParty;
    case raw_ptr_plugin::LocationClassification::kMacro:
      return LocationType::kThirdParty;
    case raw_ptr_plugin::LocationClassification::kSystem:
      return LocationType::kThirdParty;
  }
  assert(false);
}
