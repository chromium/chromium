...
class CompactBlocklistTest(unittest.TestCase):
  ...
  def TestShortenUUID(self):
    self.assertEqual(
      cb.ShortenUUID('00000000-0000-0000-0000-000000000000'),
      '00000000-0000-0000-0000-000000000000',
    )
    self.assertEqual(
      cb.ShortenUUID('01234567-89ab-cdef-0123-456789abcdef'),
      '01234567-89ab-cdef-0123-456789abcdef',
    )
    self.assertEqual(
      cb.ShortenUUID('00001812-0000-1000-8000-00805f9b34fb'), '1812'
    )
    self.assertEqual(
      cb.ShortenUUID('g1234567-89ab-cdef-0123-456789abcdef'),
      'g1234567-89ab-cdef-0123-456789abcdef',
    )
    self.assertEqual(
      cb.ShortenUUID('01234567-89ab-cdef-0123-456789abcdef0'),
      '01234567-89ab-cdef-0123-456789abcdef0',
    )
    self.assertEqual(
      cb.ShortenUUID('0123456789abcdef0123456789abcdef'),
      '0123456789abcdef0123456789abcdef',
    )
    self.assertEqual(
      cb.ShortenUUID('01234567089ab0cdef001230456789abcdef'),
  ...
  def TestProcess(self):
    ...
    try:
      ...
      cb.Process(
        '00001812-0000-1000-8000-00805f9b34fb exclude-reads', blocklist
      )
