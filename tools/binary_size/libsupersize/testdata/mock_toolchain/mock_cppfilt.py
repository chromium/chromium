...
_MAPPINGS = {
    ...
    '_ZL18extFromUUseMapping2aji':
    'extFromUUseMapping(aj, int)',
    ...
    ('(anonymous namespace)::blink::PaintChunker::releasePaintChunks() '
     '[clone .part.1]'),
    '_ZN6chrome5mojom11FilePatcher5Name_E':
    'chrome::mojom::FilePatcher::Name_',
    '_ZTV18ChromeMainDelegate':
    'vtable for ChromeMainDelegate',
    ...
    '_ZTV25ChromeMainDelegateAndroid':
    'vtable for ChromeMainDelegateAndroid',
    '_ZTVN4mojo15MessageReceiverE':
    'vtable for mojo::MessageReceiver',
    ...
    '_RNvNtNtNtNtNtCsa8PzCPyefMM_4core3num3imp7flt2dec8strategy6dragon5POW10':
    'core::num::imp::flt2dec::strategy::dragon::POW10',
}
