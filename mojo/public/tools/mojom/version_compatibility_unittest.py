...
class VersionCompatibilityTest(MojomParserTestCase):
  ...
  def testNewNonExtensibleEnumValue(self):
    ...
    self.assertNotBackwardCompatible(
      'enum E { kFoo, kBar };', 'enum E { kFoo, kBar, kBaz };'
    )
  ...
  def testEnumIdentity(self):
    ...
    self.assertBackwardCompatible(
      'enum E { kA, kB, kC };', 'enum E { kA, kB, kC };'
    )
  ...
  def testStructFieldTypeChange(self):
    ...
    self.assertNotBackwardCompatible(
      'struct S { string a; };', 'struct S { array<int32> a; };'
    )
  ...
  def testStructFieldBecomingOptional(self):
    ...
    backward-compatibility."""
    self.assertNotBackwardCompatible(
      'struct S { string a; };', 'struct S { string? a; };'
    )
  ...
  def testStructFieldOrderChange(self):
    ...
    self.assertNotBackwardCompatible(
      'struct S { string a; bool b; };', 'struct S { bool b; string a; };'
    )
    self.assertNotBackwardCompatible(
      'struct S { string a@0; bool b@1; };',
  ...
  def testNewStructFieldWithValidMinVersion(self):
    ...
    self.assertBackwardCompatible(
      'struct S { int32 a; };', 'struct S { int32 a; [MinVersion=1] int32 b; };'
    )
    self.assertBackwardCompatible(
  ...
  def testStructFieldRename(self):
    ...
    self.assertBackwardCompatible(
      'struct S { int32 x; bool b; };', 'struct S { int32 a; bool b; };'
    )
  ...
  def testStructFieldReorderWithExplicitOrdinals(self):
    ...
    self.assertBackwardCompatible(
      'struct S { bool b@1; int32 a@0; };', 'struct S { int32 a@0; bool b@1; };'
    )
  ...
  def testUnionFieldTypeChange(self):
    ...
    backward-compatibility."""
    self.assertNotBackwardCompatible(
      'union U { string a; };', 'union U { array<int32> a; };'
    )
  ...
  def testUnionFieldOrderChange(self):
    """Changing the order of fields breaks backward-compatibility."""
    self.assertNotBackwardCompatible(
      'union U { string a; bool b; };', 'union U { bool b; string a; };'
    )
    self.assertNotBackwardCompatible(
      'union U { string a@0; bool b@1; };', 'union U { string a@1; bool b@0; };'
    )
  ...
  def testNewUnionFieldWithValidMinVersion(self):
    ...
    self.assertBackwardCompatible(
      'union U { int32 a; };', 'union U { int32 a; [MinVersion=1] int32 b; };'
    )
    self.assertBackwardCompatible(
  ...
  def testUnionFieldRename(self):
    """Renaming a field has no effect on backward-compatibility."""
    self.assertBackwardCompatible(
      'union U { int32 x; bool b; };', 'union U { int32 a; bool b; };'
    )
  ...
  def testUnionFieldReorderWithExplicitOrdinals(self):
    ...
    ordinals are explicitly labeled and remain unchanged."""
    self.assertBackwardCompatible(
      'union U { bool b@1; int32 a@0; };', 'union U { int32 a@0; bool b@1; };'
    )
  ...
  def testInterfaceMethodParamsChanged(self):
    ...
    self.assertNotBackwardCompatible(
      'interface F { A(); };', 'interface F { A(int32 x); };'
    )
    self.assertNotBackwardCompatible(
      'interface F { A(int32 x); };', 'interface F { A(bool x); };'
    )
    self.assertNotBackwardCompatible(
    ...
    self.assertBackwardCompatible(
      'interface F { A(int32 x); };', 'interface F { A(int32 a); };'
    )
    self.assertBackwardCompatible(
  ...
  def testInterfaceMethodReplyParamsChanged(self):
    ...
    self.assertNotBackwardCompatible(
      'interface F { A() => (int32 x); };', 'interface F { A() => (); };'
    )
    self.assertNotBackwardCompatible(
      'interface F { A() => (bool x); };', 'interface F { A() => (int32 x); };'
    )

    self.assertBackwardCompatible(
      'interface F { A() => (int32 a); };', 'interface F { A() => (int32 x); };'
    )
    self.assertBackwardCompatible(
      'interface F { A() => (int32 x); };',
  ...
  def testNewInterfaceMethodWithValidMinVersion(self):
    ...
    self.assertBackwardCompatible(
      'interface F { A(); };', 'interface F { A(); [MinVersion=1] B(); };'
    )
  ...
  def testNullableTypeLayoutCompatibility(self):
    ...
    |has_field|."""
    self.assertBackwardCompatible(
      'struct S { bool has_foo; int32 foo; };', 'struct S { int32? foo; };'
    )
    self.assertNotBackwardCompatible(
      'struct S { bool has_foo@1; int32 foo@0; };', 'struct S { int32? foo; };'
    )
