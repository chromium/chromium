...
class StringManipulationTest(unittest.TestCase):
  ...
  def testSplitCamelCase(self):
    ...
    self.assertEqual(
      ["url", "loader", "factory"], generator.SplitCamelCase('URLLoaderFactory')
    )
    self.assertEqual(
      ["get99", "entries"], generator.SplitCamelCase('Get99Entries')
    )
  ...
  def testToCamel(self):
    ...
    self.assertEqual("CAMELCASE", generator.ToCamel("CAMEL_CASE"))
    self.assertEqual(
      "camelCase", generator.ToCamel("camel_case", lower_initial=True)
    )
    self.assertEqual(
      "CamelCase", generator.ToCamel("camel case", delimiter=' ')
    )
    self.assertEqual("CaMelCaSe", generator.ToCamel("caMel_caSe"))
  ...
  def testToSnakeCase(self):
    ...
    self.assertEqual("snake_case", generator.ToLowerSnakeCase("SnakeCASE"))
    self.assertEqual(
      "snake_d3d11_case", generator.ToLowerSnakeCase("SnakeD3D11Case")
    )
    self.assertEqual(
      "snake_d3d11_case", generator.ToLowerSnakeCase("SnakeD3d11Case")
    )
