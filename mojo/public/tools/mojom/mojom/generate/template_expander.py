...
def ApplyImportedTemplate(
  mojo_generator, path_to_template, filename, params, **kwargs
):
...
def UseJinjaForImportedTemplate(func):
  def wrapper(*args, **kwargs):
    ...
    filename = args[2]
    return ApplyImportedTemplate(
      args[0], path_to_template, filename, parameters
    )
