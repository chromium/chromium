...
extern const char kWebAccessibleResourcesExtensionIds[];
extern const char kWebAccessibleResourcesMatches[];
extern const char kWebAccessibleResourcesResources[];
extern const char kWebAccessibleResourcesUseDynamicUrl[];
