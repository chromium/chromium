...
struct RegexRuleInfo {
  ...
  CheckedPtr<const flat::RegexRule> regex_rule;
  CheckedPtr<const re2::RE2> regex;
};
...
class RegexRulesMatcher final : public RulesetMatcherBase {
 ...
 private:
  ...
  const CheckedPtr<const RegexRulesList> regex_list_;
  const CheckedPtr<const ExtensionMetadataList> metadata_list_;
