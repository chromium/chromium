...
#ifndef EXTENSIONS_BROWSER_API_PROXY_PROXY_PREF_TRANSFORMER_H_
#define EXTENSIONS_BROWSER_API_PROXY_PROXY_PREF_TRANSFORMER_H_
...
#endif  // EXTENSIONS_BROWSER_API_PROXY_PROXY_PREF_TRANSFORMER_H_
