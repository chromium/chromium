...
struct ExtensionWebRequestEventRouter::BlockedRequest {
  ...
  CheckedPtr<const WebRequestInfo> request = nullptr;
  ...
  // Only valid for OnAuthRequired.
  CheckedPtr<net::AuthCredentials> auth_credentials = nullptr;
  ...
  // OnHeadersReceived.
  CheckedPtr<scoped_refptr<net::HttpResponseHeaders>>
