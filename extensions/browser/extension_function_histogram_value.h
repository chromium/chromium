...
enum HistogramValue {
  ...
  DELETED_IDLTEST_SENDARRAYBUFFERVIEW = 58,
  ...
  DELETED_IDLTEST_SENDARRAYBUFFER = 221,
  ...
  DELETED_IDLTEST_GETARRAYBUFFER = 251,
  ...
  DELETED_AUTOTESTPRIVATE_INSTALLPLUGINVM = 1418,
  ...
  DELETED_AUTOTESTPRIVATE_SETPLUGINVMPOLICY = 1474,
  DELETED_AUTOTESTPRIVATE_SHOWPLUGINVMINSTALLER = 1475,
  ...
  DELETED_AUTOFILLPRIVATE_SETAUTOFILLSYNCTOGGLEENABLED = 1870,
  ...
  DELETED_WEBREQUESTINTERNAL_EVENTHANDLINGDONE = 1978,
  DICTATIONPRIVATE_UPDATEAUDIOLEVEL = 1979,
  ENTERPRISEREPORTINGPRIVATE_REPORTFORCESAVETOCLOUDEVENTHANDLED = 1980,
