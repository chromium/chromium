...
enum HistogramValue {
  ...
  READSERVERUDS_UPLOADTRAININGDATA = 1901,
  READSERVERUDS_TRAINMODEL = 1902,
  READSERVERUDS_INFERENCE = 1903,
  READSERVERUDS_LOADMODEL_BERT = 1904,
  READSERVERUDS_INFER_SINGLE_BERT = 1905,
  READSERVERUDS_INFER_BATCH_BERT = 1906,
