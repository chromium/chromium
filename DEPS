...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'a10f04f18a35c45ef4068ed43635a8edd10f4ae2',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'f3f744715f2a8a5db278532390d1bc361a45c5d2',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@a1633cbf62de5bd3c34026baa20a215e56298f99',
  ...
  'src/third_party/vulkan-validation-layers/src': '{chromium_git}/external/github.com/KhronosGroup/Vulkan-ValidationLayers@169a5bf16ccd52faf8c85dd722892f95df2effc5',
