...
vars = {
  ...
  'src_internal_revision': '7bbd096fc1f2ca65b36cc0773341e50f284b6a68',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '5b6eec8d9bf009d2263d784714e6bfa1777dbc7d',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '8120d26bae945ff0954b7a6abc08f0decdc4b775',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'ef30c7ac47bfbd794bb359b0f3dccf8b63bb3530',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '82c5c7018f90a1620a48249e9bfc82d4aba973cd',
