...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '91e05278a27e7e2245d2d1eadd7607dbfb92067d',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'ca151e35cfa3ebe4b1ca5551cca43bad5ef29ec2',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'db386af40f3b3cd1298db2870ae06c3b5cd0e908',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'fbafdaae8bceeb1e9c572145f65ee59b7dc95b80',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@9186ff9ecec29b692dce459857a32b7cacc9dd00',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'd094ad7e2eed596362e4628d6f0097467806682c',
  ...
  'src-internal': {
    'url': Var('chrome_git') + '/chrome/src-internal.git@e0cc9d2957b2a2f13b80d6e9d0e8d99c5c08d5b6',
    'condition': 'checkout_src_internal',
  },
