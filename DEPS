...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': '611f9ac03c2d6b6c888510eb6fbe86a90b6126c1',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + 'a3799b41dd0075b029f341ffa978fcd2ffbd08d0',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@1a51f1c88904b67c3177a64ada3fb6abcd349a06',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '877987f9179c635c829bdd312d6ca5b8ff808fe6',
