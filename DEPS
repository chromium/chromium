...
vars = {
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '134ffd92e18523b527bce1e72745b10fbaa34c0b',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
  ...
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
  'cros_components_revision': '14d32cb78b454ee03b66848099fbdafac9aeac96',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/clank': {
    ...
    '20f3ceb415fd397a228628f2f42f18d7c4ca2d99',
    ...
    'packages': [
      {
        ...
        'version': 'fgGhgbIy1yJjvhJ5MS22j8zjq6BELtWx3lt_a02hCdYC',
      },
    ],
    'condition': 'checkout_chromeos and checkout_src_internal',
    'dep_type': 'cipd',
