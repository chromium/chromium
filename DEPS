...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': 'f82fdd89c23706b270f5e6255806d64f49ee110b',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '38ccd7c56e2a4faefd40e68b4e6a595310176e15',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': 'cd4515ea33b071746f797a222b3c5fb5c2b57b0e',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'crossbench_revision': 'a7ad6ea2a551ae0abf753df7d184406b2fd8f3ef',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling CrossBench
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '723d1f04c9d4bae31e67ca7a33589aeb0849efab',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'llvm_libc_revision':    '40030fb6a930ef4b1f9c8f2cc9bc2e084a9512de',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling llvm-libc
  # and whatever else without interference from each other.
  'compiler_rt_revision': '8a95740874c537238bcd2895749717a2d6c6722a',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '8542caa75df502a0fe3d422977e27d6ebc8ff46d',
      ...
      'packages': [
          {
               ...
               'version': 'IuP2siXz-iNITIDa9pVtrvo0Cnm8CRgsa4ARsKXiEtQC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
               ...
               'version': 'zjGv3u8y62iApcw1-RAm6L9FC-wt7dt4TrFslTqJGmgC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
               ...
               'version': 'V9orqE46z2eD6d7GIF5ah1-tN51KfOsonuQZu5-1LE0C',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/third_party/eigen3/src':
    Var('chromium_git') + '/external/gitlab.com/libeigen/eigen.git' + '@' + '8a070f3e17d794a8e81ba84700b6b0bfd269b3df',
      ...
      'packages': [
          {
              ...
              'version': 'haD4_4rED1FM5eybcX96h0cQdg6i6BHUwYmW-OeQOGgC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@5b1ae5e8a8a3942c1c21cfaf2b63569befd4523a',
  ...
  'src/third_party/vulkan-validation-layers/src': '{chromium_git}/external/github.com/KhronosGroup/Vulkan-ValidationLayers@15846dc1dd3af489e5c9cea5a2ea06aed1bd1c75',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '18bd403e018cbe835eb7352649ade5b312cbf326',
    ...
    'packages': [
      {
        ...
        'version': 'ZN7X-frxpherobCi91y4Ma76x3szKub_HbpvV-y-KmQC',
      },
    ],
    'condition': 'checkout_chromeos and checkout_src_internal',
    'dep_type': 'cipd',
    ...
    'packages': [
      {
        ...
        'version': 'aJyrC4-C_5DqKUHMGgPzG5eZ-MtyIdC6xvQO5a6AygMC',
      },
    ],
    'condition': 'checkout_chromeos and checkout_src_internal',
    'dep_type': 'cipd',
    ...
    'packages': [
      {
        ...
        'version': 'O8J2ZecVeLSZyICLndUuwxXFAEjgW-BbBbiqQiKjXVAC',
      },
    ],
    'condition': 'checkout_chromeos and checkout_src_internal',
    'dep_type': 'cipd',
