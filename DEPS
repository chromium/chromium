...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '18a98e5d01fa6a59f64fc5609836c93d0a7e482c',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '55f9354534a9170aebc212260f3a8e73c2804a32',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '9a8d5f80779e9eb9a455d0d2ebce2cf29f44f9d3',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '090699a01bfc2f91af97e6461ff126bef996905a',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '37dcea112ff1c3ece0d815fd9a0b2895df0f13de',
