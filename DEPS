...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '33bcdb77bddef88c678d8b8f0fe50a8e2d128440',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '1208cb9e2d95de8cbd3e2c81b816a172147306bd',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@65b9cde3547038735d1f083a06d0e4cd2fd51f8b',
