...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': 'f9753a0124441891a0e7ef24866cc01ea310bf53',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@1dee72e157cce9f5ba89da0e6f4a51c86cca7921',
