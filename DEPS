...
vars = {
  ...
  'skia_revision': '3cf050bba6b61acdc0b134fdf495b6c004989520',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'catapult_revision': '3c6345a736f4a79e85dc46dcecc71caeebcb4499',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + 'c70ad6b2a04526e0e0a98a93a56bbb0cefdc0aef',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@93d0140b3861285eecf7fa849d72c8135b1fbe33',
    'condition': 'checkout_src_internal',
  },
