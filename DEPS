...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '992d7c0261d554c330dff6900d859cf0faae604c',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '666b0c9f3238b55688734db00bb11a0ccae31f1a',
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '229d54bc925fd18dd46298cfd1fc0eb159ad87a3',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '501c4f37bfee47b26999ee291c5355ad64554df7',
