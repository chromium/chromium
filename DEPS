...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '055b261524830122e9533cd718470632fb96f103',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/clank': {
    ...
    '6ab8d4979b601226c349fd401a718280e7e0ace4',
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '5505d106ac345b68c165a57facbedb3761093709',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '96de4d63e3c360a6e748beffe639e7cf2d3848af',
