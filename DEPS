...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '75476efc9e854f29a8893cc6185fe09f90942178',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'f546983cc8df9233e26f52864d84fe7e5565e990',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'a2d539b70ae11015dbcb52dcfb2c332866a86c0c',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'a9470e4e147772ddf96e0828c7c7880c4e0da891',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '854d3448c676387a633bea890c5f60e03c8219cc',
    'condition': 'checkout_src_internal',
  },
