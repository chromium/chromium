...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '36551a36d03c23cba727c4bbcb225a294ac9aaf4',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'f20bfbfb29b4ba87220b6acfac011f5d0e07c432',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': 'e2d2aa115838a4731672e9d0e3fd88ac34901fae',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'c0320c5f29a01f51fc1f94e2f3faf64a1f719ecd',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '7f22a6281defe18a519e2f6609b084a60e5188ce',
  ...
  'src-internal': {
    'url': Var('chrome_git') + '/chrome/src-internal.git@1263731260b8c566929301c72adb57d1cc1c49dc',
    'condition': 'checkout_src_internal',
  },
