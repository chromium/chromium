...
vars = {
  ...
  'src_internal_revision': '9c2c58730b385f2fa9213ca9b22b2a3e2e875d51',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '498446a02e7818da808e2893abf157880ec3371d',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '876be52e0a2e77e5038e13788cf2c2b3ea87da2f',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '1fd2447edb516463200669a2b213806da5e8df36',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '0044e3c439405e25a6b11ca055d123d5666ef02a',
