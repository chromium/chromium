...
vars = {
  ...
  'skia_revision': 'f46c37ba85af2db8af3c538fd2b8b3a1a1154717',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '8dc69b8da1a1cf20296b2e0addcb615ef835858b',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '5f23c4f5d372216d1408632039200253b5081aae',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@9d210e5f29d38dc82500dc61810beb83177bf3b6',
    'condition': 'checkout_src_internal',
  },
