...
deps = {
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '03a23950ab66c74457a31c5a80a4acb5bd17db2a',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@a2276b34882612a541077098dfc053c0af6bd3c6',
