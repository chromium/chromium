...
vars = {
  ...
  'skia_revision': 'f639a24c5041a1260a8ecee55a307215db1d567b',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '8c0eca5f170cfe786bb807f359489e3db7d5b9ce',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'angle_revision': '8b4990bbd6217138d30e19f5309560cc6e2592a0',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '5c5f0baa72f178cf019e6030ef99f3aa8d4a2d4e',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@f7af16c5f6fe07d0200c46292539458655779af4',
    ...
    'packages': [
      {
        ...
        'version': '63ygjtmacn3rLs5DIX3qYrJpb5lK-y2kDmejad9ymXwC',
      },
    ],
    'condition': 'checkout_chromeos and checkout_src_internal',
    'dep_type': 'cipd',
