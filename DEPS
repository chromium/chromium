...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': 'f725a5ba8a29ec7c271805624d54755ce34968a1',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'e13cc7df7075162977494fdd74a9d3cf89d4c715',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'fa88ff0f3673290a6250d985f14175217e56eac0',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'd874a8a407afae7be549be837e76f46dc12d6d2d',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '63a16f09d23ad7174ada8b992bc5443d099345aa',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '0c2cd6264f9a171562e3161724f86d61dabac3ab',
