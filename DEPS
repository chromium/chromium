...
vars = {
  ...
  # and whatever else without interference from each other.
  'crossbench_revision': '681ccfe24ff78fe7852399b91f35fc868338f289',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'deddb4391d606ef1df913c04c0588b2e7bad9287',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'f28ffc28542e950cf682fdbd0a8b8863cae2a8c1',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@3e8080afb86dd26826c24d31699ac1039485772a',
  ...
  'src/third_party/vulkan-validation-layers/src': '{chromium_git}/external/github.com/KhronosGroup/Vulkan-ValidationLayers@c3a7a71dd5a9e5ec8a18349180e05b9be4adaacc',
  ...
  'src/third_party/webgpu-cts/src':
    Var('chromium_git') + '/external/github.com/gpuweb/cts.git' + '@' + '08ed9c31e9df9e7d7f853a70175c0640854ec47b',
