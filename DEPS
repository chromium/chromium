...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '959b9536b4c1001c0f498b914dde3b539f5147c9',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'cb6885fe9497bd901ec669179ebb4ce7ab782a88',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + 'a16f43c697feeb40bbf405b46c752aa6d8525902',
