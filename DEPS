...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '55945568b0d4d4d86e8d7eb91806744a2f038664',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'd7a448fa55808a40aa97017f08b511e9a05a9601',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '9f26727b2206c3755daee0979e12b439b3f6b911',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '3409f397ec18f3367732491b0c83c45df83c88ed',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '18db2cac3f3e9413e20fc274067fcc6677c0cb02',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'a5704b80ede14248d676c20319c9c50385fcab85',
