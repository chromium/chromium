...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': '1119dfbdcec83f3012bcc86927b3550bb7d94142',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '75a8574b295236415da8ef6d06fc5790c3a69330',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@dc2aaf6e1c62639bd5e9693c5483d44e6ef738ae',
    'condition': 'checkout_src_internal',
  },
