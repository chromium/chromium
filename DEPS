...
vars = {
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '0fce39c89a7d827128e11648f99aacc949443631',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
 ...
 'version': Var('siso_version'),
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '8329cf030c1c48028e8bb7c009f965a7ca8a26f8',
  ...
  'src-internal': {
    'url': Var('chrome_git') + '/chrome/src-internal.git@aa5cae674d0f5279009fcd742899f6aa3b30cc2e',
    'condition': 'checkout_src_internal',
  },
