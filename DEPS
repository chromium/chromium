...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '2c3e5b41049fc3f84fa74a2e27dcab7eb9069e7b',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'YQk4-hgt8iea4uClmxuJ0hdYInFlq8ztoF-CND-y9z4C',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@96c6e1981f1a5c0370e2794bab0aa2d0117b5078',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'e1b01078e7afe76d77dc7160a6a7e447881ac6e4',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '39dfc058591e20c35143c6648c0fcee5b8c2c6fd',
