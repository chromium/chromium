...
vars = {
  ...
  'src_internal_revision': '13b8c38afb14a2edde3314b075b757f8aff7e789',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling Skia
  # and whatever else without interference from each other.
  'skia_revision': 'ff8d5f355de1b7819cf52a840fae8da25ff178f6',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '4086478b114abb4531f378f5020c0ddec92d3738',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '453beea10c817786ee24136991cebcec00a8c85e',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + '3fd79131b5bb37bf9bfcdcff3986783a36f1171d',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'c2eba2b6bc9d8a1cbb4d321361a296b72319b7b4',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '898746c597f3a13fb2f23c7b1482607723d9ac79',
