...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': '1174582a3d462a01858a388cf60759ff219092ae',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'catapult_revision': '4e849c596a5ea577a00cc8092379bb9b87f3e0d5',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'cb90e493041f01d979d3b2843532de60733599b2',
  ...
  'src-internal': {
    'url': Var('chrome_git') + '/chrome/src-internal.git@fbe1d1fbaa5c8b2092ac6d1aac9eb6f87b9d60d9',
    'condition': 'checkout_src_internal',
  },
