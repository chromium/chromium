...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': 'f8cd2da0256752afb0059bf17e4bf2bec422967e',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '9b21082faf16a5f029a4316272c9a627d8b33eb4',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': '82ab43bfda5a3f59e1876fd3c828f047c689bc12',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': 'ff7b4f6c5d964879b5f4356ef6e732adeed2f627',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
      ...
      'packages': [
          {
              ...
              'version': 'zhkMf2BZp0FsQU1gqKN5MNQ2jUypI8jiC8GUvUb6Te8C',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'grJ-ln_KDgERpkdNDm7AbC28C7MIIEQtBAdrKL3RC-8C',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
