...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '0d0bb92e2bab6c270138fcf6e164a7d7ef63c635',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '9994722d36570bf542be590ecbcc52c70598d704',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '63542409ef074c96c7dd037da1395efc18434102',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@8f33978c3b5d09c626bcd36fb950fd63dfb39e13',
    'condition': 'checkout_src_internal',
  },
