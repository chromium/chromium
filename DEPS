...
vars = {
  ...
  # and whatever else without interference from each other.
  'crossbench_revision': '5405a13cb0bea953115e57d9a3e3d383a5ef03f7',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'llvm_libc_revision':    '03f18fb39b5aab5e15fee77623835d67d90d3ea6',
...
deps = {
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + 'fdeead492ad4aeb731ffd491e7798f694ff73f80',
