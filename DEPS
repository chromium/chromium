...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'd4083c792c1ea3ff3f1928e5d296de22d72d526a',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '84030211c2b41805350ca96733f33637ef84aa4c',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '015b0ff975815ea96da74547fd450a3b704c1f77',
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '5a3c9438e66d2b1cfff8e4a6f3bf2dbdfd336534',
