...
vars = {
  ...
  'skia_revision': '68403f131d958d939a3b2dac614cdaadeb162ed2',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'd438156580fa8731d9c13fc7a93133fa9a821cd4',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@a29113f7c7e5a85a516e68b0072682f9dd84fe9f',
    'condition': 'checkout_src_internal',
  },
