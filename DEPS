...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '79e8742273d10f89df5ff1ec45db3e40bb3c16e7',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'gSOVUJUA8nkMiiKfJJ9aWlEXm9Fq2O1FqRqPmbnZj7EC',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'afzP97tjlAicP8mvGq1IcTuPlUw3y58eoU39qyHKLrcC',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
  ...
  'src/clank': {
    ...
    '5e51140b9e8627a146a24cb6cb2badfafba2644e',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@fc82537b4a40a0ed64075e4b662ea5edeac483da',
  ...
  'src/third_party/vulkan-validation-layers/src': '{chromium_git}/external/github.com/KhronosGroup/Vulkan-ValidationLayers@e9b07a64f0aafe1e2570f7739d0d5ffb165fb4c4',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'b4aa1c7d7e46a94c895dcbd39f124b7fc4dcb5d1',
