...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': 'f7bfa8eef5b576b0d024216db7ee43353efc6ee3',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'a6bf68ce537c8b9b9b40977951b89574088dd87b',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '4b6bbb9c47b6424dfbcf0d96dcddfef9f3d45f1b',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'a18e9bbba8b83feb328fc49efff2e88409e5aedc',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '1752c94074a84d5d0e91b66fb185056125e1aaac',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '51e55b328e90cb7df126570ec8a15414c784d012',
