...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '790068cb4b29d7db221d7572a485fa096dc5883a',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'angle_revision': '1b572acd76c407a2822ba789ed78a7c723196729',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '1f21e8e7080323d3607e8aa95c9417f013f13a76',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + '97040fb69242963e7188c12cd4ea660516895cc7',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@6814a15757aa716402509328205568352a8e040f',
  ...
  'src/third_party/vulkan-validation-layers/src': '{chromium_git}/external/github.com/KhronosGroup/Vulkan-ValidationLayers@0e53149c8b55ae63c4f4bcf230d0953636369951',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '9afb69d2f1bc4a7451404648f459d288a9030ce5',
