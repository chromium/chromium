...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': 'abbe599fb3c0ef2fa82bfadbb0ddcd321f22faf0',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '0cd69a9ba82925f5eb2c91376c4e7ba0da9dd445',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': '401e94882e22cf2aa7af649b92ab123eaa329321',
  # Three lines of non-changing comments so that
      ...
      'packages': [
          {
              ...
              'version': 'SMWi9DUgNrKvF7Qzpun3QHJdZtHZ54lfrgHWBDsrHQYC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'PSzRdGVSY2NH0rLYn8mBQZLAuplsHgSiPWizUxIiuawC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'ZMBMIkM7rWxtoYhmDL7zGoH2Enf7O9iBYZm0BBC2VAwC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
