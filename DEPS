      ...
      'packages': [
          {
              ...
              'version': 'SfqeLVAQujN0zvy9DJVzpQ-gTTSS1rHwwK8MDV8R9jgC',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'tgIAKbqAMXrinG8nXIQIrt5gvgTe9v4glXA5xT2Lm58C',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'vZmPnf-RILXbhDpsB6Z5y3sp335cLW3U0slxzLpMfd4C',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '5f51571a333dc9e7dd8adbeabd24c784fd9031c9',
