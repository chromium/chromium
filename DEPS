...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '252361be9e3bbdd7be1c7b4c718a37c987c557c9',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'angle_revision': '5b343e8fb351c39dab344ba0a4d7836ac2088c92',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'bc1af6cdbd8c3f06ca81478b648a70a7aa1c0ba9',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/chrome/release_scripts': {
      'url': Var('chrome_git') + '/chrome/tools/release/scripts' + '@' + 'e8faf5e251a0718edcd23a578265afe07d4890e3',
  ...
  'src/clank': {
    ...
    'e07d9a180fd03113b3db4499c2a4308291c1ef38',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '0401e6802e0b58ad4398dbbe2d04eade5a908589',
