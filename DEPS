...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': 'f5d9da13d56dfa0a38e4f4fc2f92b85e70f0c52d',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'gAImKcOVB2vgliqYmEwxLy_iBa-zqAbBVX4H5eF_G4gC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + '7115d474c95ead952b80ba29cd1680bb3d505dcb',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'b5023bfceb4adddceace403a2a282445720502f3',
