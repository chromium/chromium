...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': '58c1e56bcec66a87729654e387c9eaf1c867adc2',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'a19693425bac32d9ff56d1cb5f395ab6009c4e4a',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'cacf37daf2e1d0fd274da74d0bdd6d7fd52dcbbe',
    ...
    'packages': [
      {
          ...
          'version': 'QVhxMzvn7Z7W9UeqkKNTi18I-VBVZGLEOB9rJqrJdakC',
      },
    ],
    'condition': 'checkout_android and non_git_source',
    'dep_type': 'cipd',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'c5da34e6df686428f790491b6aec871a818c1003',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '247bcf7690eb0576a2e3e5a7f2eebb03b7d01e99',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '8336e67d34faa013cd2e99a26d51c53ff5e55ade',
