...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '294166fb4d0a8f2fd16abf2b69437efb9c8fbb21',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@de2a1a2d094c9e12a6d97192ce00966601a86549',
    'condition': 'checkout_src_internal',
  },
