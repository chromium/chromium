...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'fd0ced8b49a2d996b03e02504208be8dbc57b9df',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'a41372780a554c5343c56aa82224280d4688e77d',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'dc64a05113ac6faf2eb0639c98619b94cc6d6136',
    'condition': 'checkout_src_internal',
  },
 ...
 'version': Var('siso_version'),
  ...
  'src-internal': {
    'url': Var('chrome_git') + '/chrome/src-internal.git@246684ee6f9f0c90df064d7d5eb003e41c2b7afb',
    'condition': 'checkout_src_internal',
  },
