...
vars = {
  ...
  'skia_revision': 'ed1b25f0aa5c1df9d1a4a7b6a001634bdddde7cf',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'e7d518b60b814d625f9c0ba626341915bf7cfa63',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'a2161335b45002f959c926fa9199b4ce8f5d7302',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '68c640f3791cc290e23d7dbf712c448910423263',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/icu':
    Var('chromium_git') + '/chromium/deps/icu.git' + '@' + 'b61d8543fb181b10e8b5aa35dc6b12d03a035c37',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@c552b794f89c2127a77f59989764aa601ea0d1dd',
