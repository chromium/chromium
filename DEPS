...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': 'a4212b0fe373055a825a76f520dcb295c35dbeac',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@e4e4d49834a7686d0214a045c3c44974fb3d8ced',
