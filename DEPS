...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '10fea27b596de8548c72203ccd644d7c5ea9edaa',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': '6e0ae89997acca1477d0ee986c3e63825ee78c40',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'c69509638a109a40198dc3d439241c311e9873e9',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'f58cb5c3f16a47b77efd1391826cb4eee10290db',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '2997e7db259700f8537a7acf525a11303ca938bb',
    'condition': 'checkout_src_internal',
  },
