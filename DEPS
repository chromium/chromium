...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'd3b942ef59679d75e24a4c8bdbe883b5d9e9caaf',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'c54de551481a6c86a050a5a9f16a9ddea1b916ef',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'd3f4c694f8e6819489532ecde4c4ae36eac04539',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '06a8ecadf2897cffae24f37222b763138aad6c49',
