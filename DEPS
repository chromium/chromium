...
vars = {
  ...
  'skia_revision': 'f0f42774433d586430f9461f61b3f7557b559d7d',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '0e1edf9e0ec9c8a8fbc01330f66e1aea1bffaa83',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': '053d152da87a4774d5410f46ea463b6826d14021',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '8cc040fb3110f4eccbc0b4e1817cc94794218a7e',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/third_party/webgpu-cts/src':
    Var('chromium_git') + '/external/github.com/gpuweb/cts.git' + '@' + '7f36839bf1c7db6bf8c7cece8cfb22572a4f6063',

  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '81797744fd3ef6d917a5598de57189f7a35760fc',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@9eb7922592a8d50a1ba478bfeae51c0b6b913b2d',
    'condition': 'checkout_src_internal',
  },
