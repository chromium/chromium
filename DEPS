...
deps = {
  ...
  'src/clank': {
    ...
    '5825e6f567cc14b8cf75009219eee2c9bf141580',
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + 'ac166747b6bd6630d59beef2e4152375f7bd558d',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@862116708f2633cdbe4e658824214be11f737d3c',
    'condition': 'checkout_src_internal',
  },
