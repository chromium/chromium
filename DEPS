...
vars = {
  ...
  'src_internal_revision': 'e420199d9dae9a1432f6a50cfe97d6123e879c4d',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '5a962d6d798568fd76d5400aeacb3197893ec356',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '6bd13bc606ada6455694570030434c62b7b69d5d',
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '4f31a1cef7a67638c2ca072cf95a0b64d67ea62d',
  ...
  'src/components/optimization_guide/internal': {
      'url': Var('chrome_git') + '/chrome/components/optimization_guide.git' + '@' +
        '74f0eb184b214968ca9afe699b530fb71ec01103',
      'condition': 'checkout_src_internal',
  },
