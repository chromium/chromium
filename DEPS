...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '8f5288e5ffdccbb9d9f2bdc59f65c40224e39552',
  # Three lines of non-changing comments so that
      ...
      'packages': [
          {
              ...
              'version': 'PZoeOlaX1oLhraI3r9401mORy4K2RKUN0w0wQH960KUC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'FTghjSV6VyLdFDGSxvbawcZW1KBBp_2P2Jqz2026m_0C',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'cL_TWqNQ64xngesAmCqLwKoCzuJKqYRPmxFKnvuMm0MC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
