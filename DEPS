...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'DumyV7fXji9r9Gx-hQ5rXJzOe6l2et7D6Werp_28LiMC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'EMSIjSVjdhhdmVYH2E9B8v7rwkrfMuMFCU46iQh3ewMC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/third_party/eigen3/src':
    Var('chromium_git') + '/external/gitlab.com/libeigen/eigen.git' + '@' + 'eddb470a09e1b9afbbfb25c85d0d6c5e429b3dbf',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '56dc6df1cffc7306c6a6594528b2d543a75a8fe7',
