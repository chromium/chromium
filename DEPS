...
vars = {
  ...
  'skia_revision': 'ae7f7edd499b764a021e8027169add98ae584aee',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'swiftshader_revision': '9534228df856f618086d8640fd67b2888f172c16',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'e25ef59817c7a0350d8cc947834f99db32c879e3',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + 'b47a3943e13a4bd521edbe828664853397919627',
