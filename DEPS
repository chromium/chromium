...
vars = {
  ...
  'skia_revision': '1edaa6cfcd9b08110310beaadff8f770724a9cf9',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'f940feb4e976349b17dba54b6ef6bce88c214516',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': 'https://chrome-internal.googlesource.com/devtools/devtools-internal.git' + '@' + 'e20a19048cc2529590d2ad93ca8dd9300a5cc3ff',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'eb485a627145e2bd65e0b1428ec6301325ff5697',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@1c627019c80d440acec88fac134838e233d2b18a',
    'condition': 'checkout_src_internal',
  },
