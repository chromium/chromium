...
vars = {
  ...
  'src_internal_revision': '87b19058c2d07fac5889e403e2746266c0dda9bf',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'ed58a1f8286bd71bc5f03541deff581c56c106f3',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'QsYdPhfPBdZrvQr0S2jSqYa3IzaqqCcJIgCnPJvwIk0C',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/clank': {
    ...
    'b1f3eedeb35bec4136faa60cd46a7ffd5f46fcd5',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + '0dc96d49bbbad3651e3ee39e8b18f0dde87be5cb',
