...
vars = {
  ...
  # and whatever else without interference from each other.
  'boringssl_revision': '8c78018f725ad02b3b219cb509ae43a39b92b177',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'crossbench_revision': '0f1e129c9e789b2cc92c24af80a44fbee64e7e72',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling CrossBench
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '2d3b491b631f3375d2cd65736e57689e544ad539',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@d418e8ba7c95801c5acc36cf18f712e9c01fc8a9',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'c9972a490afd10173a037ccd4e1cb26e85553a6f',
