...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': 'efebb9d95ed9fe6f69daaa4816f35f1775f02a87',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'catapult_revision': '4c5f19fe4195ac759338fe0c957c2275345b6fcc',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '378550e77ae16bacde2bc32d5cde66721496c261',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '88bc812650299ff2ae07af2ff8d8731be8a448ba',
  ...
  'src/components/optimization_guide/internal': {
      'url': Var('chrome_git') + '/chrome/components/optimization_guide.git' + '@' +
        '87f58a2db90660b3cdee33917d35ff22909bb8ba',
      'condition': 'checkout_src_internal',
  },
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '5774f37908b71ecad9a0193897df40a399158d2e',
