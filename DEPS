...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': '44b31d8dacc266a7c4122ed7f96b6a0394abc4c2',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'boringssl_revision': 'cb3b2fda3d434544085f4f32400ca2ba5c2877b8',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '426302f407c80d9fb2be3334f7527a3da1dfe07e',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'e11033f1d5d76913713da79391488eb298c0300c',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '64558d26c53d1ac2d23a3046d76827758f53573c',
