...
vars = {
  ...
  'src_internal_revision': '3bba5286b185a87ba4ebf47301aa4e65ac603ea8',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'ec7a9ff12b0af8bf86f35815d4e0e8db8750b5dd',
  # Three lines of non-changing comments so that
      ...
      'packages': [
          {
              ...
              'version': 'Fhyo9wJ7i0RbuoEFS5tWRf7THBLgGARJwhb7R2xkYzcC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'WZN7ndevs8GQBO-6m49aZ2NctdQpeGcFwfrV4cGeY7YC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '87d91cccac4bbb0008a1a88bde7cfb55062e849c',
