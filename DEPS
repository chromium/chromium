...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '6301cc0db1cfe066b06da062b9e709384a648b02',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@64885544d8a49784702f6841c35349921386bb08',
    'condition': 'checkout_src_internal',
  },
