...
vars = {
  ...
  'skia_revision': '75e5696ce29764cbd127e8788e8ff0d5b14d74c1',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '7277309b69b4e526435a16e4a1ba20458f470b98',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'f75cfe5ad3e92b56493d97342f4cf0a29007cfcd',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'ff35a37a8bf5c850d70863ff2f2ed53afcb8222c',
