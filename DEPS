...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'b213057b26d183169899bc45dc0ae3c7a5f7700c',
  # Three lines of non-changing comments so that
...
deps = {
    ...
    'packages': [
      {
          ...
          'version': 'EReFwNmg0-Jip86NLW88msL56kt7A2er-jrXuCFHR3UC',
      },
    ],
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@62ba55452e48d6453ce8264b2c776f3703cac96f',
    ...
    'packages': [
      {
        ...
        'version': '0eAAktuloaMwoApqfXtVHcdKkn4EoMZtRxSswaAMCUAC',
      },
    ],
    'condition': 'checkout_chromeos and checkout_src_internal',
    'dep_type': 'cipd',
    ...
    'packages': [
      {
        ...
        'version': 'adzkRO0GEzQkgU7tVfUflRxbbdoV6_v0LKEnas0mKz8C',
      },
    ],
    'condition': 'checkout_chromeos and checkout_src_internal',
    'dep_type': 'cipd',
