...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '69f4f1f9bbaead0d6bb340ce9d6a7a103575b871',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '19214818d79b9461b9e6dcbed3af35b56a64ec4a',
