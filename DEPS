...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '5885fbf9d474f46ef259d84688dffd80f714a4f0',
  # Three lines of non-changing comments so that
...
deps = {
    ...
    'packages': [
      {
          ...
          'version': 'cQG7P72p_ndEbLHxhaEDIoVmaf_jGOGDyXvKjGHrKrAC',
      },
    ],
    'condition': 'checkout_android',
    'dep_type': 'cipd',
  ...
  'src/third_party/openscreen/src':
    Var('chromium_git') + '/openscreen' + '@' + 'fb98aabab3ee63d07f0a56c8873e8e24c18b2055',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@5a1a43b3ef765c0fdee3a4ae30285cbe5f3b57d1',
    'condition': 'checkout_src_internal',
  },
