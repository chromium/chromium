...
vars = {
  ...
  'skia_revision': '2ac3dec589b25a48eb866b49dcc720ffec05e593',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '10722a720bc3c0ef73162fac2ec6763e09dc234f',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'f36beea9839e47a39779fa956560f4981e9a4373',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@41cdecd229cb30143b0220a89c6742c472f52429',
    'condition': 'checkout_src_internal',
  },
