...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '96d8230d3a7381f78f6d691ed426fd4dc0e5ac7a',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '757f5d1b0711e8e27d44f33ce41ef9242a7b110c',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '887eaa8ae70a3109544ad12ec2bb432f09bfbdc0',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '442e80bc5689345be3fa4d53875b1728101d370f',
    'condition': 'checkout_src_internal',
  },
    ...
    'packages': [
      {
        ...
        'version': 'SLzrt2w1me_cHVAcwBkGdFCNhq2Nl73DIilVBeRGIrMC',
      },
    ],
    'condition': 'checkout_chromeos and checkout_src_internal',
    'dep_type': 'cipd',
    ...
    'packages': [
      {
        ...
        'version': 'R0dS735IUwslcO0vJP7MWSLAP8fGkrFWiUupag2XzRsC',
      },
    ],
    'condition': 'checkout_chromeos and checkout_src_internal',
    'dep_type': 'cipd',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '2dec1f5f42e255d60fc0657d92b4806838a87330',
