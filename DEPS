...
vars = {
  ...
  'src_internal_revision': 'fc150017f8c49ac3324b2fb39425c0896f89ef15',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'crossbench_revision': '46435f8ac8ee3bc00ae2535676cc4a747b42efd4',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'a58cc91cab0f2c03bc3883614e5fdd914576bc5c',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '4fab32a0bcc2e3cd1036f6436b424080e9564e93',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '0411de876e46cca9b681f03a51f26144bec0efd6',
