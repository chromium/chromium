...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'jJQQAXswzta65sONmfoMKXxW8RhWm3ieKnAi-DaSQBEC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/clank': {
    ...
    'c0af1ec9b8062c99cb8d16fe9f5883bb20d7ff97',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + 'd341a3ceb26dfce70db7ba9123f868309ba2fa09',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '062e4527f8e4ca5d8c3b7244fc3f709f81a8ceb1',
