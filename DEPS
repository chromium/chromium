...
deps = {
  ...
  'src/clank': {
    ...
    '794b3098f349f3d3333b0c5062b5367598ee4dd5',
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + 'f2a36e8fdd52549fa912586f536e40551eda2d78',

  'src/third_party/devtools-frontend/src':
    Var('chromium_git') + '/devtools/devtools-frontend' + '@' + Var('devtools_frontend_revision'),

  'src/third_party/devtools-frontend-internal': {
      'url': 'https://chrome-internal.googlesource.com/devtools/devtools-internal.git' + '@' + '7fc7c2edf41d26cdad37151de434dd160fb0f744',
    'condition': 'checkout_src_internal',
  },
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@ef6c0c112a21e45f2c229da3df581d4df6b6a199',
    'condition': 'checkout_src_internal',
  },
