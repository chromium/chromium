...
vars = {
  ...
  'skia_revision': '243aad722201e47cfc8a1214d728074805ca2de0',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'ee4a6138511d69a549677c31b563484e25855d1f',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@3093a9ef3bbe03eb090a82e60f6c245ae107ebc8',
    'condition': 'checkout_src_internal',
  },
