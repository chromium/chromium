...
vars = {
  ...
  'src_internal_revision': '01d6f1fab4bc98b1febed26625f9b4077ec645f9',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'de40b6e5e942c367873e9f7d14373cf076288ae1',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '3ef301388cf4db8870de12340bc22cf915505de0',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'beb48726e5bb0f9bdb6fda4e7287745bd91595c1',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + 'b7939f75e4529586a4a4e0a3ac79a5f15c46c708',
