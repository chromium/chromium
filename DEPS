...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': 'd5e3902e5ab63cc50c95c1552ba8571d003613cd',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'angle_revision': '196de52a3670581eee89544cea89bcb57da00751',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'f483f9b36547e2173a7c2ec9cccb094f58e22712',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '3c8f1769c003a0d068a07eda1ef296d85f6ad94f',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@2e53eaee638db2f2239b09e36f046bcbc1a8632f',
