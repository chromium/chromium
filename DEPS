...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': '9e1ce8c1a36b9053e91f048cdd57da7facb08351',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'catapult_revision': '60c19667867ffdfc5af22da1b1d4822894a9b7e4',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '59b3916e30750097d20707989b5d0afa4afcce64',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'e6ecaaefc991159c20834494f31d288ecf30a1ac',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '58ae9a0f3fddad3460d735492830830efbff956f',
