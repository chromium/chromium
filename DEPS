...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '72ef5b328f6c7a9a3f22e5272357e97c4ac616ce',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '5279224b068c6721ecf536cb32e6f84fdd49272d',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '69cafb99e46698e028495a5cd516be7069a3655c',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@c141148848c4ed7a05abc20cb4ec957c04b6fd45',
    'condition': 'checkout_src_internal',
  },
