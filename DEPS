...
vars = {
  ...
  'src_internal_revision': 'c5c08a5927265d9c36fa1a5fde56f98184ce4201',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'angle_revision': '068a0ee8ab2e3badbc9550438a86320084891ee7',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'catapult_revision': '71fc601b51dbdc95b287037510ea20ce9c3fb948',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '84cd0f83d5f3661bd4d2f10287775e778589c14e',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'libavif_revision': 'f55cdaa902bf1ab6b07c877704c6b1326100671e',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '02114752ba606c18386d415e272e0dc175c93eb3',
    ...
    'packages': [
      {
          ...
          'version': '3wF_315k6HVPXFjOHyVEcewL9BdjCCpl58Z8IcTARUAC',
      },
    ],
    'condition': 'checkout_android',
    'dep_type': 'cipd',
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + 'c4b10a0bb14d3362094ee67b6d46b35706844544',
  ...
  'src/third_party/webgpu-cts/src':
    Var('chromium_git') + '/external/github.com/gpuweb/cts.git' + '@' + 'f2546cbeefdd09eaeb8c3c785112bb58fd17bf04',

  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '702820d08780d201c06394c09f6a227f8b37d40a',
  ...
  'src/components/optimization_guide/internal': {
      'url': Var('chrome_git') + '/chrome/components/optimization_guide.git' + '@' +
        'b0f589c5340751ac54d89ab535e2e38c4eb0ca0e',
      'condition': 'checkout_src_internal',
  },
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '378fed44d3d4c79ef7580b97ba83a3b85e55ac1b',
