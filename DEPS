...
vars = {
  ...
  # and whatever else without interference from each other.
  'catapult_revision': '61a9e1f47793b68c374cec7aeffeb787d2c704e9',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '7316c47c1cf37d05855351a56034c2a78ef0f5f9',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@5f07f8014d4d6c5aa84f6c0ff5f4421716d6ba77',
    'condition': 'checkout_src_internal',
  },
