...
vars = {
  ...
  'src_internal_revision': '572a928c64c840098417721edf6f97aacd016ac9',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'chromium_variations_revision': 'be9a057bd9eb46158d1beee21207347d4b205e11',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '89aff79ef9c26ff338f1b2f14899600ca50c34e8',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
  ...
  'libcxx_revision':       '0a172216de1ce3668700eedf34daf0355bc5aec1',
...
deps = {
  ...
  'src/clank': {
    ...
    '06626609de8ada7f290afc852a1b301bbedb4e9d',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'ac7979c42f7ccb65e379fefdcf7aabc2a7741236',
    'condition': 'checkout_src_internal',
  },
    ...
    'packages': [
      {
        ...
        'version': 'nUC0q2Dvf2kOpO_nqgYnR_A73B126mjAsYnyr3ppx9IC',
      },
    ],
    'condition': 'checkout_chromeos and checkout_src_internal',
    'dep_type': 'cipd',
    ...
    'packages': [
      {
        ...
        'version': 't4Kd53s7VPlMyBz7xRF1w-OHFqzsB3ppPi-Ubs2ckkAC',
      },
    ],
    'condition': 'checkout_chromeos and checkout_src_internal',
    'dep_type': 'cipd',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '83fedc59e2a236b1b44cb45dbafcd33091f8a17d',
