...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '128058fc300e0b07173f7b6567442d7a7aa44592',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'L-SB4OccEtp8cm-Z9NG3ogWZA9LCmsNPFhWMZcA9PBAC',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + '70f19de5254bd6e5c4d0e271879d6f741067b88a',
