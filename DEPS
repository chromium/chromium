...
vars = {
  "buildspec_platforms": "win, win64, android",
...
deps = {
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@706897cbbf31d751d29f57dd946e86152a9769f2',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@c4d00ea0779e9d764b9490d5495e6f2691d1af7c',
    'condition': 'checkout_src_internal',
  },
