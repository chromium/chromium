...
vars = {
  ...
  'src_internal_revision': '7989f93bb65a487bb28d9303c37401a007cf548e',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling Skia
  # and whatever else without interference from each other.
  'skia_revision': '2ef772706cda5edc2fe1b01da2ba9653f8f3ab8e',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'angle_revision': '7b0d26bbe4570b3aee4ed97d19029024336a46c0',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '0e156b9727e180b8b3571a6c41bd163ff4c054c8',
  ...
  'src/third_party/instrumented_libs': {
    'url': Var('chromium_git') + '/chromium/third_party/instrumented_libraries.git' + '@' + '05bc4cf10c882f9e2b860b6bf3e40362f08dc59c',
