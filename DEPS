...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': '2d3ad8ec6f09bcf6ceeb88d99bdd72b5253305c9',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '789cd5819050ae78c90b4274a770e621cf545ca3',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'b45d4deb3bb03dcc1da517334235cb17fa769bba',
