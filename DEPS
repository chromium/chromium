...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': 'b65467f30ad4d2d09b13cfae585074ec00b1a96a',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': 'e7c06367d4b5964c464995858ba11a826a9466e4',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
  ...
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
  'cros_components_revision': 'f9cff53c14ff4c7af76f227ea4b1ae747612d5a1',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '4447b27110e547b51ae556d24dda3baadfe51661',
    'condition': 'checkout_src_internal',
  },
