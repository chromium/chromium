...
vars = {
  ...
  'src_internal_revision': '4f6ae1bd05c2bc880c0ca8021d05d37c690aa9ed',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling Skia
  # and whatever else without interference from each other.
  'skia_revision': '961b3686b970a6ad2eb688df2140163fc71ad259',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'eef55dce453b991e4e2af16a59f2e24fc4f85d97',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'fuzztest_revision': 'b8a1c8cf743c0bcb6604b3eb3724b131250c85e2',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'gq7l5PbyvpxS0Jlb7k7s807UJL4q1AKaD6dwJJkN0aoC',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + 'b781f1764fe1126bae485f6f134ebf5c48c7b081',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'bc3dd4557e66f74a7d4829618be0a0aaacb87e7c',
