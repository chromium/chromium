...
vars = {
  ...
  'src_internal_revision': '41ac6dc9388607510740d614089bbbb3fee18e0e',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling Skia
  # and whatever else without interference from each other.
  'skia_revision': '8161f849a6e5c6701e109439ecaba3c59734dbb7',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/clank': {
    ...
    '9e69c0e17abb399dbee290626af3b6afa36c50f4',
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '63ae5028c13f5e76edd66dc13c95e8999273693b',
