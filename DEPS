...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '56d782c045f496ab970c59d6adc83ca1d15b6424',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'a7463c8d7026da513c82c9765fbc0f0495ef98ca',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@93d45d97e8fb3cc2bf9ff2aa1b10e765d148e313',
    'condition': 'checkout_src_internal',
  },
