...
vars = {
  ...
  # and whatever else without interference from each other.
  'dawn_revision': 'dde07e1623932b0d06a852d23250a3fcf1fa7118',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '2ce9e01b8d3e4615afb26733f86d148c1d595a31',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@9aaaa1853a950e5d7bfd15d4ced0697a211848fe',
    'condition': 'checkout_src_internal',
  },
