...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': '8e79a22267c5024d563272a270ef01d6ebbdbc49',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '6e70e86d6f8d3af7213d76146fdf8422d59b69bd',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@50101b8744ff2d19b5f393d9f5961e4078fa9b8b',
    'condition': 'checkout_src_internal',
  },
