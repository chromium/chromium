...
vars = {
  ...
  'skia_revision': '5ba330cd1324b0fa7f3e869a864bbdb42926f971',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '6d50f89dacc2743bc1e6212abe9db79905724980',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + 'ba7007f5e488861360577c0f168c6ae3c9f3b2d3',
