...
vars = {
  ...
  'skia_revision': '8ccbd0e950e87ee8fca308c276ed6a61d96c65b4',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '7179f61975d6b02e105c2a7ddb5f7906aa80ec67',

  'src/third_party/devtools-frontend/src':
    Var('chromium_git') + '/devtools/devtools-frontend' + '@' + Var('devtools_frontend_revision'),

  'src/third_party/devtools-frontend-internal': {
      'url': 'https://chrome-internal.googlesource.com/devtools/devtools-internal.git' + '@' + 'efa8d7862d92ebdb68f7619de3dae8c98bb80e56',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '31c373b8658651d404a813f641f9e8c49097def3',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@549dc502be7f2b769a311e52b8a8d3b65a4d68c9',
    'condition': 'checkout_src_internal',
  },
