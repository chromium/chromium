...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'dvMYAQrPXVcKA_EtAh_coarY-w0jksYKC0orr_oh_A8C',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': '7zW0jeuynVd9zze14lhjqzkeLEPLRiwdvA19X64nCVEC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'RFhIISl9sO4yiUVehSJmechIPfrUby6YbmjnRmvJsiEC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/clank': {
    ...
    '5877509465f77a44f007b4be5ca0aa74f3c289a5',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '1ade1eaf6245bd7ee3d00cba01358304edb7fa4b',
