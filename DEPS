...
vars = {
  ...
  # and whatever else without interference from each other.
  'swiftshader_revision': 'a9f5c19e28bd1b027df3e023b5e343151e8e37f1',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + 'e8ca7709cb3ae563e52da75fdd9aab49cb19cc37',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@ae4d4bc2b966a36f2bc3dd97cecebbd9bf974c1d',
    'condition': 'checkout_src_internal',
  },
