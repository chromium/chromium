...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '24abc0b4fa3c8d5e246823cf4183c6cc65e20b57',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'cf65c701fba8fa9b480138530995708471d3da60',
    'condition': 'checkout_src_internal',
  },
  ...
  'src-internal': {
    'url': Var('chrome_git') + '/chrome/src-internal.git@14a9218fe0298bc78483541cef36e3810a714dd7',
    'condition': 'checkout_src_internal',
  },
