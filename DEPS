...
vars = {
  ...
  # and whatever else without interference from each other.
  'dawn_revision': 'd521d0ee40a2e637377c82710918561fd485ba33',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '7f3e0e80b769c2aaa1689901b1111e92a267a92e',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@8de5e360bf4158710816d49b371ab485fb94aafc',
    'condition': 'checkout_src_internal',
  },
