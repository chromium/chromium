...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '7f7d15e45af00b23457761d0c79cb67abd4d56d9',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '9e4192bcb383d51b55db4ced8f5a7792fd7e4b8f',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '7816b2e42730e8c6dfac7339e62844e2c8011e5f',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '27e8a239b8af7bcb4d1295bff29437478bac1c1a',
