...
vars = {
  ...
  'skia_revision': 'a861cf0025f147ffffd504a3009d95de1e572c2f',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '8025ef7d1bb084387a7845d46be11b7594d939c1',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@3d46f8c3f54985df085817e57418b9955e6a930c',
    'condition': 'checkout_src_internal',
  },
