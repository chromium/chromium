...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': '83150e249f2fdd296d2f327e19c9279b54a69408',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'b0b3f82fca32f996894e1675ff3f203aee09c4fb',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '3396f3e8dc2f088ed0d840d8509bb292c7292cc9',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': 'https://chrome-internal.googlesource.com/devtools/devtools-internal.git' + '@' + '9bafd44aac05d9c2c0f24ef540dc4819e911f277',
    'condition': 'checkout_src_internal',
  },
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@35e2d5bcffa98b738e414a1013f70d44d20d9890',
    'condition': 'checkout_src_internal',
  },
