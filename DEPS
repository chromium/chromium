...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': '3394c36cb5ccd7f569786451b9316425d5a59a8a',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '9eb7de0ab13625e8973626c536e213c06d69b8ea',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '6f46e9ae5e0dea5a7c474d053b2716dea07b585c',
    'condition': 'checkout_src_internal',
  },
