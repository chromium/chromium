...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '43c725e2ba5acad2b49f69187b4d92ebd17a56fc',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': 'a70492d77705a89cddee6ae3582f7d9845013f70',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/clank': {
    ...
    '54c2d6feebc466587e89928d8f38e1b8830f77da',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': 'https://chrome-internal.googlesource.com/devtools/devtools-internal.git' + '@' + '9faf4c8527be8dbbe7baea77482b816f3b7a5df5',
    'condition': 'checkout_src_internal',
  },
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@b46433464b6a185781687b5da9b6286b4a5d6425',
    'condition': 'checkout_src_internal',
  },
