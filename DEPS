...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': 'd8b3e61dee916d74b895154ccd5d6ec8df76ce6a',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'e7d198e1987044a293bb4d396517f45de44c85ea',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + 'bd045cc077b8b4518cae23bea9fc83bec5af5e04',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@63f49739609f2e2766f55dd3a4db30667b2b9b4b',
