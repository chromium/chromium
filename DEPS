...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '7810470740918b2dce457146991684adc366d035',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/clank': {
    ...
    '372c2077214a2159a63a1435d002f297c6d4921c',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '464562de710a7b51d2e64e389c73bdfbf96cdaf3',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '73cd7c9906847ae3cd4c34cefc5729292776e6bb',
