      ...
      'packages': [
          {
              ...
              'version': 'dPNQgJLyUgHCG_7q5wVPm9ucG-rMQqJpD7pTS1RBr-gC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'F2eN2ROt5aj6ymHK3hiOKzlJbK1i1vrEw39Y60ZnNPUC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'Mb6kW-qKSxj75HNMtxlIJzo1PfJvAj6lLSNSG6DJtXAC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '4fafa49f4ded4aec45643bcdf4bc3132dd137963',
