...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '1882988e02abe980380d466209afb33318358c97',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'pdfium_revision': '2ae0976943abf567523989b2732d6d57a7ee03e1',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': 'https://chrome-internal.googlesource.com/devtools/devtools-internal.git' + '@' + 'e7ed87a038cb5b71e479a832c219b4a7351357a5',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'dfa57fb060c76434875cc5bf8d38b2e838980df7',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@265952aeb3a6a5edc13d8aafd373b4ccb2c418e7',
    'condition': 'checkout_src_internal',
  },
