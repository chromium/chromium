...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '8f40b89c59d45530c589faa0673a67d39a4afb70',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '9d372be4d8b1d1dd97452c9646b36d60ecf2487b',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'c66d45a809ca0494eae8530fb1b6a8cc42fd0083',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@1469b9aeb0944d5c71f220a7f9378bf68fb2241a',
    'condition': 'checkout_src_internal',
  },
    ...
    'packages': [
      {
        ...
        'version': 'miz-Au0nmiFvT28PJI_8QM6iln4ps-gDqmwQFCImuUEC',
      },
    ],
    'condition': 'checkout_chromeos and checkout_src_internal',
    'dep_type': 'cipd',
