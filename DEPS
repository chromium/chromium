...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': 'ebd15e2be7e6c27e783af587e54067add27bccba',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'angle_revision': '5a9859805e5a31d51baf6abda97a3aeaf859be7b',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '27f9ac6ec1566274c7ba1856f2365c1abfa04085',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '9720e168ff215491dd0f4d337e8ac1b134ad3c16',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/clank': {
    ...
    '02bd8ba01e1207f937a6f46d1d76cba6c746b0c3',
