...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '1e68957df7bb66440c0d73ef3f7e52810eedc9a7',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': '7rPq_k8UBbLnsZxhQHa1VNOCW8IHKrSYy5v9-6zc520C',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/clank': {
    ...
    '3c65ded579862a028c8371f8d5ccd27bb596716f',
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + 'd72fb3a9a7007f85c82276bdeba73af6e01adbce',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '67ce67babeda453b36f936e261ce7217fe7a4801',
