...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'Z2NjKew9y6YSSVMwJLcS9zXMlAwUS6NQ5aQPu31EJlkC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'd8qg7GP68NWtf7Ws2pw3a6CxofkeBCduuCRgVoweFp8C',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/clank': {
    ...
    'fd189bd1d4ef6407321d551d6530f7403325aa0f',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@ff6522d5bafbcecc3cb5578725c85ca31b13d317',
  ...
  'src/third_party/vulkan-validation-layers/src': '{chromium_git}/external/github.com/KhronosGroup/Vulkan-ValidationLayers@e4c686930522e5f2f3ad255295b534260c0500f2',
