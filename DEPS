...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '7219df0fb0ff64f26adad448f94e8c001b964e6a',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '2df8854626abfff956977c036b8844a34b80fc04',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': '4f0c07753fc42276105a97f15f05a4aa90db5f02',
  # Three lines of non-changing comments so that
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '76245769d3da968b5662efcf737cd0f7f41cc9a1',
