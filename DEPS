...
vars = {
  ...
  'src_internal_revision': 'e3e7df3e8e75c46a8759a99b393b2965ae4bb14e',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '3a00cd90fdd5d0f75958e9daab83909718f18d09',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '538f92a49ba5cbc615bcaa063214fca38ab87813',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + 'b6ae45fcdf34f70ec4cf69d620ee60a2bfce6cf7',
