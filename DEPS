...
vars = {
  ...
  'src_internal_revision': '05ce0e50d4a22bade887e3774f6608c06b3a380d',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'f097b85c1aded26a96339d9bd31f08924aa379ae',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'a7ac418513703664a94583a5b62045f6df13120a',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'ce69a0f7e7076d325c6c41d01ec2ed9e4eb26aa1',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'd1019731838e1b01353e2fe7d9597fbd391324ad',
    'condition': 'checkout_src_internal',
  },
