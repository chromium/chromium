...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': 'b82feae3f4b96dfbf0edebc3a5790cf9141a4c04',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '8bec401b1934ca55f9d742ee68f72cca4de47931',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '81cba3f330bb715e7b2b22aad0fdfc3e1137ee30',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': 'https://chrome-internal.googlesource.com/devtools/devtools-internal.git' + '@' + 'd8c21d33f0e5cdccb2caf11fb9638dcf16a4e19c',
    'condition': 'checkout_src_internal',
  },
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@82698eea61e41f37f9112d8357dfe12d0ff7ae90',
    'condition': 'checkout_src_internal',
  },
