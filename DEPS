...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': 'dec311244db4814d9ce9b55afc50dec32cb1b11e',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '1fab97eb86bff36953dfb458ed8edb6380168217',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + '56b3c449c968296bda3831d7cd2e0d2140acc9e9',
