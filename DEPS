...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'c744b120edde68573d27f53382017045e9376b71',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/chrome/release_scripts': {
      'url': Var('chrome_git') + '/chrome/tools/release/scripts' + '@' + '1420d1d49cb4e895e6b137f64712d81aeb4a4933',
  ...
  'src/clank': {
    ...
    '7150c24a158a28e57dcf563102d32aaa5e4a2301',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@305ec8e5086ee5341635ed554ff84f835af3fe7c',
  ...
  'src/third_party/vulkan-validation-layers/src': '{chromium_git}/external/github.com/KhronosGroup/Vulkan-ValidationLayers@b6f5b88c136142ba41b76ada5ab8f2cd4174031b',
  ...
  'src/third_party/webgpu-cts/src':
    Var('chromium_git') + '/external/github.com/gpuweb/cts.git' + '@' + 'c09e68cdaa4aded26b769443c743985a6cedd383',
