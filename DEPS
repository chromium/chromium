...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '9c2fa49f870aac620b87b2767201c15d51d2d8a9',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '89d777d93ba00da9689ba6898a0ba476bf26594b',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'o1RoyB5JpQgnxBpqdqI4_ORdyCEzLJ1tD3ZK1ZQfOX0C',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
  ...
  'src/clank': {
    ...
    '2ba36a9b25efd2cf2a18b194007ce91bea6d4f32',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '36a9782b949c0b0303cc976b3b1bc7289db8d956',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '97d849b34017b541aa89bda0593395490376184c',
