...
vars = {
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '8b2ab40c392020d555ad0ea9174440709abdc5a3',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/clank': {
    ...
    'ef0c7d957a16afe539abda90596c6338e2ec6330',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '745ad21160c6b4afe885a4c9e07a4f3174e675f4',
    'condition': 'checkout_src_internal',
  },
  ...
  'src-internal': {
    'url': Var('chrome_git') + '/chrome/src-internal.git@c8d4fc8addcc2b8298e96367d576280d017b2556',
    'condition': 'checkout_src_internal',
  },
