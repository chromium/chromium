...
vars = {
  ...
  # and whatever else without interference from each other.
  'dawn_revision': 'e88005be8d20589583ef3587937ea40d5607c500',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'ia-Zsbhmj06Ymq5SEORGoI-uZ3FC3cwRJbsCitRGKmUC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'i9xGkVCJ1Jkk0suLnqwoZB7Ed52if8CQ0QDCNC5DgMEC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '9c2497e795477d16dac808e12d7f53f12e90ebc6',
