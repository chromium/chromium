...
vars = {
  ...
  'src_internal_revision': '516ebe9df0af91dea1ce39b1aff6db4d9fff29b5',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'catapult_revision': 'de642f5d6d76569ad10afbb91c15c859e2c73dec',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '377c1486a3fa74d9c2a1c61b04de0ee9d9043c1a',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '83d037667a4fd5a3360f1d021de084fa42f27235',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'a703a066e92db2a927ff2b827dce8854e78daae8',
    'condition': 'checkout_src_internal',
  },
