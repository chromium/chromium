...
vars = {
  ...
  'src_internal_revision': '423945948f7f1d4cd901d27b4f9045c0c6dad168',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling Skia
  # and whatever else without interference from each other.
  'skia_revision': 'cd98397d0c2c3eb1d5a8d76aade3c87c2e0d28ac',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '485b9d9f88ef1c4787b183b8ccc6cdcfbc07ab1a',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '65fc64fce1c8b05c34d03ce7eb4304d471c971b3',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/clank': {
    ...
    '141bd143129e00694eac06b66d531c7a22bea6e7',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'f54ce57e8a3d6208739cecb0648cb1a67d1c98f7',
