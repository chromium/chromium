...
vars = {
  ...
  'skia_revision': '85559e0993838a3a2c56cd744294b3a36afdd6d7',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'angle_revision': '7013bc86e5b72babb3d221749734a98e71b472b9',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '6022324d880e56bc1b1a942720a9aa272d00f21b',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': 'https://chrome-internal.googlesource.com/devtools/devtools-internal.git' + '@' + '7b26f14daa4ae017a7597e8b80deb2f2b18f8a77',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '4fbf05c049284e3807046b7229cc1da565baf367',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@a4bc1abc3613bd6ed05a0b97dd56758d6a383bdb',
    'condition': 'checkout_src_internal',
  },
