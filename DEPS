...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'ede15b8533cf84a7ebef5380ad726d7abdd4cfca',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'chromium_variations_revision': 'ff1f32b3501dd20d28dd64f535bc45a2806acfc0',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '5193809bed7c0a25621f3aef9d6ec2b9641a487a',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '660c7326b4f144e19fa57f904a0f469ab15651d6',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '5ed20c6e2cb6009dcd221c8040491ef2ca0dfacf',
    'condition': 'checkout_src_internal',
  },
