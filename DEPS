...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': '568d810afe4dd9ee7b6b88a2f6e8ee3f160feaf0',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'ef44cf12ed2e5e002d15a7543c78bc2fe92b0780',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'cd55557a7404a71efd9fd56350c6d021a60e7602',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'ba03b4dadf734e12607dd9694dda5a8a038d7d54',
