...
vars = {
  ...
  'src_internal_revision': '7ac04e88b5decfe2e986c2c21dc8096a089feae5',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'ceae9ef6cd82504c5e5976bf79afad857a7a3977',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '5dbb6f71a9bd613c0403242c7c021652fbf155fd',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'zx8tC1b_y1x9sSdgsPao8qMtg1COlGnbsBTEnyTyok4C',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
  ...
  'src/clank': {
    ...
    '058e9b2aa355eaba5eaf0b2511a814dea5e75a8a',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '624d0076280a79d9d964b2f07728de7572ed5775',
