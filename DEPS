...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': '9c66a0925dbc6c03f898a852702d504fd465c133',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '7c2505565a259d8af4994a0076348a9435524cf2',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@962e0bffb3c6a6005f6146103e534a0d38fa00ef',
