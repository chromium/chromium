...
vars = {
  ...
  # and whatever else without interference from each other.
  'crossbench_revision': '0ee96b43bde92f74d43813b199222c079821a245',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '2fadc23ac6f032ccc9ab3ac6c6e76f2e07f3ca01',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '518de1673ed411ba84b417377751ca7603a89bc1',
