...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '58669f2811b2ff529ec911f9c05604475ee52c46',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': 'a7ef6444610fcff176f32cb55817e1336d3fb042',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'a86b68ec8051833963eda0d04bd7118eeea388ac',
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + 'ef088c04eefd3f55ee3c0e953d87796e0bead58a',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'e8c8218f1b3a94bb43ad3f5f5e202dcb2657f6f3',
  ...
  'src/components/optimization_guide/internal': {
      'url': Var('chrome_git') + '/chrome/components/optimization_guide.git' + '@' +
        '63ddeabf4c9a568c6f308364962ea945c13e5752',
      'condition': 'checkout_src_internal',
  },
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'a22e56e816024e276a2201e140155a6474035476',
