...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '3f54f674488abfdc9a071da74a59da3d3fd46034',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + '04410d4bfbe02f82ac8916ec99ef955bf87d72df',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'ce5c7eff7373220a4912eccb456927d1e721549d',
