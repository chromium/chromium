...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': 'aadb8434cb9179ef137eb992d91ffa6b8cac10c0',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '3c366cf62af8f2b5cec1eb01229fcc66de6dfcc7',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@95506479fedc21279242b54c6177672a0e31fd2c',
    ...
    'packages': [
      {
        ...
        'version': 'vJFFMop5dwK5UfwFVkbBAJnr1Pjqbe5e7dM4SRWfTEwC',
      },
    ],
