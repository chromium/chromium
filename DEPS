...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '603b74da8a67c1e457bb6c826376d8dfcccee826',
  # Three lines of non-changing comments so that
      ...
      'packages': [
          {
              ...
              'version': 'M341HKL8Y4Bfl_JDVpyk7afArkaIRARRdxUg0owQXzEC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': '5D1GTWjD9MEqsXcYj7pStM2eTiu3larb51rQd5zxFxEC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'Y8m92mHzrzRDpJCab7d3-aDzHnDOit7fe8-UbrEGppIC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
