...
vars = {
  ...
  # and whatever else without interference from each other.
  'dawn_revision': 'af908a32679248b3a6a3f4a6f32519fc622bbf8a',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
      ...
      'packages': [
        {
          ...
          'version': 'DEFLtFtdsHzNC20jP0-EKqX9Oy37XoScAyHc6fwn7VoC',
        },
      ],
      'dep_type': 'cipd',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@a561444697820b42f48b03e0e511020e2761178a',
    'condition': 'checkout_src_internal',
  },
    ...
    'packages': [
      {
        ...
        'version': 'lLagk34D8PCyY7pGgPYEp4NzDNam6R-6FMnjwEFrgnsC',
      },
    ],
    'condition': 'checkout_chromeos and checkout_src_internal',
    'dep_type': 'cipd',
