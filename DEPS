...
vars = {
  ...
  'skia_revision': '75c38f94efd6b919b7636ff41883c45339219493',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'catapult_revision': 'ecb7a9bbb81652ca660c516b4b6db38c2b1c722c',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@e3e941194d5239e854e37609edb2a22bd4b640be',
