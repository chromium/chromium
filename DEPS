...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': 'e8d7db9facb4f23ab15d6205204d9b4bb61fe538',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '0a723634da326cad0091b61b41b7f086cf2f1685',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '652e2e90675d874dcf76ee0d7ea7c9489dcba24c',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '0fbbe876e830119e63ba62935ec913de0d13f726',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/clank': {
    ...
    'd3d0717c102fd2c4a18a35564a775fd23bf4a542',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'fa9c37bb63cb6e8340d4f058f479454d248e8140',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '004a624023ce8b01c0f9d8a62fc13390d604ce34',
  ...
  'src/components/optimization_guide/internal': {
      'url': Var('chrome_git') + '/chrome/components/optimization_guide.git' + '@' +
        '7d564d37929fffa26c57bfba60f7bbb0733f394a',
      'condition': 'checkout_src_internal',
  },
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '07015ac2098b08c0258539dd3155917b3fedfdea',
