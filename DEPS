...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '953ef34aabaeda010e05c578a8e2de5c08e25c91',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@484d6ecc00b61f3581877c795d5a670cd52af85b',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '99c1d2dae81fda07a0a7a6f0795811075b38eec1',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '04be581606336275622b9f6a3bec0f3e8a1445a8',
