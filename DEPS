...
deps = {
      ...
      'packages': [
          {
              ...
              'version': '3MQlQo6hfEs-FQBo8zXq9PYar3SA-nGOm3WkrJzzvdsC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/clank': {
    ...
    '1c694a14ee58c4295c47d79ef84ed00715de8bc5',
  ...
  'src/third_party/eigen3/src':
    Var('chromium_git') + '/external/gitlab.com/libeigen/eigen.git' + '@' + 'cc8c7cf0e6217778741e86ba278865c26b619984',
