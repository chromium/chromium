...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': '42f17af9d3872e6c22d964908c97dc509cced4e1',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '5ccc1b79f90349829c2572b7f4e9c4072d0ef604',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'uz8Mhc4VmMiRTr2XundgnUNdiGXnen1oMxGdOKoMmacC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 's2sBkEi98BApq4CYeck76QLDon9pjPAPQuJ9YdBplFMC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '2c3c984b00a5b6e15f661acfae23a512c81d5030',
