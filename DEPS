...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'fe4fa1cb2aa816dbc7583d5cdd084dd7a817fc38',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + 'b6aae11e6468330a8cdf54d06a6ec9e616993e7b',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'e9c9a519416af8b0b6dfa74bc3fa2e0cbe4b133b',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@210de4cc09c006657285f683140fece9c725b82e',
    'condition': 'checkout_src_internal',
  },
