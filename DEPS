...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'b0f33007113dc18886673b5ae14ec3964e1d65e7',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@7d39fade0985eba2f1e6ca1f36aa8f993bdf94e6',
    'condition': 'checkout_src_internal',
  },
