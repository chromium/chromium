...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '3956e1bcf898f8cb7e171201ed3a790edc2dcdca',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '7b1cbf55d40e6b2970d6d06860c4e13d6e591d5f',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': '1dcd187236d28119b08bd970a0a202a93b0492ed',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': 'd98d9ca2cb80995c50998effd9f7fc01bd240350',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '3ef1f73726da31c01c38be385da8ff99173bf04c',
