...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '5615f930baf657e0e57b5f2705c57202ecf57092',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'crossbench_revision': 'cd29caf21ba7517df5f20bc32aa47072f0d4fc66',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling CrossBench
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/clank': {
    ...
    '6b0f17e3de601294230dcd3f43f78cd914a6cff9',
    ...
    'packages': [
      {
          ...
          'version': 'baTnLIjr8sPSaLgFlrZa83hq6kxqnQqQ962KnKEVCg8C',
      },
    ],
    'condition': 'checkout_android and non_git_source',
    'dep_type': 'cipd',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + 'e2b82363b4c2a1912a6e33c9c6ae8a6561a35b93',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '1cc431b33fedcad5a2c6a6503e8d625e773efbe4',
