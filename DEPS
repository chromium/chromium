...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '25ca2b9de098c0c18fcc881d020a933b8b1b0853',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + 'c14bfe4cb2cae9e6d63ebe4bf0e889babca3795e',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '4f95188fc23865b7922d8135c16c47ac5cb6276b',
