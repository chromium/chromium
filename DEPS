...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': 'ebb2599ce16db79df92d3805f5d54147e629a2ba',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': 'https://chrome-internal.googlesource.com/devtools/devtools-internal.git' + '@' + '503e290d81dfd00d3489157b4b9d58f274f289c6',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + 'a70169d7ae6249a9706a51de48ae5f53ce1b724b',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@66df36f80e706e7812b6130671aa1a57e449b525',
    'condition': 'checkout_src_internal',
  },
