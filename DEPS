...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': 'refs/heads/chromium/5002',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': 'refs/heads/chromium/5002',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'pdfium_revision': 'refs/heads/chromium/5002',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'bf302001d40d1cc418fe46e74777464c1a0f85ba',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': 'refs/heads/chromium/5002',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '6e980ee33ef57032de94b1ba04d2c79c597a2a88',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@refs/heads/chromium/5002',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'refs/branch-heads/5002',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@refs/heads/chromium/5002',
    'condition': 'checkout_src_internal',
  },
