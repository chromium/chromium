...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': 'f2624278cd4bc2a5d4cc211124a6b60bdb4621b0',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'boringssl_revision': 'fd2208913f505586d77e897b73c389a9e6defa4c',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '4fd484473ce84aea06a0d46b710b4bb8577c804b',
