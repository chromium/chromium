...
deps = {
  ...
  'src/clank': {
    ...
    '13c6c06284aa5cfd8162d17793f119230957646a',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + 'ed789aff623d01b72ea960faf280dbd334accfde',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '08837f6e91e7a1162a92f7b4c67b991d0482f3f2',
