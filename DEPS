...
vars = {
  ...
  'skia_revision': '14efdd3d50db5d1871c994a7ad778169c61318fb',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'b6fc208511db59edbc2d4a3b3a8abe0124e6566e',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'nearby_revision': '54f30cd81d172f27aea31f2d1e620a2ed92ea2f1',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '12f724860dbb6f6d820b13da4c3d715f4e8ec9aa',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '0365c99474fd812283842f650cc090b957d73ef2',
