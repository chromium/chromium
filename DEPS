...
vars = {
  ...
  'src_internal_revision': '7f1a34e993cd449338341ffd46b1999d6dcbd350',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling Skia
  # and whatever else without interference from each other.
  'skia_revision': '28685d899b0a35894743e2cedad4c9f525e90e1e',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'ce92cefac8e62faf9fbac8388753efa33dabb6cb',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '99d11dbe7785a017c130931da851beebad934c0c',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '1be4f7b9b3a86532d76a96fd7bd9555879ba2114',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'feab13cc43bb6a5336fa7e4fd5d0e607028e4ee9',
