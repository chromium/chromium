...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '0529fe306200807c77eec8ac250d7ae6631711cf',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '0767189fbb2b5f92c375c59f3ed8cfe7d42b411f',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': '6724f8068857a2edeb1ffd0ca1dca3e7e9641f71',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': 'https://chrome-internal.googlesource.com/devtools/devtools-internal.git' + '@' + '062f4d46a2cc6d49c7b1270511a6302bb228ee06',
    'condition': 'checkout_src_internal',
  },
