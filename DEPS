...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': 'a01eb11751829966ffe9925388e47f85ce585870',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'c58e26c44634159e5c8a189d7f9abbf018ba9b92',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'GmdQyhgeHqWc93rQBT9r3LEmMPiO_vx6CslHoj5D7coC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/clank': {
    ...
    '8440999a973baf7cb66083d198481ae2d4cc668d',
