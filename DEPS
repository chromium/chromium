...
deps = {
  ...
  'src/clank': {
    ...
    'ae56924a1174e8598f0c287c77d0c31338d9711b',
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '680c4976f81ddbedd2a3161a7ac3603751cf7d96',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'da9ef00b6178b6c24c99eba4ca51f5c9b07b07ea',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '6ecdf73a8baa26d3162750f51602c17b69c912cf',
