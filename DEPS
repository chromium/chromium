...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '9ea5a1dd5270ecaf4008fec701efab7e10948dc6',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'c53b340599e20e3c294539e7843009c08ef80059',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '880a967b74f2d25b9c709f4b29082f3bc8108176',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'a66f63a24180a543c99b62b33760ee159359b751',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/ash/webui/conch': {
      'url': Var('chrome_git') + '/ash/webui/conch.git' + '@' +
        '81e45a37b3124b25cb70795b4e065d5cd00ae7ea',
      'condition': 'checkout_src_internal and checkout_chromeos',
  },
