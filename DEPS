...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': 'b8517d1e25f7445e6f6a5b9eb549c5824e723642',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'boringssl_revision': '2215589fddeed380d6da639fc610839cd5950920',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'UmHcGHl_NxUtsFM2Il6nmo3cNSP1wLizkFEMgYlKklUC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'y5gVT1m4udj7hapQatEP1Xqwu4eFwWNlK41WynuDTRIC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/clank': {
    ...
    '34c8e60ef183bfc53f67a175a6b52a71c3a282be',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@4baea9acfd6f222982f07465675aab6047299b26',
  ...
  'src/third_party/vulkan-validation-layers/src': '{chromium_git}/external/github.com/KhronosGroup/Vulkan-ValidationLayers@2924c5a2f5f09eb5ec55118f132f94aa9377f557',
