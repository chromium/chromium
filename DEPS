...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + 'e7ec2368d65ce217b7153a3e21b537bfec38ce30',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '2ea77ca557b8c6198f059e430c93aca13b3067dd',
