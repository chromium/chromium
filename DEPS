...
vars = {
  ...
  # and whatever else without interference from each other.
  'boringssl_revision': '1bc58a303ef577f4dc5c5ed0612e9766c85dce8c',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '0401dc7c8c5dcad5fdf618b326f9b0045786898b',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '9dd1580543f2545e07532ad22e7a555be56d2bad',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 's8FusVkqt4QihupJKuZdBfpPJbNd3RP8GUv_bEtIBDAC',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@bb502872ba9898f93582107adbfee73f5325c9d1',
  ...
  'src/third_party/vulkan-validation-layers/src': '{chromium_git}/external/github.com/KhronosGroup/Vulkan-ValidationLayers@17305adb9e646455e9dc29808aaedb5257fdb712',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '9f8cbef7614296cf537e393c44c4d56f9f834a48',
