...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': '49272e6e343953a4687a3c71c11ca2f04198ba3f',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@cdd3b377ef43e2b0e5f27b53b4a0bc1e6f72c6f3',
    'condition': 'checkout_src_internal',
  },
