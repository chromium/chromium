...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'b7211e25a0ce5fa07cb1c9a3a8e936f2bd0aca0f',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/google-truth/src': {
      'url': Var('chromium_git') + '/external/github.com/google/truth.git' + '@' + '14f5cfd604f2889c673c512d9bf549a2b6f1234c',
      'condition': 'checkout_android',
  },
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + 'd742ee3b0412cd77f2e8c0dcbd019e09842dc001',
