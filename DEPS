...
vars = {
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '4c87ca7e8be236c2c0c503edf9e3c547ab07e0ff',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
      ...
      'packages': [
          {
              ...
              'version': '9NCRdv1xn0um5QsGss6HXaf1BfkiRGqaA5D46X31EXIC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'vnw_gRIB5SFgrfY-WFJXdD7JeYfbkDJQsQXi_eIGhr4C',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'NtzoijvuLGvzLYtabrBdHH_7Ph-nJ0Fq3-wVaa14lcMC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
