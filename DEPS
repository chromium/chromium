...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '7ed5f952e79035a4f5a2a61e05e920d2768b154a',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'zipKa7yqA8ecNR1hQtY2m3rohlsXmegY5-gzgPR2NGQC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'H-fj5XAu0ZPNocJdgYthzsPZ7RjSLvaxyCg0sAbhQXYC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'MQmjWSp3jLp0xIUU0gEecbVE7F5hgo_2vAtnNJo7a1gC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '1788a81407183acc98163a4e1507c5c63fb175cc',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '9869ae38051aa0795da8153bc896c5e85286774b',
