...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'EblfsCRTnPc3sPVlsMOy81HIfmVT9qh7B2fDyVy1YWcC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'trlDO2hAAnnTj6i7Q3qy7zLjdSFY6pCyklGg6buXoQUC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '997079137283f693a0fac6a5350ae7f6f2cf3b59',
