...
vars = {
  ...
  'src_internal_revision': 'ce3471fc9967f6bc2a1fd62861ee1fd3296154ec',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling Skia
  # and whatever else without interference from each other.
  'skia_revision': '260e9149ba3edfd05ec1cdd645542894d0530645',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'c54259b0c84ea968f4a2f248c0a552762f47f371',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'FHAuFFt5PzTvBBsLFNXPV90Vs066FvAiYa6Xn9wCqEcC',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
  ...
  'src/clank': {
    ...
    '6c06a9d07508154de7546c18ca0c6b24d25ab4b2',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + 'fcd41bcce24052b07b162009bb0b5f945c1636b0',
