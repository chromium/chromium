...
vars = {
  ...
  'skia_revision': '1c5186754095526d520e97ddf7c9110ab8fe9ef8',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'fefe1dc71540a275bbd9c6bbcd0b416e5a504a6d',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': 'e514e1595cd19050d6f726ff4fb59086005aa409',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'b51d5ec1ab7b256189e4905f85aed20932a0d4cb',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '7372dc5cd76b62a429fa84d8c865e66ac07a8158',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@30f43943287f3b275215a3a0fbacd944fd1b02a8',
    'condition': 'checkout_src_internal',
  },
