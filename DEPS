...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': 'e5aa1ab5c59c492302052657ff4f2334b28a8f36',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'dawn_revision': 'd5692ff2fb57fcbbfe96cf71831eec135dd37088',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'K2bh8M4__fqUasChRBOqoyASnM6HiHZFJkAsbXbM4f4C',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'gcHdkvwetAygoKGGjD4W9wewgjlFwEsJ7ivwIAmlfqQC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@861a988e9415529b7770b1210d859c363b2b844e',
  ...
  'src/third_party/spirv-tools/src': '{chromium_git}/external/github.com/KhronosGroup/SPIRV-Tools@05bbb6906a5b52d590adda62b9ef756e7cb13569',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '12d717eb0cffc501d08e604752d58cf2075b10e5',
