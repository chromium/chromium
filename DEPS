...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': 'f3787285c7f3636cabef27ab5a5ae96f4114d823',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'angle_revision': '1df94a6453e3d0dac2f10eaec2352b33b56d82c5',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'cd71756ccf542793a1966a2706a7748086361d8d',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + '4089b36bc8f3c7c81b6073cfd7630bb366d48264',
