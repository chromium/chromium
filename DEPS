...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '8ce2f2b7ab03a5cebd61a2e0c4593540c2a47b62',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': 'https://chrome-internal.googlesource.com/devtools/devtools-internal.git' + '@' + '1cb921d1504f7a33811319f4389e24136cce1605',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '83555f6f043a76aa8432abe3e058dc74db52c80b',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '5683a127284ef541f2dc73768431d0490aaf8eab',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@303ac29695dd0827b4264870bf2a0a7cb581323a',
    'condition': 'checkout_src_internal',
  },
