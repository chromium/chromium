...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': 'c19c1b2ce2a08246c5ffd51bc78dfb63c8d8183d',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'angle_revision': '9217d49db032476b003472b539b5c76fff234be1',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '5226a88fe0de2bca75994aca343c663211e32a8d',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
  'dawn_revision': '0053fef8a47d72a1a240df80395d5a4bf9f6170c',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '934ac6ebdf6bae93a83c75d4eccd36e7dbfaa13d',
  ...
  'src/third_party/openscreen/src':
    Var('chromium_git') + '/openscreen' + '@' + '1030c88a4bb869ab91ca5abf28471e50183f1bcb',
