...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '7c2938938c6234057190bcaf067e523ac675b9e2',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/chrome/release_scripts': {
      'url': Var('chrome_git') + '/chrome/tools/release/scripts' + '@' + 'dee9f13b8f13be12576b4ba890134d69ef17197d',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '0c2534534ea378376fd47458667a05d11959e9be',
