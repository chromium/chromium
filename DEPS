...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': '5e34541a1c37ed97614e94361158d502486fe205',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '5c187447428ce70233ff42df9c0955176de7fb5a',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '2f3168ff383c393c1af635b872570aabf3f6d7c8',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@4649156c3792a8e767080aca30d4e6e27519a711',
    'condition': 'checkout_src_internal',
  },
