...
vars = {
  ...
  'src_internal_revision': '8ecbf4da3b2d782167895fa19191f56879afd71d',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'eaa3d4a9d29b517fdef35a70462b6f3ebd8e7de7',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'crossbench_revision': 'e7931e690138bee9acbfec76cf524895c730546f',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'ff27df9b720ff9e22f913fb765ad70c4b822075c',
