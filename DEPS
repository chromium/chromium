...
vars = {
  ...
  # and whatever else without interference from each other.
  'catapult_revision': '44d7df752c6d338b487054b119048b8e9e3f854f',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'a25d1719d8b2198714e3a1fad2828cfdab6340b4',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@3600ff36c292cde5901b2304074ff2c80b7e80df',
    'condition': 'checkout_src_internal',
  },
