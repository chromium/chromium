...
vars = {
  ...
  'skia_revision': '05ede704bc182f520f03bcda70ec56a36fd39b6a',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
  'dawn_revision': '48e24a2e9abeaaf761f07c0bd4771a5905289f5d',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@3ab6873de919fd746c3ee1e19ddf66fe6d23233e',
    'condition': 'checkout_src_internal',
  },
