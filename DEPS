...
deps = {
  ...
  'src/clank': {
    ...
    '50d851d665ebb1cef83a4b851129619380cd8d93',
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '4ced9d3c96eb45e643861fcc5196fa127ce8ea88',
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '52c86b146ad008ce877e74622fd4523cff31a568',
