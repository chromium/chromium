...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': 'ad9caf871c763f8f87c303ee804be1c98b14d81c',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
  'dawn_revision': '11b40d1ddad9d02faaf299b16b7ebc0306d28938',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@597b078922eae4deeb0da60da1b6b6f9b7ba0e5c',
    'condition': 'checkout_src_internal',
  },
