...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '66818b34e9e7b64f5de40321e57c9a2c910b7cb5',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'df5693ab93017a82a550aa158f577973794f2d6c',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + '72b133f729dcf236741d7224406c44b1615760f4',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '36284511c8850c76bbbbf89ed10285eada8bf770',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'e3609117f939a35886e7ad3f6aa36940ea6969a2',
