...
vars = {
  ...
  'src_internal_revision': '6ca50d428477fe82e1aa14181c26e674c059c5f8',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling Skia
  # and whatever else without interference from each other.
  'skia_revision': 'c5a4acd62d48d9e20d9d375a00bdb8053a0a1bac',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'ad21f5f27cc59d482fcc640bd9ca4074742ca707',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'ba3b1441390905d2c2d0614f48377d59996570ed',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'FzlezJJz9iqliKB61lW5TvkapTLTOAbCoyszz1-jVZcC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'GElM5MdkAap1RuGKornx35Rkp4qH0rTiACLAnIvT0p4C',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/third_party/eigen3/src':
    Var('chromium_git') + '/external/gitlab.com/libeigen/eigen.git' + '@' + '62e23f79dd0e8202db605332f699905c1bd5d457',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@17137fbeeafbb1503cff01252cc3342d5c26a12d',
  ...
  'src/third_party/vulkan-validation-layers/src': '{chromium_git}/external/github.com/KhronosGroup/Vulkan-ValidationLayers@019e2e0091d98c01d4a722d9cda76e42a5f5fec7',
