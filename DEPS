...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '4b11554998f6fb5ee4c17a807979915ceb3b1665',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '3a19e01c923dc38f67dd437275fe311da34d94af',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '735e4b4fa1ef359f2db9308522f5715a3130debd',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@6d633e69f28c23bffdb3b7a9a9fc865b382f5a26',
    'condition': 'checkout_src_internal',
  },
