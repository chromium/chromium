...
vars = {
  ...
  'src_internal_revision': '1d0b27985fab457b2f086266f33313fdc67fe383',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'd8e44cad29ef1f15f1f2f1935808a64ad29df21f',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/libvpx/source/libvpx':
    Var('chromium_git') + '/webm/libvpx.git' + '@' +  'af988d8d7500ab55fef744932da4655428040314',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '9a4d9cdb8cb10124639cd94b3ea108d7e420d3b3',
