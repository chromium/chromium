...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': 'a88cad1ec647aca9babe6594904b6e4357b05efe',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': 'https://chrome-internal.googlesource.com/devtools/devtools-internal.git' + '@' + '5a802c5a38f7697d786e38bd1a1f337741e8c276',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '0ce0fc9b694ca8eac9494d0264e75f1e730e19a3',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@fb38cd169a8d36a9f48ca531a9dbd898c57174ab',
    'condition': 'checkout_src_internal',
  },
