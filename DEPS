...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '5436028444db72783f9fe8d4b2ae1b8ff2badb05',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': 'aebf4a4845f1067f6bbebc43838b403651954ff1',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '763d847f1e5ac3c5607ace75cc03876e4fc1341b',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@052869521ab12d6eda893a3c304bfff564f3bc66',
    'condition': 'checkout_src_internal',
  },
