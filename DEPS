...
vars = {
  ...
  'skia_revision': 'd2be132e24e610e7e1a647acdbdfbca85cf2c3ba',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'e3fd28e1be7019002f0e07c8aaf0bc21d78bd294',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@6e7ade97ebc7005cae83e0bbfb62b2b4e3f7647b',
    'condition': 'checkout_src_internal',
  },
