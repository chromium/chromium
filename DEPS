...
vars = {
  ...
  'src_internal_revision': '983ef55b05d5639da007bfebaa72d0f2e3efa41d',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling Skia
  # and whatever else without interference from each other.
  'skia_revision': 'd2aee9cc41cd3c1b19edf06dbe6a62fe10749bbd',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'dfadbbf6345ae77d8743d4214464dcc3e60aff91',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'd0d13b7696e16b0287d86d52239f738b98a3e405',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '4fd34b5bb9a0a3473942ba4587d07a6c0100f78f',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + '43f5bba47a4a05af1b751ceeb64bfc13b40d8b31',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'cbab5c07a306d081e931106c2f3dfd49f6f50570',
