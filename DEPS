...
vars = {
  ...
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
  'dawn_revision': 'ff6c9ca6f0d3605076d3a19fb1b52374a78ea2b3',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
    ...
    'packages': [
      {
          ...
          'version': 'ed0mzbczI3DIZidFhhOKAFOBOv1pcl7dmdTt7iDJ6HwC',
      },
    ],
    'condition': 'checkout_android',
    'dep_type': 'cipd',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@b7c1da8f42f124f09df912b716af3bb4188dc20c',
    'condition': 'checkout_src_internal',
  },
