...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'W0czC73DcJRTJqujXg57DxhNzNub3niCJi79cv28Gd0C',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'GPd3wsGTaVWTKET8fsxQD4gvODSJiGxUc_PRrwSczPsC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/clank': {
    ...
    'ad65abc1af270317109880e6ca11e890b8964e6e',
  ...
  'src/third_party/eigen3/src':
    Var('chromium_git') + '/external/gitlab.com/libeigen/eigen.git' + '@' + 'c66fc52868a1ad2a144d8fbcae8edfaf6c40ccd2',
