...
vars = {
  ...
  # and whatever else without interference from each other.
  'crossbench_revision': 'a24bb301cb4fa3fe2f3915f94e6893a92ac849ca',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '4d6abdd74dd50d352285a69b79056515bbea26c1',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '0f2354087d04a77bfe165eca64278b5fddb7d7ff',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '82336b7326c89bd1cd82686cf947c85900bcc9d8',
