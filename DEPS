...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'e0c0429af2acaf050b1c9ca850aa9363944a9460',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'bc8a62b244c4038d2a005bffcbe7a82bd933d7d1',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@69cc4d22d30f333595da0d7f93e5faae749e2810',
    'condition': 'checkout_src_internal',
  },
