...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '9ae8231be181030219f5241afb0e431ed4a36c4d',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'angle_revision': '00c92e11df2f8fb9c54c29ca2a7276042ae2e7c8',
  # Three lines of non-changing comments so that
...
deps = {
    ...
    'packages': [
      {
          ...
          'version': 'Q3aXOeYqjaq46AML28mhJtta2kwm40XGwmDl05kWyHgC',
      },
    ],
    'condition': 'checkout_android and non_git_source',
    'dep_type': 'cipd',
  ...
  'src/third_party/eigen3/src':
    Var('chromium_git') + '/external/gitlab.com/libeigen/eigen.git' + '@' + 'e315a8cdd074207e96f606372a22d028dee1b3d6',
