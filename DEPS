...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '11c3150db1055f9a18f31cf8755a4ce24d65e4a4',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'baa0ef3cfe7247cd1492f50ff4f2937e4884f826',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'YxyKrabpGpal0qUVmMt3a20jTWmYKzcqjkZ_AEdEkN8C',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
  ...
  'src/clank': {
    ...
    'f5604b37d5d865d464822c249a5568f1b090d44f',
