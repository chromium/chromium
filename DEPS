...
deps = {
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + 'c1c45f8a853111bcdb24e2de7a6e8781bf2e9c06',
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + 'd82a099c7ee1e9aa05b270b78324f14a5fa9a057',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '4cd3a0d082d0b9d44fd78eef3d53d4360e99a674',
