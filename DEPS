...
vars = {
  ...
  'skia_revision': '4302396f1517cdce69a2a25225e54fecf17a4d02',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'angle_revision': '91667dcafacc6d2bec545b776547e8583393a3f9',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'catapult_revision': 'e86b91a7ff16d195c30cd42d226a79ee2acc7351',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '5ce78e1a3f41ff81dcd370b21450b203b52f39f6',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '342c5110078c7dccbf1bd2bbdbc97616aef7c5d4',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@876ef0f11859aff8c2f24ae7183ecf025955bdac',
    'condition': 'checkout_src_internal',
  },
