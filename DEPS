...
vars = {
  ...
  'src_internal_revision': 'ef687dfd6427f5a7effb7af03fcc7a27a4e8269e',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling Skia
  # and whatever else without interference from each other.
  'skia_revision': 'dc2872de506f48fe70d267e9f14e925b1caa6bcd',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'd19a8df725fe7a2c68656fc5dbedb198572b14fe',
  # Three lines of non-changing comments so that
...
deps = {
    ...
    'packages': [
      {
          ...
          'version': 'E68_LYT3n1btpB37p_zqhPF3_7fvhKd7UzYF-zZHdlgC',
      },
    ],
    'condition': 'checkout_android and non_git_source',
    'dep_type': 'cipd',
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '312d6a03138fd55c4e79c554313d21abfd3716ac',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + '8dcf87f14175f52c2efb9d2d6f503b9499fc50bf',
