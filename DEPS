...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'f311b26ad1eb4765f68f0341a338d2a5e44c6898',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'cef76d48724c801b02c7640d03c21b9307e03633',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '7d6b5b878f7440e37e2d8b6b89c9cbee8b77482f',
  ...
  'src-internal': {
    'url': Var('chrome_git') + '/chrome/src-internal.git@ad16752a40eff74ffacdda33f19ab6cce1f48496',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/ios_internal':  {
      'url': '{chrome_git}/chrome/ios_internal.git' + '@' +
        'f6a6436c2c6e8fadc5cb370a9f9f551d20e1bdcb',
