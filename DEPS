...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '5e7531112fa5a70d1b53818fd1299d8fd4ca6064',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'a20300c230013a40fbc1bf0c51f288d924bbbe30',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'ef3cee35dc94d59d85ba9fbe3da190ac1e0863db',
    'condition': 'checkout_src_internal',
  },
  ...
  'src-internal': {
    'url': Var('chrome_git') + '/chrome/src-internal.git@24bb95da0bcdf7d1b4f911475803fec365fa8f04',
    'condition': 'checkout_src_internal',
  },
