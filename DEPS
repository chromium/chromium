...
vars = {
  ...
  'skia_revision': '4bd442901f81e1ce273e925cefcb129edf63087b',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '935ee90b0e7af9226c2d1ab3f55abcb3acf5206c',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
  'dawn_revision': 'd87602df93241ee6358c205eb54b0d4126522fc8',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@20b24fae349fffbb203cceb4baaf7f4b8a437e75',
    'condition': 'checkout_src_internal',
  },
