...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'ce873d131336920fee61ac84e94d7ef87d9471dd',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '98ea8945a9892080a4963135c0ff4cbd38ceda45',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@1e1e3b95051cd5ec486af6f4ee4226a37c470e23',
    'condition': 'checkout_src_internal',
  },
