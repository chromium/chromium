...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '87c7608000abc1190399c9efec0fa6547b4e2db6',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@4c559ad04a03f69964e9195f0a585b3bcd8a10c2',
