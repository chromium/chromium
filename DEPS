...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': 'b2996314b9424499de02dbcf21f9693ae7460737',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@11c7c23a1cdb4bcb465ea6a71f347871bd108ef0',
    'condition': 'checkout_src_internal',
  },
