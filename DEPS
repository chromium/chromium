...
vars = {
  ...
  'src_internal_revision': 'c1a54f4f0d45395388dd2c4aa20e6d5b83a59543',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'c1b4b68c40f253dd098f2a53749bcf2cdaee7d90',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/chrome/release_scripts': {
      'url': Var('chrome_git') + '/chrome/tools/release/scripts' + '@' + '0e30de6ed084706269b083b4ae334d49e14c66c7',
