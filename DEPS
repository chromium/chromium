...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '5c9f28d05afe2367f33a315ddc4241555a8ad0a0',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '9b6e9bb284e898faf95d9a137c20398e6ba3b46f',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'crossbench_revision': '538e26bf9559ac68d334f1815954494086602fda',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '860c4fe6a10b46e41f78370376516a659aadb6b0',
