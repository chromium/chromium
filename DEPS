...
vars = {
  ...
  'skia_revision': '7e7782cf1b4e5e507fd8b24094bdbabc64289a24',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '90ff6c032d2bb5f22310a9dfec0b463f78af90da',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'catapult_revision': 'c7c286dd3be254885a2af1d52786f7d2d3da74f9',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '711cbeb05351098493a86684a8321a7e0cc3f883',
