...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '94b39da4cb8a04be1ce313b3674bca5a446c0e66',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'b2020511e280714c6c2d329586df86f3d9b14a6b',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '205c0158db5b15a6a1b27eacb9c25a8862c90561',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/clank': {
    ...
    'eae8697427fe91be5c4281ff2cd8d6ec0b337c18',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '71fba51768266c6f359763a650b5a12004531141',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@1d891d46a65c61d8a42bf188156d11bbeccc4f0b',
  ...
  'src/third_party/vulkan-validation-layers/src': '{chromium_git}/external/github.com/KhronosGroup/Vulkan-ValidationLayers@f1b56544dc4a65ccfb77405962ef8551b3abb23b',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'caf943dc2dbe5204650e141504e9ee0ae4fcf7cb',
