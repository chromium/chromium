...
vars = {
  ...
  'src_internal_revision': '1499799fa2baae5d3a6f0314b7249c53f3f7ff10',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'bf67570905a80845ec2ac0f75c78b6b2066b30f9',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': '970439218514a7032b0b3b0b998810db0e45f0fa',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'ed75105719cb3f4ba2099be3d8a073846a61e38f',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + '48ab4bb23708598083c10fdd6565840ecad7906a',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'a01a68fe7e0caaaf3eb3d42ce00ee8f31dac19c2',
