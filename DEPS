...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '3a90f6662a2c30a7d270c7738cc70e5980974b02',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'ba595dc892d82059793fe9e9af5d6bf6be43f8ca',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': '1ba8ec3afdee39c6b8d5c7268598b4beca530d07',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '5fdf5521a2f59e5794fef5085eeef711b760de4f',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '419855526c87360c0352e28ebacc4bf0905b9d3f',
