...
vars = {
  ...
  # and whatever else without interference from each other.
  'catapult_revision': 'c5057163e2ef2334aaa03b030ffa930ab83d1a4d',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '0f90e57aa05daa1bc022861c668d3e2345d2239c',
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '762f1e06731a2e67084d317227848a7c118dbb5f',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@d66f4e546b7ae42ca09e7da637bbc4f9c6f00280',
    'condition': 'checkout_src_internal',
  },
