...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'e4b29a139a279538f8932d4171815b24da3f4cb4',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': 'https://chrome-internal.googlesource.com/devtools/devtools-internal.git' + '@' + 'a5c96b90d7cabff39e022106554831833aef6927',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + 'c6fd8f4c1d859a648a7cf1990d96eb42d867e122',
  ...
  'src/third_party/webgpu-cts/src':
    Var('chromium_git') + '/external/github.com/gpuweb/cts.git' + '@' + '7a679a3faa381c6a930b08b73b1d4080ad554533',

  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'ab397ddec4aefe0998afb2a1cad776c872b993e9',
