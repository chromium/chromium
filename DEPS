...
vars = {
  ...
  # and whatever else without interference from each other.
  'catapult_revision': 'b0fb5822d2b0444ad66daa120c5f481253dad5ab',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'BRejE6q2de-rvkJCFLdiIxxJAmpiFoY-5IaJ-EDNEYUC'
          },
      ],
      'condition': 'host_os == "linux" and checkout_fuchsia',
      'dep_type': 'cipd',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@41c4a15536348b1717345c44f995eb5ea3253109',
