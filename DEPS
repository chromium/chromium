...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '3c028a778759f9375e76e17f8fdf124f7948ab22',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'dawn_revision': 'bf5d31685280b924fb8aac14e20ae00d18db3b1c',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': '-19Il7MlhIEGk4HA64d2yo6S3_pEkL706z6bRiCASpMC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'k7mMs7bJwU0Gn4esMbo5TirudPWn76IEl3qfMT73I4kC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + 'daf26020239a8935d16278bbbaf532019f53f118',
