...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '812c2e24f75ea67bf7ab15cf20841cccda5a2c0c',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'nRk2dgam8PNerR7Y3ctasv-R--onuBN_2989XSPSt-YC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'eZZSbktg8vC-heBHkFOs90MXghmL7vwHhw8ctf7WxacC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/clank': {
    ...
    '733346ddc15d253609df088cde9874ed255bc501',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@b31cea9d0a94d92d6c230ac8e23c0d5570b774ec',
  ...
  'src/third_party/vulkan-validation-layers/src': '{chromium_git}/external/github.com/KhronosGroup/Vulkan-ValidationLayers@7ebfe2e7a4484020869f0c1a0d28ae1ca48bbe63',
