...
vars = {
  ...
  'src_internal_revision': '770cea55998bb8b8baf415a7987658a2371d5e69',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '2ebdf1c4a1735d4349b8ba641a56a3e60dea2439',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + 'c8fbb42603972a9089c2cbe7e7f4a26053e2a8ef',
