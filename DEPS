...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': 'bf4f2763b6e6e08aadaf2d79b0c578028b34507d',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '052a13f13a8aee82b3b4de9f519ed7e0c6f18fdd',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'crossbench_revision': '1a1b13f6786662a214131f15f2512ee88eece791',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling CrossBench
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'f8c190bcd0bf071c1401407839ee2c2c3d61a5a6',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': '86KWsO295k0n6zleP4bCZQHhacGGYzQ4--7fyzPb8E8C',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'NifrvJq4suwMRIMOTyNq6bJvvtPz2J1SHaFQEyLOkjEC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/clank': {
    ...
    '8ca53cab4ce8bb2e2e32140f19bacfc182bcb1c1',
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + 'a93a14858d9bf5733017972fdf037e6e21a99510',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + '0ce504838fd94b3218e2d6d0caf363379b29bb82',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@235e641f78a0ba5d969dc3d2bfe22a99fb0773bf',
  ...
  'src/third_party/vulkan-validation-layers/src': '{chromium_git}/external/github.com/KhronosGroup/Vulkan-ValidationLayers@adfdda5b665f59aae31acf5c12c73e64a8f89553',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'e68d24dcebce1c13e4f7f79f94ef0e56b3275460',
