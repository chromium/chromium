...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': '2f1d503bcdbb85be639ecadfc7007b93e5fd15e7',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'c568467eddd29acad26769fde7cf06ad98a0164a',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '434f1f8e22caf562849968890f4a9c8792eef798',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@7e5ea8b29dbfa0b46c781ae79c798e208621af0e',
    'condition': 'checkout_src_internal',
  },
