...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '6596f6d26027b9330439b528dcf8de2ec53a6680',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'catapult_revision': '22a35ea6ab31311f5db9be22d98efd2085fd67d6',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '1c8ce9c5a262c33b33ca5e2db4032cf090bcfafe',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '0642373b276ce883bc91f765966602c5c7867ad7',
