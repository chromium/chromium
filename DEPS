...
vars = {
  ...
  # and whatever else without interference from each other.
  'swiftshader_revision': '2cf7933020822a133c7d5b1e9672ec7884a5a044',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'catapult_revision': '8d2395bd1b027b2e63f10c8d4fb6deec8cf7b759',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'd46f30a8ef8536a6d7cd3d809788bde553fe09aa',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'tqWwdNb8RBBmxEXYPSoNjPlQM6ouElLN_DnNzXR2aiIC'
          },
      ],
      'condition': 'host_os == "linux" and checkout_fuchsia',
      'dep_type': 'cipd',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@1bd135bde110cbd90790dd2dc3dcffa88f6d8267',
    'condition': 'checkout_src_internal',
  },
