...
vars = {
  ...
  'skia_revision': '192da0d824004b0efba580fbbd3e1ec0cd7c4872',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '2a039c8fa5563393bd551d208adf1511d9dff30c',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': 'a254f5c620cd868e080dafaa793024d4b5666ef8',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'pdfium_revision': '41be7e25dfecfb5ee8003448fb0b4edf81f4c4cd',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@ff6c9273a91db4f1bc08c1b93c661b8c7ab66396',
    'condition': 'checkout_src_internal',
  },
