...
vars = {
  ...
  'skia_revision': '6cd730f8f209f4c62d77f96076120ef6ae989090',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'angle_revision': '14c483f1c497ff1bcc256bd5435cbf7af3d620cf',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '49ae10d02a40b48418788461bb50a19927f7b06a',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@2b1e01b371b139a53fff0c367bac436ec0f995e9',
    'condition': 'checkout_src_internal',
  },
