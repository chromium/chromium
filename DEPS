...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'ji4LyLvb4HgDLPesI1yA4xVh77gPEpJiEVwWJ9hvC8UC',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'amwqCAfGAmS4AtOLboF3T3WFKq1iHjVoa3_LAwrIO_sC',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@7b14f3ac9637e6ae8fecc7ddad2e044304a4f3ac',
  ...
  'src/third_party/vulkan-validation-layers/src': '{chromium_git}/external/github.com/KhronosGroup/Vulkan-ValidationLayers@63301d8bd1e46b77568112e9a71da32feacb9605',
