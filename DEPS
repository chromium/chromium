...
vars = {
  ...
  'src_internal_revision': '9c0b6b3d9ac2ce699c6a123efb9efd8e73e01cea',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '2202894afcd1e4a08c3bb6d1c58dbe6c18aff001',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'd0DUcE2GLRt1cEXIb780l-qo-bXljJVn4Yy8Qtp0HU0C',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/clank': {
    ...
    'c7ff72d10f99fc362318544f79c01c5e7a15f94d',
