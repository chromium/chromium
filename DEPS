...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': '57dd0e5fed61b176464191c725bf12a422d3c38c',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'a75c27d76be3e4845f27220e8f776c7ec2f264f1',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '55ca4a7da9a2cc22d26e2adb946bd4238a3a7e33',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/clank': {
    ...
    'd0037a7ba72a76a9b5a6b8260284abb8d180a5e6',
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + 'ae46c3cecda20def1a9005e3893bfb89efca736e',

  'src/third_party/devtools-frontend/src':
    Var('chromium_git') + '/devtools/devtools-frontend' + '@' + Var('devtools_frontend_revision'),

  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '1d111fb864633b4a89de3d6d5bb38ddb9c9c0316',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@fa4838e9d3f3850b409d5b7b80d28df02a2ceb75',
