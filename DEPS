...
vars = {
  ...
  'src_internal_revision': '92aa90a90073a1dcddfb4a380ea8eae873aa871c',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '793b9a7ea79f195350983d5789c4b09660d27aa1',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': '1ad4ae4d63bfa7272debdd6b8972cf6ef6738c1c',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'catapult_revision': '1c6d2fbaf7fc1e982bd48bc91dfa296fb5cb98b1',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '8e2ca44835f5d8e7f1e223033094f16d816e5a81',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/clank': {
    ...
    '4d266238db60cb0981b724011166439c50672a23',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '46b6e87c3c8da277c087212b08b38cfa670c2e6f',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '414ce44aef4f0a7f5404f16f9065dbddfac78faf',
