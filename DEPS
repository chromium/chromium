...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '7aece8cd1277b6dac7b9b5d334e6ac79e5642c76',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '54d7547faffa82f935205a88080c5378e79b828b',
