...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '5713eb26f3ff10c6b66357837bc4ce1319bb6d9d',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'fe1fa9ab468c59f85c13fa5e132005b3d165f5ff',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + 'd71a6c715511296ff6fca63b80b96437d9762dc0',
