...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'c0e3133c3a34a0607eaa4f46f69f6c84ab369090',
  # Three lines of non-changing comments so that
      ...
      'packages': [
          {
              ...
              'version': 'yUtEN6sSEn0dYInO9H1v5qphjG2_tLae3Y0vmzIUDrQC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'wWgYtBUx3hoS-BFQmoB-ojNi8I0Oe1q6DZbMcITmuTQC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'E8fQyPhPH5zVCXIgoAkFvZuq_vef9gGzRrCFhUHcQYMC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
