...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '35952837d5c420b727642b88e28651cb80c3f538',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '1cdcbe12e8091d0f067503837131c86b2c3214fc',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@34dfbb4ce8d2cc8b5464f3705a188bc8675f4f6a',
    'condition': 'checkout_src_internal',
  },
