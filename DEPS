...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '4ef000cfa5ab4917a307630fe4a365ea9c827efc',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'ccb42e9dcebfc22fcfc2e5dfc1856e53dbda94ab',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': '60c64db11309a49cfed9e4ce01dc0c430610c06f',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '42151fcc541e8a01e5059e02ba29285fb88a0c55',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '06f19b9dd664e407bd0b678acc218bc0e0a7df8c',
    'condition': 'checkout_src_internal',
  },
