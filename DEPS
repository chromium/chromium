...
vars = {
  ...
  # and whatever else without interference from each other.
  'boringssl_revision': '50c3ac87fcdd5a83b95943b128b0974d42743755',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '1f515ec840bc06af44f76602926f1d6c80495630',
  # Three lines of non-changing comments so that
      ...
      'packages': [
          {
              ...
              'version': '4hyjFNuWlZ7JWuhbWg6Icwvm8vgfyqt3ofPfmPFTxlQC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'ad90547f7d309f28aec368f5233d7caf93d80fda',
