...
vars = {
  ...
  'skia_revision': 'ec052c170574ce2862087fa117b1d1fe81c03add',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'angle_revision': '966f3baed480eefc0bd441af4e558b3bb6308fa0',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '6c4fcff8d6524cad85a99897727efbd532b7fa50',
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + 'ff5d25bb10e4b1201b9f8f50bcf528ab45a6025f',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@6e356ad18458fad51e7942c364626b213fc78c27',
    'condition': 'checkout_src_internal',
  },
