...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '84e9cc869c13a28dec61aea4dcac427f0e940e6c',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@3a016e2569b2d6b9c308510811f1e9026d8c68c8',
    'condition': 'checkout_src_internal',
  },
