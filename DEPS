...
vars = {
  ...
  # and whatever else without interference from each other.
  'boringssl_revision': 'f347478dfbb400eaea8749bca0c40b85350e93bc',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '7a816cb4e08abc287b8e3210c9dfb8aff033bf7e',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'vRNMJ-iXCsYBbLBPj-40tO-M5anXaptpNUURNl4FaKAC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + '8cff997e4e183197a642577cd968f24b3de20a13',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'a8f3a9299e9e08305b94953e97ffdc6baa8e763a',
