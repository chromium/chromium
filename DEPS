...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '0a2535652b7b84249c423c779155cef3e5447480',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@600785d4d02617e9e602f623772d2abba3d0aa52',
    'condition': 'checkout_src_internal',
  },
