...
vars = {
  ...
  'src_internal_revision': '36b3f009fd1c40104d30fba760771a8e48b3b478',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '8ad4f5bdfa00f3019eff7b53a899f23cbdb271d2',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': '80fca933806f01d5fc74bd33fd563b1effe20a3d',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'catapult_revision': '38c800656ce8eea67d38f1ff5922f870fd128ad7',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '0079c9041ba80d1de394d9d1206475b59b43881d',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '34282c57c2859a960e35a69155ae2916b06454c0',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'd85a52ae4bc455894eab2bb574e4c39bf64abd2d',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '19b7928f0d88db2e9d0dde6665bed270927de782',
