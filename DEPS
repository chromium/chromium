...
vars = {
  ...
  'skia_revision': 'cff71322c909df8360ea013b7674e00a557a5e36',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': 'https://chrome-internal.googlesource.com/devtools/devtools-internal.git' + '@' + 'dc4a24b86d5315e995c8bc350a93cf5b96447e91',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '9632a81bb9242c1f8b95dbc36ab2cd8dae728ed0',
