...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'ca0457f68880473f0b13cf17f521260b7e963448',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'crossbench_revision': 'a83a7c3acb6caeb4cf4c2043e20df6127ab0fe73',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/chrome/release_scripts': {
      'url': Var('chrome_git') + '/chrome/tools/release/scripts' + '@' + '773f75abecb785dd3e84722a1c3540ada7b4eb1e',
  ...
  'src/clank': {
    ...
    'ea819d9ed84ea7b9684d56ba3d26a9ef1b5d3dff',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@729a70498186e80b4eac410df52f8864c165dcbd',
  ...
  'src/third_party/vulkan-validation-layers/src': '{chromium_git}/external/github.com/KhronosGroup/Vulkan-ValidationLayers@2179e1b0a6a7388f11a47cc70d48870fd87fc97c',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'd1ecc25090b8f1629842c342cdca2c1512d6a66d',
