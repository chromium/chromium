...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'baf5d9eda0cdfb4f170440440b0b617937b8ef66',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '1d25718aa54073ed081ce12e9323dd3b67dc2fa5',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/chrome/release_scripts': {
      'url': Var('chrome_git') + '/chrome/tools/release/scripts' + '@' + 'b1f1ccf2f7edee6c6a29945498cea4fd90b2a55e',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'f13201d5afde828bd7f6e62e8a8c1af6257d166f',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '5cfc75b98b23afe762a14d8632b5c81cb1e3ff72',
