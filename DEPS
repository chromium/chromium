...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '51bd5acdf3593aae1516c6c0f5af9b2a942a109a',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + 'cea074c65731ceb4cbb1985388634c16b4c74479',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'fb60796b642e6a0650afc88389f967a9a749984c',
