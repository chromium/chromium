...
vars = {
  ...
  'src_internal_revision': '3530eae2f2fa243e498495d6c6f2e34cc5a9bff6',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling Skia
  # and whatever else without interference from each other.
  'skia_revision': '4abe0638e35d34b6fdb70f1f5ce0f0e1879a021e',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '4d36678284f92d381f411c7947588d7a09989ca4',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': 'd9fc4a372074b1079c193c422fc4a180e79b6636',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'pdfium_revision': 'bbdc38bc2d1693f56154f78eb5d4ff296d8ca3da',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'c45c0ab12cb7cb674cf98c46f052f63971911181',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '6f2298c7ff7a5a6570f4aeabba4379ccb777c09e',
