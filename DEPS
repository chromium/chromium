...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': 'bca32dc673d607431b62e7cc5c8ef79d9c571e68',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
      ...
      'packages': [
          {
              ...
              'version': 'v0X0bEpjX1gH0sTX1-c3GkrvSuD5CgNeAqi0It3K1ZwC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': '1qo1XK2P3C3mve8ubtY3bbftFW-rmsvDtcnYPCIGUKUC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'RCNQ0fQp-7FXWRe5wzNyutbqb40owk7wJ8_B1OKtyR0C',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
