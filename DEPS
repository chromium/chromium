...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '0d6bc8cae85516951703b11ac2c1a7cf162e2db5',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '2414978383721023ae13e3c9840396bd454dc442',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': 'https://chrome-internal.googlesource.com/devtools/devtools-internal.git' + '@' + '173049b00a9ded262fa62474d797e2a55719f97f',
    'condition': 'checkout_src_internal',
  },
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@3a927778e72ef9e8aa619cef87143b656c6db324',
    'condition': 'checkout_src_internal',
  },
