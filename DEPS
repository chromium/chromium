...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'dc6d3de0d8491f21308ddfd3651c31a731d8437d',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + 'a91f4468f15c93f2d0e09e51039394d4a9f869ee',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@90a0223043a5d74c3df7dc093dfc3b45d2df1198',
    'condition': 'checkout_src_internal',
  },
