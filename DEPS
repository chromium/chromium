...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'cc734a457000bbeb441db4a79f7920698d730fe2',
  # Three lines of non-changing comments so that
      ...
      'packages': [
          {
              ...
              'version': 'XDhq3KcBYgR_Y5HQ5xsKhWbNftgfCXXA07xeOQ-li2UC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'rZQsntLWAgR_6GXN8Y-28y1lZ7-oJD2I5ZII5KNfiTYC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'c4NQwugKYd4FwzUFHq0PpAp7fpmsDLLuGuoCzDflR9UC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '40472474c5bf240e7d8c1f0db333867dfd3ff411',
