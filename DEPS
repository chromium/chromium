...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'bab80cef3ef9244758d049ee4617f1311db84d2b',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '298795b311e83a34d41e33065029d7a441e324c0',
  # Three lines of non-changing comments so that
      ...
      'packages': [
          {
              ...
              'version': 'J1PKvC2gPWVChLILVcamHnG9s1aoiBmnFnBuzLBC4ykC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'r3yGgMue4JjFaJcVjK6ZedR9DBkzLvrLuKuLIj0-XDcC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'MhkQdNCWDGvirsoXjMF2SFf7NELWUbzEhX2AKrG62MoC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
