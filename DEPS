...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': 'dc38a218ce7f3e6a32381c180c431ff1f3dff3d8',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '806f4a2e1cd63f934f96bf47f2fbb33c1349b3ea',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '93fd55a030e89c75e3344d4ac164ee011e33a7eb',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@b21b98bdfcd7873f51b3f0a6aa990320cc5d2964',
    'condition': 'checkout_src_internal',
  },
