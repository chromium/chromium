...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '2bcd20d19678b5a9d32c66d19606bd1a12a84ab5',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
      ...
      'packages': [
          {
              ...
              'version': 'OhFaFfgf16pXdfLGcEebuCnQZP7WSQ2wN--H0c5dFk4C',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': '64kg2NuLuQk7uYLuzUF9L0r4-DC7ATsGNpq6gNeNkrcC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'KzgO5gYzAyPZ3JnZubKkmO9Hp0gRW0P7iO74TX2fPrQC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': '6nZhkRgE9UcLVKLYGcKHqEYjVruSCjGVhJ6i_tkgJq0C',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'b72f6c32c849b474aa308d362508a9b6afd29cf7',
