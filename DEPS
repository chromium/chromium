...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '5f6458413c4632fa3c2f826709b3bdff564505c2',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'c2fc9fa0d279c8ed597688032a015063fa894b36',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '7532f6665e035d377bef618412e691fe9b3332e4',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/clank': {
    ...
    'de1fe547e0dae9848e2831d8de757375a544a650',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '91bced9ec8fc2dc591f99db86367a442857e3fe1',
    'condition': 'checkout_src_internal',
  },
 ...
 'version': Var('siso_version'),
  ...
  'src-internal': {
    'url': Var('chrome_git') + '/chrome/src-internal.git@9ec6af744af6e0fa4b573ee0a10ec9c4d4ad9d0b',
    'condition': 'checkout_src_internal',
  },
