...
vars = {
  ...
  'skia_revision': '94d454a12e68f867d0d883900e74f8ffa5a1f6f0',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'b549a8cd367384640c1a29b082f88a1a3c7b8578',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': '5384667f489e0b7138402947975ef2261dcf64b8',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '184a74e69a601cbad151f27bb7d342ab84cdcc5c',
  ...
  'src-internal': {
    'url': Var('chrome_git') + '/chrome/src-internal.git@e36b86447587bc55d0924080ab1854a0156ffa0a',
    'condition': 'checkout_src_internal',
  },
