...
deps = {
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'b6f3916c486795b60b810e6b738b072e5cbcdb0d',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@d22294a92baf86a0dceb7e897fce09be1eca5c57',
    'condition': 'checkout_src_internal',
  },
