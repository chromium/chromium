...
vars = {
  ...
  'src_internal_revision': 'cce7577191a433fcfb0930d6a8bdd99632e7bb28',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'catapult_revision': '180b79d05050132d75733851bcb06c251a537f66',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '271b17d7f642611a02c0b448cfb3b96f96c1ba3b',
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + 'f078723bf4a546a5b9c5c2c10734d0a37f684b69',
