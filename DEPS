...
vars = {
  ...
  'src_internal_revision': 'fe3d661244dfcd56239c218cd6c968bf1dd7695e',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'aa6a7dfc3d32c286ec00fac11dbd4518ed433b2a',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '72772f8db36917ac7fc579c01861ad5aef6f9c77',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '5767f7b088c08981c285a91c365cb440725dec1d',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/clank': {
    ...
    'abae4a0aadb40cc7fae516d1c66d9c3941bf6688',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '7daaf002436c30f81798a70310ccba28e2ebceee',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '4edf7bab66dcef8191a8275e007baedee5ff1374',
