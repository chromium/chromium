...
vars = {
  ...
  'skia_revision': 'eca04eeeb8d8e3e69b03b2862f4e611364377fc8',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'f691b3b5096a3a0a80b100b5231fb65042937757',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '19739b881bea80e48883a02b987fe6979103ecf7',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/openscreen/src':
    Var('chromium_git') + '/openscreen' + '@' + '66f231597428bb8843d1e11efd6e324f6934ef19',
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + 'c6b219431a1685b85f185d95322b3f06788d7c24',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@e213663d1bc2fba3bcf912b65929791fc3e5cebc',
