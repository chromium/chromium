...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '81a494cf40920ec0d392e9a047f29dd1090958a1',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'pdfium_revision': '8a822e28adea47068d423a25154b45bdba49f183',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@35e8c86dfaf356cdf7a29f564c0495ce916fedd1',
    'condition': 'checkout_src_internal',
  },
