...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '884ba1efae1a54f5eb4ff837c754a33b85ed76ce',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '36aaaf331db6a0234f4f9e58c9871d7142f33f89',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@f1c4aa7dab2cb46aa24d07b3798f1374fc78ace8',
    'condition': 'checkout_src_internal',
  },
