...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '99bc5881846d01f853e0e70124de408f00d932f3',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@fe3e6927e727cc6fa1b711467f07d6a7ebceb7dc',
    'condition': 'checkout_src_internal',
  },
