...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + 'c36c70c1d4a72eafdd257f7a63e55f49fbc3df3d',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '6b51e728e63be0986e0b57e887a96b0f1f79bb3d',
