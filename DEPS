...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'a2d76f03991821fb852b4a195a3286f470d73e40',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'a439a1a66476f8f6abf094f429de24841f9b0927',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '2df1cd72161ad1b408c21b95c0a65139810e7174',
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + 'db017d1ffe7dee96e9d93681d09d6266388efbec',

  'src/third_party/devtools-frontend/src':
    Var('chromium_git') + '/devtools/devtools-frontend' + '@' + Var('devtools_frontend_revision'),

  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'e59e5a59a78f2815d8a86468c07381824931b23e',
    'condition': 'checkout_src_internal',
  },
