...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '0fa46272c1d86f31064fea1f173e6c8bfc3e6fdd',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '7c1377424ea94d1b15d6fd3d1bf3356617d1c228',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
      ...
      'packages': [
          {
              ...
              'version': 'u7A5rigRn6QuF9IKCYFxDGkHFsjJHhSbbSv1TYVYcRoC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': '2qWDecg1xCFLgbM2ChT-fjY7WUy2wP8hChREijJHZf0C',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': '04bHV9Afrk04vD8n5xLiqRLeF7vs6Od1nFpKTQCNMpMC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
