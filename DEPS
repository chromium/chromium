...
vars = {
  ...
  'src_internal_revision': 'ffb934b67fec0895447d32d869d0a20743d5bdf8',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'fe2652643d524a49dc44245829567f670424f890',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '8543bc9859e3f798252e69885b3260182ac228a1',
