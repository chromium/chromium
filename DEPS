...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'cfe5a1735a934cc83133bb6c69d19aa27278a270',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + 'a225f71f82b0419857d1e6b8209c4501bde36354',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@81d048fc7bec14e242908a91812989b14da46015',
    'condition': 'checkout_src_internal',
  },
