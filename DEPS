...
vars = {
  ...
  # and whatever else without interference from each other.
  'nearby_revision': '180b76cf8470f659188506ee1771940c86ea0434',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '37f8120d257b0edc3ba54087cafb0d0b1721a6ad',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '42e5ed38a76d05f26854314dba10559a7537843c',
