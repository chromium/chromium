...
vars = {
  ...
  'skia_revision': '885a50684c91086afb8c984377d73fff48715ce6',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '16dd92ae20e50a167a30d35e5463df2cbb509d4d',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': '4e644b330f4030626379b1bb89e000f9f610daca',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '82a23989314fdc448da186c423bb57a3cd5b2b85',
