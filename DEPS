...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'e39dfe0fe61c66a5504d627e6afd35ea8de4ecf2',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '02106f7a2443fabba5b2e1e7d64b9682c2c539b1',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@1c583b0a649d0c93706dd1a62bef1ec6f043f3d5',
    'condition': 'checkout_src_internal',
  },
