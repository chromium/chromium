...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'e2147a58a2339351b140d251751eb0c3f1804767',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'catapult_revision': '7a0246ff177e0c65fc1c27437c02ba8420b83a04',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'ef36cec5b92ea69cb51c87179cb4bdd9135d1266',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@77e70cfcbb1aeae083810465daf93d80aa0abe63',
