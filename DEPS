...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '4d34ea98bb655295ab1f9003f6783bd509b7ccb3',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'd6583196f4d5db723b7be374bc4cd721d7043abb',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '3baa27b0fe547ae97df701b1baff055a2aeebc69',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@0b242180886ed064922bd31b083ad338ad54b8f6',
    'condition': 'checkout_src_internal',
  },
