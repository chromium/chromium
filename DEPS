...
vars = {
  ...
  'src_internal_revision': '3e47b38504e14866172b4db893a981327c2cfe96',
  # Three lines of non-changing comments so that
      ...
      'packages': [
          {
              ...
              'version': 'QmVq1V4EE8w1qEy3MQn90-PL6sMUqPUvBUGitD1fiOwC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'AoTlpVllOEO6ob_G53n3N2AtW_54MfzX6wfm-s9Q2a8C',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': '3Te7WUZsHC3UMhdHsxMOcTvAVUx0Zr14o4nEEkr-6LEC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '153ac09fd30c545ff975efa6d840c54b22bb2d44',
