...
vars = {
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '484c8f67f53a6eb8bc8eddcd894b15983b2e8117',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
      ...
      'packages': [
          {
              ...
              'version': '7ygxyrLSviwGO5YfR8cYw3QpDyu3Y_DyACWzxp_mbxMC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'Z490ScG9AluJps2R7qED1JUkY1FTFk-tPNyEzcXinJIC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'iAJAO_n2AQKpSU3ubBwdB-kdJf0dBAA0-FoO3NhxEvQC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
