...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'a9a924e1ca9b613110addd521cae662e6fbd530c',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '0179cc2b760ab49a8637170129db2271cfcd8212',
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '4375daa27578094cce157a8cabef5899559460f7',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'ce6f230b6511a4b013ea545ff7648db217624d80',
