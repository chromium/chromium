...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '07d71ea4d05652efb882a784c0ebe6a35ad6087a',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'a767c1927c015ee7cd5ce2b2026f137233d9657f',
  # Three lines of non-changing comments so that
      ...
      'packages': [
          {
              ...
              'version': 'GgPBkFVWDpOEpP7ke_p2VcL6XbFrtsXRw2cogpz6AQIC',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '8d0a5d0d6e37ef0403057087f07aca55f48dcf45',
