...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '1db567519d52ebfa579beefcbff3984f80fe307b',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '058c82320f27a9e5f6ae5ce39c901d127343a00c',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'rMcK7jZvhIQw3wfwND7jzyrfJijzDuE-jdnpKMoVZmcC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/clank': {
    ...
    'b382f4ef022afd032d4cf7d4a1ed01c099c43285',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + '786796d70682c2136db88f91aa585082edc4e027',
