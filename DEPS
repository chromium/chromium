...
vars = {
  ...
  'skia_revision': '0c8a88526da1fe107d2e2e1f5fa0e9495b53a4a5',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '811d2b7597d71d9e9fc4f2a6bd93ae8d0f9cd1df',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@a8b435bbf05dc94ea818d205926bf868810fbaf1',
    'condition': 'checkout_src_internal',
  },
