...
vars = {
  ...
  'src_internal_revision': '5a29d58fa571f34e8c85561f35aa3bec5a4b1934',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling Skia
  # and whatever else without interference from each other.
  'skia_revision': 'babeb3fb98ac2842058e70573eedc136518fe8da',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'a1e6997df9503f1c29f84e7ffebcdadbaa91ed71',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'b6809c1109c08a4934fc5d0b8fdbf05616e5d2b3',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'e69edb74a2be67ffd4d89f0db57019044e767526',
    'condition': 'checkout_src_internal',
  },
