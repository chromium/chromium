...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '71440668aa4222ef663149d22423b80895a973c4',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '996247110122193dd9a5255e45b880015813b111',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@aa4b6be540ccea8b7494acc69b6729ce857bbff9',
