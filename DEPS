...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '41e2659ee6b2c74a726c2cef24cb966400f2323d',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '9ee54fc0fd69e3222f879c29ad11d55133951302',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': 'ded782bca9d5f165d1c4a70124cdc5384043a8b3',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '1815a06195d9c74ac737a96f87c05111926e04f8',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '5a7e0ff57a52e12f834d64c57d040d1105ea17f2',
