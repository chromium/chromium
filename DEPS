...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '123c3ef5b631495a8501f79900689bc972acc2b9',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': 'a0e679b7701178d0a853552b10059f9ba0f7c2f4',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '99df666936d6be84f7e050944ee5d82fac931a27',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + 'ec01d49359e6a6763a2b1a8a8cc387295080a1fb',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '1cb54bee7ac24eb67ea8d751b1f87a5632abbe7b',
