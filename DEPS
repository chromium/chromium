...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '76154622bf46eb7b107b437a5d1a032ae6d30344',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'a3f346987b36deed8e71adf45840af56c3c8260b',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '40a94e5a543fcf992890164956531c2b73238b20',
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '6ec5a9ab6086ec6f043cd7aab1f1744eb58b17f7',
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '774816d61a8b260101dc3e37518a19bc283f4227',
