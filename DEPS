...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': '2b53114def9ff104078bbc50df2d50db870c5145',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'tY9A0iMQEXunop3wL8yOwXjT4iTjQyYIrgaVEMz8o-4C',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + '8da52185222c84378c9d110d66692ef7c8d1065d',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@6c7108eefffdebedab0bbaa203827b9fac469aa2',
  ...
  'src/third_party/spirv-tools/src': '{chromium_git}/external/github.com/KhronosGroup/SPIRV-Tools@669844c5e47f1d764a90f9117f6c9bba726a942d',
