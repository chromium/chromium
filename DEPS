...
vars = {
  ...
  'skia_revision': '5e99e36be096ee00397bc80548ebe876bfc800c9',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '27930b491fe7975aad01f08026547e6dacadf21b',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '7fa8d4651629505fa9ae4f8477fec41a96ff7552',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@749f5413ca9827d0623740ac5723dada395f9ffd',
