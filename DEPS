...
vars = {
  ...
  'src_internal_revision': '0f431761272b431a88e79b7dee1a3af0336bdc64',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'angle_revision': '80aced82cecab903f79a73069c7d5c4e7458f4fe',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '4c364455444f8342850842947115a1e14a7bf7a2',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '4b1593d916c2aeaccc4ff0d1483b5e676480b108',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'f2c6769719914eb88f4f5e78acca5b6a12f4c412',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '5c8bd0d4d6b4fb355bb4d7a9f3436e15738b6138',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'e68cb78ee72bb61efa50d03f304e1da159f23be5',
