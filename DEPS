...
vars = {
  ...
  'src_internal_revision': '6b6727334dcaef03c80abcc3a2bb7517c4c108d0',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'boringssl_revision': '8eb25be6fa18d475291122887a7bccd3762ff236',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'crossbench_revision': 'd17aed9b4f9097f25ffdfad5b476ce885d184f5d',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling CrossBench
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '016e0cbcf92721204f4282476f19e0ae44f8ff74',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'crabbyavif_revision': '9723084c3a767ffc28a91e375b864a17f4682b5d',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'fea175fea58796fab032a3398a4f1fb0b38b393a',
  ...
  'src/third_party/eigen3/src':
    Var('chromium_git') + '/external/gitlab.com/libeigen/eigen.git' + '@' + '4cba415f304f340b5e8b109434344d8aaf08f346',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + 'c40e458b6f23e43d5ba180ccf2a53d09d14e4567',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@256ae6c78c5e375d5c68b8f2134e23a89ea1fa88',
  ...
  'src/third_party/vulkan-validation-layers/src': '{chromium_git}/external/github.com/KhronosGroup/Vulkan-ValidationLayers@05bc3b28d783deb3da462abd45a83617be9a08c4',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
    ...
    'packages': [
      {
        ...
        'version': '-Ufag2SMKif4Cqe8UYWDwWuNXPEDy0kFVNHSaXxmTbgC',
      },
    ],
    'condition': 'checkout_chromeos and checkout_src_internal',
    'dep_type': 'cipd',
  ...
  'src/components/optimization_guide/internal': {
      'url': Var('chrome_git') + '/chrome/components/optimization_guide.git' + '@' +
        'fc2e41a629948130c8a32ada5d5a5c502d37ce8d',
      'condition': 'checkout_src_internal',
  },
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'a28359ad2986c64c14164f900014774e123be6a5',
