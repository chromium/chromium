...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '838ee609d4e411b9b33e26a6cac993d72cd8be3c',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '995b2f7b4b348581a2310346be89a8205270ddeb',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '0dc0de1f09e861ad3c18891339379cd312e1a178',
