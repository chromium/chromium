...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'fda8ce5469434735b6f70def2401bf6cda47ae4c',
  # Three lines of non-changing comments so that
      ...
      'packages': [
          {
              ...
              'version': 'TI4kuXDaICJGwDLpWKdqdWGnG25FkbWFW4-r-lxcjgAC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': '1pMIIkWtE86zE0mFWV2I7_ewimaBOuPdnUVESHCBbDUC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'IGVPDyGi2KKD6lj-PKLPuEc5q6xHcfquHTXdLbP4N-sC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
