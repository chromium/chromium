...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': '459f0fad20342bc70bf47bb614b92058df3cd4a9',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '41e7c41197a44e3d0b8c0629268dcbf465a1d06d',
    'condition': 'checkout_src_internal',
  },
 ...
 'version': Var('siso_version'),
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '0c4ca43ec32ebaf8cc50798557d958cc069dab35',
  ...
  'src-internal': {
    'url': Var('chrome_git') + '/chrome/src-internal.git@2d460ace1b2b7a43affe27f4bce24b19891419e7',
    'condition': 'checkout_src_internal',
  },
