...
vars = {
  ...
  'src_internal_revision': '3735915f0c1f5341e39ada1d20f71b4597fa0b37',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling Skia
  # and whatever else without interference from each other.
  'skia_revision': '18540538bceb7446632e69ef4df353f4056d177f',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'boringssl_revision': '7df46880add8c863b8526e5228b0dc28b9a28f59',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'catapult_revision': '5791b4d4e4f9ff04ef29dc3359c40206263a3191',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'cf2696520f55b32bb1d564c7ac4a919f1bb088f9',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + '8b05347d12a45a10fd30a8fb342ae88a0cbab167',
