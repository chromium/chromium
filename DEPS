...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '94a73c01ff22d075d68df2fc43920e6bd7c33aeb',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '8505f81c6a284adcf837977aef6210797be569fc',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '19d2ef88c85953be17768d8993355212766b30c7',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'f41d18c7fdc856de6e1be411c93c2924ccf4948e',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '9597c905da6eec7cf58bbd7bde7f9bb8e3ac479a',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/components/optimization_guide/internal': {
      'url': Var('chrome_git') + '/chrome/components/optimization_guide.git' + '@' +
        '890a44919fb096af5949ed3951add11625ca1f7e',
      'condition': 'checkout_src_internal',
  },
