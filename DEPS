...
vars = {
  ...
  'skia_revision': '917add76678d71cb4878dad087ae3d5d6d493129',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
  'dawn_revision': 'd4c09fb45d5119845e5ccef368725a3bff033a9e',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@de74577b923733b5d37744cf6d7b1fcf6f90a2f9',
    'condition': 'checkout_src_internal',
  },
