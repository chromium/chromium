...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': '97d33bc6e1356dcb2e63ea4ca7e6ebd2bc81a39d',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'YGA-FqglxP5hDP4qqJN7l8pZV_eFBLuZ0-gENjNXAbUC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/clank': {
    ...
    '4890eacc6bc72917917e4d30e289ee44b7452742',
  ...
  'src/third_party/eigen3/src':
    Var('chromium_git') + '/external/gitlab.com/libeigen/eigen.git' + '@' + 'ab1a75317ae025a8657cbac96cde09028f96086f',
