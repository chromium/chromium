...
vars = {
  ...
  'src_internal_revision': '03ee93fe8cbe73bde851cd574eb4923fd74d9e7b',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'angle_revision': '7a574a43ee945b19320a030d79c09e791a1666cb',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '4aed152009956ee21304fecaf6585bc8834bd3f0',
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + 'e673e5b27fb2bc039b92d68ae6da45354e94c651',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + '03b21f72ca8d2a0111aeebad5c3f29abe60a6454',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '2e38b6834d4118fd327565cf9b22c8ce902672fe',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '51bf12bce89c0f0446293baddf8739a594c80167',
