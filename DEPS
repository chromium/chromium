...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'cbdefd93309d9fa43ce4f6825aa4a971ae941b8c',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + 'd04ac04db63f4af8095f7676e9a16cf4a5bec4f6',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '10f42a3b6212ce2e2a659090ef868d099e417643',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@21e41cb2c47cde09042d0f4298d276b5e1e8f025',
    'condition': 'checkout_src_internal',
  },
