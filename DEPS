...
vars = {
  ...
  'skia_revision': '0c8a5988fea8ebf09972e74f4358eebba08994e5',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '259f2a2433d3cb531f9b204278e0a01ad476f34a',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@b47bfdf2ada3d391888610451ec8f41b8f19e91e',
    'condition': 'checkout_src_internal',
  },
