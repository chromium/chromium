...
vars = {
  ...
  'skia_revision': 'c3672fccad663cc65431b55959df071dda441d6d',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '8ff5f80eb520844cfb4a8672481ce2492164b2bb',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '7f88e0755de838d544e8fc2a2430b3e63120e869',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/clank': {
    ...
    'f1b100535c84bb834be327dcdadc5913788bdd1d',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': 'https://chrome-internal.googlesource.com/devtools/devtools-internal.git' + '@' + 'd94a14b23470c8200f7a6479753b6feb7f22cbef',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'dc7333f9d65239ef35a77b1eac93c3d0806314fd',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@8c8eccac29a10acadd6840049876a34422f83ec9',
    'condition': 'checkout_src_internal',
  },
