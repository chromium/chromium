...
deps = {
  ...
  'src/clank': {
    ...
    '54622719cd1f26919183764ea5f0bb7c1a3a676e',
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + 'e57316a6ae4e85e9bc8ba82a6c6a93eb5d9a72aa',
  ...
  'src/third_party/webgpu-cts/src':
    Var('chromium_git') + '/external/github.com/gpuweb/cts.git' + '@' + '7ec238cd348bf1809ddb8aa48133b3ce8b0a2f6b',
