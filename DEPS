...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'f1937273e69f3dd80572e5e21225b8fc8974f377',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'ad0b441eba8274010dd249c1c57a55f205ce0afb',
  # Three lines of non-changing comments so that
      ...
      'packages': [
          {
              ...
              'version': 'yM0aqSfr66uBK8-9iPMoNDVrTTVzunIaB6tGj9DRExAC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': '72snM39XIOiBftrvVoae8qwrIgNfc0hbp-lBb0-V-7AC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'I4ZnXyohkyEeVT_ai98-F5VVHhinoFRzQBrMn6ntZbsC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '8bf7f714267705619480f3e404cee0fb55cbaae0',
