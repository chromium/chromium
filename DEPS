...
vars = {
  ...
  'luci_go': 'git_revision:de048fb36dbb1cb5b78774cc4a758e783865062f',
  ...
  # and whatever else without interference from each other.
  'angle_revision': '30afc25e1fe1d729a6418c0b3f7ede5be67dd659',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling SwiftShader
  # and whatever else without interference from each other.
  'swiftshader_revision': 'e733a26e2ba04c8eb37aece51a81600a99e01612',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'catapult_revision': 'e50155de2ce9344561eefdbaa594df40ac07c0c6',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '1e08ee816bab192a7d295d2f457be97bd88c09c1',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
  'dawn_revision': 'c30496485a4d44927992eb5b642720025662fa49',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + 'b85aef9b5c2d27acc525c836faf962856368112a',
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '720bf82e4678270592454ed894a3544adc7a7225',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@8f497710b0ea442c5bb414f853ce457ce9dfd949',
    'condition': 'checkout_src_internal',
  },
    ...
    'packages': [
      {
        ...
        'version': 'RZLqLYxiuU6Q0Y_k6dDaH2sY2LIllYVfOulUrorvaLEC',
      },
    ],
    'condition': 'checkout_chromeos and checkout_src_internal',
    'dep_type': 'cipd',
