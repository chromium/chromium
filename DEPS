...
vars = {
  ...
  'skia_revision': 'a7230803d64ae9d44f4e1282444801119a3ae967',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'bbd79ee71a57239aada26c2f3a97db84881b8794',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': 'f4933235fb2c03b1d69f95624e97d159d1c78a1a',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@760cefe6260837622f5d859086756f61feb02e70',
    'condition': 'checkout_src_internal',
  },
