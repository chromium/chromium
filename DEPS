...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': 'bbd968fc436b88a79e4d2249e4e150e2ab992ca1',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '82a512eadf548b7cd3befa50eb808c2e83ca1997',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': 'fc46d336fda1e3a24a58d767cf7f573c96b2a35e',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '7b61d845315e9895a14784f9dab58d5a8234c44b',
