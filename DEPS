...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'e4107aaf86ae953a15cd4d9a3b8f1fe8fc3fa493',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': '1a72ef5e089e464fefae8b89922060bdbc5a5d2d',
  # Three lines of non-changing comments so that
      ...
      'packages': [
          {
              ...
              'version': 'rXMG2bVCwR7S5TmosfD-ZyHRU_hQZriiOyypVU3-CM4C',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'hjOpJk1K8-fvzCvkT2QNiM_XagAflLGvdegHHTIq72wC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'lLvdsjd0WTejo1L4alj8UWJrPYnPhcrldD-GX4UhehoC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
