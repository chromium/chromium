...
vars = {
  ...
  'skia_revision': 'f71e0be970978f04b4670b41c12ad0baffbb7fcd',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@eb758b5641d22c0f30c13091973880f69795327d',
