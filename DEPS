...
vars = {
  ...
  'src_internal_revision': '32514cd2c8b736f38aa1ac450a9f3a06f7ea8f65',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'crossbench_revision': 'b4bc21da068939acd9de44421b90cd0e328ce542',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling CrossBench
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/clank': {
    ...
    '13f571d37e77dc1657e6c993302c96510b7ec1c2',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + '95df54cdfabefc76be6e6ca1677af91fc5a27f30',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'edb843c2a07e2d31a9f9da27f47ab9f97f0f8027',
