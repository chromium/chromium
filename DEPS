...
vars = {
  ...
  # and whatever else without interference from each other.
  'crossbench_revision': 'c92dfa642bf08bd3dfbdb20543891dcf5aefeac3',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling CrossBench
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '334ee6a8efa39e29d0137bd35ef16b9415f6b9f3',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'ce0b493eaf2f1acae0bc3d442386d3d3ea7b6797',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'fd4483bd97d1c544e32a80a84e152c075b403fe9',
