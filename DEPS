...
vars = {
  ...
  'src_internal_revision': '6e32a9ced56e67e33be12d6ed91f0fb5fe6540b8',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '75970e0fc2a9be009fa4d946cedc0e0018c16a88',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '0297320c17e16284990db9ef331991490ae3d9a7',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '9f6eec36f4441a4840239337b9bdb167595af164',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '055ccdac1b8e5c30a776c03bc71659a44ab308e9',
