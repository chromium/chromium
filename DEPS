...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '9d7addd9cd28f10b1d912ecdeb2c4e3403f2175b',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': 'd1ee713ce6c5a29c4e37b14e28d1fef79d370095',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@d2fccc3246bac36528319d900eb4ee3759b32e41',
    'condition': 'checkout_src_internal',
  },
