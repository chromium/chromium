...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'c6871bd31f085af7aa5bd4fedda70ed0001bf14a',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '654d928592c9423f0cbaae338023b39c0bb53099',
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '72db740a9fd8db5bd17697492fe192f66f7edd0d',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '4730b75c647c5380f07452bbd3460d5c9c7d36e8',
