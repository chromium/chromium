...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '22f5d13b63b2deca04c3a332d07f523ead1e673d',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': 'ce8b70863980d84e103c8d5f3ab6e267ae90701a',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@dba86fde15d3e977725a9d34946bad439739f3cc',
    'condition': 'checkout_src_internal',
  },
