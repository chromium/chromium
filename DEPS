...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '9b6a1a4c32fdfe4f3e30d17839818d28352e3191',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': 'abe44cdad414888003d65cc1dfcc42f6dfb94692',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/clank': {
    ...
    '2d1414b6dab76143c9ec1999c8e02ed7ff2ee4b4',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': 'https://chrome-internal.googlesource.com/devtools/devtools-internal.git' + '@' + '78ac4bad6bed692456faa43def773424dc74bcc7',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'cb954cdb0814e2119b6cb0fe2512d532b5c1419c',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@e93757c39909389c4ff92e89dbfa9d970bcab043',
    'condition': 'checkout_src_internal',
  },
