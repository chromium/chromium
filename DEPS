...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': 'ad4c9c1bcee2875157e64c5d375fef60ced9f0b8',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/docs/website': {
    'url': Var('chromium_git') + '/website.git' + '@' + '96e88866475d86979c0aeca12bd94b0dcb47ae16',
  },
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@d57bbc80be0ff87b90903881ae7267ef0e711b61',
    'condition': 'checkout_src_internal',
  },
