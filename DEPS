...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'bbe020198fbfb028cba1ae17fab95bcb21febc6d',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'b2645d8caeacc68b5b67fcfbacb1360580466426',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '34d11e23b3c8f18cfcd836d241433bfbc281507b',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '9211807edc9f837e4145d8a05e7d7240c9dddee1',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'df0e702f830b14c8d93b3c88caf98ced0d49029e',
