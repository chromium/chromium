...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'cec81aee4c70be2127d295f0010b5e1a81190ea8',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'boringssl_revision': '51f16cdba30d99657237842a169d6e8d299d3caf',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'd99ae02bdcc0afe630fb9a9a3517950903e53b05',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'JIXQ6ikr_a1fQpNsem2HMBGFfxuVDb3bXUl5Ag4VZhgC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'tCkKwLE-Qhhjhee_GqjXmyrS-JdOcOBRZXFr0CVjFKAC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '7f6cce43d524da874c6b9ff55783dc213050e5e3',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'f9f195f1937750c23ad0973bf5e38ad9e7eb2242',
