...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'c33c6cd312dede734babea7a48b0fef11ae22925',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'a2f384d1a042d65e3fa4419d3059b1ea3bbfc1d7',
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + 'aaf88498d3cd8915f52402772e2ef1607fa1fa35',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '1072257098cca337068f547c669c4b15a3f624ab',
