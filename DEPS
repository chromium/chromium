...
vars = {
  ...
  'src_internal_revision': '28c9e8b247330d5f9469ebc33d33716d7333ceed',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling Skia
  # and whatever else without interference from each other.
  'skia_revision': '33c67fbb6f9440d2d2b2fdd749ecd4232bc65ef7',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '6797a6e666eec6b5198f97eccd3b06959e0aac84',
    'condition': 'checkout_src_internal',
  },
