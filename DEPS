...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '5e57c1a25c8555ec59a79c9df422ead80fe40cc2',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'a7c17c1c9d27545324a06f4fa2c680101bd34dff',
  # Three lines of non-changing comments so that
      ...
      'packages': [
          {
              ...
              'version': 'Wr5jN0ueM7Blh0hU2gvRO_x4vYLZHHx0FQ1OgRII6FMC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': '3IA8kB6Cau39KdogfMMbiT6p_XsLUquI_UHxRWC-NCUC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
