...
vars = {
  ...
  'skia_revision': 'f7d4de7fb4d20232db4d53dadcc608da6886e95f',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '29a12cf8c1f45fe67c25f42e68c5b039d4b470b1',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'fb409c975f770d2de9e019a7087163ad31d768ed',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@75758ef7708a8506ce279e1b555bf15df4b42890',
    'condition': 'checkout_src_internal',
  },
