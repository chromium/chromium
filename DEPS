...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '08b3d473163807aa0645126b6bc0dfca3da8d336',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'swiftshader_revision': '77ebb7fdd7825df2c2b2ceed19ce3583808bd1dc',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@a088c3231cbb5198f8aecae48f9538e0f239f496',
    'condition': 'checkout_src_internal',
  },
