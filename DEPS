...
vars = {
  ...
  'skia_revision': 'cc3d2d25c58e7e6d0b1fb9e5a7b8b4da670af06e',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'a9ae81086096522da8c0f9e8058627a0e11e3c0e',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '7d36ac469817bc5ad22686a9b5928e9fb64124f2',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@be5cbb81e87b37fb18e9f631a995be246fa94aae',
