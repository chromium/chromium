...
vars = {
  ...
  'src_internal_revision': 'a52bedc2aa39935cfc769e86158e6502b0a6dd14',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling Skia
  # and whatever else without interference from each other.
  'skia_revision': '32c01e74258173d37b56d0e24923bfb6c1ed52e8',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'c4533e0aae6da03775f3537466ee277c14d0d026',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'catapult_revision': 'f695e08f1941e55836a222fe9a1740d3cb51d7b8',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'llvm_libc_revision':    'd72412a71d149555b89dbd49a786091825fe0559',
...
deps = {
  ...
  'src/clank': {
    ...
    '4e8dd3a98d8e90607e23b9e2aeabb01ca2353285',
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '2c71d9143620b8cb01f23a6a98d1d3c3efa093c3',
