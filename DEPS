...
vars = {
  ...
  'src_internal_revision': 'faded0792517f51d0000a52e380ab4e0e598e8bd',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '9ae5f73732808d0b574e8efe88fcdbc72850fbd0',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '8429b6ab86af060d90e149267939c0a52be47326',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '3b29d97d3eeb534c862394aa050829b0b095e37f',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '57dbe8872738dbd86bda7548bb78d8db532318ed',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '3e0d2b8c7e5af9c0d6cb29429ccad9d8745e23c3',
