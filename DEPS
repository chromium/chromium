...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': '8d6d127acc1072488e5b57ba4e7e93da2d94bfda',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '59543ec422c2d05bd19ac50eda0d2cb63b513024',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '426deea309086bbcc0881b1f261e19abfe9cbfbf',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '76e7925f95db199cf3d2e18caabe656661d21456',
