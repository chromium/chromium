...
vars = {
  ...
  'src_internal_revision': '2e7c7289a4bb4197de2bc36ce4c8c8d6a8fb0c9c',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '6162fee75b0a72d44b2194b87680e0501ce1e1b7',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '0134ccf54098e1ccba12169d504f7b3944b88d8f',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '82eb1593e296f35fe126a7e71ff6feecc28810ac',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '4a4154ce82084c0b8f5aa49484021d9eba5ed1d1',
