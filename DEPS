...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'a852ba4496f11a11fbdf5483a37533d748879293',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '2545b9c0e26b6799b4976d982a545091b64bc559',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '1e3aee432828b2b444c43d84c3b5f1053783faa3',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '608fd9705f74c593aebb45e6cae48905718e9cab',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'e7e9a54652886c85c8424c33cd43adf31e513070',
