...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'a87435e5ec826767b587326705d739ddd92fb96c',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': 'd1057840b8daa9eaec0e3d676fbbb1223ec034a1',
  # Three lines of non-changing comments so that
      ...
      'packages': [
          {
              ...
              'version': '_FW-ZM3D3nS44cd2uaojx0YmqrIil-331ixXTAAUvQIC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'U8mx5eNXx_BbfptowCQq0D8Xt9c9VG9019D2mv5fsrMC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'p4vfEk8lZVSeN--L0-T-EddGuJ7q3nhx_Y14ZAtH1i0C',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
