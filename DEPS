...
vars = {
  ...
  'skia_revision': '559185ad34e1e57964001b1738d2885effd917c3',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '41cfa4c2b5d0bc18e87d6819dd61411f6dd7e4f3',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'aci07XDtg6MNtfT9yBvu4fil628iboUui0lJeLe3J9kC'
          },
      ],
      'condition': 'host_os == "linux" and checkout_fuchsia',
      'dep_type': 'cipd',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@d7cd379df74c2097eb15108d2587d1f3e047ae0a',
    'condition': 'checkout_src_internal',
  },
