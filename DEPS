...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '84ae5546739158cbacadc408ceb7fb0eaaf6d189',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '5f1da9002d6430f287183a8f2c2f541725dccf9f',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@bb3e9048f5f15e1e04bbabec8df3d533c07e2374',
    'condition': 'checkout_src_internal',
  },
