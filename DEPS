...
vars = {
  ...
  # and whatever else without interference from each other.
  'catapult_revision': '1ec1fe1b1334d0851051b8f2263d44af8a198ddd',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': '3x_RgEyWM6PCMzhB75C4S2YpOBGkzu0bmydWJMeEZoYC'
          },
      ],
      'condition': 'host_os == "linux" and checkout_fuchsia',
      'dep_type': 'cipd',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '5544338f6bb71005cfc3f4673c016301558f812d',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@0f01a1f331eac0552c3bd8c311a09554b46c8273',
    'condition': 'checkout_src_internal',
  },
