...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '910a784260c5a7b270b3ef80292ba22657a29657',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + 'ae9d8630a20d1fa529e83d8ed7ea81a50eb64ddd',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@44f6d2e5117ca79319e5f2e19855914e98ad967c',
    'condition': 'checkout_src_internal',
  },
