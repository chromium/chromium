...
vars = {
  ...
  'skia_revision': 'fe751b6168324e3b75590b5a5e7142f17a1de319',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '111fe25b87701a19178427563c98a95668aceb96',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'cf2a5a15582bcb9f2c738c9164379c6937208ad7',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'cbc9059a759f72dec5307f9800e5b02036d2d777',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': 'https://chrome-internal.googlesource.com/devtools/devtools-internal.git' + '@' + '2906b376f449d7a7d91bc432b9e278fb7c9d5481',
    'condition': 'checkout_src_internal',
  },
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@579aca58d9085ff0213341d050b800017b17a384',
    'condition': 'checkout_src_internal',
  },
