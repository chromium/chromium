...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '5bf0ae0c907239ebce4ce83be0d084e856310014',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'ba8780fb851626daa89cf7c025460dd11fc78ed4',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@5a387ec28da8c9ee7f664975a6068cae0e13535a',
