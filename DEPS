...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': 'a30d857718ad1e8c98e3e63c921ae5cc8a7598cf',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '3a11eeca89b4975e8512a9c0848191f8620ce593',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': '_0i204abjzwKWMS9ISQ7RQWeEddWkxagARpmwqIYppoC',
          },
      ],
      ...
      'packages': [
          {
              ...
              'version': 'ZMQ3ibABJrruAXmqQWWFa81FVl_SknW1J5XzgTUoDz0C',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
  ...
  'src/clank': {
    ...
    '61e6b5891d6da0475fedfc525375db3d9be31f3f',
