...
vars = {
  ...
  'skia_revision': 'd7845beca81f7cbe1b28e259eaff72e6e694e93e',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@426d5244b69280d7527f6b8eb5fa13eba6e60cb0',
    'condition': 'checkout_src_internal',
  },
