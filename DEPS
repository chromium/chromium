...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '172eb4ee4cb325f40ffbdf46a28b382ce980765e',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '5ef1cc5af2ef3737b5f817ca3f16f531de1c02b2',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'cf948d37aed78639d387622018b2dfb5d5ae7015',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '3824679adbf29607af695ff9364bc97bf9d62504',
    ...
    'packages': [
      {
          ...
          'version': 'VPRfE_6sa4qxmz5Fmk-Yk7F6fCCevLZqcAq9Cm7ErpQC',
      },
    ],
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'c913477a4a38c2904e3ef038533042eb4d306ea0',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '026fcfba01c2a4cf14f45d4ead42460f2a4ac754',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@e01ce27481d29c8513ebffeb3beb2385ff0a835d',
  ...
  'src/third_party/spirv-tools/src': '{chromium_git}/external/github.com/KhronosGroup/SPIRV-Tools@beabd8b7f4f20b7a25574cce1ee1735d46225f17',
  ...
  'src/third_party/vulkan-validation-layers/src': '{chromium_git}/external/github.com/KhronosGroup/Vulkan-ValidationLayers@96fb5396040477fbbffdc1b4439dea9447f59d80',
