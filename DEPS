...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': 'f260b848c0f6cc3b2a0444f7c13d0a75a291ec2e',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'addcfdf40e99e3aeb5ec67da85e7ec546488b16a',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@b73381dbbddc3ebd014b10f7026db7a5b4b80b20',
    'condition': 'checkout_src_internal',
  },
