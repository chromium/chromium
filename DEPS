...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': 'b2a01ae03cdf8f7ac889cd243cd19167d3dbc8f3',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '080a0de20617e0fa3983c29f21e53f6ed6c9fcb9',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '4bf4c2c601a63d7cd76719d9c67972c0497878cd',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'c2a4abe676c5502d12456835feb7f0412d6a9409',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@cb27f57dc05258ff70ed4315c01f82915441eaee',
