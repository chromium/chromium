...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': '91d464283d745216a6ba807c8cfa33b7379e0fb7',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'ebd1c5d71737aad8cb2b6a2e1a591512c22f58c7',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + '1488a2e8df294078049f759faf4efe6450652d88',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@f80c9662e71101058b05bd35eddd27e239e8c365',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '090f2b785f3ca1197b34b41d7a7706ffe45ec503',
