...
vars = {
  ...
  'src_internal_revision': '215748338d9fa1ccdfec76880240303502b61c15',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '98ca78b726e9128c18f1325eb51e8a7a76bf86f4',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': '6eea5ff4db822c87bdb5d5540503037f5aaec33e',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'a8bc8c7947e1bb5400ad226fe52bda01fd9d1029',
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + 'a654ff36bb3dba91a3d4f1ac8a2c6e2055e1f2df',
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '7d7c917fb32548e1a5688fdb48f5f35059d428fe',
