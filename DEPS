...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'a27fae5810b121fbc2f85c3d214da6879d3e2d3c',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'ysvCzayVjC1papgOA5PNkxJgbsOCcjSyWIN_ilPS4yMC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'OjfKOQBohd-5b9Wl-zSG--lZCgwE1aXJlM4Oth9bzgcC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/clank': {
    ...
    '473b36fab9368051c5c3234ed3c5d11f4399289e',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@996befd3da11997e26e9dd6d62ce13630a6a42e5',
  ...
  'src/third_party/vulkan-validation-layers/src': '{chromium_git}/external/github.com/KhronosGroup/Vulkan-ValidationLayers@9d314a23449a99243f9413e0e72206a838cc64b9',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '60c186265f075bb792996200a4752354e438b37f',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/components/optimization_guide/internal': {
      'url': Var('chrome_git') + '/chrome/components/optimization_guide.git' + '@' +
        '1525830f3c409c36c5bf140258bd43a0e4f451de',
      'condition': 'checkout_src_internal',
  },
