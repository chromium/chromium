...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '18ada2a1bb855492d16baabdd83b36cb038146dd',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'a7e8c957ac696012de7c903a9f4f8464879716e9',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '5891e977be539a7ebc69608fe1344c015f77283f',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/chrome/release_scripts': {
      'url': Var('chrome_git') + '/chrome/tools/release/scripts' + '@' + '3a70f42da173ff89f7e8b2137288699d63ba12f5',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'bcbf3351a9001f780ef32cd3ac4439dba772a59c',
