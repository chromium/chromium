...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'df06a59f8e286c8cb815b8f2e194e2a20d65c302',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'fc18f8af8001e73df4363f1e706b0d4ef5844d5e',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'bcef6e185927df18bd71c0de0493712708f85ecb',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@1f029097c4577233447f70421dfd07d630fc094e',
    'condition': 'checkout_src_internal',
  },
