...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': 'e5521afbaba1575abaaf4e7d561a12b6aa1f0f3d',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'a6e4891093e71d23914ad9422ce587456348d051',
    'condition': 'checkout_src_internal',
  },
  ...
  'src-internal': {
    'url': Var('chrome_git') + '/chrome/src-internal.git@183579e0b1fed8f939c4737416e0e59ed93aebd1',
    'condition': 'checkout_src_internal',
  },
