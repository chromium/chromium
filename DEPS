...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '3066269b3d79d683c789adb038847e6dfa35869e',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '179f40e81a461a9978701f6d830f8fdad92d5e2e',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@ae84980112def7b42c078e29a28cf17cf69f1112',
    'condition': 'checkout_src_internal',
  },
