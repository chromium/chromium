...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '36b759057917763f0ce02e0aef6b1b438cff6af7',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': 'a365127b27bab08e55d1073176991c55d4fb5d6e',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '936cda49fef835946bfe7e1a3a781d428ea263b7',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '97ec880eef2a4c725dcdd943fdb56bfd8d89c2d8',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '2aa154ee23caef998585ed5011f18ff5136505e2',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/components/optimization_guide/internal': {
      'url': Var('chrome_git') + '/chrome/components/optimization_guide.git' + '@' +
        'edb05e34de3e1c192179f05e3dd9e0fe16980323',
      'condition': 'checkout_src_internal',
  },
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '247deed192ca05bbe29a898ea216c875bb4280d8',
