...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '8dcde79fef2af4328c25552403e4e3e5cd92272c',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'b149a5c62d76ab536929afc5bba2b2774da46102',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + 'de58655331d91d0e9a637e91d8952d00428a0e69',
