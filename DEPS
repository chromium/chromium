...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'a58def7e2e37de97a59369c5e5dc522183f4d6cf',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'a6b620ce5dbdd93f8bb9b73aa290f14830e20e60',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '36d2e1d07b434c2b4799f435d3bd14628041545a',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '1ce914c3e24f3131d003c2fbc8a666309c012ed9',
    'condition': 'checkout_src_internal',
  },
