...
vars = {
  ...
  'src_internal_revision': '7278d5a60d61fa236bebf6220bb0dac152634748',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '21e5d4c34fbccfba94da9a1430f6f0cc1ba2f87a',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '155667f4979a587ae3597ae98082fed8551e1cb9',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'wELUKG49IBMhHDg-JN8VdHvh2yvFBX0ix2zcyzR15iIC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/clank': {
    ...
    '079e55e58abe98d7b2d6231776670ce0f9d6d68e',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@854652ef3539873c4641c30a2aa438c05c0ff926',
  ...
  'src/third_party/vulkan-validation-layers/src': '{chromium_git}/external/github.com/KhronosGroup/Vulkan-ValidationLayers@d2a1d8ea64f3c77fe3654a0b1f125b15f07c13c1',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '7d5c137847e67e94148b9856be86b4987c9861a0',
