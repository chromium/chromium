...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': 'b9671fd753089d548c580c1ce33d705a8b3db84e',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '5deb07b2542936a025070847ce64b8b49913ad92',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '95054b249d443ceb29a8ea4f5e9ed0f700c03b91',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + 'c857cb454c2684ee922dc3548f5ef159e20f1db8',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'c8b857f1c594c06b2124c9e08974d96ae3db3c10',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '75c6134d3af21d62346b7373d93bb0d6a9739690',
