...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': 'b89b444a142feef3d44fc5b84f13847eaeab16c7',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '4cc4c38cafe2fc162d9ffb2e2967d0a69a6cbdae',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': 'b1fd63ec76e393a4210fd6422e1335b05bc27e69',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '17a9d9334e0bc5913dae73069285d1e75a4b48e9',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '6987eb721b340bbddbb9bdf53682483f03a08598',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/components/optimization_guide/internal': {
      'url': Var('chrome_git') + '/chrome/components/optimization_guide.git' + '@' +
        '262439bc5d4db87dab5fe09b9cfb943ddb2b4382',
      'condition': 'checkout_src_internal',
  },
