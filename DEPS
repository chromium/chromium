...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '8585f19af2e22544f221da908f7fedf183515d39',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '2be8608b4f9bceca3ec0d15e3976a0a45e15962e',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '677a98595f9c6815a18c94c6096a7bc2e13f36f9',
    'condition': 'checkout_src_internal',
  },
  ...
  'src-internal': {
    'url': Var('chrome_git') + '/chrome/src-internal.git@a8a1b52a4683b4b1e0b964b7328c50f92ae5615f',
    'condition': 'checkout_src_internal',
  },
