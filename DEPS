...
vars = {
  ...
  'src_internal_revision': '9560cb0090985916a7f1a3ef587268cb37657783',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling Skia
  # and whatever else without interference from each other.
  'skia_revision': 'c4077516d5e515897afbfd195212617a1195c88d',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'f40b0689b0ff34ac9dcaf6ba63fe78f591609e2a',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '8c832a96226c62324b191c0f1a3576aca8245764',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + '89444b040640b1cc25feabb392c8877f9ba92b36',
