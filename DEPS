...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': '7b0f631824bd5492ed76b8f11e282aa34ef5b06e',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + 'b8a4c0ba657c8fd85e6ca552e210d419a9920f93',
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '71c88c6b29be501fd85b38198e1992baddb3729b',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@bee7f6960f871b6f32255861b2eea24b4bdce06f',
    'condition': 'checkout_src_internal',
  },
