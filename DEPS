...
vars = {
  ...
  'skia_revision': '2478c70a03bb48f30fd400fc92cff101df004eb9',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '51a9b91e1e5176bb007e749e7f506eee7b5407ba',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'angle_revision': '91b6c3b1a2b12f6c834238ed680d82c3de741cd0',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling SwiftShader
  # and whatever else without interference from each other.
  'swiftshader_revision': '69661d887fb54f80fe251561d3924d81dc48e674',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '29f4224ebe15ed9a4aa7a1c7b80bea48aa495a35',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@bcca44f5114ac21f7f8ab7e155b1d67eede9b4b6',
