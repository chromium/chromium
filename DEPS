...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '4d9b5975a3236910c2eb0fc8082ddcc1e5dcfbd1',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': '08d3be385db949b25140b85bd8eed258484b5401',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '54bee2372f32a6a3b1f1228327d7aa46c1dfd240',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'b88c3b5e02cc50c7dae29f1184b4ee6e7fc58cbc',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@b5823524e74c62f4dbff3fff0afbae21897ea4ac',
    'condition': 'checkout_src_internal',
  },
