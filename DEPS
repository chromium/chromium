...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '587bfafff4d5c416f5b47f9eb23e7586fb559bf6',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'catapult_revision': 'd6b8ba39bfca42eef90ecd7d777712780fd5757d',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'b323a109134d218fcdad8fa4f23e558a80114e92',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '05933a6692c1a49ae476ff300adb5768f9566329',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/clank': {
    ...
    '4cf8c79af6baba9daf288dd7fc61612fcae84528',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@c784867a8f8905f4834baa393bc33ce2098da44b',
  ...
  'src/third_party/vulkan-validation-layers/src': '{chromium_git}/external/github.com/KhronosGroup/Vulkan-ValidationLayers@c2ad3ab23c073a820d1018e589819d3d3bf5d580',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '75fb0dda893319158c1b7e61b60ad395dfb7ce9b',
