      ...
      'packages': [
          {
              ...
              'version': 'wWstnnlYxpm9tVaXx6ORNrLw1i73JdTNO-LVqLjB-gcC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'ufpTUyqKvbIqM2GT9FvAafSVqk4Bqu0URQUq_BNUqeQC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'uhD9xmIlKPoNR9YxmdKmAOBGpbGah-izrdUNk3Ynxx4C',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
