...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': 'e35527e40d67e564c4cea24bf3dcca5521eee2fa',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'crossbench_revision': '0277e09411d6cb24da34cae2f6a721ea9309e1be',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': 'bd302da5fe833e6662c71b5762e4c75405792c17',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/components/optimization_guide/internal': {
      'url': Var('chrome_git') + '/chrome/components/optimization_guide.git' + '@' +
        '1a5f1671d4436217b3c1e12d5c51c0340e82d08b',
      'condition': 'checkout_src_internal',
  },
