...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'd1100603964278cd89c5eb94707fbca242c788bf',
  # Three lines of non-changing comments so that
      ...
      'packages': [
          {
              ...
              'version': 'Uocd2UQ2XWDMjjBCtKqgKI93n17QA9nipK8evyWusuwC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'MIBa3WwDZca6QNDSUKlI_NwO4nc9A8GecxjRnZLsfM8C',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': '3maWr9BidDIrIXBlXjlmBKjbGoaH-J_ngCmXbaRMAvsC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
