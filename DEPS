...
vars = {
  ...
  'skia_revision': '9f46ce7a28a0d40d6b66b3dae04da7705ec82cba',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '775fee6b6ae42498c23fb888a338960a1844dd73',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@5639ba6912d1218f58b3e6f6efbde59fa966daa1',
