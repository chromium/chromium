...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '9b773f7cebeec046ec8c1ccf803a9dddda0e0616',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'chromium_variations_revision': 'df400f777aee29c798884d0502e6820542f5335e',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '7a45d24a6f2509ae030f60f1e5a615ece9e0a38e',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '484d30fdefb210d0d12910680fbaa57cb59ed9be',
