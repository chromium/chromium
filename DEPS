...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '6f61e0ef926812bd0cc231400317aae68b56235a',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '1e5166132453390189ed731b0a5acd22e36998d6',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': '3c12b7484f17677e44cad9181915905dd01ec1f5',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '64beebebc1c44802e9dbf0ce6edefe4b6551114f',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'ac8b0016a84a52407e52b92af0671ed23196202c',
