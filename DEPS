...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '05db7a2785e96b520f548ba044325c0a272344ab',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + 'aa13f67d2dcac6ca22754661ff4ac21cbade0489',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@2b95351fd263481819a51c653ddf0c6e06283e8c',
    'condition': 'checkout_src_internal',
  },
