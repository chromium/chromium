...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': '493f3f310a2b141e6a2bf67293d0e9eb86df33eb',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': 'https://chrome-internal.googlesource.com/devtools/devtools-internal.git' + '@' + '73f32880e9e5d9c90e5c4179446b3eb2f633b3ba',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '64f2017b1e088738d3989d6cd5831c8c709bfdcd',
