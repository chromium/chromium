...
vars = {
  ...
  'src_internal_revision': 'ab9bf27fa2bbb70089738012e0c3adac3b73054d',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '3aeb6b34b3f871f7d3a7a5ac8d98800e8ffc523a',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'boringssl_revision': '03ca65809451c07c860b48b28bde043ec5197b26',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'llvm_libc_revision':    '0dad4c0315cf171daa2a8880839a3d1bab8811de',
...
deps = {
  ...
  'src/clank': {
    ...
    '3558604c9ff96dd4f66113609e61e90c307060db',
