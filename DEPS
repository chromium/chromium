...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': '3b5e09ae54be246f0789189e93a288034bd072a2',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'a18167a66c4bea33c4608094995cd0d4b1d061c1',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '8b08aea5dfe63bc2538e7e4ae143e07d95b9c166',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'ebde8d35bc26cadb822953b4ed7a9f2113bb4549',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'dfa7b2b425799cbfdf7979f816bb1e143ae2303b',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'd14d0b9322fe7e517ec23f3dd13ef6748f9b1be0',
