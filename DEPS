...
vars = {
  ...
  # and whatever else without interference from each other.
  'dawn_revision': 'b55170d52ef21d991dcd5f6190c1131fe0131a4a',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'llvm_libc_revision':    'a80e92c4df2a9d33dd5a9d4882d7637434f17529',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling llvm-libc
  # and whatever else without interference from each other.
...
deps = {
    ...
    'packages': [
      {
        ...
        'version': 'Mo2VGUAOioPGw2HZBlLRwaOozvbUit7d5Rc4K_YfCKcC',
      },
    ],
    'dep_type': 'cipd',
  },
  ...
  'src/clank': {
    ...
    '4a04ae0cb3a0ee05b40a7aafaf6331aefab519b4',
