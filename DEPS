...
vars = {
  ...
  # and whatever else without interference from each other.
  'crossbench_revision': 'df24f1528a967e64ed4ff4dc3a910ac15299e154',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling CrossBench
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'cfdfa867e39ce132d94756595d876b59802ac184',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'GnTq2Qm1WdXg8DJ-cwkepE7O1UUq-8nXgye1S4rV-DIC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'DDyITHU8DfnN7mAZCVETS4-bKy-MWlbaeFyPmxdv3T0C',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + 'b4c3c9b573afeec9d27b9312acd3091041d3a112',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@e2ca4b934af71bab62c89dfa9d1290e19d557e32',
  ...
  'src/third_party/vulkan-validation-layers/src': '{chromium_git}/external/github.com/KhronosGroup/Vulkan-ValidationLayers@430c8b92c4ca4f9f235c5536fc89b930ea6be962',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '4417e36397eceac6b3e2806d1a9baa298eacc2ce',
