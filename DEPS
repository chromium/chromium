...
deps = {
      ...
      'packages': [
        {
          ...
          'version': 'LlAjtmaj1pbrqJJKGY_o0nRkUWzxp7H1pPiwNxRikicC',
        },
      ],
      'dep_type': 'cipd',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@009ab74477feee97d3111bc57b11406e13592a72',
    'condition': 'checkout_src_internal',
  },
