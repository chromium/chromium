...
vars = {
  ...
  # and whatever else without interference from each other.
  'llvm_libc_revision':    'bd2ae3e1899076ec5807d712a71e2359dbaee4aa',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling llvm-libc
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + 'b14bd1ba1326d36156784ced0e659a4745704295',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
    ...
    'packages': [
      {
        ...
        'version': 'nmmoiMZb_fzTkdHDUaab3_XKmUVsenQhrS0-FjBfglQC',
      },
    ],
    'condition': 'checkout_chromeos and checkout_src_internal',
    'dep_type': 'cipd',
    ...
    'packages': [
      {
        ...
        'version': 'ZSKhKG8-XPx1ebRGGUUJKAuVvRrMaKVIb4_TSBDQOd8C',
      },
    ],
    'condition': 'checkout_chromeos and checkout_src_internal',
    'dep_type': 'cipd',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '0267ac0e882d19d36e5b6340bdbaddf405afd422',
