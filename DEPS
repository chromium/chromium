...
deps = {
  ...
  'src/clank': {
    ...
    '7bf81c7c2c48283ffc63c6857b39f94015e8be9d',
    ...
    'packages': [
      {
          ...
          'version': '2gllZYexJMbLOJ1m0-DqSix5DxCMTOiX18-N1bef33sC',
      },
    ],
    'condition': 'checkout_android',
    'dep_type': 'cipd',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'b941c54ec0c43083b6272123d810373dc2041330',
    'condition': 'checkout_src_internal',
  },
  ...
  'src-internal': {
    'url': Var('chrome_git') + '/chrome/src-internal.git@b097668dcf7986fe6711de45906a77f2621f21f5',
    'condition': 'checkout_src_internal',
  },
