...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '89ee3035df04ace237213520e6277f1619fc9f20',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '39f4b2769434c9abcceba70af7af5fa1890d76ef',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@b86990863f56d0cd027dc6b8cc0bc72fb334012f',
    'condition': 'checkout_src_internal',
  },
