...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': 'd3e835580d1caeccc6e248f2ef09bbba26da58d9',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '092fa56137c7a2bd3bcf16cff2e202a60834f408',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '2c701d01bd706ef585a408df24c824c47430d598',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '73df3416b599245ffc56cac85d1a927cb5fb272d',
