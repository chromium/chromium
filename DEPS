...
vars = {
  ...
  'skia_revision': '19889d74fa94d0d2c5b63e8860cbf4610ca137f9',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '86a914128c9ae15c09be7ff12c88c3e6a72bee87',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '2e29d86c1890fe06fb68904fe9213c266c6615f3',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@7224936b5f6a74d229ef3d45394dcc1aa4e3eeea',
