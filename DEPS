...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': 'a17cc990c9b1869aba90a81d58438f3dbc220843',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '93ef9edde33848affc978b60f14a14e7f1a33446',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '7e9f1e45a9b8da8871734bf73c15c6b9c6aef96f',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '660e0f1f7b304237e14c3144c93c382ea3ae99f6',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'd3b71c778feac391aa0cb5403fe6fdb022d15548',
