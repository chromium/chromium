...
vars = {
  ...
  'skia_revision': '2f7929a66c555b50b37343cd022b83ad05ae00f1',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'c62c2bbd7f11b0d39c4b3477cee9e1db68c99859',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': '46af4c33ef6042e8dc91060a43e75dc547111dea',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '97689a688df949d123ad524e90901836fb45d71a',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '842858c6d0ece741013217aa92d6dd9ea24a1fda',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@257092a945faebf44c092b8164c26ac95ba80a10',
    'condition': 'checkout_src_internal',
  },
