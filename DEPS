...
vars = {
  ...
  'src_internal_revision': '0f89adf2d438d8d7812fe7c1bdd7d0bcd23f887a',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'angle_revision': '47db665315a7dbc397c57d97e22c0bef8cb3022a',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'pkYVEmq92oemGuWufqwBodnpop5OJstxX2fBoDRpl6gC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '05946612a4cd0e295edba02b74c8cd3b45063fa6',
