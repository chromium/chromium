...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '80bfc2d38a1040db89fcb777a2b3471cc0b5a314',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '842ee82a4b8d6ac0f93ba92688d493da90cfad83',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': 'https://chrome-internal.googlesource.com/devtools/devtools-internal.git' + '@' + '4f602d6a97f5c9a2b868ffe7997cc7d0c350532b',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'dff98498a5f79fb4bd81947abc8ce54d5d54f486',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@8b4f8c24f54da276818696a54612af54ec7742ca',
    'condition': 'checkout_src_internal',
  },
