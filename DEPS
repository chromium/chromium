...
vars = {
  ...
  'src_internal_revision': '67a305097a2b09d14c2a0ab9e5d721283a6c6e0c',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'f6ebdead2b58e457b923c8121a9267a5d80f59cf',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': '5cff2421ef225d14d3a4253b81073389fc840024',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '71e3fbf5d750e84d181315a663eb5dbc29a5330c',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'ef30254f49a083cc904ebfaf4ae3bcaea36ce92a',
