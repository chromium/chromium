...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '5ff2692e9c72796307ca25d27659aee977e13fb3',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '779721233a5b50c1ad35e25f5cc53b774badf217',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + '09c3512f47086dd41e0f26cdbecb470905a6285d',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@6e632b815d9169fe25eb8b9f7ea7976c9f6dc16c',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'cd4052c6c0d8a0d107d31b589112a78ab0051d7e',
