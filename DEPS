...
vars = {
  ...
  'skia_revision': '0d81bc7bb04ea69d285bb4497698b31a5db8a701',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + 'fbff2f18579ba3da4b4c10a61cd13a10bec2deb3',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@eb94f1e0d096d72a072b69c4c6f12014b8eff268',
    'condition': 'checkout_src_internal',
  },
