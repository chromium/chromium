...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '12231adf7f4e87ab0375f47583285402712b9fa1',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '5f5d54734bf6c351f7908293ec21a0e3fa480d25',
    ...
    'packages': [
      {
          ...
          'version': '9DsBYQ3FrZwe9NdDBGA3RXRB96VlTeC1yzv3zUGJX_8C',
      },
    ],
    'condition': 'checkout_android',
    'dep_type': 'cipd',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'd5343c4d437e103063352c7f922fb1b6806837da',
    'condition': 'checkout_src_internal',
  },
    ...
    'packages': [
      {
        ...
        'version': 'gMPvNzITXMbQV1oWZe9z-RFdYXfwRwj2i2RPiwY3d2wC',
      },
    ],
    'condition': 'checkout_chromeos and checkout_src_internal',
    'dep_type': 'cipd',
