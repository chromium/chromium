...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': 'e7ae039f5b1b592ae8201e83bf8894139925cfd9',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '212b3a9fcc646c37ed176171ebd68cb2ce81ea5e',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '992dea31b11472dba4dc50ca13720a00373ee699',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/clank': {
    ...
    '96067f94c440fca2543ad0537447ac59ca941196',
    ...
    'packages': [
      {
          ...
          'version': '0dHJ8Y0UrKaAwdrffOv6wtPkNJ_xG7TZ8SEncx35wtkC',
      },
    ],
    'condition': 'checkout_android',
    'dep_type': 'cipd',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'f89eaf652dfba9c57e127a72c36d07c08fd7d4e6',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '688346319365712a47cefaed3684d37d2fafd110',
  ...
  'src/ash/webui/conch': {
      'url': Var('chrome_git') + '/ash/webui/conch.git' + '@' +
        '80cc273557bf325d0a32136cd05c3906d4e4d9d8',
      'condition': 'checkout_src_internal and checkout_chromeos',
  },
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '69f892501189b4f921df961ebd0e470f880a8197',
