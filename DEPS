...
vars = {
  ...
  'skia_revision': 'e33b3a032be99fbd120ad73789b5c09864c4871f',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'c8b20b099d92e984890c76707e9e03edcd660fca',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
  'dawn_revision': 'f3e4779031bdcbc5e7b1b13fe67eaebe30405ef9',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@a0ce8430c0d02ac590a40bb39fbef2391b45a139',
    'condition': 'checkout_src_internal',
  },
