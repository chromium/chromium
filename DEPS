...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': 'd4b7690fca9211056fb66fd02c76748c9412db58',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'crossbench_revision': '89fb9d173c3fc1f2478e453bf6d09b65e0eec954',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'llvm_libc_revision':    '7c6c08e4fbbc3df5408bb8d56a15671b0192fc8a',
...
deps = {
  ...
  'src/clank': {
    ...
    '1dc35b6ff118592209310b7731c9ac6259b0692f',
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '297f5a341ce2420390abcb9e17caaabbfccbcd57',
