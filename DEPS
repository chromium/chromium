...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'f52aaf99b52cfcd1f4dedcfb132fef53c4eecaa5',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '2f618d0867732f0e82a3bc3b679219c8b62d035b',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '765b1a72c04e2ad53e230ebeb11b29ac003df725',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '13352d7bf3b81d869911c17ee28485ce26a223c7',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '85adaa1f833494618c8c49cfa7da6aaad39ac68b',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '8d643e246f389b1457670a3b6fb1c27c6c57f360',
