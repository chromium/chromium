...
vars = {
  ...
  'skia_revision': 'fde98cbddd43576389d1f10881276583835b0281',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'angle_revision': '27e52ca05dc71f184401506a32197a8894234399',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '7cbfe50ac1b1fb0d1f4654c64499c8bc1b82dd85',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@bb1cad334635c1356fb8bead6d56fe2a87499444',
