...
vars = {
  ...
  # and whatever else without interference from each other.
  'swiftshader_revision': '7a519d34f57a02c4d87d9825127516d392fda373',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'catapult_revision': '8b9cff42b376bb71d1132e70fb55340e1985d6f2',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '977eeb69af7b9ffbfe76586a5270d5c813ce2f16',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + 'e94526b4043bcd9814758bf627be6da9b5167a13',
      ...
      'packages': [
          {
              ...
              'version': 'KokysSnB365aBFHMBd9wc186FtqvhcGxKy4KUnne5G0C'
          },
      ],
      'condition': 'host_os == "linux" and checkout_fuchsia',
      'dep_type': 'cipd',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@f48161bc4b8ca21617cdbc3b9067bf817487e7d3',
