...
deps = {
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + '1929ce1d86b732b478e22617e0cec2bb93315071',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '6426dd6e0e7d4884226b44d2f46db31902967bf1',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/components/optimization_guide/internal': {
      'url': Var('chrome_git') + '/chrome/components/optimization_guide.git' + '@' +
        'a9f8b71f3638e7180a2a3004d7b2c9df5f5a4387',
      'condition': 'checkout_src_internal',
  },
