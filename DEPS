...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': 'b1a7be93c0182862b1f2b07953df0b78fc73a89a',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '76a0b2c67d10adf24f152cea2a147309c77be480',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@c450f91833f6e695193269d60c3e43c9affe5d2f',
    'condition': 'checkout_src_internal',
  },
