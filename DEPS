...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': 'ea9ca090052383a24dd5093214a04a9451b68b92',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '2e7a3f8d8b38a1f9e81819887dbdc440461143cf',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '8be592a3ccf51134f28772088cd5dd43d84d3666',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@4fc3f0f0f77497e42d54c2a6e3d4edefdbfc5827',
