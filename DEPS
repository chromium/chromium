...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '1c7716cb51210d592782b55d32ff3fc7884d45da',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '05b9dd04339b969ed7b4dd51e22bfa129fb11cd5',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'b0ae72c7c09b5ef4cbbbf72ac54375c6316164e0',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '23b9d1249f16f4ca6ba025a2a2dbb5faf29b55d6',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'd0927b72db0be207a0b5c802b3ee1daab7a78e85',
