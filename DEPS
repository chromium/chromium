...
vars = {
  ...
  'skia_revision': '89ddd74f8077e39d9cd4c819b336bedab248529c',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '9c0ccc73749185eec23cd518bb8a35818f8c8c5f',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@1bbf88211b8a2f31415b95284c49ccd229d66a3a',
    'condition': 'checkout_src_internal',
  },
