...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '3e348cf2c0dbaf4a62196704d22324edc5887d00',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + 'df30961664b55d19989a05258b5c2eaae0d0e4d0',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'f166fe245c9e91e49c07f6aed48fedd5eed6d99b',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'd08a26cce9d3d42eea06b6af87b09431b17a41c6',
