...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'c78c7c104553498462cc87c756f0cea6cc946390',
  # Three lines of non-changing comments so that
      ...
      'packages': [
          {
              ...
              'version': 'f95gukWe4MIBWGSxSdJ1dbmWIE4BiyondWzMxDaaDmMC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'uJg27EQeFncYoKwMbp21mvzZzUsk2hSuEIvEJLzLhEYC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'bJA64hvEmenH3Kx1t2OHhUX8RbkNKdLs0eKRitH7ckwC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
