...
vars = {
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '01354c07cdb26f0484244561052d62b8340b4254',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/clank': {
    ...
    '7632dfc729d6dfc285d09a2e5e6e8a11774f4058',
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + 'fd5161870a65fbdd2d5750606cfbd410d32653af',

  'src/third_party/devtools-frontend/src':
    Var('chromium_git') + '/devtools/devtools-frontend' + '@' + Var('devtools_frontend_revision'),

  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'dce28c017350214d4cc253f1347a7f71f58914d7',
    'condition': 'checkout_src_internal',
  },
