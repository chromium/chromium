...
vars = {
  ...
  # and whatever else without interference from each other.
  'catapult_revision': 'c0589f92a7e138b6077d7324491b287aa9ac09ec',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '4ee32ce4cbab9f81f14109a108507bbca3d0e707',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@91e75b0b425b10a66afe79a26931ea8c5b6e580b',
    'condition': 'checkout_src_internal',
  },
