...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '8223367ae8502e6ad0a3db9ff5c06bca430691e4',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '75004559fe219bbc8d4df5a477d1cf3d358153af',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '07503afb78b985db069292bd0f6a56785254b98f',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'd259a754a8ed78ce68313eafaed93c6eaff2ec2a',
