...
vars = {
  ...
  'src_internal_revision': '60c4f71d9af53e1e8014b6f476bafead8d532bad',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '7d93a3d145996bee660a90a46fe2ff543e9d418f',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '563c7c55273e439aafc340f08c774718b8856bb4',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'febe88eb77495484bc38437ed03a5f9fd08c079a',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '6603550a4279b4b68b8b763523370dc8e010500c',
