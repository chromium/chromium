...
vars = {
  ...
  'src_internal_revision': 'e9b290f4293d1e36532ecaf81e44f93455e5d5ba',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling Skia
  # and whatever else without interference from each other.
  'skia_revision': '9ab6bec80918e3e1458d21f60e274ce0b6ef1925',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '317d76ece3f8b610a7ba2a992789a91e6d1212ad',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '3a3b4a41e9263c9257e8daba6fccc0087f44ad0e',
  # Three lines of non-changing comments so that
      ...
      'packages': [
          {
              ...
              'version': 'smM-3TuVEH7_CxHePk3owY7ACl6lV5zOSOGSMg39XvoC',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'cdc2ef178e5d8e1a6d8083e01fd53267f33218ad',
