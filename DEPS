...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '8de238c050fb0efa37accc538ffeffaf82428034',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '02ce795cffac09e8c572798ed2ecd2885a26a9bc',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '8333c687b8d43a06535db8439ebd90dd6434ce25',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/clank': {
    ...
    'c21f5a9432f8b83c670796f5bef3bab9eda9a03d',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + 'b3b3ae415d7e8c124bab56bad8da0accc5d2b2d6',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '2cdaaedb2975064c6e120697f2b6d884765914cd',
