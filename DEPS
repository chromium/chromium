...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '9ae0b044c5778bb5cc97514abc23ad169b12bce9',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '72ea2d5c4b4ba5741aa3ccfb6fcde4536afd706b',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@3cb2c2cfc68e03b808fb49c994c7fbc04a1eb835',
    'condition': 'checkout_src_internal',
  },
