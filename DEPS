...
deps = {
      ...
      'packages': [
          {
              ...
              'version': '2giVtg9xdrBbVFhnJBOS5d5NKdEdjhxVDSIkfGvIelYC',
          },
      ],
      ...
      'packages': [
          {
              ...
              'version': '7COI31AzBqKSCyw1ujYcvS9N7a1lacAsYu6LDqrOc5IC',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + '7279d9a372a5f7f27dfbf651914d925a9f7ec2dc',
