...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '21606dd6952feda3f8727320f6639f3a33f59f5a',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'ffbdbbf8ce8396c251d3d9994def1ef7657c0129',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': '8BkRifPBxce0lGTPcKULhmRc5iI2CRi3tMg9qn0beqgC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': '66YdRB0Y8I4uiCqmRaUuil3neO5sfMkXnXDRCUXrJQkC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '660b3fa98184e4f47b8fa7ef390f23914146e395',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '713e4b53145d688517065b119f0b73ebff228e33',
