...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '541fadf13c2e29b5563282a32f0011db1cdc31bd',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'e87a76c597356bc5ad717949c35e4b6d72c9eb76',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '04ad3b729c19ad674e28afb1e922cd6cf21be7b3',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '2ba6d8f25f3dcef7dc41899270e3f3a989c9d7c6',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/components/optimization_guide/internal': {
      'url': Var('chrome_git') + '/chrome/components/optimization_guide.git' + '@' +
        '261cd0cae34ad880ff7524cfd7209075c538eae0',
      'condition': 'checkout_src_internal',
  },
