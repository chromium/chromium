...
vars = {
  ...
  'skia_revision': 'f9e20555c20d1087694880fee0a378483abb6b36',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '30a28d2adb1d652b72313a9a70db34eb1b550b2a',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@1751c9b2ec1a558fba6d56b69e00152e3be417ec',
    'condition': 'checkout_src_internal',
  },
