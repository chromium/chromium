...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': 'ee9fbcba5f16a55d0a545235e26a9ae5f94f6ad6',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '30152edff696855e3241c6dc63ce414d550563fa',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@e41b3bb941a627859614975aae2338401774bbd1',
