...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': 'e3f6bfa1c02b0b893a9996d06fa961caad5c9451',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'angle_revision': '720ab592e480a5af3260ca39331d9f7673d0e41a',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'k4u8yjuUwbF7axk-cPfVtq5tMecVkhRH25BJ6AKUiIYC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/third_party/eigen3/src':
    Var('chromium_git') + '/external/gitlab.com/libeigen/eigen.git' + '@' + 'e246f9cb68d07e8f15c60a2404ac9a625c349223',
