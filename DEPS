...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'f8ddca00cbced8567c222a1531ae109db6a634a7',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '333f7fb6acb100da09e0e24306fc249f85c57632',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@3fa5f4c03bb496e21f66645cde54ee47a40413c6',
    'condition': 'checkout_src_internal',
  },
