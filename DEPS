...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '3f6338e564fbfb2e67a475e89c227a4fb9964997',
  # Three lines of non-changing comments so that
      ...
      'packages': [
          {
              ...
              'version': 'qf9Nl630Jpqgz_u89WKhoQcRbbvBEyTr0j-SEWc6IcAC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'Q4ldPLvvByQpf0BL-jCC9Ej-YRfm5p3qoDni8nzWZUUC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'X5hjBtDqinwUPRRKEjUOy6U7xLRCIv6PVGgjklEZ9N4C',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'a808b77370ae160462cd5dbde7e90f62998e1787',
