...
vars = {
  ...
  'skia_revision': 'fd61fa92d67387de8ff860dec02131b0c3afff5c',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '0e206b7d3f0d7c241a7f035c3840d1d63a24f062',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
  'dawn_revision': '180ec459ea79f3be400a80f270920a243940db1a',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@6cdac697c344988d24e08890c788cffd1706b1ca',
    'condition': 'checkout_src_internal',
  },
