...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '592a981aa27ea0363839b248095f5b48ac20ed7d',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '31ba07e62ba26176e1834f76be391a858c2b495c',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '7064e3d83a300fb9401ad734d7efc4e79ea736b6',
    ...
    'packages': [
      {
          ...
          'version': '1LCfpFxGYgC8UXitq4jY8PBJm-Bgoc7OYA604TSO_roC',
      },
    ],
    'condition': 'checkout_android and non_git_source',
    'dep_type': 'cipd',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '491639ac68fec40df13e3f7a1bc7b97275d1442d',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '13e910bf015ff6b908dfa403050912bdcead0700',
