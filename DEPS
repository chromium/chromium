...
vars = {
  ...
  'skia_revision': 'b6de28fe1a0eb05bbd79c4a3f5c1898d98f0d132',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '8f9b44ba38c134e1c69126196e4d9e566ca5d5e3',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@8187c3ca43109649a1ffed54fa60a2a853c35754',
    'condition': 'checkout_src_internal',
  },
