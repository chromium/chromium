...
vars = {
  ...
  'skia_revision': '53f7801cf17fa230a8328fed90acecc0ae51cc98',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '99bdf2f27002569610a8f868c9f8bdfeeddcbec5',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': '6b4be8ad99e9f9234cbb1a709798ade2fecd8b66',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '8ad555b18228a1e667578d04c5e52c067b3cd1e7',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@0c59c7c6d436dcfba7ed046f6e3d9a24b7610b44',
    'condition': 'checkout_src_internal',
  },
