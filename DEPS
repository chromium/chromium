...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': '257ef4e287b0e78c534521a7532c93c443f4e4b6',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'e199c5a8a773dd3efd726f3b90e21c9c0094e48d',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@db5d917c41c983a2772990d24b0e489321c62daf',
    'condition': 'checkout_src_internal',
  },
