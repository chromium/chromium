...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'ee55f09b8aac575606fa342a8df5cfeb23693321',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': 'be79ae93752cbf7502d396a8fe06f8337f940b4f',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '063348ad6615c9b0a78979b3f86cc2a398c36ec1',
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '8d8494a1414ef3f532805768f8380f4fd6b9c4dd',
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '29c68a3312c2d07d7a57e4f40348cfff364bdf34',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '65264b50c7c005614b731e4638d42d342feff917',
