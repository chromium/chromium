...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': 'f45e39804403ed33fd92a5a64c2fbfabef7a70ea',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '7547ac091e77502706259f242a8e6cb3819b4cd7',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '6657bea2b094fb00aa1735775d504bf22415af03',
    'condition': 'checkout_src_internal',
  },
  ...
  'src-internal': {
    'url': Var('chrome_git') + '/chrome/src-internal.git@c5bd09ce9c968deb400dafaa863557c7e417c10b',
    'condition': 'checkout_src_internal',
  },
