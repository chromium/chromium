...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'ba14c03cda54632faec7dbd18f72c2075f74f904',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '03d33adea525022f9ab6803e936294e71b3bcbaf',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '9699803874eb8ab11a89d1c7ec4933f4eef4e783',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@c54cc8dd7f03095ab9305286d18f2230fb0c1f20',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '69d335ff367f2c5fc8c93d5e01ae8980698b41ee',
