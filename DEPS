...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'f43cf18de5ff19c218b911c87a9da38ecf65b13d',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '74cd7c59889e9842535c8d032418a41d0cbb7614',
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '2be7ee975d27c328763998888a55db89c46aecd4',

  'src/third_party/devtools-frontend/src':
    Var('chromium_git') + '/devtools/devtools-frontend' + '@' + Var('devtools_frontend_revision'),

  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '7d2234b7b975ba8289a7e7473f8c68d37d77b620',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + 'eee42b5a6be9449b977df871c40a588fcd4e4102',
