...
vars = {
  ...
  # and whatever else without interference from each other.
  'swiftshader_revision': '159f5121f1bdfa0f5982c19067ad2bc263f59d0d',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'catapult_revision': 'eec3f1824d6ed9ba2e2c36ff3a794e619cae3d19',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + 'c11a583b2097461479b9bdb77251b29b8f541cd6',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '3efea373092caf3f29c83fb4a40ca0f46fc6821d',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@fc525727b9794cba82b0c973ad7607c39759cae9',
    'condition': 'checkout_src_internal',
  },
