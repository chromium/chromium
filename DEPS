...
vars = {
  ...
  'skia_revision': '1400dda5de60b35c228e0dded4a8f8a2850b9151',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'angle_revision': '2be35682cd679a4bd955d513c31c8781d0fd8f6e',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'catapult_revision': '87dd38763359b68d5df05b0bf1d5f5200c29c06a',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '64d02136b23552f904e36d4b3f2fffca23be6c7a',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '8ecad5261a1fd2aa8c59a3c472ad4052e46961fc',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@99f4c7607c8c7c3623f6e5b164c59443c983805f',
