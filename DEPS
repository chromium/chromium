...
vars = {
  ...
  'src_internal_revision': '84c1f25d398bca573fc50b6fc70d5e93cee21110',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling Skia
  # and whatever else without interference from each other.
  'skia_revision': 'b44aa9b66f281133e0bc6435b81e80daa8822bcd',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/clank': {
    ...
    'deead966310e8d3355dc0779c340bf008956ce57',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '557d387a2e25bee33a17f6e5b2e4c19a77a61cf5',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '551191ddfb53b5da1e66a981c6c528c8ffbc46d1',
