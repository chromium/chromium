...
vars = {
  ...
  'skia_revision': '8a54d86c780a22796f8d535f74bf6af33a06c707',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '89fd7a5b6d44e45d3cc48d2428d6a6d62f3e9abb',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'fdf95d90a8515a73eb8549ef3497718e40bc8d18',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '1ffd761a14204bc0bd5321e3d4ee11b51dc2b71b',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@93343215d1c0adaa22f8d2dcf5f9f2d6108176d7',
    'condition': 'checkout_src_internal',
  },
