...
deps = {
  ...
  'src/clank': {
    ...
    '980191f5a89d37dc8b45b6c735b3ce42079d319f',
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '2acd6f4c9d29c8a25dae7d7eb9e3a469f586bb1a',

  'src/third_party/devtools-frontend/src':
    Var('chromium_git') + '/devtools/devtools-frontend' + '@' + Var('devtools_frontend_revision'),

  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '6b1047ef0865b6139e9a1dd3e440356823422315',
    'condition': 'checkout_src_internal',
  },
