...
vars = {
  ...
  'src_internal_revision': 'fa59f88018ed5cd92564be1b94d42162447110b9',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'e6d1a1d6a39ce223629e8dde7a89c794bf681c40',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'cbd29523fdfc7ef71091871286a85cda8239ffd1',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'a3ae2db3bc1ab61358b10b44ca005c423a7c78d2',
    'condition': 'checkout_src_internal',
  },
