...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': '670f6d863bb1fbe9321728a77d4761f0344c8e1c',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '042a451b96fc18ef011287950f6c528e51ef37af',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '06a5858667e6e2fe2689f2ef2881f3797a0e2904',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'fc9200d573db847b3ad8b4251b8c964a359d4c06',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + 'bea89ea6dbfd0d0c173193c5a827cdf9ba04fc82',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@e25f9bb7a149c87b9dc58e5fc8510198a8972ae9',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '1f90b92eda82d0d85128936288decc88cc52d70c',
