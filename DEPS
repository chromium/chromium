...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': 'c084f1d48380f8302b3706f4f8a74c2a15476d34',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'c86b89fe6700269222af9efa844826ecce21a39f',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@8fa6e06748e7ddd1935b5c9e417b860c0a4108d2',
    'condition': 'checkout_src_internal',
  },
