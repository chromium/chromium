...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '9f5b4623bc06fffa98ea7dcfc5101915999ae242',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'swiftshader_revision': '16f4b38bdc034f5524cbf0cfd196a98a60a4b98b',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'catapult_revision': 'd4b3a645413bcf530fe9b3cd6ab654213833f3d6',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@06e5653a423504dc92d0a1b253210336891b5535',
    'condition': 'checkout_src_internal',
  },
