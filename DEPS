...
deps = {
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'e836f5fe1ad9935fdd66b47ac2dcd667fbf8489c',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@fb94f26a90c16ca5cdc2169168850eeacef1fadb',
    'condition': 'checkout_src_internal',
  },
