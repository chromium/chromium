...
deps = {
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'fcffa2dd532d826d91842d2f5ae0a59d3e008cac',
    'condition': 'checkout_src_internal',
  },
  ...
  'src-internal': {
    'url': Var('chrome_git') + '/chrome/src-internal.git@cbc816532531799b8d4ac4e8d8ad48108965fcd7',
    'condition': 'checkout_src_internal',
  },
