...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '699e4f0dd21cdb0ee1db6a0d3b7a53e7d823345e',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': '48e40ef60b69837b3224adf8c2bf5f0d30b0736e',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '29f6476d0d75aa0aebeb2ecaa60892afe36ef640',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
  'cros_components_revision': 'ee11efc3bd18089649593a6d1009660cc84879fa',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/clank': {
    ...
    'e111709576d38ecbff2e3c7a2112a90d0d67be66',
    'condition': 'checkout_android and checkout_src_internal',
  },

  'src/docs/website': {
    'url': Var('chromium_git') + '/website.git' + '@' + '25b67e9615ab41bbdad5f644ab2aee99f1bdc74a',
  },
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': 'https://chrome-internal.googlesource.com/devtools/devtools-internal.git' + '@' + '27c2954e886c939efcafbfa59ffc7bd5340a8158',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '725274a6285d521fe2c6569d8421c04ebf83e9d0',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@bd5634fbaca7cf38a3a676a8005734a04d4a89ff',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@df23583af7874f2c7af84671dd591fa813d41ced',
    'condition': 'checkout_src_internal',
  },
