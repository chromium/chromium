...
vars = {
  ...
  'src_internal_revision': 'd2728fa513a5f83d55ad7ea714b727d3dfe2c838',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '895e6cbda81570c2bb68ab1780c06f19fecfbaad',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': '2e167e092239c3e6f5357383db405e60e3b23ffa',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '90ab67177fd6ba4d88835eab8fec35a3e707b5af',
