...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': 'f19d0a67366545eab90ccaf7262cb2db58580495',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': 'b1872400b71460f28f242bd0f6f422587796800b',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '7e74f2bc3fc3dd610cfb5793761b16c0e4355b8f',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@2af0355a1ae4c08d98e57a97b4ee992d156b8a63',
    'condition': 'checkout_src_internal',
  },
