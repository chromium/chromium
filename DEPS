...
vars = {
  ...
  'skia_revision': '47cf526becc965bb80204fc3dbba65dca14ae0da',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'angle_revision': '01be7a8340df71a99a7c43b9765db1a0f54a0e6d',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@4d8fbac264b404ab6649aec066fc6ba13445d0d2',
    'condition': 'checkout_src_internal',
  },
