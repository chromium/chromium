...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '506379e55f830a0ace015d5e32aecd2fe24520c8',
  # Three lines of non-changing comments so that
      ...
      'packages': [
          {
              ...
              'version': 'P10bBgGOYn7CA_NXERK0dZOyaLPyRP5v3VfEmWtgxxsC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'i2ODZeZeU19IQ44rQtF5RCvjrm-1ogspb_JKLFY5CswC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'nJunQgH6NnRRKESNQs08yjo35LFrfpVGGM08-Vu3_8gC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
