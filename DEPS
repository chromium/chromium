...
vars = {
  ...
  'skia_revision': '3f903200b30a62e9f8bd2ff6909d2e534c9a044d',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@8cf71f63cf3d4a8751b9ac2d2728d6a6e0c0ad08',
