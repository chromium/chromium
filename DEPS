...
vars = {
  ...
  'skia_revision': 'fcb72b857ae1336680d2c4c1d04b5e07d1485b13',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'refs/heads/chromium/5715',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': 'refs/heads/chromium/5715',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'pdfium_revision': 'refs/heads/chromium/5715',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'cf223582486f7d0917ce49cb5b4255e7a44ece5b',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': 'refs/heads/chromium/5715',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'refs/heads/chromium/5715',
    'condition': 'checkout_src_internal',
  },
 ...
 'version': Var('siso_version'),
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '0eaad46a44e9ff88f034a199a7de1e814607cf3e',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@refs/heads/chromium/5715',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'refs/branch-heads/5715',
  ...
  'src-internal': {
    'url': Var('chrome_git') + '/chrome/src-internal.git@refs/heads/chromium/5715',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/libassistant': {
      'url': Var('chrome_git') + '/chrome/libassistant.git' + '@' + 'refs/heads/chromium/5715',
      'condition': 'checkout_src_internal and checkout_chromeos',
  },
}
