...
vars = {
  ...
  'src_internal_revision': 'b09e8d036b50c30dee10d4770d1da712ce98ddb4',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling Skia
  # and whatever else without interference from each other.
  'skia_revision': '6d438894c2a825440122c9935fc673fc541454df',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'd1e6c48b120ded1718c747f0c921ef7ed56d4bfd',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '6c167de91dd10b540e67d391a72a485a1de8be27',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'dfd36fdbd0bff0111082813feacb535bf1780862',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@c26d5d13405473ed45b29e56a9779b3fc1ce4ce5',
  ...
  'src/third_party/vulkan-validation-layers/src': '{chromium_git}/external/github.com/KhronosGroup/Vulkan-ValidationLayers@876d576195b6afbe470a207252cd402d603e2775',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'a6154a452353cb984c6ce0af010036dbb7659e6b',
