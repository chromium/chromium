...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'cd7f1f85c0efb4877e0ad0a802f460877678eb07',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '899eb1772eca02057f820f5ad80f3fe52a894849',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
  ...
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
  'cros_components_revision': 'fad3dabf208b8271b754ee9f9083dabfde29e7b9',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/clank': {
    ...
    'ddbb09e298421ef1916fb5f2fdf8dd41b84a5522',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '08d09b333480eab1333b88b2b8cd713bfc57af12',
    'condition': 'checkout_src_internal',
  },
    ...
    'packages': [
      {
        ...
        'version': 'hXjzr3WPIKtMvR8hzZvQs9vGGM97mx3Xw3RTqJytkY4C',
      },
    ],
    'condition': 'checkout_chromeos and checkout_src_internal',
    'dep_type': 'cipd',
