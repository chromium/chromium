...
vars = {
  ...
  'skia_revision': '78849da620b1e62cfca77470498ebb5b88ef6360',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@ae17d1717a936192e13f73cbba09e85bd02b3766',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'b96902d33c08a5f36eea6b85a75084590bdc4dc4',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@24dec84ddc9aca48fb804cfa59466edf6c8c9a6f',
    'condition': 'checkout_src_internal',
  },
