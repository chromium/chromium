...
vars = {
  ...
  'skia_revision': '64fc64c9483f723dde62f077ed6a91585ec26659',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '111d7e5e4378a0ec01c1846a68f8f881847b469b',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@96657655f644da8019ff4a03a7060680ef6b8e92',
