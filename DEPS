...
vars = {
  ...
  'src_internal_revision': '3ecb9d8279f2a31535d956df47d57cb6240dcf33',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'angle_revision': '53f2bebeea2d12837581b62a09c261606de4962a',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'boringssl_revision': 'ca566612b7e0373108d2bc19c04e8d6a09fa29b7',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '2f72f40f43908229513d2f4f003bf107fcf867b9',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + 'e4ab274cfbd1aff6fd34f402322ec54acbfb838b',
