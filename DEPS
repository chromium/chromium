...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '17da96eb5a1f5db470de4488b780d6c07056d8cf',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'angle_revision': '35a83e20afe2ab312852e000ad5d8871c16bf86c',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'd1e47c942d65714bc84c35480d6f44ca4c2f58a6',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'fdd8e9cadc025f732012dc8348b50de7478e9e21',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@23b4c102d4d255efccd1024369e7bdc057fa6a8a',
    'condition': 'checkout_src_internal',
  },
