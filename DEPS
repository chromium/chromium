...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'D9t8nMKqI_5W9X9v0VXRDfYI5Q4Ga7gGcWKvt_i8inkC'
          },
      ],
      'condition': 'host_os == "linux" and checkout_fuchsia',
      'dep_type': 'cipd',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@f076894a7445b7f0dc3bfc976d7016817a5c48fa',
    'condition': 'checkout_src_internal',
  },
