...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '3b7f4b51de583a5dda769397b757ab76535e0bc5',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'boringssl_revision': '8eb9a8e7e78b26fd11ad16b38d1a30d0fd5c77f0',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'e7d0af304997047baf83a5b5b8c6617d1db8833f',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + 'fc30a4a3fe06dbad47b6d24a81b0106025fcf034',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'c96b50b74931690876578e7356839af416d119c4',
