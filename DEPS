...
vars = {
  ...
  # and whatever else without interference from each other.
  'boringssl_revision': '5199c7adec3e3f3876a1b84cba909904e2ff48db',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'llvm_libc_revision':    '62a96d261ba7701c61ab979dd82a08c0eecd5487',
...
deps = {
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '67ddd5efb7d5a072a886d3de708563ab994305a2',
