...
vars = {
  ...
  # and whatever else without interference from each other.
  'crossbench_revision': 'c59710627c648cd09631973aa24ef66b1692b6b5',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '1e47fd2a6319ee886b50ef3d1346e53c281560f9',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + '375989a5b6a682028d0425bccfb93257407d37f3',
