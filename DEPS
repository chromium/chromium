...
vars = {
  ...
  'src_internal_revision': 'baef2fc57e37877bc90a384625ce0b7704e4288a',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'c6cc8b5e8481ddff311735affb5684aef45e7edc',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + '5edd379b152e5477805eaff3c4b6eeaa79126713',
