...
vars = {
  ...
  'skia_revision': 'e1d8daa27daa7304bf3ea1e73a908d0d1a7bf20c',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'c7719514c4a5674613627a78ea2b2f5cc3b15b4d',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@6c79eeaf104c8cef93cee4b49f9e04f86f776c07',
    'condition': 'checkout_src_internal',
  },
