...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'a7a998af693348c1285fa5e69a86bf66de9e943b',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': 'afd1f446866eac9bcef5df4f65e6ee2ee0f880b1',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '9b4d93d9a97c20f162c79151079bca66e504c261',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'HP3jL-eHf_kBFzOYcSOQANpU0gVA79VOuQiKd6S7qvkC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'wdQGP5X_RqUM9FJBXfRaajOXeRDDMa_KqQ4k6JI4QbwC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/clank': {
    ...
    'd91a323795641b002b0678cc7ae0dbf62dd0917b',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + '212fafd3c4fea7c4a722d2adb7d74bc21157706b',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@bb2eb8f1bf19553bb35e2206dba48393b8fb0481',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '278dbb7312e1e236a339015047d6beffcccba13d',
