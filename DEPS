...
vars = {
  ...
  'skia_revision': 'be5c9ccbbce25086f39e9b33921cba2fd2ad846b',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '0c0c602653d22281705c0bd61cbab5a8c9429462',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@69aa108cf92416852eef1c544c571dafb427f459',
    'condition': 'checkout_src_internal',
  },
