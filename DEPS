...
vars = {
  ...
  # and whatever else without interference from each other.
  'crossbench_revision': '7c8da6754334a034e3bac784f005a3e36e1aeb39',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '406149a12d42c9d19efb910f8317f46c298dc12e',
  # Three lines of non-changing comments so that
...
deps = {
    ...
    'packages': [
      {
          ...
          'version': 'QngR_WXgWfE_nKxhN-9JQVNyIF9q1KAJp8boXgSM1n4C',
      },
    ],
    'condition': 'checkout_android and non_git_source',
    'dep_type': 'cipd',
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '955f325828f98d0a60ced060ed3e7674735126ad',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '762faa79fc2e76f688351366d5c4296ef0c128d6',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '8101db96a94781f9129dba0fbf77f7c5a47b72e8',
