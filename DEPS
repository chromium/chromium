...
vars = {
  ...
  'skia_revision': '14673e98267277ce8ce8bc2ee325783f6692990e',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'fa157379d69f3e5d8965a21b72d99bf1b77fa4da',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
  'cros_components_revision': '16c6ec06e01d6a44dbfd33f6286a26762232d2aa',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/clank': {
    ...
    '8e5ced1598a06d162190f01b0846a0fbb771fe86',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': 'https://chrome-internal.googlesource.com/devtools/devtools-internal.git' + '@' + 'e575f298845fdf41ebcc57d006ae5ec659badd81',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + 'bddab2f0f589eae7a70f8b5a6efa06fd6219bcab',
