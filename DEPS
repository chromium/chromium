...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '54336e489c4359ec17ddd241b4a96d35333ff1aa',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'd7118801b8f82efc6dfd93c06c2fcfb6f99bb7c3',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': 'https://chrome-internal.googlesource.com/devtools/devtools-internal.git' + '@' + 'b63cdfa9dd7f211c614aee87680346734412abf0',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '6aba07e5fe553610471d5026d09ffba82a22b61b',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@38032932b234635d7134bce4cd9d53bd2b1c3c23',
    'condition': 'checkout_src_internal',
  },
