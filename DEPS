...
vars = {
  ...
  # and whatever else without interference from each other.
  'nacl_revision': '7ccd070716e66e3a580821620477637b90b641e5',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'catapult_revision': 'd0f9d5b5acb5b3f7bd96e060cb6a835a64dd619c',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '288e51c0eef9081143cbdb9052376651268d8f02',
