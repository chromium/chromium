...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': 'ed04513c0bca5c699a17aad09f91f8bec69da329',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/clank': {
    ...
    'c89beeb8a8ec77906e90c02f98fb064ba5a27dbf',
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + 'ea5d49a7812bb7a263dbc38073067d18068c73d6',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + '7ea82a62297366babf22b966562328a05599f4e7',
