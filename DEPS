...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': '4b6a5a84b57708617df929286ee5165fdf53c019',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '744ca3ed9ea4f0d397864f35a7decec1d5604ac4',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'fTiK_JJGDEL2HQZDifTfx4SBsLSYHloKKo3ydWFMSuIC'
          },
      ],
      'condition': 'host_os == "linux" and checkout_fuchsia',
      'dep_type': 'cipd',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'e6aa6a874093c40ef423ac06c66424a73f3aee1e',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@37aebb7390363708f891666f3be7b61ae2b28d1b',
    'condition': 'checkout_src_internal',
  },
