...
vars = {
  ...
  'src_internal_revision': '05314194263c9714bb289c07a698bc8e6687502a',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling Skia
  # and whatever else without interference from each other.
  'skia_revision': 'cb1329a7ab0fa07ff2d9e85a51af8578a1db0e9a',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '1a62acb10d4379fef75f30d7e903ac316d0e358c',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'ee1f7b6629aaa34bfb694c76754f014021989fa6',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': 'https://chrome-internal.googlesource.com/devtools/devtools-internal.git' + '@' + '72e87b956ca97f40b132deb3cedfd789514989aa',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/libvpx/source/libvpx':
    Var('chromium_git') + '/webm/libvpx.git' + '@' +  '91ba9ad08a45e2bd1e0f34658dd4d3fd101b047b',

  'src/third_party/libwebm/source':
    Var('chromium_git') + '/webm/libwebm.git' + '@' + 'e4fbea0c9751ae8aa86629b197a28d8276a2b0da',

  'src/third_party/libwebp/src':
    Var('chromium_git') + '/webm/libwebp.git' + '@' +  '0aba549eb6c7e26a02d1f130d3c3f2b95b376a57',
