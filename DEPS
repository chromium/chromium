...
vars = {
  ...
  'skia_revision': '03b2e3aeee6686f0237601dbdc5ace3b03b1b51c',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/ios/third_party/earl_grey2/src': {
      'url': Var('chromium_git') + '/external/github.com/google/EarlGrey.git' + '@' + 'b26a58bcd2c283c9bfc92272282a5c728f420d32',
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '8254f06ba7acdb16e8aa5fa856462e4cc6eeca47',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '01ed32589ef2bd9e19a320dcb18f171cea999e57',
