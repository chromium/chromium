...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'ebebd5834bda257946f4d622c512467f70cf199c',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '8f25690d549dc36de644b5c8acf67b8d67890259',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@dfbb212ff221a39d4d7790ee2d1c4352174e9055',
    'condition': 'checkout_src_internal',
  },
