...
vars = {
  ...
  'src_internal_revision': '7f188909167ef6d13887dfdef7925039a90c6d1d',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '898fd09f05d84953d8a7ca161216f54f63525cc0',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'ba162af0fdb384c7134c14a71155a82980348281',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'b42af16790c039d2607f4a5d698ae77a1724f8d0',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/components/optimization_guide/internal': {
      'url': Var('chrome_git') + '/chrome/components/optimization_guide.git' + '@' +
        'db3e0657d08c9b4bacedddff0ddd2a08bf5453c2',
      'condition': 'checkout_src_internal',
  },
