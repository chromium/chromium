...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': '81db1a4694d9de183422423b3d1de3b1dd17391b',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '4a360d7688c9b17b440db7e3373a746513aa67c2',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
  'dawn_revision': 'fa725baf17fb74e6feeffe399d53a7e4e0fa8ca6',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@c82edf73b9465ce46a560eb1b272f3776e927fcf',
    'condition': 'checkout_src_internal',
  },
