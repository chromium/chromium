...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': 'f44561727b9c70d39f0275847469c082386bc7a8',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '9fe625fb100260ed8584fc6d220e32bacb7531d4',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'zeoncNG09Bm08Kd91NAEAg0UzGVVITMyF3kRwkQnTkoC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'Yp_V_dD3Y5CIibreVg0CCqyiGmB1mrNfXNHWjO2uANIC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/clank': {
    ...
    'c3d76900cea21caccbeb121fd03bcbeff5a9e94c',
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '11b0e6b80543472bfc88eaeae478744f317a0d32',
  ...
  'src/third_party/openscreen/src':
    Var('chromium_git') + '/openscreen' + '@' + '2fc2a2e620a5eb6536aa237c9c6628d3db5f3ae7',
