...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '886a0ff2fa239a3ef547306feed68664a2342e54',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'catapult_revision': '75329f416dcc00edd629b31be1735639087a7788',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '759ba989296e146de1ecff505e74129c13735b89',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '0817380a56a627c8ea24d5dedcab5708f64bc27a',
