...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'mrIL-_s0jJORBxBvaKo-UVub4OhnsUtJfZYvpoZLlRcC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'vO-f6fc_6zP1mrFqCxQOkEzXTUxqQgmyi61j5HNjsnYC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '1822467bec1c91b8d782e9c7f24342d1d65f01f2',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'af1102a326ecd31e284233b2e84fd99c44e81dd0',
