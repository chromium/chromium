...
vars = {
  ...
  # and whatever else without interference from each other.
  'crossbench_revision': '58f66c5774317fff52586dc0bed66959207e1b9d',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'e82e9e46965d9996069388faef5d0114c804ac11',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '472ff40de2ae6dee96737da172654fcbe5ece03a',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'b56dbd785cb7a6ae11c5d4781ed4c7099ba96e5b',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '60cb2a20ebf3830d1c9b6d076ae5865cbc2b64ad',
