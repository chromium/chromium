...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'ca94d1da85979c910be4c185f97f1f1406534634',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '24a9cfc3d4439e8a881b408bf405ef5d88b4cfe1',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
  'dawn_revision': 'fac169113df7dad1b55092ab099eabb25e723719',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + 'ccaf6dbd5c6e94ab46ed9473033bb380c93e5063',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@8978b61a6b13ab6e2aefed9a47f9427f85398eca',
