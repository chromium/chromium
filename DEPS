...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': 'f7528051b26ebd074f5695e7c412e1fc30f514c6',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@da25871cf90070c4df68c5424b9a08e8c9e2505d',
    'condition': 'checkout_src_internal',
  },
