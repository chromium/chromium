...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'c36fb74b276bd1ff8adc1e108942f4977f5b8c10',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'crossbench_revision': 'c3b12670cf543e0c4464c4ca719112b475349291',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'aeedc937438be962cb29502380d260aaf84e8da8',
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + 'efbdae379df328fd49a234caa790e3bd66b310bd',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '3cd42ef2ec0879c88aedb6b1e867b69b09b3602b',
