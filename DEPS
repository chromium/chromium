...
vars = {
  ...
  'src_internal_revision': '8adc1fc81fcaeffc7d52ba1715484c34eb648fcb',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'angle_revision': '71f8079e12be1e4a07ee51dc9809194c223c9304',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': 'c43a057fa6ae9b124362d25471650d214a4bb6f6',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': '1VWgBb-0rrjffc6o3wpX9TxNwR8I6PiW6UK3_GUXeCgC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'KidRqOQIpa4Hkk-0rKQwAn8OO4M5lYLOtTydNsasyzkC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@762b6fbf06c4f9397a9d580b932e806cfade5f75',
  ...
  'src/third_party/vulkan-validation-layers/src': '{chromium_git}/external/github.com/KhronosGroup/Vulkan-ValidationLayers@a4cf40ca1fd954635f9ef967dfc22856463a6b8f',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/components/optimization_guide/internal': {
      'url': Var('chrome_git') + '/chrome/components/optimization_guide.git' + '@' +
        'eb159a7fabeeb632d2d2d672c7a1c251114c47d6',
      'condition': 'checkout_src_internal',
  },
