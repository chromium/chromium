...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'dfda9179824d588ac8794997179dbca6b040ea6a',
  # Three lines of non-changing comments so that
      ...
      'packages': [
          {
              ...
              'version': 'PyzUPoB-89_OAYMy4kUo4w5i4VzyM47h7sTOgEdMWzQC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'Ud8GOYf3i_bz3a3ClnnYlWt9cm1tE4UJfFp0jnzkyv4C',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'FXgbRfM5T6BgWeG7VN20zYuYpbOPRqbiEooQNwJLuLgC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '79123e3da55b76ce5cdff651b34c2c2fbad83787',
