...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'TEp3mnDG_01X38NoHzvFdHbH5r4qCJlSTI-_9Q_OObgC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'OQ7ez-SvHZqeaLOt2ILF2BG8jFNM4gUrXuBDOaoA8tEC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@3976fc3e92454a5a34a32fa1660caef0c361a32e',
  ...
  'src/third_party/vulkan-validation-layers/src': '{chromium_git}/external/github.com/KhronosGroup/Vulkan-ValidationLayers@344e3116f371cd7db994dd0678f9c49ca4622663',
