...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': '84613b972d5df8b37d1ecf65b4660830a988c861',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '2fa2c1c4b72511b5097b3534b197586f39ad003e',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'a5778281f28ebda491a5d42e2861024619b4d04d',
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '3b8d270b5def5696dadbee86c1d57e77ec87a099',

  'src/third_party/devtools-frontend/src':
    Var('chromium_git') + '/devtools/devtools-frontend' + '@' + Var('devtools_frontend_revision'),

  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'cc34ce4da3658babbe90bb4ab47130c0822a6094',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/openscreen/src':
    Var('chromium_git') + '/openscreen' + '@' + '6633e85336ea17f21a11a0076046a144ed824f86',
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '17624a369fe8fa1f635be5fabbfd69053be8cefe',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'c5318e3dbeb0a0af2821c20161dc9edec3c55024',
  ...
  'src/components/optimization_guide/internal': {
      'url': Var('chrome_git') + '/chrome/components/optimization_guide.git' + '@' +
        'ad0854b1e928db461ac0783fe88dbd10d4512b1d',
      'condition': 'checkout_src_internal',
  },
