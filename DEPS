...
vars = {
  ...
  'skia_revision': '0f5bc280a0f563afe11a927d3db1d60c4eb3dc38',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'eea12ef36e8b580b8667289dff78764af7019b45',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': '5f0badf4541ba52659c937cfe9190d3735a76c10',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@60d94c86b01eaa41fc767f60a85e847b302e37b2',
    'condition': 'checkout_src_internal',
  },
