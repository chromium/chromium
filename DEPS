...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '934f90af7826d6ad3fed86cd5801fff68560bfd8',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': '4f_aRTD9wR6DvFjEfoGuQDsacFu1WAuQ6U72AdgME8oC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': '3Z3rcW9P6705QccMT2hkuGF0nz6xCmkAqMCdJOzEEy8C',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/clank': {
    ...
    'deeb02b7cab6a407396a2ec6d93cf42d3857e389',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'ac4db2b98c8a588e5450ac82e1aebdd65b0581ec',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '99f50c46857c0362ca46f70879470e64c11bfd0a',
