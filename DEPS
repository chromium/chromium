...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': 'ac03ed7f3942591811c2966e4d2573694d46d5d8',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@4d7630e0bb5a5c1fc959115642ffa2cd4da06c2f',
    'condition': 'checkout_src_internal',
  },
