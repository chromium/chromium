...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': 'd7ff8abb545ad8160e189a7e8352c13c7b0e30b8',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '4fea78dcf0dbe0ec1d8b9e3eda87bd3c476ae254',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '88f712e012191691dd81932e5f694c4ac9b7244b',
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + 'a4edfc0db10b623d6fdf3281b358bc131bade994',
