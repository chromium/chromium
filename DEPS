...
vars = {
  ...
  # and whatever else without interference from each other.
  'freetype_revision': 'b93f20ab7ad610c986497243ca963ca79013411c',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling freetype
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': 'https://chrome-internal.googlesource.com/devtools/devtools-internal.git' + '@' + 'a617a371fe0a37c396b1b204cbecdfc29bd81490',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '4426c4709db5f8090d407b05e76563475c72049e',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@fa6be2bfaee7304c03af2691d6bb06b99dd4d968',
    'condition': 'checkout_src_internal',
  },
