...
vars = {
  ...
  # and whatever else without interference from each other.
  'catapult_revision': '986f4bb45c120aec31b57ffbeaaffe684d49b5b1',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '70dcfe26e2b8baea8194d61b661442ee3e0cd876',
      ...
      'packages': [
          {
              ...
              'version': 'h4sc_fgXqeXSq8iTRy-MdVWZug9JjNurHj3qavM4pCwC'
          },
      ],
      'condition': 'host_os == "linux" and checkout_fuchsia',
      'dep_type': 'cipd',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@202d1abed505c85d16061741c9999af5aceec34e',
    'condition': 'checkout_src_internal',
  },
