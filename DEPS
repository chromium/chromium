...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '608df59149e14b2f5bf8c32680200be3928f3064',
  # Three lines of non-changing comments so that
      ...
      'packages': [
          {
              ...
              'version': 'cICF-L7bEy8ciGx9cwsGQJaWxC-jgCfczo99OkWyWgAC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'NL7RvSL06HTpabYflIJQ012yDQCoZwJUlFsvb_towv0C',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': '8keyMUBeA1vPc_9fu7wG0UzHZM2drg0bqqOyfl6W1UsC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
