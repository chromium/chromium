...
vars = {
  "buildspec_platforms": "mac64, win, win64, linux64",
  ...
  # and whatever else without interference from each other.
  'v8_revision': 'b4a7494bd7a21f7af772f42499777bca544fbea7',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@5e298117b4e201397aad203a4191857cd45b2111',
