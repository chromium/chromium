...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '8ce8a54a1f242765747a3153152ebed37fb4db5d',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '45c664c483794c16f851b7ad3e6481532e7e3a1a',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + 'e072dd8fa7263f47b46217fe3bf5f19570e5d1eb',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '0e586a8dbc3935022e73665155c23a424325b24e',
