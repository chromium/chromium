      ...
      'packages': [
          {
              ...
              'version': 'Yi_ctfvJ6wx_6wcNETSkaGRaZfK3fKLVpKQb75WLqNkC',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'QFhAHt2_h_BxqS13_p36IXvEWqhd8HHV7sMPX2f82jgC',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'IrIzI-NIZT8SxFFtSUh_Dtev-nBNP_1Cf8zhktP2efkC',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'c90dd459403a0a029985e7e30484de013bfa4763',
