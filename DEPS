...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'b18b0b0234aa8fcc0bd133670979fe058d599b5a',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '11e9216d823a95aaf2cc23c1045c4dc6dc0bf678',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'e53f5dcbe180f2738c60d2bb10d6e47b8f72f9aa',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '50c6a66ba0210152ec5a51d66bb3209094de2aa9',
