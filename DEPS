...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': 'f44dbc40d81e6b780465c63a811b12c1143953ef',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '33672fc941408b7292811e4dbefaa775aea1e899',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': '2bf945775fe634eb9e420c2263dae6043bbb5ece',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'b1c698c4e6cc796046c6aa9767b6899ab9ce7729',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'ef5ca53fa3b8ab99b0a39cfd340e511bb8738c4d',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'e756ef85dd577760ea4d1bfc13c0c97b78f0ffc2',
