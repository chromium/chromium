...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '621ed5035df0daaf3e06c93e0ba0a6ee3a57cdb1',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/icu':
    Var('chromium_git') + '/chromium/deps/icu.git' + '@' + 'e5b846b51fc6dd47e87b6e53b57a9a1dbf0e2c15',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '31764096a5a2c8ef776841fab11828133ae3803a',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@0caca05bff80f52e700f67094ff4e921b31dc3f3',
    'condition': 'checkout_src_internal',
  },
