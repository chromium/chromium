...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '33a1c4f3e06782f4c14330d22d05dbb931f5a454',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'boringssl_revision': 'd671f42fa565a7f2dd2d01dc47376f182687b1d2',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '08b4d1d95f09533c48800adc4192451eb0fc73b1',
    ...
    'packages': [
      {
          ...
          'version': 'zEEgyqXVaDxv1rK77cQK2nPtG3VC6D5JHtJ26TA_JIQC',
      },
    ],
    'condition': 'checkout_android and non_git_source',
    'dep_type': 'cipd',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + 'c11e98f36b43bfe116950af0e00433cc36c37d50',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '777159a37aea750db75ad49ec294a434b7c292fc',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
    ...
    'packages': [
      {
        ...
        'version': 'IwWa74LO0_tgrmbmHvfGTv-NMb7fwJXhGC13ofDfrq0C',
      },
    ],
    'condition': 'checkout_chromeos and checkout_src_internal',
    'dep_type': 'cipd',
    ...
    'packages': [
      {
        ...
        'version': '4ttzZqHHydwYp3HZ8ThEy2UXvTr3aJfFYt5-kLu3eO8C',
      },
    ],
    'condition': 'checkout_chromeos and checkout_src_internal',
    'dep_type': 'cipd',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'afb3305b08e324c2b0f4ac2a52d48803a6d350de',
