...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '93690c525a10acbc0f1617a03c0c766af02736d0',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '0a0ced5701b3e3f0acd76f48edcc033dbc7cdd6b',
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + 'adfd994f983aa9cb9906816aaabf538ca6a7f547',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '0fce186c0a0f3a442e4fcc4ef76225e9e08d54ed',
