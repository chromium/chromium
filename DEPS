...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '27012a456186ec8c35584d2e355d52296a8e45cb',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'faabeadc1390f00e807548859d20ad99e6ec9eb2',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'BD2npgA_dqsPXYvaZ5ROu6EHUkb0EBO6Yzq-yQnxbdcC',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@9e258c5a2a0e65fd0e76d59886bc0e59eed9adff',
