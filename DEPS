...
vars = {
  ...
  'src_internal_revision': 'a9c0cdd14758e4f95f22f0ca882d1841e0f9bcf6',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'aac38c51452dc8b39b9306edd189351b86294c8e',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': 'd4d891d2c248fa9b5a24479eb6caa411fd7e49dc',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/clank': {
    ...
    '65620bc69c5ca6055938fd71eaed7ef693130d69',
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + 'a3b24ea910f2df988a1849b1860d849457882071',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '764ac7ec0a3f3149b7b7c6a590dfb2a8dc05f495',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'f7c2b69116ebdb677cf2e4cc1cafb08ced8bbd4d',
