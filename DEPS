...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': '63a2848a126482712e6efff800b9937ecfb2ff83',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': 'https://chrome-internal.googlesource.com/devtools/devtools-internal.git' + '@' + '240d34a9f8d65228562974e1cc3ea41dd2f50f2f',
    'condition': 'checkout_src_internal',
  },
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@50a9a1d6e2864f07b6a3af584a16500946ad5806',
    'condition': 'checkout_src_internal',
  },
