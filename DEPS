...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': 'c11907e1d0b610db9d8acedd321356bdf6906201',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': 'bf5a007afc1f5c96e48ae2bfea925bfe157bf7bd',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'catapult_revision': '0726e80456d58b0bc63db40087e12b1b54284791',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '48181438f32065679c5ed2895dff2a1928c103e9',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': 'https://chrome-internal.googlesource.com/devtools/devtools-internal.git' + '@' + 'cb751cd1a25ee75c4abd5abd793cd7011bc5e50a',
    'condition': 'checkout_src_internal',
  },
