...
vars = {
  ...
  'src_internal_revision': 'bb9e5894cd1f525aa295aaf731cb885fc4e76c4a',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '26704111e3f64453a306e7fea27a58a55e7a45e1',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'b75201427fcd1f2594a7facb5c3bd7fe32a96ce3',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '402f60c2eabefbc7a120ec01659690c7fdf89769',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'ef433b689a25594064a04954d2f311befbbd817c',
