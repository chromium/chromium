...
vars = {
  ...
  'src_internal_revision': '4498684cb166c925cf3f959facbaef089a735549',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling Skia
  # and whatever else without interference from each other.
  'skia_revision': '1b5d2171f74cb88d877d818c207daf6041d5d0a6',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '4f282ae4acae85cdcc8c167cbc296a86d24c1cf6',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '2cf603f49d30a4dcc7c91ec241b5d399c239a07b',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '046650f75938d2d90b3ed89f1e881956e31a43d0',
