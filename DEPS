...
vars = {
  ...
  'src_internal_revision': '60f2276d5266d6c1a86a4ca2c15e33afc4337818',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling Skia
  # and whatever else without interference from each other.
  'skia_revision': '51b1b17355c5559e88940e5f79f84f64aefa937c',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'a8a50370e695c8a2a62d2cb307dbd029cdd7d76f',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': '0d7d6130d89f19f66b5d5a8c08af820e6e48796b',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'a9e2de00d5671369ced00f7e27e5bd42c433db93',
    'condition': 'checkout_src_internal',
  },
