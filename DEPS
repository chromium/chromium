      ...
      'packages': [
          {
              ...
              'version': 'k_l6eWquQYMKkZWibAr6KEkm2bUGSdUEBRqMXR6HRqEC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'reilIE_EIz0rPLbjO-1VwOdtdRF4omBFvnRCITNRS0AC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'V12kuIMDTCLvClvAzANJSEyezb-lkx2Fl5PYhDuobN8C',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
