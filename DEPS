...
deps = {
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'dc7839ebd33d4b7e942f411fbc8e8472db9b7cd7',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '48a584243be66d507e8a60eadcf62b8a3c263753',
  ...
  'src/components/optimization_guide/internal': {
      'url': Var('chrome_git') + '/chrome/components/optimization_guide.git' + '@' +
        'acb946a450bc0cf856617118720b6f2bc42d48c0',
      'condition': 'checkout_src_internal',
  },
