...
vars = {
  ...
  'src_internal_revision': '574049fa9b542400f5bdc7eef2c86c3930ddafeb',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '88b222ccdf079923c703302408c4ed9f20e9e6db',
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + 'b6c9900a175a7ed54a7b2f5dd47719a73f14989c',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@bf2b4e8ba30eaa8e30a0f23e822a1eaec407fb63',
