...
vars = {
  ...
  'src_internal_revision': '56aa3238e407cbe9adcf465ad1b268bd15b30f03',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'fd423864c1635c4eb19305d9e7d320cb8a457a89',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + 'bd72f29183b6897c6d092985256fe4ba309ecdce',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'c1436d3676d2117357565eea2e3c09d50250c98e',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '7ac93a84e3d0c5497e6fd80eda874f3e9e32a4fb',
