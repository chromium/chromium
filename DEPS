...
vars = {
  ...
  # and whatever else without interference from each other.
  'crossbench_revision': '3a7836d3480c0c32bbd757ca81028d24e3f996c3',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'dfe9ded02144468fc69ddde4f4305402e70af1e4',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '2fab75eae297d3311c418f80daf5bae503c6c3c3',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'ccbf599804f4580d126ef29170427ec818097690',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '452c876b47ab5937a6997594d333ec7238fa7444',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '3ee2161cc950d25107c290e6a84282e5b1240a29',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'f741328451ef75d257a7b7b74e3d8d2e6e9fc806',
