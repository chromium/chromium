...
vars = {
  ...
  'skia_revision': '775b4b55e59a6fa2d935711db7c5bad2409c819e',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'f4f3dea444e640b02b80d1e81ce096b224f9177a',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': 'https://chrome-internal.googlesource.com/devtools/devtools-internal.git' + '@' + 'bf020f399dae594a55f9bb34090c5a844c3e38e5',
    'condition': 'checkout_src_internal',
  },
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@231de142285601d1fcb6de5b2ff07a75689dc8b2',
    'condition': 'checkout_src_internal',
  },
