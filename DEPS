...
vars = {
  ...
  'src_internal_revision': 'e79413180afeec42f558966bda467b41f8fe4868',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '0d4b98179095810e69b7db4670745014af6f2f3f',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '41d4bdf93cbc8783699cc6f9d6a1b04fa056b662',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/clank': {
    ...
    '9e9710b1d43519acd2e320866f951cff4717f127',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'eda553e21f40f705301d52645bc597646bcac5d5',
