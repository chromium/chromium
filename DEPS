...
vars = {
  ...
  'src_internal_revision': 'c9abe897da1efecb78ad3207f7c1493b3a33b1f0',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling Skia
  # and whatever else without interference from each other.
  'skia_revision': '1d458db1cd0d4739c4e15977113b769296342d85',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'b06c71dbd0682aac0fb6978f76dd6425f9fa040e',
  # Three lines of non-changing comments so that
      ...
      'packages': [
          {
              ...
              'version': 'lCZRDT6RtPm0bURwzPcnvYyJrnJKTrfK15ZDyzDYZ10C',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
