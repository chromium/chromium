...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': 'de42a0c4337ba478efff9e601fbefac91d0a3df4',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'ff733299dd82fe87b3ccc3890143bb1e700c4148',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'ef7f6c33179ec1ffc2c49b3950cbdd0308432644',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + '1c412442bfcc90ed8f6ab0f844e10a91458fdafe',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@204af683d1612e48dbd2f73813191f365664b1e4',
  ...
  'src/third_party/vulkan-validation-layers/src': '{chromium_git}/external/github.com/KhronosGroup/Vulkan-ValidationLayers@794586c13f41294eb5d64cbf884eb8be6cc0464b',
