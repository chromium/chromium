...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '113810dcadad0d7a07ac95a07ee119a88e2d2003',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '4352accbae8cd23ac265fdf9bbd7674aa78b397d',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '5f7fdd424e8afad1e90fc283a740dea99447e58c',
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '5370bad242c8c0f0bb8f342e13542844401584ca',
