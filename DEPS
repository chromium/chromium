...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': '949bb97ac07572f7f8ae44e38541cc6e8ca95f93',
  # Three lines of non-changing comments so that
      ...
      'packages': [
          {
              ...
              'version': 'TDocO170bYlupjR_kWeIorvQRZI-75caDiKH-fpS-WIC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'QJnA4rgR96quihKC39fuLc5SJtGZZ-a3vBDAUswlq3oC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '0316eff2793b7211efa89242dd274c28e02bbe29',
