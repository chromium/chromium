...
vars = {
  ...
  'skia_revision': 'fd5bb8d130e214076873548146d3fe2cd681feaa',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'b266c856ec463ba7b8e33b8eb275ba20294a3023',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@fde2865b2f2178c3b3525ad4178f9c8cd556876e',
    'condition': 'checkout_src_internal',
  },
