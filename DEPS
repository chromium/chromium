...
vars = {
  ...
  'src_internal_revision': '931f80e5ff86909a1380de3a83b9d5b12a805cc5',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'ae33b59db8e2faf1817f04bd9d28301fa1c3f734',
  # Three lines of non-changing comments so that
      ...
      'packages': [
          {
              ...
              'version': 'SOMJyZLTnFCBsuQ6IooouSseG2r4-Gb-Zdz04g6HRjUC',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '48d6eccbfe30e38f35bf0cd44c02c711b7a7f8bf',
