...
vars = {
  ...
  'skia_revision': 'afc5ed58e2735c67a9c8cb7fcc266cb28b447c43',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '2ab914c6ab73ac0f85f633a5ce499cae74e7b75a',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@16bad7f9dea5cb8571e3a97569dbcc8cdb0b0279',
    'condition': 'checkout_src_internal',
  },
