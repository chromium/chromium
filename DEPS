...
vars = {
  ...
  'src_internal_revision': '3af30c6b0c14ae19873fabb816e86aeb1f09b7ae',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'dd212bae8d4271e2c3c9b38a513d1bfd28678ebe',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'fuzztest_revision': 'f959b01fdbc70b964545619f6e07521d2910f79c',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'CoMbAUmYlBzI8tLUdSq3OcSvYzQDD-6zfrSTqOSqEb4C',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/clank': {
    ...
    'e29211218eae7b5a1d7407dd06f5b4cdbd99504e',
