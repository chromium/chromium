...
vars = {
  ...
  'src_internal_revision': '127cf93169b43d9c054e82b330f4c6b3f889d7ad',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '27a614293297ea83723b67e0ff49c1df1b91331f',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'crossbench_revision': '7e973a8f8c73164c867ddb18495dc1fa381ddeb2',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling CrossBench
  # and whatever else without interference from each other.
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': '5rIe7CNWOmjpUMZY4zcAEXf9o1QJj28PIb5WDbLLFV4C',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/clank': {
    ...
    'b04aef86e69e03d3a057f157f4495b166b938b86',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + 'b5f42c8166dd436fffc5a43beeb22190126ee65a',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'ecaf12aa9a0406bfffbd62db5d11dc8dc2289225',
