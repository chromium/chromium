...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '2cf70a764bb5327593ad233897233b8b03eaa2cd',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'RK3Khbn4erL2FTWcqtEYlmvLpf8VRVN-ruIKK7kj7IIC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + 'cf730883467baf53c26506159524f978e6c65c83',
