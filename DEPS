...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '3dafd1404ce2d50cd13f569ee4afa47c65955b8d',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'i70GwCAcPbc7WgJv8BfmycY5uHFNYgrNJxlQmmcPxrIC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'qGy78mT8dWDyFeEWng27kTLEOs2QjOQghC-OFcmyzPQC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + 'd8c8618e68d93cc39cecdbe013eb0d3948b98089',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'a59fdd0c08d7353d290f89a56558218226c089f0',
