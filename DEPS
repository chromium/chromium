...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': '5f6be59356c8d3a0789044801e93849c1c3fc2c4',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '516123f515e344f483d6eea04d934cdf2accda79',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': 'cf1b10b81c4305dc9daca07422aad494f8351ef4',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/clank': {
    ...
    '9fe865b4cfc9783595f6a21df8b7dea93f8287bf',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '930b7605b9b4b69a09821fcfa9ffee308df6c5f2',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '1e504d56234551eebfe918a8999298183bb3d06c',
