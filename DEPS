...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': 'b7a1f4fdedc183a8ac3dc69026b668c74beed405',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'be1e039a9f90170c6d80c5e67178ced9617d1476',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'ed69aa26bf9b9616bc3b0fab94fe0e2b5f6f1925',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'd0c54e23713328ca58d57ca8b9b9ce1511e1f847',
    'condition': 'checkout_src_internal',
  },
