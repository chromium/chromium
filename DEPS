...
vars = {
  ...
  'skia_revision': 'd4bcb486efc50d6c19ce72440573013d0a023d80',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'ae2ff7972237c01243bcb0c3fdb40db3468cdcce',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'catapult_revision': '738798dc163a412436701a759f2b604ba1b20c86',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '41173656ed4342b64ea9a112cc184e47c93e1401',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
  'dawn_revision': 'b0143bcd4c78b687ea11a7c115673348f5709158',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/docs/website': {
    'url': Var('chromium_git') + '/website.git' + '@' + '8331c33abe579a01682202d6ea6f5fe8e2bd7a20',
  },
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '8ef7da78b37d2996fad57739c658d0fb00b16dab',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@fe73b89e971773a8afb01ed5d7d5f8d1ac55b8f7',
    'condition': 'checkout_src_internal',
  },
