...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': 'ac49c3b3fcadd39126fb35ece225ce7cba8c5602',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': '756d592df0ebda04b0608a6b05e5007ffa0e5e4b',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'ac608fe67027cbcd747f8b9a66324e4e19a3df5e',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '7d8273c587aef45b00f8755a9b27a2975cad6c5c',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'f7826f12c59bcb9e036f296eb634c13c66af0033',
  ...
  'src-internal': {
    'url': Var('chrome_git') + '/chrome/src-internal.git@e233f21a3149736fec69c79d125dbc7dcc069ce6',
    'condition': 'checkout_src_internal',
  },
