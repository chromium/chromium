      ...
      'packages': [
          {
              ...
              'version': 'DXSjV7IOtolna-TZe80rBMDEYsuIgC9TOYK0qcVBc6UC',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': '3rUKMQt44mOk2tpYOzJDb-a89ogxyZWPlFXM4NbYY3oC',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'oQG9BGxdYoNV07EAZjz43oicu3BKd8sQ3XaxVuyCxG4C',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'd08c7da8dcf4365e100d7347b35b89e53f10c8d7',
