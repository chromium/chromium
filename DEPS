...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': 'b359b3c360254c8669a5d0262bb2c24ac87b51fc',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '480eed8a9e22da7f55d1fccf99c3b066d86b181c',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@b14a5e3a4c0ca2e1a1793a2f8b5a1f5752d1d499',
    'condition': 'checkout_src_internal',
  },
