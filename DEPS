...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '6804c35f147093f6d43f8e08effdccfa3c37f2ae',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'angle_revision': '55c38e9f9ba358dd108adb804e6f4f8f1eb33068',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'zVqf0jBfF3pDji0mKSt4wklgjofF5PU0ZsaJpyGI4mEC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/clank': {
    ...
    'db89ab569a7e6454f5b57f21884946678c42ae27',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + '26fc4e948c98ece82967553c90e926a351aaa63e',
