...
deps = {
      ...
      'packages': [
          {
              ...
              'version': '5w9IZ8tDrsorwmuYJb3wWL5E5mc0Ho0aWI7xILg_plsC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': '09S5ONzHZBmcSEgVxoIlJKdWo8LelPxB7zAtBNUMj6oC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@e70441254a5fa7c34e3c4a7e648d6dade532dbcc',
