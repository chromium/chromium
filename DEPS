...
vars = {
  ...
  'skia_revision': '71df8c3ee28f31bfcfa53491ebfc3d6f6ad3ceca',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '618fa0fd3a7a476f4be9bc66306b076f425dcee5',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'a18881f8193e52447f71d9e03d2566dae1f02d0a',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'f9f044e73cae90e4b5eb690aacf1303b32a201a8',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + 'f56345bcd10e20c4d0735486368cbc157b4e05ca',
