...
vars = {
  ...
  'src_internal_revision': 'c1ab4476aade13143301badb70bdbcda696fe36b',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'catapult_revision': 'ffa25609002d081bc24a66d45eff2e184e63e030',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'a1c36583e4e9bf5085582a91954daa649051c643',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '5def9bae3d2b7831643656c7be8839043fad04a4',
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '8e30250504e47b2550b312a1f377a6f20f958113',

  'src/third_party/devtools-frontend/src':
    Var('chromium_git') + '/devtools/devtools-frontend' + '@' + Var('devtools_frontend_revision'),

  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '2922778a98ad96496e6df082a007c4df1886e13d',
    'condition': 'checkout_src_internal',
  },
