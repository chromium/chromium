...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': 'bc65426efb07baebfe0857da28530e505c597168',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '603520caea5f03503c714db78b2b8f136a253485',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '2d7afc383f81e3c6e86dbbdb173abe0aec7b5ba5',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '991810463a797d6e770127e604cdd3d8b8ff6e43',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/clank': {
    ...
    '7dd49cd43d2a258cd492f6fbcd8e7e57d3f045cd',
