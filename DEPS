...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '913053e9677210e33ec8e8683b652b57edae63b7',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + 'e94b3a3ebb90acca505072dc25808f25a68aa140',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@77b350450591d23d1ceb93f61344b8d8ea5a0572',
