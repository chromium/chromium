...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'b9afe06c191e52084630dbbbc87951abd40543cd',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': 'adcf333bd486a7f0a1c5c4a52c8ea5ae54e15c32',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
      ...
      'packages': [
          {
              ...
              'version': 'hGc3pX-kc0QZXujljLLMcc_Eqsl_X_u5Hp3FjtatGHUC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'ZsIH-ALIZA-CiqUyuUr0n5LGague9IgIHzQ2biBz9FoC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'ImjiEbHAwnNHiCuRm885ZHJgcc6DsaDA3X6YmKCa3A8C',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
