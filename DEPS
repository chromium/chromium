...
vars = {
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '512e7e06c01d0d6cb89e832cf2fd3bbd49126e42',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '85632687238ae23799c46afae898ad89b057a90d',
    'condition': 'checkout_src_internal',
  },
  ...
  'src-internal': {
    'url': Var('chrome_git') + '/chrome/src-internal.git@69ecc2d334073ddc365b08047f66ddd854cded97',
    'condition': 'checkout_src_internal',
  },
