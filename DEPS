...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '8027c6ed2ca18a45d1d4d57c5371d78ab1a6ddad',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'Ml6tS2bXUpt2JAvCxZPk2IG4DoEvN-cKTsRTpdX5qz4C',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'MPoW1k9GyIONR2ZM6RUj6kl7AjHbUt9ffc1DKic5YLoC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@654cab9f7688bc1a3ae595d4a391573777b1ac8b',
