...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '3dae4bdd873e596828327fa2a24968ec8a4b1b28',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '7a736be2c169a21f4afb0721b83c8004b2c17f4f',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '6ce847830605985b570bb21907c1dd59e7a48d83',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '932c0a3b0857648a44c72d573a1f794b966530ee',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'd01abd825aac4b83adf1c341badf4a2eb9904b99',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '865702da0739a3940538a04b1b5f365054188d33',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '37f037d0d820a7a02800733e2423453cfb47a546',
