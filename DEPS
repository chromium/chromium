...
deps = {
  ...
  'src/third_party/openscreen/src':
    Var('chromium_git') + '/openscreen' + '@' + 'c48f5ba0b57dd59ac09ed4fa01eee8202e3c829c',
      ...
      'packages': [
          {
              ...
              'version': '9FjKamJ39G4CzzgozDWmQdkXU_hfjSh-jc7xoNWqL9QC'
          },
      ],
      'condition': 'host_os == "linux" and checkout_fuchsia',
      'dep_type': 'cipd',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@60669b2c831fb8673e5b7910e234e721f713b06a',
