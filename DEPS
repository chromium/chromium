...
vars = {
  ...
  'src_internal_revision': 'fb4409c81f20771e45bf9dc7c830d819368350d7',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '18c644accb142ba335354ebaea15bdf6b2eb60b6',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/chrome/release_scripts': {
      'url': Var('chrome_git') + '/chrome/tools/release/scripts' + '@' + '34c2d7b11b51b496c45002d73577091da251ca2b',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'c90436330c128d3c0f7411ee04365a599829f305',
