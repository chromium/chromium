...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'd0de3533dfd59784cb3923009d5fd2587e33fac1',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '5acd4196ab6f9f1f758a604fcd0db8af8c2242ee',
  # Three lines of non-changing comments so that
      ...
      'packages': [
          {
              ...
              'version': 'GNQP8xeizjeKUozEixEMZy-aG8STcRA-1KNa_iEpP4AC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'ak2VpQdD-NtNfY1aSl8BXg7rgcQRC8MdHCd-e89CLWcC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '50d2baa0016a0145807902764680d56dd0b86216',
