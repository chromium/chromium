...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': 'a3377e2234a32e1a67a620a180415b40f3dadb80',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': 'd635feb1152049c91714642389cb899f72490969',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling SwiftShader
  # and whatever else without interference from each other.
  'swiftshader_revision': '415051cb49e19ce5e6745cd1759aaf530c0cc73f',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@3bfdb60a666fdd72abd192ffe0f84ac8ddcc0546',
    'condition': 'checkout_src_internal',
  },
