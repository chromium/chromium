...
vars = {
  ...
  # and whatever else without interference from each other.
  'fuchsia_version': 'version:11.20221230.2.1',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': 'da69157b4f48bf325e01b31b902a032bc74d8fb1',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'nearby_revision': '0173ad3e1b9c02f287eb2b5a02abd2d215f9bece',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '865730a6ed493d9697fa992c124781db7ea9ce3f',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': 'https://chrome-internal.googlesource.com/devtools/devtools-internal.git' + '@' + 'dfd5735284bcbc07599adcabafb31fec9ae1ce70',
    'condition': 'checkout_src_internal',
  },
