...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'f55dc2f88aaefa227c903805f63c0225dba45042',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '1fdda7bc9e96a5812e8cb49909c6e837692d0b2e',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/chrome/release_scripts': {
      'url': Var('chrome_git') + '/chrome/tools/release/scripts' + '@' + 'ad592c5722203f2bb382eca9afee92703fb71b7a',
  ...
  'src/clank': {
    ...
    '242152fe5fa592477e2eb3126b73a394d65048ec',
    ...
    'packages': [
      {
          ...
          'version': 'p6_Y90Uwpj0wlqT7ko1OKFz3TrCk5nuIz1BqCQxpn84C',
      },
    ],
    'condition': 'checkout_android and non_git_source',
    'dep_type': 'cipd',
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + 'a76898d959da1af29774c90dcfebb8224c9e2f2e',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '2594671f75c703537795bd69a4a32eb94abb405c',
