...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'b0eb20dfd18a704a93d899d91da5e8af02e6917c',
  # Three lines of non-changing comments so that
      ...
      'packages': [
          {
              ...
              'version': 'UEwKGOXPmfBFfU7_iLz61PBKm5xg0q_2VdqPZllhqWEC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': '_CavDI3nqhl4pNlfBK9PdxT25zreX9s6MUx3p9Zu5csC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'VKyPL68psk1k8gJCwasFyqP9_DhmKBVM8eql6fL4v6gC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
