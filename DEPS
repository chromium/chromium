...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '45e3f00367457e28ae192c72a4ed04053af1f336',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '8a4b87a8bb3fff404d7a5ae6a46723ec81d9151a',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'db14ea1a9da42c4490c3af9a1757dc7482c49fcb',
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '8f4d3df0bcdd356c0b1d95e4a5eab4da5b4da3a1',

  'src/third_party/devtools-frontend/src':
    Var('chromium_git') + '/devtools/devtools-frontend' + '@' + Var('devtools_frontend_revision'),

  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '871625b303622fd43974ad78a65c06a5724bbc31',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'db098619abd8d6b1c5ee198507e4d17e9e30d981',
