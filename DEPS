...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'c354106099abfd54dde5d57d707528c8355c2119',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '868a58e09393cd0787aac8db8a5197c61dcefd3e',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + '0a1b23792bd50fedbd154fb5554100d9a88f0ae4',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '31417145edec85b9e80a1023d78bd45a119c2554',
