...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': 'f3d250126ba9a7fce22314add74c14cdaa4fe3af',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'af4e5159b93c13a7f260a4b665d11a29359e813d',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '42a7e8c39018171e5b2b4b56a9c4af82522c94e4',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'c199e20fc41f058a77813f7e00b05934cf792ea6',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '3e436d4ee4c5b8b340d25f24011021d041768c57',
