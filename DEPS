...
vars = {
  ...
  'skia_revision': '73073bb3f16d8fde481213256f79adaf5e9d6ec5',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '37f7eb0c1a430b25044909a1694a98aae54ef8e4',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': 'https://chrome-internal.googlesource.com/devtools/devtools-internal.git' + '@' + '1fb1e2f10608a057ca81d184d81b47a19faea839',
    'condition': 'checkout_src_internal',
  },
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@4db12989ab29de0cb306e6aa52f92ed14302f94b',
    'condition': 'checkout_src_internal',
  },
