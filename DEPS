...
vars = {
  "buildspec_platforms": "android, win, win64",
  ...
  # and whatever else without interference from each other.
  'v8_revision': 'a5b8b1607dccc81ee67d494b4f1e0b558b755519',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'e9535b908f3fb9c6585a0a57d4122f736bd04269',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@937370fb9643410dd8f71c22d697356f3e9cdc8b',
