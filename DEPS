...
vars = {
  ...
  # and whatever else without interference from each other.
  'boringssl_revision': '24184fa4975e124e173bba1ca1a0dbeaf38ddd33',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '436def30101ca06fed8d46b2d426edf530344cbc',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + '850e737e31ac8d943818959f3fcb2fdf4dd4bd8b',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/components/optimization_guide/internal': {
      'url': Var('chrome_git') + '/chrome/components/optimization_guide.git' + '@' +
        'ab715baeec9c15d42e127ebdd85d80768d343175',
      'condition': 'checkout_src_internal',
  },
