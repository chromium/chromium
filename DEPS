...
vars = {
  ...
  'src_internal_revision': '0da4640634f747b95a48cead0fbcc6f0984cf027',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '506f68d84378bbc220fddb2bae0868cd7a7d5462',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': 'd27a1fd008e59451b531bfab86358536aa8ea4a7',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '5d52e8438523ae3fd5a75686b6057a2c7bfd4ff2',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/chrome/release_scripts': {
      'url': Var('chrome_git') + '/chrome/tools/release/scripts' + '@' + 'ff9efcd1ae24fa25c75c9720ed74ef05f53f1bcd',
  ...
  'src/clank': {
    ...
    '3346bcf31656dda14db2b85d4e259f0a30c8e231',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@fc4737d353874c9d65469eae85c51d243fd24daf',
  ...
  'src/third_party/vulkan-validation-layers/src': '{chromium_git}/external/github.com/KhronosGroup/Vulkan-ValidationLayers@168175068e2ddf37d01d10c8e81c8cd98de47cb5',
