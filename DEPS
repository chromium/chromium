...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': 'a97f79a3e92b21beb0e6542a7d982c3add1d007f',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'nearby_revision': '487d272e24e5a65782c2320c5da555b493757676',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@229a0ac31f14773802afe2b986bd2b25a8368f21',
    'condition': 'checkout_src_internal',
  },
