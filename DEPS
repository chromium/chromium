...
vars = {
  ...
  'src_internal_revision': '8fc169838e6f7ce840fad847573ecd25729df5a4',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling Skia
  # and whatever else without interference from each other.
  'skia_revision': '38f355af4f36dd2f40687a849bf66877a6eb0827',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'c5ab1cebccaab0f8de466e5f797faa3d5a84bea5',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'f42ba5feb0428ccf28edb78e06a03a88d0c9cc28',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'f21b60aa359f6e00c6ab5dc9deab2d4e6057a791',
    'condition': 'checkout_src_internal',
  },
