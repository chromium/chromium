...
vars = {
  ...
  'skia_revision': 'de89bf0cd7b29cc971e153e42d290d13f5fd3f74',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'catapult_revision': '5bd87e0c59a53bb6888894448463cdcac9f3b4c4',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '9ceff7157bd755bb1196b603ca6c4345e1ec5496',
