...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'GxsDqVPxDrWbBhq8QnBxPe9otUI5ueqy9OPb2NjoJo0C',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': '2Of5aWo9rzKQynpcdEp181ysE-ruuuTjk4h0YVl1X28C',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@a1b89014b638ec7222970649dca554cfab793ebb',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '34ac172fa77a952245068636691b011d793bb070',
