...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '8ea5f769b67115978f723a5f79d3604ad112b389',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': '4572a17644d2f86ad8d2ad2d4593bf8c53742f3a',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@0e8ea48ff8ed19a13e4fdda5a5f6661482ad6b82',
    'condition': 'checkout_src_internal',
  },
