...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': '4256c0224531a8c1a747825295172d010241caeb',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '8bd7c8f77eda07fce732b96a43f6ccff0db20d94',
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '3356e129437df94c4ee427b47a48e5855d2bfab6',
