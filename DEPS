...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '502ee6f2a0d77f320e56d7110dc9cb8b0a43f763',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'f83ffe627d40fbf17d4fec2ae2e6b37d304675e3',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'd995be65d86c330ba723f3be98457df32eb89f1d',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'KGuEl7RRSZ4UU6b_tc5Srvu3-8vxv4BgIDm9WACsA8MC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '4d277b9989674e09ca149149ba9fa56c4df3c701',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '2b1e601c6a2701f75e0ca8c25d4a869110f52e78',
