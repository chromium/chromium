...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '5954a4f6bd7412b33e9611e3e385af39a266c857',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '06c9643051d8c0a3360495d3cd4cb87901a7729e',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': 'c9a5aa975b309aa74f4e1c04a8c5a69ee1ed22cd',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/clank': {
    ...
    'd296c271c445bfa81b612c19af8551952a0a350d',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '86805420eae2719751c4f1d25bdc69fc0d2ee244',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '4078ddf474ac38188866a282d611861d8fc34860',
  ...
  'src/components/optimization_guide/internal': {
      'url': Var('chrome_git') + '/chrome/components/optimization_guide.git' + '@' +
        '057f0c26de6491a5befd31b3c426c9282efcae0e',
      'condition': 'checkout_src_internal',
  },
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '5e8702048a118b374b7bb58a9b839fbdb58e3242',
