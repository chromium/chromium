...
deps = {
      ...
      'packages': [
          {
              ...
              'version': '8rWBUcsxZqv-q3EvgquejXR1twHw-Kg9K7A2p3rQ-8YC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'Ocda8IyHJ6WHf8V2YGXqPg51qzj_xneq0RfQbuNZvcgC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/third_party/eigen3/src':
    Var('chromium_git') + '/external/gitlab.com/libeigen/eigen.git' + '@' + '0e424f4050a1c329c3a740e07263df2bb1702a81',
