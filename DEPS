...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'df95109f840656fcd443681bba90a73af0a2644e',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '090fb1806a825c5cf908d69231d80333da6c81ba',
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '089b877e0ec10c65fe9b3acd072dc4397ee7d3d5',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '06717773a58a754163fb44638405ef61d59833ca',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '7836a391a192c9b54f96a9a3cc33cb800cdfde3c',
