...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '350839a04e7ea4fd5fd69722163495766bff5368',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '070419786f1cb282f6781fff074d3c8885c08f2b',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@dafea070c38af26fe2a89a5c2818abedd19aa018',
