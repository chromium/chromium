...
vars = {
  ...
  'src_internal_revision': '1049a4c10d564892395b6735e953e6a197ecf187',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling Skia
  # and whatever else without interference from each other.
  'skia_revision': 'ae2b97d74812391d93ddfb8d790007a658793223',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '2cbda783feeff6b931df0822fca11c8718f70e0c',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '637c2faffe8364055401a24c8c5694d6e7a8c569',
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + 'c3f37c111e0478a30f4c2f7ec123bf0346db3920',

  'src/third_party/devtools-frontend/src':
    Var('chromium_git') + '/devtools/devtools-frontend' + '@' + Var('devtools_frontend_revision'),

  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '1e10b33e41b29bac7e588e350eec26c7b18dbac9',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/components/optimization_guide/internal': {
      'url': Var('chrome_git') + '/chrome/components/optimization_guide.git' + '@' +
        '59a64adaa8e52f1c7ed6211dbd22dac2be5a73d1',
      'condition': 'checkout_src_internal',
  },
