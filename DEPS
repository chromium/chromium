...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': 'fb402093cfb56589ea468e95170e01b91d52ad81',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'e89111062b25e3fff3cffe1fca4b6c47293cccee',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': 'f5d9b050bacd6cc449825490aca55f082a1d2ffe',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'aEZGcxdv9RFzWl6FKg1ftP7d4EMlSXq2PPr41f0AnGIC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/clank': {
    ...
    '36ea84e1aa16bec129ed367779070ded361a3c2b',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@d54ef6333c6966d4ff4f289df6857a7914bf5d22',
  ...
  'src/third_party/vulkan-validation-layers/src': '{chromium_git}/external/github.com/KhronosGroup/Vulkan-ValidationLayers@fb017128e0ca955b80e9e5751152018dbda60396',
