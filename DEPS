...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': 'b531fa82b45a66638f0efe63ad931e418d6c1682',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'fa082bb58ba756fe1c7538f8af2332ef70017097',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '5b238b2e5f6eb1a5ab43b8520ec9f23447724819',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '810b74c0d7e44a56c06dd4834d4ec3e15dafdcf3',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@9418e43a9c9d719854e02dd07e94a1d5755af2e1',
