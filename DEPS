...
vars = {
  ...
  'skia_revision': '407992b2e42917fb3ff83e4efed8a68203a0021b',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'c4b95929b8b36d32b330755646ec5c0a2c65c8cf',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'catapult_revision': 'e5bf2c49f5ae06d3be53808f31f3bc8f67824a8c',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@fedebc11c5e7a6e5a7fee6ec3afe609d63eefda1',
    'condition': 'checkout_src_internal',
  },
