...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'a8565b3f0f20c19c40cbedcc670a801830143e45',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'AP94qPLgWCVI60lIDmvawM5pmrLDlcCFYZGnf0yHmT8C',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'DUiecHmEuO4niDCl4ywRI2ckOr_Dun_ihPKXaq2eJjIC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/third_party/libyuv':
    Var('chromium_git') + '/libyuv/libyuv.git' + '@' + 'cd42708dac1ab460f1295e37723bbedb488a48b8',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@d7da3806ac80d1dd07729a5bd6e2ec7232b298fd',
  ...
  'src/third_party/vulkan-validation-layers/src': '{chromium_git}/external/github.com/KhronosGroup/Vulkan-ValidationLayers@01bf0debe6008693187d1376e1b33a390e921ccd',
