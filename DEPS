...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'f2fe6b9e08d4b9bed1a669724eae1c9456e384d4',
  # Three lines of non-changing comments so that
      ...
      'packages': [
          {
              ...
              'version': 'dcYm7q0isJ3vMKDet_t0374-28_Y0QQqsJ3fZnIOLOYC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': '11ttZMBiX82TBuLO0WPpG44kHhZCIHR3zd0vTDsuf6wC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'E3b8Bio0rWYPtfAeAL7YdzVb5IvDBqr9G4NGUAgBMjIC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
