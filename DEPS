...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': '56259f30108224ae0f8cc4838436aad2beaffabd',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'catapult_revision': 'd912307685dc8fbc6c970a353383b304dad2f1d2',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'c138a5492920d5a0a18c7bf78dc03d45255b3e5a',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '53ccabeb25bdc785f0b50867840513686e367a81',
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '8454fc2458b2421e0e339714c6ff7e6fffb70dc4',
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + 'cb0320182ac88bdd7c4110c2a9e1406a874628ea',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@21dee1f8e116b12ca9e2dc7e3a7daa3f16486962',
