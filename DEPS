...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '41bce47d18303c8412234bf451f9ecabff6db5ca',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@f2d4f1cf62b242d7694a154345ec1ad65efd66f3',
    'condition': 'checkout_src_internal',
  },
