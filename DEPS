...
vars = {
  ...
  'skia_revision': 'd3d4f9c161627385dbbb0c8890b3ff067cd9a891',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '9676eee2fe9ab4257d1a0254bb80d6001733dd49',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'e39f1b590785c8b53e2b0ff7187d71691b6d2837',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@849e420a31794de8c471601e2e6b994588df0a09',
    'condition': 'checkout_src_internal',
  },
