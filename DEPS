...
vars = {
  ...
  'src_internal_revision': '0f725cb307e10ced3149f7c044c594d73f16b07e',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'c9d55051acf93438ed98849a5a50ff3def66cbab',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '6fc2c1235b8186fbb9b5189cfba923d95cc4865a',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '4f2d8d9ced9df4d338afc31d629c57a0a1f38c64',
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '55d065cc0c7b65c7de40d8c798b78ff693cc3651',

  'src/third_party/devtools-frontend/src':
    Var('chromium_git') + '/devtools/devtools-frontend' + '@' + Var('devtools_frontend_revision'),

  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '77c15d6cb2641d315ec5baede6d523d39b4b6ef4',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '2c7b40a3f75d6b47ed27e8b19e77a8ff9d6cac53',
  ...
  'src/chrome/browser/platform_experience/win': {
      'url': Var('chrome_git') + '/chrome/browser/platform_experience/win.git' + '@' +
        'a270fb2ec79662ba5d48598ced0ac7c1384e66be',
      'condition': 'checkout_src_internal',
  },
  ...
  'src/components/optimization_guide/internal': {
      'url': Var('chrome_git') + '/chrome/components/optimization_guide.git' + '@' +
        'bc46dea5842464132f7d61ce3ce8fd1195795683',
      'condition': 'checkout_src_internal',
  },
