...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '4417d50716f8e133f09857e4042546cfa624b954',
  # Three lines of non-changing comments so that
      ...
      'packages': [
          {
              ...
              'version': 'qUYd4U3gZDBqAagEdyonfocTekdNbioji6KGz6Oan8cC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'p1gGZQc-L5vCdWZrn0U69ehj0ueais8ruOV2VagTV7gC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'DaLYLEKApgypBHxMf8zZ1Kud7ivW7pB3SFzEJ0jVrAAC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '2ba3295e840e3de1f18be5f325594659a119bcac',
