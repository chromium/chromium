...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': 'ba95ec201dfdef2597526e8bd983e8295884bdc0',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'angle_revision': '9edd74e2ff86cc9a6de9c81684832cebe4f180e9',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'catapult_revision': '41f6453cccf3023db67440775e917f4fe6872675',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '20531f75348eea6826a135fd5c1ba6a29bec0fa6',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '6181061f5783de62eed26ec43ee15e92972332db',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'b7832d66160a45ad73bc67e9c5fe00d47af3662e',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '86acbccce91a632bfd12e1a15b88a7e13ce41aa6',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@f29e45be2e0c749f77644879ec92911894a25c30',
  ...
  'src/third_party/vulkan-validation-layers/src': '{chromium_git}/external/github.com/KhronosGroup/Vulkan-ValidationLayers@ef416aa26f9b107e47a111723cf0839ae603f963',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '37784ef368dedbe4298277fa4c8821347fb91b09',
