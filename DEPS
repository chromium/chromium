...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'ef162dcbefef8aaf701fdeef31775cdf557a22a6',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/chrome/release_scripts': {
      'url': Var('chrome_git') + '/chrome/tools/release/scripts' + '@' + 'ca92d41d61581c0c2c29b46ba02247fcef6193e8',
  ...
  'src/clank': {
    ...
    '3f397b811175ec560362d8bc20098e70f0cbf25c',
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '2451ee476dfa0f94b3443455af612a56fc06c2c9',
