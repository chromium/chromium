...
vars = {
  ...
  'src_internal_revision': 'b3ef9a46b67654b620b8f9ea233c3f6e53218497',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '9939eff0b80cb3d1db6e0ba141e533104d0abe00',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'ffdd283bef24d921de44a8ad6e857e0ce7d66c5b',
    'condition': 'checkout_src_internal',
  },
