...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'rsiIFXe-lJ6ZldmFrxl-kfeKQBtX93LvdGdMcKHbKpsC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'kVko5RkMyzosh-pYMBabBdJYJpk_d80mLOx9IdN_FWkC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@ce24c4725c8a66f0d6e13e4b45f0f4860728cccc',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/components/optimization_guide/internal': {
      'url': Var('chrome_git') + '/chrome/components/optimization_guide.git' + '@' +
        'ecaef95d5eee1948a7a259e0ddf8928e2f6cc1e7',
      'condition': 'checkout_src_internal',
  },
