...
vars = {
  ...
  'src_internal_revision': '7126dff632eef6616d74e5daf155b30e70e50e9b',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'd30e47727da80c9dc48c72cf71ac943146ace2bd',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'catapult_revision': 'a80034dce3dc766cba406f745887ddbbb8215918',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling chromium_variations
  # and whatever else without interference from each other.
  'chromium_variations_revision': 'de6f4b8722830519173e51618c0f45f1f302129b',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '4975e45e94803c81563f0c290585a526d4c089d1',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/clank': {
    ...
    '935ca10387b225ef2025ce91503e74538719d73f',
    'condition': 'checkout_android and checkout_src_internal',
  },

  'src/docs/website': {
    'url': Var('chromium_git') + '/website.git' + '@' + '3768b355607a618a2f85b23f1a7fdef3253e01f8',
  },
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'b0ff374fc90a36361646a57955321fab6155b537',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '9af71284a152b2e2584a59e0b32f8913a8934065',
