...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '6b99dcadd1075a9a4ee09b80edcbc7ff6981c932',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
        {
          ...
          'version': 'ekeB0822335f4q1CAI0210oCrl-ATqfc7p1TDhnPPxwC',
        },
      ],
      'dep_type': 'cipd',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@6145d30b334dc36b68afb4d0551f8e2414ccfa48',
    'condition': 'checkout_src_internal',
  },
