...
vars = {
  ...
  'src_internal_revision': '268af8712ab21744242c27c6b3a82763fd8840a7',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'e305459968f2086e06e9e1dfe0996806bfe6c56b',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '8ccad544418cdc2756ba80cf7b19e712ef419fc7',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/clank': {
    ...
    '857b177e9a00f0db4c82c05ead96a6db33520b6e',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'c9a2e8f635806c88569b13fff0147eca837c523d',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '89d0266746300c5aff651a2bc1870f05e1a49c05',
