...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': 'f7b93564f36174e5556c692819e21fe67f2bfbac',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'nearby_revision': 'd4b40ed9a760cd439a1b32f73adae4465f3cb2da',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@1ce3a87e20ec7640502d00a3bbbd4c1d09637227',
    'condition': 'checkout_src_internal',
  },
