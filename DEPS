...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'ff9d3aac7928317000c3ce10697daf177cf96e8d',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'aa51ce909dc8b992cdecc4a1b449b43684461585',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'b4ec1fd6c5c2c89b0d95b7877d4bed69d204462d',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@0b7675ce1faabcb2e4916367d39475d4f107552b',
