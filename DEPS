...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'a63f095d8a4a2ad7d83901ee4494bcae599164c5',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '7a783419ac29c1acb66d742f710ddce7cc6bc6f1',
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '56dc8e9eeeab366ed116c7f523e1c6461fdcc027',

  'src/third_party/devtools-frontend/src':
    Var('chromium_git') + '/devtools/devtools-frontend' + '@' + Var('devtools_frontend_revision'),

  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'b2a7bf40b10bca5563162e54dc4221cbb2104385',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '861dde7504074ee325857d2ffa6856bd2e416399',
  ...
  'src/third_party/webgpu-cts/src':
    Var('chromium_git') + '/external/github.com/gpuweb/cts.git' + '@' + 'c2c2fa9b203a3ec5ee0aa5f96a0c05c1fe55a25b',
