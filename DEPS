...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '7ae78192ad4cdaaed7015cbe09d1fa065887881f',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'b33d781cecc0465f5bf8aea21fb66d15fa3a058e',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': 'd809b7ab84621363fe52173cc65cd4e09eea07c1',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'a3c18016e617733daa6a2bb7139150ecd6f727c4',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'nearby_revision': '334ef7a3e1264f5175cd8e857cd25254124c0838',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '2758a864b7aea1679d0797c28e14268497345471',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '3edcd7d5ba92e1f3d5b25aecb1c6f80255e03360',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '20da4f4b706fbf524da3360cc85e2185e83ab48f',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '7c6624a9ead152a54701001f9f1b4039c9d307d3',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'b73e17aea19d50e72d8a32dc6421e9b4a8743377',
