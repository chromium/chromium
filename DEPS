...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': 'c4bcf570097db9dd62e9bc7fd839cfd1d9c77e18',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '3c7ff519be35ed5c3274223ae61c254585e23558',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '9eaf0093e4be0b3fc10e31c6cbfb35a3a7eeabfd',
    'condition': 'checkout_src_internal',
  },
  ...
  'src-internal': {
    'url': Var('chrome_git') + '/chrome/src-internal.git@1790f664ff4f50c4ba476ecf1f35d4c3d9fdec37',
    'condition': 'checkout_src_internal',
  },
