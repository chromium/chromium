...
vars = {
  ...
  'skia_revision': '7e114d7b3c238ec7dbc9ff51525fb3655343d71c',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '602cf4c02224868c786aeae431bf453dd330a3c2',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@9e4f0be44e7b00f7225dbdb595bc218e617e6d60',
    'condition': 'checkout_src_internal',
  },
