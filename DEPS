...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '304de4ad80886b2a095e35745c7a75a87b50871d',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@299f2d6d48fca5798a9ae08c161ab2898ef57026',
    'condition': 'checkout_src_internal',
  },
    ...
    'packages': [
      {
        ...
        'version': 'QooIzO0OCuLP_DuCtYhu2wKqzywPUdGzJARW28OZHasC',
      },
    ],
    'condition': 'checkout_chromeos and checkout_src_internal',
    'dep_type': 'cipd',
    ...
    'packages': [
      {
        ...
        'version': 'by0TesQtM48y8kzTBTDHVGq7yePk0Gd1faFbtoVIznQC',
      },
    ],
    'condition': 'checkout_chromeos and checkout_src_internal',
    'dep_type': 'cipd',
