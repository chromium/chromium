...
vars = {
  ...
  'skia_revision': '7dd8c705a55e093dffb5dcb26ee9872802e19252',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '22474aa11c0ce1c8f1905537d6a4a58e7d5cd9e6',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': 'c0ac374f795d2dfe6090dcc09ca737c7ea283949',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '80b4fb19ce957b894f403b7ea33ee60cd450c66b',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + 'f7e510b2f7ca1e3636c7f769d65e61827ef3cb39',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@ae395ad754897321414ff91650cf7fc0368ba37c',
    'condition': 'checkout_src_internal',
  },
