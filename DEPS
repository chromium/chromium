...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '887a4aebd50a092acd5c8580934dd2f7f9cb7c96',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '7bcc9bf8e0e12c39ff9cfb579e2924cf9c777368',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': '1g_211TnBVa7jiqvbVc1MP81PLQih7JoftSG7hOe1x4C',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
  ...
  'src/clank': {
    ...
    '21da233e631a80a35bb74bf79c51317fe04da8b1',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + 'b226f6147822d9c8f0c706f8ed2746ed9e5f1289',
