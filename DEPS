...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': '79729f7c6098b66a623632cd9d82945d140ad840',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '152935c2673be4e703eeb7bd51f02f3926fa2e6f',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '45af5a81f06979adcdbc78eed7553b3e687e165c',
