...
vars = {
  ...
  'skia_revision': 'f2ff66bd62eb56120f31c02ceb8f6c5ce0168868',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'c992fef70eefedb5041c1bab85e457a76f7e7edb',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'angle_revision': '81758a3102bd2940100470acda0033bd194f3e8e',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/icu':
    Var('chromium_git') + '/chromium/deps/icu.git' + '@' + '2dc7862ceb3091b1f32ff794872d6874ba5e76a0',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@a9948c5ca63b6a0c32503105e29089286cf7f508',
    'condition': 'checkout_src_internal',
  },
