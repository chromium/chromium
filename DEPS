...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + 'a4488671e30a2c1617b86190860b0dfd1afeb488',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '161d2c84528ec9eb0c19bfb51024bca54353abc4',
