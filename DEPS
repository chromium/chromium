...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '4231d46ff0ecf13a9c4454ea7d4013eae0867c45',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'b4e88d86be867fa31a55dad68fc8a578230768f5',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'gXc7F8O7n5M5TPkaNmiWHbuPeajy1MovzszXgeKBbr4C',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + '34d969360658ee7c0505e4e34d5687f0ea55aaa0',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'a3d63d040d4b229ca811a5029a7b3790692733b4',
