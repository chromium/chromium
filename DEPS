...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'aef02d04fc060e397818804431ec33980c7f01ac',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '93ed673f441f19446d7263e82dfbfb54fc38c677',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '515492e958b5f9f888ab1d1e1c6eab347899056c',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '3e9a5f3638892be94dde5d6dbfb3a6b6d301f96b',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'c5d0cb23b5a8c70b96d0e73ebd1ffc513fa7372b',
