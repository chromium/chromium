...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': '7cde4ef59f6c434ea78cc3ec43be699a9acbab49',
  # Three lines of non-changing comments so that
      ...
      'packages': [
          {
              ...
              'version': 'KnFu-9MCLpEziBlrL4dXrYtq2ffbLJlcHeO5rf1vy5oC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'lIrROYoYdAD_f3OlUWLmJ7j4iq-97-SVhi6SjMMMcGcC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'ur_2IEvG9pbbhqy3AQs367nqXpVbhwpc6AiJ4IDX3SUC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
