...
vars = {
  ...
  'src_internal_revision': 'fb927ac952cc61fd7883299d5b70b80c6e78144d',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '88d0419a76aa5336ad772e8cb9ef0c998b108bd5',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'e3931d9ded01efbb3875889bc16a14003a5eb19d',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '9c3ab2cab4fd55408762b6d64b93ea0c768379a2',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'f5ffd458556d7be6eafb4c644898f26f271388c0',
  ...
  'src/ios_internal':  {
      'url': '{chrome_git}/chrome/ios_internal.git' + '@' +
        'bfbf9dae114eba526941fbd5874a874588d1a344',
