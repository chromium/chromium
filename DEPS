...
vars = {
  ...
  'src_internal_revision': 'd9212a7b9a3089833680b1787c0160a8ce3a1f05',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '5c579f7d592622e12e9b2f8f8cce9dd36cca16b0',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '08846254291d08979fad450bff686080bb1d13c6',
