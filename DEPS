...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'tv3yADR1MCm0FDfBurLrJbKo4FHMtxOfFNl5I1SZtbcC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': '_ze8-1JzRbyITikG21EnJzEVUzlXbVxHRC7bBCY7WqUC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/clank': {
    ...
    'ea7ba0f236038d3e27e2bd7ed4ce84e2dc741d3d',
  ...
  'src/third_party/eigen3/src':
    Var('chromium_git') + '/external/gitlab.com/libeigen/eigen.git' + '@' + 'e6accc73ffd98aca823785625b8938703c2bdf60',
