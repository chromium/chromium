...
vars = {
  ...
  'src_internal_revision': '685022e89b26d29aeebbedc58a8a01c28ed33cb5',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '9cd19430365888e9cf1e66cc260c6e2c1492df2e',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + 'd3f7357259be3b1010b90de77b8c565dca6e9a1b',
