...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'ecc45dfce0f374b1b1727b7132859913b4ad4a90',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'j4oVrFaQ9EOt9DKzicl37ya4uIC-vQ6M3maTsWR_ZbsC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + '0289f5273c94988621254b15b157de0786ec6636',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@c9318cb42bb55f8a41b93fbe68eb6f3bb92df186',
  ...
  'src/third_party/vulkan-validation-layers/src': '{chromium_git}/external/github.com/KhronosGroup/Vulkan-ValidationLayers@0c64ac6e164e52c458117f9bc677182cce6af063',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'f8c4bce515bf156fcdafe3619a343f3cc00d2660',
