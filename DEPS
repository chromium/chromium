...
deps = {
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '2afcec32a3c3bb689225fe78fcbcf0905b19c3a1',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@c64bb49e35dd97efa73ab36715c44cd759888d5b',
    'condition': 'checkout_src_internal',
  },
