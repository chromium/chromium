...
vars = {
  ...
  'skia_revision': 'c8cb357b532fcf9132eece344547ff7392f4d0b2',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'f1834403ce26a37d021a2b25c3fb929cac1f6d8c',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '70633af610d0a9b72aebc356f009c52f1a258c21',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'j6vRJcQFltO_iGz4KyCfVsjmuEnA6vgCzPEu4dFoC-EC'
          },
      ],
      'condition': 'host_os == "linux" and checkout_fuchsia',
      'dep_type': 'cipd',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'eee0e336a2f3de58c286e308e0705265f9a8ba0c',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@42b67a672bddf19aabb0e469dad4d2605e3bd4d0',
    'condition': 'checkout_src_internal',
  },
