...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': 'dc97ada0077ed41efddc3ac7fe64b0e5f46a2166',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': '9a34c8e0609a08a68b05b0748f4a1303e081f1fa',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '4663a3a710969991ea437c69bbe61d80b61a91d8',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/clank': {
    ...
    'ab3f75bc5398b75bd756db2bed4ff4dde264b6ca',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'c241eaae16eeceb7bb76829297d4d59b87424ee6',
    'condition': 'checkout_src_internal',
  },
  ...
  'src-internal': {
    'url': Var('chrome_git') + '/chrome/src-internal.git@3498e91efe891fdb8b7a8299fafcd3eb5fa37202',
    'condition': 'checkout_src_internal',
  },
