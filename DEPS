...
vars = {
  ...
  # and whatever else without interference from each other.
  'fuchsia_version': 'version:8.20220529.3.1',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'd64f8d37e82ef42fa407d1430d661e57daa5099b',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'aba10f3183567ca1f412331921bdad4c318d4830',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@8a77391047c6f9de78bbdbd1522d841d3b93a210',
    'condition': 'checkout_src_internal',
  },
