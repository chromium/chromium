...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '150ff9766609aeadba3b55ac1d0a463eae32f765',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@61527922ed56b178191d986409afe609d7925e35',
    'condition': 'checkout_src_internal',
  },
