...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': 'cc84a862695504c7f10253c5a79997928f640b42',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '1a1709fbaf30cd2ef9070d36342a0e38283e104a',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '162ed1faec3c57b7b1eb6d7a143d8edbdb87f0fd',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '35117a9d43d835e0f79b04bdcb351dc8b1e91fdb',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '83933bec8e0e51cabfd633baeab3121dbd066799',
