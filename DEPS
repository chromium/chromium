...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': '02bd7ad6ab96f24eea8b5d097e61a675ed2c57d8',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '2e725f7316f97c0b0131fe7af41820d2bfb01e75',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '0104c1d8c766f8147a19a909e219cc2afa850811',
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '40b4bd765b913ce3d8d3a336372f58c9cf49160c',
