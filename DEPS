...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '478aed630170bf3a8c47c54a7bafc6743d91b641',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'angle_revision': '227e4c2c01f2a0fa8a7ff560a8f7a144ca715892',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '22b657d21f73350906f5029706d576d18817f011',
  # Three lines of non-changing comments so that
      ...
      'packages': [
          {
              ...
              'version': 'axM_O8iGolsPe_lE2HQZYN5tizKnXSHCaMui_yZmbmIC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'mUEG0iQ6p4Ebtb2ftVQ3HP9wWQSisqzTdkoA4eUhfGUC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'Slnha3fuulvqMAIA1w6L_s1nVe1_gKZ4Z8KiK_JgH7AC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
