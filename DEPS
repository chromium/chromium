...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '88bd1c49dddf7bc1e18bf750178d33558996fd2c',
  # Three lines of non-changing comments so that
      ...
      'packages': [
          {
              ...
              'version': '-Yl_SfRVG9brgAJE4szaoVWvei3P-AUBvESKGgGv7cUC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': '0gRN-PYtuTYlgxSRymjIAp5B5oYIgyBihJkSBNf-qk0C',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'dg0I1DI30nCL9D6Oq5V11JTocfYaC8FmRb7uxUI-L4MC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
