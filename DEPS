...
vars = {
  ...
  'src_internal_revision': 'bbd36dd3480bbd562b3a9938c90f39ce6aee8566',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling Skia
  # and whatever else without interference from each other.
  'skia_revision': '665fdd2e75bd88d8c4c402726eb6eae432a2d3bf',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'd6f56ec630a53575e75147ccf5eeee27c78d4a72',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'd94bff904fd8cffd0a5e2776ec79f5fc049540a6',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '490f848c904f69e4f46dcb2dc36150bac9a741b4',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '0cc664e6b67487ec08b9d67cac6a95e094f78174',
