...
vars = {
  ...
  'skia_revision': '5bb67430b6687332d138e5c3624e24b0ecfccec0',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'angle_revision': '9121a79d649d04ffa0cdbdb476df40a5c429a6fd',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@60edfdb05e01afd01559aff3d6b9b47aec44e0a7',
    'condition': 'checkout_src_internal',
  },
