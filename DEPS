...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '5ef4f85a6d76a6b2025a4cc01c0488d036d06f2f',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '57b140e9e98d5784a90e9158b3b30d829d149eae',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@3f6d76ef1d7934480eed4c3cca7acba071f8f47f',
    'condition': 'checkout_src_internal',
  },
