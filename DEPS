...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '0b980ec92acdb082853cfe2bce70029b7528e726',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '188345573b9ff795911faadc98a13e2d302f3dca',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '546333fdc2d03607a7814f4a5e09a9bdfd54c533',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '01e1c11dfc8879d3f46a364f5d59d03e0d768bd7',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@1d27ee23e76c685b1fd9ec8f22aa8ce51e326d6b',
  ...
  'src/third_party/vulkan-validation-layers/src': '{chromium_git}/external/github.com/KhronosGroup/Vulkan-ValidationLayers@ec5abbe827c39598152d3a9d46ad0359f20b0910',
