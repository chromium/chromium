...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '7cdc7bbd6820203b5c168507cbcc3da7faafc98f',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '8524c6164c1d34c722fd3c1c5395ede0b2e98c57',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'f1d4b63c46f8e4d3260ae4c78f307777938a1178',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '80000bc733698876c13cbb20891da9236496bfec',
