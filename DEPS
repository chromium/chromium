...
vars = {
  ...
  'src_internal_revision': 'b1bdf7aabfa5d2f1ffa1c5bf40f03d1d2b52cc75',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'd8625347bdcc618a2e110825ec509cd43e85bee5',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': 'ecd30d8877d044aa72e9d92a50f20c6b285974de',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '2ecd7f65d515990b4e31bef0340af9ce86240e48',
  # Three lines of non-changing comments so that
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '986504cb8a5fda931878aebd3637c934f7ce31f1',
