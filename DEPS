...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '3ad24080ee4f4ae7fc58c3d95e2edc8053f9e4bd',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'bab3f9ab79ecf84100d94291b494d0336d24bce2',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'c1861e8bc6761b345c74e8e159effea23fe0e20e',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/chrome/release_scripts': {
      'url': Var('chrome_git') + '/chrome/tools/release/scripts' + '@' + 'a4eb9272a74426fec78688857b1ad0fa78d60cc0',
    ...
    'packages': [
      {
          ...
          'version': 'g5XalNPRJA50EwowSPBTc04V7tXl1doOhi92zUwjOWoC',
      },
    ],
    'condition': 'checkout_android and non_git_source',
    'dep_type': 'cipd',
