...
vars = {
  ...
  'skia_revision': '014892aa01c8ae33393c7350eb3fa4d85920f277',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '2de23a688bf594e097f42e01b6ac685449aa1160',
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + 'e8512ff98a46f7a51181db44d2915dd3b1e37a40',
  ...
  'src-internal': {
    'url': Var('chrome_git') + '/chrome/src-internal.git@f087480c58ae2db60917a05b788b3c8167394e31',
    'condition': 'checkout_src_internal',
  },
