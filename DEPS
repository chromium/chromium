...
vars = {
  ...
  'src_internal_revision': 'a0325701a4be32bd8978e206149b59b0185f2912',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'f11105484b3545a2245931f39e22e7efcd6f7305',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'crossbench_revision': '473c68e5e51a39533ae3b6c1a6acd78be3c2c2eb',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling CrossBench
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'a8da482c41d48cd2cfc56d96beeaa34c9ff1d3fa',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'VL-fxVn6O8_NopQWTqOxXVXOVnKM_4DFe7wsbJe8jqEC',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': '89wxytgs0ZYjcgbvVihV3qHpPRQXDauF9YXBOyvnUb4C',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@0844ad1a3e4a9e43a8e9ea3286d596e15bda134d',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '89791d6a484f36ebb129c5c871bce4ea48b9b179',
