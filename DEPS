...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '434fe93ce30208c573cd3571ef647b32daa8b87e',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': 'fe220ebdc2546fb7dec7b5069ba4b97f72689163',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
      ...
      'packages': [
          {
              ...
              'version': 'rJzMa2Vz66FFSBjbpGcNgny-PDFj_xBHULm6bkAyi5gC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'DC4tyvsaTkKZ_t6yZrd2dCZyBf7lQJGEznV5mDHJTUsC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'YwEUR8QzNOSFEgIpX-k0AdF7VryCBep55nibq5culcoC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
