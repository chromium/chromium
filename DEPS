...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '7226e4dff0acc9e3343924ece900f0b879b4bd8e',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'c0692cb38581fbdd640cf2b37e36701fe07434a5',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@ec9e99bebc5430c67907455d3e990c50967d3564',
    'condition': 'checkout_src_internal',
  },
