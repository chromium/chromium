...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '8f416599bb3745b140628af2145b12c57db96ba1',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': '77151a6c870c0bcf85f470fd23c5ce60906317b6',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '5819446364e869d64b3811b3cf7e81e9bf10c9d2',
  ...
  'src/third_party/webgpu-cts/src':
    Var('chromium_git') + '/external/github.com/gpuweb/cts.git' + '@' + 'e46bd35978d176ee2ba8ee4a66fdae844c8ad5ae',
