...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '2864f76c56ddeb52149de16937d316577fbcd105',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '85221e31294dcd56613605661a929b2a2eda062f',
  # Three lines of non-changing comments so that
      ...
      'packages': [
          {
              ...
              'version': '4xHoUGPrXdcdjwGnpPgBvrqNdEBr01bb3mdAaK5M0DoC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'rHaZ_IjH80aSC6RZW4qbPuEN_XCXsDQ9Tzl898E3t7oC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
