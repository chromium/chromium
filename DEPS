...
vars = {
  ...
  'src_internal_revision': 'ea01e235ff160457425ff412345971c080a9809c',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling Skia
  # and whatever else without interference from each other.
  'skia_revision': 'bf34df08cd99e9436a20e82f17d01c89d94d1a3a',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '96e9d02753fbc3055cc6b3246b17ca1398d371f9',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': '238d0aabc10b2faf36063509d2aadff842b7642b',
  # Three lines of non-changing comments so that
