...
deps = {
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '68dc02b32fb33fa2718ef8c6180faa44ef021625',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@c90131cabfb2cdd61c380bf320753b7a97f9fc74',
    'condition': 'checkout_src_internal',
  },
