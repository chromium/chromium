...
deps = {
  ...
  'src/clank': {
    ...
    'eee1a7c65d3f177e4af3ae7770da06e89d05e87b',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + '99a4e9c6541ff9281920eb4427f219017a3398dc',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'ed3c6e4d74fca63d73abb47058e5627ba2707e81',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'cc43ca6c0b812b6842463952397929239dd8abf0',
