...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'a3800944fa3c02d2c8efe7707a53a1277387cb45',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'b33544332fc823b0ee5c3c4db4f27e4ac630cf72',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '2c0f1639db6d6e63de86472c3d2070b6797d2d6f',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '888fb5647ce3fe5740a33500eaf731ec8c6b1b0d',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'd2f507d9d174772bd19e4e997476a36acd26e982',
