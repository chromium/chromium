...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '15638ba75c96753816efa28d7248e1078eec94a3',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'D6UjESWx9C7bzW13IVEsgA1A940HqjP4geiRe0C_FOIC',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'uzCKRc2HbqSfCZFFarh5ppcP0sUu_n7kYvSfi0lBYNcC',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
  ...
  'src/clank': {
    ...
    'c19778846c80aa497a7e636a1fa9b4faf85b8de6',
