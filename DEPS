...
vars = {
  ...
  'skia_revision': 'cb6ea84c4e772667a2c71a714dbcfa61c22d2a27',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '8653624e9108896731cce55ce4db8dc84ee0bd8e',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '2b9f01b3a9b1d518b0bed5bf83fcffdc08560528',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@fb19736c96016846619c9db53ee7e11154e88088',
