...
vars = {
  ...
  'skia_revision': '3142dbef3e31c6b785510219630a7ad40371d791',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'angle_revision': '4718e8197a83458d5948a7c2984972da114f1d28',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@0c6a1cec843fe92209f37cd4ac1fc1f42e957aa9',
    'condition': 'checkout_src_internal',
  },
