...
deps = {
  ...
  'src/clank': {
    ...
    '5e0e8b98ce86ee110925c50a6de5bd1a95664613',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + '874674e91c82c0a52df3fa8b4262dc910ca8ea4a',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'f3c36d565fb8b751d5f322b1d919b1069d2857b1',
