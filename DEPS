...
vars = {
  ...
  'skia_revision': '320a4de77b3172eba294b88329e011a64fcd19e4',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '52f5be82ff6ba59343ba65ab7d8e215e46d44d3b',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@95908c5b09df0abaf786baee7507f168d4aa6a3e',
    'condition': 'checkout_src_internal',
  },
