...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '503345eeea44c1b5e938f28e8cbfd45d76968ef6',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '99616d8da6ed81afce3ca05ec6c47ffbab125c93',
  # Three lines of non-changing comments so that
      ...
      'packages': [
          {
              ...
              'version': 'vStZf85VFIPyjNqYp_g2VajHZA-7dX9901YjiyeI3BUC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'YHeSJTSoU8VkZmrHYl-aXq5lOZuN2ZRuIQbQdw4rGKEC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
