...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '47438c4b989f2aa273dde9ab59ebd1c30e9c9a72',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '95a792f8dc424a2f317577f7accde7ddd4826499',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/chrome/release_scripts': {
      'url': Var('chrome_git') + '/chrome/tools/release/scripts' + '@' + 'c17005d1a6a52f55a288b1d4ac93b8d40e975ef0',
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '0e6fa583b3b593331786fa890c85f09e7a93e7d8',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '9a2c408a1a240e9aa16b548a3c17281c572f37fc',
