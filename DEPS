...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': 'd0abbb09f8d3a9eaa0109a582d3cbfd00076c442',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'adeb8b4c461621cdfc60ab3f55011c2698e7106c',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': '4ce8b71e1e038d1c42329c1cc94b9026c21b9c80',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '3d55ad2581ffccaf195f37a0463f163fcc7641b9',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '0deca19a0cdd53f2e14524077c4b1bb0e1872530',
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + 'e2cd2390e6fd45c8fb36ace79b599367cca81b3d',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'c356a8360bbd1222a798201e532a8d8ba5a730f5',
