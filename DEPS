...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'b9cbdf96194400d92bb83ea8aa1c7a56ffded9fc',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '36f9846409b3b1b7e69924b582f8fab25c493f57',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '42b163f2365f9ec68940ebd1367c03097ef8f324',
