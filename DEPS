      ...
      'packages': [
          {
              ...
              'version': 'UxWfHR-LpE3CexhpbrMXCCk1YOcYqwe0ZlGcP0QGzUAC',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'UWJq4ifJNrxAe_RauIoVg3kNdvbRo4lNzpHDq8eRUHgC',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'qCXq5S3PIQdjoCQPTUgXrTvorDuLccNyXKtjh76xYEoC',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
