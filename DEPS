...
vars = {
  ...
  'src_internal_revision': 'a22ce32732a75e8b8bcac5c4a5a98609eb211b6f',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '479dc5f64d4c2a18440bb9f9b06ae177f052cb5d',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '11f6e630490452304f20cba0894dc3297d8638a3',
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + 'cc1689822e8ae09ae15120356d7ac8460319f63d',

  'src/third_party/devtools-frontend/src':
    Var('chromium_git') + '/devtools/devtools-frontend' + '@' + Var('devtools_frontend_revision'),

  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '7f6ff9e13d527ddebe2393421607dce14ddbe354',
    'condition': 'checkout_src_internal',
  },
