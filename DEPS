...
vars = {
  ...
  'src_internal_revision': 'e44416b224771aa36c6b298908ac5d42eee066c7',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '8259aa21740c238f184f68a2ad5f2d73fb39e885',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'e5340fb4141c4bee531fbdd1181783eebb6afefe',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '8dc01d708d2ba0e36f1dd97728b95580ebaf58a5',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'a451045c16d77f428491447664e1cbb7d0d215f8',
    'condition': 'checkout_src_internal',
  },
