...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '9d1463a544758ea5a957f5aa57e540d3ad14f8e4',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'f2e4b2c57de1640626294fedc510a06509e0e613',
    ...
    'packages': [
      {
          ...
          'version': 'bm-askHvNBpnbli2ok6EoqzrbgeeGKBgBhm8n7if3MEC',
      },
    ],
    'condition': 'checkout_android and non_git_source',
    'dep_type': 'cipd',
  ...
  'src/third_party/cpuinfo/src':
    Var('chromium_git') + '/external/github.com/pytorch/cpuinfo.git' + '@' + '403d652dca4c1046e8145950b1c0997a9f748b57',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@5cb9d1d5c55bdc346a295cc473d565c32093f5bb',
  ...
  'src/third_party/vulkan-validation-layers/src': '{chromium_git}/external/github.com/KhronosGroup/Vulkan-ValidationLayers@0d3ccd48d5567c59c4bc0897006be373f7036d69',
