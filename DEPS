...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'jd3sqkRmA2HtWr6TxkCcowwHIEEDDuoo7WCoceWU-LQC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': '_I_-L0GUSHyHVBq478cSATlWjQIH7yb7JBUHVrWWuiEC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + 'e53760314cac8930de3a6ae44679d89c9525c9cd',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'd8ff62a1a2565ed422c045d26c4a5dd82bd6cf2c',
