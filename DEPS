...
vars = {
  ...
  'src_internal_revision': '368fd8d51480920aeed9e473e914aa4199e3869a',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling Skia
  # and whatever else without interference from each other.
  'skia_revision': '7f7555536e3c71d4404ad82c57fea4ac21102460',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '194b7e6add096ae067a02a3a87670fc21d8a0d0e',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': 'a3f6a9c8a66f1117d7d7f25b33e2c7bb2bc5029a',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '5b453afd40aaf4d93596c8d9340bab6542c85aeb',
