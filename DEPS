...
vars = {
  ...
  'src_internal_revision': '377d5b821faf5b21b9faeb7e5595eade7ad0122e',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling Skia
  # and whatever else without interference from each other.
  'skia_revision': '940a08503b8234d3483a75589b0ef1b38a5fbf68',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'e92be92d2c1537d41acb9d82bacf3c1c19e93ff9',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '09e6b27a2745df6fbbb802aa7c693fe2296414ae',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '34a55c2d3c5e423a6fe0ef28abffa7c7602e75ec',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'crUjFaEpW9EP3I4kqIyQOUp0KaCKfSZzClZCMXGce6AC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'vtqgysSQN-3nULGdR-ioVYh98dnU-rhg_389fTc35qsC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'XgC5BBxKut89_riTWJN_wz2eWS7jNntD5PHfs3oQAWwC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'baa28d0aef79834abeef2074693d59bfc16274ed',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '6b5478a4b27dcce0c8289abaf7ce6976a64ab40d',
