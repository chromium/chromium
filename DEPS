...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': '1ca1589fed63b9b8c684f558b6b3a679f4cd6508',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'ef916d8c4d8690c0158192cd0d14db2c391ca30f',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + 'bc883aef4a5701d9dd033dd93afd101f7079ede9',
