...
vars = {
  ...
  'src_internal_revision': '1b90d3613ae0d6b1f2aa905e3c1b8a3395d7b158',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling Skia
  # and whatever else without interference from each other.
  'skia_revision': '09fa46808e28ff50babd55d87ef5929e41333f63',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'dawn_revision': 'c118734b98b7fcd90e0fe9b665211f062866afbc',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '3db327648966d48b5bd7b35a1f26ecbde3df74a2',
