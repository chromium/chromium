...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '5a1e4e05abda4c55073df6d06c07f5a56d04d1b2',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '59a82947aaa54c28b5daba96d15970a78b4a6683',
  # Three lines of non-changing comments so that
      ...
      'packages': [
          {
              ...
              'version': 'hEi2UztVMrQ-dE8nmYph2vM4ootiHh9HwTdVJgDhidkC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'aV4EFrwBuOkj95Zf9zrRma-XkpKkg9QJrS_FkR2V-QQC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'kpbKdVCrlHibEEAf-IeGRk4LHcQSLkraqKMmGM8Q4AkC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '39b755ba10dae6de0943aa46667988c668598f1b',
