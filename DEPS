...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '0319ad036fdfc753cfc97f6fd4769248bfa6b336',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '78916591659fe35f1afe4bc460c36b17ac32af90',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'd1d02f027dd91a8908bb31621803e393b16c14ed',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '0ad574d9dccbed0d9ac44fa0ca7aad7420c25753',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '13fb5d53a1958e32f297b72fffeada941fdec333',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@b2e03f98270ff86cb689e3e4cfc9bb482b1b3ae3',
