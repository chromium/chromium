...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '4266ee27c940806ecda63bf6492993c2bbc54a51',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@eff82bdde6562d5dcc8301f78a76ad61c775d06c',
    'condition': 'checkout_src_internal',
  },
