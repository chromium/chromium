...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': '5462a5286288facf797f07aeead1fb9c6007cd4a',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/chrome/release_scripts': {
      'url': Var('chrome_git') + '/chrome/tools/release/scripts' + '@' + '7a1b710cf5b585eac8d63eec9321d54ea787c833',
  ...
  'src/clank': {
    ...
    '9aba8609b0b842b1dfd1c7e19626ba870549118f',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + '235088d2c92be0ef47fb167e60519c80e98af119',
