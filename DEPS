...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'adb1ff62bee5aab4b04ca0f32b07a66821f1dcce',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '58ea383e3b3c5b2d19db9d33700b9dcdf2ef3289',
  # Three lines of non-changing comments so that
      ...
      'packages': [
          {
              ...
              'version': '8RNo-PbQgnCl3UdysSGBv8CKV0mlnV6hCTdSrWXqsqgC',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'ZkQsk8oS0DO_tw1Cxb0X-up03iyC3-etadSyodUe6LQC',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'uiRpS3nsyL4RUBCcawV_38sr3BlP1Gmm2Phx5SmARvsC',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
