...
vars = {
  ...
  'src_internal_revision': 'dd6ac23f4337a674dbfb1c7ee96e7062777b1ad9',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'ZKhZtuINYwSdLVTdoOteV5grZU17jXCkIkTL5xRHU_8C',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'tM_HYTADYF102cqjtPK_By9kqrApFe40elbD5pZ57VYC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'KtgOncAXg5rT39YUdJVCU0LuNFhLRPwwjtWiuv54uUsC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/clank': {
    ...
    'bcbef66ee2c2126f37c3411c8544c573a345d64c',
