...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'f5f394b2e3292dc15a07df28c37d506b92de4742',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'boringssl_revision': '0f4721abad67ebc9f9fcc1e7b682c4ca266e5858',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '3e0c68ba18997bc93d7913f7472f7bd3f57340e5',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + 'b6bd27cf5bbd6fbc4157a966c4144f0f7d79cb7c',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '0ce7f03d0cc28f8ab39250482450476a34c06e73',
