...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': 'd3610d0f4d9c29c60d5faac5ff5263038278b5cf',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': '06187cbdaf533f2f0f8cdc59ff8296dc4c658efa',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@736458ed04d126d53b1ac8c1308b529a81163e79',
    'condition': 'checkout_src_internal',
  },
