...
vars = {
  ...
  'src_internal_revision': '76fc33b962ad9d42f19b850929fdb843c66ab116',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '762df8e03839d3f6ca67ccd41739d26b302366e0',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': '70b0a25845f064f57793cc595f61801ac9045446',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'bfcab517629403c7bbf0e50b829a4f9ad94fd99c',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'd6d30d7176096f3503e475e526ff376975dbda6d',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '04ee24493d08714bd9bba83fdbdd0c6568abe1cf',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '17ac2a1b8ce47fe7ee052fbcbcc19d0234938016',
