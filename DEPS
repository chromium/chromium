...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': '1b3751620608adb5dfe89700e2dd9e5dda8a2e89',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '4e899371fca9fd253d22630cbdcf16b6934307d1',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '7b167fbace1a6c5cabe453d08670d5f41ec8fafe',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'b18e96e974d546af27d68986d603be0677000244',
