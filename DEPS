...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': '547c5504127cd8d7a6ef813366c46c0693b8fcad',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'crossbench_revision': '9383401f65b0581cf077e39171a0f1f296cadd8a',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling CrossBench
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/clank': {
    ...
    '54abb4fd77d6c563a17ddcf9392915039ef66a94',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + 'f0873c8c7e018532a7a14880e628c79689e9a8c4',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'a692d2a87e6a6c7981639a8dc14f185e2dc80db6',
