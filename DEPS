...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': '9374b4bdbed3355c0457b4081a23c276c6190d33',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '114901f5e50245d31c07b707cd0f5c3536b13d37',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@7918fcc5803aa83ec7a9de1ed66733abf75c1d4e',
    'condition': 'checkout_src_internal',
  },
