...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '519350816e99a82142712b2e5b6781984a77e39c',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '8c72cc1634db39fcded8d6bd79089f8aeee27415',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@bf63253f710d5c0040c12fff5e11ad10f8cc3634',
    'condition': 'checkout_src_internal',
  },
