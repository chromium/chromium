...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': 'd937440c7b9174376b0225a50c73c5576dc30590',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': '9586397ef5e65fee51f9af383ff9cecec4324b93',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '6a467df9375852f1cd04c23cdd21e6ef61b8736f',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': 'https://chrome-internal.googlesource.com/devtools/devtools-internal.git' + '@' + 'f13a9df437e5dfba3ed2851e1884681955cf26ab',
    'condition': 'checkout_src_internal',
  },
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@95df67421add9619aa9739adae897db16c3fa34e',
    'condition': 'checkout_src_internal',
  },
