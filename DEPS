...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '0718854fc1b4514799c0feaea75f065bea59c4b3',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'swiftshader_revision': '9677c6d282788b0e2b7e2a02d539b5fa86279ee1',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@99a6e0dc737b7ec82040836757723ced6d008dd7',
