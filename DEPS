...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': '77600bcb3cdd9e8964736cde819ccc6ec25a96ca',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': '59Sn1I6e1RNNZ9SEwM1DZYh_p-rjuWVItZINkpXzFX0C'
          },
      ],
      'condition': 'host_os == "linux" and checkout_fuchsia',
      'dep_type': 'cipd',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@58baf1c4c2833bd5bf1d3feeb794b3d129807a12',
