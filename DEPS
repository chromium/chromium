...
vars = {
  ...
  'skia_revision': 'fc6759b235c51ecc84f239b70549380da290d6e9',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@43c6a7d994aead1d73629c309aadb92ea0e3b21a',
