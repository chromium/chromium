...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '17686918fa1f2fcc102813f4fdc56b41b8fb7f2b',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'e2628f92f5ba03fca492edf3f982b237421ab24d',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '2d619e157ea6cdd9cb1b7dae60601dbcc3515d20',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'e0668e3cf6205d4148e1b9bac203d41ad4054a67',
    ...
    'packages': [
      {
          ...
          'version': '7pjTWjDV9repI2ISrfdqJOrLIV795s8PgmJIG_TEtHAC',
      },
    ],
    'condition': 'checkout_android',
    'dep_type': 'cipd',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'a499a53596edb7216021782dbfa72d4d154c79ab',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '3844c24f9152aa4d401e1729fbf8b6926f7fcd5f',
  ...
  'src/third_party/webgpu-cts/src':
    Var('chromium_git') + '/external/github.com/gpuweb/cts.git' + '@' + '4df51a5e13c5864e517ae2b2410c36afb4a02ec5',

  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '4e5b89f77bac5159b03f6e61f1349c046909fb35',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'b2db32c5b5f84eaf538d9f3aea4d394ca7586ae7',
