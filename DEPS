...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'c8fc466db6e3790fcff9e33563662dd0231f1074',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': '00fa9af9e681eb7f064a7724a9e1c8b977e25095',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'bf2ddcb896e9b9fde307edec2810e07f7f7a27b2',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '79078ef753ec4c2b85bc3cb0d252c5e550777406',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'db34cc164929b5afb5fbec2c6df7e3223bd8fd1a',
    'condition': 'checkout_src_internal',
  },
