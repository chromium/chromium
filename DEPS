...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '84ea0dc1cf26f6096f625cc534fe65bde9309d90',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'f340b0eb5cc2d87bd02a0da59cae76a5fa38f582',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '8d074e2c695ecf7d08a4229b08e7ea7d5da07c45',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '16a3031bf9532978f0140513dfd95d1451997dd6',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'bfb6a6d1e32e39943b4e8fb928795a177ef94bc0',
