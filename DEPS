...
deps = {
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '8dd1f99b2ea7f29514f1522c061192d086176bcd',
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '2ca7a20f3978e16c4e29e0f615ad89e7ee3410a4',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '55220c6fa7d031b0e0e432b2cc26a98416c545cf',
