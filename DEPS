...
vars = {
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '02c927fb5f3dcf6ddb66fa4d6e1df21577c6e32e',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': 'https://chrome-internal.googlesource.com/devtools/devtools-internal.git' + '@' + '1f0bdad77d9812bcfb3d5f4a7c43bc39c348be69',
    'condition': 'checkout_src_internal',
  },
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@b136452e88ef90b7930c43ac6871cfb31c09cbc5',
    'condition': 'checkout_src_internal',
  },
