...
vars = {
  ...
  'skia_revision': '75c92131b3761af5d01e58199b17cc1c040306b8',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@a23393ad706b29417f36c73d8e358a4db5eccd8a',
    'condition': 'checkout_src_internal',
  },
