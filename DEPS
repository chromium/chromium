...
vars = {
  ...
  'skia_revision': '9e49b5096e2fcb2169c9c8620f49e63ee3eec7a4',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '075620fa96ae6d459619b052b2c9e7b81cceeeb4',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': 'e5045587752d091991ec9a19646e973a7f99da02',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'ffdb7c251a34034ba986110202d8a5030726ea59',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '4d789841502d5a7f301ed240801aa13350bc8782',
      ...
      'packages': [
          {
              ...
              'version': 'g_pMVaO4gwfQ1xC1PmXD4q9ctKUzQCaXAT9HPA0IiwcC'
          },
      ],
      'condition': 'host_os == "linux" and checkout_fuchsia',
      'dep_type': 'cipd',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@843c0056f8a5bd4b52d77175f76163a7ee87defa',
    'condition': 'checkout_src_internal',
  },
