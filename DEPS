...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'b7efdaa879eb0e887882bd99ba00e11f5e959df3',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '8086a6b0ee57a64758820601c82ea614fdc1a9ee',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'aaef065ab033018f94c2077d33b65ad1796ce33c',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'a6142d426d83d361c8ba3025c709aa53cbeeaa26',
    'condition': 'checkout_src_internal',
  },
