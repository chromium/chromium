...
vars = {
  ...
  'src_internal_revision': '541fc0d68fe04db4c90494d5b4a07d8c6a927c50',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'angle_revision': '1bfeb8a5a3e7630ff771380c0d3e3b169e91e907',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'boringssl_revision': '9ddcda5d267599078d0e50ade89448a7815b190a',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/chrome/release_scripts': {
      'url': Var('chrome_git') + '/chrome/tools/release/scripts' + '@' + '92651eed79f9298ef8aa5f2d6dd82d28de026507',
  ...
  'src/clank': {
    ...
    'e62699b0d4739c7cd17b07f0f28effad100ea3a4',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '608da90beabd448d756a87a0c6bc50a0cc45f276',
