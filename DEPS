...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '232d5182b3f0369332b14c5aa7f449e1a58a12a5',
  # Three lines of non-changing comments so that
      ...
      'packages': [
          {
              ...
              'version': '0DaBU-mtmxQRyWvDGGGmGdtCFToeNn0HOC0hflE1-J4C',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'cpfoxGJXIUypUDtzQNzRgbrwBueYrOQIdcSlIlY6wxcC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'rZODSYffPGm6TqM9inPJtqTyednfXspiZ-J7lJ52pZ0C',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
