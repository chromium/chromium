...
vars = {
  ...
  # and whatever else without interference from each other.
  'catapult_revision': 'dc9aaefb883a8f6720045d839feedd7bfe653457',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'nearby_revision': '0a88efb1de97a0365c26ba416db21869789f95e2',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'e7099c7a57c8469e3c363b765ee3b2dbaa24e573',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@000f813b24e4266a0b40283bada2c5e6502a95a6',
    'condition': 'checkout_src_internal',
  },
