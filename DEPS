...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '09a3e4b0e70e551470f1c72abb02446741928cd3',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '5c723cedaab4ee0779c61cf6e311523b772b5257',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@f28822d735d54073b49fa6e04a7b75a3d7dafe8d',
    'condition': 'checkout_src_internal',
  },
