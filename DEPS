...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '3efb298b0890fd4e4eaaabc0b218104c90ec7f4f',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '2bd6a49e61266906f16bac60c80e076b1a6807ac',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'pdfium_revision': 'd25c46aee795d5719ff2bdfbd11ed7624b94cb42',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'jetstream_main_revision': '1cbd5f1a54d095ea17d296c397fab2cfb4923fe4',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': '37fIvNySXGdcOLqLPj6mAt5Pi6BYkcmTbbMeR73otj8C',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': '0VEvdOfEuu9UYHSWgcFDEJ6vaKIqy69KAH9kklcmtWYC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/clank': {
    ...
    '2245a026c9f526d7efda87d2f8a61bb2e520000a',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + '9c11a99005f5f3b8c17aefad113efdafa2774af8',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@ceb875ce199c34c1b7b43c5e6a974bfebe186c2e',
  ...
  'src/third_party/vulkan-validation-layers/src': '{chromium_git}/external/github.com/KhronosGroup/Vulkan-ValidationLayers@df738a2720f1c3f227f6196915472465e200c2fd',
