...
deps = {
  ...
  'src/clank': {
    ...
    '5e655d0b5542500244d43120823c3a1eebe1f10f',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '140eb82acd09f053780605710fc47d3b2f169021',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@4ea00718ad35e0d1d3cd38a3f57526bd0f118106',
    'condition': 'checkout_src_internal',
  },
