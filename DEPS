...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '5416d6b6390c775b6e55f842de3cf47b696b913c',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '86a243b657972200821a1241331835c913b994d3',
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + 'a853000023857ebd63b4c72802d795ba13a4ff33',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'e1dbddfbcf83f449e15ab4bcb4e3028f543eec49',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '0dc10a3a47f37d731547810c29b0361c9daece66',
