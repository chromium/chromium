      ...
      'packages': [
          {
              ...
              'version': 'fe7MRgsmwwZuqcLvPcVPerYVIbEeitqgYiggowJrSxwC',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'brNXALbCVbQAhdYbj-RM1E2iJMU_x_Q2xuyVszufx9gC',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'Mjtaise_rJeQKgv2Wm6IeGIts5PLlvCl4phvTtXLCQYC',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
