...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': 'a2888b27a98e4ff30085d4d2dba8a1a99baf6dfb',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'ad6e4525c418a92147c8247ef9d144ce4c242a38',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': '50fd896fb21cca91f325812d01d1e971593efc73',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '305a870932d9c9de4bbfe3814d4946b2f6cf2c60',
