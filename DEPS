...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '21dee1081c2170ab95b85ac0da59af59bd839e56',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '0a1237ff95130bad38cce47c806184493f6c57b2',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'u7j9gwkiwf1jWf9OeIUNu3YKqY-JrO5knZe7piMGu7MC',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
  ...
  'src/clank': {
    ...
    '0ef70813cc2ac0975a3e2e60e79362519008aaf9',
