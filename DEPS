...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': 'ebc0b8fb2b85fb38e0bad368fe8fbbc96765331a',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '4c118bf7b6a552db495c0607800be22d4c8c3da3',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '09f5713a6b0416ccc5b5dbcec793c07162bd7fa9',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@42a02f8cf83eca4d4eb71ebeabbd318b82fde3a9',
    'condition': 'checkout_src_internal',
  },
