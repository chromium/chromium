...
vars = {
  ...
  'skia_revision': '24d78778b90f6ccb837fed15aa387fae2f8dff37',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'a10ff6024086029ef2bae0bc50579123227c7968',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '89a717bacf3577a3156787b19508f6b592b6843f',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': 'https://chrome-internal.googlesource.com/devtools/devtools-internal.git' + '@' + '5e51a28610bbb32a4038588b2d68f64fc0c772dd',
    'condition': 'checkout_src_internal',
  },
