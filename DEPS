...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '4050431d57f40328b7aa06661741d98ccc32012f',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'baec26cf66c7dae30594b4a03f696fb3f17fa337',
  # Three lines of non-changing comments so that
      ...
      'packages': [
          {
              ...
              'version': '_QWePjN4jRGvH3fvbR-iPv5NLYm_UQkghOmTr6DdJsUC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'KRfi0l0XRWPGJ_Pm6x98EM4-qGi1jaG4iES2SESKF8oC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
