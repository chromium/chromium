...
vars = {
  ...
  'src_internal_revision': 'c06a42faddc8d65e13c627bfc90f48d9b099f119',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling Skia
  # and whatever else without interference from each other.
  'skia_revision': '4fe64907eec20ca726945904e768a5ba444649f7',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'angle_revision': '60e3f72af6be32126406cedf8eb9fe95772bde6d',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '0f8814d83d9733eff4ec2c8f2b8c8d0e8d449d73',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': '2Sxkt2TSu-FYM_YPfzFKneo7OsWbFNWqAjYzHlM5E5gC',
          },
      ],
      ...
      'packages': [
          {
              ...
              'version': 'BnyUl3oOt6o209V-bZLwz9hq-u7XPFdDQzGVVWsyGwEC',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
  ...
  'src/clank': {
    ...
    '4b1002d0eed7a8d72db34e6fda402fa6da339f35',
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + 'eb60ab38deeda6975c9b0fef883978f2a9f69120',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + '714365290796a154d38534f29b99d6e045636bc3',
