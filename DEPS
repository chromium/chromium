...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '89794f0b5384055f3b673b4accb32b88ed568852',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': '0MDeo3ppeMCR7GIikzDFBZCSphduwOygPfMKT0mLFrIC',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
      ...
      'packages': [
        {
          ...
          'version': 'p2ak7auzk8rDPbYjWo53PqUc8iyP162QD5WFRqr3lXgC',
        },
      ],
  },
  ...
  'src/clank': {
    ...
    '00b16a13561790868a74ba8096848f94d65886c7',
  ...
  'src/third_party/openscreen/src':
    Var('chromium_git') + '/openscreen' + '@' + '665f839091ccb25cc2c388758770ac1f0c84d20a',
