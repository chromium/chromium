...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '2f5669dfcbf9568817f5cce5b6add6ed4bf91314',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': '7489c5f0b9ad2c2766e28a3d509b94db64db8720',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '78db5b60419a9fcc1ee0f78a64b1ad93a3716f85',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '5e84f719fa20eb83c2a49bd3ce436602191b5aa2',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + 'cd959327cef23a4b4daa2d354162e4e2dc1685b4',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@17d345a0f23dd6b9f89e1eb6c31a336dd40c5112',
