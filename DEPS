...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'a400e76d02df52995736097b8ac3efdfbcbd55c1',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
  'dawn_revision': 'a0eca4a3e4ff8a48c4c6a6dafbed5a90d0947e5e',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@b750c30572795ff184f9a3a3c9fa1bbf0c70cc4d',
    'condition': 'checkout_src_internal',
  },
