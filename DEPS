...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'ae02c3292a956555a00f3237edaef2962e8d89a5',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'crossbench_revision': '5f7a4dc4cc3a85a0537838c5da0a1bd7de5e237a',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling CrossBench
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'd865a7530c9d76d614783ac8d66e0fd90b298814',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': 'cd3a5de0811f5f5c230e850864f583b8f086cf3e',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': '9RU9KGPQrYDyas3ObU2BdQMJWCHCtgZg-0zjvFuVoZsC',
          },
      ],
      ...
      'packages': [
          {
              ...
              'version': '0YwWU6R6WEJmUhbz3xpVduT-sAccbCBMrAIBvxsLpIEC',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': '0B_rePk2dOyON1lOqynMtb5g6pAuq63V6eOTsUPFGoAC',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
  ...
  'src/clank': {
    ...
    'f7c13516d2292487a106a038c749105122298e9b',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + 'f3b1787ab1aba6c27dc97c0e4cb704137f0bba26',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@85a6a41f6beac9176574e6a2a7b8887e8b44771d',
  ...
  'src/third_party/vulkan-validation-layers/src': '{chromium_git}/external/github.com/KhronosGroup/Vulkan-ValidationLayers@b93138a75edd4cb93a5e8b00c8c1ff749afd4783',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'a4867cda199ced8f4a30d0c780ecbabed0b5a11c',
