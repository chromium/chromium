...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '04a70e9456ebf54949162c38fe8174ddf2e2fcec',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '86f0ffa32c9c36a8af8d293172374d2b7f625f4f',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'b5a81c5103ee08f3476087ccd3f7494c26d34cc6',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + 'f3951539fede7be03fa252128431b67beff49d3b',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@d5b84f78a00ec27e44bf811b5acfcd788940e53b',
  ...
  'src/third_party/vulkan-validation-layers/src': '{chromium_git}/external/github.com/KhronosGroup/Vulkan-ValidationLayers@4e49d314a38e0b8865428489140d90353204ce61',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'd020a4e4957bc209c39cdf531278dac09ca0c22f',
