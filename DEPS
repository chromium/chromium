...
vars = {
  ...
  'skia_revision': '7cf6dab7a92f126f5d5f4c6b23a7b9ef42118140',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '3824393ab855f2507ba18ee85e4f282562a2dbe8',
  ...
  'src-internal': {
    'url': Var('chrome_git') + '/chrome/src-internal.git@3924b0284b5664e8482623c32cb51aa29270b722',
    'condition': 'checkout_src_internal',
  },
