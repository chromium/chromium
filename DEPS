...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '536f9b540f9e57ec48e0909ed530f13a60d74b72',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '0810b2532fed9d4634f686fe4090c2628a679358',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + 'be9dc5976ef8fccb58a82ba75794ef03676c9a64',
