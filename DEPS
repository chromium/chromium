...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '8f8cd76e6ffe4aab961972ae9f28aa01f908ab7e',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'f1f277fcc92a3b6e42ed2b6e6e03f8eca9a2245c',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'nearby_revision': '911d55ff634e39fc14a9395e0ffe1d86d76e43a7',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'f820635694033daa15281dc8e39f16274b8648c9',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@356a05c8a55390aa1137500e037c0dc3582b0973',
  'src/third_party/glslang/src': '{chromium_git}/external/github.com/KhronosGroup/glslang@0e311906b92f8cc74eab258260343074b00a9710',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '1707a7d9d1c3f492b761eae5937b443d56120a8f',
