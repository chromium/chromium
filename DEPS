...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'e02962c02f8130bb93a66102739f867a2d973d36',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '1e98f95391647887d0db25dd5d9dcfba7f87ebd7',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@be26798276be9f3cda2d70597c79b1ef3478b438',
