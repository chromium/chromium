...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'bafb3bee4e5115c49a202ff6701b499b160206b0',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'boringssl_revision': 'cdd30d5d710ad6a33835babd9dd0f07bf2b11c51',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'e0a876566751d866422357f93a92208153fdb579',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'c0f9917cbfedfbdfc9f06c8173c9273b4cee207a',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '773122f82c14f4be5471661edda6e0f7d4082a68',
