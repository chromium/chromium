...
vars = {
  ...
  'src_internal_revision': 'd5bc54b68859d8c227c8c66df0be100dfd99f2f9',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '89f7998441f124a69253c526b1b0610e79fb6096',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'nearby_revision': '1e1d841965c11f8720a863669af205ca60d0ce57',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '3596e35bd7e5330c6523c596e5c5287ff90f76e5',
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + 'ddda8ae2e478c71a089cd117901820e41b3d84c8',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '4dfe7ea5afa4cbfde1bf0e5579aec362ea1a4a09',
