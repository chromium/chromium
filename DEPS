...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '0fac906712b30620e3bdfd6d85cd79da96532b41',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': 'f3867db40efe947a22be56a5d0e5fcdd17ab82ea',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
      ...
      'packages': [
          {
              ...
              'version': '1tL-m3dyYpINJ_dxLRwIWo2YSxNh1ZSRNBk4X9B9E3cC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'Jr-JKz7Wwiuh99rlzEEtSH9gI59FIBupIxtvHOMup08C',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'Hu2vPo2YrNY8LP4Ng_kl45fRk2CRjBJONhPNd4LeYJsC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
