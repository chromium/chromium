...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '108f8bb41c84d9d2e708c49480b3df6f029ea39f',
  # Three lines of non-changing comments so that
      ...
      'packages': [
          {
              ...
              'version': 'zgV3d4KcZLUa9d16zByvHfFSRJyWe2OALkGIqoq4kz0C',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'VNEuqbLwabLCHox8b1WnWb_Bvv4qXd6W4ooHIQiB5WgC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'lxNf2fsxI7Bf5aTbJop8sYp_zLuMa-Zt2GsXxMrfpM4C',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
