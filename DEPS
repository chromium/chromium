...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'ef5251b7f82f041117d2545d00e1757a0151cc7e',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'c2c17396c9e0da3f1ce6514c3a946f88a06b17f2',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '728ae41a6987c3c505258fbed695e074cd970ead',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/clank': {
    ...
    '3058dff4ea101d0f40c5984401512d8a67aeb801',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'fd38deb31f6378d62b6822ea0c3b3b825dabe53a',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/webgpu-cts/src':
    Var('chromium_git') + '/external/github.com/gpuweb/cts.git' + '@' + 'e5f120ee5cfc477b1eeeb4b57a402a831767ef00',
