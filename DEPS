...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': '203154b52a462070e774072abb3c71882bd9b61e',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling SwiftShader
  # and whatever else without interference from each other.
  'swiftshader_revision': '5b36fbc5ed2b330b2bc02c93ff2bdb58d03ae051',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '8d1dafc6c231e7d5fa2204b3bb4d6b5275e25dff',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '03fc9a3eb3f8ac993f244ed2dfff426e76501eb8',
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + 'dc8ef8034344ffc445da1d16754e84a3cbebed13',
