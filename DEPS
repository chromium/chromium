...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': 'e0cf17ed03ffd03c1d3996065fd2cf016ae21fa7',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'angle_revision': '031596231c6732257c8ebe172120bbad62ad4a93',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'ypzTaJKLIObzzwx14OkbvnEdMgITCnLCMmTM8eQ5VW8C',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '26a3f8e2cd5837754c0e34fdaacc4b32a81329c4',
