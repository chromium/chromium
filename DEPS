...
vars = {
  ...
  # and whatever else without interference from each other.
  'catapult_revision': '64317c59b532ee97e357fc29562e7e145d8e9f93',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'fde2869de510da0a0d914db29671be8c141382a6',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '0512dc45b8f86da2b0b78f77250e47ec9cbd68e2',
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '9e4325bd32708deac58fde08a7b3df48725f8b48',

  'src/third_party/devtools-frontend/src':
    Var('chromium_git') + '/devtools/devtools-frontend' + '@' + Var('devtools_frontend_revision'),

  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '75d4834eda67058cafb83d6b06ef801d78164b33',
    'condition': 'checkout_src_internal',
  },
