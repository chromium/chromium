...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': 'c0ae5e46fd2c076b917ef20ab59500fabdb89e1d',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': '8b60855ba90cca4384cf4eb1985425f383eb41cb',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'catapult_revision': '5302adf09e893ce9a72b888844175ede25f67e02',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
  'dawn_revision': '62238ec684a8e89a00e7bebacabc6e6dbbee03f0',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '6c3c3db184940371384b5c1b85a29a1b8cb1cc2f',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@081967a9be8d13dfb162c910a92daebf483dafc6',
    'condition': 'checkout_src_internal',
  },
