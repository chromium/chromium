...
vars = {
  ...
  'skia_revision': '0bc32f23f69e3ba865f665745d33a420676de319',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'a8b2b4a5eb3968236adf086f3e6d03be6dc8d318',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '0489cc12af57e3384c8789f8b12ac5cfb0f48ad0',
