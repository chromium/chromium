...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '18e868627dbf8e3d5b35ff7c739b0226bd13bcd0',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': 'https://chrome-internal.googlesource.com/devtools/devtools-internal.git' + '@' + '11145adae77813bcc053bd08790b86435e54db74',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '157c42b26e6c5904c6e443f352a14d1f36c9f801',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '504198a50ef116cc877e1fcac5f02481cdee9718',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@90185bda8c5c099ef8abfea60467c1d3cfeccc7b',
    'condition': 'checkout_src_internal',
  },
