...
vars = {
  ...
  'skia_revision': '28c9c8b9f5574991b67db3b3f47781e0c8ee5659',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '21fdc5bcd967bc0549648197d771106869442a09',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@fc45e546b217cc9e003c62647bbdce20dcc48481',
    'condition': 'checkout_src_internal',
  },
