...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': 'f7f63e2604e9d436f56daeaba55b103b578fc19e',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'b42cee1f3afc538f0e2339f3abf2b571bdb349db',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'e5cbd01063643f1d5a550a07994c0ed42ca7ddf8',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'e4bf564b982e8460c0b3f091dbe737fb43aa69a0',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'c2917d4b9b868330ea050a1223d026efd8578ace',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/components/optimization_guide/internal': {
      'url': Var('chrome_git') + '/chrome/components/optimization_guide.git' + '@' +
        '5a7e8779ddb59559f7805a763c2da46ab4566edc',
      'condition': 'checkout_src_internal',
  },
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'fbf83b2c3bfcd9f232971d513e4ad3816608d3e2',
