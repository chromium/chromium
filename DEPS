...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '0bd243efded55c52060d25611b9df8f641a1b918',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'pdfium_revision': '7f0bb5197ed133c92ceac8c0009f569caea4f065',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/ffmpeg':
    Var('chromium_git') + '/chromium/third_party/ffmpeg.git' + '@' + 'f7a2aaa56ebda21cff6bfa021ba363a715a5ed9b',
  ...
  'src/third_party/icu':
    Var('chromium_git') + '/chromium/deps/icu.git' + '@' + '66b5d2f0fa0fec806e2edbcb369ac59722782c48',
  ...
  'src/third_party/libaom/source/libaom':
    Var('aomedia_git') + '/aom.git' + '@' +  '3eca8ad6b0b52b2c2a897dcc398400434083c836',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@c148a85bb4316fd6b6749888fccd9bfd721885f8',
    'condition': 'checkout_src_internal',
  },
