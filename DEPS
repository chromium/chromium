...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': 'ef5b914f3d672592d9c56eb974df3ec2875f9239',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '13812f6305d418de0588de694e1c73cead1c4c29',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@8ed307d4f7fb660d03bec53896ca68202c7e5fc6',
