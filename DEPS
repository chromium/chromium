...
deps = {
  ...
  'src/clank': {
    ...
    '35b1cc3e2ccc7a1984e448e012c9e4a7f81d3074',
  ...
  'src/third_party/eigen3/src':
    Var('chromium_git') + '/external/gitlab.com/libeigen/eigen.git' + '@' + '47a78413da2e2c8cf6e314effef3aa120c4bb038',
    ...
    'packages': [
      {
        ...
        'version': '_YJe8YJ3YEtk_1eu4NOlE6qPnpuFeZYOuJHufvCOaHAC',
      },
    ],
    'condition': 'checkout_chromeos and checkout_src_internal',
    'dep_type': 'cipd',
