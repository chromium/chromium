...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': '046327343595c94f82d3075451c968cbe5ee8320',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'd602700b9e64579b804ae6472a655733927fce2c',
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + 'bdcdd7c2288bc835a314aaaba2909978bc37157f',

  'src/third_party/devtools-frontend/src':
    Var('chromium_git') + '/devtools/devtools-frontend' + '@' + Var('devtools_frontend_revision'),

  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '9bed69e81b193b5339e9c5ad2c87ee19efad86e3',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '1bea8ecadf920fb073e4c958d2bc877da753d722',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@1c484942880c6fefb0f5e2b4504684a93e0ad81e',
