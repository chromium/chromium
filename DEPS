...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '94aed216f4b20435b76ad68d24f5f8abdf49f6d4',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'f183d1d9966b312006e395dc4c270639b35d26de',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@2d121531af4e96f764fe4e5f8ecc7b2a3e1907ed',
