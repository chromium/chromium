...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '554b798423c371d187c505b405232c974b266ebc',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'f51170b395fc3e64f926864a14fb3d49cae9d675',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '8962d5956dc4dd2d718952ea7aa910ab5bc52aac',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'f9ca1847f5baef18501e35a9335ba47f81d2f187',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '99e2e8fcfcdea670b5d4de96307ae388c10b5fe9',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + 'f42965114c40311c0c73e27ad56150c0e5540bda',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'fb299fa2044a398aaa68fac3d81a1e70247d37a9',
