...
deps = {
  ...
  'src/chrome/release_scripts': {
      'url': Var('chrome_git') + '/chrome/tools/release/scripts' + '@' + 'c94663f27cca726972fc8123d3d79ec7f34bd709',
  ...
  'src/clank': {
    ...
    'd3269195e2a0b905fd7f0fb3f8a3b5961968284c',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@31f2bbf5c72d49a7f7e1685702e42dec61ae005c',
  ...
  'src/third_party/vulkan-validation-layers/src': '{chromium_git}/external/github.com/KhronosGroup/Vulkan-ValidationLayers@dd0b80a72086896e05e16c77d50b3016a81e7061',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '15a446d802ed6b4021ed0850bd3843a7a540967a',
