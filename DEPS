...
vars = {
  ...
  'src_internal_revision': '9483c05f72f8214d2e73e2f9bb67cc5db01e7151',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
  'cros_components_revision': '67561ee428e5d22a2a552053cb369b47c7c28c56',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/clank': {
    ...
    '0f3f5dcfe2511df9df35b5986dddcc9f8ebcb5a7',
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '450aa8d76cbfd4635e2650dfa6630a1876eaf3f6',

  'src/third_party/devtools-frontend/src':
    Var('chromium_git') + '/devtools/devtools-frontend' + '@' + Var('devtools_frontend_revision'),

  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '1df6a188506e002e407649c25803115a5d8808a0',
    'condition': 'checkout_src_internal',
  },
