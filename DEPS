...
deps = {
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + 'babe2e011914d2b97f10da36b1154e41a46ef625',
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '64b00eacb96f0540f69f9608cbced098e7c6d755',
  ...
  'src/components/optimization_guide/internal': {
      'url': Var('chrome_git') + '/chrome/components/optimization_guide.git' + '@' +
        '63d13e603e74fbf7fd8bda0463500cf536ea92b9',
      'condition': 'checkout_src_internal',
  },
