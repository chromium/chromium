...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '3b78b78b61377ebeb38f2790b55c4d8d3d7e8538',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '11bc35c1c540586f780135f33237510f9605ee22',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@003296c175f0098282c587af84e9435527524fe1',
    'condition': 'checkout_src_internal',
  },
