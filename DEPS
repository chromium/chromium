      ...
      'packages': [
          {
              ...
              'version': '8amnC7e2ZZrSwDezjE6R_BHcaJ_hK9xGQ5v472vxuzIC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'fsdfbM9jThI8ASRe7PdakjbW6MIwbQKOq5JqDBTXAMcC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': '6kudJdtS1UbgEi1O70M1ePQ64S3nQ_5Yy3RbZXETEoUC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'XoVQXuLQOOH_NDJNiDnZWtzHDUZxcK-iGTcsNdhiyPYC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
    ...
    'packages': [
      {
          ...
          'version': 'UL6BZ9EIGUurtyN2FGY30YoW9ov97kE0du4ZgoEKc2YC',
      },
    ],
    'condition': 'checkout_android and non_git_source',
    'dep_type': 'cipd',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '1379b190400907d94080b8ed04cc069c9acb7415',
