...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '504086429f556d51873e0e48877f37eacbf4ab33',
  # Three lines of non-changing comments so that
      ...
      'packages': [
          {
              ...
              'version': 'sCva2puEPO7xNA_QokgboOgIcY0FjvNWQz4ii9IS4pQC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'FVPYEUp7IrxPxjctJ6l9gk8e2gLvtkDEE8NTwzANW90C',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'dzU_KldnKrLv7TbyJUf8ODDyv90XW_tF72QaZdAJD38C',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
