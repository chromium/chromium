...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': 'a781880b38f1b29c83c2109f3314063162da118c',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '7d3290f0062264dbc71de6aa876e45efc1da1a6a',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@a7a04cff6da51268700ef20b9f8e1d0758134693',
    'condition': 'checkout_src_internal',
  },
