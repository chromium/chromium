...
vars = {
  ...
  'src_internal_revision': '8c21f86fc443887c87a40e4464396f56167e4907',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling Skia
  # and whatever else without interference from each other.
  'skia_revision': '0c243ef46d3b2cf82ff71a769cb4870de6939b3c',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'crossbench_revision': '4a6d8e47379dfdec8ac4cc862cf21f0820caab2a',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling CrossBench
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '140bd91477a1c72a081343b5897a38bedcdf8cce',
  # Three lines of non-changing comments so that
      ...
      'packages': [
          {
              ...
              'version': 'wfkJ1v6a1rVxbL1Z8vUiWWhLLoOolWlESrPxw_GgiiMC',
          },
      ],
      ...
      'packages': [
          {
              ...
              'version': 'eWXJt4IvqM2DmTzy1MV0edTWTFkouyp-tKwAaEJ0vDkC',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
