...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '39c55e16d889eb5193214c328de81250dcd97349',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'catapult_revision': '032ed8560c6ed8302564e3ad2afa33e9926f903b',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@bb8dbbbc9590d761b881ce6b8100d78d0d89253d',
    'condition': 'checkout_src_internal',
  },
