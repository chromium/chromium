...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'c84d7818f7460c800536e313e0c360752eb1af4e',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': 'f7296e958b13db1adb033daf042d560169875191',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '2b9539184610b02de11cd78f05ffb1cc5d528e93',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '4ddd1657c4fa3222cc1312a371465ef668d49a46',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '0da4e10671f17ed3de660f83a3c175b982ef58fb',
    'condition': 'checkout_src_internal',
  },
