...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '6137414bef5cd6ffca33579d75f0532b57bc6f42',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'd3728521450c85ef422639605b9ba2098f52f6f5',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'c68d28b625d697d1f605596917d6cd4908e5009c',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@bbc872ec2e938f2ee087a7058e9f3d4716755f96',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'adfd0210c8e478807273ea7cf1edb9fe0bdab87f',
