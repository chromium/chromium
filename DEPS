...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '958dcc7b6c1cae90df64c6bfa95459ff91023f8e',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'boringssl_revision': '0f55aa8416787562e57bc962b9c4aeb70261cb7c',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'crossbench_revision': 'c01232b38c62c8d0a3a1b68745e6b6e0a7ba8f13',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'eaf6b4cf219721e8d904471d0ca42ffd7426e1cf',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'e89bdccc4c04df352a4b65e15cf89ebbb04f0cb2',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'f3dd05972d3cb332a751fd6fb1c566363c70a4fb',
