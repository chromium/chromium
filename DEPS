...
vars = {
  ...
  'src_internal_revision': '491471c683c23cd8cd205b3d7bd8b9ff25a5db61',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'ddb4756a90fb7d89dc789859f8b2a3639d8de125',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '6a6719ee09f1078356fdd31c69061e07b5c61c2d',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/clank': {
    ...
    '758e2644d4b2e371f8eee252bad96469488f593c',
  ...
  'src/third_party/libvpx/source/libvpx':
    Var('chromium_git') + '/webm/libvpx.git' + '@' +  '893c9f6d070cc3bd8503152480089673f57fdf76',
