...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '47870d57277087777b9de9735a1a894e4e6ea2ec',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'f25383729afdb562c78de348453ab9a6620c550c',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + 'a46bc5a9c616bb82bdbf7e54205a722f4994906a',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '58bb1686f164d89b73a525775f174b668127ebf8',
