...
vars = {
  ...
  # and whatever else without interference from each other.
  'crossbench_revision': '11bd801a8a0d69d87b77e6bc4dc80ef7e5bbc43b',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '95f2596355c0e3cb8136c982183dabca690af722',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '869f82232611bdae2880473bde7a66fb997b74b5',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + 'b8c36d812498ff32773959fef6c2c40e8eac7ede',
