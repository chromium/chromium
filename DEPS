...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '84ef9af1b07bbcf3249d3fe55b06faed5f539faa',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': '757dd6419291106a7a770305005c9b306ffd6deb',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'f1766eec8dbec58d04c7cf169765b9a26ebe48e6',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'c035698fdc582a3fb732d26b2609edae02baa7fc',
    'condition': 'checkout_src_internal',
  },
  ...
  'src-internal': {
    'url': Var('chrome_git') + '/chrome/src-internal.git@bbc0c6c5c6d0afabbb2a13e7441686c6d44fd462',
    'condition': 'checkout_src_internal',
  },
