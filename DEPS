...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '6c08afd9f3d00be33a4dc3f58256a6dc11d72432',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + 'efbcdf72c021840bbc7c9e4f483f451d7eab677d',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@d59c41b8658fa3407dbb194047fd99aacfb02a70',
    'condition': 'checkout_src_internal',
  },
