...
vars = {
  ...
  'skia_revision': '2f1f21b8a976e9177d03149e3b98e06f05bb2cd1',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '249b346bb9f3f458107afbe2b5b83aac4def80e2',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': 'f4d94efbc335db33e007818fdc5bbc648596b716',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '53a9c7a2a012680a34802e248cfab86c15c435f5',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@69d373ccf48b70cd8220113058b88268db0eddcc',
    'condition': 'checkout_src_internal',
  },
