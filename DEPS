...
vars = {
  ...
  # and whatever else without interference from each other.
  'crossbench_revision': 'c1184df451bd6d99a58a60cfd6d41d9d5c9fbcd9',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '01f70bb2cf878497e089f7ff2047d32830f1da9e',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '0ee9f870976b814b54140c8f2bb170837d3c9f83',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + 'd7a0fbbdd095ac711ef4ce704776b3b26b1171a6',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '65ce9656f3fe01d8ca9f913976b128fdf203fb4c',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'ac34a0377938f5414716c5a5d7e99a9f6393df64',
