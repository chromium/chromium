...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '09fc8b866cc4f7ea442a5928c0e593084e847172',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + 'd697fe0d742357f8217fba8ca825574d7e01e07f',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '6f2bf6deb3d6fb5744ef722c878ed701792b72d3',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@6d676cf85cbbf44079553d2fdd7631bc19c8f626',
    'condition': 'checkout_src_internal',
  },
