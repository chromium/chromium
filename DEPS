...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'f11eb737212f1f5e733d259a0a0dd2ff24dea2b9',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@df8ab001c3f9565168712acac5783ae94a13bfbf',
    'condition': 'checkout_src_internal',
  },
