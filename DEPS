...
vars = {
  ...
  'src_internal_revision': '0c19169e92797edcea3018399bc0394ee42b831e',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'd81834b6226544e962f6bb65da39f4cab47ada54',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'boringssl_revision': 'ae9bdd34a0c11ff62fd8fd086767a8ccd341f0be',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '79b9dfe9a903f167b06cc2457d94b1704e56866b',
