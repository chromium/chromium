...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'e563110ddfc1cb99527d33bed497d2bd49d3e0e5',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': '193e9cdada8e7c67765e1b6a2f4d610d3104706c',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'd65aeaf606961938b7dfc27c54d571a5e3c46333',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '54f9191b54bb48c0be88b42eac1ec5cccdd80e72',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + '25892c67b6ff761aa15bfa64ef6a94b008df351b',
