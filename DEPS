...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'f78612cc0f8963fd0083c897c2bb153b58a775b8',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'cf573f201f67a999e33ef2ff35a3d44fca64f86d',
    'condition': 'checkout_src_internal',
  },
  ...
  'src-internal': {
    'url': Var('chrome_git') + '/chrome/src-internal.git@0ca02b67b7b25930a94b17f3278af7a81c5c38ac',
    'condition': 'checkout_src_internal',
  },
