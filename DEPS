...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': 'f78470f22767000f6a169bb8b0ebb19b1f035ae2',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'ff95cc93afacf096823e7202d57695710001c89a',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'a0944c59e9e6a2f93f24155efbb83b45adfe5f91',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': 'bfb0f1fba4a0b1f10458d8f848c36ea77eeb4013',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'iTUtmhPx6-TjaEhyIASOg3CQTHBSjSstZXa4jlrIVrkC',
          },
      ],
      ...
      'packages': [
          {
              ...
              'version': 'uUR51anJmkViAWCV4f1M1-sdxsxi26Kak4ghRe2TMg4C',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
  ...
  'src/clank': {
    ...
    '32247f352cb20acb659e7b82a390f02d3d79ee0d',
