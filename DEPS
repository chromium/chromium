...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'f5e64e21f4998043f3122b12ccb378908bed7cdc',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'd4516d86d3d949493976fea526b059749ff9525a',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@f50ffd420f04e1efa2410bafc5dcdb42d5d4a9f3',
    'condition': 'checkout_src_internal',
  },
