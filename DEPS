...
deps = {
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + 'f8b43ac95d4fa826b01f4c63da915093518b1bb4',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + 'b3cb179514bc1954c36a9a2f087988d2630c411f',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/components/optimization_guide/internal': {
      'url': Var('chrome_git') + '/chrome/components/optimization_guide.git' + '@' +
        '9e414afd7c796e8b4d5834931d1d9bf9dc65797f',
      'condition': 'checkout_src_internal',
  },
