...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '64c530c3fc1d4d775dc11fe085fc6ea543a32a76',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '3558379c044dec4b2d64c2de3d8da11a62d4ce92',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': '0d458614fb28f42cb96a54e6eece8076bdda16bc',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '1ff27e633a54ac532be30157137f7991b27434dd',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '3435ae3d2d0cf0e272662f2f01119c1f88b8dac5',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '431b57f4b945573d7eeff3feafebf545ad67713a',
    'condition': 'checkout_src_internal',
  },
