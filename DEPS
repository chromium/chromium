...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '4310dae171ec5ed3d99ff910c662be168fb4dd93',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'a47c3bd29c0e69f7b5526c9006e1b8f89a2ce2c8',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'b40b9967695365e0181e5b9a285f467ae5f52dd5',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'b071871aa06a8db400b000400f0fb8bf7c247904',
