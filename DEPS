...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '05638eeeef1636e5d19c925ce082b552f057e7e0',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'angle_revision': '17904b43c75d017ea23d0577d976a431e1ee002d',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'f6d32836fa0eb5394657749019b227dd510d7a40',
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + 'fbb90a5af29abb899afcdb6623784a0e2048b7d3',
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '9294501f951ea2767faaaf74c3dc69bc6f81ce57',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '1227edbb93df1b365a50e390a88b763ef1f3bf1b',
