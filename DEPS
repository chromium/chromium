...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': 'dbd1def27aae86c874f5007fb8a7b7e0b433cb55',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': '36386cd79b45c2d7140ad7992454e58ea9f9addd',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@2d996b471b43ae292fd9e4c2bd38cfc77397715f',
    'condition': 'checkout_src_internal',
  },
