...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '77a883926d1e92b28ee73f6805c71532aaf75a48',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '84442c6766618bdbe2de64f2fbcdd4309dad160d',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@ea473984ad3941e19a2112be20b45a3eb2ab54c5',
    'condition': 'checkout_src_internal',
  },
