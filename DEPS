...
vars = {
  ...
  'src_internal_revision': '5915359011e55d8ebc7750fcfc7fdbc70d4f7ca9',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling Skia
  # and whatever else without interference from each other.
  'skia_revision': '95252854a0eb1816fd1af18d95c7ec3f5ce75de2',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'ed3b55ddd4c484bd06ebb3a82e5af5b060e96153',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'e470028e674230a15d22b48e6b314c0572927820',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'ca1ca3b1b3630afc4dc48ab47e6db7c6eb18887f',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '725162769ff4ae49167143fb44fed84460427505',
