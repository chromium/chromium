...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '4502f88af90279ad2685528bd3cf7e90ab140f19',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '3ab1df504f1af37a64f8d3949e77b0868e154894',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
      ...
      'packages': [
          {
              ...
              'version': 'W4Vn2bEn43EezooAUMofgpkVis6AQ0UyuAhT-LcEZlwC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'TPRw4aDiRdezMNHrvzAeOKvbXSMP3WxmquEALmV7m3gC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
