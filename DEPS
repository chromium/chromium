...
vars = {
  ...
  'skia_revision': '5d9c20ecc96916f9364e825df9690f70a122c1f6',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '47d52df761519c02ad8273a2240ce7e6e5175dc7',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + 'c2358f484dc4014eeca62763fe642f72f31d3f64',
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '477a53fcd228388dee2ad5cdf3f97dcaabf58f4f',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@256630ef39b721bc95373816012ef2c962e635ff',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@45e010751de5e1fee849a289fa344e348f386820',
