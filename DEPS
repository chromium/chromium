...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': 'ad9fc9ee5fb0bfd199b2db596f823395431f53c6',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '1cf434910e25f5e25ade45a6ff59548bc5a5a743',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': 'fa028f307139f9f4c46dd81204d0872b233ce222',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '53211135e2198d991b087354704ef2ab047c6ecd',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '83f27136a770d949cf005c49c8e339d283e8688e',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'f3b356c5175c406e5d8d55de10c58e17a067058d',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'b2fcc4b573100e771b803a0bc0d89a153503b3fd',
