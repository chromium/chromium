...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'b62f8dd1164a7486646ad9281ffd6f02aa926e1c',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'catapult_revision': '64e004fc4fc94e7a48dbedf0428c31f920f17342',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '0f402641d07b62c39f271bd764388c664d0e5ad2',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@8fc5672c1cbf2cc23535e90f4b1abcab3167fcf7',
    'condition': 'checkout_src_internal',
  },
