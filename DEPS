...
deps = {
  ...
  'src/clank': {
    ...
    'ad4dcc1d7f611d9296a670377a9f2bf77d03f387',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'bf36fb2989571925c1344d79da49ef91a6232c75',
    'condition': 'checkout_src_internal',
  },
  ...
  'src-internal': {
    'url': Var('chrome_git') + '/chrome/src-internal.git@b0f366c70952a049a3c7c5043ee526b778dacecd',
    'condition': 'checkout_src_internal',
  },
