...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + 'b3694fd90110c28532e47831bd1ffc517d0ccc1b',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '8c6d88ff5c5d8d89b93e74935aa354d58ef3799f',
