...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': 'cd1739d16aeede9a5d85c9afe57cd0f5d94ed639',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': '6cced91b3d9272ea2f62c7427defeafb06c18d28',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling SwiftShader
  # and whatever else without interference from each other.
  'swiftshader_revision': 'f53de1aefc33267c4e5432f19d54a968b5326d80',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'nacl_revision': 'f120c761bda09fac43f13a3c1c3c3fa487d682bd',
  # Three lines of non-changing comments so that
