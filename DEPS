...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'bb106889fe8d7bbfc13a0b2e015631c445c87e14',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'df5e207e1a8fdac0bee0541be4dab44c4373ca36',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'afa99b525e76f46069a7a1bcdab8bf8f732862f4',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'c0a994f7094476d8388b23675f66d2344472427b',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'a158ea09f6587c7025e0a5e37615f13f3f2a8f99',
