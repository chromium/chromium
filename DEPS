...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '7a8acfb06eaa02012c45b535aa0efaa8a92c6a56',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '024112d5bcd56c49846f6fc6831623631e2bbcee',
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '94423c3343b0e789bbbc066dbbd3d0ad686f225d',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '6379518655753be85b56de39335a2dbcb1ba3685',
