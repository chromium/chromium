...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '7407135975aa531c6e74fd63d14eb1ec4bdb0fcb',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': '360cd0d17291aabe28e48f26aca2ff300a6db5e5',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'catapult_revision': '268f683c726e7ccacafed33ae546fa3d97a3b406',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + 'c40715e2d23537de16c479a87e7f492f61f57b0f',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@240e5d5016c90138418fc2dc859540fa75af584c',
    'condition': 'checkout_src_internal',
  },
