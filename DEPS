...
vars = {
  ...
  # and whatever else without interference from each other.
  'swiftshader_revision': '35f077086ef34ae8d0cabfba346b602d08c49160',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '6def748c92e9d9b41250e8db22f3c56b67640c29',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@a5103e45d8084902f58c7e103731a8cbb74df5ec',
