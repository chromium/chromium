...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': '0aa8c4b8547c8c0744284ea88ebcffa28049a611',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '812fba096005a2e8dd68942fc305f4a97310314a',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'webpagereplay_revision': '8bb88234a0959017eb35d2086a4bf4c5d5aff029',
  # Three lines of non-changing comments so that
      ...
      'packages': [
          {
              ...
              'version': 'Vuq-I9QbjAUat4-nCpvAtZh-S7bOzuhiI5kDqt9a8I8C',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'eJcVOvDI_LnZwf6F95k_Jq3uo0z43swAvbmxcuoAONsC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
