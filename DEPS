...
vars = {
  ...
  'skia_revision': '149eb4561980851be83913057d5be20c32b73e06',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '6147f322009a70ad31ed15f63e5a72d423ceeaaf',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '607fe09ed4d88fa0d0453d04c904e7d3bc100b25',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@521b3cbc04d8e78635fad2b4c35f4aa14e151101',
    'condition': 'checkout_src_internal',
  },
