...
deps = {
      ...
      'packages': [
          {
              ...
              'version': '3COpFn8TtaPPxbLUwGS6x5Af-W8rmIBc0C_kWpEFtgMC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'zOr_ymfWlVxzsZPtNwHkLSng9zSDOvbKwOzkAX4Q7foC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/clank': {
    ...
    'a9a9c3aa88d3fb689494c9b5bee4a3534eab20e3',
  ...
  'src/third_party/eigen3/src':
    Var('chromium_git') + '/external/gitlab.com/libeigen/eigen.git' + '@' + 'a0e30732a7f194ecd7e283627becb16d10ee09cf',
