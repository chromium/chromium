...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '2f7ec6e0c7622adfaeef7ea627d8f972cded0d2b',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '6ed3e27c3922b07fcc64fbbf88c1549d9f89e2d5',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'd2624b1f249a76285629347edadca2fd376a6f40',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '56cb78476d23bff099fc78e617f425046933f7ae',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'a7a67cc90346343feb9ec611c0300147f3d3415c',
