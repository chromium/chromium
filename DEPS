...
deps = {
  ...
  'src/clank': {
    ...
    '7efd54ab9625ceb75f12d7f0ff2e70d680b66621',
  ...
  'src/third_party/eigen3/src':
    Var('chromium_git') + '/external/gitlab.com/libeigen/eigen.git' + '@' + '09097300776414cc65bc96c973465decf1c00433',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '4fc37edd3d43bbfe45f61d4e0cf3cf3491e1d3e1',
