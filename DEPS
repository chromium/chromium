...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '31d4bb7cf85091bee1a5fe27d6e2f824c424ae4c',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'bf9168edc5a317095fcc4c69a660ef4e16f626a1',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': 'https://chrome-internal.googlesource.com/devtools/devtools-internal.git' + '@' + '01e4e549d011678b528dbaf108f98a7b285d0daa',
    'condition': 'checkout_src_internal',
  },
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@84ea78c397c4a640b62e4eb4d0b36871916b646d',
    'condition': 'checkout_src_internal',
  },
