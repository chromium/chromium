...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '043ecd71882fcfb2a930d434d9653b951e7a7dc8',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@7ba17d6197e385b0f53779c911a47f87813d8c0b',
