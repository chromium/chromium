...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': '00e96b3a09a8d59b485ea0ca765ee55092aa76f5',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'boringssl_revision': '910636ca365a7f51187dcaa397aea402ff400390',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '24e19faf37febd14eddbb09e22de8762e3859326',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'Q7WpRxBLxBEJ-sPIgdM4DIiPABI3AVVAPndeqa__yD0C',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': '3UA68Q41qLJKI1jeNVtGsnsJtyqRd7Mf038gUChnwpgC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + 'd4e262a9c5fcea9bdbc68028e9a808abf418e699',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + '9e88d7f37407ab04dc3e158d6b8673a06014430f',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@c9def683f930026bde0fc1aa9cbac66138af4d93',
  ...
  'src/third_party/vulkan-validation-layers/src': '{chromium_git}/external/github.com/KhronosGroup/Vulkan-ValidationLayers@5575aa03fe9176c1e4cea69a0a180ece57c5e177',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'dd492e775f70c0606d4086a4db265f713907c297',
