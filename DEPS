...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '520da768fb493324a972d8e8bf8a50d9695091a3',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'boringssl_revision': '683262795801abab5d0d5b2dd533d82dcfd64248',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'catapult_revision': '7f980f212bc2515d6186a6ecf57df092c6539742',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'ff7416219e32c5642f3ea4b183716d53ab298af1',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '0152c8125a899d78df324b22757023082f19ecdc',
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '718c82860e39edad17a71b12a097a6c70ffc45fa',
