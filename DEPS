...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': '853087b79259af4a2893ab7bb3f1004eaf189d4f',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + 'f83d7ea5ed4d1c25eb7026f50fac7d8e04d00b49',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '4b96bfde967983e1ca9781c7b11496a76f081f5f',
