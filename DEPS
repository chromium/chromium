...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '3995312fc71429ef20640559585048fe4360fb9a',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '4d2f63976903b474dcc62c70f64d72b060263491',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'a5f7208bd6d6d2a1601bb2be48a7f45d57870d36',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '2bd8bf98f5fae3233acd9421d2da73cb4724fd16',
