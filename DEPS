...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'a0001354e75e51c513e33e6e6cbba555b7c949e2',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'qpMGbtmDxqld40etrJfNvc5sk4WU4-dd6UERn_W2OGwC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + '569e766ac8c29a8d5102ed0e9e450d5c713941aa',
