...
vars = {
  ...
  'src_internal_revision': '348ac877bc82538add89fb2ca79f5f7d94e9d2ca',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'dc2b7378cfdc0b550487b8920d59e28236afcfc7',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '8263352b3d66d4b4c3d9c857dd437eaf11935071',
  # Three lines of non-changing comments so that
      ...
      'packages': [
          {
              ...
              'version': 'N19HZrAPUpSNDtQiVzN_x0Pu3mwOfgEDoV5v-e0wMC4C',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '039aa8b0d67a26c6cb6bbfc4c2a32283bd169b4f',
