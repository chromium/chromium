...
vars = {
  ...
  'skia_revision': '793871779799654b566eaea111192d37804327f9',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '783a881e12cf0b488494d94badf91ae7919faaf1',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@8ce2fad80022e31340dcabb536a51e2b342387ae',
