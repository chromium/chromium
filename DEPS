...
vars = {
  ...
  'skia_revision': 'd5a507cafd3ba292846cef6c96bcc64f29ee776d',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'f9259e714fe8ac0b7c2292e2d1591d75764957ec',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '962bf1896185c0d84232f2bfae492eeb04e1236d',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@1b26f98cace29d04b9e84d7c32ee8f1e6eca9258',
    'condition': 'checkout_src_internal',
  },
