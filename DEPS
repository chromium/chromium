...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '7b7888582d1d3b1b329b04325da766e8748915f9',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '0627cb3920d958f954edff1c263abbfd6a747c5e',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@4cf0da0abcfc322610ac36f3d7f8205ab74760a1',
    'condition': 'checkout_src_internal',
  },
