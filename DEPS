...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '1d53f18576e4b9b9aca4c94a6a1698e8fb8049f4',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '2b6db685174c9e186f6878cc968b597dc9c1e7cf',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@b9b6f8493f255381cfcd2746b55d97d9fa118387',
    'condition': 'checkout_src_internal',
  },
