...
vars = {
  ...
  'skia_revision': '8dddb0400f4799721c926577276f3e609796a606',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'd2f4b461e4a312ab377fcc07f21605b6f3586b95',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@bef6dfb3738f129e3bef6c1d92d1b0141fc2ebef',
