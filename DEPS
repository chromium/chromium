...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'd7fcf1c0c6dbb20b1a5434be116e61cb562b491d',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': '03b93d4f153a567f7c4149d9aec0329f359a6f7f',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '0ac2ca5fc8924c6dd1be19b11c4e786516c36a5e',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '66344aca9cfc6c8ac8631069b88f59bc78622982',
