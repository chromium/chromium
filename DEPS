...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '267a07cd5cf29b26627dfbaaaa03cddaa361f7df',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': 'bed8383ad192a1b6f03d41ed44375f4e7edf21b8',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
  'cros_components_revision': '033cf2bcd9d9b96b0b8699eab7ea57f314ac266c',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/clank': {
    ...
    '9180cfa806edf96a972fe3754ae5588048cee075',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': 'https://chrome-internal.googlesource.com/devtools/devtools-internal.git' + '@' + 'c99511ff327f0fef11236fdac023bd9351a03d64',
    'condition': 'checkout_src_internal',
  },
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@81212534557255ff95bd612eea88ba440e1e9a0b',
    'condition': 'checkout_src_internal',
  },
