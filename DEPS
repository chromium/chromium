...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'fd9c56506b6d879cab4ee5fd6349406eedb0cd24',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'v_jDdygAOm3Mw8ZJKjyIXiRdx433LSp6l9TivINStuMC',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'KIKJ7NzIgtiJ1Q38_66T49psIBLI3w4fbZ9oqkzoaZUC',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'nFf4OyZ1VtgYLRUVDnIlKI151FK_S_N_H9pogIbOaVwC',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
  ...
  'src/clank': {
    ...
    '85bde59ab6399a9514a5db5d1efea63f6660ddc2',
