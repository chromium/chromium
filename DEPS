...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '95f212882e9a2504e4a9bbdfb3aad2413358a274',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': 'ee63db1307983647685cd9c9110f247def507e77',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '75e88ce83f7720bad253a8f35ad7756750371c16',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'a075f1298c454f77be141c8aa2d8ad66f1fa03e7',
