...
vars = {
  ...
  # and whatever else without interference from each other.
  'boringssl_revision': 'c3ffc3300a9450cf8e396c7880be7c6cadc16a4a',
  # Three lines of non-changing comments so that
...
deps = {
    ...
    'packages': [
      {
          ...
          'version': 'NLeSxO2hT1PsU3zDilqAkKZ-u1z9W9IOSnAPUVJWd0IC',
      },
    ],
    'condition': 'checkout_android and non_git_source',
    'dep_type': 'cipd',
  ...
  'src/third_party/eigen3/src':
    Var('chromium_git') + '/external/gitlab.com/libeigen/eigen.git' + '@' + '0f908429aed1b289155159774d8328c5f68ba7f7',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/components/optimization_guide/internal': {
      'url': Var('chrome_git') + '/chrome/components/optimization_guide.git' + '@' +
        '942913894accfcc87cafa915086094254f17a274',
      'condition': 'checkout_src_internal',
  },
