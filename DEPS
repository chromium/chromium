...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'c40262dc844b9a85b7ac579fbfeea3728843138a',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'catapult_revision': 'df756ffdf05068c08273c561950fcacfa0cb08cd',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + 'cdd52af78456cf93fdaf24d06a94cda6c87064ba',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@f65db4f90b7946c890fbbfd5672396e314f1ecfe',
    'condition': 'checkout_src_internal',
  },
