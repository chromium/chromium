...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + 'd20a718173d2e4d34979df09dc24f51ccf5aa724',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '55a61898a80de4e602db622fd02d3adb91a03ef7',
