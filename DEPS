...
deps = {
    ...
    'objects': [
      {
        ...
        'object_name': 'Linux_x64/clang-llvmorg-22-init-6153-gd7484684-1.tar.xz',
        'sha256sum': '2b3bd9b46500086bb2b09595f1b5b82eafec18a696e13dec22ea20b0a50a94cd',
        'size_bytes': 55618756,
        'generation': 1756882099116880,
        'condition': '(host_os == "linux" or checkout_android) and non_git_source',
      },
      {
        'object_name': 'Linux_x64/clang-tidy-llvmorg-22-init-6153-gd7484684-1.tar.xz',
        'sha256sum': '7a17926443ddbea8ba1feb9ba8d72647ec1ed39be6ab64d809fc287a244f5423',
        'size_bytes': 13847536,
        'generation': 1756882099972366,
        'condition': 'host_os == "linux" and checkout_clang_tidy and non_git_source',
      },
      {
        'object_name': 'Linux_x64/clangd-llvmorg-22-init-6153-gd7484684-1.tar.xz',
        'sha256sum': '6b59b93b718f521521011b13021b1dfd515bbb4b95f97c9be6893509e1ab7b8a',
        'size_bytes': 14203596,
        'generation': 1756882100131999,
        'condition': 'host_os == "linux" and checkout_clangd and non_git_source',
      },
      {
        'object_name': 'Linux_x64/llvm-code-coverage-llvmorg-22-init-6153-gd7484684-1.tar.xz',
        'sha256sum': 'bbdec5b648edad61a1c2a88b0588f92747b2ed0ec50254f18fbf3fd1a083452c',
        'size_bytes': 2263936,
        'generation': 1756882100627173,
        'condition': 'host_os == "linux" and checkout_clang_coverage_tools and non_git_source',
      },
      {
        'object_name': 'Linux_x64/llvmobjdump-llvmorg-22-init-6153-gd7484684-1.tar.xz',
        'sha256sum': 'f803f2f74960b73cc5fa18801d5eb4849129a61fd2d7ba86ffe67bb46539a5cb',
        'size_bytes': 5650580,
        'generation': 1756882100017377,
        'condition': '((checkout_linux or checkout_mac or checkout_android) and host_os == "linux") and non_git_source',
      },
      {
        'object_name': 'Mac/clang-llvmorg-22-init-6153-gd7484684-1.tar.xz',
        'sha256sum': '90b826ea7bc8bd64eb7c809a43ee613b5b9bbcb745948450d083dc69e823a9cb',
        'size_bytes': 53387020,
        'generation': 1756882102585478,
        'condition': 'host_os == "mac" and host_cpu == "x64"',
      },
      {
        'object_name': 'Mac/clang-mac-runtime-library-llvmorg-22-init-6153-gd7484684-1.tar.xz',
        'sha256sum': 'fb118982d1b409cf0eb2088593fcf58a3167ec28520028b19f50b6896e1ffbc9',
        'size_bytes': 1002300,
        'generation': 1756882125174633,
        'condition': 'checkout_mac and not host_os == "mac"',
      },
      {
        'object_name': 'Mac/clang-tidy-llvmorg-22-init-6153-gd7484684-1.tar.xz',
        'sha256sum': '63c91ac7847a0508e79f3acb1c479b5b5db9dc79e254c429dd6ef33e043b8163',
        'size_bytes': 13957420,
        'generation': 1756882102803291,
        'condition': 'host_os == "mac" and host_cpu == "x64" and checkout_clang_tidy',
      },
      {
        'object_name': 'Mac/clangd-llvmorg-22-init-6153-gd7484684-1.tar.xz',
        'sha256sum': 'ea55b24833d7952663a7918c216508f2bc4a9131a063ba87539f1733d2902607',
        'size_bytes': 15406260,
        'generation': 1756882102958198,
        'condition': 'host_os == "mac" and host_cpu == "x64" and checkout_clangd',
      },
      {
        'object_name': 'Mac/llvm-code-coverage-llvmorg-22-init-6153-gd7484684-1.tar.xz',
        'sha256sum': '10960886fcb918e826c07de1be0c437234b8b20f0ad520329e530566ce11b29d',
        'size_bytes': 2312636,
        'generation': 1756882103550481,
        'condition': 'host_os == "mac" and host_cpu == "x64" and checkout_clang_coverage_tools',
      },
      {
        'object_name': 'Mac/llvmobjdump-llvmorg-22-init-6153-gd7484684-1.tar.xz',
        'sha256sum': '72629a382658dfd868d688623a5250448098b87afdfb640ac7268020e5a1d5b3',
        'size_bytes': 5548924,
        'generation': 1756882103146518,
        'condition': 'host_os == "mac" and host_cpu == "x64"',
      },
      {
        'object_name': 'Mac_arm64/clang-llvmorg-22-init-6153-gd7484684-1.tar.xz',
        'sha256sum': '008b739be965996d5df8ada20d4f6535dbf92a15877867ac448d2616e886b543',
        'size_bytes': 44472264,
        'generation': 1756882127487982,
        'condition': 'host_os == "mac" and host_cpu == "arm64"',
      },
      {
        'object_name': 'Mac_arm64/clang-tidy-llvmorg-22-init-6153-gd7484684-1.tar.xz',
        'sha256sum': 'b355c5d31e521c766bfb2a0511778ecb880d2947ffb80ca4e926bed9e1a3276a',
        'size_bytes': 11958124,
        'generation': 1756882127265521,
        'condition': 'host_os == "mac" and host_cpu == "arm64" and checkout_clang_tidy',
      },
      {
        'object_name': 'Mac_arm64/clangd-llvmorg-22-init-6153-gd7484684-1.tar.xz',
        'sha256sum': '66f9f7a87fea5c882c06416f77fc8e62fe341eb265ee045879393f30a26909f3',
        'size_bytes': 12264196,
        'generation': 1756882127709286,
        'condition': 'host_os == "mac" and host_cpu == "arm64" and checkout_clangd',
      },
      {
        'object_name': 'Mac_arm64/llvm-code-coverage-llvmorg-22-init-6153-gd7484684-1.tar.xz',
        'sha256sum': '7c682ff358fa1fadc76c89d6511d18699dbce005c976f4c39eb06a82c639904c',
        'size_bytes': 1940280,
        'generation': 1756882127910234,
        'condition': 'host_os == "mac" and host_cpu == "arm64" and checkout_clang_coverage_tools',
      },
      {
        'object_name': 'Mac_arm64/llvmobjdump-llvmorg-22-init-6153-gd7484684-1.tar.xz',
        'sha256sum': '2f1b6129e86a8966a03cbe6528eac853336913dade68854f7521976f59ba3483',
        'size_bytes': 5285352,
        'generation': 1756882127864182,
        'condition': 'host_os == "mac" and host_cpu == "arm64"',
      },
      {
        'object_name': 'Win/clang-llvmorg-22-init-6153-gd7484684-1.tar.xz',
        'sha256sum': 'a7fc8ed0af7e792255d5be375173d3d398d739ea0d9b0fb0e2a8f82b3eb892be',
        'size_bytes': 47595284,
        'generation': 1756882153742015,
        'condition': 'host_os == "win"',
      },
      {
        'object_name': 'Win/clang-tidy-llvmorg-22-init-6153-gd7484684-1.tar.xz',
        'sha256sum': 'cd986f879dfc2cb9cb461f2c68b3f01161291090a6105fa150d3eb0639ad4e54',
        'size_bytes': 13861208,
        'generation': 1756882154165222,
        'condition': 'host_os == "win" and checkout_clang_tidy',
      },
      {
        'object_name': 'Win/clang-win-runtime-library-llvmorg-22-init-6153-gd7484684-1.tar.xz',
        'sha256sum': '61e8098e6ea38d4f9c10b81edf620c2f1f60502ee9edf152e915eb97245f4c23',
        'size_bytes': 2500728,
        'generation': 1756882174515249,
        'condition': 'checkout_win and not host_os == "win"',
      },
      {
        'object_name': 'Win/clangd-llvmorg-22-init-6153-gd7484684-1.tar.xz',
        'sha256sum': '896a3c1725def397530b46f7f9bd87716ed26aada52f079d69de9fc0df5344f1',
        'size_bytes': 14360648,
        'generation': 1756882154311924,
       'condition': 'host_os == "win" and checkout_clangd',
      },
      {
        'object_name': 'Win/llvm-code-coverage-llvmorg-22-init-6153-gd7484684-1.tar.xz',
        'sha256sum': '51858fa95db617df8c1df53175a4f635439dd26f8dbb431315f3916405d71041',
        'size_bytes': 2361272,
        'generation': 1756882154879280,
        'condition': 'host_os == "win" and checkout_clang_coverage_tools',
      },
      {
        'object_name': 'Win/llvmobjdump-llvmorg-22-init-6153-gd7484684-1.tar.xz',
        'sha256sum': '9da302231c07c29951273e1c81baf9545c501f406ceca3cefbe258de8708978f',
        'size_bytes': 5660836,
        'generation': 1756882154555413,
  ...
  'src/third_party/rust-toolchain': {
    ...
    'objects': [
      {
        'object_name': 'Linux_x64/rust-toolchain-51ff895062ba60a7cba53f57af928c3fb7b0f2f4-2-llvmorg-22-init-6153-gd7484684.tar.xz',
        'sha256sum': '47a5333786409ada31f9d9e25e43da5ff466c93fd237d00e39c8dc289710a073',
        'size_bytes': 141403440,
        'generation': 1756891711601008,
        'condition': 'host_os == "linux" and non_git_source',
      },
      {
        'object_name': 'Mac/rust-toolchain-51ff895062ba60a7cba53f57af928c3fb7b0f2f4-2-llvmorg-22-init-6153-gd7484684.tar.xz',
        'sha256sum': '7573249f404911bac87587385833e98beb2ece02f242c7b590d16c2db892d75c',
        'size_bytes': 135184020,
        'generation': 1756891713690110,
        'condition': 'host_os == "mac" and host_cpu == "x64"',
      },
      {
        'object_name': 'Mac_arm64/rust-toolchain-51ff895062ba60a7cba53f57af928c3fb7b0f2f4-2-llvmorg-22-init-6153-gd7484684.tar.xz',
        'sha256sum': '4a0672733c036a9db63511f1a41e6d5b2d4bfcc82df06e3be95e3a57bc32bd51',
        'size_bytes': 122684748,
        'generation': 1756891715808448,
        'condition': 'host_os == "mac" and host_cpu == "arm64"',
      },
      {
        'object_name': 'Win/rust-toolchain-51ff895062ba60a7cba53f57af928c3fb7b0f2f4-2-llvmorg-22-init-6153-gd7484684.tar.xz',
        'sha256sum': '7f8edf19ff7acc008d8c7487738b1c7ecb9ff2436afbdfc4a54d302413223da1',
        'size_bytes': 198760804,
        'generation': 1756891718046177,
        'condition': 'host_os == "win"',
      },
    ],
  },
