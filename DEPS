...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': 'd429ea695cc92da8773c2e748811ecccc9805389',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'abe4dc267ca5415d42fcf8f7aa8cec2e6cafef0b',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@c86a29844fcfdf74bee6998f90b1bc886a6405a8',
    'condition': 'checkout_src_internal',
  },
