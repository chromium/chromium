...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '2582c1bf95f1e8f75c1243b32ca9e81a38c581a4',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/ios/third_party/earl_grey2/src': {
      'url': Var('chromium_git') + '/external/github.com/google/EarlGrey.git' + '@' + 'a4626b59ea3988be8d91a6be31d0c92ae944d831',
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + 'cb0a55b733225af4706c51686c339ce9d93c9bbf',
