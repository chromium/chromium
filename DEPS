...
vars = {
  ...
  'skia_revision': '61e2da49e03ec2dcc1357df8e80dcb9e34dd0cfc',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'catapult_revision': 'aa3bcbb814d828f3593723157485344f93adbc7d',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '9e4c453e324098e70b084d573280ea98969b8d0e',
  ...
  'src-internal': {
    'url': Var('chrome_git') + '/chrome/src-internal.git@9bf8cd473df686bffe6ba42fc9fea3ac8b8b27a2',
    'condition': 'checkout_src_internal',
  },
