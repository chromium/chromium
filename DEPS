...
vars = {
  ...
  'skia_revision': '8c5e09f079a3e8eeb97532cf1cbc6e0934ce40f7',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '18a6255a7b7c82e94089589396db33b2f66f83a0',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': 'https://chrome-internal.googlesource.com/devtools/devtools-internal.git' + '@' + '94f8c83e115c792e7991068f3f22467c3a49ac45',
    'condition': 'checkout_src_internal',
  },
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@f1374500c7630ffffd011fdb5b62857aeaea58ce',
    'condition': 'checkout_src_internal',
  },
