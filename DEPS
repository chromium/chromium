...
vars = {
  ...
  'src_internal_revision': '46c34d410197b11bd16558035f9a6b9d7c88a15c',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'd1d238efd2dcc72b2b317345c2937697d269bede',
    'condition': 'checkout_src_internal',
  },
