...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '8a7bdab2c199472f2b4dc171c62dacdb2398ee22',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'a59ad5511604242044658f63abb9674357e42fc4',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'boringssl_revision': 'a4eb021cfa159497648eab66c4fece99c59bed0c',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '9e239602b499a811a3e0054193f1f1d75dab7144',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '803ff2bdaf8e409b3d326f6e544ed7ea1ccf63d6',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '30fbb810caa466e399ce1f459cfa977c2a4585ac',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@fa4e977770e736014bcd29f1b96864bb28b63abf',
  ...
  'src/third_party/spirv-tools/src': '{chromium_git}/external/github.com/KhronosGroup/SPIRV-Tools@7ba72f14f2f59a6f65465e5fb3e849dc81ae462d',
