...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': 'f03e17a69eb82d784dbb5c23befe6ae5286c9d1a',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '60bfc77729d1a52685c564e4902916bc2e7df26a',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
  'dawn_revision': '983d13235dc30838db578813175e4802db5bda22',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + 'a96691940e8d82e3c47b066b210ce817ea59b204',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'ee212a72f220641f0a4a23fb2c1bd600a9069440',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@6eb062cdbe8956cd62d536a0be8536c7708da396',
    'condition': 'checkout_src_internal',
  },
