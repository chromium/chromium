...
vars = {
  ...
  'src_internal_revision': 'fbca564f355a38c0d663e915257005ed72be147b',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '8df6322f5a68e30f390feb420b50446b7a95d0f3',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'c5d3732ad251c39930fc7598cd180367d0d31b56',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'ad829c16402256606288f079039287aede0809b8',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'a624ee1be7a11e795a849edb2a27dc1137d2b63d',
