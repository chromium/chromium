...
vars = {
  ...
  # and whatever else without interference from each other.
  'dawn_revision': 'd7fd9f0b40806d78bf8f2ca37e8775898719d57d',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/clank': {
    ...
    '199ae5b91f6125670ab3a296c5141e939cf11e7e',
    ...
    'packages': [
      {
          ...
          'version': 'tC0iDspHMdx7t4KbG0576gQ3_t7ZR3h3RuDMZRAaploC',
      },
    ],
    'condition': 'checkout_android and non_git_source',
    'dep_type': 'cipd',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '1317971116b2a3b8e73c3346ecaa6a927a82e9bc',
