...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'LhwjGmpSuUo-uKnvFMPzuBkO5ht4Swv9xSZ9tq1-g4oC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': '1CKbOYj2p6nKDmCpPwQxdi_q-WZAHwwuYZpSaM5pc6UC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'd7b28ebba1bb063e00d203fe831ec435af223813',
