...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '2c342c4b6eff17741316fa144e07a39047cf614b',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '21517f14e2f0ecd7ded51a615bdc044d6796c467',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '11bc1b0cfde39f1f05a36e4417706ab38d7fb72b',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/clank': {
    ...
    'b63739bbd7e146bd78b57251d7a5463ec86fa11b',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '9175b3d51b1e52e15388f0c27ebc0c3ccaf277bc',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '487532a0f7fcc713edcfc43966e8c824abc35bd5',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '694acfe6afe94533d1056959a1ad55fea71f45ee',
