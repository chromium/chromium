...
vars = {
  ...
  'src_internal_revision': '6921b7d49fd5badf001cd8c25293b73dbf80cc72',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling Skia
  # and whatever else without interference from each other.
  'skia_revision': '521b24236f56a598f2ffa4f1de17ef65012b6652',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'angle_revision': '7b14dd73d265b45c82c97ce145981710fc41981d',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '7d502afc82da5f9b9493b78ce0d86025774ca75a',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '9e894b16da43b7a7da0894aebf678a13dcd68073',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'rt8SDAW_9xmhdMNb1Etc9e-hxg81Ba7nrf0VJhJG95gC',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'qKMEhKtt5A4Mc_fJ6p2zN-LquE4Hp2dBjyWPGnyPdo0C',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + 'cecee2f88c913b276afcfecf2b6053781d8054cc',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@fbaa5e76f12319b61c72dc3d793a755e696df2e3',
