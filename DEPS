...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '04017c0776ecac2cfcff7cd449e0a070d537b2af',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@f294ab6373b97f77d4cce59f1f882112655bf958',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@ddfcfab78979b6ae0b40dc979fa309494acc37eb',
    'condition': 'checkout_src_internal',
  },
