...
deps = {
      ...
      'packages': [
        {
          ...
          'version': '-icPu40FLo-RX1bmLWORfRFk1y4ym7mUoH6fB5oHrw8C',
        },
      ],
      'dep_type': 'cipd',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@d320e84d7ed0a4395a412b607ef3f5d5a21cf57e',
    'condition': 'checkout_src_internal',
  },
    ...
    'packages': [
      {
        ...
        'version': 'hSzaCHrG5FdEsgwX18zPcTFAgFqeL4Te7VP4CigrD0gC',
      },
    ],
    'condition': 'checkout_chromeos and checkout_src_internal',
    'dep_type': 'cipd',
