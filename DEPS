...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': 'b43cdd28784cafbaef600119e0e55bb5ab901118',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'dawn_revision': 'b19b17b62694f3c776136690db177eab343b3342',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/clank': {
    ...
    '0a6f30d04490f5254a98035ebaa6d3f763bd9d7b',
    ...
    'packages': [
      {
          ...
          'version': 'LdF9K8XEnWhlWamDzAy_flJZnS1q3ANbPoQSNJ7G6UMC',
      },
    ],
    'condition': 'checkout_android and non_git_source',
    'dep_type': 'cipd',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'ec20269777c921af931930f366a6d1a45b03c75e',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@1bc271cfc64199a027aa0653d1605305c70c1719',
  ...
  'src/third_party/vulkan-validation-layers/src': '{chromium_git}/external/github.com/KhronosGroup/Vulkan-ValidationLayers@9900b9b60270bcb4f8e81719270d6863e98f995c',
