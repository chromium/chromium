...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '1a821af6b78a0e123fbd641867f29976236eccda',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': 'a501c8337f22b461db82bf9d175e74ed3d8a7185',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'be8caad57c7699dd14a8d7df90166127d56ec8dc',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '127d568a722c7edf42607748b7992a2a89c11aba',
    'condition': 'checkout_src_internal',
  },
  ...
  'src-internal': {
    'url': Var('chrome_git') + '/chrome/src-internal.git@10be879cb9af6e08df876355537d61bde0883a0b',
    'condition': 'checkout_src_internal',
  },
