...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': 'a4015a9d36d942367d7290ffdebe5994c3215b9f',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': '9f87adc2aab0c5b7613b82c96a50efe6315330f9',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '49e0d734ed60b19d61a8a3b37cc9fc9518b875a9',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
  'dawn_revision': 'db6aa8a4add6b913f5aa4604fa26e0bafca0fa38',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + 'e0b479c40117dfee85ddec54c32e64befc58a2af',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@91e8f18ef94d27c10243855e66567f6af82bef4e',
    'condition': 'checkout_src_internal',
  },
