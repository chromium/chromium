...
vars = {
  ...
  'src_internal_revision': '17f7a01bbe94cac7138b9e4cdebda49c825e86e7',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling Skia
  # and whatever else without interference from each other.
  'skia_revision': 'c3feddb877388498cc9a491e9504268a53607b15',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '8348549c9ecdcb4fd12a9b9c7dc453a231f584ea',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '637e3a4d3f99afedb7b4340b5bba2e375ec72a39',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'e0d9fc042f4fd0350d5ecfb3ee1d625fdc3c2c47',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'b73d3b622f858a5deb9184448ca7df29c5aafcdd',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '292138c1d7beebb17f47915751de130565b1e493',
