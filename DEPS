...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': '9f002018ee550790febd83b994ed5364fe1d2b3a',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'c97cc25052762296bdfb5db594e8128be0d8da26',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '584a1a732f53240e4018878ee69eb83e9289ec83',
    'condition': 'checkout_src_internal',
  },
