...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'WePUBhL_yzsT4PzYaHWACGp5SCfw09qrwvNyxAvba_8C',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'ODXqffJdmsaaMvkazPNhFErHh460PixvKm-ShIYNgP0C',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/clank': {
    ...
    'c076d8e91ccfa215518f0c2bbf75fe0c658803d7',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/components/optimization_guide/internal': {
      'url': Var('chrome_git') + '/chrome/components/optimization_guide.git' + '@' +
        'c17e841ea6c21d4bbd7dfd279a623061f2c14754',
      'condition': 'checkout_src_internal',
  },
