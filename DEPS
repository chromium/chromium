...
vars = {
  ...
  'skia_revision': '9cb3f98191709d59b957cac18b7c7d010a90c5e2',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '6ddaa46a423eec4f5cad774b0e1ec3419fb82356',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'v0uEmbtbCg90i_X0BxbOrS53SEnXs1yjadvaonoTnJQC'
          },
      ],
      'condition': 'host_os == "linux" and checkout_fuchsia',
      'dep_type': 'cipd',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@f938fbe07d22e237f83e6389bf6c8b6312f07ffe',
