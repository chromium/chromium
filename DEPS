...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '2b5f79af0aa9b2cd2b327ad962a5cfb935fd7f94',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'QQMgBY975kTMcWZQFtlT2I15pkS9mbKQkqVYtYTNOt0C',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'r3d2mTELUXvf1d0DQGhBAHuKZ8_A-bUzjrxCpB5NnvEC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@7197b08a9ac75b39e130af704299f0ace7cb5d02',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/components/optimization_guide/internal': {
      'url': Var('chrome_git') + '/chrome/components/optimization_guide.git' + '@' +
        '5e76a986ccdf5ef92418889304e7ba65002b2768',
      'condition': 'checkout_src_internal',
  },
