...
vars = {
  ...
  'src_internal_revision': 'f23ada0aee4e0edaadfe1122a0a901ab3c5f5a34',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '6cbee1b86cbae84a286e0ff720b3fcd027918f04',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '91e10a34b5524ea1f6362555df42c076f29f3895',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'c026167f59bcf4b438d2235e452a76593d62c4e3',
