...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '9b126720927987bc44780fdf61e65adf81c50bd6',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@5ab6c20796aa497f682a6b7dcb1762e3760af1b3',
    'condition': 'checkout_src_internal',
  },
