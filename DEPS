...
vars = {
  ...
  'src_internal_revision': '42e3557d74daee03e648ee14ba7d514e76d5ff57',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling Skia
  # and whatever else without interference from each other.
  'skia_revision': '21a1dab82b702f8672080f88d9e438c82fb93a0e',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'ink_revision': '2b48039ad80d999d79a0660021a69528079a1f6f',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'rfPpdPZzpICrJddX3IvTwoa0JYk3GnPsfR_LFERWsxkC',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'MHkpsMYY-90TWNenqayqoF25ge8ew6kGMtKnFauuv3EC',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '5269eb44454182ab8197a7f34738fcb2f5b68f27',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@8f4fc402f4b1a4e0c7da3ded5ce38db22b46336a',
