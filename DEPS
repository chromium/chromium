...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': 'f14a396f212ea0ff506a70f5dde60b2bb0541f8e',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '76abfb3e8f7d061c864b59599d9c41c16998e2c2',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '0a388aa1bbf14bf41ba04bb81b2275f3f90cb44a',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': 'https://chrome-internal.googlesource.com/devtools/devtools-internal.git' + '@' + 'd015cdb2855d571f580cf8220308cb667ee7cc4f',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/webgpu-cts/src':
    Var('chromium_git') + '/external/github.com/gpuweb/cts.git' + '@' + 'f3375af355a7ca4a5b9e21665cf77a553462ad26',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@b36ddf27f0aeed9eeb812f4b8cefff0396b5f7c2',
    'condition': 'checkout_src_internal',
  },
