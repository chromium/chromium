...
vars = {
  ...
  'src_internal_revision': '444931bff5981ee96d7f48d244092e436ac2c1d3',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'd68cba11318145c22d6e4ece3368e4e129190657',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '040c4e7ffc7755636d0f2c06a20c5e99e625736d',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'a145d12a38cf7219d98f8ba3f689816a4017eff9',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + 'b31d431ad7154377cfbbb44ee95fa24a4a229d16',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '75f4b5a2953d836c6ffcf9941ccb65b1c9189745',
