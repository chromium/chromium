...
deps = {
      ...
      'packages': [
          {
              ...
              'version': '26EoSpswAdy8qPei7SEz25vbWTNPBf4dhqiBFNdtx78C',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'i1FkPuugm61Ixx8BGCKOJXdiVwJvDEFYI00mdCsm6CwC',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'NiyzZnCwoIarUlELpY4vyu2NDD6DiAAJCPuIkz77phcC',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
  ...
  'src/clank': {
    ...
    '2e6f5f823b3732b3f2d0727b4c5afbcd15c8e76e',
