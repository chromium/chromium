...
vars = {
  ...
  'src_internal_revision': '3732f7bf2b7cfc03271baacb2515d552864c75da',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'angle_revision': '03380548ccdf195d81421b2683d3b3d7358075b9',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'cbde6b1e425a4f953bb6e91e474454cde65b16dc',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '252dbb9652b6f52fa2856ad33e920d65588f5f70',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'df1cd60fc28d1f5ae5fc5ea8b7485986b5acb098',
    'condition': 'checkout_src_internal',
  },
