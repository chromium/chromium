...
vars = {
  ...
  # and whatever else without interference from each other.
  'boringssl_revision': '4a0e7967db63fbfa2d89f6c9639de47abe831909',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'UK1vuZtmfYouhxGOESTI_28PhLde8yXudcWLrxoybNsC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@e65fb3bf6dc6ff9fe7670c6aed4197374bc2ed23',
  ...
  'src/third_party/vulkan-validation-layers/src': '{chromium_git}/external/github.com/KhronosGroup/Vulkan-ValidationLayers@6e6b564c6f3ace8622373d1409c825a7f9d67448',
