...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '9fb4f453100f95e3a19bdf45b316da3c9360a23d',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@2539a207246cfd65b65194138c4f48228e99537f',
    'condition': 'checkout_src_internal',
  },
