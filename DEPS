...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': 'afa5555c74171c9596aa2687ad5163ed5dc5dc40',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '9dc6898da3492e57f5e5f086eeafc475124a91d1',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'f2eac2241f0841f6d58c3b4342fd0d9d4abeed10',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'lYgPFkbBI7QDlw2O-o0Ne7NzyiNVFUTDlKFgG5dsT54C',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': '28x9O9CSBdD91H41p9VjPP8zhC2xdFjHvP7zeZ5iCPMC',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + '91d0f001437670a821b6fc5b24652ffaf82281d7',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '1ae7fadf81dd7ffe3ff30a0391efeccd050d2fa6',
