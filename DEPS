...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'ec1c4b275d2b568491cf63fe266a30cdb647d34f',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'b2fd4cb3b0af1827a2adc6a3aab1d404272252c4',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '9a93d72a532bfd94e4b9c75efe21ccb380175d30',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + 'e24e9c2be090796ec9437bf39b745d1833edb96f',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@582441e75299eb88d5bcc0ee8d94b1dfc3cd37fa',
