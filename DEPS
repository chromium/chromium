...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '188dfa1a0b6cd6e6a8adb2c7c239e5e78f2b4b54',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'boringssl_revision': '312a2c08dee696d52d5c34ba9250efc76a93f076',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@c8176fec3964dbfb86548b2d9534f9d300d66d79',
  ...
  'src/third_party/vulkan-validation-layers/src': '{chromium_git}/external/github.com/KhronosGroup/Vulkan-ValidationLayers@3c3e82d7fb61d3e5f682875320b5b0cfa3216d5f',
