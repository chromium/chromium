...
vars = {
  ...
  'src_internal_revision': '5d69d5c848820cc5c685535e4f130ebec82890c0',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling Skia
  # and whatever else without interference from each other.
  'skia_revision': 'eb000b138a9d99ea6bc89fec86cf8c783d606ff0',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '23eb79859dae8c5e1c7cca3963c01617239b038d',
  # Three lines of non-changing comments so that
      ...
      'packages': [
          {
              ...
              'version': 'xE_xgIiEsPEtCIzKMlXMv5OZFekpqFfWRs7zzqqIEg4C',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'abe36481ac02e61e6a64369533f747217f8f4c8b',
