...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '1af674728d07ccb5ce4a2f2e9b8e6dc287511611',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '48362bae65664a7b1f345bc9805c4b306707438e',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@e5192a390e3de7d3b7e2255ad08ab33369bd6755',
    'condition': 'checkout_src_internal',
  },
