...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': 'ca9614b4fd8ed8bf2ad3d6a37bf4b8de13f1c077',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '6bc5a16461c463020a26d561b14a65735557385e',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '783285fa1cd9a5eb2ab794ee61164462692320b0',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/clank': {
    ...
    '5f6b90e3e110c861e2b6b03a470b09b0bba80162',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '35173880b9483d8efbe093ec0d4ba9dd8f037111',
    'condition': 'checkout_src_internal',
  },
  ...
  'src-internal': {
    'url': Var('chrome_git') + '/chrome/src-internal.git@4b62433411f771ebe754372bdf367acc4ac0c6d2',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/ios_internal':  {
      'url': '{chrome_git}/chrome/ios_internal.git' + '@' +
        'b3ecb53c2985176df0316de9f6c0b4471a4f2fab',
