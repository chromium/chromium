...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '5eaf3b975fa09ebe88aaf84f6dfe2bc689037ecf',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'catapult_revision': '412c9963b7cb755f4770ab24ad218363c4b6e37b',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '295e685053e6d087e0b3b93772ddb1bcb24c3a7e',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '7257c563dd3855bf493b9d426d8e4231a4248be1',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '2bad4b546349a4d9ceeaf024133290943ce33da3',
    'condition': 'checkout_src_internal',
  },
