...
vars = {
  ...
  'src_internal_revision': 'a12f6262e1c36bb0f638477579d2d774bf43843e',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'catapult_revision': '4157dba92b2208d97ac451f24cca5fbf5f7506c7',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/chrome/release_scripts': {
      'url': Var('chrome_git') + '/chrome/tools/release/scripts' + '@' + '0cfc938dfbdfb1763610974217ae0b150ba9ad77',
