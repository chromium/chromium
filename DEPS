...
vars = {
  ...
  'skia_revision': 'e80318473fb979f4927ca3b982de76c1deaf81a6',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@cfd36a8fb45a415fc61e6784f90d764f19d4663e',
    'condition': 'checkout_src_internal',
  },
