...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': '195c142d7ee0bba45140ede20091a1bc66ba40a4',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '95888e532f9f1326f384bc2cca2541bac67742ca',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'f595afd8a7a23af97202b1937aab9084f9a8a5a5',
    'condition': 'checkout_src_internal',
  },
