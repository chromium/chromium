...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'f1576326d0076f4346002af0af9321a7cb1e9b38',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': 'e4c707b3295ca577565bfc102cf72f1dc6161ab4',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'crossbench_revision': '00106c65e5164aec7400b4bb5b87177a0e09d821',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '8f898d71ad8a38558f386a74413c744a50af274a',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '599316536e0bd93447f9ce4d23288f47b5d1c1cc',
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '684c85f395459c8bbac30a68653dbf3528fcb26c',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'd0c7568226288efac02de868219f74f0f7100564',
