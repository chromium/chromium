...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'e9ce822a5399d3177aea5756cd24d9c7ecec2c2c',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '233ba7781e19fc4a803db4fc39433e06ad2de328',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 't7Elm4eIbw82xIdkxdRsCWKaCEwkHn_Em3EHdek28TcC',
          },
      ],
      ...
      'packages': [
          {
              ...
              'version': 'cnj-_TcTMzfBZyjmr9scI3Zl0V8KNh9BbBxbafXrU20C',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
  ...
  'src/clank': {
    ...
    '06c0a61f1e2260de6ea10a2b8e3b818699503d09',
