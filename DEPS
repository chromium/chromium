...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '65bc4d40b38fde9a27f2764c0c3ded1bac48909f',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'a35729793716997901408779178da4f90f7b7831',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@d37b83508ac42c4435526a0d1327891223d4746f',
  ...
  'src/third_party/vulkan-validation-layers/src': '{chromium_git}/external/github.com/KhronosGroup/Vulkan-ValidationLayers@6d14a2eaa9645b90e2db9a8ba7c2bf759a54aedb',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/components/optimization_guide/internal': {
      'url': Var('chrome_git') + '/chrome/components/optimization_guide.git' + '@' +
        'ec627c0b0055bd50e3387c29583af791e34e5f1d',
      'condition': 'checkout_src_internal',
  },
