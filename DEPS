...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '96aa2812515058be6536b472cf2f677da4169f78',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'cf56966bc340fe3324dfdb2709db79ebcdf907c9',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + 'e535a96ea0270d6b5922b552b40e69d534d401e0',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@18713be1c74428c14a09fb804d8a017d3ad123f2',
    'condition': 'checkout_src_internal',
  },
