...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '02dcfcc9033a1649b30300419e454535f7b970f3',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '41d11f8e7fb72e2287d613d45b76b956e67da557',
    ...
    'packages': [
      {
          ...
          'version': 'a1W8eH2Jm--_XqWIvmw1bxQGRGQwXBOoVOU1JEkFAfwC',
      },
    ],
    'condition': 'checkout_android',
    'dep_type': 'cipd',
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + 'bdf64705c3315c5c66931bbd315d407056cee915',

  'src/third_party/devtools-frontend/src':
    Var('chromium_git') + '/devtools/devtools-frontend' + '@' + Var('devtools_frontend_revision'),

  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'e5c6e902a86857edf7fa906fde5a43fc1f753a84',
    'condition': 'checkout_src_internal',
  },
