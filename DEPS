...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': 'c3af666eed3a0a7370cc40231637e781ae38436f',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '4065687d3eb9e8c42f8bbe011798c8d13ad84911',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '0089d47887be55580621b6ea4cd1d537adb48f07',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/clank': {
    ...
    '995c48055c9ce00ca08ebff040b5f74432d483d3',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '97b828d27fc91e1df03273528f9e1de04777e9c7',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@8b2b21d7ec4fc65e511fad7035556f3b872e163b',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'a63e96f7d80c0282d3f52bc22bbcb4650fe98ae6',
  ...
  'src-internal': {
    'url': Var('chrome_git') + '/chrome/src-internal.git@5bcbf74f1471d22ee35ed4dc9acd9c555e92ecb7',
    'condition': 'checkout_src_internal',
  },
