...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': 'c2270c2b7091670b17c99ed24f669dd82da6a663',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'bec384b13132ec5768cb42cdfe0795a67f8860b5',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/eigen3/src':
    Var('chromium_git') + '/external/gitlab.com/libeigen/eigen.git' + '@' + 'f26a444af3b7bfcac0fd908d2753e2452a863729',
