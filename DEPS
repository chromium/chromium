...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': '9f1dc3e9933b26c64454b9f7c45bbcbd3053c94a',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '7ebe6561641ce18ee780af3f63aa62b12833cb15',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@3d7abbdedfa1271e4fb01b4d3237e58494075671',
    'condition': 'checkout_src_internal',
  },
