...
vars = {
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '48a79bb063683f2846b653612d53b3b49f140f04',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/clank': {
    ...
    '8413f10af47068626a55429c2f05a97d1400e455',
      ...
      'packages': [
          {
               ...
               'version': 'Xu34gsdwgp2ZoSz1aFNGsKe16-zkJ_HBg1fcFiHechYC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/third_party/eigen3/src':
    Var('chromium_git') + '/external/gitlab.com/libeigen/eigen.git' + '@' + 'a1a19e6b2c34b3775acfe54ec9c4cf6d67382184',
  ...
  'src/third_party/libyuv':
    Var('chromium_git') + '/libyuv/libyuv.git' + '@' + 'b5c764cfdd6a671aa837bf91ff53939402f9a730',
