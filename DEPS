...
vars = {
  ...
  'skia_revision': '872b8c13d7618ac1e2a4a1e0b3e0b10883d7ff8c',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '4d4f61b50dea9eb160cd6d0ac18ead3db523b623',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'pdfium_revision': 'a9aff888733a52abd08f0b842c1bf540d829f9dd',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '1627015c84089c0da53f37edab6d42a708cff2e7',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@1b9285a9a04d4ae2b8f7c6bf8d62e9c6a41c0eca',
