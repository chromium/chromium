...
vars = {
  ...
  # and whatever else without interference from each other.
  'dawn_revision': 'db9db31cabee06d9bc22a11f84599dcd7b7fe3e1',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'nearby_revision': '59ea8e8005b6afad3f26ff584b022de8d3275cfd',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@e4e46b09b1d4a74f6c1f806bb972579d1a9efa60',
    'condition': 'checkout_src_internal',
  },
