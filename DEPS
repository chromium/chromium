...
vars = {
  ...
  'src_internal_revision': '5ec5496a331904f9c146dbd5ce124e0842989955',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '0a812e4830848e6fc0f45d53ba074f6ef0083f89',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '72846d78927b90a77b51b12d13009320a74067e0',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'vshlT1d5ayntGiXNz2-T1rph4TFdh7xkcZr1xjKSUB4C',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'wCXjFgyy-Y1gNNYDfAQN7GRb5aA1Q3_ww9dPJLqhIDkC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'w-URChnJLQcyE1CnC4Ssrq2iMiwKNPsvx3iEywAQHr4C',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/clank': {
    ...
    '226e2fc602a02c092d293ec6f79fe4f6134c22e3',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '0c55abf6aaaab8bdd66ef479b4125a7b37927480',
