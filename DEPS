...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'HLbsDPS2TEp0RNDaa6Nb1Ff4sktyZEEJKRqz4FdyT1UC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'LeudA7HCcR9F4hyaASh5D-IfXIz_87jFxO1cN-iOnRIC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/clank': {
    ...
    '7e2e13470301adb897499e1c050f05b956c5d287',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '9af725c18b77642759bad20b5d84b766b6489aa4',
