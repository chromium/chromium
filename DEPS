...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'ef237faf660c53cdf4e648aa8ccf435466b90d45',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '9cbd6c9453ca55edb0f155068830b1ad69c5136e',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
  'dawn_revision': 'ba0d653b8c00f5d4a7fdfdfdbeb9fe4d73478a6b',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@23071cc04c7f282ba043947a73a499d679d234e6',
    'condition': 'checkout_src_internal',
  },
