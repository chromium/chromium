...
vars = {
  ...
  'src_internal_revision': 'a961489fdec7731ad3c1faeb5add10d40915a644',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '5512e0c15d4272213d060b4d275797c4a2f00a03',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '0f98902bf5dd0829a254f42dde0c8b1ee30aa535',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/clank': {
    ...
    '3e14f051c42a1f7a0ba4d953f8324243fae5ce0d',
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '4ff51c15adfdd03b06cf842d5f18cab3f3868635',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '53e89371496e736849b47d0b2eec15892902cbff',
