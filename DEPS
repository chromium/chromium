...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': 'abcc292f8afe140812d7363b6d95c3e04c66dc0f',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '4af4626f60ec642bc92885aa2965cbfd561507d3',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'a4a75d5228fd207c684695f504e586e34eed0fd6',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '44a63789d56974e0493fe54df10be9042e09f893',
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '522e12caff136406943edbf7c025821681c05749',

  'src/third_party/devtools-frontend/src':
    Var('chromium_git') + '/devtools/devtools-frontend' + '@' + Var('devtools_frontend_revision'),

  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '21b298f320f1c5afdebd7379ba3190ccbfaf15a9',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '1b328e10ecfed881836e190642b5be2901cbd61c',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '097a4decc2ad2838378827b6a64b7715fda5e955',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '983d97f58e4dfb7e62322e23110513c54fc554a6',
