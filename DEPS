...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '8f7e9c02b226cb3fa0a8a7cad21f4936f0d3b231',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': 'c2dc6235ad86e5973184ce0d2919d98312f7d980',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
      ...
      'packages': [
          {
              ...
              'version': 'WMbxzuNgopJKv1X1_r7Ikew1jzuNf_PEI7EaDgr0tZgC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'TR36y-i4Fpf8_bwx4_ifTt-vB9vV081bP-JEsQyHIQkC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': '29LW8XFVTNKeuwHq7Trxqf6NTx4kP8T92SvC19j1Eb0C',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
