...
vars = {
  ...
  'src_internal_revision': 'aaab08a882031c0d46453468bad5419468383c56',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling Skia
  # and whatever else without interference from each other.
  'skia_revision': '211612e2ce3d9e56c945403fd143471d706c4814',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'db12f43b821e871b7ae45020e1015f957a333fa9',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'boringssl_revision': '27ac00d2837576313da5c047d6a20e7415f3f34c',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'crossbench_revision': 'c0ac0471e9a2186caa230c08ec706b4f27bdc0f9',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/chrome/release_scripts': {
      'url': Var('chrome_git') + '/chrome/tools/release/scripts' + '@' + '2c89f87d26d3c4a00409bac1cd425a062eb9c57a',
  ...
  'src/clank': {
    ...
    '6095afcf829106512425fb090080383ab7f5cda1',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + '5bc1bca2d4a560b987d254f4c21ac5d338cece85',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@77796c44f9489d9569023f63097365b0334b54ed',
  'src/third_party/glslang/src': '{chromium_git}/external/github.com/KhronosGroup/glslang@0b3e8560fe8a236229c234f93557748df79bb081',
  ...
  'src/third_party/spirv-tools/src': '{chromium_git}/external/github.com/KhronosGroup/SPIRV-Tools@898ed77be18c99418f983ea220be91a926e6e26e',
  ...
  'src/third_party/vulkan-validation-layers/src': '{chromium_git}/external/github.com/KhronosGroup/Vulkan-ValidationLayers@fae6f149fb641880c66239424e8c193ce9e8cd97',
