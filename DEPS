...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '78fd0dfa6cf8889650ec2e739791d6592001888a',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '04cf59d0de8bb9119022b97f06080f1df13cd33b',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'aea4464265720b3ba681bae25a52a7bb04d2a2c5',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '64157ed2c1d41a0f02660f61d516a05e792b6366',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '9b66805e183843f21e00077e63582cf346693efb',
