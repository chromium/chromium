...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'af1d19f2fb1f48b46a4cc40de4562030ada19abe',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '3fc2823ceff42349382fe1859fa89add46cc61c9',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'c66ac2042d6f06b7f1491b4e0e09220401f3ab60',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'dcd5acd8ea5fb9d5345576b11dd086e78f633fc4',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '88960332a3610873594da2b008b59032828b7e5a',
