...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': 'a9bd897d459aff351ae787b48164fe85c1db14fe',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'cbad18b147e06f27082e0ff9312aeed86e6632b6',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@bc564f2fadef2eed3bd5b8ec829e86c0b438e6df',
    'condition': 'checkout_src_internal',
  },
