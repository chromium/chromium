...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '4a44b28e3681083ea7e3adb2f9ae66b85fb0b64a',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '3a8829a1831ea780307e03437c7deb59a1fe8455',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@0473f4d721e12aa0f44a9a8577f3545488aa1c7c',
    'condition': 'checkout_src_internal',
  },
