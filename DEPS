...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'd7786a7763e3d85d5b71e489a8390f898c909e8c',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'boringssl_revision': '17b042512ab50f412fe3aab5103d863994274d95',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'crossbench_revision': '5b1644c530efc101b36aa3fcb53d5df182641e74',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'a2f21f7fed4dda467b7b52f18fb5fa67bafafce1',
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '6dbcefe70eded3139dc7e6931fa6731924c0c99d',
