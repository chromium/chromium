...
vars = {
  ...
  'src_internal_revision': 'f67756e23f88b6240dce232fd4fae44131fb014b',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling Skia
  # and whatever else without interference from each other.
  'skia_revision': '501e9efaa2fc929ec67c44da6dbaf9335264b559',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'a74c1d5b8519748c97fc3c08d2ab124133e831db',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'pdfium_revision': 'cd5b3af32160ebd8a92213c36e56e2790671b414',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'c528d01a6516b4a33e49245de2745822eb440aed',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '6618c245838ff4878cf40ddc231cc2ab037b9647',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '13d42dc3d7c4ad41ad9c63db500ee82e97a9cfbb',
    'condition': 'checkout_src_internal',
  },
