...
deps = {
  ...
  'src/clank': {
    ...
    '4cfaa1a1721fa7c44bf2dac663c00c5a25ee87ad',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '48f05cd0e8dfced24b26bcce610dcd1ee52b0f0d',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@3b7abc12ccb45961ec4080cf9cc7dd7795b73787',
    'condition': 'checkout_src_internal',
  },
