...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': '83ca1fbc506b7afcb0cb971ef8435578042eafc8',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'lf-n2l2KToxgNJf4ZR3n_g7IlXKiCn_J183awA2F9XwC'
          },
      ],
      'condition': 'host_os == "linux" and checkout_fuchsia',
      'dep_type': 'cipd',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '5f133dbc29e837bcd6fa6a2bdeba317eea5a02b3',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@baafda826782e66d2da6bef353cf639eee6dad70',
    'condition': 'checkout_src_internal',
  },
