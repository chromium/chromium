...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '69cfde7b0a7602435998246305097ea85ca71c01',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '259b138f43580261b4ba55b3449d3541cfccff73',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': 'd02d6f14c534c551ac596a8124c37450cce40501',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/clank': {
    ...
    '23a54869f4b90ed383a628e5c40a357ebad4c3dc',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '76c4d6efc95c282294cc452bd344bc723d74afa6',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + 'e2179663544d7241ebbd23d83f31ffc3dd36024a',
