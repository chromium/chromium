...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '46e03d9a4fa21fb8b5c2079221440ce784350a39',
  # Three lines of non-changing comments so that
      ...
      'packages': [
          {
              ...
              'version': 'm5SrFhwAjAOw41mkzUgKGc9HHMcGqgyJ_yF0OLgLRroC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'Xo-FaeuCJWvu80GfeyOvKmet6XniysDdHGzFMYWTn-cC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'o_G-2ckLAZxZAryFvA7dvs0Nb42L5FgGYkeoA3dz8gcC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
