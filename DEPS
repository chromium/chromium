...
vars = {
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '7f36c0e71184a02c498d5fae682ce43a0fbfe3ef',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'bbeea47079bc56dcb0439f3045f85b983f4179f0',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@75dd08022c6277967d51f9dd9bba1b5d66705631',
    'condition': 'checkout_src_internal',
  },
