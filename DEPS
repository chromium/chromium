...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '91a9154d0dfad06f8837b10bc43176d8443ade43',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '7c2c6681f5c997ff1c58070b7e95713a694a688f',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'catapult_revision': '37d163125f970033fac246239d8f3c57a56a2d57',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'af323d99b4d38654beee536e03f97771f3def080',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '94d96255bddd33f330571ffa670d85f2ffc0a153',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '2df2c8a588d51b6c6145af449bf20802e76f5b1b',
    'condition': 'checkout_src_internal',
  },
