...
vars = {
  ...
  'src_internal_revision': '2ac5cdcc8cd6a29fde2e1dad60361045af8c1eb6',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '85c07c1f360ed3d0a6842eae4d976d1c4f98f263',
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '46ec2752b4b22d2f244ea2b66564bb451759d6b0',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '902a21a8c3443310c41f3642de735dade95eb3d2',
