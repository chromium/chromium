...
vars = {
  ...
  'skia_revision': 'a97a6769b5c4f43edc2331990f271674bf99c4fb',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'bf973970df85affefdfeb135e316b098e30eb55b',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '42c5bbbc96b863cecc319ae78cb888555ee0128e',
      ...
      'packages': [
          {
              ...
              'version': 'fJbQ9Rmxhf3YAQcd-9SXRr_7rojZByLjO8_FbwbqaOwC'
          },
      ],
      'condition': 'host_os == "linux" and checkout_fuchsia',
      'dep_type': 'cipd',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@b2431f7e6021d9b9f395d1c9c6dc9f98056ee6a0',
    'condition': 'checkout_src_internal',
  },
