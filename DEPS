...
vars = {
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '713b372f0350bf949e106c035281da10f6402eb2',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@b09abcbc65481196b9fdd927c3e0d5630d3da08d',
    'condition': 'checkout_src_internal',
  },
