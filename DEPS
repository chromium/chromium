...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '7d88bb89aec16c4bd9daef2daa585f61502e1d05',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'angle_revision': '61ddca7917b99d2dcd4157f674647db52ca56ffa',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '81972f7f9fbb1d4592166331406a8b45d59d7853',
  # Three lines of non-changing comments so that
      ...
      'packages': [
          {
              ...
              'version': '2wrQaG3Wzqj-Z-kcr4HyMcxJ1QGYBQP9FAQnEgSVbSwC',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
