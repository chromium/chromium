...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '676d3be2892fc7dbca5a2317aa7f5cc1d017737f',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': '67d508d33c12cf7f391392e48c62a0d3a2ef7967',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '21a6a9dd8a665f81f30e6949ef1d388769992173',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/chrome/release_scripts': {
      'url': Var('chrome_git') + '/chrome/tools/release/scripts' + '@' + 'c882ac70059c617b23fbbc3b9fd2a1ba2f297f7f',
  ...
  'src/clank': {
    ...
    'f188da3de5735b2c91fca3fe619c9e02f260c705',
    ...
    'packages': [
      {
          ...
          'version': 'BelqZVnrrdDXo9kVc-J7QraChrmtNISnHNiVRRAw0IcC',
      },
    ],
    'condition': 'checkout_android and non_git_source',
    'dep_type': 'cipd',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'e159fd20fed36680470271a7f35492d9e0197d6d',
