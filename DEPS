...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': '5726566af0c4e81a03bb4027eead995e783014c6',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'cbfa6ec5b5461ad6e3078e34eb1125b23f8b4c7a',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'c7ec2cbe88700aaf9520a4f341340b32594d4687',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + 'ad1c5e7c6ae230eab3ef33df9d1484336ef73e46',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'e24b34c1782b4df51d3b1bc68dc58153479a53e5',
