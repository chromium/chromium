...
vars = {
  ...
  'src_internal_revision': '93dcf4f6c118bc247b62b700884ed0a7044e28b8',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling Skia
  # and whatever else without interference from each other.
  'skia_revision': 'c53f9d64301c0d757e46ddc8844f604156158784',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '5e56e24f250f3e894f87c8612ef82ccf217591e1',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/clank': {
    ...
    'a56df24c44bda349bfb029022944dddf96f18c65',
