...
vars = {
  ...
  'src_internal_revision': '2c9fdcd4b08ac02a1f11fdb242e456e53b96ebf3',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling Skia
  # and whatever else without interference from each other.
  'skia_revision': 'ff0ff0117b79efc4b958b98cc02a1bb825f0b49b',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/clank': {
    ...
    '63fd70022c012a3f93dce2fe83ee8f2484cc35e8',
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '487e552926c40845da8a9f2fdac9621476c7e845',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '1ac162ee20a214bf97f6594a7effcbbc21f1effb',
