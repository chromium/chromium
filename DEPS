...
vars = {
  ...
  'skia_revision': 'e9b71c144e7a4837f021728b9f7f214737a843fd',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '65f473e0e4438e71b6869380937c9067a06727c3',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '40f936ebc05412df5e2c0962a57d973d44cec5a4',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '390ab6b716dd588d398a18db0aff3fc905497293',
  ...
  'src-internal': {
    'url': Var('chrome_git') + '/chrome/src-internal.git@c8fad24ab0de6484ea590c63e17d61d64687170a',
    'condition': 'checkout_src_internal',
  },
