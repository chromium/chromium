...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'cab73e1e13f8ed70513be6d646d7f0957c7178cb',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': '88d1f594cfd0bec8d0c38e30540a4c074a2cca90',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@9639cb9a57e6d6b92506c9fec2bb77a745aaa4cd',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'cdbb48d659db61b5d95e2334136aa1e4cede9c33',
