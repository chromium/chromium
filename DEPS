...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': '1fb7f648f5feaaf27576517bdb07859381f1226d',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'cfdedf00a0f2aec050cd0fe4b04ea9d4fb5832d6',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '9054aa8904a54de8ee0d298950f53539f714e3ec',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@34de26c1c4a290283bcf32583f2c8188610b8456',
