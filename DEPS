...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'ee023e6af4ea32e22c9f19cfa0d1041dc9fbb5f1',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '68df7954e3ddfdd2ba4b0085b9fd0cde80fdff0d',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@d58d921b7a5a863b450806a43834497a38b9ff4f',
    'condition': 'checkout_src_internal',
  },
