...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '196c9fce68105531bf6d06e632fb3241d70b6526',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': 'd9f5a980bb5a4baeb7d9c1fef89a39789a6cd9fb',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
      ...
      'packages': [
          {
              ...
              'version': '90nJxahuCDp57ShnEvQ7WSEUCFAb_kIp3y6u6bI9NRcC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'hDZ59kpnU43TJDX2koXQhUGLyZvGGy3Lod8kq1hd75gC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'sqx6o-s00SWfh1HXT-tESLtRgc23XBE7r_DwKuSmKxMC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
