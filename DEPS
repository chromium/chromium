...
vars = {
  ...
  'skia_revision': '699841c3e8624fe76b40f94346fef030ea18404a',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '09ac7d283dd71e792263b12a274320c3f30c46b3',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': 'f2290d80cf478be8e21ce80dd78d7a88c48ed933',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '92735c2e1845415adcffa3a3c2bd8de3544ab318',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '33a18b4ec9feae8acbd568a056bd1e86dc31828a',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': 'https://chrome-internal.googlesource.com/devtools/devtools-internal.git' + '@' + '340bc4934f3931433a84a5a68483b6c7a548237a',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '6f941fa396445168b3205af792b3f8bdc24587f2',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@aa8e35fa3836e7eb7359d1161816241bc0dfed81',
    'condition': 'checkout_src_internal',
  },
