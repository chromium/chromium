...
vars = {
  ...
  'src_internal_revision': '40b3a4c3e7b8ee9ade1d246fd5a713f258e2257f',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '526a37c34993b2e57d3fba25b7527686528a09dd',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '5279ad5610c740cd903ae84720662193617991d9',
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '3468e6f8f098afb080fa81ca17b1ba643232ce5d',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '61a52146f5b0443fbfd7506abd6fa7bbdf4f5f8c',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'f394ee93ffb381e64fc365b659801e0a6eed5e27',
