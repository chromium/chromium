...
deps = {
  ...
  'src/chrome/release_scripts': {
      'url': Var('chrome_git') + '/chrome/tools/release/scripts' + '@' + 'ab8ff2816e0961fbd95011a1af49a92703ddf730',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@19cf256e9611eebea1ac2cc6c0fce6965d584a58',
  ...
  'src/third_party/spirv-tools/src': '{chromium_git}/external/github.com/KhronosGroup/SPIRV-Tools@0aa67e2afa0df344dcf50e240c3190ee735549d1',
