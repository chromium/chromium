...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '9b44b12fb152b3d91a24e77c0d2e4bd8afe99234',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'a48a154fa57cca9be8cbbefe1a0f65d4d253ad83',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'e42ba4f6e0a24fa1ba1f1588f3fe4187b32ec6aa',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '42ee0a3309a91f7512d9de8f6ce6c0c8c7cdc7ae',
