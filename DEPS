...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '9313fe1fcf2b12d3f00ee2d93ea2b9cd212a77e7',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '69ba4f4f79b9e34135d31b54679dad9bdd82766e',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '53987851c66c473620be403e788f105cdc9d51cb',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '7c6fd858b772b5bd7dcaded58e4b221197712292',
