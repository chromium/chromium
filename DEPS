...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '85e5cbeb1343661118c03f3ef6176302b07c2018',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@12dc0b779643142b2c1443312649869d731c11c3',
