...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '30d129c8800b5626c46fb83fa62db10b9b22b319',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'angle_revision': '1c0f91aaa60a1f87725840495cbfd9717e7c77c8',
  # Three lines of non-changing comments so that
      ...
      'packages': [
          {
              ...
              'version': 'EDzDA6FB0pS2E8TZevxwSE_44-svQk4JQtoMFicNUhIC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'W4JzMUxyiEVr6Ft45bnC2GEzZ9wX8PJUwyYz5RgY56AC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': '5c23BbLDkNeeATfaeMbIKTAcmHULrw2xEQ_rPjVcwJkC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
