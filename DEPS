...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '6eadb9b3a512887d25dca232f47903a8dbb65b5a',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': 'https://chrome-internal.googlesource.com/devtools/devtools-internal.git' + '@' + 'a991d79f5eb15439d6bb71dbd61724b179eb569a',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '15a569594bd7fefe86fcdff152fdf1d359b322ee',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '5625a86f5aa018d80d1dcc4890e064c7e85c6d1b',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@41ba431bc05430fcb7e05247bba8e32cab3cd328',
    'condition': 'checkout_src_internal',
  },
