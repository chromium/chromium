...
vars = {
  ...
  'src_internal_revision': 'e8853bbc8c3c345027ac89fd2c75c0bfcad31316',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '158dc4ec7ae09da66e960d680868baa278787dc8',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '2ff932f12a8624b79d25df04115d4f9891084260',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'd95382fab7dcac8867d9811c4630367c4454cb7d',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'd542f75d1395f181ff5b475607352ff17f2b569a',
