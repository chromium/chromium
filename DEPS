...
deps = {
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '903ba6d736f05663415d988111970f61c663184a',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@ac052833faeacd250398793182ecba00bc82da2c',
    'condition': 'checkout_src_internal',
  },
