...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '0e62d11175aa55faee186f3becd622c7a5108f22',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'dae7c83260cb1aa80ceb569ffea68b9407e350bd',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '5bf48e42788d87649ee373f89cab366f6653b0fe',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '6266faa8f28f38696da17898a360a8e208bc459d',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '42976771f7ec7fde78b01506fc22ef525f4860c7',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '772731755a0a76bffbc0b77ea2b300d65d033ec0',
