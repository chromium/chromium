...
deps = {
    ...
    'packages': [
      {
        ...
        'version': '4ff4Uz2Rc3uRZ9dTwLSEkrp8gq4F9YrVeex312KEgHkC',
      },
    ],
    'condition': 'checkout_chromeos and checkout_src_internal',
    'dep_type': 'cipd',
    ...
    'packages': [
      {
        ...
        'version': 'Uj8KYww7aZadz6o-0jcRw7yTFh_by1Lyw1a2cS3BYsMC',
      },
    ],
    'condition': 'checkout_chromeos and checkout_src_internal',
    'dep_type': 'cipd',
    ...
    'packages': [
      {
        ...
        'version': 'tno8NXluyGT_lgb96KpIty0Z0AUI8WusojgNeMDW1CkC',
      },
    ],
    'condition': 'checkout_chromeos and checkout_src_internal',
    'dep_type': 'cipd',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '03430c94b4a70e9e466794f888e1e8c0a4c8afa6',
