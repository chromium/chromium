...
vars = {
  ...
  'skia_revision': 'b201c37f9d19ee4d14ce1fc83155661f82f7465d',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '377aab2e4667865896ec71698aa8677610896d85',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
  'dawn_revision': '14ed470da0b28fd66850cdf873ae52d800fe9bd4',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@35c52f8988c2d534f745a31b8996e01d0963f91a',
    'condition': 'checkout_src_internal',
  },
