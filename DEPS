...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'ZAhgHv1TxiUfpzQ_1i6A4m9Ca3jOUd47pn1_n1NPDzwC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/third_party/webgpu-cts/src':
    Var('chromium_git') + '/external/github.com/gpuweb/cts.git' + '@' + 'c1281de6a9da45753b6b4d77e407199034d72bd2',

  'src/third_party/webpagereplay':
    Var('chromium_git') + '/webpagereplay.git' + '@' + Var('webpagereplay_revision'),

  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'baa2059a2a70a24dca4309bb9780d60ca804e7b9',
