...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '863faf7fb4dcdfcdde265324c1eba8e2a045cf5e',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'fuchsia_version': 'version:11.20221229.0.1',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'd64d3232fa128f02064b577752dbcc0dd3d9ac28',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '086c26bff88085499c60880924b75a4ca6f42d06',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': 'https://chrome-internal.googlesource.com/devtools/devtools-internal.git' + '@' + '702aa24f0e4cf7257b5af660aaef7a41bfa03bc6',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'a3fb4e07872168b4097c997e0b7d276ef32d8b50',
