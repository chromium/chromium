...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'eb7da1eaf43d93ef7d8ba24ce8ac841127671d0f',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '9c16560693f200a81db1572ba829baf66c3ae9af',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'e02a8117316994f2acd3fdcb1647d12f1371c82a',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '7415341b2c60b9fdfd98a5167507bd0f4980cb40',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'e630a3d7ad5010f5e11a58f66e8fe39939984b77',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'c2291d3cd3193225dc2c06f17474eca555a172f5',
