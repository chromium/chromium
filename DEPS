...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '9d9766c4af47d4c6a10377a8d6f8efd2b7b70b97',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'fuzztest_revision': '3a04e5c9611e7f0fb9346bebe637400cc7ddf942',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '3ff16f376e25da959cc4c15a83268106628db7de',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '48a4b672dd7dd8b16b8d12819c213b1076b04c49',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + '859642bff054a844411ec0f90f0884b33e0247a4',
