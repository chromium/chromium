...
vars = {
  ...
  'src_internal_revision': '4489a0a2b1a4c2d00f1a098f16d5d733b3ba5b95',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '222041a04d06c75534063465c34411ec501994c2',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '3f2c3e8a0426b7d72747f2e01aae35abb69a6ac2',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/clank': {
    ...
    '0dd90a5782c7c896960b79adcb44bcfb1d8712cb',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '03026efba8f3ae933c03ead1bcc0c772365314d1',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + 'e1b65d4b6fa8e522b8ab3047fcd3ba7f79e26529',
