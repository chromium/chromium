...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '4b3ed3ee3050407145cc69e8a4f2d786aea7a3c0',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + 'd94e4dc359a4d002a2fbf4bd11d22b7ecd1b2466',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'b6ff84b5168136caa1537e91e80701255cb52843',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@b09e321f3d6022d977078b4ee4914864ab364081',
    'condition': 'checkout_src_internal',
  },
