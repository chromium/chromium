...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': 'cc9c81d7fc4d532d6faef3da1ba7e0b384cd9dae',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'e102d2a6d54ae7e96dd00d9684121dad594c8f1c',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '5a38e86d41c5520566f83e467b718b34d389de8b',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '8ab662be102dec1e7db696d75ce6529b1c8f5aea',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'f654998b8090f558ae5159efd5086ddbeb235465',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '887cd1903a6dc0beedcd435d1b13b7a9a6a217aa',
