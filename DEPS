...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '2d3e704beb39f7f2d91e16af651dec8fc943851a',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '947166d547a5b5528eca194065f11ce5c99f97ca',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@627986cabd836508a95873043905a7d520c15a35',
    'condition': 'checkout_src_internal',
  },
