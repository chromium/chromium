...
vars = {
  ...
  'src_internal_revision': '338902d18493f2836789881a8b4d4382acdc7757',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling Skia
  # and whatever else without interference from each other.
  'skia_revision': 'dc3da09ca905a1ab7eab79a7eafddee3ab0270cd',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '6c5c0d0e3546b41fe57c0772b5186ef7b2271524',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + '7ada5c9db49a7f52ffdc423ff76538c655a9c1e9',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@d1577d1f5f2b5d263cb96edd0c629d04c7cc7f4a',
