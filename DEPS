...
vars = {
  ...
  # and whatever else without interference from each other.
  'crossbench_revision': 'a83a66ff35ee674de044384038cffc2b2089fbea',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'e55fe887022f71c83e1b3b052ce0192eb1557c44',
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + 'a4c2038a298f5e2993e98295c5a7cf0e9fc719f8',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '0b84b26967fe834c5fd34ab36aa59723a837e2ec',
