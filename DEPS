...
deps = {
      ...
      'packages': [
        {
          ...
          'version': '6NQ_ckFqbPMII28QZ1DHo3Z0yA2UqzacuHoy6vANNUEC',
        },
      ],
      'dep_type': 'cipd',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@5eb9460856930ee4ed36c1abf2b952eb5ee56a11',
    'condition': 'checkout_src_internal',
  },
