...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'ea70300ba04404ba0c1cacf2173a0a1e3b443adf',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
  'dawn_revision': 'b0987d6e46ae4be58b009af9c242d4c841519f05',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '3b2974f6cfefec527332a1521b53d33a49b19427',
      ...
      'packages': [
          {
              ...
              'version': 'Wdnse22My6CRHP1P17guf1W6_Z4tCbhzuevnCZ2TCFYC'
          },
      ],
      'condition': 'host_os == "linux" and checkout_fuchsia',
      'dep_type': 'cipd',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '10ab697dcbee66c4570f6e767274d92412af67e7',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@64926a34a85012571e2baa33ac491b47655caa07',
    'condition': 'checkout_src_internal',
  },
