...
vars = {
  ...
  'skia_revision': '9ea0f5911f804a73806ad3ae935769ba9f42f30d',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '9a8cb2c0be476a447374746bc7eb95e47d9914c9',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': 'a4f71e40e571a8768f8fe2dbdc35678bcb9e6783',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/icu':
    Var('chromium_git') + '/chromium/deps/icu.git' + '@' + '14e51893e5b59140c9878ec2f53045a4fcdbe6e6',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@05d0ef3a959fe5df63ad0e65141a7a74c830c8b6',
    'condition': 'checkout_src_internal',
  },
