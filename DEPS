...
vars = {
  ...
  'src_internal_revision': '35873f7b2462d63785d5beda32ece9362b716ac1',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'f31e4ccf044c1744edf3a94f895ef823a509fd0f',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '075881c4632160b5322a68c1c83ed523808a63fc',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '469a1a517020c9135df82b5be98f1e18cd5cdf1f',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + 'c997b03e0b7d7afc0913a0164e0d8a4116d42730',
