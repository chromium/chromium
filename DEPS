...
vars = {
  ...
  'skia_revision': 'b493f91ba151ab4ca881b78272fa014dd7bd0941',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '84ad208406b689969d4c928e9a84ddeb7c5ea332',
    'condition': 'checkout_src_internal',
  },
  ...
  'src-internal': {
    'url': Var('chrome_git') + '/chrome/src-internal.git@dc7d4faf2743e82bc27bc5a4e408bb389f714b85',
    'condition': 'checkout_src_internal',
  },
