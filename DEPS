...
vars = {
  ...
  'src_internal_revision': 'bfe1b7cc408afbb7ef90ee41521f65ed395ae0d9',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '3555ea8453e88eb851171d7b5a5a3969dfccf6db',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '58e64a83af3a5d68eccc936430b09da8a9093438',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '10ffc9f7de627e7229c3061c261dd1dd452cde72',
    'condition': 'checkout_src_internal',
  },
