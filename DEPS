...
vars = {
  ...
  'src_internal_revision': '2536a7827b492ebe44d5136e0ea6c001f207c3e7',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '8fd9b6c4481babb973bba94decd8e2614669b5e9',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'd51117d60547d1b3c08c0a6422993deb67c113b2',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': 'aecb406b5e2519b7a4725c14c747894b114a9f11',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/clank': {
    ...
    'eaf3d9e173e0cb1e342589bd76ad81b9967a81b0',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'c7585b33e2510e641603521d62f6d12c5f51f276',
    'condition': 'checkout_src_internal',
  },
