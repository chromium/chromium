...
vars = {
  ...
  'skia_revision': 'aa6cd276a83509183c0001e170d7e11bde0bb316',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '24731722650d697aa6e86beae03711290ce2094e',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'a7c8a38622d68523014194c69e744effdc1c2df5',
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + 'b2429ece99e265a453f177902e6a3446d017ca2a',
