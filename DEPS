...
vars = {
  ...
  'src_internal_revision': 'e8b2069ca82fdeb044807dc322c3ec54abdb56ea',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '346d072544d5e837a96578d133ece3be78005b81',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'f90b803913fd832d060f77d7ddbefd43b1e0c784',
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + 'fc6af5ccd7d754accec3ba4e944174c070dd49bd',
  ...
  'src/chrome/browser/platform_experience/win': {
      'url': Var('chrome_git') + '/chrome/browser/platform_experience/win.git' + '@' +
        'b486c7115923154acd9b490d00149646fd7f90ff',
      'condition': 'checkout_src_internal',
  },
  ...
  'src/components/optimization_guide/internal': {
      'url': Var('chrome_git') + '/chrome/components/optimization_guide.git' + '@' +
        'efb26838d7176b2ed9ab830033a683fd101dd6f8',
      'condition': 'checkout_src_internal',
  },
