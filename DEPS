...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '68a0212d298bc788debdbb225a168be96f63c7dd',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'f5f6ac59025c9c34c1626573d6b5f77f804509ba',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '02d6754dd5cd180b7288bcbaed9b9e0a8a66b395',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + '9d9c4e778b7867127e336d7560ddb49525b12faf',
