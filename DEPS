...
vars = {
  ...
  'skia_revision': 'fde37f5986fd8cc1b2e428ddacda2b553c480396',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'fuchsia_version': 'version:11.20230102.0.1',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '1edfdfdec2f8e8a39f221e5823b44ec609ea01e6',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/clank': {
    ...
    'b4d920bd545bdf33344fe1207a2fac155f73095a',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': 'https://chrome-internal.googlesource.com/devtools/devtools-internal.git' + '@' + '1853b474c70a0f1b1920fffb31a16f16e5df6ed7',
    'condition': 'checkout_src_internal',
  },
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@d72aef9ee8f41f01a87fafc977d69e15c080b260',
    'condition': 'checkout_src_internal',
  },
