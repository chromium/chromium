...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'f376964e55e844f0661b95db33837d6a209b7f56',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '35def679a57a9540e37dea4f88493f53bed9e3e2',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
  'cros_components_revision': '7d69b864874507c59135a428bbd25c226cc1fd72',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/clank': {
    ...
    'ed21146e48d95685d85019c671bd00c1f0682643',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '71e5b53b1b6751f81ef5c73ac1bdf5719bb7d413',
    'condition': 'checkout_src_internal',
  },
