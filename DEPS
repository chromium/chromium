...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '7beec4be23867a11b2ccf828502303aa705a7cfe',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '58fbd1bafe92e4531d582436a863087c8201ba60',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@d6db8b1d953c4d913e9050d753b03415ee3ed179',
    'condition': 'checkout_src_internal',
  },
