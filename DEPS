...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'e10803f765b2a9be08cef9e249da2e777d0f3d4e',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '564de099675d7b66a3cf1d63db5b1ae44f3a37b8',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@10489b007e219baab83bd474e673e57551e4f30f',
    'condition': 'checkout_src_internal',
  },
