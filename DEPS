...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '371239eb12ff1b91014236c85ca7a2cccc64d083',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'crossbench_revision': '1cc40632e4ca2dba02384807a7af92d1899e87e2',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '5ba96042deccae247fb83507dd54872a7577c0eb',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': 'd3d43b36d3ed64fc6fb3591c568f3d6969441292',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/clank': {
    ...
    '34279c480634ec80328493adc5773bbdbf3062df',
    ...
    'packages': [
      {
          ...
          'version': 'IvbAUrgddYsFm91IQUCIOiQdTVrf4lH6MazrnG_735UC',
      },
    ],
    'condition': 'checkout_android and non_git_source',
    'dep_type': 'cipd',
  ...
  'src/third_party/leveldatabase/src':
    Var('chromium_git') + '/external/leveldb.git' + '@' + 'e829478c6a3a55d8e5c1227e2678dcc18d518609',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@8e630125b1718c1960a73f54e9a9ad3fcc80f1e3',
  ...
  'src/third_party/vulkan-validation-layers/src': '{chromium_git}/external/github.com/KhronosGroup/Vulkan-ValidationLayers@9edf248c597b5876df8cfc384c8a0d8bc6bc83de',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'c6278957d11fc63c6acc3791ef31672744ced623',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'baa6b29be57aa536b917b86eeaf23a49479a3e83',
