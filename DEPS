...
vars = {
  ...
  'skia_revision': '70ae43148dc553ab80f86e8d734d0172e61f2cf8',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'd3e677167124e39394c236431a439349c9b9c4eb',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling SwiftShader
  # and whatever else without interference from each other.
  'swiftshader_revision': '6bd0509636c86b4902dab5a24026114c9d008715',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '0894513760cfda086b5c2a42aca2d3edf5ae8c9f',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@1d147ab3d6bb7de08bc84fd29081062a4202c099',
    'condition': 'checkout_src_internal',
  },
