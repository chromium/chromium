...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'M913uM9SW8lhNLgvbfazNkKBgH4vZGAxQttvU2la2wgC'
          },
      ],
      'condition': 'host_os == "linux" and checkout_fuchsia',
      'dep_type': 'cipd',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@0d3670244c111ffcaa18bcd6feff9e3863b9febf',
    'condition': 'checkout_src_internal',
  },
