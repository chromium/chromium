...
vars = {
  ...
  'skia_revision': '51fa1d5813d3bc4d34c6734fd9693553a63a40a6',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'f77121cc6b533d820823f70e2b9832751591796e',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '2e5dc94b5436e883bd722e9c0ffd77f63c11c7bb',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/clank': {
    ...
    'a6346783c5328914b652cbe078a49afb0b5fad7e',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '28c9c41cbedab7a7fb748a2dc5fc160efbb621f5',
    'condition': 'checkout_src_internal',
  },
  ...
  'src-internal': {
    'url': Var('chrome_git') + '/chrome/src-internal.git@4ec6ede812b0eedb0e124badfa12f0fce091de1b',
    'condition': 'checkout_src_internal',
  },
