...
vars = {
  ...
  # and whatever else without interference from each other.
  'crossbench_revision': '29ae86ba7781192232a4cd5bee75b1b955d74b25',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/chrome/release_scripts': {
      'url': Var('chrome_git') + '/chrome/tools/release/scripts' + '@' + '321d1f592299eed02d49973a003d41a33f19ca21',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '9acd4d1201ddc27153141f92790e9286c23bff2b',
