...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': '9a753dba4faf562a14d9e5c90991486cff5f4dfa',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'crossbench_revision': '46a7b9658482e135b4cbb9d50dfce8f9f08e6066',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'afd77e5343187593d9ec2b091520765e755358a9',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/chrome/release_scripts': {
      'url': Var('chrome_git') + '/chrome/tools/release/scripts' + '@' + '8a6c4b35a9dcd752a7d5f9152d1ccfd35fc3968d',
