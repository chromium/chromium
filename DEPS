...
deps = {
  ...
  'src/clank': {
    ...
    '532c71a2be6bff60804922daafbbb2f22334cefc',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '8797eb3c0245408600bea1a62ec5914b94ed3146',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'f0d954f659a77b214b0ff177e6f66bad1d626423',
