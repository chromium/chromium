...
vars = {
  ...
  'src_internal_revision': '909c020c8fb2d370592e487ddf40ba29a2579041',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling Skia
  # and whatever else without interference from each other.
  'skia_revision': '59c6cad539f7fe01a42bded543beb927546739d5',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'ee05836a4934129527544385203ecf420afc5dd1',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': 'f39150de4906bdac6f3fec9a3a0430c54cffdbc4',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + 'a2c5efe7f8cbb386fb87516edf820e6214747835',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@ed7288c778ba9986ddecc2942d2ae45aa1487e7a',
  ...
  'src/third_party/vulkan-validation-layers/src': '{chromium_git}/external/github.com/KhronosGroup/Vulkan-ValidationLayers@7c24cb9cc07728dc05bb49d3b594e94c24e711f7',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'c7e0941cee3eb7b771e18d0c93155e238d874866',
