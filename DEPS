...
vars = {
  ...
  'src_internal_revision': '43434999069bd30a576a66fdff51f5288237b687',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '8d801a30f79bd45976c63da62f1b38f025858286',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'd72a7e50d2737feaabeeaaeb0b500ce4c2ca906f',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '5432cfaef1b8b3fa42eb583bbd3338a4519a4aa7',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '96b51292675ffc7b6bb924d76c418d4909f2a198',
    'condition': 'checkout_src_internal',
  },
