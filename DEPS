...
deps = {
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '87e7b3dd6c585b2009c051112777d4285d6bc844',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@2bc8559d78627007bd7ce53bd67d5027ed5467af',
    'condition': 'checkout_src_internal',
  },
