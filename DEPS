...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '58f43e55f1bace20db6549c9df60224a10dfdfe1',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '7189b15d13e406084a462ed14de0aa1f710f6892',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': '7ddc219f8b8fe5810d8e7293d316b283e9e2b393',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'd4ac6bb97e0f63c0c3b346e0627a2414d7939fdc',
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + 'c9fe205c6677257b8d332737562d9146432d5a6e',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@5206b9c5537c131c788dd70fb406fbd7f7562712',
  ...
  'src/third_party/vulkan-validation-layers/src': '{chromium_git}/external/github.com/KhronosGroup/Vulkan-ValidationLayers@a9abc3636996b94c43f55b802bb73e63961f547a',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '8af8b85561741bf987e88c16f5b2158f5681efc5',
