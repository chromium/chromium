...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'fedc92bfd3bd5edc80965287ecbb1b6947c240e7',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': '9b75ed9a32988ef859703dd3794968be927d4e1b',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '70b8a78e61436ca313eb49ad06e4ba1abd261c74',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/chrome/release_scripts': {
      'url': Var('chrome_git') + '/chrome/tools/release/scripts' + '@' + '1b46ea6a8f18a36341f603371b4840d6c0d863a7',
  ...
  'src/clank': {
    ...
    '8e9e7364923505d441263b6847a82b591db74d2e',
