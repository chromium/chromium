...
vars = {
  ...
  'src_internal_revision': '35718be5dbd7908007d554152f8f83122462b875',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '5bad19eae083f6904cfb218b732a1224af322ef9',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '7bb9852d623d0a3480677ebce55c8b87ca8cc4ae',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': 'f7386737af831594412c56decfc76ada1163abb6',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/clank': {
    ...
    '40e79fccd1816815f93390329e723576d9e8db15',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '3e09a7a9da001c8f6407223f97267eaf34764b94',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '3861413596e8ab1189c102b7e1e3dfae3376eecb',
