...
vars = {
  ...
  # and whatever else without interference from each other.
  'catapult_revision': 'ab71952890cb723caa14c6774f594a1e611705cc',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '58e8d8269e21ede1242eb049fafe51b592f82b9e',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@16c8c648c4bc40791af5c3db2aa9bc4d879ade3c',
    'condition': 'checkout_src_internal',
  },
