...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '7d2bc92f5f92663cf378e882b256a667632d0f7d',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'MwG0hUpuOG1fWsP4H9O8Yo_2cQM4oabnbm0UkqSxka8C',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 't6jKZNIvV3ANjHaEzK0B2FjwXTWPUsyUzoZ8hHb4Y_kC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/third_party/eigen3/src':
    Var('chromium_git') + '/external/gitlab.com/libeigen/eigen.git' + '@' + '34092d278812c68692f9dcf1ecab13e69216726d',
