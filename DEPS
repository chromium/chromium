...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '5eaf624077b5df5a6098957a5b0b326610665d93',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'a1df00cde45fd6d8be0a3c50c24e1f7a90bf7179',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '603d6a0d99fbb34adf25d15c8ddf1246ba4d1776',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'c2b3cad347f41d80f0fd3089b3e1b863051b7e49',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '74e7f32b3b4aa22c432357384034900b80b88ebd',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '6e586e1ad29039d51c66c1eedce3d25a5dd49b81',
