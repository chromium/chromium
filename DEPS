...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '00a4f56a5429bf8f9e78f91915e6892ca6d7139b',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '9cfc7f9b9c1d44ddc5d13d8315399eff6e651654',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '7cff817e868df3c661e4e856ee8a42949324d209',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '4fcd05385a507a55a7984e7d982589771600a6d8',
