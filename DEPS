...
vars = {
  ...
  'skia_revision': 'c5a65cb22d362f917777db09f1eac15ab29fa018',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'angle_revision': '71439efca7ff212dbf4b140db82887611e54a1f2',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '905f814dbac63f13a55861993b3750eb429c24a0',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + 'f6fca142a208dbd263313f5d276c51cc0aef663d',
