      ...
      'packages': [
          {
              ...
              'version': 'dPB6J5f-WFM6V7qnVSUXHHi0vJ7niHJO6Iaach8mhcMC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'ZnyJ0rtWrm_gmZUPVhUidPnDfqaNN_3ooEGBb5tkrJ8C',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'rJPnOrDd0BTYSt9_MmC9y-jT8tWzgHY9TdHuZHetcg0C',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '379c5a9721aa3acf1e54d99242915ad9fbe2f96d',
