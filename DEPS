...
vars = {
  ...
  'src_internal_revision': '29d95f8c9f7c7abf6c86273ee678bf9ed55cb937',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'angle_revision': '4203139600b50e9ba0b1de084f6b954ebf22ced6',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '19360b34d07191326cc9cb56e34d0319902c3e81',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'ad9c17b6780585d7f80c431ac158e9e888cd5cce',
