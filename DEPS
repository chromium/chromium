...
vars = {
  ...
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
  'dawn_revision': '05b770ae86177f40c7119fe9e7b6034e04dae8df',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '36dbfca8873c511c3c14609d1e17ef70224e0b83',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '062acd9eb471fcc9157d589380333302e5d125b1',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@837c123de8a913c886259778de6ccb20739d8cf3',
    'condition': 'checkout_src_internal',
  },
