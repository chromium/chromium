...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '730b13e7a3dc5e57a335f2c4ecd18418658edac9',
  # Three lines of non-changing comments so that
      ...
      'packages': [
          {
              ...
              'version': 'LIYxQA2GUXLk2edL_2EADfSsxiYi8iC0EbIO185ACokC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'dMeRJMT0tP39FxnzT2Q2UXr-4dkGxpmNzuBCL9QtjysC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'cGQ930aGs2_oxfaltRlBtWlMMrxO6j5BXXWPYt-9P-4C',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
