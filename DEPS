...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '838e15f3e43b537c02f5d038525ee69ce10880d5',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': 'https://chrome-internal.googlesource.com/devtools/devtools-internal.git' + '@' + '72b7d26e51710773ef2acb2955198bba18401488',
    'condition': 'checkout_src_internal',
  },
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@de27e1368bdb4f8829005fe37e3b04a26aae2f15',
    'condition': 'checkout_src_internal',
  },
