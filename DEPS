...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '14ccf649114e66067cfe6132fce6fc2f22fb3194',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'f04fb14712507857837cfec65707c5827d77bdc0',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'HTKilCnzzXzMNS-5av3Nst4vsDuIzojexEtxRFJje-QC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'hSciml5fnb5XaArTYr18CgXNzS-Gk0KcJcgtnpzcWmsC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'QKpQQC4uZkNwKccclwMTRNXx01ABSp0GWS-XD7rqimsC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'de817d4ccf67a457e310c6a1eca6eafcd9c2977e',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/components/optimization_guide/internal': {
      'url': Var('chrome_git') + '/chrome/components/optimization_guide.git' + '@' +
        'c50ac4f55308d083b6ef8186038939218eb456c6',
      'condition': 'checkout_src_internal',
  },
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'fe5e892a91cc6f49988147d8b6872089f9e4b21d',
