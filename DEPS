...
vars = {
  ...
  'src_internal_revision': '6ef5be014204509360b37f2f2c38ccf5b3207aa5',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'a485435d13194868d13a750844db1d84d1729e75',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'b88f4c4eca4c24d08acad47c7c7b7e4c0bab516a',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'deGGmCgCmr5ni7rXpd98JCjNocalu0UUsiAJMiHiCvAC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'Fyu6-DLyGJ8rXndzl7X9hn94tJGEY6idGTwhO7PoS5UC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/clank': {
    ...
    '7f76398dd20ace4414df159450ee4f665f59e118',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + '79b66cb520be165bcf82f628666c764429123cc6',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '4eef1b18f51fa7041956dbfd6fd1161ca4bcb1ea',
