...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '14e7dd2ec8f6a74589204f35c0a7d445ffe6f935',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'd6ad612ccdfcde025cf7403e2877b885121afca8',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '6b6ae349f088d22938376dc34ba412f0d7738977',
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '008ecc31b215d7cd45b61292ec67ef7e4e3e35e4',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + 'eb89044a47f0805706f2a4ce47146feace41ef84',
