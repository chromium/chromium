...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '59c58ba7ac0c47e126164b3ea0c9e1873021e4f0',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'b24f069b5c6487add5b024e76fc7eb4f248c65cf',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/chrome/release_scripts': {
      'url': Var('chrome_git') + '/chrome/tools/release/scripts' + '@' + 'be9169edecf1845c19440343d2151b9bd19b5901',
