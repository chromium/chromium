...
vars = {
  ...
  'src_internal_revision': '6d08ac2f1ef39860365f0c20892edae9b5a4bc6d',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'fb6a232ccd16b1052248983cbc96af8e79a04f98',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '11e3f26092d5574b7f7c0357048224ad15b1cf08',
    'condition': 'checkout_src_internal',
  },
