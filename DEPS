...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': 'e1026639c7816001da60cdb0bb9ad5ec72aa2a30',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@5c4dae4b61c1b7f1c6d5e1c1c257602f0930ca05',
    'condition': 'checkout_src_internal',
  },
