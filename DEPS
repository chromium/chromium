...
vars = {
  ...
  'luci_go': 'git_revision:c5ba52b7f9e08d2660b56cb6bef9fcccb16bc66e',
  ...
  'skia_revision': '91216d5b65ecc8de586dc6808ea9aa4138e74e7f',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + 'b2c07b2300438244429333d5fb42248442985850',
      ...
      'packages': [
          {
              ...
              'version': 'SBtMPfaG0B_y-t5gU-TNKMG47xj34Bi6kSR9PkBZIxEC'
          },
      ],
      'condition': 'host_os == "linux" and checkout_fuchsia',
      'dep_type': 'cipd',
