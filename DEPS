...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': '1be015356eb8530b43e4c71b6cd514570186e08e',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'a3d469d468613028b00ec4aae82067dd392f4b9c',
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '6eed548a47030e2962a5950ef29d161110c52ae9',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '64d384ff29dcbaf39f2d68a515bb1784e52cd55a',
