...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '7ad507eca0bd223c3bdd392ea72550a45ae0a104',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'angle_revision': '602a6a9a532fac607e3c36824a8998e270d406a4',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '6f9f9badec715bbb53e1163bc7cf9c3412cad29e',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '6e6172a7ecc30400437bbe53d6c8c006ab8f3f48',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'de4e9d1a7452506a564c1aca9f0417597a906534',
    'condition': 'checkout_src_internal',
  },
