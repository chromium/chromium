...
vars = {
  ...
  # and whatever else without interference from each other.
  'dawn_revision': 'd3fa3f0e23cf8da1db77a464260d0fa8dffc3c4e',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
    ...
    'packages': [
      {
          ...
          'version': 'c61iciZGOuwjI0CNlIMBA5f6i3kvUYpWuZ3vPzEjUTYC',
      },
    ],
    'condition': 'checkout_android',
    'dep_type': 'cipd',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@f95dc6c33651403c3bd1f946914c4e4fcb939a66',
    'condition': 'checkout_src_internal',
  },
