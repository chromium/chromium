...
vars = {
  ...
  'src_internal_revision': 'd9028a198915395a27d51217d1d10095ac27d9d3',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'angle_revision': '1025f0a9b35285900d810c6843c9fc37aaa4782b',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'a0942527c631c7cd0ccc9141c07df2a8aefa1f1f',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'e37bb3d2dbba4563a482e6cc5485fdf732f9b00b',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@e7d6ffd2affc7da3a1c7571052007d399ef31d58',
  ...
  'src/third_party/spirv-tools/src': '{chromium_git}/external/github.com/KhronosGroup/SPIRV-Tools@748a140f969328d9c17edc9a1188f6973a6bd1ba',
