...
vars = {
  ...
  'src_internal_revision': 'cea880cdcf4eb8c313e478a01ad50b9b6b4b0853',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling Skia
  # and whatever else without interference from each other.
  'skia_revision': 'bd5b8d13e0aaac0912b213f2a8bcb147273dbe53',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'cbd5e68a1af9f6de574623bb77146619b01b8235',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'd7HZ4wPGXSLZOkd7aJ588XeXSp0qbQtlNiqxLYQRx1QC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '012ba18eab91ff6ec5991b7135c952ce7be94a5c',
