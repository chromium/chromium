...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '50841da4a7b7064b3cea8a851e60ef921c87a103',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '34e8ec12a41742b454346b3fd44ad0ed08738b07',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': '05459080c9a323e89a52209efb799d6dc5b68a86',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'lPDGjITsWOGMC00Y5R8YJEwxth8pezYGPjsD0u3Xi8QC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'GpB35suaYBx-gl9I5I_9tz3PXp_UpC4L6gTum7RVh8YC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': '9NoRmqdjGaRi4ZwqO_0O_2U5kSdAjUHU_-3I69NsgbAC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'fe210de7215dc375cba88a42df2715e4a4d6706f',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '7bf450e837f671b7f193473b99003739b76399b2',
