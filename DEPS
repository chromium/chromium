...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '523ad2bb1ff764f92fd3941c121651db8f570fb0',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': '3b96a73a23bd5bfe397ac34736dac2031f22458f',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'boringssl_revision': '14fa4996cb794af518b18d3a41733153f5f5f2f8',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '041558d125d70e71e3d0143ab93fe78611a4aec5',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '6713f183a8736461d3d515eb49d9523305a7f0d9',
