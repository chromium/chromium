...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '059a03eec978a9185ca5afe3e3adeb2c4b3ac5da',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '374ddc5c02b84613fa8c20c3fc60d8dd2a0b9698',
  # Three lines of non-changing comments so that
      ...
      'packages': [
          {
              ...
              'version': 'u9uIYmcNGCp1S-maJjDxXW5BNOphQilririCSr7bgh8C',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'QvD_mUjiI5o8ns6qw4kl5rop9W3unsNPSYshy4t4qqoC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': '6B6RHBJHL3VsDX0MNYZmfpOWP3MfPIUDYmU74nV9fKQC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '123aa947de71ffadaf183e84dd08c5d512935175',
