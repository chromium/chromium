...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '55c9c377f0b028c4966481d7e437536eeca8a734',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '04821fa116f29d3939381f27c0f0ce092bf48eea',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'ab9535c0989b79b74b241dee88c505d79fa474f1',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'd41d9982e0e907e0d305b515f0ad75ac5035231e',
