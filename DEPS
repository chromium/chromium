...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '1536d3975057297af8087d22419f6c95dc96305d',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '44ac520eb42ec79968df3dd7b0db91ca681ccf4e',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '8d036103a9fd766d64e72a85b2099f7d468e93a8',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/components/optimization_guide/internal': {
      'url': Var('chrome_git') + '/chrome/components/optimization_guide.git' + '@' +
        'c0c5f7fe8697944321629859f7cc1cb5bfb5ea50',
      'condition': 'checkout_src_internal',
  },
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '361322a47d1eae66d80df9d976c780b001070da9',
