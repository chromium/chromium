...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '4a8d3db3f0d3480425ced5b8cdab5215ca575148',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'eUrTIl6lewwh6OoPrY-ZxDgjx7boZgQyuow1EjfU7LAC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + '51c6d658b5e18c75d5deeeb9df9cd9491e7cc8a5',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '2d71ccad18e407459ce231e565e196932617abf2',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '250bfe8a5189b25d3108af555490121a3aa0272f',
