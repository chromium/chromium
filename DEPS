...
vars = {
  ...
  # and whatever else without interference from each other.
  'boringssl_revision': '6a7f096275070a950cfe3a9fda45bf633350228d',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'b5a777579b0e6f3db3848f5e1efe025d52b1780d',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/chrome/release_scripts': {
      'url': Var('chrome_git') + '/chrome/tools/release/scripts' + '@' + 'edee2128909c42e3ffcc681ba44d64ca8cfb3af2',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '3726ee0cecba4bfbb31bceb2db7165ec5341410c',
