...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '75a4bf6706bd9c13b06975864fd941e495aac848',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '8888b75ecc0e3ac236e6538cd5116da0f8f35703',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/clank': {
    ...
    'b3a5267cc304b2aa72385fb9a0f38477b5bb7c28',
  ...
  'src/third_party/eigen3/src':
    Var('chromium_git') + '/external/gitlab.com/libeigen/eigen.git' + '@' + 'f7a85f8e9552a7d1d885b07bd52bab557332cb95',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@ff429e66da82b4a06ac2e22798f102535010c4a5',
  ...
  'src/third_party/spirv-tools/src': '{chromium_git}/external/github.com/KhronosGroup/SPIRV-Tools@891df4cab0da905a9d22231b4e239552022911f0',
  ...
  'src/third_party/vulkan-validation-layers/src': '{chromium_git}/external/github.com/KhronosGroup/Vulkan-ValidationLayers@85b45ff8f6e2cd4ae93a7b4cc4d21879ace5c325',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
    ...
    'packages': [
      {
        ...
        'version': '7Be38qxpczeQHgdm-M5TyCdpnrv0JCw5y0FBMTfXJmUC',
      },
    ],
    'condition': 'checkout_chromeos and checkout_src_internal',
    'dep_type': 'cipd',
    ...
    'packages': [
      {
        ...
        'version': 'RmJF_XaaaSUN_RQPhf__feXgX-dya7a0G6MbtKQX8xUC',
      },
    ],
    'condition': 'checkout_chromeos and checkout_src_internal',
    'dep_type': 'cipd',
    ...
    'packages': [
      {
        ...
        'version': '7rZC4irU8COBNYLNlKYH8XZg3iT_YJyxxf5GxvQsy2UC',
      },
    ],
    'condition': 'checkout_chromeos and checkout_src_internal',
    'dep_type': 'cipd',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '4ee76c4f4aeba289d9db5977b9a6e1be1a7dea05',
