...
vars = {
  ...
  'src_internal_revision': 'dd063826fb14be0a956ffa39cf1483fe4762b1f5',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling Skia
  # and whatever else without interference from each other.
  'skia_revision': '54ac6609a26520583876bd7ecc9e5b1e43a1f9f1',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'ab9b7d719e358ad3a98d6a6ce86bab3905fd1046',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': '3d6cf23c7d8d3b08feb824e364d228b767be7d3f',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + 'a40df24c915e082f86e5cf5a24f640aa715e5c6a',

  'src/third_party/devtools-frontend/src':
    Var('chromium_git') + '/devtools/devtools-frontend' + '@' + Var('devtools_frontend_revision'),

  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '97e03ad8c577b25b8650d7cf91b3356bc68972eb',
    'condition': 'checkout_src_internal',
  },
