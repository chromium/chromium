...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': '5ea435e34885c1eb991c594c378310c98d8cdc53',
  # Three lines of non-changing comments so that
      ...
      'packages': [
          {
              ...
              'version': '_RPTUKKRD9GcLpuV-4qOrwLfyygM0BRvu550gozXNdgC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': '63_nUuC9jV-ebYePn-OEOk-zw311UkOjK2SlWQ1wL1IC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': '6OJuBdJO3BTEzC98TeY3XxuylwmVEURxHm5HuJ-OKawC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
