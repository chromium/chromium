...
vars = {
  ...
  'skia_revision': 'd0b3f6eafe1c26ebbdcbe276d1c256a899b62931',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '45dbe43da1c4164e76d69188f74143b1680a6c98',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@d211db8157046c95362a0cb4163738bb0c06c02c',
    'condition': 'checkout_src_internal',
  },
