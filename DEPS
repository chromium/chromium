...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '02c660ae896a5d69bc999a65692d1e675d6efe3c',
  # Three lines of non-changing comments so that
      ...
      'packages': [
          {
              ...
              'version': 'CQKihpX4pyiroq2IxWM7-CL8ooiwXaehbaWk85U8N70C',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'wShaO90v_Woc3E796hgeGOyHGSO9i817lh71Et8sZ0sC',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'F3U0AoJ68I1wR9tEgNR6w8tvhrB1kNHeao7WTehZLokC',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
