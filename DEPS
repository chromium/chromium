...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '91500f20a4e983a43c192a4860fddab036cda367',
  # Three lines of non-changing comments so that
      ...
      'packages': [
          {
              ...
              'version': 'w1opLXf1uVQ0gZtCqO8UgGmI6rwzZPAW9lXb41ZCDJAC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'dKjS13rpfpqelKLInGh1b9EcKI_VWxC4BKFV7KV9tDwC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'I_80k3J9-_4FKk8aBlEt61W8HHB2acCAdAEBH4EGI4oC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
