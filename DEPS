...
vars = {
  ...
  'skia_revision': '5de8b1950422d002f9c1a1ebdf545364d7d1dcfe',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'ca90a4d5473f6f109e4b9f5edc3593c622345a75',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + 'a5221eeff147144bf86e1257b32fafc65bee603f',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@20a67358bf50356b09e9dbc0f0fa4f12e8a74b86',
    'condition': 'checkout_src_internal',
  },
