...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'd07cbd2c3bea2d2295ed1f40e34323c22efece0d',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': '3e83d1887e2bad0d5dac01b37fa94b88188ecd4f',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '7fde1a7949cf4d9234500f1363c4576cb0b36b6e',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '5f8377eedbc7f6707f33d3983c1f4c4dc6b0b7a3',
    ...
    'packages': [
      {
          ...
          'version': 'FlpHLn9UD3XQvlc6qOm72lbvgdFtrnDzwJgg3AQrmB0C',
      },
    ],
    'condition': 'checkout_android and non_git_source',
    'dep_type': 'cipd',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '07bc85570d318f17de81d29672e670e5fa926811',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '14065c577b236eea1431d076f24538e2d990a5c3',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@f8cce96c9b12c4b86d63d2361fa92fe1fd1b04e3',
  'src/third_party/glslang/src': '{chromium_git}/external/github.com/KhronosGroup/glslang@7e896697dc04d2be09ddfe920b7b7cf5bab7cf01',
  ...
  'src/third_party/webgpu-cts/src':
    Var('chromium_git') + '/external/github.com/gpuweb/cts.git' + '@' + 'a70b240cee25ed4baab5a914b1eefa5832fd4c1b',
