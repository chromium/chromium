...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '1274241ea3ccc14f8592f42d356e36dffba2ff20',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@c27a175a3ee3450fc7a07ef2af91e9fae4ad0fa2',
    'condition': 'checkout_src_internal',
  },
