...
vars = {
  ...
  # and whatever else without interference from each other.
  'swiftshader_revision': 'a421556a7cb5554b6f60eb9a18345bb1b7a23ad2',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@84ec37c4dd4d3b3ed666260f7592a55a79daad67',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@6f1d09f7fe38e86f4c69f0bb13dd7aabfdf64ac4',
