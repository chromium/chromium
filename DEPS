...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '1512060121e60243615778438c4df08ec102edde',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '5e2719866ba410feb87a293acb05ce2b7b78ccf3',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@ede31f9d4e49c428f08ec18181bf4ce519856976',
    'condition': 'checkout_src_internal',
  },
