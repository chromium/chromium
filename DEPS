...
vars = {
  ...
  # and whatever else without interference from each other.
  'crossbench_revision': '7202f29ded7235a6f0ec9c5fcbf5316bfd361d2d',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling CrossBench
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '2f6504485cb3cd60417ac089130ea89cf7cb9739',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'c0d8_Q511BJWJQElxS5EojpI5DGTVEOYbYiBxiCby74C',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'eaddb18033d2c40c29a4ff1f28afd54a75c9b901',
