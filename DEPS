...
vars = {
  ...
  'src_internal_revision': '421564eb20fd1c261510969a64cbea88c2bbb8ec',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '61cb47a73c921c2be190843e75960861c11c1bac',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/chrome/release_scripts': {
      'url': Var('chrome_git') + '/chrome/tools/release/scripts' + '@' + 'a2a27b733c31f492c5e58c19df1bce6f2ba71693',
