...
vars = {
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '1c65b983f91ec0716df4a749155b397bce783b0d',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/clank': {
    ...
    '74864ed27332a5c284c66fea0aac7fb8e01228a5',
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '7db417c0cd8ffbc5a8c4692a92ee096e73cc43a0',
  ...
  'src/components/optimization_guide/internal': {
      'url': Var('chrome_git') + '/chrome/components/optimization_guide.git' + '@' +
        '689eee004bb27c775daaa152c0cb1e827248b593',
      'condition': 'checkout_src_internal',
  },
