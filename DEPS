...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '90905f8986f3d62277f4b8a499840fa47b545a30',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '9be22239780fe6e89ff89b27fddd5ba31097a860',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '58891802b12ae51ddcecde3f7fc7711f91e18f3e',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'cfa46732f740c146bdb0e43ef1ed7a51cbe0237d',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '67e098b7e22eab83548a5be0024e7f2d1c167e48',
