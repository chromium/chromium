...
vars = {
  ...
  # and whatever else without interference from each other.
  'crossbench_revision': '30a477df59a630add6a48393557e4bb5b2891ad4',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '597b77080fcd01e292cb8f1cad78f5785811e7f2',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'f89d633101e35f8ccfc1a5014830c575426417e8',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '7892413450564bd2213cba9458481643eea456b6',
