...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': 'c7eef449aee8ac370df7bbf458556d8f9d0c38df',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '5fd7506a2e0b731317ebb85ba062c14bb0620e59',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/libaom/source/libaom':
    Var('aomedia_git') + '/aom.git' + '@' +  '5a1b33b710050b69557d26cf53d4943325481beb',
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '1cbd384f38146c9d557ab57ae6020f21c5542808',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@3c601c2ae89a2b2c6894ab63fd7edf6f04dab89e',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@230cff6e660bcd4fe986cc3cc0a1ecc8cd6dfc19',
