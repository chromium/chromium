...
vars = {
  ...
  'skia_revision': '802eb7f66fc55cbe949db5f6e231006494014306',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'd440babf3a36f3848bb2f7f745f0b7660186a0fc',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'catapult_revision': '2005a89c451ab9c3d6f3d0ea5d0d9614cdaaa822',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '290184775afc4e394fd380303b707897ae98576d',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '1692ea303991994828975856a3bb3a8d6eb3493f',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '3bd134289941203c157f8202f021ea844993230a',
