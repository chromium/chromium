...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'baeea13f9394f953e3bc55f4c9f32b1c9a3b1eac',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'crossbench_revision': 'bbf18e77d55e73abafa2349e5ab023b63aa68eaf',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling CrossBench
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'ff656fbfbf7b9eaf9826c6a4f745beed96a9f2af',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '2270ae001f52dc1ea47271c7a5b5832b411bbf11',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + '881aff6bc7fa816e270ebb799bcb6ffa1918fa17',
