...
vars = {
  ...
  'src_internal_revision': '9a036775a0a0e6c747a625934217c4e959cc8456',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling Skia
  # and whatever else without interference from each other.
  'skia_revision': 'd0f2c99ed6fc12cf72c455cc92093f3c6e18d26d',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'a83579c38aea705a983d5a6eef1dc6b2302f7729',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '2f869bf997507bca6cda4e883fc06f5e121556a8',
