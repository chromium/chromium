...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '499c348996b637c8d8e9a66bcbab8f17399ca1fd',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'ea86e9e1b101a5c2d212883108cfae2878642482',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + 'c4a2b1fa2b9681032b0336cacd1903368061e4a3',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@093dc4735ab866d01273fb466785f7df3a92e572',
    'condition': 'checkout_src_internal',
  },
