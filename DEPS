...
vars = {
  ...
  'skia_revision': '18ac33a9014d980374cc118203af106a9c303a57',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'nacl_revision': '74383b4e8193fa8c4a28f5fd24a30ac03731eaf9',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '0a5be0fd9ac9d98b3a09c527ff71066657c95e70',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '4fb8a56cb7394935421f40eb9c50b4edc6d479e5',
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + 'c2a4f5db62b8664119eec191d8ba1a388e62feaf',

  'src/third_party/devtools-frontend/src':
    Var('chromium_git') + '/devtools/devtools-frontend' + '@' + Var('devtools_frontend_revision'),

  'src/third_party/devtools-frontend-internal': {
      'url': 'https://chrome-internal.googlesource.com/devtools/devtools-internal.git' + '@' + '8b23afacd99ba0b28f06ad1c6fd5dae5ce8fc141',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '4bccc087b33388c7f729358b66e9d1108cf0f96f',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '222c052864e8b26e95554705f7b11689a6a24ba0',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@b2b19911de8231fcdf3c9014d8b07f7a925252c8',
    'condition': 'checkout_src_internal',
  },
