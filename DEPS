...
vars = {
  ...
  'skia_revision': '983ae8625b05737e7528fac074030d11e225961d',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '6b05f045a67a21fc4fc27335084193de5e60459d',
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '6e725a0d833a5d0121a46626fbec865285d13bf1',
