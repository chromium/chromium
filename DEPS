...
vars = {
  ...
  'src_internal_revision': '6d2330ba6a8965196a72258a478a3bcecb5f810c',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'b787b83ae8115d826b0e0d6373175f622ed5e792',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '70bb5071fd336d075196c871746fd11ba243623d',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '1e30ce21aa036f52ac27452b7a15a95184a63e0c',
