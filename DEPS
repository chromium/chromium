...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': 'e7737a203fcc63a976e19a3fc14974409f38640c',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'c509cfbcd0e30d0dc90fb416e7c97029dfdaf166',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@fe10648a49131b463e1fb23969304624b6135cd7',
