...
vars = {
  ...
  'src_internal_revision': 'c7df84c01c2886668e25550b2e1ac336c8f07606',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'a007bfcea3e4254ed3d61d670d4b1367d9b42e47',
    'condition': 'checkout_src_internal',
  },
