...
vars = {
  ...
  # and whatever else without interference from each other.
  'chromium_variations_revision': '93883a4eec58b7cfc854780ffdf41fdca1ddf655',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '1d203d2ca022a0a5acfa9f65ef7e9ea51b09e78b',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/clank': {
    ...
    'acb87d8985de5ad167703777c4822172bcae2419',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '6d5a9f47a98e41a57847e809ccc182a9ec023a0e',
    'condition': 'checkout_src_internal',
  },
