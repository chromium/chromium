...
vars = {
  ...
  'src_internal_revision': 'd5d8e400ebc1763498f5c74acab03b56d1e3e831',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'ba0824c4388e2560f02adf24416baead96e4eff1',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'b89e8e7003692fb54894c0b42b4a4b89f2edb2e4',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': '5GflSmKjWL317yoDOEtvOqX35YAFEiUVk-60OGIqjx8C',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'dToG2zWFpHgDEfurY3Ly-xHqcVVaokTYSJrslqxbDFQC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': '5E8decR_bIt6QlNmQL1hOi70ZD8EGpIJjexBntKrY8wC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/clank': {
    ...
    'cb815871af5805e02325f7cd9eb7e8d7a232f13d',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '707580fa62c2c2ba461e619620b1718e5cc7f4d9',
