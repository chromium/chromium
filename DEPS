...
vars = {
  ...
  'src_internal_revision': '517f5b6a9d922a90fa22cf13993be0e28dbba559',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling Skia
  # and whatever else without interference from each other.
  'skia_revision': 'd09786dfb85445bfca55df40ab3b9c1af9c25161',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'crossbench_revision': '4641bc65921b365a444755b2bb1f20d5ff51df46',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling CrossBench
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '3fe42b1e5bea22aa658e44d3bbdfdc9f5236cac2',
  # Three lines of non-changing comments so that
      ...
      'packages': [
          {
              ...
              'version': 'waI55wUC9bJyeKwtOG9duV8fiqWzy7VV1Bk-yLOCgaYC',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'FMccPeuv4R_VqZxTk660YFmUQyNLzUACgYHmG-bSD2EC',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
