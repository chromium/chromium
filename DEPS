...
vars = {
  ...
  'src_internal_revision': 'd771a7ca4b384fa3149581a1b2403e33575624b9',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '2d02f82723833fca8828283d3df46cbf736779a6',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'lPpwfz5jJjj6U96Un0wyCJOPt6um5HKmMGfxZkrT1Q4C',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'g1oUF3RN6m94WpPlb3nzj28RbGnGt0A5ZtmbEiGIrF0C',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'bYVp9E5LyD1wjxiBAH5AR380MBIWeXjWlWvoBxgS-_YC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'bb3693c382cfc7d51b18230fc67057055d2a57ee',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'cd1ff5e8be3ae3464ffb1d14b909613039015848',
