...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': 'a950e323ee97a778d5862b6295629a6eff50bae3',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '8bbb235cb96cd01a098719aa61e9039d6bb83f24',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '47766edf410bfd9fa6094935cb7cc862d91b40aa',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': '3ZFrrXMMi73hVBxJu5XCQAqcLwQBAwn24lWeKg7_bZ8C',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'wHnXmRnnfTX6a7E8Yx3fQ3JN_zEUd5RmBjJXBm2LcIEC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/chrome/test/data/autofill/captured_sites/artifacts': {
    'url': Var('chrome_git') + '/chrome/test/captured_sites/autofill.git' + '@' + '616af7d2dce9817307b6edf7feb965eb07494d4c',
  ...
  'src/clank': {
    ...
    '83fd690ace42a3011d64cfdd0425494e0aef18d5',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@86719d10b1124a32d5fc1f6c2a3ee46cb0bf3514',
  ...
  'src/third_party/spirv-tools/src': '{chromium_git}/external/github.com/KhronosGroup/SPIRV-Tools@5f4b62de998d161ee01e6f7706da2d855f8fcdc8',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '10eeb88e5c8b6df1e0bcc2e642f1fef43d22d96f',
