...
vars = {
  ...
  'skia_revision': '44a92728d97f9161516838a58ce7dc744e1d4c5f',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': 'a541560c4ce0a91dd8b7d70b3678775b89791ecb',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/clank': {
    ...
    '2c5734be5fa0975fcad36cb40848a80d68bfead9',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@f1b9dcac41d9294df3257abbc9a49f2b8f587ab6',
    'condition': 'checkout_src_internal',
  },
