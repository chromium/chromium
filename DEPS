...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '3c3b82f208b11195f0bf097514cc7031375490d5',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': 'e208994a093cfcac9f4bcc8134f9c2a13a262d63',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'crossbench_revision': 'a1fb1a948569f947bfca211c199bbe10ba855f2d',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '85884841294957293a3785af2570b90dd2cc4436',
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '917165dd9698ae3a2ee3d5a3bcdcb827243c857f',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'd7819cd5b1814c9fe8b82f636036e2416294ac44',
