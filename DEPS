...
vars = {
  ...
  'skia_revision': '2fad2703fbc62db50f5d0a9ef0d31851a5643f65',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'angle_revision': '459bdc2f2c3061401e428955ff696c679d272568',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@41429780492da9b853c63e7b56e1ab7421f1b8f0',
    'condition': 'checkout_src_internal',
  },
