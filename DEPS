...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': '6c160cad375b467e12b68c3388c810d6a9b9077c',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '94def377bf7a7fc305231b5b94d86b4fb593e686',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'BDqbJxh4PYbKoHbReWowxeV9WxVZeGAVi_-hbTr93p8C',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
  ...
  'src/clank': {
    ...
    '9df82a550494459ed9aadb12e39ea687f8c12459',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@f2d10b3451c4bc04be63c5b0c25a2187670939e9',
  'src/third_party/glslang/src': '{chromium_git}/external/github.com/KhronosGroup/glslang@f3a7f2c2bc48b20510cc76ac8479ce882bbe2032',
