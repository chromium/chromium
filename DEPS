...
vars = {
  ...
  'src_internal_revision': '8be82ea77c2f5518188b3f9513f6f7d97d35e9ea',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '57d93ffc4c99cae113ebd9d813879ca6e9c3491e',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'fc18d2bccd9cb1ea9f8b3c32c0ca4f93fd17fd9d',
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + 'cb8b22fa77ca4e6451e697c079b09390580061a9',
  ...
  'src/third_party/webgpu-cts/src':
    Var('chromium_git') + '/external/github.com/gpuweb/cts.git' + '@' + 'f136a759a4d7e05a71473bb37cdea99f627e4814',
  ...
  'src/components/optimization_guide/internal': {
      'url': Var('chrome_git') + '/chrome/components/optimization_guide.git' + '@' +
        '2403c41f70055b2c0afa1d98a2cfa7a5afb12070',
      'condition': 'checkout_src_internal',
  },
