...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '63c653adedf9fbb17c851d99c2e562d69ec9a916',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'HgHIS0A0zgDnSyI99XyRXjSNHAAHAYHfRhRdD7aXGssC'
          },
      ],
      'condition': 'host_os == "linux" and checkout_fuchsia',
      'dep_type': 'cipd',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@cef5cc09a38496ddd26273f8ba2899e80c0b0600',
    'condition': 'checkout_src_internal',
  },
