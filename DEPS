...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': '6bca07bd6f97cd06ae8366d413d8af5f195ac77d',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '0a2a85a9bb1f64d84d6aad7bc7bf2aacb85d2f4f',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'f06c12f831af0d76cd8b17e64512959185ce67ad',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '291058fe016675bcba54ecb581e1cf9d6e1c8471',
