...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '637a9dcc149eb48bc7502d5e819faa4019fe76ce',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/clank': {
    ...
    '6747075bb7e007a60373cdb9cd7fd796c6c9eb89',
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + 'a3faab0214d8a11a3d73ad6501f4be12cdd99681',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '8c0e6286c899c0ea0ee38e464ee8fb04de2ae20c',
