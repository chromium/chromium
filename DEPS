...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '29833603fd76598eeb5f79d217154ab338af2e3d',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'qLfRckDPNq1gqURzw6ju1uwWpuayq0cNJtAN1LTFcDwC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': '2uF_NXt4M3_t-jnHBUt6zhgsY2T0RsJakbhlCqlrknQC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + 'c84bcfbd35a8f09166df4b7d847e69aaeb2f6dcc',
