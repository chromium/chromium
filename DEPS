...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': 'eee0a5b472c1e62bcdf0ac7e6575248382e256c2',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '901df53d3cd5cfcc28ce78dd1ccd053116fbf453',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/libpfm4/src':
    Var('chromium_git') + '/external/git.code.sf.net/p/perfmon2/libpfm4.git' + '@' + 'a927efb0309db45c072a875e56f750b1be65ec44',
