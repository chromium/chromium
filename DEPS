...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': 'e288e552e6e91d79a06d73a1839713222e690efb',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'XmYOeywuttkcA95CLRh4J9-rQeZDtj2i5kA6jGZN10YC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'N09snycYLuZZ3qA5WURNDqGnRLj6dhgyB59UR-HEg2wC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@36700ce29255077776d9e58bc80257c8c4cc41e5',
