...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '363a1744f166e9763ef5e1a7672151f1d3c8b5a9',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '019b32b9370b7e2a96f23f7d34cf3770c1bf1736',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'ae33e46597ae71f92f466e05c4e7bf09419c79b1',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'ff2462e54a98467069b08264b50102207814ddad',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'bcda594eac00f5f7117162bbd16a6579201b8d76',
