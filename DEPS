...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '1c4a0643e77dc2d0625ed9fa8bd1a4250f66c28e',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'angle_revision': '346ba328eaccd16701a609cacaee4d6e771b2a93',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'f898ec8612ff5905c208b43f1b30c55225c30a72',
  ...
  'src/third_party/webgpu-cts/src':
    Var('chromium_git') + '/external/github.com/gpuweb/cts.git' + '@' + '1654b1d4bd7abd8951971012061a3e57d691c7af',
