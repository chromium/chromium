...
vars = {
  ...
  # and whatever else without interference from each other.
  'boringssl_revision': '7d63bd0e024e928e2e61aa88977e9d8064a7ea7c',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '43fda93af32f0a073e325235fdf9538b0a10daaa',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'mAsQpmMKdmVB_-FsG7JmMUzWPMg-obbWY0y4naG4FJkC',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
  ...
  'src/clank': {
    ...
    'b9b9680c872141027db450635bc74637d4f7ff92',
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + 'e5797fdfad58cea9abb465291a06db8156b55177',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'f7ecdbe669311fdf2211ef440ecb33943e7ed4c8',
