...
deps = {
    ...
    'packages': [
      {
          ...
          'version': 'iJXVy5WJPyuzmUtlJyCISCKEn_wdTPJ2xZdT5VNk-B0C',
      },
    ],
    'condition': 'checkout_android',
    'dep_type': 'cipd',
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '7b8e4f1537b214151be0ffeae815bf64ec510a17',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '6dfb8c131afbd1536102212718ae0365cd144fdc',
