...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'e897c387dddf1dc660e71762bf7863416b3ad2ce',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'dj_l2R63hlJnvogFh7zjcOolCXd2XZKVLFl13aXDU20C',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + '96a4d3da1cb11ceab0e305efee6ee766a4c15a8c',
