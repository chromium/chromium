...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '672f74162cbd5d232144c47763174d9b977aa32d',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@4adb125ca75f902b5777f21c10cd0568c9a284d0',
    'condition': 'checkout_src_internal',
  },
