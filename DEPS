...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + 'cf78152e523d9e19614030351d0adc0d5c52ba11',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '7c8c4db8ea600e87fae0867b031552a5a8967876',
