...
vars = {
  ...
  'luci_go': 'git_revision:e70737ea7fea6ecd9140de2334a3551cd7fa44cc',
...
deps = {
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '6a3e09171cddd58fb807d6981320eb33175684ff',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@989a787991a1e4684c1bd0769b42d56beb2eda9a',
    'condition': 'checkout_src_internal',
  },
