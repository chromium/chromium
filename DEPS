...
vars = {
  ...
  # and whatever else without interference from each other.
  'boringssl_revision': '4972fd602f89abdf9e7633a52a088bed40b39375',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'fuzztest_revision': '174c1ff2dd94e4a0ec1c828fa946f978a1e55c99',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + 'ea9c9d3526a28556e93d191651b85741b722e989',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'b9fb3636ec1203a3dbce63048daa2a77b8553ab9',
