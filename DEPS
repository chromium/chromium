...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'ir0BWyGheEQmrUsveiDPFl6DsbFVyFGIU2v6GV-Ed0EC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'JeaWhlFGVVCwnldOBpYXJmIxb-zZXiVzEuroLY7ac98C',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'dca9aab12dacc36db2549b79ae3b4fe5def618cc',
