...
vars = {
  ...
  'skia_revision': 'a0ca6ed48fc1f0381548be1b16f33894fca81686',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'ede53872f423f99ca1b737922cbb3dfbbe7845e2',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '010e6c1867a689266316ad607725cfd8ed11d3f9',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@845d58ce11f1a4567074b0584961beae5e3c21c7',
    'condition': 'checkout_src_internal',
  },
