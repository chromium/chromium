...
vars = {
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '7a2797425b2f16500bc4f1a4694696017494523a',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': 'https://chrome-internal.googlesource.com/devtools/devtools-internal.git' + '@' + '5b4ceb063c0687072e1e8f2aa8ff23cb402596ad',
    'condition': 'checkout_src_internal',
  },
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@4b8e574f111f237cbaa0db88e93a231b17d6217b',
    'condition': 'checkout_src_internal',
  },
