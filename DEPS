...
vars = {
  ...
  'src_internal_revision': 'f44dc18dcda1a3dd0fc6562602741eddef60634b',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'fd282ef829f30c625e27f8a2bcceb0ee2cb6aceb',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'csAm186g4u8HKOuEmOZdGwlSNFa0KRQLLOLrxXla7IkC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + 'bbcf561adc5b4c499d1b5af076f3eb4748f7fde3',
