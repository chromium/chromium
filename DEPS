...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': 'dc90545125dc0aa7c208dea6dcf5f9faf70e4cad',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '87b25a89a4da3014c26ab02f3a1384e8f1495c62',
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + 'b8f80aa6f67d583f59e17f0568279de807cbef77',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '78e1388ea70b73aab4a8ac8beeb5df93b706ac02',
