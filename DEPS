...
vars = {
  ...
  'src_internal_revision': '41705d6ff5fd61ce3a4c14b23983bb4a978bf4ba',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling Skia
  # and whatever else without interference from each other.
  'skia_revision': '0f81dc8b2e43c060972a8d8d229b346694a674f8',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '0eacd1c50757030108739bb3aeda1de320bd83b1',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'fa1fe59e1c8171469ab827dee7b7da5518eb14e3',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': 'ce8647829dd84e36a239d20cdab929dec016c04a',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/clank': {
    ...
    'd25fb109178a7ef1a82207b8bebce1b7e14f5072',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'e6ad499c1788e4d344e3d4d7c47e5cb691f99290',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '31350c7119fb0e100336e3f22d869e7bd9a0126f',
  ...
  'src/components/optimization_guide/internal': {
      'url': Var('chrome_git') + '/chrome/components/optimization_guide.git' + '@' +
        '3f3201907b6c373ac7b4e8bc4a58e6141366bacf',
      'condition': 'checkout_src_internal',
  },
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '59d2d79be259cc21171f793587ea2c504b512623',
