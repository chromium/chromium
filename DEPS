...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': 'e60181fbd809fa35825089eb4ad544a2d69640d2',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'dc330cd048477f84d2c12cd97a00deb71b3615c2',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '20f6d310843ccea1f413fb8648d544ebba302fd0',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '317bd01a671a7b16e5da10d21afdf15333c8d65a',
