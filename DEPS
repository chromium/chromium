...
vars = {
  ...
  # and whatever else without interference from each other.
  'nacl_revision': '5a1947f6290f506325ce8940700f32ee4557971d',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'cbaeafc3461b88b716d6f596fe556639514c2de5',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@ee4a2ba56e8a887798dc96bb388465085d9b246b',
    'condition': 'checkout_src_internal',
  },
