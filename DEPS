...
vars = {
  ...
  'src_internal_revision': 'f9f0fc7bccf3d21ee1d26abf8cda2746d55fba1d',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'boringssl_revision': 'd1422334aea39e33df0f17c85d1217403b260b40',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '77fb77dc86182efceb9d64350a8b6480925467d7',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '35dc9d3ef3033f81fcf7666a91b33ee48daa162d',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@9b55d8906d6fa6d971926c8396eac508a50ab606',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '94ae73313e30c437b2f56f45cb68ab8a30489090',
