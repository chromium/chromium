...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '2a0cd138d2184c06b0d8138131ba884062ccfa92',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@c2af58aecb69bdaaf7169db537a90a42c01be8b7',
    'condition': 'checkout_src_internal',
  },
