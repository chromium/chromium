...
vars = {
  ...
  'src_internal_revision': '17ca95596f719575c0e03ff5bcb1fb549a55beee',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'e6cc87a5f83b0779c4d5834d6b9a527632fedb13',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': 'dfa3a3070f78ad59955768ab666de19b1d8c413c',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'b2c7d7d7bc1638702179d31dd58a38ba47090da0',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '4256a4e16ff2d22751a1e3df98204b97e93d9b37',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '8fbabf340da0bd6c9f1450a8c4522c54390598a1',
  ...
  'src/ios_internal':  {
      'url': '{chrome_git}/chrome/ios_internal.git' + '@' +
        '3ade58aa3b2eaf4c55ea661eb769a2f541b16f88',
