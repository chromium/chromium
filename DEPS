...
vars = {
  ...
  'skia_revision': 'b42686ad015b6a68065ba38afbbc8dc49494bc63',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '91cf42a0759a4bb733f534178d303e9521a49f0d',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@238470adc0e5da3fdc30e147adeac932c7219113',
