...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'b354aa4d2540f79a0b1e276f3aeb2c8b9d846036',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'be45b3f944601508509e6a84694683ad5f967e28',
  # Three lines of non-changing comments so that
...
deps = {
    ...
    'packages': [
      {
          ...
          'version': 'iMCJS_4q6z9bSKJVJVw5ZR9qdI_5iZilsQytJhVNWz8C',
      },
    ],
    'condition': 'checkout_android',
    'dep_type': 'cipd',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': 'https://chrome-internal.googlesource.com/devtools/devtools-internal.git' + '@' + 'c8958f5c3c03e45c23116074159399e6e1a722a2',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '96db79eeca95ba3068331ab1642e757b5879828e',
  ...
  'src/third_party/webgpu-cts/src':
    Var('chromium_git') + '/external/github.com/gpuweb/cts.git' + '@' + 'afb5c81b795ba43b16fbaf5f0cb2c480eb21dfb3',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@cef2c780f340e9643eb25486f222c229521beacb',
    'condition': 'checkout_src_internal',
  },
