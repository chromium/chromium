...
deps = {
  ...
  'src/clank': {
    ...
    '743d35496e18d6110680bcef7f9dcbe983f44637',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
    ...
    'packages': [
      {
        ...
        'version': 'xJSAIlikQsyTtCs9NE5WlxABcLWyBOObs8J2r-aDlNMC',
      },
    ],
    'condition': 'checkout_chromeos and checkout_src_internal',
    'dep_type': 'cipd',
    ...
    'packages': [
      {
        ...
        'version': 'mJoqU0YTxlo4FRqmsniC14X5DanWGhhbkiERVBTC08oC',
      },
    ],
    'condition': 'checkout_chromeos and checkout_src_internal',
    'dep_type': 'cipd',
    ...
    'packages': [
      {
        ...
        'version': 'gMfA5nwhbGICmM4io4k4JOERWuq3-zBVSbxfDj0Vwq8C',
      },
    ],
    'condition': 'checkout_chromeos and checkout_src_internal',
    'dep_type': 'cipd',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '2e76b213e2507e274aa1f635631339e9d7368e9e',
