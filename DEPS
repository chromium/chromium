...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': '555b23280b58dc49b9fce8bbb5e78bee63930aec',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'fuzztest_revision': 'fb61507617bdb5106df7db5d74cb1b70536fe8d7',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'KIs_zoAmsvMmjZ9NtrkOvrzfQFBwaAaW7NcpnLGj4aIC',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
  ...
  'src/clank': {
    ...
    'de63e2e3e4408ab753696828a9cded348f4c1ea9',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + '551b305f4c2a79b188b25b6c4b3522c717905b16',
