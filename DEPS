...
vars = {
  ...
  'src_internal_revision': '402d7aad1993b901da9bc1436b820588cc56bae7',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'e35b9c1f0e3a88c432b11af6649a2cbbb72d2823',
    'condition': 'checkout_src_internal',
  },
