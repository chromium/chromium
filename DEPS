...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '36248d9b87040ba1f95249ba7258648692666960',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '372ee0fa20a57a916ddbc765e77d9c3b267fced5',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'c24a2189d72b2bf37e91ffe99605912de4d633a7',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@8992910361ebabf90ea59ce1cc79c0f6a0c26181',
    'condition': 'checkout_src_internal',
  },
