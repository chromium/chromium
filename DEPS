...
vars = {
  ...
  'src_internal_revision': 'a2fd7f82661eeabd05536ddef5b6e528a90e149b',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling Skia
  # and whatever else without interference from each other.
  'skia_revision': '37477d8a57ab6ec562b91cf7880d62ee7bc09d46',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '017070b0de448e07d31688336f64d216b2c1e94b',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '7b8d04f97e159bcdb307200083744399c60d33d7',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'db8ea2401c73a737e98924b86ac5c07132675da3',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '112935dd6e40653163f1f60af7080cbe9522c802',
    'condition': 'checkout_src_internal',
  },
