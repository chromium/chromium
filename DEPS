...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'aaa5b0cb2bf4c5c77cc0b3b8a7d4821130fefcdc',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + 'd18b5e4e8ab932c663c3c6b6410d712ba09eb948',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '814e92fecd2858eece25c4ca7f640934d1c9711a',
