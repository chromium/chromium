...
vars = {
  ...
  'src_internal_revision': '647eec609cd27dcf10efa0ed4277ecac1fc3a9e2',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling Skia
  # and whatever else without interference from each other.
  'skia_revision': 'a454242c39341d8866fb76dad426318b1b01296e',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'angle_revision': '28a78b94a9c4b24b927f4d860ce121d20dddbae9',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '7374af926d3b94c75fc66106043fd94055aee21e',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'LXwpW6r9qe_IJsm1R2xCaoMjaGZUnrlNyPG2WKCiBCwC',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'HxJdIJ8agnv4G79UyoT0G-4y8lLVgWGA0Sc5rteh5NgC',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
  ...
  'src/clank': {
    ...
    '35bf2e8d684d9b3641a8ebb9c9a4b0dfc65313b6',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@e15b37282401f73f0dc84aee37dcfa1e05f28173',
  ...
  'src/third_party/vulkan-validation-layers/src': '{chromium_git}/external/github.com/KhronosGroup/Vulkan-ValidationLayers@c7f0a7be235ab72e0fed531dcab8b88315d50fb3',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'a189930d4a9d237259c0b344f2bda667d4632fcc',
