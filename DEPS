...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': 'aec20536e1ab80e41479395951b3e55e1efeaa4c',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@7918772b6c12205236f578810847b503202458d2',
    'condition': 'checkout_src_internal',
  },
