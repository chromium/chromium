...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': '0e3d6d30aa879156cecf16f7b52f1f421e8a2ad4',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '1ddc2087027fb447b742de2d61c7773612d473b7',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'ce196da5ca5499a5a0fa7d0fe083a25498f1c1c8',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '39dbbc4d0d05eacd6de237f55710df4f63e85c89',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'd0fd8d2a2622b2da6f16d8684e9204e44882cf20',
