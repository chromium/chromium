...
vars = {
  ...
  'skia_revision': 'd95a5d65bf67995a01ff714601e286252a53a0b1',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'b8636b57b8f231994ecb3fb14f181c593c83a3fb',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@fef22530a08959ea1f93f45a90f5d785d879495e',
    'condition': 'checkout_src_internal',
  },
