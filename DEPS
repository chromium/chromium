...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': 'f007f2b49f6669ac2e42558b1f14ed474ad87a5c',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'HrYfJz1BQ74UUtRr8h3clrw2aFivrIiCpFkF-8w4dJQC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'X8RuWEQV3Co-uNmKBdm6MagRaPJvVGPMmEPENApCydsC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '6f83fce8652bbde3873c6f486179a93c9b6f9421',
