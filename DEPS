...
vars = {
  ...
  'src_internal_revision': '8f52c96adcf687ccb5169f63273f27a66139b5e6',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '748d3360122aeb3bcb450fb4b7c1b18049cab004',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '0060a26b92e0e115c4126263ba5e7ac037e15349',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '597e7ba370a973f64f822aa247cb2355de7c5f47',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '5c2e60edc5b7d0a626a4224f5edce181dca7f11a',
