...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '88bf3883dee5da4e245cfafd920da11050d0a87c',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@72e8ca5b4e92a9c4e172ddc9f41bec03c1e9c7be',
    'condition': 'checkout_src_internal',
  },
