...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'e39bcdc3107b59dbce9d81fee594012b38b83902',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/chrome/release_scripts': {
      'url': Var('chrome_git') + '/chrome/tools/release/scripts' + '@' + '6efec25c722df305be1cf82c0475cb0f25ea351b',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + 'f6c54cbd51670b3ff1f223977933f4d8587987fb',
