...
vars = {
  ...
  'src_internal_revision': '01644a69be04debb52418be7a40e0524cd0845f6',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '9f53629c92fbb1f7e42d3ac28c2b6c710fb4458f',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'b5bd0311152e53b97304d900084c46654053b5b3',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'dc81da707d6d61c930136dc7a6fc2981743ff59b',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '970f9f73b338c3462d63a6b31e58f3c915752873',
