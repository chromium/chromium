...
vars = {
  ...
  'src_internal_revision': '1d38626ab229afe72acc41255053d116677e5244',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'jetstream_main_revision': '6561562fa6e9947259e3c3c3683ff9fa5c1aad47',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'vOOLlrHigsbt3D0q-L7ZaxRSPGMCVoiwz_2XKKuvJc8C',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '1f33a15831b8d56edccc80ac66f80e2943c598f1',
