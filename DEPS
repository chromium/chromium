...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'eab2d546ef0741607d5e1f6b95ba99af0bcc7c76',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': 'b7cf9dd263052710dc2714674dbb4da401874e14',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@d8f16142832c5ad1905238736dd47840949d48f4',
    'condition': 'checkout_src_internal',
  },
