...
vars = {
  ...
  'src_internal_revision': 'f1181a354a624a4f93bcce9ca8bb66f3d71884f7',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'ce152febba7a0b5ed83ff1b446f38ed6a3dc62d2',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': 'ad1f58aa9a2a1fa4ff60d3809a592a351547caaf',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '7a7bb0e7be36ed5c232c2a0328c82a8b9fe12f01',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/clank': {
    ...
    '8ca2a9cce1ff7c1368d7772fd93e4b9430a63c76',
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '2840874a2d817e63a8a08ee5745c55c0fc045bf9',
