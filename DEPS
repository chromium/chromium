...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '25c246d19e9d24a874f49de3b02198d5ee3bece2',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'd9d5fdbea9e2d62640f15e14e04da68ed7c9b22d',
    ...
    'packages': [
      {
          ...
          'version': 'QTqVVyp1CETHtZaVAXbXUhet9dCZT5_1j3T8_08NkNYC',
      },
    ],
    'condition': 'checkout_android and non_git_source',
    'dep_type': 'cipd',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@d284305388b07d4aded38f3381110534a03d7d68',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '8ccd3d5ded3f28be1a83e7bc3a3c3ba0b3dbbbd3',
