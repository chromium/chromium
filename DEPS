...
vars = {
  ...
  'src_internal_revision': 'c902db3c026852789b398bb0ad3c659585af5784',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '4dfe44264389130c653c02ffdd36c934a767ace4',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'n-NCGUF4HO4HBYbop8ZTqElhn2emQTe1SZVascX0mG0C',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'LbQDUT_yZiImF9bnBCuUOe_111EzHq5Rxu8Jo7c_pZAC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/clank': {
    ...
    '88edb2755840c854063b170b6f4ca37cbf0af004',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'f083c099b3b6409315e94257e8b2032a0f678235',
