...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'a16158ac5469c96c4760c76c4fdfcbdedda19e37',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'aafa8d1a1f1933aca4eab9c4cb0ebd621e76ffa4',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '7b6c887ffd1741caaad33b02b96c909f6a58c493',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '1422e4cc3247463ca848ddc79616e42a5e93e929',
