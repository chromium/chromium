...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': '36cd4c1f076df866fdabf1796c81b6840f8c204f',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'nearby_revision': 'bc44fee3747ae7589fdc2f875d6d1f7e2934e17d',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'b436cd1e137d72354692cde3874ac80828bf330c',
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '2f5dd07a00c9722ee7298413d97fa521a7a2d417',
  ...
  'src/components/optimization_guide/internal': {
      'url': Var('chrome_git') + '/chrome/components/optimization_guide.git' + '@' +
        '1831a0e08342853e11368c6b936a9adbd1b61484',
      'condition': 'checkout_src_internal',
  },
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '2cf1a1b9f5651d6c4474b8b59d31843fd590ebcf',
