...
vars = {
  ...
  'src_internal_revision': '9d3b0415b7e95fc325fabb5213d1813ec3940ed8',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '079427027e5cb39c21c4e6f0aa2ad309b71afa6d',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '4fc65c141d6c45d6933bba2b27910bbeb39939e8',
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + 'a487155ccf87ddf37baa950d42544ece75f7b2be',

  'src/third_party/devtools-frontend/src':
    Var('chromium_git') + '/devtools/devtools-frontend' + '@' + Var('devtools_frontend_revision'),

  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '0a36c0f1a4dac20d9574170fa2174231e53ecb61',
    'condition': 'checkout_src_internal',
  },
