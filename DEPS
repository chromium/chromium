...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '72c5b04fe883ecc94c42cf7b21a92afad3ac5ea7',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '8a5112747ff064cde054f592bc255cc4371a28b5',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
  'dawn_revision': '307ece163070ea01ff641e84965a8b256279bf41',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/third_party/openscreen/src':
    Var('chromium_git') + '/openscreen' + '@' + '91beff4e632ae0348af1fd690710ea767c546805',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@2571c470a8a07b9eb7a9546cf0de91790f0e5ca4',
