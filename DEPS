...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'ec604a5f45e64f91d36c01652be5b2934edf8388',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'da8edc45b1477e5c5d0882f3547e7c02127b7c2d',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '3b87b43f06da7fc2fb27568b977c59beee0a4e17',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '60542f51d967d46561fd7f5c9dea76dddec79a1f',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '6a19186fe236ae1b1addfe6f7e7d9a5ce78ea834',
