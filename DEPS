...
vars = {
  ...
  'skia_revision': '8c7467c44066efcb094163b6b421f1e636614eea',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'd5e0769641a37313a495b84bf5612365f71cc9de',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '50b3a3e17494625cf5a574ccb3b09b1f20668fa9',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + 'fecd4f15a152352c52c00837b9f144579bec0aa2',
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + 'cfaa1f3f043c30a87957ab9bcf3c5d47329c462a',
