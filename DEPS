...
vars = {
  ...
  'skia_revision': '2bab9f91e8f507a93691906ef4a9540636d5b2f2',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + 'f1348d458c30238bf27f4fd38d5d08e1afdfcb3a',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@1626cb812a5ace4e6030dfae9eb2dbf24ba0e44c',
    'condition': 'checkout_src_internal',
  },
