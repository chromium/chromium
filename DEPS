...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'f842e63aaeb7de5411ec6a87f17ccf78909306f1',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
  'cros_components_revision': 'eadc6c610199d6a1431ce698e28a5d386750b8d1',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'be163ba399a0b4917c7f697c264c4a7f459e0a03',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '5d69a9365ef1755ec0cd393df2e41e8e5ff45385',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'c54b6378a253ed23a823a75dffd95fdf1de66262',
