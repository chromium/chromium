...
vars = {
  ...
  'skia_revision': '46e60f8404dc692ba1673f969087777e9c212d92',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '29245a4673ccb56b94fdaed474f907ed37c6c829',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'swiftshader_revision': '7f209ebb709ff99ab27d62ea3a72443e832ade66',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '26494688a40f2450c3769f72bef85749aeec81f4',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': 'https://chrome-internal.googlesource.com/devtools/devtools-internal.git' + '@' + '0cc27d7e74c5487c0a576c111413c98ccf5a77fd',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '6b750587746475b4bb8b8f95d63d47ec764efa63',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@c4051ff193a88119c2baa39355ba3094e3fb57f4',
    'condition': 'checkout_src_internal',
  },
