...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '634e970210b7f8233cec53510bf82a3c9c18a80d',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'f5037c4c44b93f9ab74ab05b2f2c7fcce621b43f',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': 'bb2c4be41a51f9e25443374b15609edb1405baab',
  # Three lines of non-changing comments so that
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'ad17066c5f9038707d0d3e45f366868f444ed211',
