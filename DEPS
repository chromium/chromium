...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '221ecf93d114faa445dcb699a61975f9fd3c7f47',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'catapult_revision': 'e2b1d1a886b6826a306509e0e6ca9bdee441d8eb',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'feb39d032fe9a860d68b2b69946f3498029679e2',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@f886d60e70464084459e4b1ac2755b1a6c82ad7f',
    'condition': 'checkout_src_internal',
  },
