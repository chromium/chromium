...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + 'dd01e0f620c1452649babcf3f358e5dd6bd518f5',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '6cbb468b6d53e373909ffe5ea69e65b2c6da0c79',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@56c13723ddc9c8a92d7c047bf617d338f5624f35',
    'condition': 'checkout_src_internal',
  },
