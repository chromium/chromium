...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': '7d61980e65c5d5a7f95f57f3f6c7efa3ca325807',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '258aef24bb293187718a3dfd3cfc67308a3cfaf3',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'a7bcd5ad6aba286deacadb9fd195160fef841471',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '9b54599f6695c222e6d9eab26d4669f1c0aa0108',
