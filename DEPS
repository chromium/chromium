...
vars = {
  ...
  # and whatever else without interference from each other.
  'swiftshader_revision': 'e1930f0fac2b0c590a292a4c42f76f4b24447f6f',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'catapult_revision': 'd454c2e6f1131b6d6479c3c731adc3af9598dee2',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '257f7df564b5ff82f41e4dbd7a1e12d90c338a6b',
      ...
      'packages': [
          {
              ...
              'version': 'wItYDUPLxNnMEaQQfFwFS4L6fYPK9YRTvwx-M29l7E8C'
          },
      ],
      'condition': 'host_os == "linux" and checkout_fuchsia',
      'dep_type': 'cipd',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@4a15bb24c79fa0c9fcaa5cb47db8ce731927d8ed',
    'condition': 'checkout_src_internal',
  },
