...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': 'e2062707b0c0a41129b07a5fe4360d14b1d55448',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'angle_revision': '2805c81195a3e979fa9a577b203cf1304eec299a',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': '2iTYTS8elnljFAP9Hdt5L3_20NtU1samUAthj6KAiNoC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': '6lSk7nbVRS27TszMHOZzYiTdtRVQQMCgOB_taUDCZMkC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/clank': {
    ...
    '2cffe37cd8d8a407f81f1333b59b8d69e1b143c1',
