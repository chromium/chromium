...
vars = {
  ...
  'skia_revision': '56808316819c20af7079f98afd81c0798d6dc7a2',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'ba3f29f1d41b0a30bded98f029afa7166fefae6e',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'angle_revision': '540debacd12c69ba77de12db679c69d8d0db7b3e',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'd7d5a2b400a7ff6bcab867cbafd457c22031c490',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '764821164662f1edfa42aa114c334a1e16dec935',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@6c83b81120d43905289d74800b10f6eeb3def0f6',
