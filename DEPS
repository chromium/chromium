...
vars = {
  ...
  'src_internal_revision': '8d708fa8bb7473b6b386ddd00722c0a6752b0113',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '4e031e4b6bfa4ba1d203e9bcfe3dc26d47a06b2c',
  # Three lines of non-changing comments so that
      ...
      'packages': [
          {
              ...
              'version': 'pHoD1Ay0niImunNGFIzGCBVzAO0FhQm55xZ3nm4XvgQC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'D65XjXoFFUVLcrhmgNO-aDf1gNVu8MhyG1OqT-qbAEEC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'q2nb90LMHPmzpvRl68VWQunLVO_h626NwCaCxZrWnjAC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
