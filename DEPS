...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '0155bf2665875ecfe4d451c853b677857ae4886c',
  # Three lines of non-changing comments so that
      ...
      'packages': [
          {
              ...
              'version': 'vbyt-3JINjDPfDRkfU39MFG3S_TI9CmtiAOlJuWkL-MC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'nDxgsHUJUaIovuxQ4cr-iu-ZZb0RJV97TlcuUDCKx10C',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'Hoymcz3Ma8_slVp20c1AlVjFWUHlLhaDOR2Z3psalD4C',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '0e3da6790bade222376a376e93db9928968a3b82',
