...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'b4eaa3a29d8f6c46da5238c6c034f203f88344e2',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '429bd42abd48a1b68179f8cfdb174038c30c43fb',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'df894ad299703bc7cdd43df28591b2fe1f6c92f1',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@68001623f2c4d8aeccc7c67b2b30b32e008a4efc',
    'condition': 'checkout_src_internal',
  },
