...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '95d8ea63123a015781ca507147dc684d90c6ec05',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'angle_revision': '0018b93b121b19a8e66bb70e57a23a10aab28ed9',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '380221dc052d258da0db8552b0794ed6043d0c56',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '502676c46508cefd85d421fa5cb042691a69c395',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'AjYIZ2AUXe0IstUgP4DEuuKTTT_MVew_XhL9XBnZskMC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/clank': {
    ...
    '816eb2c8130dc27d6b43117bd90af7129e0a9c9e',
