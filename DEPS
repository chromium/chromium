...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '36ad0ee78d60f6a21536b1f72cb878a666d35198',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '56048bb21c8170976fea4f9c52ea69fb6d1e0b1d',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': 'a55b29e0bd3e5d928efd03cc227c7fa13a2069c7',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@88dc7bf3020f24619fa0176305b1a3aa018e7059',
    'condition': 'checkout_src_internal',
  },
