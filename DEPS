...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': 'a2d8eca22ad478a95ca67bb2421a9a2535113925',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@e5508d9e07825e28d3d39d74c39ceb7951db78d2',
