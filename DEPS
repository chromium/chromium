...
vars = {
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '99ad82a8aaec458d21b6245b6a30215dc93655e3',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'nearby_revision': 'c7c698412cf741203bdccef2210172c7673b1d31',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@317bc9162828db68676e20dbdff69cb29be74198',
    'condition': 'checkout_src_internal',
  },
