...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': 'fb2e9d308c35b4964cf7a3dc545d6587de708e64',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/clank': {
    ...
    'a55a22327286fb3e37c7deee8b9b22ba880dc55f',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '0b8db14fea288edd82c1da00f68c3665bd703eff',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '818cfef6bf3c75a55f0f056924c1229b9c0d0254',
