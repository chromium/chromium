...
vars = {
  ...
  'skia_revision': '61e7b64962a5a4432c111909e0915cc15778088a',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'angle_revision': '5204587698099207ce8ae70779ef44ffae877996',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
  'dawn_revision': '25b3ed12e3056b5322b19c7323bf1a718fb05ff6',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '8b64ddec2a54503ca802a545cd19ca368ab27448',
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '548e77ec5f1796508f013df5e2a671d9423ca4a2',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '8e3441933f3cafb9993dfc9b863879a3c2d576ce',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@455168f6013dce3700e47761832cf7ab10f77911',
    'condition': 'checkout_src_internal',
  },
