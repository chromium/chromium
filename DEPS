...
vars = {
  ...
  'skia_revision': '4e0e8d4124f5c014cdcc85be718c5eb7f56e530f',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '61a71c992a5a976086c53fd0a71b046a35405281',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@4121a1f12b0efb0d35316028cf6df3f40add1796',
