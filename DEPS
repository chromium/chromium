...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '6a4b93ece2069276af3ed916e9538baa86d3baff',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'f3bcd11640f51c4de26c3dba36c4989afdcf64ae',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '527bbd70a6a56f44d842d85f77ac28effc3fa00b',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '46e4778f4095c994e3f125416602cf578637a388',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@baa9940928e0d13dca7e423c39c969751b6e0536',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'c18f083900394495b1adcba2e89d98d5de1b5d7b',
