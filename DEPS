...
vars = {
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '633f6bcce972ac503d2ade167b6a37e9de593bba',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'U1J0Mv5NejLOfTwTTuRpTEBVz41rOcpJ58g8l1_0nAEC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'Gy0HEYnVObj86fO8-waospoS9fLr4Pt602DJ9nQBidsC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': '0sBHhKb5zV3M9r-Adwr6y-08a3wmeS5bEQGgQSzWzCUC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '2a1a91dd2aa18478cb03629a2d335ac4df90c0f5',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '09aef5f61bde2101efab89e76e4cb3e334b63420',
