...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '803109fb15a70c712fdbb7d226a161ff499cc08a',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'ca58770f4b79ebdf362806e01bf8ea1c47309809',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'CYS3BGTJkcib78Onevf3bnUvzwIKQ9EZGPeQ7c7-Z4gC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '0847ade5098114dff79ac52b4080471ad4221016',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'f987e93795d2cc942d363539c41d05a5bb32d671',
