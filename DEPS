...
vars = {
  ...
  'skia_revision': 'a9bc6c6437919514d725f10502a60dcc3f24981f',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
  'dawn_revision': 'df7414586f66e26d24c5e1582ca4b70204a06e5b',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'efe522b09f7fe51071685152be2214e81e1ee7d3',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@c4808940f6bf7aeed83a947cfcde999a9a35573b',
    'condition': 'checkout_src_internal',
  },
