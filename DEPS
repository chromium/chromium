...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'd5d5b44392901390d6c3db44848390fa1c8798dd',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '117e3b7bb7fa57df35667c4148f0abc8cbca0a6f',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'cc71a772366cc3ee14d2241c0ed3d7217fecec4f',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '6b00833c610733204efb608e33600b3aaba1a7a2',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '28ac56a415a7513f1ebfb985659bf2012d84df3f',
  ...
  'src-internal': {
    'url': Var('chrome_git') + '/chrome/src-internal.git@f7f967b9d61b9e780add32b584771b558fbbe47e',
    'condition': 'checkout_src_internal',
  },
