...
vars = {
  ...
  'src_internal_revision': '2f0fd857fdfccd6445ee4c2d5fd2e2dfebcbbb6f',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'e71f8e7f830840fc7ef9c13583ee73efa0ad01db',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': 'c2316adbbe3cda5f4d072b0ac20549ead38eb7b8',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': '7YwaJXSPcbc7h6766kQgJ_oFeCJfGYUetZV4uxAI5sUC',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
  ...
  'src/clank': {
    ...
    '70426bb7e690eeb505c03f08192b8158bafc97e7',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + 'daa021374bd0cf6e825a1c047f3196f551d85864',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@87790e404be9b7d2d8e303f4fd41db87edb60a67',
  ...
  'src/third_party/vulkan-validation-layers/src': '{chromium_git}/external/github.com/KhronosGroup/Vulkan-ValidationLayers@5c60cdded694688d981eabe173c148c669504451',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '095f5c50cdda10aef2b8442e5d908527dd6731c5',
