...
vars = {
  ...
  # and whatever else without interference from each other.
  'catapult_revision': '87a29d9fe1ac1b6ab2b426d5444232b49612c48b',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + 'ee1a2c72b7ddff4149206d1ef8f5e91d0fa4d1a4',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@5e5855fe06a7fb4bc9e39062fb2a719cf18fe2e7',
    'condition': 'checkout_src_internal',
  },
