...
vars = {
  ...
  'src_internal_revision': '008052ac334141dafde5ce8c98785bca17275a83',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '7d110f6fed8f3cb107f03bd1cda592505cc6ff84',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '4ff8050238e4d48943daaec46e1431e5e37b77ce',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '70fbb1ccc9110ed0dca72682c23f61b5ebdf6a69',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '96143a0b75f44f09f57fed9c2a4ff8a0c283f625',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '5b5cb09f9e2cddedb8100d8114f04e465955a5f6',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'e3a40f4bc16ebe211184b3658903c6f9d3d36b3b',
