...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'f1a84a84d30845074fe88290140c8831f85dcdd5',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '86117b2d5f0fc555df4324bc4ca84571bb63c58a',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': 'f5804298ecff179e8cd0a6c2e751113c43f7d951',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/clank': {
    ...
    '9e2e977520fb6870f6b0161c3aa9984098fcc0cc',
    ...
    'packages': [
      {
          ...
          'version': 'InK-hVmXM6vNCUgH1XLP9G3N4piapKiDVst8yOffkfMC',
      },
    ],
    'condition': 'checkout_android and non_git_source',
    'dep_type': 'cipd',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '69598a73cbbb7bb1109cc5b5986e335cd63085e1',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/openscreen/src':
    Var('chromium_git') + '/openscreen' + '@' + '87d11c80f40404dbd35320c9b4d188c79114f114',
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '399747a972f7fd06f4efb54a747ad9b6482a915e',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '2f91bdceee74c076dc7a7ec084de8ef4691b1cc0',
