...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'b4de8af03d5e829476ffaefe793d946bfe93b5dd',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '0d5e40f62c19d090ceebbe3ba60015d40e464f9a',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '5f10715718c0d771c9aa82af48dc65229ee5f302',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + 'b8171aef7c6c46b10b41a157aadc8b72aa79072e',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'a1b32f560a11e76ec727d99380fc05ee90e1887b',
