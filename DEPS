...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'e72efa276c450127c96633a99d4621875effd1f2',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'd185cec148d4733dcafe33ecfd1a5d93b98c0c40',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '1cf55aaf90c9c9693c904bea055f05bfc60c6b16',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '81590aa510c755f1e89af5a93aeb610ce1238b2f',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + 'b6fd57bdbf7b83932413bc32ccad2a26819cfc93',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '85c05a8a1702d2e94daf6436043523998ba413b0',
