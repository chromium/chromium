...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '54c47a3b88180933e4fae6d6078a084918113ecf',
  # Three lines of non-changing comments so that
      ...
      'packages': [
          {
              ...
              'version': 'flKpj9BozzFFUruvUJUOk-IV4s08Wk1RIYa9nooUQjQC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'GyDQWZmRM5g9qYHbcHBdvwfOj39TvzTAq6ftLlR6m2UC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'o-n5wodCoTv4sN2m3EQquzNK7JQBHzKtyvTkdJoigEoC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
