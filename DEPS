...
deps = {
  ...
  'src/chrome/release_scripts': {
      'url': Var('chrome_git') + '/chrome/tools/release/scripts' + '@' + '852e8cf1e39b4fa3b7717ec3329ab16c5263da45',
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '8f95112db7bc635b098ed276d3fea6d53767e680',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + '852ea3b3255852b10e27b15ee1dde39490519fb5',
