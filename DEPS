...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': 'fb6c00107a5144a84687bd865a6dfb5d7452b3a6',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'catapult_revision': '66e962d6e39b756e4f7ee493e1d29a4de33ace41',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': 'd85d2c7690749eb1fd886aa2834ead1524977701',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'XP4I99zjm_wJsBlHYv6eWFh_LaDlrGN5A_NPO-MMvMMC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/clank': {
    ...
    '28a8e79771e61d9d1c0e14c57d9b2ad490f1c69a',
