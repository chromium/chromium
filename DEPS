...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + 'b4193168545d5f701d192f4163def93481d53875',
      ...
      'packages': [
          {
              ...
              'version': 'MFU2TSiVAB2Tx2DiKl8GlOEvfRi--Gql4pJugHC0nasC'
          },
      ],
      'condition': 'host_os == "linux" and checkout_fuchsia',
      'dep_type': 'cipd',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'b8ba8c9248ed92ac15b585e24c02ec9e21432ef0',
