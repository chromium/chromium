...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '981d30bae3db3f9c34d49a48d4dd8407af88a770',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '6e59e6f8581d0aeb68498d100a348dd8a299887e',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@5800c8f2f29a8fa777be5330a4fb4e55c5e5afcf',
