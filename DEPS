...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '9afb48471d6513acd04e8f1e302d5be63deaecb0',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + 'e63ea799769bdec3341a92fa676d0b147c4924c2',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'ff22a81629bdd35402e8e22b7f7d685c475f4400',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@a0881992192f64e9160286290462ace3cc90d9c4',
    'condition': 'checkout_src_internal',
  },
