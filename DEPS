...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '7d71b1f65a394a430450347c253f8b4ae9fd8a91',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '68689c346a2c0e4c483312eb6fc484026213bcf4',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'd1eb1836aaf04bf480c2ec38d9bdeb7fbf04d4b9',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + '47bb94656e28c94d51f107d27ee894fd365cb71a',
