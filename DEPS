...
vars = {
  ...
  'src_internal_revision': '628b35bc5ef8caa9c64e09659f058caae421aa29',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '941f21add00a7a522cb5dfa13c99b032f3c782be',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '0937cc698b3e94c5246268e8ca454f60f5760590',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + '40e14220333e9780e3fda1e985ec34de062b2254',
