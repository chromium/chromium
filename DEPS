...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': 'a0e8e520c1b9a99a00cf4ebcdc0d7109353ed436',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@3de0a5f7d181ae03eb4a05005bcb3be8990703a4',
    'condition': 'checkout_src_internal',
  },
