...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '34f5fc47b8fd5d9b482cb438640dbefd477f0bb0',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'swiftshader_revision': 'd43f39b388368a303d0202e4042d6b03eab8bc90',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
  'dawn_revision': '822672d7d33672781001de309927be5038257d47',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '1909696991d3e1e689d6d8815bb44fb327527d52',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@1e2d6d2ec338ad0c2fc2e4ad0ca40bd81e7d7d14',
    'condition': 'checkout_src_internal',
  },
