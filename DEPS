...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'b48b4d16c522f861c51abe6b40c80d09c7adf7ab',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': '6HzdYGEDtq4p49zSGrY2swLaD88WOZBfg64rAkUV8_sC',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + '6ffd5942ae83e827e8b522a0463a4db8adc8bd07',
