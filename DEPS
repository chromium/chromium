...
vars = {
  ...
  'src_internal_revision': '1b61f292c73b80d0af60aac005780ef4f291fd02',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'c48d07c65ad5f2fba7c1827bbc4db5d8b4980d62',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'b008f1cf15afb404bcf6cd1ec7bc2ef69dc41f56',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'b77cade20199caf774514e469cd8d51f8a953916',
