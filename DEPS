...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'a11c41db520ca5f0f0f69ed464c4e8ffcaf0dd6a',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'sFLlx9hZLmR0KWBASKTIf3APKmOFsh3VUKTpEGQ3c28C',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
  ...
  'src/clank': {
    ...
    'f6e7892cc66b42f9ef370535a9b5fe114f11b268',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'bdd8c8aae2efea4beac7b37460f985f12ebd2e40',
