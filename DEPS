...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'a12dd26c9ce10a7396cb944ab5d0854e602f5410',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'catapult_revision': '62a64f1eb2f4f3761a2e4fd941125ae511a2866e',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': 'https://chrome-internal.googlesource.com/devtools/devtools-internal.git' + '@' + 'c0fb22fb9450eef138f29c7a96e7b1b84b13e71f',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + 'ff4faa58a8eb3f4e5faf9afbd5e8bd938bcf7bfa',
