...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '42eb5644c8c53ffecc23bca36125a6e77ddd8681',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '1a2246d19b114193ca7299acb89317f39be5a8a3',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '4d888682c8cbeabc02cf10c3e9a54f1e3ee4ac0a',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'ff5297dc5a61324e7ff3e5dba1ff155a570fae32',
    'condition': 'checkout_src_internal',
  },
