...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'a50b2727a5af9f9634d938bee21dd14d4b7890ea',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@da180e3a276d9fe010cef71e34a3a1c6f828149e',
    ...
    'packages': [
      {
        ...
        'version': 'dKCWIwCjI-Llf0IbrcnsJtfwbOnvd3xwWPFEAmLSr2QC',
      },
    ],
    'condition': 'checkout_chromeos and checkout_src_internal',
    'dep_type': 'cipd',
