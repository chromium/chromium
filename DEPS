...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '169494888fe0798225fd7a9f4f33119f07fa59e9',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 's8PCIfAg9fOJz-Hdazlsnfk464tmg9mOVd7C5WzJ0H4C',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'f05UBqmA8wvfS8BAmqQmyCEph3dIJ_KZzLcywCMlEAoC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'bMwgvhUU5U3shNnRe1ASJsP_SU2rdX3y3QtupOa-YagC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'xR2dGcKTmsc6hueDcdBthigOb69X6a5mnxNMTFOqrI8C',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/clank': {
    ...
    'f25ffb5983f2fe23d54fc4a54ffeb9d00790555c',
    ...
    'packages': [
      {
          ...
          'version': '2VxW6TUm-h-RO3xsQZbAMWwacBtSGiDgAB0mzwi2GcUC',
      },
    ],
    'condition': 'checkout_android and non_git_source',
    'dep_type': 'cipd',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@054bfeafe598806a728d647ab76f8e1c8550c077',
  ...
  'src/third_party/vulkan-validation-layers/src': '{chromium_git}/external/github.com/KhronosGroup/Vulkan-ValidationLayers@b3b08da45364b5b43e64cead4f509b7f9c91967e',
