...
vars = {
  ...
  'skia_revision': '14fc2421982a634ebf97cc8af482de16cd8b19dc',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@849699c0a626d0ced381eef59859053ad6ed8665',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '86ebbdba50c6f1c9fe5971b1fdd6317da2261a84',
