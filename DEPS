...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '0e17bce266114f228cf2d24033df7333d54b3f82',
  # Three lines of non-changing comments so that
      ...
      'packages': [
          {
              ...
              'version': 's4FkSiCSnx1On0G3ywIzwfQo2k4RM6bmyyAupaW8rjkC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'b7NCpwSNlTyJd2ZeddeThMCr07SU1eM-R3gK0gbp_IcC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'cuxpE4YOCvayBRlHmvrq-4nM9KaeRYH3AZFVotKdd6YC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
