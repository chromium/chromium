...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'e7f0d107f25835aafe9ce7b32b342157ea6d3ad3',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'f7adad3f10fd6ecfe7245c06199d1809eb691407',
    ...
    'packages': [
      {
        ...
        'version': 'I9KZUu5RQLZF7yH6gUWjEhMFK2PN-UnO9tqRuf1NTXYC',
      },
    ],
    'condition': 'checkout_chromeos and checkout_src_internal',
    'dep_type': 'cipd',
    ...
    'packages': [
      {
        ...
        'version': 'O2T82qhfElY2DDeL12gJvTQAWGyrR8I_oxm1_3sjGqIC',
      },
    ],
    'condition': 'checkout_chromeos and checkout_src_internal',
    'dep_type': 'cipd',
    ...
    'packages': [
      {
        ...
        'version': '99Ahu6y13zZdeLdpOYkJAEZePyPf9LKTirT1pBbJv0wC',
      },
    ],
    'condition': 'checkout_chromeos and checkout_src_internal',
    'dep_type': 'cipd',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '225299a8fd748cd8e8f5f0c34ca2b942a21fd37d',
