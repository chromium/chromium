...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '3c9891dcc128edb70724888e519990bfa6ad6839',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'swiftshader_revision': '9e9d7d210d81335c27c807980ca031a596880de0',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'catapult_revision': 'd9467f315ab26ec7bcba06a1d98353df7d3887f2',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '37b423ad6e0771873d03cc4dde3aee825d46d958',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@604f763a0b27b0263fe27ded9ab143123f55b0e7',
    'condition': 'checkout_src_internal',
  },
