...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '0bc1b7d19c43ea53a978084364f427df03f7e8e9',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'd69ce5551ea4c0cd985e79a1f4812dfaa397e07e',
  # Three lines of non-changing comments so that
      ...
      'packages': [
          {
              ...
              'version': 'RW1I_W9BjW-FrrEVkVacQTJ2FVk2BG4SfRdwD4g0R5YC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': '-0hjiC8y3dPriN6Py5_2CrAxVTgAG8YZBm0wBWJKMpIC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
