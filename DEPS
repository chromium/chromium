...
vars = {
  ...
  'src_internal_revision': '1a7d3346629b0d0ab2bbc890ea907adb5a37815a',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'sAjciOi_s2Koa-eM0VxmNTx06L3ijt0WSL0LLEy7sEYC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'YS1aLLG1iMBdlxAQY-iDorim8kmR1nNPZD-MuiAQxEcC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + '925b24bbd956a9f00ce2ac0c137b67ce673ad338',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'a858d7fcc74f08220b3857e457a855c3fecf4091',
