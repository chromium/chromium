...
deps = {
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '3376f974af79d952daa25faca530ab20a2632080',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@639b59d93e913cd3084b8f79f1cdfe9c6c66af09',
    'condition': 'checkout_src_internal',
  },
