...
vars = {
  ...
  'src_internal_revision': '1da7e1a00038ee532aa851576d67cb3e332b964e',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'd9af24231584129dba6b4c9f9d408d534d169cb6',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'crossbench_revision': 'bc745de45bf167fff9835e625db2c14497610572',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '20c9eb33c91bcb6cbd382354ad3fdbbfe0f5c19e',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '43fc8f4ac645dfe2850e68e24aa10845e24b3d89',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '2b76c8441e0015cdcefcbf469a2a9e262aa9378a',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '991cdbb36b2b3f656c7cb8c9eb461abe5895240c',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '12b861ef29060e7434dd72f05f96700dc7d940d4',
