...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'b97ab3d929c9a5331afa020052f1757adf7c98e0',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '276709bebff9de42e7715a3f30645d4117f1f944',
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '5cac0a369729cd1e8aa92a9ca4cbeee7cbec8ad2',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'ceb5a3b11e07cde708fc3b484b0365eccc660433',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '419f9593fe7da76b961f3246f99dfdf685b68aae',
