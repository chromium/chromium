...
vars = {
  ...
  'skia_revision': '7779a70f8729363a2805f1ac3da13730afc604f5',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '28577db11fcf6f82aa3b36eb768ca5bc8bdebad2',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@14d917aa619021eacbe59dc7192dc2a1dada49e7',
    'condition': 'checkout_src_internal',
  },
