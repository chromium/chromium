...
vars = {
  ...
  'src_internal_revision': 'ec04305070ade0a9ef1b74bcaf0d05f013505892',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'd58d4c4c5dea50c1c01ce9821c53aa073a4b7e3d',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': '7c7a3090564335406cb887ed74d1fed6f3485482',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': 'aa88e5afa08a81763165f99b602fde25ab731227',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/clank': {
    ...
    'd9fcebb5065038b319603ed239e2004664a68b1d',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'f0caaed2f3cf27c0fb09a750a19b0455a810641d',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '3a8d50fa5fbd620cc15b903ee0c74ed59b901c9a',
