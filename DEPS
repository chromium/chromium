...
vars = {
  ...
  'src_internal_revision': 'cc1e385053cae7fdcb2a8d79803b5f9eb118df99',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '4bed5ba3f526a4e528d7ca34357bbe1ee9e6b77e',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '6256fa9061433c0c6b7bf252eaac5050c5a30dd7',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '362a98046ff6f6598e1608ccc8b4fb04436da8e8',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/clank': {
    ...
    '9cd4563301de93bbabb909d105e42c51b975e3d7',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '4331ea8454b9d9fe934f81acd5c46d100aba1470',
    'condition': 'checkout_src_internal',
  },
