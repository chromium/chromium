...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '0ad812d268a7820dba9bf848b416aeda4dd1b2e5',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'go5tA9CR3bxgyX5lMXS2255_DKMuhX0x1XmG5KR-lGMC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': '4WK2hf3LTPHY0EHvMt22jtehF1mlTLaFsnxW0jCi8FsC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'R-05od9k3jrlRjpgJ9OPdywn3Wr0NqAeNJRpiDyS-f0C',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '6733aa5ba16e1e1087f339d1151c80c924a6fbf8',
