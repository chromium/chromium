...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '07b45e9b1cb74e6fbb279b21cf475c857ed27aed',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@5576241156e8923deb7c71a2179c91a07f52cfac',
    'condition': 'checkout_src_internal',
  },
