...
vars = {
  ...
  'src_internal_revision': '3f1eb89c913377e982a8d955b099bf6957f671b1',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling Skia
  # and whatever else without interference from each other.
  'skia_revision': '20829e37dfb8e58eac302337d338ba459aaf831f',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'e16bdc5f76a2673f3ae32b5801a20ddbdfa49b1e',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '840f70170b00933dac9e0d6b80cbf57a95b97ee4',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'Gm4X1sH4I4pXylQCR3YASOW2WBVAhwGJyG4-UmiVjosC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': '6Rx3XSRqsI4PboBxM0GBR1fz2LDdnuBUlNPe-EMutzkC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/clank': {
    ...
    '26c353c7cb7921da3c1890edc0740e6310b5f322',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + '1aa7f81a800c7421ac4a9383d243ff575b5fd9f1',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@f0c4e97a968d3753d999910ba0183e6a6026a1b8',
  ...
  'src/third_party/spirv-tools/src': '{chromium_git}/external/github.com/KhronosGroup/SPIRV-Tools@3d4342d4809220cd4e300edb1c124a37061f3b51',
