...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'b456219dafbfa0bf4dddf8d426220012c37617ed',
  # Three lines of non-changing comments so that
      ...
      'packages': [
          {
              ...
              'version': 'Q9WFhtmuHxBOy4Y3PLh5114-gxpZ5un-0DzsmdvNbb8C',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'kpdbCp4dXch_0MeGSiep7MDNm4IfL6-zt4Ms3lZTs3wC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'aKKpggVEaOQZVWJK49_Sq_2ctQzLfCN27YYDiHMv_qQC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
