...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': '23b99e2f8c711abe3717a7e5528dbd6caddc0cf9',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'boringssl_revision': 'be88fd4a09943317889c11e639b04c53bfc99ce7',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '88dbfc041fc9a09a14089e7c0df6d9614798e556',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '15b2b247c77f97ec20588291cdf1fc8d373a3271',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'df7b03586f126e24b74432ac0191a3d633d98fb8',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '90886fdbe7808105fe78938c79fae144036a6cb9',
  ...
  'src/components/plus_addresses/resources/internal': {
      'url': Var('chrome_git') + '/chrome/components/plus_addresses/resources.git' + '@' +
        'a3a449ca0617707e9e3a14b5b5ef96c9322b5a9a',
      'condition': 'checkout_src_internal',
  },
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '8b13e8e57db43dc90e4c836dc9475d5f9ef33116',
