...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'b96439b0cb341ff78c23f6e9d36fd0dd878f9288',
  # Three lines of non-changing comments so that
      ...
      'packages': [
          {
              ...
              'version': 'ZUlitlPGii5z-fGcQMUW9RXMdqYHrMK6_n0fXdO1WBYC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'Unwk4erP_kJCa39-qxYwRyVdc6f8KJO0OnEWpuzWRFIC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'nanBMfIl0cWiP4Hcen2HIrTq3SNzEvrqxZEoNPAEmHQC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
