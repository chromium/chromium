...
vars = {
  ...
  'src_internal_revision': '4e6979d9d9aae78eb65c5e9ca0ec2298d043d568',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'be38cd393b81610d82d3a76d463481b6260d0b29',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '1bbe315ed5e21182aa018e83b370793a8dbda6c3',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'aa6e12a248f96ac725f445f248142268c9bc15ff',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'c3a0d6c06996639a5d8807c53aee180bb4f4153a',
