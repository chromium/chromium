...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'ace3d51282b8882d327e9dcd8f7e69d9ef4697b2',
  # Three lines of non-changing comments so that
      ...
      'packages': [
          {
              ...
              'version': 'ZVTInTdP6S6Zj26DKBNZOD1LNf9hVHPRRi__uvC2N8QC',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'Z_SZ5vjZY-qrlN3p9Y-4z_Mzf7bkbCp9M8XJzwtq8R0C',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'ocGuFPDyfmrX1erBPAPtL2ABBaYkKLmH2wBEyzi-EwQC',
          },
      ],
      'condition': 'checkout_android',
      'dep_type': 'cipd',
