...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '55399a10def43b875130482a3c07cfe63c6399fd',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '6001ac69a8a0f4e5f2eac9f68ac8fbb988d135ac',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@016bdda965eed37d42dbb1d3e6037b617c8e03f8',
    'condition': 'checkout_src_internal',
  },
