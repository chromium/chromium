...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'f7a1ff6bcd663b5e7c4b49e3aa3930653a65dbff',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'L-_9y_NJXpajwF9IHKudYn0Zs42rx6JvoqHqsebNvrcC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + 'd61fcf4cf6b9e5b637b0b9c115bda2a6cb56078e',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@9210bd1e37ba447f51982ec58a048494ff36ff92',
