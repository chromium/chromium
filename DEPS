...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '9b07794062f88388f5bb88b15cd5d11ca09d296b',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'waRCuLXi2hxJ--Op6bSWjj-fpfmB0JSdnwy_kFT1IV4C',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + '4164eebab5e341d655e79a8a76f4cf7a4b228382',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '06728539ce05dacfbccbfeea4800929d3cdb63b6',
