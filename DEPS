...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'f9ce93eb09a8cc4b8bf4ea5de337d3a7d8ca82f6',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': '62d9f847e4f69fb072d030e7cbe9bd4e37fe2a06',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '55e036736525a9680b45f14cfc1eae3daf87f82b',
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + 'd2b2de302f2c291041354d4760788bf56a783209',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '5ab294aaaa2cf521b0e2088a19a5a17851605f3b',
