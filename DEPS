      ...
      'packages': [
          {
              ...
              'version': 'z4jpX7ssXoz8atSDvgTj1eWGLxVCYeOM40yxNbaXQi8C',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 's-SqZy9TtJShOObHdB2e305PCD1HYFtntN6HGS6TJigC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'rtmNpqPQ9YMaFQVoC_HEX51LvzuancgHjNHFXbjI2bwC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '4d8a2dde6894a32ca7c4cb3a5c0971275b3b4707',
