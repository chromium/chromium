...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': '19683d2d5782c58ea50342c7f9c16d2a0138f6ab',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@098d0d72a1e7ad45246155f267604b1419356822',
    'condition': 'checkout_src_internal',
  },
