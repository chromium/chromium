...
vars = {
  ...
  'src_internal_revision': '0d3e342ae559b3f5a4c73d910433e0ee06555bad',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'e260514fda5327af9ea235bfb4cfc8d692af9d8d',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'catapult_revision': 'd28ef26c7ec6e12c7b1f38399e462282222c669f',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '75b21c0041546cad25d6c6cd699b005757154e3a',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '2a5c926a8edc28b5041221d489c896ab14e45494',
