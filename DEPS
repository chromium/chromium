...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '5e4b993feea4a7a42ec79842f6a14d7d002df6cc',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'd05b8da37939a87ea8675cccdf12bb7e8271952d',
  # Three lines of non-changing comments so that
      ...
      'packages': [
          {
              ...
              'version': 'rpezo1KnvK5G968WbbSLw6l_8U7LzrET5QNk4BubiKIC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'WFvd_NxN0WKXRultl_5A5XqOfoXdZQiadgVS1w3n6ukC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'Qg6SF1SmaP0Of3G61bxgDsiiTQbWWVysEhtrAxq7mNcC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
