...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '0012f931c6aeedd24174ba6fc6cab65b591dda36',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': 'dc4b9ae9d47f3b0c0d12d5ee94371f3d67ed3047',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/clank': {
    ...
    '74e670b4fcc2bd7cd037f0dc4967c5f8c4f51467',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@dcf4ff3cb0ac12053ba45df984a41f22721d94b2',
    'condition': 'checkout_src_internal',
  },
