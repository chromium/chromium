...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '341344a0f9e6d90e561eb50bbc87229cd17971f1',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '5c80b14d6f2e905f0e06c19b2855489f53170894',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@039c5b90ec26a3d893dc29b3646b97426150a29b',
    'condition': 'checkout_src_internal',
  },
