...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '9037a527a3555aeee32d1a1f0cfaabd5822dd7c4',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'b4e382d3fefb1fb91fcd55a2b953116c2b5dcbe9',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@3c758aafe1ada3d186a4631e4eaed3906bb439d2',
    'condition': 'checkout_src_internal',
  },
