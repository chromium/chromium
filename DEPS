...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '0e5a5d241dd9b54d5634df5c5582e86b54101492',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'bdbcbe94074d9c656639f5837c2689acb395fdbd',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@13694cecae3979da5c3986a7324bcd77858df6d3',
