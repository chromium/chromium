...
vars = {
  ...
  # and whatever else without interference from each other.
  'dawn_revision': 'd9a6644e66fe460e14de287872aa3830aaf5c891',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/clank': {
    ...
    '93bef367bc2c4336e27a007fd5df34eca22a16b0',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@13859ce3f399223700ec3a7936e9ac673ae3b504',
    'condition': 'checkout_src_internal',
  },
