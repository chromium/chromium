...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '4702412cdb616c8000b87bf5f157fcc037d66647',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'ixE5L4y5eSlnXVIbzLJil7HsjiVF2Gt-B74xltVPI20C',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@ac55dee5b314e5ee9804a7a8ebdecb28694a01dc',
  ...
  'src/third_party/vulkan-validation-layers/src': '{chromium_git}/external/github.com/KhronosGroup/Vulkan-ValidationLayers@1974ee2f21dcc4abf589b08f29ac6acb43e9bec4',
...
# LINT.ThenChange(/components/cronet/gn2bp/copy.bara.sky)
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '157dd2b02d854dceff118f9e495744dfd24c6fa9',
