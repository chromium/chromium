...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '3041085c8d46864aaf4094b349694fda4b896c3a',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@6c85f8e8c21c5fa2c47f5273043e30273b846d3c',
    'condition': 'checkout_src_internal',
  },
