...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '14e83e8c7a1d81e36451a5772027a42fa311e147',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '5910ea5022800f317b839ed96bdaa3430cb64f96',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '028da9c22d16fb877f3fd4b702dabddc8c2af5ec',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'f23f15bf0de7a246d8235221b42d3dabe0734586',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '5a7f4213075c3b64341333dce6df7557e0fd98e3',
