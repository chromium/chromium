...
vars = {
  ...
  'src_internal_revision': '5d112df7631c3eff1f76e4851ea2a8cc32580191',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'G-U3SED7QSB4B8Uck3NGx5TRigZxkANeQP_Gj9FKoikC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'WFNLCANLkE6aq2J056hzi72acvvz2YxlK1OwF4R6iBsC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'vqFcKt_dhaL4ErR2O0cOBLVZnQWRYMGaz5DrxVtQVaUC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/clank': {
    ...
    'b3f6c8587f534853e791d261ea52fdbe1cfddef5',
