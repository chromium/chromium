...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '9cf20be0f12a3e5785b28205809e233741435bac',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': '425be99db6b82235c4c1dae63cc25ae91a7ff3f9',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '0ebe111400b540f7e548137e1eec237f304cddd7',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'a4b7c46d7a83716b1e51e7e4bdf58f6e1c54005f',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '462fd2f5e5dd13c6cad28969772b9227ad17083c',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '75787bcfb61d362034a4b9a31858a721742304fb',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@dd6c2371c85d2dbb8280ca68a27fcb19b4e9931e',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '14613639bfdd2021d531aa13fb9c72ff56f4b786',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '819d9ad57f9940fe5bfdd50dc55ec8236f8e72a1',
