...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '8e379a524e005ab7e655dfa4f6eaa86db31e3a7f',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'dcdbdbaff22ba426d5a0801404aae146ab0e1050',
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '014909c881f7786eb7d9f8cdaa5dd3820fec8f5c',

  'src/third_party/devtools-frontend/src':
    Var('chromium_git') + '/devtools/devtools-frontend' + '@' + Var('devtools_frontend_revision'),

  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '142d2fdc8ace88c7e954fb359bcef55964a651db',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '1e25c7809701d1d80450f446326c1a485deca9d6',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'f4aa6953f9005b850548b75a8f9882b368ced570',
