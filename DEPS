...
vars = {
  ...
  # and whatever else without interference from each other.
  'catapult_revision': '3ae1ddb24821aed9efc496d14694fed37711e031',
  # Three lines of non-changing comments so that
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'O5dWfbZTvExkZJFqanxCXVRKtUE8VJFF6nbgI3fIOHYC'
          },
      ],
      'condition': 'host_os == "linux" and checkout_fuchsia',
      'dep_type': 'cipd',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@9be933bb079a23f6a8621c2bf13e1fd1ed58bdf7',
