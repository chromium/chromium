...
vars = {
  ...
  'skia_revision': '7eb544c9b8bf1c860d3e9968232c102aaca49c1a',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'f760217010c11a2c1b556104e8576614314f2e28',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '6566fa526c84964e14bf2d819b51142662ca9275',
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '59f9ce1aa9d9ab16f338b164af7f20b8fc407da0',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '9f3ccf291e5f05f41175ae5684ede51d17894f56',
  ...
  'src-internal': {
    'url': Var('chrome_git') + '/chrome/src-internal.git@885866a9a43a04a16ae729cfc9498fbe51cf17d6',
    'condition': 'checkout_src_internal',
  },
