...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '76941e2ddc5d612775782aa1edf537d2084897cb',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '686631a1ab9f06af2834102cab6d02d4bcbaadc4',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'nearby_revision': '5b3d4438150cbd4abefde95a2add15de5f634bfd',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@eb8d8f22bf7e4e8fe878187a6cbebc914827f687',
    'condition': 'checkout_src_internal',
  },
