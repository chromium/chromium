...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': '3605b399e094948159fe0a3578c5cec537a4e336',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': 'e8cd0beb74e5bc838dd907db50148543a6a48d00',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/clank': {
    ...
    '3e47e7727c6de9a463e7e59938659f08c002fb3b',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@667758bb30f44ddd237e913edd8603a8ee2dd87d',
    'condition': 'checkout_src_internal',
  },
