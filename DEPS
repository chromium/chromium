...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': '85c98a92bb763452133bd7b4580d80625bb2c75d',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '252db9970a4edf29f21086e31d22c2e0ddc42431',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': 'https://chrome-internal.googlesource.com/devtools/devtools-internal.git' + '@' + 'd3e3c864fc22ff2956d486a3092a65415074156b',
    'condition': 'checkout_src_internal',
  },
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@ae9ac74961abe0db0cf5cca0558b603eaec8fff1',
    'condition': 'checkout_src_internal',
  },
