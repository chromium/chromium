...
deps = {
  ...
  'src/chrome/release_scripts': {
      'url': Var('chrome_git') + '/chrome/tools/release/scripts' + '@' + '330cf5badc966bc4df6e2251a1627f0439afdaac',
  ...
  'src/third_party/vulkan-deps': '{chromium_git}/vulkan-deps@1ce6f54f68c64af2abd4541ea489f6a54f80b848',
  ...
  'src/third_party/vulkan-validation-layers/src': '{chromium_git}/external/github.com/KhronosGroup/Vulkan-ValidationLayers@0f024dba941e9c8a8d692f67c7760baabf2238ca',
