...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'f03ad02753899382bee1dbd7779c59e424e090a0',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '3ac3c58ce9e8d5f1e374512ceb2b7e50a04f6bb7',
    'condition': 'checkout_src_internal',
  },
  ...
  'src-internal': {
    'url': Var('chrome_git') + '/chrome/src-internal.git@fc7f34a04996c8535caae11143852b47dd19ac5b',
    'condition': 'checkout_src_internal',
  },
