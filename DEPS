...
vars = {
  ...
  'src_internal_revision': 'a75750ce0a25142745e6f5ea8dcd486a62295c51',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '465c8d3348ef14d39fa77bd2af7483d4c3bb58a1',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '11d2018f709ac9fcb6bcd8557e192e56eadaba62',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'ce935d54e947ec9afd8560cef83c168f1be16730',
