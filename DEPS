...
vars = {
  ...
  'skia_revision': '784ac915d4278f7ae1dfa33bee1314b532cef318',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'fa4250337f1ba6ef0dbb65c4c7604527dc460042',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@d9d752771b77db2aefc1dd232ac5ef393b387e84',
