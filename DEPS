...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'cedad4757a948fc9fc892d08d2a1c97a5122b811',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '0aa91fccbbbbf929de67b94a15e11943f842f27a',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '746d903acd6c098a05befa209d0bec9b2567db36',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'd2dbd15d72c9d0a8d47a7d0b00bf40f58fde1a73',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '534435c6bc6bf49626757f27659bd2d0ccdd8d2f',
