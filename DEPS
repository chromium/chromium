...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': '370a9dc680645ff8609e1650063a4286bd248a8d',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '64bbf018080153bc127e967a9f9ea5ef8b6d6372',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '0d475aea340d6b987f9b47e04ca3a27925c45a33',
    'condition': 'checkout_src_internal',
  },
