...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': 'dfb80e31d15b3154b7386afcd801020400f2ea89',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '61a33b333e779199f05ba622a90da293654351c1',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + 'e7e3d5925ad2c96b840dedc2ba619edb3545a9c9',
