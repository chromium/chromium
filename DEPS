...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '6be127658c6c7acca4244ef3c085367482fe8a1f',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'd97b6192c232ddefddebacfe7cf13a5129f75d7f',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '59e3ec2da0d8848335c3da7e12ea00ada26147f9',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@81470c68718703c36b22c355d13992b2f1d34056',
    'condition': 'checkout_src_internal',
  },
