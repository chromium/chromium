...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '3ab3f5bcbf3a0cba6f7b42403a416d9c1f4cc71d',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'c82161979956372565fcf828fa8c49b0ad2b9fa1',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'e01047d61f37daeb4535cbf84a654cd188568bb3',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + 'eb7af20cc1c39fb27c2b59ddeae8570ea7916054',
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        '7718f57a3cc2d5126cb5cdabeea58d8fe1e49340',
