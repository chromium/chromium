...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': '1e7442b2f005e30eb0752f0caa25e0946d3b6ebd',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'crossbench_revision': '9d6235c560f56334518e41a38711731a8068424b',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '30b4e1d1c631d577b3afdba4627dde2c61917bf3',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '60aa2633253df870fff64c4aead3c0c1edb63dc9',
