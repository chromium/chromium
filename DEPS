...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': '1ead4cbd1af3a782b4c7443d5c65e5d6fb9e3ebb',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': 'abbbafdec13c2d8ce2511f04e1cff9251e5d1800',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/chrome/release_scripts': {
      'url': Var('chrome_git') + '/chrome/tools/release/scripts' + '@' + 'def59f0b7727fe166d1ceac147c653dc2f797482',
  ...
  'src/clank': {
    ...
    '74e94560e3b4d16ce3d5b7a1744a41bf8fc87273',
