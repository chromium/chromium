...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': 'f6a19c3fd1e8ec3b3fb3424cf3eec513e0777e79',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'dawn_revision': '74f6bc7e4028df0b1abfa0b03279cbb5b3b4903d',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': 'https://chrome-internal.googlesource.com/devtools/devtools-internal.git' + '@' + 'ca85e46d54b67efd30f6e6dc0c8bf7140bed72e6',
    'condition': 'checkout_src_internal',
  },
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@7e64c7970f50e3fb0baab7c7bb86c5ffa2dcdf20',
    'condition': 'checkout_src_internal',
  },
