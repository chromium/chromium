...
vars = {
  ...
  'luci_go': 'git_revision:328aa4830ebbda8ec1526bee4dc0d0e006367d46',
  ...
  # and whatever else without interference from each other.
  'skia_revision': 'e594b6dd7ff7516edeb8d2b88c9423e0eb112c93',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '9d6422566d04feefb2235f838d0bb18aa342be69',
  ...
  'src/third_party/eigen3/src':
    Var('chromium_git') + '/external/gitlab.com/libeigen/eigen.git' + '@' + 'a91913e9611d1193f492fda42e879325fb312256',
