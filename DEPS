...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '8a18c670e04779caf55577e4fafb934aa49d3ecf',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': 'b7aed3fa978b9ff8ca52f24a018ad660fadf74c7',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@f8599688a0175e3aee7e801731e83c5207e9c386',
    'condition': 'checkout_src_internal',
  },
