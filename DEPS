...
vars = {
  ...
  'skia_revision': '0ad2d013b1f8a689665c13697c650ba290822d20',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '003e17fd1a88901caeaad028b1bceb107fb76797',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': 'eb6a3b514ae0958517c648820c02a45ddedb73b3',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '501bd715898bfeeeb80a9ac0d8c9befa494d9f15',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@7d278e08845a6cca96de96cf3639e70271f5cecc',
    'condition': 'checkout_src_internal',
  },
