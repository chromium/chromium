...
vars = {
  ...
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '8e26147bf7213a1355d440f5658695db2f310a46',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '76d151de44d6dc267ea7a4303093f7c71fa2db0c',
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + 'f82e76bda590f95122db33491eb3d46012bd4352',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '74e7ac59b05e0941d0d86709747ce404b15a6da9',
