...
vars = {
  ...
  'skia_revision': 'a2ec871255352c61077a25fadffed3304bfc104c',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '2f06aca78d5d7dc24b2803302d6c3f3c3d3bb54c',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@d9db5d892b12d32f328976497bd1e4e7dc3d0769',
    'condition': 'checkout_src_internal',
  },
