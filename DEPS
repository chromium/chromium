...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '48311c8e39d1892245dfd5ecc1f557a14825ec69',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'e97898de6bfe3d238b9adc4132055dc736a85864',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling ANGLE
  # and whatever else without interference from each other.
  'angle_revision': 'd04b9e9dcec748024794528f3f3fbd449228b6ab',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '277299a6b14965c0719d8d36939266d553afaf03',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'f06684bb980df1c5d3a32993b5e7a0517b6f15ea',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'f2cc4caf31c9be4d76c260ddaf4da700f6bfc985',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/ios_internal':  {
      'url': Var('chrome_git') + '/chrome/ios_internal.git' + '@' +
        'e35777b39a164741ad49cd3f0fe074ac2d0d4dc9',
