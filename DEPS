...
vars = {
  ...
  'src_internal_revision': 'ba077984c0de7882d51eaf05a67460f43d4731bc',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling Skia
  # and whatever else without interference from each other.
  'skia_revision': '570482f8e4f53f35a803c85f9055f362dc857a2b',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '4bb5d75b3c0e48a4d2daf864f82c4319a0870a47',
