...
vars = {
  ...
  'src_internal_revision': '9a8862ba2dd1d6ed10aa38a294cfa573c38900d4',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling Skia
  # and whatever else without interference from each other.
  'skia_revision': 'd1a63fadf029f6df5274cfbec5de0cce8b680f77',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'e8aea8cb3cb68d1dab41295d5356b95b8e0e6cfc',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'c1a4058723e0dc0cfec7c1593cc2119895bba6d3',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + 'd66d92e2d83b7c2e44a8f6857a85c99ed7eafb28',
    'condition': 'checkout_src_internal',
  },
