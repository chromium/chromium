...
vars = {
  ...
  # and whatever else without interference from each other.
  'dawn_revision': 'f11011937c1b00c58d92454a9a322108f8b8ba68',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
      ...
      'packages': [
          {
              ...
              'version': 'uDBLnxAaSwxSO-QkTEXXsc3hjzt4MOT47ozYUgENG3kC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'vfe3IGlkqn_dCDMBoXs5BZjiOJiseN-4fx3RZ-Nf9MAC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'Jd4wxxAKb0CS6sZLRE5MRpyjNVPnnsjlSWKoBVElqfwC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
