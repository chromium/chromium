...
vars = {
  ...
  'src_internal_revision': '71d478687069bb1de14848accfcde0998c388bd2',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'a469cc1501fda3ca0e8fb4638e0e92e69b390d43',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'crossbench_revision': '134e1ffac2ca25e8a1ca59dfd1655b6591c164f4',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling CrossBench
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/clank': {
    ...
    '26bf376f5c5519f73939793d74e1978c8af9359b',
