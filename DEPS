...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'ebf4c58fa36def0355edfb1e315bd096ad41182a',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '2a1b3a93b0208e48351737a37569d7e8dc559e2c',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '163bda8d83ed14d9a911ce98cc625825530c33e3',
