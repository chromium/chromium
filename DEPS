...
vars = {
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '74b64f35544ac1f2cfe8dd0de58f36e75f9577ee',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    '892f6df6d5d18bfa44d3427c49aaf26d3082eeec',
  ...
  'src/third_party/perfetto':
    Var('chromium_git') + '/external/github.com/google/perfetto.git' + '@' + '3c78c63c99a7dc3ea2856075998b14948ff79c20',
