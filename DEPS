...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'e10a4031b176f89b1c7409341c7c2e15e4cab39a',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling SwiftShader
  # and whatever else without interference from each other.
  'swiftshader_revision': '40adeaba22a6159bd2315aa28cf8c34269beac32',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '225aef1530e3d9b249684c794340779504e4cccb',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
  'dawn_revision': '96ac969a33de78c673e767e0504e93b1d89a2db3',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/third_party/depot_tools':
    Var('chromium_git') + '/chromium/tools/depot_tools.git' + '@' + '984ce942a4b1a5a559a5b07b9c0b29b228cd070d',
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '23b24d116347c3706f6a3254ce3b7d9a3c8b4213',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '52b9e1ecfbc83e92cee06594d18febc0d1f944d7',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@fcc80282c35018b0d824e4dac11433b59b17c771',
    'condition': 'checkout_src_internal',
  },
