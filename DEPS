...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'fb0174fa6556af32da4ccb07965a8418dc9597b5',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/clank': {
    ...
    'f55884220a58e06aeafe98e56b922ebfe419e7f4',
  ...
  'src/third_party/devtools-frontend-internal': {
      'url': Var('chrome_git') + '/devtools/devtools-internal.git' + '@' + '66ea51e65e404a76b988166fe18a7c86c8d4c635',
    'condition': 'checkout_src_internal',
  },
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + '8e5a39d8ee0b28da4d9b893208ddf1bf4385f8dd',
  ...
  'src/third_party/webgpu-cts/src':
    Var('chromium_git') + '/external/github.com/gpuweb/cts.git' + '@' + 'ebb7792be3218a391c85a80a436fad285ec40c18',
