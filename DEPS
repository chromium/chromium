...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '6d7ade9386436cb5497d78155c7ab5eb3ddebfb9',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
...
deps = {
      ...
      'packages': [
          {
              ...
              'version': 'EzG9Od2-WUjubJqUYD8XbfM-2Q9eiiYsGDGYdoH6NXUC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
      ...
      'packages': [
          {
              ...
              'version': 'bdB98mp1V9mxBL6XE95ZgYwpcjrVebUKMxyH4MvKqjsC',
          },
      ],
      'condition': 'checkout_android and non_git_source',
      'dep_type': 'cipd',
  ...
  'src/clank': {
    ...
    'dacc562433baf7f930cc3b433a4726a1d33151bf',
  ...
  'src/third_party/eigen3/src':
    Var('chromium_git') + '/external/gitlab.com/libeigen/eigen.git' + '@' + '806c7b659008bb917fb088fab3ff1373ad629628',
