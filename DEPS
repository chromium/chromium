...
vars = {
  ...
  # and whatever else without interference from each other.
  'v8_revision': '266462e7cde92a1502a29c3137e2598fa42e0f9b',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'devtools_frontend_revision': '78b2ae5c5baa825c88917098ef57b595d3c94aa0',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '153c9e51074b3004ffeaa6fdb9749e4269b71ba8',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@ac117a2ad4541550e1c839e35270d6ec8d1b3591',
    'condition': 'checkout_src_internal',
  },
